...
Describe -tag 'PSOpenAPITools' -name 'MessageError' {
    Context 'MessageError' {
        It 'Initialize-MessageError' {
            # a simple test to create an object
            #$NewObject = Initialize-MessageError -Message "TEST_VALUE"
            #$NewObject | Should -BeOfType MessageError
