...
module OpenapiClient
  class RejectReason
    ...
    def self.all_vars
      @all_vars ||= [OTHER, EXCHANGE_UNREACHABLE, EXCHANGE_RESPONSE_TIMEOUT, ORDER_ID_NOT_FOUND, INVALID_TYPE, METHOD_NOT_SUPPORTED, JSON_ERROR].freeze
    end
    ...
    def build_from_hash(value)
      return value if RejectReason.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #RejectReason"
    end
  end
end
