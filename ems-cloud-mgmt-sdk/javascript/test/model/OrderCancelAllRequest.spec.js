...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsRestApi.OrderCancelAllRequest();
  });
  ...
  describe('OrderCancelAllRequest', function() {
    it('should create an instance of OrderCancelAllRequest', function() {
      // uncomment below and update the code to test OrderCancelAllRequest
      //var instance = new EmsRestApi.OrderCancelAllRequest();
      //expect(instance).to.be.a(EmsRestApi.OrderCancelAllRequest);
    });
