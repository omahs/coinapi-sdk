...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsRestApi.MessageError();
  });
  ...
  describe('MessageError', function() {
    it('should create an instance of MessageError', function() {
      // uncomment below and update the code to test MessageError
      //var instance = new EmsRestApi.MessageError();
      //expect(instance).to.be.a(EmsRestApi.MessageError);
    });
