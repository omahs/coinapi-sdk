...
class OrderCancelAllRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["exchange_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["exchange_id", ], str]):
