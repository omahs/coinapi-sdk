...
class OrderExecutionReports(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OrderExecutionReport']:
            return OrderExecutionReport

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OrderExecutionReport'], typing.List['OrderExecutionReport']],
    ...
    def __getitem__(self, i: int) -> 'OrderExecutionReport':
