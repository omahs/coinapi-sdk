...
class TimeInForce(
    ...
    @schemas.classproperty
    def GOOD_TILL_TIME_EXCHANGE(cls):
        return cls("GOOD_TILL_TIME_EXCHANGE")
    
    @schemas.classproperty
    def GOOD_TILL_TIME_OMS(cls):
        return cls("GOOD_TILL_TIME_OMS")
    
    @schemas.classproperty
    def FILL_OR_KILL(cls):
        return cls("FILL_OR_KILL")
    
    @schemas.classproperty
    def IMMEDIATE_OR_CANCEL(cls):
