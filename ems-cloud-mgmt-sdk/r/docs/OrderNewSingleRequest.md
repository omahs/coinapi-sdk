...
**side** | [**OrdSide**](OrdSide.md) |  | [Enum: ] 
**order_type** | [**OrdType**](OrdType.md) |  | [Enum: ] 
**time_in_force** | [**TimeInForce**](TimeInForce.md) |  | [Enum: ] 
...
**exec_inst** | **array[character]** | Order execution instructions are documented in the separate section: &lt;a href&#x3D;\&quot;#ems-order-params-exec\&quot;&gt;EMS / Starter Guide / Order parameters / Execution instructions&lt;/a&gt;  | [optional] [Enum: ] 
