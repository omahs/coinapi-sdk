...
PositionsApi <- R6::R6Class(
  ...
  public = list(
    ...
    V1PositionsGet = function(exchange_id = NULL, data_file = NULL, ...) {
      local_var_response <- self$V1PositionsGetWithHttpInfo(exchange_id, data_file = data_file, ...)
    ...
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @return API response (array[Position]) with additional information such as HTTP status code, headers
    #' @export
    V1PositionsGetWithHttpInfo = function(exchange_id = NULL, data_file = NULL, ...) {
      ...
      local_var_url_path <- "/v1/positions"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response, "array[Position]", loadNamespace("openapi")),
          error = function(e) {
