...
-- |
data EMS-RESTConfig = EMS-RESTConfig
...
-- | display the config
instance P.Show EMS-RESTConfig where
  show c =
    T.printf
...
-- | constructs a default EMS-RESTConfig
--
-- configHost:
--
...
-- @"ems---rest/0.1.0.0"@
--
newConfig :: IO EMS-RESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ EMS-RESTConfig
        { configHost = "https://ems-gateway-aws-eu-central-1-dev.coinapi.io"
        , configUserAgent = "ems---rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => EMS-RESTConfig -> auth -> EMS-RESTConfig
addAuthMethod config@EMS-RESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: EMS-RESTConfig -> IO EMS-RESTConfig
...
withStderrLogging :: EMS-RESTConfig -> IO EMS-RESTConfig
...
withNoLogging :: EMS-RESTConfig -> EMS-RESTConfig
...
data EMS-RESTRequest req contentType res accept = EMS-RESTRequest
  { rMethod  :: NH.Method   -- ^ Method of EMS-RESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of EMS-RESTRequest
  , rParams   :: Params -- ^ params of EMS-RESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (EMS-RESTRequest req contentType res accept) NH.Method
rMethodL f EMS-RESTRequest{..} = (\rMethod -> EMS-RESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (EMS-RESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f EMS-RESTRequest{..} = (\rUrlPath -> EMS-RESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (EMS-RESTRequest req contentType res accept) Params
rParamsL f EMS-RESTRequest{..} = (\rParams -> EMS-RESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (EMS-RESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f EMS-RESTRequest{..} = (\rAuthTypes -> EMS-RESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => EMS-RESTRequest req contentType res accept -> param -> EMS-RESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: EMS-RESTRequest req contentType res accept -> param -> EMS-RESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: EMS-RESTRequest req contentType res accept -> param -> EMS-RESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** EMS-RESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> EMS-RESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = EMS-RESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     EMS-RESTRequest req contentType res accept
  -> [NH.Header]
  -> EMS-RESTRequest req contentType res accept
...
removeHeader :: EMS-RESTRequest req contentType res accept -> [NH.HeaderName] -> EMS-RESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => EMS-RESTRequest req contentType res accept -> EMS-RESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => EMS-RESTRequest req contentType res accept -> EMS-RESTRequest req contentType res accept
...
addForm :: EMS-RESTRequest req contentType res accept -> WH.Form -> EMS-RESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: EMS-RESTRequest req contentType res accept -> NH.Part -> EMS-RESTRequest req contentType res accept
...
_setBodyBS :: EMS-RESTRequest req contentType res accept -> B.ByteString -> EMS-RESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: EMS-RESTRequest req contentType res accept -> BL.ByteString -> EMS-RESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => EMS-RESTRequest req contentType res accept -> P.Proxy authMethod -> EMS-RESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> EMS-RESTRequest req contentType res accept
    -> IO (EMS-RESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> EMS-RESTConfig
  -> IO (EMS-RESTRequest req contentType res accept)
_applyAuthMethods req config@(EMS-RESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
