# openapi.model.CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO
...
**dailyVolumeByTokenAmount** | **List<String>** |  | [optional] [default to const []]
**dailyVolumeByTokenUsd** | **List<String>** | All trade volume occurred in a given day for a specific input token, in native amount. The ordering should be the same as the pool's 'inputTokens' field. | [optional] [default to const []]
