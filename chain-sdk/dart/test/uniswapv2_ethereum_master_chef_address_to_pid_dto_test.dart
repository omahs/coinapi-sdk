...
// tests for UNISWAPV2ETHEREUMMasterChefAddressToPidDTO
void main() {
  // final instance = UNISWAPV2ETHEREUMMasterChefAddressToPidDTO();

  group('test UNISWAPV2ETHEREUMMasterChefAddressToPidDTO', () {
    // DateTime entryTime
