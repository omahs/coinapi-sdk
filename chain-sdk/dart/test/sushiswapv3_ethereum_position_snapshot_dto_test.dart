...
// tests for SUSHISWAPV3ETHEREUMPositionSnapshotDTO
void main() {
  // final instance = SUSHISWAPV3ETHEREUMPositionSnapshotDTO();

  group('test SUSHISWAPV3ETHEREUMPositionSnapshotDTO', () {
    // DateTime entryTime
