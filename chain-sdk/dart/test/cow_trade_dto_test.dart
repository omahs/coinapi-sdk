...
// tests for CowTradeDTO
void main() {
  // final instance = CowTradeDTO();

  group('test CowTradeDTO', () {
    // DateTime entryTime
    ...
    // Buy amount.
    // String buyAmount
    test('to test the property `buyAmount`', () async {
      // TODO
    });

    // Sell amount.
    // String sellAmount
    test('to test the property `sellAmount`', () async {
      // TODO
    });
