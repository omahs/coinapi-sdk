...
// tests for PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO
void main() {
  // final instance = PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO();

  group('test PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO', () {
    // DateTime entryTime
