...
// tests for PANCAKESWAPV3ETHEREUMPositionSnapshotDTO
void main() {
  // final instance = PANCAKESWAPV3ETHEREUMPositionSnapshotDTO();

  group('test PANCAKESWAPV3ETHEREUMPositionSnapshotDTO', () {
    // DateTime entryTime
    ...
    // List<String> cumulativeDepositTokenAmounts (default value: const [])
    ...
    // List<String> cumulativeWithdrawTokenAmounts (default value: const [])
    ...
    // List<String> cumulativeRewardTokenAmounts (default value: const [])
    test('to test the property `cumulativeRewardTokenAmounts`', () async {
      // TODO
    });

    // Total reward token accumulated under this position, in USD
    // List<String> cumulativeRewardUsd (default value: const [])
