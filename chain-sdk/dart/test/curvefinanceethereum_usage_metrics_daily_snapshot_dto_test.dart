...
// tests for CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
void main() {
  // final instance = CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO();

  group('test CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO', () {
    // DateTime entryTime
