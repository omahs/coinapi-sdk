...
// tests for PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
void main() {
  // final instance = PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO();

  group('test PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO', () {
    // DateTime entryTime
    ...
    // 
    // List<String> tokenPrices (default value: const [])
