...
// tests for PANCAKESWAPV3ETHEREUMWithdrawDTO
void main() {
  // final instance = PANCAKESWAPV3ETHEREUMWithdrawDTO();

  group('test PANCAKESWAPV3ETHEREUMWithdrawDTO', () {
    // DateTime entryTime
    ...
    // List<String> inputTokenAmounts (default value: const [])
