...
class CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO {
  /// Returns a new [CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO &&
  ...
  /// Returns a new [CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO-objects as value to a dart map
  static Map<String, List<CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
