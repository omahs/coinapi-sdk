...
class UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO {
  /// Returns a new [UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO &&
  ...
  @override
  String toString() => 'UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, blockRange=$blockRange, id=$id, protocol=$protocol, hourlyActiveUsers=$hourlyActiveUsers, cumulativeUniqueUsers=$cumulativeUniqueUsers, hourlyTransactionCount=$hourlyTransactionCount, hourlyDepositCount=$hourlyDepositCount, hourlyWithdrawCount=$hourlyWithdrawCount, hourlySwapCount=$hourlySwapCount, timestamp=$timestamp]';
  ...
  /// Returns a new [UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO-objects as value to a dart map
  static Map<String, List<UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
