...
class SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
  /// Returns a new [SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO &&
  ...
  @override
  String toString() => 'SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, id=$id, day=$day, protocol=$protocol, dailyActiveUsers=$dailyActiveUsers, cumulativeUniqueUsers=$cumulativeUniqueUsers, dailyTransactionCount=$dailyTransactionCount, totalPoolCount=$totalPoolCount, dailyDepositCount=$dailyDepositCount, dailyWithdrawCount=$dailyWithdrawCount, dailySwapCount=$dailySwapCount, timestamp=$timestamp]';
  ...
  /// Returns a new [SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO-objects as value to a dart map
  static Map<String, List<SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
