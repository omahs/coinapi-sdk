...
class SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO {
  /// Returns a new [SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO &&
  ...
  /// Returns a new [SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO-objects as value to a dart map
  static Map<String, List<SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
