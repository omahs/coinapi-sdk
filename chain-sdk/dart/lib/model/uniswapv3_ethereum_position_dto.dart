...
class UNISWAPV3ETHEREUMPositionDTO {
  /// Returns a new [UNISWAPV3ETHEREUMPositionDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UNISWAPV3ETHEREUMPositionDTO &&
  ...
  /// Returns a new [UNISWAPV3ETHEREUMPositionDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UNISWAPV3ETHEREUMPositionDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UNISWAPV3ETHEREUMPositionDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UNISWAPV3ETHEREUMPositionDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UNISWAPV3ETHEREUMPositionDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UNISWAPV3ETHEREUMPositionDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UNISWAPV3ETHEREUMPositionDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UNISWAPV3ETHEREUMPositionDTO> mapFromJson(dynamic json) {
    final map = <String, UNISWAPV3ETHEREUMPositionDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UNISWAPV3ETHEREUMPositionDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UNISWAPV3ETHEREUMPositionDTO-objects as value to a dart map
  static Map<String, List<UNISWAPV3ETHEREUMPositionDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UNISWAPV3ETHEREUMPositionDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UNISWAPV3ETHEREUMPositionDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
