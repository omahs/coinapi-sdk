...
class CURVEFINANCEETHEREUMDexAmmProtocolDTO {
  /// Returns a new [CURVEFINANCEETHEREUMDexAmmProtocolDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CURVEFINANCEETHEREUMDexAmmProtocolDTO &&
  ...
  int get hashCode =>
    ...
    (poolIds == null ? 0 : poolIds!.hashCode);

  @override
  String toString() => 'CURVEFINANCEETHEREUMDexAmmProtocolDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, blockRange=$blockRange, id=$id, name=$name, slug=$slug, schemaVersion=$schemaVersion, subgraphVersion=$subgraphVersion, methodologyVersion=$methodologyVersion, totalValueLockedUsd=$totalValueLockedUsd, protocolControlledValueUsd=$protocolControlledValueUsd, cumulativeVolumeUsd=$cumulativeVolumeUsd, cumulativeSupplySideRevenueUsd=$cumulativeSupplySideRevenueUsd, cumulativeProtocolSideRevenueUsd=$cumulativeProtocolSideRevenueUsd, cumulativeTotalRevenueUsd=$cumulativeTotalRevenueUsd, cumulativeUniqueUsers=$cumulativeUniqueUsers, totalPoolCount=$totalPoolCount, poolIds=$poolIds]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.poolIds != null) {
      json[r'pool_ids'] = this.poolIds;
    } else {
      json[r'pool_ids'] = null;
    }
    return json;
  }

  /// Returns a new [CURVEFINANCEETHEREUMDexAmmProtocolDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CURVEFINANCEETHEREUMDexAmmProtocolDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CURVEFINANCEETHEREUMDexAmmProtocolDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CURVEFINANCEETHEREUMDexAmmProtocolDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CURVEFINANCEETHEREUMDexAmmProtocolDTO(
        ...
        poolIds: json[r'pool_ids'] is List
            ? (json[r'pool_ids'] as List).cast<String>()
            : const [],
      );
    }
    return null;
  ...
  static List<CURVEFINANCEETHEREUMDexAmmProtocolDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CURVEFINANCEETHEREUMDexAmmProtocolDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CURVEFINANCEETHEREUMDexAmmProtocolDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CURVEFINANCEETHEREUMDexAmmProtocolDTO> mapFromJson(dynamic json) {
    final map = <String, CURVEFINANCEETHEREUMDexAmmProtocolDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CURVEFINANCEETHEREUMDexAmmProtocolDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CURVEFINANCEETHEREUMDexAmmProtocolDTO-objects as value to a dart map
  static Map<String, List<CURVEFINANCEETHEREUMDexAmmProtocolDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CURVEFINANCEETHEREUMDexAmmProtocolDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CURVEFINANCEETHEREUMDexAmmProtocolDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
