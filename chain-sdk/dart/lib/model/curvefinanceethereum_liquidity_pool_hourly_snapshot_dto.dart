...
class CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO {
  /// Returns a new [CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO &&
  ...
  /// Returns a new [CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO-objects as value to a dart map
  static Map<String, List<CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
