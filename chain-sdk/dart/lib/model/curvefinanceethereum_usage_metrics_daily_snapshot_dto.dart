...
class CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO {
  /// Returns a new [CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO &&
  ...
  @override
  String toString() => 'CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, id=$id, protocol=$protocol, dailyActiveUsers=$dailyActiveUsers, cumulativeUniqueUsers=$cumulativeUniqueUsers, dailyTransactionCount=$dailyTransactionCount, dailyDepositCount=$dailyDepositCount, dailyWithdrawCount=$dailyWithdrawCount, dailySwapCount=$dailySwapCount, totalPoolCount=$totalPoolCount, timestamp=$timestamp]';
  ...
  /// Returns a new [CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO-objects as value to a dart map
  static Map<String, List<CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
