...
class UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO {
  /// Returns a new [UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO &&
  ...
  @override
  String toString() => 'UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, blockRange=$blockRange, id=$id, protocol=$protocol, pool=$pool, timestamp=$timestamp, totalValueLockedUsd=$totalValueLockedUsd, cumulativeSupplySideRevenueUsd=$cumulativeSupplySideRevenueUsd, dailySupplySideRevenueUsd=$dailySupplySideRevenueUsd, cumulativeProtocolSideRevenueUsd=$cumulativeProtocolSideRevenueUsd, dailyProtocolSideRevenueUsd=$dailyProtocolSideRevenueUsd, cumulativeTotalRevenueUsd=$cumulativeTotalRevenueUsd, dailyTotalRevenueUsd=$dailyTotalRevenueUsd, dailyVolumeUsd=$dailyVolumeUsd, dailyVolumeByTokenAmount=$dailyVolumeByTokenAmount, dailyVolumeByTokenUsd=$dailyVolumeByTokenUsd, cumulativeVolumeUsd=$cumulativeVolumeUsd, inputTokenBalances=$inputTokenBalances, inputTokenWeights=$inputTokenWeights, outputTokenSupply=$outputTokenSupply, outputTokenPriceUsd=$outputTokenPriceUsd, stakedOutputTokenAmount=$stakedOutputTokenAmount, rewardTokenEmissionsAmount=$rewardTokenEmissionsAmount, rewardTokenEmissionsUsd=$rewardTokenEmissionsUsd]';
  ...
  /// Returns a new [UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO-objects as value to a dart map
  static Map<String, List<UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
