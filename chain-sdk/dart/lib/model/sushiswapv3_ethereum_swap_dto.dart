...
class SUSHISWAPV3ETHEREUMSwapDTO {
  /// Returns a new [SUSHISWAPV3ETHEREUMSwapDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SUSHISWAPV3ETHEREUMSwapDTO &&
  ...
  /// Returns a new [SUSHISWAPV3ETHEREUMSwapDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SUSHISWAPV3ETHEREUMSwapDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SUSHISWAPV3ETHEREUMSwapDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SUSHISWAPV3ETHEREUMSwapDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SUSHISWAPV3ETHEREUMSwapDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SUSHISWAPV3ETHEREUMSwapDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SUSHISWAPV3ETHEREUMSwapDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SUSHISWAPV3ETHEREUMSwapDTO> mapFromJson(dynamic json) {
    final map = <String, SUSHISWAPV3ETHEREUMSwapDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SUSHISWAPV3ETHEREUMSwapDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SUSHISWAPV3ETHEREUMSwapDTO-objects as value to a dart map
  static Map<String, List<SUSHISWAPV3ETHEREUMSwapDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SUSHISWAPV3ETHEREUMSwapDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SUSHISWAPV3ETHEREUMSwapDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
