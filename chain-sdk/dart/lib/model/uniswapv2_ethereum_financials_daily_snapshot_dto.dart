...
class UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO {
  /// Returns a new [UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO &&
  ...
  @override
  String toString() => 'UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, blockRange=$blockRange, id=$id, protocol=$protocol, totalValueLockedUsd=$totalValueLockedUsd, protocolControlledValueUsd=$protocolControlledValueUsd, dailyVolumeUsd=$dailyVolumeUsd, cumulativeVolumeUsd=$cumulativeVolumeUsd, dailySupplySideRevenueUsd=$dailySupplySideRevenueUsd, cumulativeSupplySideRevenueUsd=$cumulativeSupplySideRevenueUsd, dailyProtocolSideRevenueUsd=$dailyProtocolSideRevenueUsd, cumulativeProtocolSideRevenueUsd=$cumulativeProtocolSideRevenueUsd, dailyTotalRevenueUsd=$dailyTotalRevenueUsd, cumulativeTotalRevenueUsd=$cumulativeTotalRevenueUsd, timestamp=$timestamp]';
  ...
  /// Returns a new [UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO-objects as value to a dart map
  static Map<String, List<UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
