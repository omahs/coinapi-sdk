...
class CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO {
  /// Returns a new [CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO &&
  ...
  @override
  String toString() => 'CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, blockRange=$blockRange, id=$id, protocol=$protocol, hourlyActiveUsers=$hourlyActiveUsers, cumulativeUniqueUsers=$cumulativeUniqueUsers, hourlyTransactionCount=$hourlyTransactionCount, hourlyDepositCount=$hourlyDepositCount, hourlyWithdrawCount=$hourlyWithdrawCount, hourlySwapCount=$hourlySwapCount, timestamp=$timestamp]';
  ...
  /// Returns a new [CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO-objects as value to a dart map
  static Map<String, List<CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
