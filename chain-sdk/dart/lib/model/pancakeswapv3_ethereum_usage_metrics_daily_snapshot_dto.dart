...
class PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
  /// Returns a new [PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO &&
  ...
  @override
  String toString() => 'PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, id=$id, day=$day, protocol=$protocol, dailyActiveUsers=$dailyActiveUsers, cumulativeUniqueUsers=$cumulativeUniqueUsers, dailyTransactionCount=$dailyTransactionCount, totalPoolCount=$totalPoolCount, dailyDepositCount=$dailyDepositCount, dailyWithdrawCount=$dailyWithdrawCount, dailySwapCount=$dailySwapCount, timestamp=$timestamp]';
  ...
  /// Returns a new [PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO-objects as value to a dart map
  static Map<String, List<PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
