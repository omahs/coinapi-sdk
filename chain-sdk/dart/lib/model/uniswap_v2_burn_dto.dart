...
class UniswapV2BurnDTO {
  /// Returns a new [UniswapV2BurnDTO] instance.
  UniswapV2BurnDTO({
    this.entryTime,
    this.recvTime,
    this.blockNumber,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UniswapV2BurnDTO &&
     ...
     other.needsComplete == needsComplete &&
     other.feeTo == feeTo &&
  ...
  int get hashCode =>
    ...
    (needsComplete == null ? 0 : needsComplete!.hashCode) +
    (feeTo == null ? 0 : feeTo!.hashCode) +
    (feeLiquidity == null ? 0 : feeLiquidity!.hashCode) +
    (vid == null ? 0 : vid!.hashCode);

  @override
  String toString() => 'UniswapV2BurnDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, id=$id, transaction=$transaction, timestamp=$timestamp, pair=$pair, liquidity=$liquidity, sender=$sender, amount0=$amount0, amount1=$amount1, to=$to, logIndex=$logIndex, amountUsd=$amountUsd, needsComplete=$needsComplete, feeTo=$feeTo, feeLiquidity=$feeLiquidity, vid=$vid]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.needsComplete != null) {
      json[r'needs_complete'] = this.needsComplete;
    } else {
      json[r'needs_complete'] = null;
    }
    if (this.feeTo != null) {
  ...
  /// Returns a new [UniswapV2BurnDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UniswapV2BurnDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UniswapV2BurnDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UniswapV2BurnDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return UniswapV2BurnDTO(
        ...
        needsComplete: mapValueOfType<bool>(json, r'needs_complete'),
  ...
  static List<UniswapV2BurnDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UniswapV2BurnDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UniswapV2BurnDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UniswapV2BurnDTO> mapFromJson(dynamic json) {
    final map = <String, UniswapV2BurnDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UniswapV2BurnDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UniswapV2BurnDTO-objects as value to a dart map
  static Map<String, List<UniswapV2BurnDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UniswapV2BurnDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UniswapV2BurnDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
