...
class SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
  /// Returns a new [SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO &&
  ...
  @override
  String toString() => 'SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, id=$id, hour=$hour, protocol=$protocol, hourlyActiveUsers=$hourlyActiveUsers, cumulativeUniqueUsers=$cumulativeUniqueUsers, hourlyTransactionCount=$hourlyTransactionCount, hourlyDepositCount=$hourlyDepositCount, hourlyWithdrawCount=$hourlyWithdrawCount, hourlySwapCount=$hourlySwapCount, timestamp=$timestamp]';
  ...
  /// Returns a new [SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO-objects as value to a dart map
  static Map<String, List<SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
