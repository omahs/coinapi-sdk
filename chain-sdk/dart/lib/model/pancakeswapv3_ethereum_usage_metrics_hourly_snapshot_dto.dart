...
class PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
  /// Returns a new [PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO &&
  ...
  @override
  String toString() => 'PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, id=$id, hour=$hour, protocol=$protocol, hourlyActiveUsers=$hourlyActiveUsers, cumulativeUniqueUsers=$cumulativeUniqueUsers, hourlyTransactionCount=$hourlyTransactionCount, hourlyDepositCount=$hourlyDepositCount, hourlyWithdrawCount=$hourlyWithdrawCount, hourlySwapCount=$hourlySwapCount, timestamp=$timestamp]';
  ...
  /// Returns a new [PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO-objects as value to a dart map
  static Map<String, List<PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
