...
class UNISWAPV2ETHEREUMSwapDTO {
  /// Returns a new [UNISWAPV2ETHEREUMSwapDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UNISWAPV2ETHEREUMSwapDTO &&
  ...
  @override
  String toString() => 'UNISWAPV2ETHEREUMSwapDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, block=$block, id=$id, hash=$hash, logIndex=$logIndex, protocol=$protocol, to=$to, from=$from, timestamp=$timestamp, tokenIn=$tokenIn, amountIn=$amountIn, amountInUsd=$amountInUsd, tokenOut=$tokenOut, amountOut=$amountOut, amountOutUsd=$amountOutUsd, reserveAmounts=$reserveAmounts, pool=$pool, blockRange=$blockRange, poolId=$poolId, transactionId=$transactionId, evaluatedPrice=$evaluatedPrice, evaluatedAmount=$evaluatedAmount, evaluatedAggressor=$evaluatedAggressor]';
  ...
  /// Returns a new [UNISWAPV2ETHEREUMSwapDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UNISWAPV2ETHEREUMSwapDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UNISWAPV2ETHEREUMSwapDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UNISWAPV2ETHEREUMSwapDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UNISWAPV2ETHEREUMSwapDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UNISWAPV2ETHEREUMSwapDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UNISWAPV2ETHEREUMSwapDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UNISWAPV2ETHEREUMSwapDTO> mapFromJson(dynamic json) {
    final map = <String, UNISWAPV2ETHEREUMSwapDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UNISWAPV2ETHEREUMSwapDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UNISWAPV2ETHEREUMSwapDTO-objects as value to a dart map
  static Map<String, List<UNISWAPV2ETHEREUMSwapDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UNISWAPV2ETHEREUMSwapDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UNISWAPV2ETHEREUMSwapDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
