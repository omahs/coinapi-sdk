...
class PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO {
  ...
  @override
  String toString() => 'PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, id=$id, hourId=$hourId, tick=$tick, pool=$pool, liquidityGross=$liquidityGross, liquidityGrossUsd=$liquidityGrossUsd, liquidityNet=$liquidityNet, liquidityNetUsd=$liquidityNetUsd, timestamp=$timestamp]';
