...
class PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO {
  /// Returns a new [PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO &&
  ...
  @override
  String toString() => 'PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, vid=$vid, id=$id, hourId=$hourId, tick=$tick, pool=$pool, liquidityGross=$liquidityGross, liquidityGrossUsd=$liquidityGrossUsd, liquidityNet=$liquidityNet, liquidityNetUsd=$liquidityNetUsd, timestamp=$timestamp]';
  ...
  /// Returns a new [PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO-objects as value to a dart map
  static Map<String, List<PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
