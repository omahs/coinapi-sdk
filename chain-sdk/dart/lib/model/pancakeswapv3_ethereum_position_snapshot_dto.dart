...
class PANCAKESWAPV3ETHEREUMPositionSnapshotDTO {
  /// Returns a new [PANCAKESWAPV3ETHEREUMPositionSnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PANCAKESWAPV3ETHEREUMPositionSnapshotDTO &&
  ...
  /// Returns a new [PANCAKESWAPV3ETHEREUMPositionSnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PANCAKESWAPV3ETHEREUMPositionSnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PANCAKESWAPV3ETHEREUMPositionSnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PANCAKESWAPV3ETHEREUMPositionSnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PANCAKESWAPV3ETHEREUMPositionSnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PANCAKESWAPV3ETHEREUMPositionSnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PANCAKESWAPV3ETHEREUMPositionSnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PANCAKESWAPV3ETHEREUMPositionSnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, PANCAKESWAPV3ETHEREUMPositionSnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PANCAKESWAPV3ETHEREUMPositionSnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PANCAKESWAPV3ETHEREUMPositionSnapshotDTO-objects as value to a dart map
  static Map<String, List<PANCAKESWAPV3ETHEREUMPositionSnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PANCAKESWAPV3ETHEREUMPositionSnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PANCAKESWAPV3ETHEREUMPositionSnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
