...
class SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO {
  /// Returns a new [SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO &&
  ...
  /// Returns a new [SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO-objects as value to a dart map
  static Map<String, List<SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
