...
class UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO {
  /// Returns a new [UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO &&
  ...
  @override
  String toString() => 'UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO[entryTime=$entryTime, recvTime=$recvTime, blockNumber=$blockNumber, blockRange=$blockRange, id=$id, protocol=$protocol, dailyActiveUsers=$dailyActiveUsers, cumulativeUniqueUsers=$cumulativeUniqueUsers, dailyTransactionCount=$dailyTransactionCount, dailyDepositCount=$dailyDepositCount, dailyWithdrawCount=$dailyWithdrawCount, dailySwapCount=$dailySwapCount, totalPoolCount=$totalPoolCount, timestamp=$timestamp]';
  ...
  /// Returns a new [UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO> mapFromJson(dynamic json) {
    final map = <String, UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO-objects as value to a dart map
  static Map<String, List<UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
