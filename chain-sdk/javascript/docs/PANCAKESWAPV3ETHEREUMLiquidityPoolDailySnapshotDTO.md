# OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO
...
**vid** | **Number** | . | [optional] 
**block** | **Number** | The Ethereum block number associated with the liquidity pool daily snapshot. | [optional] 
