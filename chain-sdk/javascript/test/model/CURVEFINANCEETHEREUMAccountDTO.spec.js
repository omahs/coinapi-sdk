...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMAccountDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMAccountDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMAccountDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMAccountDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMAccountDTO);
    });
