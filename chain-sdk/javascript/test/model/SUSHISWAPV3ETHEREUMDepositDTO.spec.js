...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMDepositDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMDepositDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMDepositDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMDepositDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMDepositDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMDepositDTO);
    });
