...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolAmountDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMLiquidityPoolAmountDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMLiquidityPoolAmountDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMLiquidityPoolAmountDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolAmountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolAmountDTO);
    });
