...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMTokenDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMTokenDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMTokenDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenDTO);
    });
    ...
    it('should have the property lastPriceUsd (base name: "last_price_usd")', function() {
      // uncomment below and update the code to test the property lastPriceUsd
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenDTO();
      //expect(instance).to.be();
    });

    it('should have the property lastPriceBlockNumber (base name: "last_price_block_number")', function() {
      // uncomment below and update the code to test the property lastPriceBlockNumber
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenDTO();
      //expect(instance).to.be();
    });

    it('should have the property lastPricePool (base name: "last_price_pool")', function() {
      // uncomment below and update the code to test the property lastPricePool
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property largePriceChangeBuffer (base name: "large_price_change_buffer")', function() {
      // uncomment below and update the code to test the property largePriceChangeBuffer
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenDTO();
      //expect(instance).to.be();
    });

    it('should have the property largeTvlImpactBuffer (base name: "large_tvl_impact_buffer")', function() {
      // uncomment below and update the code to test the property largeTvlImpactBuffer
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenDTO();
      //expect(instance).to.be();
    });
