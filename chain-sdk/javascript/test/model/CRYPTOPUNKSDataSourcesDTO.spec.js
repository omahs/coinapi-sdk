...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CRYPTOPUNKSDataSourcesDTO();
  });
  ...
  describe('CRYPTOPUNKSDataSourcesDTO', function() {
    it('should create an instance of CRYPTOPUNKSDataSourcesDTO', function() {
      // uncomment below and update the code to test CRYPTOPUNKSDataSourcesDTO
      //var instance = new OnChainDappsRestApi.CRYPTOPUNKSDataSourcesDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CRYPTOPUNKSDataSourcesDTO);
    });
    ...
    it('should have the property causalityRegion (base name: "causality_region")', function() {
      // uncomment below and update the code to test the property causalityRegion
      //var instance = new OnChainDappsRestApi.CRYPTOPUNKSDataSourcesDTO();
      //expect(instance).to.be();
    });

    it('should have the property manifestIdx (base name: "manifest_idx")', function() {
      // uncomment below and update the code to test the property manifestIdx
      //var instance = new OnChainDappsRestApi.CRYPTOPUNKSDataSourcesDTO();
      //expect(instance).to.be();
    });
