...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickDailySnapshotDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMTickDailySnapshotDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMTickDailySnapshotDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickDailySnapshotDTO);
    });
