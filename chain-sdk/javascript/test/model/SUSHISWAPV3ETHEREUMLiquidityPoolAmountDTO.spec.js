...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO);
    });
