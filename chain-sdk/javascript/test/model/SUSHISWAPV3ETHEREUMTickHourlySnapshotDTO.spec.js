...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO);
    });
