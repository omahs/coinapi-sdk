...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO);
    });
