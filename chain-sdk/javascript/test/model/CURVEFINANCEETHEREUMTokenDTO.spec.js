...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMTokenDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMTokenDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMTokenDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMTokenDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMTokenDTO);
    });
