...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CRYPTOPUNKSUserDTO();
  });
  ...
  describe('CRYPTOPUNKSUserDTO', function() {
    it('should create an instance of CRYPTOPUNKSUserDTO', function() {
      // uncomment below and update the code to test CRYPTOPUNKSUserDTO
      //var instance = new OnChainDappsRestApi.CRYPTOPUNKSUserDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CRYPTOPUNKSUserDTO);
    });
