...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolAmountDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMLiquidityPoolAmountDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMLiquidityPoolAmountDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMLiquidityPoolAmountDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolAmountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolAmountDTO);
    });
