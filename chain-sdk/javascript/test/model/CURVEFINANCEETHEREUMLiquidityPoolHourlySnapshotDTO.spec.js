...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO);
    });
