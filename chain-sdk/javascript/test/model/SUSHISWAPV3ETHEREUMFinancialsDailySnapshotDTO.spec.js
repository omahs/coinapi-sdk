...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO);
    });
