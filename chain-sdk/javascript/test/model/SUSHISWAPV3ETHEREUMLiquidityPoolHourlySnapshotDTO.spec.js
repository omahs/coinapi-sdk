...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO);
    });
