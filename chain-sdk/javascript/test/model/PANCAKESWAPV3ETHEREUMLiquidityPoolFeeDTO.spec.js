...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO);
    });
    ...
    it('should have the property feePercentage (base name: "fee_percentage")', function() {
      // uncomment below and update the code to test the property feePercentage
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO();
      //expect(instance).to.be();
    });
