...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMAccountDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMAccountDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMAccountDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMAccountDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMAccountDTO);
    });
