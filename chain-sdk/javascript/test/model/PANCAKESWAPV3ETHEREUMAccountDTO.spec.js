...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMAccountDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMAccountDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMAccountDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMAccountDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMAccountDTO);
    });
    ...
    it('should have the property swapCount (base name: "swap_count")', function() {
      // uncomment below and update the code to test the property swapCount
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMAccountDTO();
      //expect(instance).to.be();
    });
