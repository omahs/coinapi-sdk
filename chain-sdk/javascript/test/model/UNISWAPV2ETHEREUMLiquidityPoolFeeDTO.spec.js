...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolFeeDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMLiquidityPoolFeeDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMLiquidityPoolFeeDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMLiquidityPoolFeeDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolFeeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolFeeDTO);
    });
