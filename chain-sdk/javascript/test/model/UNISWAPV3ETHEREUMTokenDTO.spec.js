...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTokenDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMTokenDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMTokenDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMTokenDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMTokenDTO);
    });
