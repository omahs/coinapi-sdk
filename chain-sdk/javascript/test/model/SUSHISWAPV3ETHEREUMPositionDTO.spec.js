...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMPositionDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMPositionDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMPositionDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMPositionDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMPositionDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMPositionDTO);
    });
