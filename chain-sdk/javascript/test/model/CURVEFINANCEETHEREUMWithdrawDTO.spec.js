...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMWithdrawDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMWithdrawDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMWithdrawDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMWithdrawDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMWithdrawDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMWithdrawDTO);
    });
    ...
    it('should have the property outputTokenAmount (base name: "output_token_amount")', function() {
      // uncomment below and update the code to test the property outputTokenAmount
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMWithdrawDTO();
      //expect(instance).to.be();
    });
