...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO);
    });
