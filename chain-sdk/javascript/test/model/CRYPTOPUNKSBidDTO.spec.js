...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CRYPTOPUNKSBidDTO();
  });
  ...
  describe('CRYPTOPUNKSBidDTO', function() {
    it('should create an instance of CRYPTOPUNKSBidDTO', function() {
      // uncomment below and update the code to test CRYPTOPUNKSBidDTO
      //var instance = new OnChainDappsRestApi.CRYPTOPUNKSBidDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CRYPTOPUNKSBidDTO);
    });
    ...
    it('should have the property tokensBid (base name: "tokens_bid")', function() {
      // uncomment below and update the code to test the property tokensBid
      //var instance = new OnChainDappsRestApi.CRYPTOPUNKSBidDTO();
      //expect(instance).to.be();
    });
