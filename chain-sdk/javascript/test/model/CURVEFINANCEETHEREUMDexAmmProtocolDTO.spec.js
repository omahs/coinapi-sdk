...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMDexAmmProtocolDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMDexAmmProtocolDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMDexAmmProtocolDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMDexAmmProtocolDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMDexAmmProtocolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMDexAmmProtocolDTO);
    });
    ...
    it('should have the property poolIds (base name: "pool_ids")', function() {
