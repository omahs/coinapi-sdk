...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO);
    });
