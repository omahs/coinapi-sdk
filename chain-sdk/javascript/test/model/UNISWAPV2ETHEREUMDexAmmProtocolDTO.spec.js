...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMDexAmmProtocolDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMDexAmmProtocolDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMDexAmmProtocolDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMDexAmmProtocolDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMDexAmmProtocolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMDexAmmProtocolDTO);
    });
