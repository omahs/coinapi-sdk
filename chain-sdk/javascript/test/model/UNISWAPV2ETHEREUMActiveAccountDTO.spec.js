...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMActiveAccountDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMActiveAccountDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMActiveAccountDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMActiveAccountDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMActiveAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMActiveAccountDTO);
    });
