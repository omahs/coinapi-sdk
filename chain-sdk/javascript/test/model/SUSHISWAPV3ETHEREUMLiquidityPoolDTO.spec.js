...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMLiquidityPoolDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMLiquidityPoolDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMLiquidityPoolDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolDTO);
    });
