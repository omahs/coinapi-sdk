...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolFeeDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMLiquidityPoolFeeDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMLiquidityPoolFeeDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMLiquidityPoolFeeDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolFeeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolFeeDTO);
    });
