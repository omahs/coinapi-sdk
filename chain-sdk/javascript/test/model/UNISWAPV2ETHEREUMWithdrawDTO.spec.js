...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMWithdrawDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMWithdrawDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMWithdrawDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMWithdrawDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMWithdrawDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMWithdrawDTO);
    });
