...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTickDailySnapshotDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMTickDailySnapshotDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMTickDailySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMTickDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTickDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMTickDailySnapshotDTO);
    });
