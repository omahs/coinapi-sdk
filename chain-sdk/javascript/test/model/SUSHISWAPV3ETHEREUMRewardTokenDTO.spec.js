...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMRewardTokenDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMRewardTokenDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMRewardTokenDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMRewardTokenDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMRewardTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMRewardTokenDTO);
    });
