...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolFeeDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMLiquidityPoolFeeDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMLiquidityPoolFeeDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMLiquidityPoolFeeDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolFeeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolFeeDTO);
    });
