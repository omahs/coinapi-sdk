...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMDepositDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMDepositDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMDepositDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMDepositDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMDepositDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMDepositDTO);
    });
