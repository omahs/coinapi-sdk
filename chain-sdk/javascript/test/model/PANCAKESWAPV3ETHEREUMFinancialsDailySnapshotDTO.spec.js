...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO);
    });
