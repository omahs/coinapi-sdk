...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMRewarderProbeDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMRewarderProbeDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMRewarderProbeDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMRewarderProbeDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMRewarderProbeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMRewarderProbeDTO);
    });
    ...
    it('should have the property blockNum (base name: "block_num")', function() {
      // uncomment below and update the code to test the property blockNum
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMRewarderProbeDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lpStaked (base name: "lp_staked")', function() {
      // uncomment below and update the code to test the property lpStaked
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMRewarderProbeDTO();
      //expect(instance).to.be();
    });
