...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CRYPTOPUNKSItemDTO();
  });
  ...
  describe('CRYPTOPUNKSItemDTO', function() {
    it('should create an instance of CRYPTOPUNKSItemDTO', function() {
      // uncomment below and update the code to test CRYPTOPUNKSItemDTO
      //var instance = new OnChainDappsRestApi.CRYPTOPUNKSItemDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CRYPTOPUNKSItemDTO);
    });
