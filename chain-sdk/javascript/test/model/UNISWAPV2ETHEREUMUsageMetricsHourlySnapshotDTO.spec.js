...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO);
    });
