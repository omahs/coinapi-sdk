...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO);
    });
    ...
    it('should have the property tokenPrices (base name: "token_prices")', function() {
      // uncomment below and update the code to test the property tokenPrices
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO();
      //expect(instance).to.be();
    });
