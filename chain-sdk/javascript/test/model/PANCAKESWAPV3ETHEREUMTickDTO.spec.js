...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTickDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMTickDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMTickDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMTickDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTickDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTickDTO);
    });
