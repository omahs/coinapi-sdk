...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenWhiteListSymbolDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMTokenWhiteListSymbolDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMTokenWhiteListSymbolDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMTokenWhiteListSymbolDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenWhiteListSymbolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTokenWhiteListSymbolDTO);
    });
