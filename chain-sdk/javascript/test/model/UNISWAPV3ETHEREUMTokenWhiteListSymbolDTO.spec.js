...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO);
    });
