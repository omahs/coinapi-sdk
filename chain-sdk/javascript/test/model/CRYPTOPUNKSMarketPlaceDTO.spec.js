...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CRYPTOPUNKSMarketPlaceDTO();
  });
  ...
  describe('CRYPTOPUNKSMarketPlaceDTO', function() {
    it('should create an instance of CRYPTOPUNKSMarketPlaceDTO', function() {
      // uncomment below and update the code to test CRYPTOPUNKSMarketPlaceDTO
      //var instance = new OnChainDappsRestApi.CRYPTOPUNKSMarketPlaceDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CRYPTOPUNKSMarketPlaceDTO);
    });
