...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO);
    });
    ...
    it('should have the property hourId (base name: "hour_id")', function() {
      // uncomment below and update the code to test the property hourId
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO();
      //expect(instance).to.be();
    });
