...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMRewardTokenDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMRewardTokenDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMRewardTokenDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMRewardTokenDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMRewardTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMRewardTokenDTO);
    });
