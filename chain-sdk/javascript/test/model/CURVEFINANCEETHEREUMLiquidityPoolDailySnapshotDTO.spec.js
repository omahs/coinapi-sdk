...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO);
    });
