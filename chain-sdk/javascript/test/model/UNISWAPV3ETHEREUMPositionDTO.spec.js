...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMPositionDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMPositionDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMPositionDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMPositionDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMPositionDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMPositionDTO);
    });
