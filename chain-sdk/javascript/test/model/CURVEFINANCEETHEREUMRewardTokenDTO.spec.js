...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMRewardTokenDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMRewardTokenDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMRewardTokenDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMRewardTokenDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMRewardTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMRewardTokenDTO);
    });
