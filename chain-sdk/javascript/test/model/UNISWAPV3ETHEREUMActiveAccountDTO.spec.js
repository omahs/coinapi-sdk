...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMActiveAccountDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMActiveAccountDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMActiveAccountDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMActiveAccountDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMActiveAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMActiveAccountDTO);
    });
