...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO);
    });
