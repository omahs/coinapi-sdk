...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMRewardTokenDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMRewardTokenDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMRewardTokenDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMRewardTokenDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMRewardTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMRewardTokenDTO);
    });
