...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO);
    });
