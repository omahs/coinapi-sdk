...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMActiveAccountDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMActiveAccountDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMActiveAccountDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMActiveAccountDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMActiveAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMActiveAccountDTO);
    });
