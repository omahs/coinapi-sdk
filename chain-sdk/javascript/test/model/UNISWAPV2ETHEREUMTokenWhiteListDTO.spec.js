...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMTokenWhiteListDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMTokenWhiteListDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMTokenWhiteListDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMTokenWhiteListDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMTokenWhiteListDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMTokenWhiteListDTO);
    });
