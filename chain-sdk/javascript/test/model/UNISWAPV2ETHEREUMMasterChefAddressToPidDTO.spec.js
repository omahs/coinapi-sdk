...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefAddressToPidDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMMasterChefAddressToPidDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMMasterChefAddressToPidDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMMasterChefAddressToPidDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefAddressToPidDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefAddressToPidDTO);
    });
