...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMSwapDTO();
  });
  ...
  describe('PANCAKESWAPV3ETHEREUMSwapDTO', function() {
    it('should create an instance of PANCAKESWAPV3ETHEREUMSwapDTO', function() {
      // uncomment below and update the code to test PANCAKESWAPV3ETHEREUMSwapDTO
      //var instance = new OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMSwapDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.PANCAKESWAPV3ETHEREUMSwapDTO);
    });
