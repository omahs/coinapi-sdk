...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO);
    });
