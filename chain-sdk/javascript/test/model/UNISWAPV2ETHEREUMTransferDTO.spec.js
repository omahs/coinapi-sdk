...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMTransferDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMTransferDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMTransferDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMTransferDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMTransferDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMTransferDTO);
    });
