...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO);
    });
