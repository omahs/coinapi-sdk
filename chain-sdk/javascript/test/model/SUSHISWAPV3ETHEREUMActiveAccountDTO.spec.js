...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMActiveAccountDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMActiveAccountDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMActiveAccountDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMActiveAccountDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMActiveAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMActiveAccountDTO);
    });
