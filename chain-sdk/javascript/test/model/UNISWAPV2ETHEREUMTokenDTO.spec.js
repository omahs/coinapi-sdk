...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMTokenDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMTokenDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMTokenDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMTokenDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMTokenDTO);
    });
