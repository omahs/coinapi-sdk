...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMDexAmmProtocolDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMDexAmmProtocolDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMDexAmmProtocolDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMDexAmmProtocolDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMDexAmmProtocolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMDexAmmProtocolDTO);
    });
