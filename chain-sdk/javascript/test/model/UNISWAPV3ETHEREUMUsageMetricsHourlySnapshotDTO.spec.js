...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO);
    });
