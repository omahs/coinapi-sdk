...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTokenDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMTokenDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMTokenDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMTokenDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTokenDTO);
    });
