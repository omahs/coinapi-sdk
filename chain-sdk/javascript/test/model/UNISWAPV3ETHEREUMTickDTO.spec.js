...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTickDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMTickDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMTickDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMTickDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTickDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMTickDTO);
    });
