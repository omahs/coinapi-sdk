...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO);
    });
