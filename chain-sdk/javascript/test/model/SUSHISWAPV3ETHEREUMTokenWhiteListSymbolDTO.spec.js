...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTO);
    });
