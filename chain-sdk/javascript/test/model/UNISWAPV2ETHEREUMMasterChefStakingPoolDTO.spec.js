...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefStakingPoolDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMMasterChefStakingPoolDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMMasterChefStakingPoolDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMMasterChefStakingPoolDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefStakingPoolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefStakingPoolDTO);
    });
    ...
    it('should have the property poolAllocPoint (base name: "pool_alloc_point")', function() {
      // uncomment below and update the code to test the property poolAllocPoint
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefStakingPoolDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lastRewardBlock (base name: "last_reward_block")', function() {
      // uncomment below and update the code to test the property lastRewardBlock
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefStakingPoolDTO();
      //expect(instance).to.be();
    });

    it('should have the property rewarder (base name: "rewarder")', function() {
      // uncomment below and update the code to test the property rewarder
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMMasterChefStakingPoolDTO();
      //expect(instance).to.be();
    });
