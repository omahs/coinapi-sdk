...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMSwapDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMSwapDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMSwapDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMSwapDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMSwapDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMSwapDTO);
    });
