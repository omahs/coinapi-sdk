...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTickHourlySnapshotDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMTickHourlySnapshotDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMTickHourlySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMTickHourlySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMTickHourlySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMTickHourlySnapshotDTO);
    });
