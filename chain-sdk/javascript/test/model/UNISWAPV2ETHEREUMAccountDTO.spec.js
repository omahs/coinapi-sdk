...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMAccountDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMAccountDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMAccountDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMAccountDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMAccountDTO);
    });
