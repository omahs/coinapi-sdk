...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMLiquidityPoolDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMLiquidityPoolDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMLiquidityPoolDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolDTO);
    });
    ...
    it('should have the property inputTokensOrdered (base name: "input_tokens_ordered")', function() {
      // uncomment below and update the code to test the property inputTokensOrdered
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property gaugeAddress (base name: "gauge_address")', function() {
      // uncomment below and update the code to test the property gaugeAddress
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityPoolDTO();
      //expect(instance).to.be();
    });
