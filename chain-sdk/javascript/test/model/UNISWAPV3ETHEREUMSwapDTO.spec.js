...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMSwapDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMSwapDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMSwapDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMSwapDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMSwapDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMSwapDTO);
    });
