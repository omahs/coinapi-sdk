...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityGaugeDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMLiquidityGaugeDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMLiquidityGaugeDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMLiquidityGaugeDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityGaugeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMLiquidityGaugeDTO);
    });
