...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMAccountDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMAccountDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMAccountDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMAccountDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMAccountDTO);
    });
