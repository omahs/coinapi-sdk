...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO);
    });
