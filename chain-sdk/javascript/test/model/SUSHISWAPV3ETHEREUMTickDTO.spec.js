...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMTickDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMTickDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMTickDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMTickDTO);
    });
