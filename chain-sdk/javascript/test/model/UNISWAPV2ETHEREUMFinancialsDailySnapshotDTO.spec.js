...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO);
    });
