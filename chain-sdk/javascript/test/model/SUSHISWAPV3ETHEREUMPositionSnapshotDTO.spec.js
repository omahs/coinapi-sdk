...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMPositionSnapshotDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMPositionSnapshotDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMPositionSnapshotDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMPositionSnapshotDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMPositionSnapshotDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMPositionSnapshotDTO);
    });
