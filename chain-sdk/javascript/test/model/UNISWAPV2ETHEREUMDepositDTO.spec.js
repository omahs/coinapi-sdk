...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMDepositDTO();
  });
  ...
  describe('UNISWAPV2ETHEREUMDepositDTO', function() {
    it('should create an instance of UNISWAPV2ETHEREUMDepositDTO', function() {
      // uncomment below and update the code to test UNISWAPV2ETHEREUMDepositDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV2ETHEREUMDepositDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV2ETHEREUMDepositDTO);
    });
