...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMWithdrawDTO();
  });
  ...
  describe('SUSHISWAPV3ETHEREUMWithdrawDTO', function() {
    it('should create an instance of SUSHISWAPV3ETHEREUMWithdrawDTO', function() {
      // uncomment below and update the code to test SUSHISWAPV3ETHEREUMWithdrawDTO
      //var instance = new OnChainDappsRestApi.SUSHISWAPV3ETHEREUMWithdrawDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.SUSHISWAPV3ETHEREUMWithdrawDTO);
    });
