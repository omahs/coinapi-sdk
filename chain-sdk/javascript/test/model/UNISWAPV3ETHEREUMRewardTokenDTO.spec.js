...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMRewardTokenDTO();
  });
  ...
  describe('UNISWAPV3ETHEREUMRewardTokenDTO', function() {
    it('should create an instance of UNISWAPV3ETHEREUMRewardTokenDTO', function() {
      // uncomment below and update the code to test UNISWAPV3ETHEREUMRewardTokenDTO
      //var instance = new OnChainDappsRestApi.UNISWAPV3ETHEREUMRewardTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.UNISWAPV3ETHEREUMRewardTokenDTO);
    });
