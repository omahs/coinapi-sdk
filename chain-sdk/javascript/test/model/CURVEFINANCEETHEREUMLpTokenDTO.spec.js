...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLpTokenDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMLpTokenDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMLpTokenDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMLpTokenDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMLpTokenDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMLpTokenDTO);
    });
