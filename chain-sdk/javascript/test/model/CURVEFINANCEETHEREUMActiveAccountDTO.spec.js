...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMActiveAccountDTO();
  });
  ...
  describe('CURVEFINANCEETHEREUMActiveAccountDTO', function() {
    it('should create an instance of CURVEFINANCEETHEREUMActiveAccountDTO', function() {
      // uncomment below and update the code to test CURVEFINANCEETHEREUMActiveAccountDTO
      //var instance = new OnChainDappsRestApi.CURVEFINANCEETHEREUMActiveAccountDTO();
      //expect(instance).to.be.a(OnChainDappsRestApi.CURVEFINANCEETHEREUMActiveAccountDTO);
    });
