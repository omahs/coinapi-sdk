...
/**
 * The PANCAKESWAPV3ETHEREUMTokenDTO model module.
 * @module model/PANCAKESWAPV3ETHEREUMTokenDTO
 * @version v1
 */
class PANCAKESWAPV3ETHEREUMTokenDTO {
    /**
     * Constructs a new <code>PANCAKESWAPV3ETHEREUMTokenDTO</code>.
     * Stores aggregated information for a specific token across all pairs that token is included in.
     * @alias module:model/PANCAKESWAPV3ETHEREUMTokenDTO
     */
    constructor() { 
        
        PANCAKESWAPV3ETHEREUMTokenDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PANCAKESWAPV3ETHEREUMTokenDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PANCAKESWAPV3ETHEREUMTokenDTO} obj Optional instance to populate.
     * @return {module:model/PANCAKESWAPV3ETHEREUMTokenDTO} The populated <code>PANCAKESWAPV3ETHEREUMTokenDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PANCAKESWAPV3ETHEREUMTokenDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>PANCAKESWAPV3ETHEREUMTokenDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PANCAKESWAPV3ETHEREUMTokenDTO</code>.
     */
 ...
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['block_number'] = undefined;

/**
 * .
 * @member {Number} vid
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['vid'] = undefined;

/**
 * 
 * @member {String} block_range
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['block_range'] = undefined;

/**
 * Smart contract address of the token.
 * @member {String} id
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['id'] = undefined;

/**
 * Name of the token, mirrored from the smart contract.
 * @member {String} name
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['name'] = undefined;

/**
 * Symbol of the token, mirrored from the smart contract.
 * @member {String} symbol
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['symbol'] = undefined;

/**
 * The number of decimal places this token uses, default to 18.
 * @member {Number} decimals
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['decimals'] = undefined;

/**
 * Optional field to track the price of a token, mostly for caching purposes.
 * @member {String} last_price_usd
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['last_price_usd'] = undefined;

/**
 * Optional field to track the block number of the last token price.
 * @member {String} last_price_block_number
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['last_price_block_number'] = undefined;

/**
 * Last pool that gave this token a price.
 * @member {String} last_price_pool
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['last_price_pool'] = undefined;

/**
 * Amount of tokens in the protocol.
 * @member {String} total_supply
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['total_supply'] = undefined;

/**
 * Total value locked in the protocol.
 * @member {String} total_value_locked_usd
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['total_value_locked_usd'] = undefined;

/**
 * The buffer for detecting large price changes.
 * @member {Number} large_price_change_buffer
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['large_price_change_buffer'] = undefined;

/**
 * The buffer for detecting large TVL (Total Value Locked) impact.
 * @member {Number} large_tvl_impact_buffer
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['large_tvl_impact_buffer'] = undefined;

/**
 * @member {String} token_symbol
 */
PANCAKESWAPV3ETHEREUMTokenDTO.prototype['token_symbol'] = undefined;
...
export default PANCAKESWAPV3ETHEREUMTokenDTO;
