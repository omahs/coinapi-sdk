...
/**
 * The PANCAKESWAPV3ETHEREUMLiquidityPoolDTO model module.
 * @module model/PANCAKESWAPV3ETHEREUMLiquidityPoolDTO
 * @version v1
 */
class PANCAKESWAPV3ETHEREUMLiquidityPoolDTO {
    /**
     * Constructs a new <code>PANCAKESWAPV3ETHEREUMLiquidityPoolDTO</code>.
     * Pool-level metadata.
     * @alias module:model/PANCAKESWAPV3ETHEREUMLiquidityPoolDTO
     */
    constructor() { 
        
        PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PANCAKESWAPV3ETHEREUMLiquidityPoolDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PANCAKESWAPV3ETHEREUMLiquidityPoolDTO} obj Optional instance to populate.
     * @return {module:model/PANCAKESWAPV3ETHEREUMLiquidityPoolDTO} The populated <code>PANCAKESWAPV3ETHEREUMLiquidityPoolDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PANCAKESWAPV3ETHEREUMLiquidityPoolDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>PANCAKESWAPV3ETHEREUMLiquidityPoolDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PANCAKESWAPV3ETHEREUMLiquidityPoolDTO</code>.
     */
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['block_number'] = undefined;

/**
 * .
 * @member {Number} vid
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['vid'] = undefined;

/**
 * Block range of the liquidity pool.
 * @member {String} block_range
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['block_range'] = undefined;

/**
 * Smart contract address of the pool.
 * @member {String} id
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['id'] = undefined;

/**
 * Protocol this pool belongs to.
 * @member {String} protocol
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['protocol'] = undefined;

/**
 * Name of liquidity pool (e.g. Curve.fi DAI/USDC/USDT).
 * @member {String} name
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['name'] = undefined;

/**
 * Symbol of liquidity pool (e.g. 3CRV).
 * @member {String} symbol
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['symbol'] = undefined;

/**
 * Token that is to represent ownership of liquidity.
 * @member {String} liquidity_token
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['liquidity_token'] = undefined;

/**
 * Tokens that need to be deposited to take a position in protocol. e.g. WETH and USDC to deposit into the WETH-USDC pool. Array to account for multi-asset pools like Curve and Balancer.
 * @member {Array.<String>} input_tokens
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['input_tokens'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['reward_tokens'] = undefined;

/**
 * Fees per trade incurred to the user. Should include all fees that apply to a pool (e.g. Curve has a trading fee AND an admin fee, which is a portion of the trading fee. Uniswap only has a trading fee and no protocol fee.).
 * @member {Array.<String>} fees
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['fees'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['is_single_sided'] = undefined;

/**
 * Timestamp when the liquidity pool was created.
 * @member {String} created_timestamp
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['created_timestamp'] = undefined;

/**
 * Block number when the liquidity pool was created.
 * @member {String} created_block_number
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['created_block_number'] = undefined;

/**
 * Current tick representing the price of token0/token1.
 * @member {String} tick
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['tick'] = undefined;

/**
 * Current TVL (Total Value Locked) of this pool in USD.
 * @member {String} total_value_locked_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['total_value_locked_usd'] = undefined;

/**
 * Sum of all active and non-active liquidity for this pool.
 * @member {String} total_liquidity
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['total_liquidity'] = undefined;

/**
 * Sum of all active and non-active liquidity in USD for this pool.
 * @member {String} total_liquidity_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['total_liquidity_usd'] = undefined;

/**
 * All liquidity `k` that is active. Will be equal to totalLiquidity except for in concentrated liquidity - where activeLiquidity is all liquidity positions that contain the pools current tick.
 * @member {String} active_liquidity
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['active_liquidity'] = undefined;

/**
 * All liquidity in USD that is active. Will be equal to totalLiquidity except for in concentrated liquidity - where activeLiquidity is all liquidity positions that contain the pools current tick.
 * @member {String} active_liquidity_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['active_liquidity_usd'] = undefined;

/**
 * All protocol-side value locked in token amounts that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_protocol_side_token_amounts
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['uncollected_protocol_side_token_amounts'] = undefined;

/**
 * All protocol-side value locking in USD that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_protocol_side_values_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['uncollected_protocol_side_values_usd'] = undefined;

/**
 * All supply-side value locked in token amounts that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_supply_side_token_amounts
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['uncollected_supply_side_token_amounts'] = undefined;

/**
 * All supply-side value locked in USD that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_supply_side_values_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['uncollected_supply_side_values_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} cumulative_supply_side_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_supply_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} cumulative_protocol_side_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_protocol_side_revenue_usd'] = undefined;

/**
 *  All revenue generated by the liquidity pool.
 * @member {String} cumulative_total_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_total_revenue_usd'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_volume_by_token_amount'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_volume_by_token_usd'] = undefined;

/**
 * All trade volume occurred for a specific input token, in USD. The ordering should be the same as the pool's `inputTokens` field.
 * @member {String} cumulative_volume_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_volume_usd'] = undefined;

/**
 * Amount of input tokens in the pool. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} input_token_balances
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['input_token_balances'] = undefined;

/**
 * Amount of input tokens in USD in the pool. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} input_token_balances_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['input_token_balances_usd'] = undefined;

/**
 * Weights of input tokens in the liquidity pool in percentage values. For example, 50/50 for Uniswap pools, 48.2/51.8 for a Curve pool, 10/10/80 for a Balancer pool.
 * @member {Array.<String>} input_token_weights
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['input_token_weights'] = undefined;

/**
 * Total supply of output tokens that are staked (usually in the MasterChef contract). Used to calculate reward APY.
 * @member {String} staked_output_token_amount
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['staked_output_token_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day, in token's native amount. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_amount
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['reward_token_emissions_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day, in USD value. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['reward_token_emissions_usd'] = undefined;

/**
 * Total number of deposits (add liquidity).
 * @member {Number} cumulative_deposit_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_deposit_count'] = undefined;

/**
 * Total number of withdrawals (remove liquidity).
 * @member {Number} cumulative_withdraw_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_withdraw_count'] = undefined;

/**
 * Total number of trades (swaps).
 * @member {Number} cumulative_swap_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['cumulative_swap_count'] = undefined;

/**
 * Number of positions in this market.
 * @member {Number} position_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['position_count'] = undefined;

/**
 * Number of open positions in this market.
 * @member {Number} open_position_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['open_position_count'] = undefined;

/**
 * Number of closed positions in this market.
 * @member {Number} closed_position_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['closed_position_count'] = undefined;

/**
 * Day ID of the most recent daily snapshot.
 * @member {Number} last_snapshot_day_id
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['last_snapshot_day_id'] = undefined;

/**
 * Hour ID of the most recent hourly snapshot.
 * @member {Number} last_snapshot_hour_id
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['last_snapshot_hour_id'] = undefined;

/**
 * Timestamp of the last time this entity was updated.
 * @member {String} last_update_timestamp
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['last_update_timestamp'] = undefined;

/**
 * Block number of the last time this entity was updated.
 * @member {String} last_update_block_number
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['last_update_block_number'] = undefined;

/**
 * 
 * @member {Number} evaluated_ask
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.prototype['evaluated_ask'] = undefined;
...
export default PANCAKESWAPV3ETHEREUMLiquidityPoolDTO;
