...
/**
 * The SUSHISWAPV3ETHEREUMDepositDTO model module.
 * @module model/SUSHISWAPV3ETHEREUMDepositDTO
 * @version v1
 */
class SUSHISWAPV3ETHEREUMDepositDTO {
    /**
     * Constructs a new <code>SUSHISWAPV3ETHEREUMDepositDTO</code>.
     * Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
     * @alias module:model/SUSHISWAPV3ETHEREUMDepositDTO
     */
    constructor() { 
        
        SUSHISWAPV3ETHEREUMDepositDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SUSHISWAPV3ETHEREUMDepositDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SUSHISWAPV3ETHEREUMDepositDTO} obj Optional instance to populate.
     * @return {module:model/SUSHISWAPV3ETHEREUMDepositDTO} The populated <code>SUSHISWAPV3ETHEREUMDepositDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SUSHISWAPV3ETHEREUMDepositDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>SUSHISWAPV3ETHEREUMDepositDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SUSHISWAPV3ETHEREUMDepositDTO</code>.
     */
 ...
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} block_
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['block_'] = undefined;

/**
 * Identifier, format: (transaction hash)-(log index)
 * @member {String} id
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['id'] = undefined;

/**
 * Transaction hash of the transaction that emitted this event.
 * @member {String} hash
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['hash'] = undefined;

/**
 * Nonce of the transaction that emitted this event.
 * @member {String} nonce
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['nonce'] = undefined;

/**
 * Event log index. For transactions that don't emit event, create arbitrary index starting from 0.
 * @member {Number} log_index
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['log_index'] = undefined;

/**
 * Gas limit of the transaction that emitted this event.
 * @member {String} gas_limit
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['gas_limit'] = undefined;

/**
 * Gas used in this transaction. (Optional because not every chain will support this).
 * @member {String} gas_used
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['gas_used'] = undefined;

/**
 * Gas price of the transaction that emitted this event.
 * @member {String} gas_price
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['gas_price'] = undefined;

/**
 * The protocol this transaction belongs to.
 * @member {String} protocol
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['protocol'] = undefined;

/**
 * Account that emitted this event.
 * @member {String} account
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['account'] = undefined;

/**
 * The user position changed by this event.
 * @member {String} position
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['position'] = undefined;

/**
 * The pool involving this event.
 * @member {String} pool
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['pool'] = undefined;

/**
 * Lower tick of position.
 * @member {String} tick_lower
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['tick_lower'] = undefined;

/**
 * Upper tick of position.
 * @member {String} tick_upper
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['tick_upper'] = undefined;

/**
 * Timestamp of this event.
 * @member {String} timestamp
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['timestamp'] = undefined;

/**
 * Amount of liquidity minted.
 * @member {String} liquidity
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['liquidity'] = undefined;

/**
 * Input tokens of the pool. E.g. WETH and USDC to a WETH-USDC pool.
 * @member {Array.<String>} input_tokens
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['input_tokens'] = undefined;

/**
 * Amount of input tokens in the token's native unit.
 * @member {Array.<String>} input_token_amounts
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['input_token_amounts'] = undefined;

/**
 * Amount of input tokens in the liquidity pool.
 * @member {Array.<String>} reserve_amounts
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['reserve_amounts'] = undefined;

/**
 * USD-normalized value of the transaction of the underlying (e.g. sum of tokens deposited into a pool).
 * @member {String} amount_usd
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['amount_usd'] = undefined;

/**
 * 
 * @member {String} block_range
 */
SUSHISWAPV3ETHEREUMDepositDTO.prototype['block_range'] = undefined;
...
export default SUSHISWAPV3ETHEREUMDepositDTO;
