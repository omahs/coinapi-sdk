...
/**
 * The SUSHISWAPV3ETHEREUMPositionSnapshotDTO model module.
 * @module model/SUSHISWAPV3ETHEREUMPositionSnapshotDTO
 * @version v1
 */
class SUSHISWAPV3ETHEREUMPositionSnapshotDTO {
    /**
     * Constructs a new <code>SUSHISWAPV3ETHEREUMPositionSnapshotDTO</code>.
     * 
     * @alias module:model/SUSHISWAPV3ETHEREUMPositionSnapshotDTO
     */
    constructor() { 
        
        SUSHISWAPV3ETHEREUMPositionSnapshotDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SUSHISWAPV3ETHEREUMPositionSnapshotDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SUSHISWAPV3ETHEREUMPositionSnapshotDTO} obj Optional instance to populate.
     * @return {module:model/SUSHISWAPV3ETHEREUMPositionSnapshotDTO} The populated <code>SUSHISWAPV3ETHEREUMPositionSnapshotDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SUSHISWAPV3ETHEREUMPositionSnapshotDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>SUSHISWAPV3ETHEREUMPositionSnapshotDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SUSHISWAPV3ETHEREUMPositionSnapshotDTO</code>.
     */
 ...
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['block_number'] = undefined;

/**
 *  (position id )-( transaction hash )-( log index ) 
 * @member {String} id
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['id'] = undefined;

/**
 * Transaction hash of the transaction that triggered this snapshot
 * @member {String} hash
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['hash'] = undefined;

/**
 * Event log index. For transactions that don't emit event, create arbitrary index starting from 0
 * @member {Number} log_index
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['log_index'] = undefined;

/**
 * Nonce of the transaction that triggered this snapshot
 * @member {String} nonce
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['nonce'] = undefined;

/**
 * Position of this snapshot
 * @member {String} position
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['position'] = undefined;

/**
 * Type of token used to track liquidity
 * @member {String} liquidity_token_type
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['liquidity_token_type'] = undefined;

/**
 * total position liquidity
 * @member {String} liquidity
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['liquidity'] = undefined;

/**
 * total position liquidity in USD
 * @member {String} liquidity_usd
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['liquidity_usd'] = undefined;

/**
 * amount of tokens ever deposited to position
 * @member {Array.<String>} cumulative_deposit_token_amounts
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['cumulative_deposit_token_amounts'] = undefined;

/**
 * amount of tokens in USD deposited to position
 * @member {String} cumulative_deposit_usd
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['cumulative_deposit_usd'] = undefined;

/**
 * amount of tokens ever withdrawn from position (without fees)
 * @member {Array.<String>} cumulative_withdraw_token_amounts
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['cumulative_withdraw_token_amounts'] = undefined;

/**
 * amount of tokens in USD withdrawn from position (without fees)
 * @member {String} cumulative_withdraw_usd
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['cumulative_withdraw_usd'] = undefined;

/**
 * Total reward token accumulated under this position, in native amounts
 * @member {Array.<String>} cumulative_reward_token_amounts
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['cumulative_reward_token_amounts'] = undefined;

/**
 * Total reward token accumulated under this position, in USD
 * @member {Array.<String>} cumulative_reward_usd
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['cumulative_reward_usd'] = undefined;

/**
 * Number of deposits related to this position
 * @member {Number} deposit_count
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['deposit_count'] = undefined;

/**
 * Number of withdrawals related to this position
 * @member {Number} withdraw_count
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['withdraw_count'] = undefined;

/**
 * Timestamp of this snapshot
 * @member {String} timestamp
 */
SUSHISWAPV3ETHEREUMPositionSnapshotDTO.prototype['timestamp'] = undefined;
...
export default SUSHISWAPV3ETHEREUMPositionSnapshotDTO;
