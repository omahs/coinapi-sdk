...
/**
 * The UNISWAPV3ETHEREUMDepositDTO model module.
 * @module model/UNISWAPV3ETHEREUMDepositDTO
 * @version v1
 */
class UNISWAPV3ETHEREUMDepositDTO {
    /**
     * Constructs a new <code>UNISWAPV3ETHEREUMDepositDTO</code>.
     * Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
     * @alias module:model/UNISWAPV3ETHEREUMDepositDTO
     */
    constructor() { 
        
        UNISWAPV3ETHEREUMDepositDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UNISWAPV3ETHEREUMDepositDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UNISWAPV3ETHEREUMDepositDTO} obj Optional instance to populate.
     * @return {module:model/UNISWAPV3ETHEREUMDepositDTO} The populated <code>UNISWAPV3ETHEREUMDepositDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UNISWAPV3ETHEREUMDepositDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UNISWAPV3ETHEREUMDepositDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UNISWAPV3ETHEREUMDepositDTO</code>.
     */
 ...
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} block_
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['block_'] = undefined;

/**
 * Identifier, format: (transaction hash)-(log index)
 * @member {String} id
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['id'] = undefined;

/**
 * Transaction hash of the transaction that emitted this event.
 * @member {String} hash
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['hash'] = undefined;

/**
 * Nonce of the transaction that emitted this event.
 * @member {String} nonce
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['nonce'] = undefined;

/**
 * Event log index. For transactions that don't emit event, create arbitrary index starting from 0.
 * @member {Number} log_index
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['log_index'] = undefined;

/**
 * Gas limit of the transaction that emitted this event.
 * @member {String} gas_limit
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['gas_limit'] = undefined;

/**
 * Gas used in this transaction. (Optional because not every chain will support this).
 * @member {String} gas_used
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['gas_used'] = undefined;

/**
 * Gas price of the transaction that emitted this event.
 * @member {String} gas_price
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['gas_price'] = undefined;

/**
 * The protocol this transaction belongs to.
 * @member {String} protocol
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['protocol'] = undefined;

/**
 * Account that emitted this event.
 * @member {String} account
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['account'] = undefined;

/**
 * The user position changed by this event.
 * @member {String} position
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['position'] = undefined;

/**
 * The pool involving this event.
 * @member {String} pool
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['pool'] = undefined;

/**
 * Lower tick of position.
 * @member {String} tick_lower
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['tick_lower'] = undefined;

/**
 * Upper tick of position.
 * @member {String} tick_upper
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['tick_upper'] = undefined;

/**
 * Timestamp of this event.
 * @member {String} timestamp
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['timestamp'] = undefined;

/**
 * Amount of liquidity minted.
 * @member {String} liquidity
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['liquidity'] = undefined;

/**
 * Input tokens of the pool. E.g. WETH and USDC to a WETH-USDC pool.
 * @member {Array.<String>} input_tokens
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['input_tokens'] = undefined;

/**
 * Amount of input tokens in the token's native unit.
 * @member {Array.<String>} input_token_amounts
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['input_token_amounts'] = undefined;

/**
 * Amount of input tokens in the liquidity pool.
 * @member {Array.<String>} reserve_amounts
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['reserve_amounts'] = undefined;

/**
 * USD-normalized value of the transaction of the underlying (e.g. sum of tokens deposited into a pool).
 * @member {String} amount_usd
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['amount_usd'] = undefined;

/**
 * 
 * @member {String} block_range
 */
UNISWAPV3ETHEREUMDepositDTO.prototype['block_range'] = undefined;
...
export default UNISWAPV3ETHEREUMDepositDTO;
