...
/**
 * The CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO model module.
 * @module model/CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO
 * @version v1
 */
class CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO {
    /**
     * Constructs a new <code>CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     * 
     * @alias module:model/CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO
     */
    constructor() { 
        
        CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO} obj Optional instance to populate.
     * @return {module:model/CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO} The populated <code>CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     */
 ...
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {String} block_range
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['block_range'] = undefined;

/**
 * (smart contract address of the pool)-(# of hours since unix epoch time)
 * @member {String} id
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['id'] = undefined;

/**
 * The protocol this snapshot belongs to
 * @member {String} protocol
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['protocol'] = undefined;

/**
 * The pool this snapshot belongs to
 * @member {String} pool
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['pool'] = undefined;

/**
 * Timestamp of this snapshot
 * @member {String} timestamp
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['timestamp'] = undefined;

/**
 * Current TVL (Total Value Locked) of this pool
 * @member {String} total_value_locked_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['total_value_locked_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} cumulative_supply_side_revenue_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_supply_side_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} hourly_supply_side_revenue_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_supply_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} cumulative_protocol_side_revenue_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_protocol_side_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} hourly_protocol_side_revenue_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_protocol_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool.
 * @member {String} cumulative_total_revenue_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_total_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool.
 * @member {String} hourly_total_revenue_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_total_revenue_usd'] = undefined;

/**
 * All trade volume occurred in a given hour, in USD
 * @member {String} hourly_volume_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_usd'] = undefined;

/**
 * All trade volume occurred in a given hour for a specific input token, in native amount. The ordering should be the same as the pool's 'inputTokens' field.
 * @member {Array.<String>} hourly_volume_by_token_amount
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_by_token_amount'] = undefined;
 ...
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_by_token_usd'] = undefined;

/**
 * All historical trade volume occurred in this pool, in USD
 * @member {String} cumulative_volume_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_volume_usd'] = undefined;

/**
 * Amount of input tokens in the pool. The ordering should be the same as the pool's 'inputTokens' field.
 * @member {Array.<String>} input_token_balances
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['input_token_balances'] = undefined;

/**
 * Weights of input tokens in the liquidity pool in percentage values. For example, 50/50 for Uniswap pools, 48.2/51.8 for a Curve pool, 10/10/80 for a Balancer pool
 * @member {Array.<String>} input_token_weights
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['input_token_weights'] = undefined;
 ...
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['output_token_supply'] = undefined;

/**
 * Price per share of output token in USD
 * @member {String} output_token_price_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['output_token_price_usd'] = undefined;

/**
 * Total supply of output tokens that are staked (usually in the MasterChef contract). Used to calculate reward APY.
 * @member {String} staked_output_token_amount
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['staked_output_token_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day (not hour), in token's native amount. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_amount
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['reward_token_emissions_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day (not hour), in USD value. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_usd
 */
CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['reward_token_emissions_usd'] = undefined;
...
export default CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO;
