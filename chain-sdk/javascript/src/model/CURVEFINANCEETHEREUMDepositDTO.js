...
/**
 * The CURVEFINANCEETHEREUMDepositDTO model module.
 * @module model/CURVEFINANCEETHEREUMDepositDTO
 * @version v1
 */
class CURVEFINANCEETHEREUMDepositDTO {
    /**
     * Constructs a new <code>CURVEFINANCEETHEREUMDepositDTO</code>.
     * Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
     * @alias module:model/CURVEFINANCEETHEREUMDepositDTO
     */
    constructor() { 
        
        CURVEFINANCEETHEREUMDepositDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CURVEFINANCEETHEREUMDepositDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CURVEFINANCEETHEREUMDepositDTO} obj Optional instance to populate.
     * @return {module:model/CURVEFINANCEETHEREUMDepositDTO} The populated <code>CURVEFINANCEETHEREUMDepositDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CURVEFINANCEETHEREUMDepositDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>CURVEFINANCEETHEREUMDepositDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CURVEFINANCEETHEREUMDepositDTO</code>.
     */
 ...
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {String} block_range
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['block_range'] = undefined;

/**
 * deposit-(Transaction hash)-(log index)
 * @member {String} id
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['id'] = undefined;

/**
 * Transaction hash of the transaction that emitted this event
 * @member {String} hash
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['hash'] = undefined;

/**
 * Event log index. For transactions that don't emit event, create arbitrary index starting from 0
 * @member {Number} log_index
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['log_index'] = undefined;

/**
 * The protocol this transaction belongs to
 * @member {String} protocol
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['protocol'] = undefined;

/**
 * Address that received the tokens
 * @member {String} to
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['to'] = undefined;

/**
 * Address that sent the tokens
 * @member {String} from
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['from'] = undefined;

/**
 * Timestamp of this event
 * @member {String} timestamp
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['timestamp'] = undefined;

/**
 * Input tokens of the pool. E.g. WETH and USDC to a WETH-USDC pool
 * @member {Array.<String>} input_tokens
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['input_tokens'] = undefined;

/**
 * Output token of the pool. E.g. the UNI-LP token
 * @member {String} output_token
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['output_token'] = undefined;

/**
 * Amount of input tokens in the token's native unit
 * @member {Array.<String>} input_token_amounts
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['input_token_amounts'] = undefined;

/**
 * Amount of output tokens in the token's native unit
 * @member {String} output_token_amount
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['output_token_amount'] = undefined;

/**
 * USD-normalized value of the transaction of the underlying (e.g. sum of tokens deposited into a pool)
 * @member {String} amount_usd
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['amount_usd'] = undefined;

/**
 * The pool involving this transaction
 * @member {String} pool
 */
CURVEFINANCEETHEREUMDepositDTO.prototype['pool'] = undefined;
...
export default CURVEFINANCEETHEREUMDepositDTO;
