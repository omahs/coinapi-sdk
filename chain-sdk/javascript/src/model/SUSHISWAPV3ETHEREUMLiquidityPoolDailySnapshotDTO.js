...
/**
 * The SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO model module.
 * @module model/SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO
 * @version v1
 */
class SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO {
    /**
     * Constructs a new <code>SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO</code>.
     * Represents a liquidity pool daily snapshot for Sushiswap V3.
     * @alias module:model/SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO
     */
    constructor() { 
        
        SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO} obj Optional instance to populate.
     * @return {module:model/SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO} The populated <code>SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO</code>.
     */
 ...
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['block_number'] = undefined;

/**
 * The Ethereum block number associated with the liquidity pool daily snapshot.
 * @member {Number} block_
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['block_'] = undefined;

/**
 * Identifier, format: (smart contract address of the pool)-(# of days since Unix epoch time).
 * @member {String} id
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['id'] = undefined;

/**
 * Number of days since Unix epoch time.
 * @member {Number} day
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['day'] = undefined;

/**
 * Protocol associated with the liquidity pool.
 * @member {String} protocol
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['protocol'] = undefined;

/**
 * Pool this snapshot belongs to.
 * @member {String} pool
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['pool'] = undefined;

/**
 * Current tick representing the price of token0/token1.
 * @member {String} tick
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['tick'] = undefined;

/**
 * Current TVL (Total Value Locked) of this pool.
 * @member {String} total_value_locked_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['total_value_locked_usd'] = undefined;

/**
 * The sum of all active and non-active liquidity for this pool.
 * @member {String} total_liquidity
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['total_liquidity'] = undefined;

/**
 * Sum of all active and non-active liquidity in USD for this pool.
 * @member {String} total_liquidity_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['total_liquidity_usd'] = undefined;

/**
 * All liquidity `k` that is active. Will be equal to totalLiquidity except for in concentrated liquidity - where activeLiquidity is all liquidity positions that contain the pools current tick.
 * @member {String} active_liquidity
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['active_liquidity'] = undefined;

/**
 * All liquidity in USD that is active. Will be equal to totalLiquidity except for in concentrated liquidity - where activeLiquidity is all liquidity positions that contain the pools current tick.
 * @member {String} active_liquidity_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['active_liquidity_usd'] = undefined;

/**
 * All protocol-side value locked in token amounts that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_protocol_side_token_amounts
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['uncollected_protocol_side_token_amounts'] = undefined;

/**
 * All protocol-side value locking in USD that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_protocol_side_values_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['uncollected_protocol_side_values_usd'] = undefined;

/**
 * All supply-side value locked in token amounts that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_supply_side_token_amounts
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['uncollected_supply_side_token_amounts'] = undefined;

/**
 * All supply-side value locked in USD that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_supply_side_values_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['uncollected_supply_side_values_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} cumulative_supply_side_revenue_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_supply_side_revenue_usd'] = undefined;

/**
 * Daily revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} daily_supply_side_revenue_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_supply_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} cumulative_protocol_side_revenue_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_protocol_side_revenue_usd'] = undefined;

/**
 * Daily revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} daily_protocol_side_revenue_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_protocol_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool.
 * @member {String} cumulative_total_revenue_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_total_revenue_usd'] = undefined;

/**
 * Daily revenue generated by the liquidity pool.
 * @member {String} daily_total_revenue_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_total_revenue_usd'] = undefined;

/**
 * All historical trade volume occurred in this pool, in USD.
 * @member {String} cumulative_volume_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_volume_usd'] = undefined;

/**
 * All trade volume occurred in a given day, in USD.
 * @member {String} daily_volume_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_volume_usd'] = undefined;
 ...
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_volume_by_token_amount'] = undefined;

/**
 * All trade volume occurred in a given day for a specific input token, in native amount. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} daily_volume_by_token_amount
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_volume_by_token_amount'] = undefined;
 ...
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_volume_by_token_usd'] = undefined;

/**
 *  All trade volume occurred in a given day for a specific input token, in USD. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} daily_volume_by_token_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_volume_by_token_usd'] = undefined;

/**
 * Amount of input tokens in the pool. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} input_token_balances
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['input_token_balances'] = undefined;

/**
 * Amount of input tokens in USD in the pool. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} input_token_balances_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['input_token_balances_usd'] = undefined;

/**
 * Weights of input tokens in the liquidity pool in percentage values. For example, 50/50 for Uniswap pools, 48.2/51.8 for a Curve pool, 10/10/80 for a Balancer pool.
 * @member {Array.<String>} input_token_weights
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['input_token_weights'] = undefined;

/**
 * Total supply of output tokens that are staked (usually in the MasterChef contract). Used to calculate reward APY.
 * @member {String} staked_output_token_amount
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['staked_output_token_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day, in token's native amount. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_amount
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['reward_token_emissions_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day, in USD value. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_usd
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['reward_token_emissions_usd'] = undefined;

/**
 * Total number of deposits (add liquidity).
 * @member {Number} cumulative_deposit_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_deposit_count'] = undefined;

/**
 * Total number of deposits (add liquidity) in a day.
 * @member {Number} daily_deposit_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_deposit_count'] = undefined;

/**
 * Total number of withdrawals (remove liquidity).
 * @member {Number} cumulative_withdraw_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_withdraw_count'] = undefined;

/**
 * Total number of withdrawals (remove liquidity) in a day.
 * @member {Number} daily_withdraw_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_withdraw_count'] = undefined;

/**
 * Total number of trades (swaps).
 * @member {Number} cumulative_swap_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['cumulative_swap_count'] = undefined;

/**
 * Total number of trades (swaps) in a day.
 * @member {Number} daily_swap_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['daily_swap_count'] = undefined;

/**
 * Number of positions in this market.
 * @member {Number} position_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['position_count'] = undefined;

/**
 * Number of open positions in this market.
 * @member {Number} open_position_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['open_position_count'] = undefined;

/**
 * Number of closed positions in this market.
 * @member {Number} closed_position_count
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['closed_position_count'] = undefined;

/**
 * Timestamp of when this snapshot was taken/last modified (May be taken after interval has passed).
 * @member {String} timestamp
 */
SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO.prototype['timestamp'] = undefined;
...
export default SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO;
