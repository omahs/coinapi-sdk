...
/**
 * The UNISWAPV2ETHEREUMLiquidityPoolDTO model module.
 * @module model/UNISWAPV2ETHEREUMLiquidityPoolDTO
 * @version v1
 */
class UNISWAPV2ETHEREUMLiquidityPoolDTO {
    /**
     * Constructs a new <code>UNISWAPV2ETHEREUMLiquidityPoolDTO</code>.
     * Pool-level metadata.
     * @alias module:model/UNISWAPV2ETHEREUMLiquidityPoolDTO
     */
    constructor() { 
        
        UNISWAPV2ETHEREUMLiquidityPoolDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UNISWAPV2ETHEREUMLiquidityPoolDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UNISWAPV2ETHEREUMLiquidityPoolDTO} obj Optional instance to populate.
     * @return {module:model/UNISWAPV2ETHEREUMLiquidityPoolDTO} The populated <code>UNISWAPV2ETHEREUMLiquidityPoolDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UNISWAPV2ETHEREUMLiquidityPoolDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UNISWAPV2ETHEREUMLiquidityPoolDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UNISWAPV2ETHEREUMLiquidityPoolDTO</code>.
     */
 ...
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['block_number'] = undefined;

/**
 * .
 * @member {Number} vid
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['vid'] = undefined;

/**
 * Smart contract address of the pool
 * @member {String} id
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['id'] = undefined;

/**
 * The protocol this pool belongs to
 * @member {String} protocol
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['protocol'] = undefined;

/**
 * Name of liquidity pool (e.g. Curve.fi DAI/USDC/USDT)
 * @member {String} name
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['name'] = undefined;

/**
 * Symbol of liquidity pool (e.g. 3CRV)
 * @member {String} symbol
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['symbol'] = undefined;

/**
 * Tokens that need to be deposited to take a position in the protocol
 * @member {Array.<String>} input_tokens
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['input_tokens'] = undefined;

/**
 * Token that is minted to track ownership of position in protocol
 * @member {String} output_token
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['output_token'] = undefined;

/**
 * Aditional tokens that are given as reward for position in a protocol
 * @member {Array.<String>} reward_tokens
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['reward_tokens'] = undefined;

/**
 * Fees per trade incurred to the user
 * @member {Array.<String>} fees
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['fees'] = undefined;

/**
 * Whether this pool is single-sided
 * @member {Boolean} is_single_sided
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['is_single_sided'] = undefined;

/**
 * Creation timestamp
 * @member {String} created_timestamp
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['created_timestamp'] = undefined;

/**
 * Creation block number
 * @member {String} created_block_number
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['created_block_number'] = undefined;

/**
 * Current TVL (Total Value Locked) of this pool in USD
 * @member {String} total_value_locked_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['total_value_locked_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the supply side
 * @member {String} cumulative_supply_side_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['cumulative_supply_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the protocol
 * @member {String} cumulative_protocol_side_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['cumulative_protocol_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool
 * @member {String} cumulative_total_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['cumulative_total_revenue_usd'] = undefined;

/**
 * All historical trade volume occurred in this pool, in USD
 * @member {String} cumulative_volume_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['cumulative_volume_usd'] = undefined;

/**
 * Amount of input tokens in the pool
 * @member {Array.<String>} input_token_balances
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['input_token_balances'] = undefined;

/**
 * Weights of input tokens in the liquidity pool in percentage values
 * @member {Array.<String>} input_token_weights
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['input_token_weights'] = undefined;

/**
 * Total supply of output token
 * @member {String} output_token_supply
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['output_token_supply'] = undefined;

/**
 * Price per share of output token in USD
 * @member {String} output_token_price_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['output_token_price_usd'] = undefined;

/**
 * Total supply of output tokens that are staked
 * @member {String} staked_output_token_amount
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['staked_output_token_amount'] = undefined;
 ...
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['reward_token_emissions_amount'] = undefined;
 ...
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['reward_token_emissions_usd'] = undefined;

/**
 * Evaluated ask value of the liquidity pool.
 * @member {Number} evaluated_ask
 */
UNISWAPV2ETHEREUMLiquidityPoolDTO.prototype['evaluated_ask'] = undefined;
...
export default UNISWAPV2ETHEREUMLiquidityPoolDTO;
