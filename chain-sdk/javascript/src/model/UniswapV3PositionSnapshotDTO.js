...
/**
 * The UniswapV3PositionSnapshotDTO model module.
 * @module model/UniswapV3PositionSnapshotDTO
 * @version v1
 */
class UniswapV3PositionSnapshotDTO {
    /**
     * Constructs a new <code>UniswapV3PositionSnapshotDTO</code>.
     * @alias module:model/UniswapV3PositionSnapshotDTO
     */
    constructor() { 
        
        UniswapV3PositionSnapshotDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UniswapV3PositionSnapshotDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UniswapV3PositionSnapshotDTO} obj Optional instance to populate.
     * @return {module:model/UniswapV3PositionSnapshotDTO} The populated <code>UniswapV3PositionSnapshotDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UniswapV3PositionSnapshotDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UniswapV3PositionSnapshotDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UniswapV3PositionSnapshotDTO</code>.
     */
 ...
 */
UniswapV3PositionSnapshotDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UniswapV3PositionSnapshotDTO.prototype['recv_time'] = undefined;
 ...
 * @member {String} owner
 */
UniswapV3PositionSnapshotDTO.prototype['owner'] = undefined;

/**
 * Pool the position is within.
 * @member {String} pool
 */
UniswapV3PositionSnapshotDTO.prototype['pool'] = undefined;

/**
 * Position of which the snap was taken of.
 * @member {String} position
 */
UniswapV3PositionSnapshotDTO.prototype['position'] = undefined;

/**
 * Timestamp of block in which the snap was created.
 * @member {String} timestamp
 */
UniswapV3PositionSnapshotDTO.prototype['timestamp'] = undefined;

/**
 * Total position liquidity.
 * @member {String} liquidity
 */
UniswapV3PositionSnapshotDTO.prototype['liquidity'] = undefined;

/**
 * Amount of token 0 ever deposited to position.
 * @member {String} deposited_token_0
 */
UniswapV3PositionSnapshotDTO.prototype['deposited_token_0'] = undefined;

/**
 * Amount of token 1 ever deposited to position.
 * @member {String} deposited_token_1
 */
UniswapV3PositionSnapshotDTO.prototype['deposited_token_1'] = undefined;

/**
 * Amount of token 0 ever withdrawn from position (without fees).
 * @member {String} withdrawn_token_0
 */
UniswapV3PositionSnapshotDTO.prototype['withdrawn_token_0'] = undefined;

/**
 * Amount of token 1 ever withdrawn from position (without fees).
 * @member {String} withdrawn_token_1
 */
UniswapV3PositionSnapshotDTO.prototype['withdrawn_token_1'] = undefined;

/**
 * All time collected fees in token0.
 * @member {String} collected_fees_token_0
 */
UniswapV3PositionSnapshotDTO.prototype['collected_fees_token_0'] = undefined;

/**
 * All time collected fees in token1.
 * @member {String} collected_fees_token_1
 */
UniswapV3PositionSnapshotDTO.prototype['collected_fees_token_1'] = undefined;

/**
 * Transaction in which the snapshot was initialized.
 * @member {String} transaction
 */
UniswapV3PositionSnapshotDTO.prototype['transaction'] = undefined;

/**
 * Variable needed for fee computation.
 * @member {String} fee_growth_inside_0_last_x128
 */
UniswapV3PositionSnapshotDTO.prototype['fee_growth_inside_0_last_x128'] = undefined;

/**
 * Variable needed for fee computation.
 * @member {String} fee_growth_inside_1_last_x128
 */
UniswapV3PositionSnapshotDTO.prototype['fee_growth_inside_1_last_x128'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UniswapV3PositionSnapshotDTO.prototype['vid'] = undefined;
...
export default UniswapV3PositionSnapshotDTO;
