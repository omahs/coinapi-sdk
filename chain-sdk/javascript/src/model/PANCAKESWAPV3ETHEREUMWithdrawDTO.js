...
/**
 * The PANCAKESWAPV3ETHEREUMWithdrawDTO model module.
 * @module model/PANCAKESWAPV3ETHEREUMWithdrawDTO
 * @version v1
 */
class PANCAKESWAPV3ETHEREUMWithdrawDTO {
    /**
     * Constructs a new <code>PANCAKESWAPV3ETHEREUMWithdrawDTO</code>.
     * 
     * @alias module:model/PANCAKESWAPV3ETHEREUMWithdrawDTO
     */
    constructor() { 
        
        PANCAKESWAPV3ETHEREUMWithdrawDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PANCAKESWAPV3ETHEREUMWithdrawDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PANCAKESWAPV3ETHEREUMWithdrawDTO} obj Optional instance to populate.
     * @return {module:model/PANCAKESWAPV3ETHEREUMWithdrawDTO} The populated <code>PANCAKESWAPV3ETHEREUMWithdrawDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PANCAKESWAPV3ETHEREUMWithdrawDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>PANCAKESWAPV3ETHEREUMWithdrawDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PANCAKESWAPV3ETHEREUMWithdrawDTO</code>.
     */
 ...
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['block_number'] = undefined;

/**
 * (transaction hash)-(log index)
 * @member {String} id
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['id'] = undefined;

/**
 * Transaction hash of the transaction that emitted this event
 * @member {String} hash
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['hash'] = undefined;

/**
 * Nonce of the transaction that emitted this event
 * @member {String} nonce
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['nonce'] = undefined;

/**
 * Event log index. For transactions that don't emit event, create arbitrary index starting from 0
 * @member {Number} log_index
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['log_index'] = undefined;

/**
 * Gas limit of the transaction that emitted this event
 * @member {String} gas_limit
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['gas_limit'] = undefined;

/**
 * Gas used in this transaction. (Optional because not every chain will support this)
 * @member {String} gas_used
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['gas_used'] = undefined;

/**
 * Gas price of the transaction that emitted this event
 * @member {String} gas_price
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['gas_price'] = undefined;

/**
 * The protocol this transaction belongs to
 * @member {String} protocol
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['protocol'] = undefined;

/**
 * Account that emitted this event
 * @member {String} account
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['account'] = undefined;

/**
 * The user position changed by this event
 * @member {String} position
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['position'] = undefined;

/**
 * lower tick of position
 * @member {String} tick_lower
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['tick_lower'] = undefined;

/**
 * upper tick of position
 * @member {String} tick_upper
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['tick_upper'] = undefined;

/**
 * The pool involving this event
 * @member {String} pool
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['pool'] = undefined;

/**
 * Timestamp of this event
 * @member {String} timestamp
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['timestamp'] = undefined;

/**
 * Amount of liquidity burned
 * @member {String} liquidity
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['liquidity'] = undefined;

/**
 * Input tokens of the pool (not input tokens of the event/transaction). E.g. WETH and USDC from a WETH-USDC pool
 * @member {Array.<String>} input_tokens
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['input_tokens'] = undefined;

/**
 * Amount of input tokens in the token's native unit
 * @member {Array.<String>} input_token_amounts
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['input_token_amounts'] = undefined;

/**
 * Amount of input tokens in the liquidity pool
 * @member {Array.<String>} reserve_amounts
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['reserve_amounts'] = undefined;

/**
 * USD-normalized value of the transaction of the underlying (e.g. sum of tokens withdrawn from a pool)
 * @member {String} amount_usd
 */
PANCAKESWAPV3ETHEREUMWithdrawDTO.prototype['amount_usd'] = undefined;
...
export default PANCAKESWAPV3ETHEREUMWithdrawDTO;
