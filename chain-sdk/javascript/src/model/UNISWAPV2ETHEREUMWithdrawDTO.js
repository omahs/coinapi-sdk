...
/**
 * The UNISWAPV2ETHEREUMWithdrawDTO model module.
 * @module model/UNISWAPV2ETHEREUMWithdrawDTO
 * @version v1
 */
class UNISWAPV2ETHEREUMWithdrawDTO {
    /**
     * Constructs a new <code>UNISWAPV2ETHEREUMWithdrawDTO</code>.
     * 
     * @alias module:model/UNISWAPV2ETHEREUMWithdrawDTO
     */
    constructor() { 
        
        UNISWAPV2ETHEREUMWithdrawDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UNISWAPV2ETHEREUMWithdrawDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UNISWAPV2ETHEREUMWithdrawDTO} obj Optional instance to populate.
     * @return {module:model/UNISWAPV2ETHEREUMWithdrawDTO} The populated <code>UNISWAPV2ETHEREUMWithdrawDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UNISWAPV2ETHEREUMWithdrawDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UNISWAPV2ETHEREUMWithdrawDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UNISWAPV2ETHEREUMWithdrawDTO</code>.
     */
 ...
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} block_
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['block_'] = undefined;

/**
 * Withdraw-(transaction hash)-(log index)
 * @member {String} id
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['id'] = undefined;

/**
 * Transaction hash of the transaction that emitted this event
 * @member {String} hash
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['hash'] = undefined;

/**
 * Event log index. For transactions that don't emit event, create arbitrary index starting from 0
 * @member {Number} log_index
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['log_index'] = undefined;

/**
 * The protocol this transaction belongs to
 * @member {String} protocol
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['protocol'] = undefined;

/**
 * Address that received the tokens
 * @member {String} to
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['to'] = undefined;

/**
 * Address that sent the tokens
 * @member {String} from
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['from'] = undefined;

/**
 * Timestamp of this event
 * @member {String} timestamp
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['timestamp'] = undefined;

/**
 * Input tokens of the pool (not input tokens of the event/transaction). E.g. WETH and USDC from a WETH-USDC pool
 * @member {Array.<String>} input_tokens
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['input_tokens'] = undefined;

/**
 * Output token of the pool (not output token of the event/transaction). E.g. the UNI-LP token
 * @member {String} output_token
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['output_token'] = undefined;

/**
 * Amount of input tokens in the token's native unit
 * @member {Array.<String>} input_token_amounts
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['input_token_amounts'] = undefined;

/**
 * Amount of output tokens in the token's native unit
 * @member {String} output_token_amount
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['output_token_amount'] = undefined;

/**
 * Amount of input tokens in the liquidity pool
 * @member {Array.<String>} reserve_amounts
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['reserve_amounts'] = undefined;

/**
 * USD-normalized value of the transaction of the underlying (e.g. sum of tokens withdrawn from a pool)
 * @member {String} amount_usd
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['amount_usd'] = undefined;

/**
 * The pool involving this transaction
 * @member {String} pool
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['pool'] = undefined;

/**
 * 
 * @member {String} block_range
 */
UNISWAPV2ETHEREUMWithdrawDTO.prototype['block_range'] = undefined;
...
export default UNISWAPV2ETHEREUMWithdrawDTO;
