...
/**
 * The SUSHISWAPV3ETHEREUMPositionDTO model module.
 * @module model/SUSHISWAPV3ETHEREUMPositionDTO
 * @version v1
 */
class SUSHISWAPV3ETHEREUMPositionDTO {
    /**
     * Constructs a new <code>SUSHISWAPV3ETHEREUMPositionDTO</code>.
     * 
     * @alias module:model/SUSHISWAPV3ETHEREUMPositionDTO
     */
    constructor() { 
        
        SUSHISWAPV3ETHEREUMPositionDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SUSHISWAPV3ETHEREUMPositionDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SUSHISWAPV3ETHEREUMPositionDTO} obj Optional instance to populate.
     * @return {module:model/SUSHISWAPV3ETHEREUMPositionDTO} The populated <code>SUSHISWAPV3ETHEREUMPositionDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SUSHISWAPV3ETHEREUMPositionDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>SUSHISWAPV3ETHEREUMPositionDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SUSHISWAPV3ETHEREUMPositionDTO</code>.
     */
 ...
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['block_number'] = undefined;

/**
 * (account address)-(market address)-(count)
 * @member {String} id
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['id'] = undefined;

/**
 * Account that owns this position
 * @member {String} account
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['account'] = undefined;

/**
 * The liquidity pool in which this position was opened
 * @member {String} pool
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['pool'] = undefined;

/**
 * The hash of the transaction that opened this position
 * @member {String} hash_opened
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['hash_opened'] = undefined;

/**
 * The hash of the transaction that closed this position
 * @member {String} hash_closed
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['hash_closed'] = undefined;

/**
 * Block number of when the position was opened
 * @member {String} block_number_opened
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['block_number_opened'] = undefined;

/**
 * Timestamp when the position was opened
 * @member {String} timestamp_opened
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['timestamp_opened'] = undefined;

/**
 * Block number of when the position was closed (0 if still open)
 * @member {String} block_number_closed
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['block_number_closed'] = undefined;

/**
 * Timestamp when the position was closed (0 if still open)
 * @member {String} timestamp_closed
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['timestamp_closed'] = undefined;

/**
 * lower tick of the position
 * @member {String} tick_lower
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['tick_lower'] = undefined;

/**
 * upper tick of the position
 * @member {String} tick_upper
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['tick_upper'] = undefined;

/**
 * Token that is to represent ownership of liquidity
 * @member {String} liquidity_token
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['liquidity_token'] = undefined;

/**
 * Type of token used to track liquidity
 * @member {String} liquidity_token_type
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['liquidity_token_type'] = undefined;

/**
 * total position liquidity
 * @member {String} liquidity
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['liquidity'] = undefined;

/**
 * total position liquidity in USD
 * @member {String} liquidity_usd
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['liquidity_usd'] = undefined;

/**
 * amount of tokens ever deposited to position
 * @member {Array.<String>} cumulative_deposit_token_amounts
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['cumulative_deposit_token_amounts'] = undefined;

/**
 * amount of tokens in USD deposited to position
 * @member {String} cumulative_deposit_usd
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['cumulative_deposit_usd'] = undefined;

/**
 * amount of tokens ever withdrawn from position (without fees)
 * @member {Array.<String>} cumulative_withdraw_token_amounts
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['cumulative_withdraw_token_amounts'] = undefined;

/**
 * amount of tokens in USD withdrawn from position (without fees)
 * @member {String} cumulative_withdraw_usd
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['cumulative_withdraw_usd'] = undefined;

/**
 * Total reward token accumulated under this position, in USD
 * @member {Array.<String>} cumulative_reward_usd
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['cumulative_reward_usd'] = undefined;

/**
 * Number of deposits related to this position
 * @member {Number} deposit_count
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['deposit_count'] = undefined;

/**
 * Number of withdrawals related to this position
 * @member {Number} withdraw_count
 */
SUSHISWAPV3ETHEREUMPositionDTO.prototype['withdraw_count'] = undefined;
...
export default SUSHISWAPV3ETHEREUMPositionDTO;
