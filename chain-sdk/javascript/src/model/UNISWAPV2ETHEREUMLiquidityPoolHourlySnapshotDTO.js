...
/**
 * The UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO model module.
 * @module model/UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO
 * @version v1
 */
class UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO {
    /**
     * Constructs a new <code>UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     * 
     * @alias module:model/UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO
     */
    constructor() { 
        
        UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO} obj Optional instance to populate.
     * @return {module:model/UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO} The populated <code>UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     */
 ...
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {String} block_range
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['block_range'] = undefined;

/**
 * (smart contract address of the pool)-(# of hours since Unix epoch time)
 * @member {String} id
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['id'] = undefined;

/**
 * The protocol this snapshot belongs to
 * @member {String} protocol
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['protocol'] = undefined;

/**
 * The pool this snapshot belongs to
 * @member {String} pool
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['pool'] = undefined;

/**
 * Timestamp of this snapshot
 * @member {String} timestamp
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['timestamp'] = undefined;

/**
 * Current TVL (Total Value Locked) of this pool
 * @member {String} total_value_locked_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['total_value_locked_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} cumulative_supply_side_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_supply_side_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} hourly_supply_side_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_supply_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} cumulative_protocol_side_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_protocol_side_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} hourly_protocol_side_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_protocol_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool.
 * @member {String} cumulative_total_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_total_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool.
 * @member {String} hourly_total_revenue_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_total_revenue_usd'] = undefined;

/**
 * All trade volume occurred in a given hour, in USD
 * @member {String} hourly_volume_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_usd'] = undefined;

/**
 * All trade volume occurred in a given hour for a specific input token, in native amount. The ordering should be the same as the pool's 'inputTokens' field.
 * @member {Array.<String>} hourly_volume_by_token_amount
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_by_token_amount'] = undefined;

/**
 * All trade volume occurred in a given hour for a specific input token, in native amount. The ordering should be the same as the pool's 'inputTokens' field.
 * @member {Array.<String>} hourly_volume_by_token_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_by_token_usd'] = undefined;

/**
 * All historical trade volume occurred in this pool, in USD
 * @member {String} cumulative_volume_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_volume_usd'] = undefined;

/**
 * Amount of input tokens in the pool. The ordering should be the same as the pool's `inputTokens` field
 * @member {Array.<String>} input_token_balances
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['input_token_balances'] = undefined;

/**
 * Weights of input tokens in the liquidity pool in percentage values. For example, 50/50 for Uniswap pools, 48.2/51.8 for a Curve pool, 10/10/80 for a Balancer pool
 * @member {Array.<String>} input_token_weights
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['input_token_weights'] = undefined;
 ...
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['output_token_supply'] = undefined;

/**
 * Price per share of output token in USD
 * @member {String} output_token_price_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['output_token_price_usd'] = undefined;

/**
 * Total supply of output tokens that are staked (usually in the MasterChef contract). Used to calculate reward APY.
 * @member {String} staked_output_token_amount
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['staked_output_token_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day (not hour), in token's native amount. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_amount
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['reward_token_emissions_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day (not hour), in USD value. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_usd
 */
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['reward_token_emissions_usd'] = undefined;
...
export default UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO;
