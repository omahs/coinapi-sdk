...
/**
 * The SUSHISWAPV3ETHEREUMWithdrawDTO model module.
 * @module model/SUSHISWAPV3ETHEREUMWithdrawDTO
 * @version v1
 */
class SUSHISWAPV3ETHEREUMWithdrawDTO {
    /**
     * Constructs a new <code>SUSHISWAPV3ETHEREUMWithdrawDTO</code>.
     * 
     * @alias module:model/SUSHISWAPV3ETHEREUMWithdrawDTO
     */
    constructor() { 
        
        SUSHISWAPV3ETHEREUMWithdrawDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SUSHISWAPV3ETHEREUMWithdrawDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SUSHISWAPV3ETHEREUMWithdrawDTO} obj Optional instance to populate.
     * @return {module:model/SUSHISWAPV3ETHEREUMWithdrawDTO} The populated <code>SUSHISWAPV3ETHEREUMWithdrawDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SUSHISWAPV3ETHEREUMWithdrawDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>SUSHISWAPV3ETHEREUMWithdrawDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SUSHISWAPV3ETHEREUMWithdrawDTO</code>.
     */
 ...
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['block_number'] = undefined;

/**
 * (transaction hash)-(log index)
 * @member {String} id
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['id'] = undefined;

/**
 * Transaction hash of the transaction that emitted this event
 * @member {String} hash
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['hash'] = undefined;

/**
 * Nonce of the transaction that emitted this event
 * @member {String} nonce
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['nonce'] = undefined;

/**
 * Event log index. For transactions that don't emit event, create arbitrary index starting from 0
 * @member {Number} log_index
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['log_index'] = undefined;

/**
 * Gas limit of the transaction that emitted this event
 * @member {String} gas_limit
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['gas_limit'] = undefined;

/**
 * Gas used in this transaction. (Optional because not every chain will support this)
 * @member {String} gas_used
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['gas_used'] = undefined;

/**
 * Gas price of the transaction that emitted this event
 * @member {String} gas_price
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['gas_price'] = undefined;

/**
 * The protocol this transaction belongs to
 * @member {String} protocol
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['protocol'] = undefined;

/**
 * Account that emitted this event
 * @member {String} account
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['account'] = undefined;

/**
 * The user position changed by this event
 * @member {String} position
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['position'] = undefined;

/**
 * lower tick of position
 * @member {String} tick_lower
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['tick_lower'] = undefined;

/**
 * upper tick of position
 * @member {String} tick_upper
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['tick_upper'] = undefined;

/**
 * The pool involving this event
 * @member {String} pool
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['pool'] = undefined;

/**
 * Timestamp of this event
 * @member {String} timestamp
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['timestamp'] = undefined;

/**
 * Amount of liquidity burned
 * @member {String} liquidity
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['liquidity'] = undefined;

/**
 * Input tokens of the pool (not input tokens of the event/transaction). E.g. WETH and USDC from a WETH-USDC pool
 * @member {Array.<String>} input_tokens
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['input_tokens'] = undefined;

/**
 * Amount of input tokens in the token's native unit
 * @member {Array.<String>} input_token_amounts
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['input_token_amounts'] = undefined;

/**
 * Amount of input tokens in the liquidity pool
 * @member {Array.<String>} reserve_amounts
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['reserve_amounts'] = undefined;

/**
 * USD-normalized value of the transaction of the underlying (e.g. sum of tokens withdrawn from a pool)
 * @member {String} amount_usd
 */
SUSHISWAPV3ETHEREUMWithdrawDTO.prototype['amount_usd'] = undefined;
...
export default SUSHISWAPV3ETHEREUMWithdrawDTO;
