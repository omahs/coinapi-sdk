...
/**
 * The PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO model module.
 * @module model/PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO
 * @version v1
 */
class PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO {
    /**
     * Constructs a new <code>PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     * 
     * @alias module:model/PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO
     */
    constructor() { 
        
        PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO} obj Optional instance to populate.
     * @return {module:model/PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO} The populated <code>PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO</code>.
     */
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['vid'] = undefined;

/**
 * (Smart contract address of the pool)-( # of hours since Unix epoch time)
 * @member {String} id
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['id'] = undefined;

/**
 * Number of hours since Unix epoch time
 * @member {Number} hour
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hour'] = undefined;

/**
 * The protocol this snapshot belongs to
 * @member {String} protocol
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['protocol'] = undefined;

/**
 * The pool this snapshot belongs to
 * @member {String} pool
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['pool'] = undefined;

/**
 * Current tick representing the price of token0/token1
 * @member {String} tick
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['tick'] = undefined;

/**
 * Current TVL (Total Value Locked) of this pool
 * @member {String} total_value_locked_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['total_value_locked_usd'] = undefined;

/**
 * The sum of all active and non-active liquidity for this pool.
 * @member {String} total_liquidity
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['total_liquidity'] = undefined;

/**
 * The sum of all active and non-active liquidity in USD for this pool.
 * @member {String} total_liquidity_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['total_liquidity_usd'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['active_liquidity'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['active_liquidity_usd'] = undefined;

/**
 * All protocol-side value locked in token amounts that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_protocol_side_token_amounts
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['uncollected_protocol_side_token_amounts'] = undefined;

/**
 * All protocol-side value locking in USD that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_protocol_side_values_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['uncollected_protocol_side_values_usd'] = undefined;

/**
 * All supply-side value locked in token amounts that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_supply_side_token_amounts
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['uncollected_supply_side_token_amounts'] = undefined;

/**
 * All supply-side value locked in USD that remains uncollected and unused in the pool.
 * @member {Array.<String>} uncollected_supply_side_values_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['uncollected_supply_side_values_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} cumulative_supply_side_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_supply_side_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool, accrued to the supply side.
 * @member {String} hourly_supply_side_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_supply_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} cumulative_protocol_side_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_protocol_side_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool, accrued to the protocol.
 * @member {String} hourly_protocol_side_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_protocol_side_revenue_usd'] = undefined;

/**
 * All revenue generated by the liquidity pool.
 * @member {String} cumulative_total_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_total_revenue_usd'] = undefined;

/**
 * Hourly revenue generated by the liquidity pool.
 * @member {String} hourly_total_revenue_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_total_revenue_usd'] = undefined;

/**
 * All historical trade volume occurred in this pool, in USD.
 * @member {String} cumulative_volume_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_volume_usd'] = undefined;

/**
 * All trade volume occurred in a given hour, in USD.
 * @member {String} hourly_volume_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_usd'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_volume_by_token_amount'] = undefined;

/**
 * All trade volume occurred in a given hour for a specific input token, in native amount. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} hourly_volume_by_token_amount
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_by_token_amount'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_volume_by_token_usd'] = undefined;
 ...
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_volume_by_token_usd'] = undefined;

/**
 * Amount of input tokens in the pool. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} input_token_balances
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['input_token_balances'] = undefined;

/**
 * Amount of input tokens in USD in the pool. The ordering should be the same as the pool's `inputTokens` field.
 * @member {Array.<String>} input_token_balances_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['input_token_balances_usd'] = undefined;

/**
 * Weights of input tokens in the liquidity pool in percentage values. For example, 50/50 for Uniswap pools, 48.2/51.8 for a Curve pool, 10/10/80 for a Balancer pool.
 * @member {Array.<String>} input_token_weights
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['input_token_weights'] = undefined;

/**
 * Total supply of output tokens that are staked (usually in the MasterChef contract). Used to calculate reward APY.
 * @member {String} staked_output_token_amount
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['staked_output_token_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day (not hour), in token's native amount. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_amount
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['reward_token_emissions_amount'] = undefined;

/**
 * Per-block reward token emission as of the current block normalized to a day (not hour), in USD value. This should be ideally calculated as the theoretical rate instead of the realized amount.
 * @member {Array.<String>} reward_token_emissions_usd
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['reward_token_emissions_usd'] = undefined;

/**
 * Total number of deposits (add liquidity)
 * @member {Number} cumulative_deposit_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_deposit_count'] = undefined;

/**
 * Total number of deposits (add liquidity) in an hour
 * @member {Number} hourly_deposit_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_deposit_count'] = undefined;

/**
 * Total number of withdrawals (remove liquidity)
 * @member {Number} cumulative_withdraw_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_withdraw_count'] = undefined;

/**
 * Total number of withdrawals (remove liquidity) in an hour
 * @member {Number} hourly_withdraw_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_withdraw_count'] = undefined;

/**
 * Total number of trades (swaps)
 * @member {Number} cumulative_swap_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['cumulative_swap_count'] = undefined;

/**
 * Total number of trades (swaps) in an hour
 * @member {Number} hourly_swap_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['hourly_swap_count'] = undefined;

/**
 * Number of positions in this market
 * @member {Number} position_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['position_count'] = undefined;

/**
 * Number of open positions in this market
 * @member {Number} open_position_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['open_position_count'] = undefined;

/**
 * Number of closed positions in this market
 * @member {Number} closed_position_count
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['closed_position_count'] = undefined;

/**
 * Timestamp of when this snapshot was taken/last modified (May be taken after interval has passed)
 * @member {String} timestamp
 */
PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO.prototype['timestamp'] = undefined;
...
export default PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO;
