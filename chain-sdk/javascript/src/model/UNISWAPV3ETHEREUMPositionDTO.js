...
/**
 * The UNISWAPV3ETHEREUMPositionDTO model module.
 * @module model/UNISWAPV3ETHEREUMPositionDTO
 * @version v1
 */
class UNISWAPV3ETHEREUMPositionDTO {
    /**
     * Constructs a new <code>UNISWAPV3ETHEREUMPositionDTO</code>.
     * 
     * @alias module:model/UNISWAPV3ETHEREUMPositionDTO
     */
    constructor() { 
        
        UNISWAPV3ETHEREUMPositionDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UNISWAPV3ETHEREUMPositionDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UNISWAPV3ETHEREUMPositionDTO} obj Optional instance to populate.
     * @return {module:model/UNISWAPV3ETHEREUMPositionDTO} The populated <code>UNISWAPV3ETHEREUMPositionDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UNISWAPV3ETHEREUMPositionDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UNISWAPV3ETHEREUMPositionDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UNISWAPV3ETHEREUMPositionDTO</code>.
     */
 ...
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {Number} vid
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['vid'] = undefined;

/**
 * (account address)-(market address)-(count)
 * @member {String} id
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['id'] = undefined;

/**
 * Account that owns this position
 * @member {String} account
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['account'] = undefined;

/**
 * The liquidity pool in which this position was opened
 * @member {String} pool
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['pool'] = undefined;

/**
 * The hash of the transaction that opened this position
 * @member {String} hash_opened
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['hash_opened'] = undefined;

/**
 * The hash of the transaction that closed this position
 * @member {String} hash_closed
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['hash_closed'] = undefined;

/**
 * Block number of when the position was opened
 * @member {String} block_number_opened
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['block_number_opened'] = undefined;

/**
 * Timestamp when the position was opened
 * @member {String} timestamp_opened
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['timestamp_opened'] = undefined;

/**
 * Block number of when the position was closed (0 if still open)
 * @member {String} block_number_closed
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['block_number_closed'] = undefined;

/**
 * Timestamp when the position was closed (0 if still open)
 * @member {String} timestamp_closed
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['timestamp_closed'] = undefined;

/**
 * lower tick of the position
 * @member {String} tick_lower
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['tick_lower'] = undefined;

/**
 * upper tick of the position
 * @member {String} tick_upper
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['tick_upper'] = undefined;

/**
 * Token that is to represent ownership of liquidity
 * @member {String} liquidity_token
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['liquidity_token'] = undefined;

/**
 * Type of token used to track liquidity
 * @member {String} liquidity_token_type
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['liquidity_token_type'] = undefined;

/**
 * total position liquidity
 * @member {String} liquidity
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['liquidity'] = undefined;

/**
 * total position liquidity in USD
 * @member {String} liquidity_usd
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['liquidity_usd'] = undefined;

/**
 * amount of tokens ever deposited to position
 * @member {Array.<String>} cumulative_deposit_token_amounts
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['cumulative_deposit_token_amounts'] = undefined;

/**
 * amount of tokens in USD deposited to position
 * @member {String} cumulative_deposit_usd
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['cumulative_deposit_usd'] = undefined;

/**
 * amount of tokens ever withdrawn from position (without fees)
 * @member {Array.<String>} cumulative_withdraw_token_amounts
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['cumulative_withdraw_token_amounts'] = undefined;

/**
 * amount of tokens in USD withdrawn from position (without fees)
 * @member {String} cumulative_withdraw_usd
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['cumulative_withdraw_usd'] = undefined;

/**
 * Total reward token accumulated under this position, in USD
 * @member {Array.<String>} cumulative_reward_usd
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['cumulative_reward_usd'] = undefined;

/**
 * Number of deposits related to this position
 * @member {Number} deposit_count
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['deposit_count'] = undefined;

/**
 * Number of withdrawals related to this position
 * @member {Number} withdraw_count
 */
UNISWAPV3ETHEREUMPositionDTO.prototype['withdraw_count'] = undefined;
...
export default UNISWAPV3ETHEREUMPositionDTO;
