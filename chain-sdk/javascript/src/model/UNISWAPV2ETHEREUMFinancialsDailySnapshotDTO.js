...
/**
 * The UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO model module.
 * @module model/UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO
 * @version v1
 */
class UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO {
    /**
     * Constructs a new <code>UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO</code>.
     * Daily financial metrics for Uniswap V2.
     * @alias module:model/UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO
     */
    constructor() { 
        
        UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO} obj Optional instance to populate.
     * @return {module:model/UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO} The populated <code>UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO</code>.
     */
 ...
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['entry_time'] = undefined;

/**
 * @member {Date} recv_time
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['recv_time'] = undefined;

/**
 * Number of block in which entity was recorded.
 * @member {Number} block_number
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['block_number'] = undefined;

/**
 * 
 * @member {String} block_range
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['block_range'] = undefined;

/**
 * ID is # of days since Unix epoch time
 * @member {String} id
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['id'] = undefined;

/**
 * Protocol this snapshot is associated with
 * @member {String} protocol
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['protocol'] = undefined;

/**
 * Current TVL (Total Value Locked) of the entire protocol
 * @member {String} total_value_locked_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['total_value_locked_usd'] = undefined;

/**
 * Current PCV (Protocol Controlled Value). Only relevant for protocols with PCV.
 * @member {String} protocol_controlled_value_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['protocol_controlled_value_usd'] = undefined;

/**
 * All trade volume occurred in a given day, in USD
 * @member {String} daily_volume_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['daily_volume_usd'] = undefined;

/**
 * All historical trade volume in USD
 * @member {String} cumulative_volume_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['cumulative_volume_usd'] = undefined;

/**
 * Revenue claimed by suppliers to the protocol. LPs on DEXs (e.g. 0.25% of the swap fee in Sushiswap). Depositors on Lending Protocols. NFT sellers on OpenSea.
 * @member {String} daily_supply_side_revenue_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['daily_supply_side_revenue_usd'] = undefined;

/**
 * Revenue claimed by suppliers to the protocol. LPs on DEXs (e.g. 0.25% of the swap fee in Sushiswap). Depositors on Lending Protocols. NFT sellers on OpenSea.
 * @member {String} cumulative_supply_side_revenue_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['cumulative_supply_side_revenue_usd'] = undefined;

/**
 * Gross revenue for the protocol (revenue claimed by protocol). Examples: AMM protocol fee (Sushi’s 0.05%). OpenSea 10% sell fee.
 * @member {String} daily_protocol_side_revenue_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['daily_protocol_side_revenue_usd'] = undefined;

/**
 * Gross revenue for the protocol (revenue claimed by protocol). Examples: AMM protocol fee (Sushi’s 0.05%). OpenSea 10% sell fee.
 * @member {String} cumulative_protocol_side_revenue_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['cumulative_protocol_side_revenue_usd'] = undefined;
 ...
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['daily_total_revenue_usd'] = undefined;

/**
 * All revenue generated by the protocol. e.g. 0.30% of swap fee in Sushiswap, all yield generated by Yearn.
 * @member {String} cumulative_total_revenue_usd
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['cumulative_total_revenue_usd'] = undefined;

/**
 * Timestamp of this snapshot
 * @member {String} timestamp
 */
UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO.prototype['timestamp'] = undefined;
...
export default UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO;
