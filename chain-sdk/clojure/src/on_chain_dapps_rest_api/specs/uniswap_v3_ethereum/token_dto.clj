(ns on-chain-dapps-rest-api.specs.uniswap-v3-ethereum/token-dto
...
(def uniswap-v3-ethereum/token-dto-data
  {
...
(def uniswap-v3-ethereum/token-dto-spec
  (ds/spec
    {:name ::uniswap-v3-ethereum/token-dto
     :spec uniswap-v3-ethereum/token-dto-data}))
