(ns on-chain-dapps-rest-api.specs.uniswap-v3-ethereum/deposit-dto
...
(def uniswap-v3-ethereum/deposit-dto-data
  {
...
(def uniswap-v3-ethereum/deposit-dto-spec
  (ds/spec
    {:name ::uniswap-v3-ethereum/deposit-dto
     :spec uniswap-v3-ethereum/deposit-dto-data}))
