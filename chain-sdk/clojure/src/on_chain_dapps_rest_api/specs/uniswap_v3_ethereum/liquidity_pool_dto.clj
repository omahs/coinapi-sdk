(ns on-chain-dapps-rest-api.specs.uniswap-v3-ethereum/liquidity-pool-dto
...
(def uniswap-v3-ethereum/liquidity-pool-dto-data
  {
...
(def uniswap-v3-ethereum/liquidity-pool-dto-spec
  (ds/spec
    {:name ::uniswap-v3-ethereum/liquidity-pool-dto
     :spec uniswap-v3-ethereum/liquidity-pool-dto-data}))
