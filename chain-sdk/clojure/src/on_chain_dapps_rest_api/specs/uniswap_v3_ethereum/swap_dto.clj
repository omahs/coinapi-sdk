(ns on-chain-dapps-rest-api.specs.uniswap-v3-ethereum/swap-dto
...
(def uniswap-v3-ethereum/swap-dto-data
  {
...
(def uniswap-v3-ethereum/swap-dto-spec
  (ds/spec
    {:name ::uniswap-v3-ethereum/swap-dto
     :spec uniswap-v3-ethereum/swap-dto-data}))
