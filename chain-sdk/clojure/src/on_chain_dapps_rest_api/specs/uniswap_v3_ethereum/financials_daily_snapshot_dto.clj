(ns on-chain-dapps-rest-api.specs.uniswap-v3-ethereum/financials-daily-snapshot-dto
...
(def uniswap-v3-ethereum/financials-daily-snapshot-dto-data
  {
...
(def uniswap-v3-ethereum/financials-daily-snapshot-dto-spec
  (ds/spec
    {:name ::uniswap-v3-ethereum/financials-daily-snapshot-dto
     :spec uniswap-v3-ethereum/financials-daily-snapshot-dto-data}))
