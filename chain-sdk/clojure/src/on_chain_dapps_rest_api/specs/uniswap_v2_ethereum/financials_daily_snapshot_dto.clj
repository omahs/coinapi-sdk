(ns on-chain-dapps-rest-api.specs.uniswap-v2-ethereum/financials-daily-snapshot-dto
...
(def uniswap-v2-ethereum/financials-daily-snapshot-dto-data
  {
...
(def uniswap-v2-ethereum/financials-daily-snapshot-dto-spec
  (ds/spec
    {:name ::uniswap-v2-ethereum/financials-daily-snapshot-dto
     :spec uniswap-v2-ethereum/financials-daily-snapshot-dto-data}))
