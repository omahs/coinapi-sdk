(ns on-chain-dapps-rest-api.specs.uniswap-v2-ethereum/deposit-dto
...
(def uniswap-v2-ethereum/deposit-dto-data
  {
...
(def uniswap-v2-ethereum/deposit-dto-spec
  (ds/spec
    {:name ::uniswap-v2-ethereum/deposit-dto
     :spec uniswap-v2-ethereum/deposit-dto-data}))
