(ns on-chain-dapps-rest-api.specs.uniswap-v2-ethereum/dex-amm-protocol-dto
...
(def uniswap-v2-ethereum/dex-amm-protocol-dto-data
  {
...
(def uniswap-v2-ethereum/dex-amm-protocol-dto-spec
  (ds/spec
    {:name ::uniswap-v2-ethereum/dex-amm-protocol-dto
     :spec uniswap-v2-ethereum/dex-amm-protocol-dto-data}))
