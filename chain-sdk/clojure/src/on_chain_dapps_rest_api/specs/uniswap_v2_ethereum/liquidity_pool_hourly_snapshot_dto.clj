(ns on-chain-dapps-rest-api.specs.uniswap-v2-ethereum/liquidity-pool-hourly-snapshot-dto
...
(def uniswap-v2-ethereum/liquidity-pool-hourly-snapshot-dto-data
  {
...
(def uniswap-v2-ethereum/liquidity-pool-hourly-snapshot-dto-spec
  (ds/spec
    {:name ::uniswap-v2-ethereum/liquidity-pool-hourly-snapshot-dto
     :spec uniswap-v2-ethereum/liquidity-pool-hourly-snapshot-dto-data}))
