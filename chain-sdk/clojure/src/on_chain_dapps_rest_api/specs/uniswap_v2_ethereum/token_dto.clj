(ns on-chain-dapps-rest-api.specs.uniswap-v2-ethereum/token-dto
...
(def uniswap-v2-ethereum/token-dto-data
  {
...
(def uniswap-v2-ethereum/token-dto-spec
  (ds/spec
    {:name ::uniswap-v2-ethereum/token-dto
     :spec uniswap-v2-ethereum/token-dto-data}))
