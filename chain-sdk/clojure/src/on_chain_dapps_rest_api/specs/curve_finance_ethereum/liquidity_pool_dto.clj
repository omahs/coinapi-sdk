(ns on-chain-dapps-rest-api.specs.curve-finance-ethereum/liquidity-pool-dto
...
(def curve-finance-ethereum/liquidity-pool-dto-data
  {
   ...
   (ds/opt :input_tokens_ordered) (s/coll-of string?)
   ...
   (ds/opt :gauge_address) string?
   (ds/opt :evaluated_ask) float?
   })

(def curve-finance-ethereum/liquidity-pool-dto-spec
  (ds/spec
    {:name ::curve-finance-ethereum/liquidity-pool-dto
     :spec curve-finance-ethereum/liquidity-pool-dto-data}))
