(ns on-chain-dapps-rest-api.specs.curve-finance-ethereum/liquidity-pool-daily-snapshot-dto
...
(def curve-finance-ethereum/liquidity-pool-daily-snapshot-dto-data
  {
...
(def curve-finance-ethereum/liquidity-pool-daily-snapshot-dto-spec
  (ds/spec
    {:name ::curve-finance-ethereum/liquidity-pool-daily-snapshot-dto
     :spec curve-finance-ethereum/liquidity-pool-daily-snapshot-dto-data}))
