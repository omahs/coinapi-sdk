(ns on-chain-dapps-rest-api.specs.curve-finance-ethereum/deposit-dto
...
(def curve-finance-ethereum/deposit-dto-data
  {
...
(def curve-finance-ethereum/deposit-dto-spec
  (ds/spec
    {:name ::curve-finance-ethereum/deposit-dto
     :spec curve-finance-ethereum/deposit-dto-data}))
