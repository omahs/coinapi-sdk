(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/dex-amm-protocol-dto
...
(def pancakeswap-v3-ethereum/dex-amm-protocol-dto-data
  {
...
(def pancakeswap-v3-ethereum/dex-amm-protocol-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/dex-amm-protocol-dto
     :spec pancakeswap-v3-ethereum/dex-amm-protocol-dto-data}))
