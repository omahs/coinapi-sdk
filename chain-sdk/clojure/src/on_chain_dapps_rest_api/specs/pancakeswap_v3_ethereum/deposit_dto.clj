(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/deposit-dto
...
(def pancakeswap-v3-ethereum/deposit-dto-data
  {
...
(def pancakeswap-v3-ethereum/deposit-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/deposit-dto
     :spec pancakeswap-v3-ethereum/deposit-dto-data}))
