(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/liquidity-pool-daily-snapshot-dto
...
(def pancakeswap-v3-ethereum/liquidity-pool-daily-snapshot-dto-data
  {
...
(def pancakeswap-v3-ethereum/liquidity-pool-daily-snapshot-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/liquidity-pool-daily-snapshot-dto
     :spec pancakeswap-v3-ethereum/liquidity-pool-daily-snapshot-dto-data}))
