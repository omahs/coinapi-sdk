(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/position-snapshot-dto
...
(def pancakeswap-v3-ethereum/position-snapshot-dto-data
  {
...
(def pancakeswap-v3-ethereum/position-snapshot-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/position-snapshot-dto
     :spec pancakeswap-v3-ethereum/position-snapshot-dto-data}))
