(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/swap-dto
...
(def pancakeswap-v3-ethereum/swap-dto-data
  {
...
(def pancakeswap-v3-ethereum/swap-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/swap-dto
     :spec pancakeswap-v3-ethereum/swap-dto-data}))
