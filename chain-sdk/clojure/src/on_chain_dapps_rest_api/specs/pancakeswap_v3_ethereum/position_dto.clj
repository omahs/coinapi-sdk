(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/position-dto
...
(def pancakeswap-v3-ethereum/position-dto-data
  {
...
(def pancakeswap-v3-ethereum/position-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/position-dto
     :spec pancakeswap-v3-ethereum/position-dto-data}))
