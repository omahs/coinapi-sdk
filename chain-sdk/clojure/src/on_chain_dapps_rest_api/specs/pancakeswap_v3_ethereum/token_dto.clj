(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/token-dto
...
(def pancakeswap-v3-ethereum/token-dto-data
  {
...
(def pancakeswap-v3-ethereum/token-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/token-dto
     :spec pancakeswap-v3-ethereum/token-dto-data}))
