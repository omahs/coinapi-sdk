(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/withdraw-dto
...
(def pancakeswap-v3-ethereum/withdraw-dto-data
  {
...
(def pancakeswap-v3-ethereum/withdraw-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/withdraw-dto
     :spec pancakeswap-v3-ethereum/withdraw-dto-data}))
