(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto
...
(def pancakeswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto-data
  {
...
(def pancakeswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto
     :spec pancakeswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto-data}))
