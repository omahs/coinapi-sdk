(ns on-chain-dapps-rest-api.specs.pancakeswap-v3-ethereum/tick-dto
...
(def pancakeswap-v3-ethereum/tick-dto-data
  {
...
(def pancakeswap-v3-ethereum/tick-dto-spec
  (ds/spec
    {:name ::pancakeswap-v3-ethereum/tick-dto
     :spec pancakeswap-v3-ethereum/tick-dto-data}))
