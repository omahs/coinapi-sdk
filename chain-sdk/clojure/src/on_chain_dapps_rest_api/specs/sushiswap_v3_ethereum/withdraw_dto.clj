(ns on-chain-dapps-rest-api.specs.sushiswap-v3-ethereum/withdraw-dto
...
(def sushiswap-v3-ethereum/withdraw-dto-data
  {
...
(def sushiswap-v3-ethereum/withdraw-dto-spec
  (ds/spec
    {:name ::sushiswap-v3-ethereum/withdraw-dto
     :spec sushiswap-v3-ethereum/withdraw-dto-data}))
