(ns on-chain-dapps-rest-api.specs.sushiswap-v3-ethereum/liquidity-pool-daily-snapshot-dto
...
(def sushiswap-v3-ethereum/liquidity-pool-daily-snapshot-dto-data
  {
...
(def sushiswap-v3-ethereum/liquidity-pool-daily-snapshot-dto-spec
  (ds/spec
    {:name ::sushiswap-v3-ethereum/liquidity-pool-daily-snapshot-dto
     :spec sushiswap-v3-ethereum/liquidity-pool-daily-snapshot-dto-data}))
