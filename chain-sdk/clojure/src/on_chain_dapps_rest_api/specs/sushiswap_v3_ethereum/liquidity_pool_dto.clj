(ns on-chain-dapps-rest-api.specs.sushiswap-v3-ethereum/liquidity-pool-dto
...
(def sushiswap-v3-ethereum/liquidity-pool-dto-data
  {
...
(def sushiswap-v3-ethereum/liquidity-pool-dto-spec
  (ds/spec
    {:name ::sushiswap-v3-ethereum/liquidity-pool-dto
     :spec sushiswap-v3-ethereum/liquidity-pool-dto-data}))
