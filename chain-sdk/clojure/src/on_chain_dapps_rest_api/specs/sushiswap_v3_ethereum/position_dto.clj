(ns on-chain-dapps-rest-api.specs.sushiswap-v3-ethereum/position-dto
...
(def sushiswap-v3-ethereum/position-dto-data
  {
...
(def sushiswap-v3-ethereum/position-dto-spec
  (ds/spec
    {:name ::sushiswap-v3-ethereum/position-dto
     :spec sushiswap-v3-ethereum/position-dto-data}))
