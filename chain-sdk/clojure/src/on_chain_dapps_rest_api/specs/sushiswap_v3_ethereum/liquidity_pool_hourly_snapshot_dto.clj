(ns on-chain-dapps-rest-api.specs.sushiswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto
...
(def sushiswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto-data
  {
...
(def sushiswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto-spec
  (ds/spec
    {:name ::sushiswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto
     :spec sushiswap-v3-ethereum/liquidity-pool-hourly-snapshot-dto-data}))
