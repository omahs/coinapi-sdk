...
#
package WWW::OpenAPIClient::Object::SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO;
...
__PACKAGE__->class_documentation({description => 'Represents a liquidity pool daily snapshot for Sushiswap V3.',
