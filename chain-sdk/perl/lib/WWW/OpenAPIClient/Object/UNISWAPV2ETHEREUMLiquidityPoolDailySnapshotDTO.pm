...
#
package WWW::OpenAPIClient::Object::UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO;
...
__PACKAGE__->class_documentation({description => 'Represents a liquidity pool daily snapshot for Uniswap V2.',
...
__PACKAGE__->method_documentation({
    ...
    'id' => {
        datatype => 'string',
        base_name => 'id',
        description => '(smart contract address of the pool)-(# of days since Unix epoch time)',
        format => '',
        read_only => '',
            },
    'protocol' => {
    ...
    'output_token_supply' => {
        ...
        description => 'Total supply of output token. Note that certain DEXes don&#39;t have an output token (e.g. Bancor).',
        format => '',
        read_only => '',
            },
