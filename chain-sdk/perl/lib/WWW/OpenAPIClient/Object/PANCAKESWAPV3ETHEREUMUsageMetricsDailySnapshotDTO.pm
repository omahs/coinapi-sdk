...
#
package WWW::OpenAPIClient::Object::PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO;
...
__PACKAGE__->method_documentation({
    ...
    'id' => {
        datatype => 'string',
        base_name => 'id',
        description => 'ID is # of days since Unix epoch time',
        format => '',
        read_only => '',
            },
    'day' => {
    ...
    'protocol' => {
        datatype => 'string',
        base_name => 'protocol',
        description => 'Protocol this snapshot is associated with',
        format => '',
        read_only => '',
            },
    'daily_active_users' => {
        datatype => 'int',
        base_name => 'daily_active_users',
    ...
    'daily_transaction_count' => {
        datatype => 'int',
        base_name => 'daily_transaction_count',
        description => 'Total number of transactions occurred in a day. Transactions include all entities that implement the Event interface.',
        format => '',
        read_only => '',
            },
    'total_pool_count' => {
    ...
    'daily_deposit_count' => {
        ...
        description => 'Total number of deposits (add liquidity) in an day',
        format => '',
        read_only => '',
            },
    'daily_withdraw_count' => {
        ...
        description => 'Total number of withdrawals (remove liquidity) in an day',
        format => '',
        read_only => '',
            },
    'daily_swap_count' => {
        ...
        description => 'Total number of trades (swaps) in an day',
        format => '',
        read_only => '',
            },
    'timestamp' => {
