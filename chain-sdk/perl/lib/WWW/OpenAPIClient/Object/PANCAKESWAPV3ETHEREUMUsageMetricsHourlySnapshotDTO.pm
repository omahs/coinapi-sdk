...
#
package WWW::OpenAPIClient::Object::PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO;
...
__PACKAGE__->method_documentation({
    ...
    'id' => {
        datatype => 'string',
        base_name => 'id',
        description => '(# of hours since Unix epoch time)',
        format => '',
        read_only => '',
            },
    'hour' => {
    ...
    'hourly_active_users' => {
        datatype => 'int',
        base_name => 'hourly_active_users',
        description => 'Number of unique hourly active users',
        format => '',
        read_only => '',
            },
    ...
    'hourly_transaction_count' => {
        datatype => 'int',
        base_name => 'hourly_transaction_count',
        description => 'Total number of transactions occurred in an hour. Transactions include all entities that implement the Event interface.',
        format => '',
        read_only => '',
            },
