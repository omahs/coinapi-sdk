...
#
package WWW::OpenAPIClient::Object::CRYPTOPUNKSCollectionDailySnapshotDTO;
...
__PACKAGE__->method_documentation({
    ...
    'daily_min_sale_price' => {
        datatype => 'string',
        base_name => 'daily_min_sale_price',
        description => '',
        format => '',
        read_only => '',
            },
    'daily_max_sale_price' => {
        datatype => 'string',
        base_name => 'daily_max_sale_price',
        description => '',
        format => '',
        read_only => '',
            },
    'cumulative_trade_volume_eth' => {
        datatype => 'string',
        base_name => 'cumulative_trade_volume_eth',
        description => '',
        format => '',
        read_only => '',
            },
    'daily_trade_volume_eth' => {
        datatype => 'string',
        base_name => 'daily_trade_volume_eth',
        description => '',
        format => '',
        read_only => '',
            },
    'marketplace_revenue_eth' => {
        datatype => 'string',
        base_name => 'marketplace_revenue_eth',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'daily_traded_item_count' => {
        datatype => 'int',
        base_name => 'daily_traded_item_count',
        description => '',
        format => '',
        read_only => '',
            },
