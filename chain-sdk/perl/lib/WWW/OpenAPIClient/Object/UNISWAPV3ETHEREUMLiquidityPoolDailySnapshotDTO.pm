...
#
package WWW::OpenAPIClient::Object::UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO;
...
__PACKAGE__->class_documentation({description => 'Represents a liquidity pool daily snapshot for Uniswap V3.',
