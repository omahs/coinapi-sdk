...
#
package WWW::OpenAPIClient::Object::DexPriceDTO;
...
__PACKAGE__->class_documentation({description => 'Token price in conjuction with batch id.',
                                  class => 'DexPriceDTO',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'price_in_owl_numerator' => {
        datatype => 'string',
        base_name => 'price_in_owl_numerator',
        description => 'Price enumerator in OWL (derivative of the GNO token).',
        format => '',
        read_only => '',
            },
    'price_in_owl_denominator' => {
        datatype => 'string',
        base_name => 'price_in_owl_denominator',
        description => 'Price denominator in OWL (derivative of the GNO token).',
        format => '',
        read_only => '',
            },
    'volume' => {
