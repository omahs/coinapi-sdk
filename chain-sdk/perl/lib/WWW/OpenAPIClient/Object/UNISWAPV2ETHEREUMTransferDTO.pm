...
#
package WWW::OpenAPIClient::Object::UNISWAPV2ETHEREUMTransferDTO;
...
__PACKAGE__->method_documentation({
    ...
    'block_range' => {
        ...
        description => 'Entity is used to track data from the transfer events (execution of: deposit/withdraw, mint/burn).',
        format => '',
        read_only => '',
            },
    'id' => {
