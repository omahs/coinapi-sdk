...
#
package WWW::OpenAPIClient::Object::UniswapV3PositionSnapshotDTO;
...
__PACKAGE__->method_documentation({
    ...
    'position' => {
        datatype => 'string',
        base_name => 'position',
        description => 'Position of which the snap was taken of.',
        format => '',
        read_only => '',
            },
    'timestamp' => {
        datatype => 'string',
        base_name => 'timestamp',
        description => 'Timestamp of block in which the snap was created.',
        format => '',
        read_only => '',
            },
    'liquidity' => {
    ...
    'deposited_token_0' => {
        datatype => 'string',
        base_name => 'deposited_token_0',
        description => 'Amount of token 0 ever deposited to position.',
        format => '',
        read_only => '',
            },
    'deposited_token_1' => {
        datatype => 'string',
        base_name => 'deposited_token_1',
        description => 'Amount of token 1 ever deposited to position.',
        format => '',
        read_only => '',
            },
    'withdrawn_token_0' => {
        datatype => 'string',
        base_name => 'withdrawn_token_0',
        description => 'Amount of token 0 ever withdrawn from position (without fees).',
        format => '',
        read_only => '',
            },
    'withdrawn_token_1' => {
        datatype => 'string',
        base_name => 'withdrawn_token_1',
        description => 'Amount of token 1 ever withdrawn from position (without fees).',
        format => '',
        read_only => '',
            },
    ...
    'transaction' => {
        ...
        description => 'Transaction in which the snapshot was initialized.',
        format => '',
        read_only => '',
            },
    'fee_growth_inside_0_last_x128' => {
        datatype => 'string',
        base_name => 'fee_growth_inside_0_last_x128',
        description => 'Variable needed for fee computation.',
        format => '',
        read_only => '',
            },
    'fee_growth_inside_1_last_x128' => {
        datatype => 'string',
        base_name => 'fee_growth_inside_1_last_x128',
        description => 'Variable needed for fee computation.',
        format => '',
        read_only => '',
            },
