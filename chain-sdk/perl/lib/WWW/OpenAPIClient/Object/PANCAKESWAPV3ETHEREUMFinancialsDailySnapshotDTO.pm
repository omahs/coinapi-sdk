...
#
package WWW::OpenAPIClient::Object::PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO;
...
__PACKAGE__->class_documentation({description => 'Daily financial metrics for PancakeSwap V3.',
