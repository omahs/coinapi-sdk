...
#
package WWW::OpenAPIClient::Object::DexWithdrawRequestDTO;
...
__PACKAGE__->class_documentation({description => 'Withdraw request of an user',
...
__PACKAGE__->method_documentation({
    ...
    'withdrawable_from_batch_id' => {
        datatype => 'string',
        base_name => 'withdrawable_from_batch_id',
        description => '',
        format => '',
        read_only => '',
            },
