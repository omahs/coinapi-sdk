...
#
package WWW::OpenAPIClient::Object::CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO;
...
__PACKAGE__->class_documentation({description => 'Daily financial metrics for Curve finance.',
