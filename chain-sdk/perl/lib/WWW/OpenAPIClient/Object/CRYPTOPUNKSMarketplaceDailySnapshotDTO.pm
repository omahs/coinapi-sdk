...
#
package WWW::OpenAPIClient::Object::CRYPTOPUNKSMarketplaceDailySnapshotDTO;
...
__PACKAGE__->method_documentation({
    ...
    'daily_active_traders' => {
        datatype => 'int',
        base_name => 'daily_active_traders',
        description => '',
        format => '',
        read_only => '',
            },
    'daily_traded_collection_count' => {
        datatype => 'int',
        base_name => 'daily_traded_collection_count',
        description => '',
        format => '',
        read_only => '',
            },
