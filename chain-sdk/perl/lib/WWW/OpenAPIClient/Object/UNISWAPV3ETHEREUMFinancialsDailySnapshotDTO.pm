...
#
package WWW::OpenAPIClient::Object::UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO;
...
__PACKAGE__->class_documentation({description => 'Daily financial metrics for Uniswap V3.',
...
__PACKAGE__->method_documentation({
    ...
    'cumulative_volume_usd' => {
        ...
        description => 'All historical trade volume in USD',
        format => '',
        read_only => '',
            },
    ...
    'daily_protocol_side_revenue_usd' => {
        ...
        description => 'Gross revenue for the protocol (revenue claimed by the protocol). Examples: AMM protocol fee (Sushi’s 0.05%). OpenSea 10% sell fee.',
        format => '',
        read_only => '',
            },
    ...
    'timestamp' => {
        datatype => 'string',
        base_name => 'timestamp',
        description => 'Timestamp of when this snapshot was taken/last modified (May be taken after the interval has passed).',
        format => '',
        read_only => '',
            },
});
