...
#
package WWW::OpenAPIClient::Object::CURVEFINANCEETHEREUMDexAmmProtocolDTO;
...
__PACKAGE__->class_documentation({description => 'Entity for calculating daily/hourly active users.',
...
__PACKAGE__->method_documentation({
    ...
    'name' => {
        datatype => 'string',
        base_name => 'name',
        description => 'Name of the protocol, including version.',
        format => '',
        read_only => '',
            },
    'slug' => {
        datatype => 'string',
        base_name => 'slug',
        description => 'Slug of protocol, including version.',
        format => '',
        read_only => '',
            },
    'schema_version' => {
    ...
    'pool_ids' => {
        ...
        base_name => 'pool_ids',
        description => 'All pools that belong to this protocol',
        format => '',
        read_only => '',
            },
});
