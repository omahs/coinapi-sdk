...
#
package WWW::OpenAPIClient::Object::UniswapV3SwapDTO;
...
__PACKAGE__->class_documentation({description => 'Swap are created for each token swap within a pair.',
...
__PACKAGE__->method_documentation({
    ...
    'transaction' => {
        ...
        description => 'Pointer to transaction.',
        format => '',
        read_only => '',
            },
    'timestamp' => {
    ...
    'sender' => {
        datatype => 'string',
        base_name => 'sender',
        description => 'Sender of the swap.',
        format => '',
        read_only => '',
            },
    'recipient' => {
        datatype => 'string',
        base_name => 'recipient',
        description => 'Recipient of the swap.',
        format => '',
        read_only => '',
            },
    'origin' => {
        datatype => 'string',
        base_name => 'origin',
        description => 'Transaction origin: the EOA (Externally Owned Account) that initiated the transaction',
        format => '',
        read_only => '',
            },
    'amount_0' => {
        datatype => 'string',
        base_name => 'amount_0',
        description => 'Delta of token0 swapped.',
        format => '',
        read_only => '',
            },
    'amount_1' => {
        datatype => 'string',
        base_name => 'amount_1',
        description => 'Delta of token1 swapped.',
        format => '',
        read_only => '',
            },
    'amount_usd' => {
