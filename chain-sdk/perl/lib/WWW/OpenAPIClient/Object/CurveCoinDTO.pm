...
#
package WWW::OpenAPIClient::Object::CurveCoinDTO;
...
__PACKAGE__->method_documentation({
    ...
    'rate' => {
        datatype => 'string',
        base_name => 'rate',
        description => 'Exchange rate between this coin and the associated underlying coin within the pool.',
        format => '',
        read_only => '',
            },
    'updated' => {
