...
#
package WWW::OpenAPIClient::Object::UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO;
...
__PACKAGE__->class_documentation({description => 'Daily financial metrics for Uniswap V2.',
...
__PACKAGE__->method_documentation({
    ...
    'daily_total_revenue_usd' => {
        ...
        description => 'll revenue generated by the protocol. e.g. 0.30% of swap fee in Sushiswap, all yield generated by Yearn.',
        format => '',
        read_only => '',
            },
