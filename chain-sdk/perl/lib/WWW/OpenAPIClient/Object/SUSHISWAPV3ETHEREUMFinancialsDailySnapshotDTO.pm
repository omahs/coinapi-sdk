...
#
package WWW::OpenAPIClient::Object::SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO;
...
__PACKAGE__->class_documentation({description => 'Daily financial metrics for Sushiswap V3.',
