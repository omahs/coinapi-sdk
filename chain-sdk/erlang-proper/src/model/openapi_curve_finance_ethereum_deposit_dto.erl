...
-export([openapi_curve_finance_ethereum_deposit_dto/0]).

-export([openapi_curve_finance_ethereum_deposit_dto/1]).
...
openapi_curve_finance_ethereum_deposit_dto() ->
    openapi_curve_finance_ethereum_deposit_dto([]).

openapi_curve_finance_ethereum_deposit_dto(Fields) ->
