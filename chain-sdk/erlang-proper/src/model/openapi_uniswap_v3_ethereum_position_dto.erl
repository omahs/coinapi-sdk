...
-export([openapi_uniswap_v3_ethereum_position_dto/0]).

-export([openapi_uniswap_v3_ethereum_position_dto/1]).
...
openapi_uniswap_v3_ethereum_position_dto() ->
    openapi_uniswap_v3_ethereum_position_dto([]).

openapi_uniswap_v3_ethereum_position_dto(Fields) ->
