-module(openapi_curve_finance_ethereum_liquidity_pool_hourly_snapshot_dto).

-include("openapi.hrl").

-export([openapi_curve_finance_ethereum_liquidity_pool_hourly_snapshot_dto/0]).

-export([openapi_curve_finance_ethereum_liquidity_pool_hourly_snapshot_dto/1]).

-export_type([openapi_curve_finance_ethereum_liquidity_pool_hourly_snapshot_dto/0]).

-type openapi_curve_finance_ethereum_liquidity_pool_hourly_snapshot_dto() ::
  [ {'entry_time', datetime() }
  | {'recv_time', datetime() }
...
openapi_curve_finance_ethereum_liquidity_pool_hourly_snapshot_dto() ->
    openapi_curve_finance_ethereum_liquidity_pool_hourly_snapshot_dto([]).

openapi_curve_finance_ethereum_liquidity_pool_hourly_snapshot_dto(Fields) ->
