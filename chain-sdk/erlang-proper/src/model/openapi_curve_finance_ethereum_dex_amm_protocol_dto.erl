...
-export([openapi_curve_finance_ethereum_dex_amm_protocol_dto/0]).

-export([openapi_curve_finance_ethereum_dex_amm_protocol_dto/1]).
...
-type openapi_curve_finance_ethereum_dex_amm_protocol_dto() ::
  ...
  | {'pool_ids', list(binary()) }
  ].


openapi_curve_finance_ethereum_dex_amm_protocol_dto() ->
    openapi_curve_finance_ethereum_dex_amm_protocol_dto([]).

openapi_curve_finance_ethereum_dex_amm_protocol_dto(Fields) ->
