...
-export([openapi_uniswap_v2_ethereum_usage_metrics_daily_snapshot_dto/0]).

-export([openapi_uniswap_v2_ethereum_usage_metrics_daily_snapshot_dto/1]).
...
openapi_uniswap_v2_ethereum_usage_metrics_daily_snapshot_dto() ->
    openapi_uniswap_v2_ethereum_usage_metrics_daily_snapshot_dto([]).

openapi_uniswap_v2_ethereum_usage_metrics_daily_snapshot_dto(Fields) ->
