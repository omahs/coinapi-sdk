...
-export([openapi_sushiswap_v3_ethereum_usage_metrics_daily_snapshot_dto/0]).

-export([openapi_sushiswap_v3_ethereum_usage_metrics_daily_snapshot_dto/1]).
...
openapi_sushiswap_v3_ethereum_usage_metrics_daily_snapshot_dto() ->
    openapi_sushiswap_v3_ethereum_usage_metrics_daily_snapshot_dto([]).

openapi_sushiswap_v3_ethereum_usage_metrics_daily_snapshot_dto(Fields) ->
