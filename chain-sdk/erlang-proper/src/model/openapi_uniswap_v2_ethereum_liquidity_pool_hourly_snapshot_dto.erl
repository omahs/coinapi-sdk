...
-export([openapi_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto/0]).

-export([openapi_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto/1]).
...
openapi_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto() ->
    openapi_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto([]).

openapi_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto(Fields) ->
