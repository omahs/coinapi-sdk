...
-export([openapi_pancakeswap_v3_ethereum_liquidity_pool_amount_dto/0]).

-export([openapi_pancakeswap_v3_ethereum_liquidity_pool_amount_dto/1]).
...
openapi_pancakeswap_v3_ethereum_liquidity_pool_amount_dto() ->
    openapi_pancakeswap_v3_ethereum_liquidity_pool_amount_dto([]).

openapi_pancakeswap_v3_ethereum_liquidity_pool_amount_dto(Fields) ->
