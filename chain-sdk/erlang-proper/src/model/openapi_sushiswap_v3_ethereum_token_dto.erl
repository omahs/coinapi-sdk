...
-export([openapi_sushiswap_v3_ethereum_token_dto/0]).

-export([openapi_sushiswap_v3_ethereum_token_dto/1]).
...
openapi_sushiswap_v3_ethereum_token_dto() ->
    openapi_sushiswap_v3_ethereum_token_dto([]).

openapi_sushiswap_v3_ethereum_token_dto(Fields) ->
