-module(openapi_pancakeswap_v3_ethereum_position_dto).

-include("openapi.hrl").

-export([openapi_pancakeswap_v3_ethereum_position_dto/0]).

-export([openapi_pancakeswap_v3_ethereum_position_dto/1]).

-export_type([openapi_pancakeswap_v3_ethereum_position_dto/0]).

-type openapi_pancakeswap_v3_ethereum_position_dto() ::
  [ {'entry_time', datetime() }
  | {'recv_time', datetime() }
...
openapi_pancakeswap_v3_ethereum_position_dto() ->
    openapi_pancakeswap_v3_ethereum_position_dto([]).

openapi_pancakeswap_v3_ethereum_position_dto(Fields) ->
