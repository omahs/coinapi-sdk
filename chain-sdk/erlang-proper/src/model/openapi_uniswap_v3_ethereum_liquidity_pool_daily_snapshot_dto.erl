-module(openapi_uniswap_v3_ethereum_liquidity_pool_daily_snapshot_dto).

-include("openapi.hrl").

-export([openapi_uniswap_v3_ethereum_liquidity_pool_daily_snapshot_dto/0]).

-export([openapi_uniswap_v3_ethereum_liquidity_pool_daily_snapshot_dto/1]).

-export_type([openapi_uniswap_v3_ethereum_liquidity_pool_daily_snapshot_dto/0]).

-type openapi_uniswap_v3_ethereum_liquidity_pool_daily_snapshot_dto() ::
  [ {'entry_time', datetime() }
  | {'recv_time', datetime() }
...
openapi_uniswap_v3_ethereum_liquidity_pool_daily_snapshot_dto() ->
    openapi_uniswap_v3_ethereum_liquidity_pool_daily_snapshot_dto([]).

openapi_uniswap_v3_ethereum_liquidity_pool_daily_snapshot_dto(Fields) ->
