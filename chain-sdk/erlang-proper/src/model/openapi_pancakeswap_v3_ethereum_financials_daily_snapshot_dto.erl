...
-export([openapi_pancakeswap_v3_ethereum_financials_daily_snapshot_dto/0]).

-export([openapi_pancakeswap_v3_ethereum_financials_daily_snapshot_dto/1]).
...
openapi_pancakeswap_v3_ethereum_financials_daily_snapshot_dto() ->
    openapi_pancakeswap_v3_ethereum_financials_daily_snapshot_dto([]).

openapi_pancakeswap_v3_ethereum_financials_daily_snapshot_dto(Fields) ->
