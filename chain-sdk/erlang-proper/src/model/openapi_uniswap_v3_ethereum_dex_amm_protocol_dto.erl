-module(openapi_uniswap_v3_ethereum_dex_amm_protocol_dto).

-include("openapi.hrl").

-export([openapi_uniswap_v3_ethereum_dex_amm_protocol_dto/0]).

-export([openapi_uniswap_v3_ethereum_dex_amm_protocol_dto/1]).

-export_type([openapi_uniswap_v3_ethereum_dex_amm_protocol_dto/0]).

-type openapi_uniswap_v3_ethereum_dex_amm_protocol_dto() ::
  [ {'entry_time', datetime() }
  | {'recv_time', datetime() }
...
openapi_uniswap_v3_ethereum_dex_amm_protocol_dto() ->
    openapi_uniswap_v3_ethereum_dex_amm_protocol_dto([]).

openapi_uniswap_v3_ethereum_dex_amm_protocol_dto(Fields) ->
