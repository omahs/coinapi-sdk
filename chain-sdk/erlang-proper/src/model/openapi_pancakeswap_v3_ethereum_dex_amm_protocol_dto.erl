...
-export([openapi_pancakeswap_v3_ethereum_dex_amm_protocol_dto/0]).

-export([openapi_pancakeswap_v3_ethereum_dex_amm_protocol_dto/1]).
...
openapi_pancakeswap_v3_ethereum_dex_amm_protocol_dto() ->
    openapi_pancakeswap_v3_ethereum_dex_amm_protocol_dto([]).

openapi_pancakeswap_v3_ethereum_dex_amm_protocol_dto(Fields) ->
