...
-export([openapi_uniswap_v2_ethereum_deposit_dto/0]).

-export([openapi_uniswap_v2_ethereum_deposit_dto/1]).
...
openapi_uniswap_v2_ethereum_deposit_dto() ->
    openapi_uniswap_v2_ethereum_deposit_dto([]).

openapi_uniswap_v2_ethereum_deposit_dto(Fields) ->
