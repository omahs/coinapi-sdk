...
feature -- API Access
	...
	u_ni_sw_ap_v3_et_he_re_um_accounts_current : detachable LIST [UNISWAP_V3_ETHEREUM_ACCOUNT_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_ACCOUNT_DTO]
		require
		local
  			l_path: STRING
		...
		do
			...
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_ACCOUNT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_ACCOUNT_DTO] }) as l_data then
				Result := l_data
			else
	...
	u_ni_sw_ap_v3_et_he_re_um_active_accounts_current : detachable LIST [UNISWAP_V3_ETHEREUM_ACTIVE_ACCOUNT_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_ACTIVE_ACCOUNT_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_ACTIVE_ACCOUNT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_ACTIVE_ACCOUNT_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_deposits_current : detachable LIST [UNISWAP_V3_ETHEREUM_DEPOSIT_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_DEPOSIT_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_DEPOSIT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_DEPOSIT_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_dex_amm_protocols_current : detachable LIST [UNISWAP_V3_ETHEREUM_DEX_AMM_PROTOCOL_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_DEX_AMM_PROTOCOL_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_DEX_AMM_PROTOCOL_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_DEX_AMM_PROTOCOL_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_financials_daily_snapshots_current : detachable LIST [UNISWAP_V3_ETHEREUM_FINANCIALS_DAILY_SNAPSHOT_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_FINANCIALS_DAILY_SNAPSHOT_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_FINANCIALS_DAILY_SNAPSHOT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_FINANCIALS_DAILY_SNAPSHOT_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_liquidity_pool_fees_current : detachable LIST [UNISWAP_V3_ETHEREUM_LIQUIDITY_POOL_FEE_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_LIQUIDITY_POOL_FEE_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_LIQUIDITY_POOL_FEE_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_LIQUIDITY_POOL_FEE_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_position_snapshots_current : detachable LIST [UNISWAP_V3_ETHEREUM_POSITION_SNAPSHOT_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_POSITION_SNAPSHOT_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_POSITION_SNAPSHOT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_POSITION_SNAPSHOT_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_positions_current (pool: STRING_32): detachable LIST [UNISWAP_V3_ETHEREUM_POSITION_DTO]
			-- Positions (current)
			-- Gets positions.
			-- 
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_POSITION_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_POSITION_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_POSITION_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_reward_tokens_current : detachable LIST [UNISWAP_V3_ETHEREUM_REWARD_TOKEN_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_REWARD_TOKEN_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_REWARD_TOKEN_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_REWARD_TOKEN_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_swaps_current : detachable LIST [UNISWAP_V3_ETHEREUM_SWAP_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_SWAP_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_SWAP_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_SWAP_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_tick_daily_snapshots_current : detachable LIST [UNISWAP_V3_ETHEREUM_TICK_DAILY_SNAPSHOT_DTO]
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_TICK_DAILY_SNAPSHOT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_TICK_DAILY_SNAPSHOT_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_tick_hourly_snapshots_current : detachable LIST [UNISWAP_V3_ETHEREUM_TICK_HOURLY_SNAPSHOT_DTO]
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_TICK_HOURLY_SNAPSHOT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_TICK_HOURLY_SNAPSHOT_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_ticks_current : detachable LIST [UNISWAP_V3_ETHEREUM_TICK_DTO]
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_TICK_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_TICK_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_token_white_list_symbols_current : detachable LIST [UNISWAP_V3_ETHEREUM_TOKEN_WHITE_LIST_SYMBOL_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_TOKEN_WHITE_LIST_SYMBOL_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_TOKEN_WHITE_LIST_SYMBOL_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_TOKEN_WHITE_LIST_SYMBOL_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_token_white_lists_current : detachable LIST [UNISWAP_V3_ETHEREUM_TOKEN_WHITE_LIST_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_TOKEN_WHITE_LIST_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_TOKEN_WHITE_LIST_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_TOKEN_WHITE_LIST_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_tokens_current (id: STRING_32): detachable LIST [UNISWAP_V3_ETHEREUM_TOKEN_DTO]
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_TOKEN_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_TOKEN_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_usage_metrics_daily_snapshots_current : detachable LIST [UNISWAP_V3_ETHEREUM_USAGE_METRICS_DAILY_SNAPSHOT_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_USAGE_METRICS_DAILY_SNAPSHOT_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_USAGE_METRICS_DAILY_SNAPSHOT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_USAGE_METRICS_DAILY_SNAPSHOT_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_usage_metrics_hourly_snapshots_current : detachable LIST [UNISWAP_V3_ETHEREUM_USAGE_METRICS_HOURLY_SNAPSHOT_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_USAGE_METRICS_HOURLY_SNAPSHOT_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_USAGE_METRICS_HOURLY_SNAPSHOT_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_USAGE_METRICS_HOURLY_SNAPSHOT_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	u_ni_sw_ap_v3_et_he_re_um_withdraws_current : detachable LIST [UNISWAP_V3_ETHEREUM_WITHDRAW_DTO]
			...
			-- 
			-- 
			-- Result LIST [UNISWAP_V3_ETHEREUM_WITHDRAW_DTO]
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { LIST [UNISWAP_V3_ETHEREUM_WITHDRAW_DTO] } l_response.data ({ LIST [UNISWAP_V3_ETHEREUM_WITHDRAW_DTO] }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
