...
class PANCAKESWAP_V3_ETHEREUM_TICK_HOURLY_SNAPSHOT_DTO
...
feature -- Change Element
    ...
    set_hour_id (a_name: like hour_id)
        -- Set 'hour_id' with 'a_name'.
      do
        hour_id := a_name
      ensure
        hour_id_set: hour_id = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass PANCAKESWAP_V3_ETHEREUM_TICK_HOURLY_SNAPSHOT_DTO%N")
        ...
        if attached hour_id as l_hour_id then
          Result.append ("%Nhour_id:")
          Result.append (l_hour_id.out)
          Result.append ("%N")
        end
