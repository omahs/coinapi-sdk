...
feature --Access
    ...
    batch_id: detachable STRING_32
      -- Batch identifier.
    price_in_owl_numerator: detachable STRING_32
      -- Price enumerator in OWL (derivative of the GNO token).
    price_in_owl_denominator: detachable STRING_32
...
feature -- Change Element
    ...
    set_price_in_owl_numerator (a_name: like price_in_owl_numerator)
        -- Set 'price_in_owl_numerator' with 'a_name'.
      do
        price_in_owl_numerator := a_name
      ensure
        price_in_owl_numerator_set: price_in_owl_numerator = a_name
      end

    set_price_in_owl_denominator (a_name: like price_in_owl_denominator)
        -- Set 'price_in_owl_denominator' with 'a_name'.
      do
        price_in_owl_denominator := a_name
      ensure
        price_in_owl_denominator_set: price_in_owl_denominator = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass DEX_PRICE_DTO%N")
        ...
        if attached price_in_owl_numerator as l_price_in_owl_numerator then
          Result.append ("%Nprice_in_owl_numerator:")
          Result.append (l_price_in_owl_numerator.out)
          Result.append ("%N")
        end
        if attached price_in_owl_denominator as l_price_in_owl_denominator then
          Result.append ("%Nprice_in_owl_denominator:")
          Result.append (l_price_in_owl_denominator.out)
          Result.append ("%N")
        end
