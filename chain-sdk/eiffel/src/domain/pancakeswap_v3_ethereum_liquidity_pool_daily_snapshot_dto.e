...
class PANCAKESWAP_V3_ETHEREUM_LIQUIDITY_POOL_DAILY_SNAPSHOT_DTO
...
feature --Access
    ...
    daily_volume_by_token_amount: detachable LIST [STRING_32]
    ...
    daily_volume_by_token_usd: detachable LIST [STRING_32]
...
feature -- Change Element
    ...
    set_daily_volume_by_token_amount (a_name: like daily_volume_by_token_amount)
        -- Set 'daily_volume_by_token_amount' with 'a_name'.
      do
        daily_volume_by_token_amount := a_name
      ensure
        daily_volume_by_token_amount_set: daily_volume_by_token_amount = a_name
      end
    ...
    set_daily_volume_by_token_usd (a_name: like daily_volume_by_token_usd)
        -- Set 'daily_volume_by_token_usd' with 'a_name'.
      do
        daily_volume_by_token_usd := a_name
      ensure
        daily_volume_by_token_usd_set: daily_volume_by_token_usd = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass PANCAKESWAP_V3_ETHEREUM_LIQUIDITY_POOL_DAILY_SNAPSHOT_DTO%N")
        ...
        if attached daily_volume_by_token_amount as l_daily_volume_by_token_amount then
          across l_daily_volume_by_token_amount as ic loop
            Result.append ("%N daily_volume_by_token_amount:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
        ...
        if attached daily_volume_by_token_usd as l_daily_volume_by_token_usd then
          across l_daily_volume_by_token_usd as ic loop
            Result.append ("%N daily_volume_by_token_usd:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
