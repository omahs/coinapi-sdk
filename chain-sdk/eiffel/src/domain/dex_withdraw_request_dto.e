...
class DEX_WITHDRAW_REQUEST_DTO
...
feature --Access
    ...
    amount: detachable STRING_32
      -- 
    withdrawable_from_batch_id: detachable STRING_32
      -- 
    create_epoch: detachable STRING_32
      -- 
    create_batch_id: detachable STRING_32
      -- 
...
feature -- Change Element
    ...
    set_withdrawable_from_batch_id (a_name: like withdrawable_from_batch_id)
        -- Set 'withdrawable_from_batch_id' with 'a_name'.
      do
        withdrawable_from_batch_id := a_name
      ensure
        withdrawable_from_batch_id_set: withdrawable_from_batch_id = a_name
      end
    ...
    set_create_batch_id (a_name: like create_batch_id)
        -- Set 'create_batch_id' with 'a_name'.
      do
        create_batch_id := a_name
      ensure
        create_batch_id_set: create_batch_id = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass DEX_WITHDRAW_REQUEST_DTO%N")
        ...
        if attached withdrawable_from_batch_id as l_withdrawable_from_batch_id then
          Result.append ("%Nwithdrawable_from_batch_id:")
          Result.append (l_withdrawable_from_batch_id.out)
          Result.append ("%N")
        end
        ...
        if attached create_batch_id as l_create_batch_id then
          Result.append ("%Ncreate_batch_id:")
          Result.append (l_create_batch_id.out)
          Result.append ("%N")
        end
