...
class CRYPTOPUNKS_COLLECTION_DAILY_SNAPSHOT_DTO
...
feature --Access
    ...
    royalty_fee: detachable STRING_32
      -- 
    daily_min_sale_price: detachable STRING_32
      -- 
    daily_max_sale_price: detachable STRING_32
      -- 
    cumulative_trade_volume_eth: detachable STRING_32
      -- 
    daily_trade_volume_eth: detachable STRING_32
      -- 
...
feature -- Change Element
    ...
    set_daily_min_sale_price (a_name: like daily_min_sale_price)
        -- Set 'daily_min_sale_price' with 'a_name'.
      do
        daily_min_sale_price := a_name
      ensure
        daily_min_sale_price_set: daily_min_sale_price = a_name
      end

    set_daily_max_sale_price (a_name: like daily_max_sale_price)
        -- Set 'daily_max_sale_price' with 'a_name'.
      do
        daily_max_sale_price := a_name
      ensure
        daily_max_sale_price_set: daily_max_sale_price = a_name
      end
    ...
    set_daily_trade_volume_eth (a_name: like daily_trade_volume_eth)
        -- Set 'daily_trade_volume_eth' with 'a_name'.
      do
        daily_trade_volume_eth := a_name
      ensure
        daily_trade_volume_eth_set: daily_trade_volume_eth = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass CRYPTOPUNKS_COLLECTION_DAILY_SNAPSHOT_DTO%N")
        ...
        if attached daily_min_sale_price as l_daily_min_sale_price then
          Result.append ("%Ndaily_min_sale_price:")
          Result.append (l_daily_min_sale_price.out)
          Result.append ("%N")
        end
        if attached daily_max_sale_price as l_daily_max_sale_price then
          Result.append ("%Ndaily_max_sale_price:")
          Result.append (l_daily_max_sale_price.out)
          Result.append ("%N")
        end
        ...
        if attached daily_trade_volume_eth as l_daily_trade_volume_eth then
          Result.append ("%Ndaily_trade_volume_eth:")
          Result.append (l_daily_trade_volume_eth.out)
          Result.append ("%N")
        end
