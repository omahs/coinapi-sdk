# PANCAKESWAP_V3_ETHEREUM_LIQUIDITY_POOL_HOURLY_SNAPSHOT_DTO
...
**id** | [**STRING_32**](STRING_32.md) | (Smart contract address of the pool)-( # of hours since Unix epoch time) | [optional] [default to null]
...
**active_liquidity** | [**STRING_32**](STRING_32.md) | All liquidity &#x60;k&#x60; that is active. Will be equal to totalLiquidity except for in concentrated liquidity - where activeLiquidity is all liquidity positions that contain the pool&#39;s current tick. | [optional] [default to null]
...
**hourly_supply_side_revenue_usd** | [**STRING_32**](STRING_32.md) | Hourly revenue generated by the liquidity pool, accrued to the supply side. | [optional] [default to null]
...
**hourly_protocol_side_revenue_usd** | [**STRING_32**](STRING_32.md) | Hourly revenue generated by the liquidity pool, accrued to the protocol. | [optional] [default to null]
**cumulative_total_revenue_usd** | [**STRING_32**](STRING_32.md) | All revenue generated by the liquidity pool. | [optional] [default to null]
**hourly_total_revenue_usd** | [**STRING_32**](STRING_32.md) | Hourly revenue generated by the liquidity pool. | [optional] [default to null]
...
**hourly_volume_usd** | [**STRING_32**](STRING_32.md) | All trade volume occurred in a given hour, in USD. | [optional] [default to null]
