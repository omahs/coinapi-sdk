# PANCAKESWAP_V3_ETHEREUM_LIQUIDITY_POOL_DTO
...
**block_range** | [**STRING_32**](STRING_32.md) | Block range of the liquidity pool. | [optional] [default to null]
**id** | [**STRING_32**](STRING_32.md) | Smart contract address of the pool. | [optional] [default to null]
**protocol** | [**STRING_32**](STRING_32.md) | Protocol this pool belongs to. | [optional] [default to null]
...
**reward_tokens** | [**LIST [STRING_32]**](STRING_32.md) | Additional tokens that are given as reward for position in a protocol, usually in liquidity mining programs. e.g. SUSHI in the Onsen program, MATIC for Aave Polygon, usually in liquidity mining programs. e.g. SUSHI in the Onsen program, MATIC for Aave Polygon. | [optional] [default to null]
...
**is_single_sided** | **BOOLEAN** | Specifies whether this pool is single-sided (e.g. Bancor, Platypus&#39;s Alternative Pool). The specifics of the implementation depends on the protocol. | [optional] [default to null]
**created_timestamp** | [**STRING_32**](STRING_32.md) | Timestamp when the liquidity pool was created. | [optional] [default to null]
**created_block_number** | [**STRING_32**](STRING_32.md) | Block number when the liquidity pool was created. | [optional] [default to null]
...
**total_liquidity** | [**STRING_32**](STRING_32.md) | Sum of all active and non-active liquidity for this pool. | [optional] [default to null]
