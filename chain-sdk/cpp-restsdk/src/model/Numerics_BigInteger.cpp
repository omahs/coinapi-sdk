...
Numerics_BigInteger::Numerics_BigInteger()
{
...
void Numerics_BigInteger::validate()
{
    // TODO: implement validation
}

web::json::value Numerics_BigInteger::toJson() const
{
...
bool Numerics_BigInteger::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Numerics_BigInteger::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Numerics_BigInteger::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool Numerics_BigInteger::isIsPowerOfTwo() const
{
    return m_Is_power_of_two;
}

void Numerics_BigInteger::setIsPowerOfTwo(bool value)
{
    m_Is_power_of_two = value;
    m_Is_power_of_twoIsSet = true;
}

bool Numerics_BigInteger::isPowerOfTwoIsSet() const
{
    return m_Is_power_of_twoIsSet;
}

void Numerics_BigInteger::unsetIs_power_of_two()
{
    m_Is_power_of_twoIsSet = false;
}
bool Numerics_BigInteger::isIsZero() const
{
    return m_Is_zero;
}

void Numerics_BigInteger::setIsZero(bool value)
{
    m_Is_zero = value;
    m_Is_zeroIsSet = true;
}

bool Numerics_BigInteger::isZeroIsSet() const
{
    return m_Is_zeroIsSet;
}

void Numerics_BigInteger::unsetIs_zero()
{
    m_Is_zeroIsSet = false;
}
bool Numerics_BigInteger::isIsOne() const
{
    return m_Is_one;
}

void Numerics_BigInteger::setIsOne(bool value)
{
    m_Is_one = value;
    m_Is_oneIsSet = true;
}

bool Numerics_BigInteger::isOneIsSet() const
{
    return m_Is_oneIsSet;
}

void Numerics_BigInteger::unsetIs_one()
{
    m_Is_oneIsSet = false;
}
bool Numerics_BigInteger::isIsEven() const
{
    return m_Is_even;
}

void Numerics_BigInteger::setIsEven(bool value)
{
    m_Is_even = value;
    m_Is_evenIsSet = true;
}

bool Numerics_BigInteger::isEvenIsSet() const
{
    return m_Is_evenIsSet;
}

void Numerics_BigInteger::unsetIs_even()
{
    m_Is_evenIsSet = false;
}
int32_t Numerics_BigInteger::getSign() const
{
    return m_Sign;
}

void Numerics_BigInteger::setSign(int32_t value)
{
    m_Sign = value;
    m_SignIsSet = true;
}

bool Numerics_BigInteger::signIsSet() const
{
    return m_SignIsSet;
}

void Numerics_BigInteger::unsetSign()
{
    m_SignIsSet = false;
}
}
