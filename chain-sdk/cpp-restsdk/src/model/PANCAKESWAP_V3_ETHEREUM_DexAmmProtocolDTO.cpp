...
PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO()
{
    ...
    m_Cumulative_unique_l_ps = 0;
    m_Cumulative_unique_l_psIsSet = false;
    ...
    m_Cumulative_position_count = 0;
    m_Cumulative_position_countIsSet = false;
...
void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::validate()
{
    // TODO: implement validation
}

web::json::value PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::toJson() const
{
    ...
    if(m_Cumulative_unique_l_psIsSet)
    {
        val[utility::conversions::to_string_t(U("cumulative_unique_l_ps"))] = ModelBase::toJson(m_Cumulative_unique_l_ps);
    }
    ...
    if(m_Cumulative_position_countIsSet)
    {
        val[utility::conversions::to_string_t(U("cumulative_position_count"))] = ModelBase::toJson(m_Cumulative_position_count);
    }
    ...
    if(m_RegenesisIsSet)
    {
        val[utility::conversions::to_string_t(U("regenesis"))] = ModelBase::toJson(m_Regenesis);
    }

    return val;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("cumulative_unique_l_ps"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("cumulative_unique_l_ps")));
        if(!fieldValue.is_null())
        {
            int32_t refVal_setCumulativeUniqueLPs;
            ok &= ModelBase::fromJson(fieldValue, refVal_setCumulativeUniqueLPs);
            setCumulativeUniqueLPs(refVal_setCumulativeUniqueLPs);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("cumulative_position_count"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("cumulative_position_count")));
        if(!fieldValue.is_null())
        {
            int32_t refVal_setCumulativePositionCount;
            ok &= ModelBase::fromJson(fieldValue, refVal_setCumulativePositionCount);
            setCumulativePositionCount(refVal_setCumulativePositionCount);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("regenesis"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("regenesis")));
        if(!fieldValue.is_null())
        {
            bool refVal_setRegenesis;
            ok &= ModelBase::fromJson(fieldValue, refVal_setRegenesis);
            setRegenesis(refVal_setRegenesis);
        }
    }
    return ok;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Cumulative_unique_l_psIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("cumulative_unique_l_ps")), m_Cumulative_unique_l_ps));
    }
    if(m_Cumulative_unique_tradersIsSet)
    {
    ...
    if(m_Cumulative_position_countIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("cumulative_position_count")), m_Cumulative_position_count));
    }
    if(m_Last_snapshot_day_idIsSet)
    {
    ...
    if(m_RegenesisIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("regenesis")), m_Regenesis));
    }
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("cumulative_unique_l_ps"))))
    {
        int32_t refVal_setCumulativeUniqueLPs;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("cumulative_unique_l_ps"))), refVal_setCumulativeUniqueLPs );
        setCumulativeUniqueLPs(refVal_setCumulativeUniqueLPs);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("cumulative_position_count"))))
    {
        int32_t refVal_setCumulativePositionCount;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("cumulative_position_count"))), refVal_setCumulativePositionCount );
        setCumulativePositionCount(refVal_setCumulativePositionCount);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("regenesis"))))
    {
        bool refVal_setRegenesis;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("regenesis"))), refVal_setRegenesis );
        setRegenesis(refVal_setRegenesis);
    }
    return ok;
}

utility::datetime PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getEntryTime() const
{
    return m_Entry_time;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getRecvTime() const
{
    return m_Recv_time;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getBlockNumber() const
{
    return m_Block_number;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getBlockRange() const
{
    return m_Block_range;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setBlockRange(const utility::string_t& value)
{
    m_Block_range = value;
    m_Block_rangeIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::blockRangeIsSet() const
{
    return m_Block_rangeIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetBlock_range()
{
    m_Block_rangeIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getId() const
{
    return m_Id;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::idIsSet() const
{
    return m_IdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getName() const
{
    return m_Name;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::nameIsSet() const
{
    return m_NameIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getSlug() const
{
    return m_Slug;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setSlug(const utility::string_t& value)
{
    m_Slug = value;
    m_SlugIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::slugIsSet() const
{
    return m_SlugIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetSlug()
{
    m_SlugIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getSchemaVersion() const
{
    return m_Schema_version;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setSchemaVersion(const utility::string_t& value)
{
    m_Schema_version = value;
    m_Schema_versionIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::schemaVersionIsSet() const
{
    return m_Schema_versionIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetSchema_version()
{
    m_Schema_versionIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getSubgraphVersion() const
{
    return m_Subgraph_version;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setSubgraphVersion(const utility::string_t& value)
{
    m_Subgraph_version = value;
    m_Subgraph_versionIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::subgraphVersionIsSet() const
{
    return m_Subgraph_versionIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetSubgraph_version()
{
    m_Subgraph_versionIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getMethodologyVersion() const
{
    return m_Methodology_version;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setMethodologyVersion(const utility::string_t& value)
{
    m_Methodology_version = value;
    m_Methodology_versionIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::methodologyVersionIsSet() const
{
    return m_Methodology_versionIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetMethodology_version()
{
    m_Methodology_versionIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getTotalValueLockedUsd() const
{
    return m_Total_value_locked_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setTotalValueLockedUsd(const utility::string_t& value)
{
    m_Total_value_locked_usd = value;
    m_Total_value_locked_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::totalValueLockedUsdIsSet() const
{
    return m_Total_value_locked_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetTotal_value_locked_usd()
{
    m_Total_value_locked_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getTotalLiquidityUsd() const
{
    return m_Total_liquidity_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setTotalLiquidityUsd(const utility::string_t& value)
{
    m_Total_liquidity_usd = value;
    m_Total_liquidity_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::totalLiquidityUsdIsSet() const
{
    return m_Total_liquidity_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetTotal_liquidity_usd()
{
    m_Total_liquidity_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getActiveLiquidityUsd() const
{
    return m_Active_liquidity_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setActiveLiquidityUsd(const utility::string_t& value)
{
    m_Active_liquidity_usd = value;
    m_Active_liquidity_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::activeLiquidityUsdIsSet() const
{
    return m_Active_liquidity_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetActive_liquidity_usd()
{
    m_Active_liquidity_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getUncollectedProtocolSideValueUsd() const
{
    return m_Uncollected_protocol_side_value_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setUncollectedProtocolSideValueUsd(const utility::string_t& value)
{
    m_Uncollected_protocol_side_value_usd = value;
    m_Uncollected_protocol_side_value_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::uncollectedProtocolSideValueUsdIsSet() const
{
    return m_Uncollected_protocol_side_value_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetUncollected_protocol_side_value_usd()
{
    m_Uncollected_protocol_side_value_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getUncollectedSupplySideValueUsd() const
{
    return m_Uncollected_supply_side_value_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setUncollectedSupplySideValueUsd(const utility::string_t& value)
{
    m_Uncollected_supply_side_value_usd = value;
    m_Uncollected_supply_side_value_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::uncollectedSupplySideValueUsdIsSet() const
{
    return m_Uncollected_supply_side_value_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetUncollected_supply_side_value_usd()
{
    m_Uncollected_supply_side_value_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getProtocolControlledValueUsd() const
{
    return m_Protocol_controlled_value_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setProtocolControlledValueUsd(const utility::string_t& value)
{
    m_Protocol_controlled_value_usd = value;
    m_Protocol_controlled_value_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::protocolControlledValueUsdIsSet() const
{
    return m_Protocol_controlled_value_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetProtocol_controlled_value_usd()
{
    m_Protocol_controlled_value_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getCumulativeVolumeUsd() const
{
    return m_Cumulative_volume_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setCumulativeVolumeUsd(const utility::string_t& value)
{
    m_Cumulative_volume_usd = value;
    m_Cumulative_volume_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::cumulativeVolumeUsdIsSet() const
{
    return m_Cumulative_volume_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetCumulative_volume_usd()
{
    m_Cumulative_volume_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getCumulativeSupplySideRevenueUsd() const
{
    return m_Cumulative_supply_side_revenue_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setCumulativeSupplySideRevenueUsd(const utility::string_t& value)
{
    m_Cumulative_supply_side_revenue_usd = value;
    m_Cumulative_supply_side_revenue_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::cumulativeSupplySideRevenueUsdIsSet() const
{
    return m_Cumulative_supply_side_revenue_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetCumulative_supply_side_revenue_usd()
{
    m_Cumulative_supply_side_revenue_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getCumulativeProtocolSideRevenueUsd() const
{
    return m_Cumulative_protocol_side_revenue_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setCumulativeProtocolSideRevenueUsd(const utility::string_t& value)
{
    m_Cumulative_protocol_side_revenue_usd = value;
    m_Cumulative_protocol_side_revenue_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::cumulativeProtocolSideRevenueUsdIsSet() const
{
    return m_Cumulative_protocol_side_revenue_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetCumulative_protocol_side_revenue_usd()
{
    m_Cumulative_protocol_side_revenue_usdIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getCumulativeTotalRevenueUsd() const
{
    return m_Cumulative_total_revenue_usd;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setCumulativeTotalRevenueUsd(const utility::string_t& value)
{
    m_Cumulative_total_revenue_usd = value;
    m_Cumulative_total_revenue_usdIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::cumulativeTotalRevenueUsdIsSet() const
{
    return m_Cumulative_total_revenue_usdIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetCumulative_total_revenue_usd()
{
    m_Cumulative_total_revenue_usdIsSet = false;
}
int32_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getCumulativeUniqueUsers() const
{
    return m_Cumulative_unique_users;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setCumulativeUniqueUsers(int32_t value)
{
    m_Cumulative_unique_users = value;
    m_Cumulative_unique_usersIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::cumulativeUniqueUsersIsSet() const
{
    return m_Cumulative_unique_usersIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetCumulative_unique_users()
{
    m_Cumulative_unique_usersIsSet = false;
}
int32_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getCumulativeUniqueLPs() const
{
    return m_Cumulative_unique_l_ps;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setCumulativeUniqueLPs(int32_t value)
{
    m_Cumulative_unique_l_ps = value;
    m_Cumulative_unique_l_psIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::cumulativeUniqueLPsIsSet() const
{
    return m_Cumulative_unique_l_psIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetCumulative_unique_l_ps()
{
    m_Cumulative_unique_l_psIsSet = false;
}
int32_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getCumulativeUniqueTraders() const
{
    return m_Cumulative_unique_traders;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setCumulativeUniqueTraders(int32_t value)
{
    m_Cumulative_unique_traders = value;
    m_Cumulative_unique_tradersIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::cumulativeUniqueTradersIsSet() const
{
    return m_Cumulative_unique_tradersIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetCumulative_unique_traders()
{
    m_Cumulative_unique_tradersIsSet = false;
}
int32_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getTotalPoolCount() const
{
    return m_Total_pool_count;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setTotalPoolCount(int32_t value)
{
    m_Total_pool_count = value;
    m_Total_pool_countIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::totalPoolCountIsSet() const
{
    return m_Total_pool_countIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetTotal_pool_count()
{
    m_Total_pool_countIsSet = false;
}
int32_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getOpenPositionCount() const
{
    return m_Open_position_count;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setOpenPositionCount(int32_t value)
{
    m_Open_position_count = value;
    m_Open_position_countIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::openPositionCountIsSet() const
{
    return m_Open_position_countIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetOpen_position_count()
{
    m_Open_position_countIsSet = false;
}
int32_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getCumulativePositionCount() const
{
    return m_Cumulative_position_count;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setCumulativePositionCount(int32_t value)
{
    m_Cumulative_position_count = value;
    m_Cumulative_position_countIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::cumulativePositionCountIsSet() const
{
    return m_Cumulative_position_countIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetCumulative_position_count()
{
    m_Cumulative_position_countIsSet = false;
}
int32_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getLastSnapshotDayId() const
{
    return m_Last_snapshot_day_id;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setLastSnapshotDayId(int32_t value)
{
    m_Last_snapshot_day_id = value;
    m_Last_snapshot_day_idIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::lastSnapshotDayIdIsSet() const
{
    return m_Last_snapshot_day_idIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetLast_snapshot_day_id()
{
    m_Last_snapshot_day_idIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getLastUpdateTimestamp() const
{
    return m_Last_update_timestamp;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setLastUpdateTimestamp(const utility::string_t& value)
{
    m_Last_update_timestamp = value;
    m_Last_update_timestampIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::lastUpdateTimestampIsSet() const
{
    return m_Last_update_timestampIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetLast_update_timestamp()
{
    m_Last_update_timestampIsSet = false;
}
utility::string_t PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::getLastUpdateBlockNumber() const
{
    return m_Last_update_block_number;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setLastUpdateBlockNumber(const utility::string_t& value)
{
    m_Last_update_block_number = value;
    m_Last_update_block_numberIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::lastUpdateBlockNumberIsSet() const
{
    return m_Last_update_block_numberIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetLast_update_block_number()
{
    m_Last_update_block_numberIsSet = false;
}
bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::isRegenesis() const
{
    return m_Regenesis;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::setRegenesis(bool value)
{
    m_Regenesis = value;
    m_RegenesisIsSet = true;
}

bool PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::regenesisIsSet() const
{
    return m_RegenesisIsSet;
}

void PANCAKESWAP_V3_ETHEREUM_DexAmmProtocolDTO::unsetRegenesis()
{
    m_RegenesisIsSet = false;
}
}
