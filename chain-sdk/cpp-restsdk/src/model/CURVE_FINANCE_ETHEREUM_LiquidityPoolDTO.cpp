...
CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO()
{
    ...
    m_Input_tokens_orderedIsSet = false;
    ...
    m_Gauge_address = utility::conversions::to_string_t("");
    m_Gauge_addressIsSet = false;
    m_Evaluated_ask = 0.0;
...
void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::validate()
{
    // TODO: implement validation
}

web::json::value CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::toJson() const
{
    ...
    if(m_Input_tokens_orderedIsSet)
    {
        val[utility::conversions::to_string_t(U("input_tokens_ordered"))] = ModelBase::toJson(m_Input_tokens_ordered);
    }
    ...
    if(m_Gauge_addressIsSet)
    {
        val[utility::conversions::to_string_t(U("gauge_address"))] = ModelBase::toJson(m_Gauge_address);
    }
...
bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("input_tokens_ordered"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("input_tokens_ordered")));
        if(!fieldValue.is_null())
        {
            std::vector<utility::string_t> refVal_setInputTokensOrdered;
            ok &= ModelBase::fromJson(fieldValue, refVal_setInputTokensOrdered);
            setInputTokensOrdered(refVal_setInputTokensOrdered);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("gauge_address"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("gauge_address")));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setGaugeAddress;
            ok &= ModelBase::fromJson(fieldValue, refVal_setGaugeAddress);
            setGaugeAddress(refVal_setGaugeAddress);
        }
    }
...
void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Input_tokens_orderedIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("input_tokens_ordered")), m_Input_tokens_ordered));
    }
    if(m_Output_tokenIsSet)
    {
    ...
    if(m_Gauge_addressIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("gauge_address")), m_Gauge_address));
    }
    if(m_Evaluated_askIsSet)
    {
...
bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("input_tokens_ordered"))))
    {
        std::vector<utility::string_t> refVal_setInputTokensOrdered;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("input_tokens_ordered"))), refVal_setInputTokensOrdered );
        setInputTokensOrdered(refVal_setInputTokensOrdered);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("gauge_address"))))
    {
        utility::string_t refVal_setGaugeAddress;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("gauge_address"))), refVal_setGaugeAddress );
        setGaugeAddress(refVal_setGaugeAddress);
    }
...
utility::datetime CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getEntryTime() const
{
    return m_Entry_time;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getRecvTime() const
{
    return m_Recv_time;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getBlockNumber() const
{
    return m_Block_number;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
int64_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getVid() const
{
    return m_Vid;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::vidIsSet() const
{
    return m_VidIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetVid()
{
    m_VidIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getId() const
{
    return m_Id;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::idIsSet() const
{
    return m_IdIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getProtocol() const
{
    return m_Protocol;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setProtocol(const utility::string_t& value)
{
    m_Protocol = value;
    m_ProtocolIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::protocolIsSet() const
{
    return m_ProtocolIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetProtocol()
{
    m_ProtocolIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getName() const
{
    return m_Name;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::nameIsSet() const
{
    return m_NameIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getSymbol() const
{
    return m_Symbol;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetSymbol()
{
    m_SymbolIsSet = false;
}
std::vector<utility::string_t>& CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getInputTokens()
{
    return m_Input_tokens;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setInputTokens(const std::vector<utility::string_t>& value)
{
    m_Input_tokens = value;
    m_Input_tokensIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::inputTokensIsSet() const
{
    return m_Input_tokensIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetInput_tokens()
{
    m_Input_tokensIsSet = false;
}
std::vector<utility::string_t>& CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getInputTokensOrdered()
{
    return m_Input_tokens_ordered;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setInputTokensOrdered(const std::vector<utility::string_t>& value)
{
    m_Input_tokens_ordered = value;
    m_Input_tokens_orderedIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::inputTokensOrderedIsSet() const
{
    return m_Input_tokens_orderedIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetInput_tokens_ordered()
{
    m_Input_tokens_orderedIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getOutputToken() const
{
    return m_Output_token;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setOutputToken(const utility::string_t& value)
{
    m_Output_token = value;
    m_Output_tokenIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::outputTokenIsSet() const
{
    return m_Output_tokenIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetOutput_token()
{
    m_Output_tokenIsSet = false;
}
std::vector<utility::string_t>& CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getRewardTokens()
{
    return m_Reward_tokens;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setRewardTokens(const std::vector<utility::string_t>& value)
{
    m_Reward_tokens = value;
    m_Reward_tokensIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::rewardTokensIsSet() const
{
    return m_Reward_tokensIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetReward_tokens()
{
    m_Reward_tokensIsSet = false;
}
std::vector<utility::string_t>& CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getFees()
{
    return m_Fees;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setFees(const std::vector<utility::string_t>& value)
{
    m_Fees = value;
    m_FeesIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::feesIsSet() const
{
    return m_FeesIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetFees()
{
    m_FeesIsSet = false;
}
bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::isIsSingleSided() const
{
    return m_Is_single_sided;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setIsSingleSided(bool value)
{
    m_Is_single_sided = value;
    m_Is_single_sidedIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::isSingleSidedIsSet() const
{
    return m_Is_single_sidedIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetIs_single_sided()
{
    m_Is_single_sidedIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getCreatedTimestamp() const
{
    return m_Created_timestamp;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setCreatedTimestamp(const utility::string_t& value)
{
    m_Created_timestamp = value;
    m_Created_timestampIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::createdTimestampIsSet() const
{
    return m_Created_timestampIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetCreated_timestamp()
{
    m_Created_timestampIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getCreatedBlockNumber() const
{
    return m_Created_block_number;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setCreatedBlockNumber(const utility::string_t& value)
{
    m_Created_block_number = value;
    m_Created_block_numberIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::createdBlockNumberIsSet() const
{
    return m_Created_block_numberIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetCreated_block_number()
{
    m_Created_block_numberIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getTotalValueLockedUsd() const
{
    return m_Total_value_locked_usd;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setTotalValueLockedUsd(const utility::string_t& value)
{
    m_Total_value_locked_usd = value;
    m_Total_value_locked_usdIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::totalValueLockedUsdIsSet() const
{
    return m_Total_value_locked_usdIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetTotal_value_locked_usd()
{
    m_Total_value_locked_usdIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getCumulativeSupplySideRevenueUsd() const
{
    return m_Cumulative_supply_side_revenue_usd;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setCumulativeSupplySideRevenueUsd(const utility::string_t& value)
{
    m_Cumulative_supply_side_revenue_usd = value;
    m_Cumulative_supply_side_revenue_usdIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::cumulativeSupplySideRevenueUsdIsSet() const
{
    return m_Cumulative_supply_side_revenue_usdIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetCumulative_supply_side_revenue_usd()
{
    m_Cumulative_supply_side_revenue_usdIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getCumulativeProtocolSideRevenueUsd() const
{
    return m_Cumulative_protocol_side_revenue_usd;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setCumulativeProtocolSideRevenueUsd(const utility::string_t& value)
{
    m_Cumulative_protocol_side_revenue_usd = value;
    m_Cumulative_protocol_side_revenue_usdIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::cumulativeProtocolSideRevenueUsdIsSet() const
{
    return m_Cumulative_protocol_side_revenue_usdIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetCumulative_protocol_side_revenue_usd()
{
    m_Cumulative_protocol_side_revenue_usdIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getCumulativeTotalRevenueUsd() const
{
    return m_Cumulative_total_revenue_usd;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setCumulativeTotalRevenueUsd(const utility::string_t& value)
{
    m_Cumulative_total_revenue_usd = value;
    m_Cumulative_total_revenue_usdIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::cumulativeTotalRevenueUsdIsSet() const
{
    return m_Cumulative_total_revenue_usdIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetCumulative_total_revenue_usd()
{
    m_Cumulative_total_revenue_usdIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getCumulativeVolumeUsd() const
{
    return m_Cumulative_volume_usd;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setCumulativeVolumeUsd(const utility::string_t& value)
{
    m_Cumulative_volume_usd = value;
    m_Cumulative_volume_usdIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::cumulativeVolumeUsdIsSet() const
{
    return m_Cumulative_volume_usdIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetCumulative_volume_usd()
{
    m_Cumulative_volume_usdIsSet = false;
}
std::vector<utility::string_t>& CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getInputTokenBalances()
{
    return m_Input_token_balances;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setInputTokenBalances(const std::vector<utility::string_t>& value)
{
    m_Input_token_balances = value;
    m_Input_token_balancesIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::inputTokenBalancesIsSet() const
{
    return m_Input_token_balancesIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetInput_token_balances()
{
    m_Input_token_balancesIsSet = false;
}
std::vector<utility::string_t>& CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getInputTokenWeights()
{
    return m_Input_token_weights;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setInputTokenWeights(const std::vector<utility::string_t>& value)
{
    m_Input_token_weights = value;
    m_Input_token_weightsIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::inputTokenWeightsIsSet() const
{
    return m_Input_token_weightsIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetInput_token_weights()
{
    m_Input_token_weightsIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getOutputTokenSupply() const
{
    return m_Output_token_supply;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setOutputTokenSupply(const utility::string_t& value)
{
    m_Output_token_supply = value;
    m_Output_token_supplyIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::outputTokenSupplyIsSet() const
{
    return m_Output_token_supplyIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetOutput_token_supply()
{
    m_Output_token_supplyIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getOutputTokenPriceUsd() const
{
    return m_Output_token_price_usd;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setOutputTokenPriceUsd(const utility::string_t& value)
{
    m_Output_token_price_usd = value;
    m_Output_token_price_usdIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::outputTokenPriceUsdIsSet() const
{
    return m_Output_token_price_usdIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetOutput_token_price_usd()
{
    m_Output_token_price_usdIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getStakedOutputTokenAmount() const
{
    return m_Staked_output_token_amount;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setStakedOutputTokenAmount(const utility::string_t& value)
{
    m_Staked_output_token_amount = value;
    m_Staked_output_token_amountIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::stakedOutputTokenAmountIsSet() const
{
    return m_Staked_output_token_amountIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetStaked_output_token_amount()
{
    m_Staked_output_token_amountIsSet = false;
}
std::vector<utility::string_t>& CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getRewardTokenEmissionsAmount()
{
    return m_Reward_token_emissions_amount;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setRewardTokenEmissionsAmount(const std::vector<utility::string_t>& value)
{
    m_Reward_token_emissions_amount = value;
    m_Reward_token_emissions_amountIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::rewardTokenEmissionsAmountIsSet() const
{
    return m_Reward_token_emissions_amountIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetReward_token_emissions_amount()
{
    m_Reward_token_emissions_amountIsSet = false;
}
std::vector<utility::string_t>& CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getRewardTokenEmissionsUsd()
{
    return m_Reward_token_emissions_usd;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setRewardTokenEmissionsUsd(const std::vector<utility::string_t>& value)
{
    m_Reward_token_emissions_usd = value;
    m_Reward_token_emissions_usdIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::rewardTokenEmissionsUsdIsSet() const
{
    return m_Reward_token_emissions_usdIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetReward_token_emissions_usd()
{
    m_Reward_token_emissions_usdIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getRegistryAddress() const
{
    return m_Registry_address;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setRegistryAddress(const utility::string_t& value)
{
    m_Registry_address = value;
    m_Registry_addressIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::registryAddressIsSet() const
{
    return m_Registry_addressIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetRegistry_address()
{
    m_Registry_addressIsSet = false;
}
utility::string_t CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getGaugeAddress() const
{
    return m_Gauge_address;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setGaugeAddress(const utility::string_t& value)
{
    m_Gauge_address = value;
    m_Gauge_addressIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::gaugeAddressIsSet() const
{
    return m_Gauge_addressIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetGauge_address()
{
    m_Gauge_addressIsSet = false;
}
double CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::getEvaluatedAsk() const
{
    return m_Evaluated_ask;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::setEvaluatedAsk(double value)
{
    m_Evaluated_ask = value;
    m_Evaluated_askIsSet = true;
}

bool CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::evaluatedAskIsSet() const
{
    return m_Evaluated_askIsSet;
}

void CURVE_FINANCE_ETHEREUM_LiquidityPoolDTO::unsetEvaluated_ask()
{
    m_Evaluated_askIsSet = false;
}
}
