...
Dex_WithdrawRequestDTO::Dex_WithdrawRequestDTO()
{
    ...
    m_AmountIsSet = false;
    m_Withdrawable_from_batch_id = utility::conversions::to_string_t("");
    m_Withdrawable_from_batch_idIsSet = false;
...
void Dex_WithdrawRequestDTO::validate()
{
    // TODO: implement validation
}

web::json::value Dex_WithdrawRequestDTO::toJson() const
{
    ...
    if(m_Withdrawable_from_batch_idIsSet)
    {
        val[utility::conversions::to_string_t(U("withdrawable_from_batch_id"))] = ModelBase::toJson(m_Withdrawable_from_batch_id);
    }
...
bool Dex_WithdrawRequestDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("withdrawable_from_batch_id"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("withdrawable_from_batch_id")));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setWithdrawableFromBatchId;
            ok &= ModelBase::fromJson(fieldValue, refVal_setWithdrawableFromBatchId);
            setWithdrawableFromBatchId(refVal_setWithdrawableFromBatchId);
        }
    }
...
void Dex_WithdrawRequestDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Withdrawable_from_batch_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("withdrawable_from_batch_id")), m_Withdrawable_from_batch_id));
    }
    if(m_Create_epochIsSet)
    {
...
bool Dex_WithdrawRequestDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("withdrawable_from_batch_id"))))
    {
        utility::string_t refVal_setWithdrawableFromBatchId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("withdrawable_from_batch_id"))), refVal_setWithdrawableFromBatchId );
        setWithdrawableFromBatchId(refVal_setWithdrawableFromBatchId);
    }
...
utility::datetime Dex_WithdrawRequestDTO::getEntryTime() const
{
    return m_Entry_time;
}

void Dex_WithdrawRequestDTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool Dex_WithdrawRequestDTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void Dex_WithdrawRequestDTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime Dex_WithdrawRequestDTO::getRecvTime() const
{
    return m_Recv_time;
}

void Dex_WithdrawRequestDTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool Dex_WithdrawRequestDTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void Dex_WithdrawRequestDTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t Dex_WithdrawRequestDTO::getBlockNumber() const
{
    return m_Block_number;
}

void Dex_WithdrawRequestDTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool Dex_WithdrawRequestDTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void Dex_WithdrawRequestDTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t Dex_WithdrawRequestDTO::getId() const
{
    return m_Id;
}

void Dex_WithdrawRequestDTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Dex_WithdrawRequestDTO::idIsSet() const
{
    return m_IdIsSet;
}

void Dex_WithdrawRequestDTO::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Dex_WithdrawRequestDTO::getUser() const
{
    return m_User;
}

void Dex_WithdrawRequestDTO::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dex_WithdrawRequestDTO::userIsSet() const
{
    return m_UserIsSet;
}

void Dex_WithdrawRequestDTO::unsetUser()
{
    m_UserIsSet = false;
}
utility::string_t Dex_WithdrawRequestDTO::getTokenAddress() const
{
    return m_Token_address;
}

void Dex_WithdrawRequestDTO::setTokenAddress(const utility::string_t& value)
{
    m_Token_address = value;
    m_Token_addressIsSet = true;
}

bool Dex_WithdrawRequestDTO::tokenAddressIsSet() const
{
    return m_Token_addressIsSet;
}

void Dex_WithdrawRequestDTO::unsetToken_address()
{
    m_Token_addressIsSet = false;
}
utility::string_t Dex_WithdrawRequestDTO::getAmount() const
{
    return m_Amount;
}

void Dex_WithdrawRequestDTO::setAmount(const utility::string_t& value)
{
    m_Amount = value;
    m_AmountIsSet = true;
}

bool Dex_WithdrawRequestDTO::amountIsSet() const
{
    return m_AmountIsSet;
}

void Dex_WithdrawRequestDTO::unsetAmount()
{
    m_AmountIsSet = false;
}
utility::string_t Dex_WithdrawRequestDTO::getWithdrawableFromBatchId() const
{
    return m_Withdrawable_from_batch_id;
}

void Dex_WithdrawRequestDTO::setWithdrawableFromBatchId(const utility::string_t& value)
{
    m_Withdrawable_from_batch_id = value;
    m_Withdrawable_from_batch_idIsSet = true;
}

bool Dex_WithdrawRequestDTO::withdrawableFromBatchIdIsSet() const
{
    return m_Withdrawable_from_batch_idIsSet;
}

void Dex_WithdrawRequestDTO::unsetWithdrawable_from_batch_id()
{
    m_Withdrawable_from_batch_idIsSet = false;
}
utility::string_t Dex_WithdrawRequestDTO::getCreateEpoch() const
{
    return m_Create_epoch;
}

void Dex_WithdrawRequestDTO::setCreateEpoch(const utility::string_t& value)
{
    m_Create_epoch = value;
    m_Create_epochIsSet = true;
}

bool Dex_WithdrawRequestDTO::createEpochIsSet() const
{
    return m_Create_epochIsSet;
}

void Dex_WithdrawRequestDTO::unsetCreate_epoch()
{
    m_Create_epochIsSet = false;
}
utility::string_t Dex_WithdrawRequestDTO::getCreateBatchId() const
{
    return m_Create_batch_id;
}

void Dex_WithdrawRequestDTO::setCreateBatchId(const utility::string_t& value)
{
    m_Create_batch_id = value;
    m_Create_batch_idIsSet = true;
}

bool Dex_WithdrawRequestDTO::createBatchIdIsSet() const
{
    return m_Create_batch_idIsSet;
}

void Dex_WithdrawRequestDTO::unsetCreate_batch_id()
{
    m_Create_batch_idIsSet = false;
}
utility::string_t Dex_WithdrawRequestDTO::getTxHash() const
{
    return m_Tx_hash;
}

void Dex_WithdrawRequestDTO::setTxHash(const utility::string_t& value)
{
    m_Tx_hash = value;
    m_Tx_hashIsSet = true;
}

bool Dex_WithdrawRequestDTO::txHashIsSet() const
{
    return m_Tx_hashIsSet;
}

void Dex_WithdrawRequestDTO::unsetTx_hash()
{
    m_Tx_hashIsSet = false;
}
int64_t Dex_WithdrawRequestDTO::getVid() const
{
    return m_Vid;
}

void Dex_WithdrawRequestDTO::setVid(int64_t value)
{
    m_Vid = value;
    m_VidIsSet = true;
}

bool Dex_WithdrawRequestDTO::vidIsSet() const
{
    return m_VidIsSet;
}

void Dex_WithdrawRequestDTO::unsetVid()
{
    m_VidIsSet = false;
}
}
