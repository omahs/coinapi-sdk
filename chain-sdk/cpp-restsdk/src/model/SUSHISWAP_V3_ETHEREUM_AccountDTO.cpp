...
SUSHISWAP_V3_ETHEREUM_AccountDTO::SUSHISWAP_V3_ETHEREUM_AccountDTO()
{
...
void SUSHISWAP_V3_ETHEREUM_AccountDTO::validate()
{
    // TODO: implement validation
}

web::json::value SUSHISWAP_V3_ETHEREUM_AccountDTO::toJson() const
{
...
bool SUSHISWAP_V3_ETHEREUM_AccountDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SUSHISWAP_V3_ETHEREUM_AccountDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SUSHISWAP_V3_ETHEREUM_AccountDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime SUSHISWAP_V3_ETHEREUM_AccountDTO::getEntryTime() const
{
    return m_Entry_time;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime SUSHISWAP_V3_ETHEREUM_AccountDTO::getRecvTime() const
{
    return m_Recv_time;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getBlockNumber() const
{
    return m_Block_number;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getBlockRange() const
{
    return m_Block_range;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setBlockRange(const utility::string_t& value)
{
    m_Block_range = value;
    m_Block_rangeIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::blockRangeIsSet() const
{
    return m_Block_rangeIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetBlock_range()
{
    m_Block_rangeIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getId() const
{
    return m_Id;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::idIsSet() const
{
    return m_IdIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetId()
{
    m_IdIsSet = false;
}
int32_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getPositionCount() const
{
    return m_Position_count;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setPositionCount(int32_t value)
{
    m_Position_count = value;
    m_Position_countIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::positionCountIsSet() const
{
    return m_Position_countIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetPosition_count()
{
    m_Position_countIsSet = false;
}
int32_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getOpenPositionCount() const
{
    return m_Open_position_count;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setOpenPositionCount(int32_t value)
{
    m_Open_position_count = value;
    m_Open_position_countIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::openPositionCountIsSet() const
{
    return m_Open_position_countIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetOpen_position_count()
{
    m_Open_position_countIsSet = false;
}
int32_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getClosedPositionCount() const
{
    return m_Closed_position_count;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setClosedPositionCount(int32_t value)
{
    m_Closed_position_count = value;
    m_Closed_position_countIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::closedPositionCountIsSet() const
{
    return m_Closed_position_countIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetClosed_position_count()
{
    m_Closed_position_countIsSet = false;
}
int32_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getDepositCount() const
{
    return m_Deposit_count;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setDepositCount(int32_t value)
{
    m_Deposit_count = value;
    m_Deposit_countIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::depositCountIsSet() const
{
    return m_Deposit_countIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetDeposit_count()
{
    m_Deposit_countIsSet = false;
}
int32_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getWithdrawCount() const
{
    return m_Withdraw_count;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setWithdrawCount(int32_t value)
{
    m_Withdraw_count = value;
    m_Withdraw_countIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::withdrawCountIsSet() const
{
    return m_Withdraw_countIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetWithdraw_count()
{
    m_Withdraw_countIsSet = false;
}
int32_t SUSHISWAP_V3_ETHEREUM_AccountDTO::getSwapCount() const
{
    return m_Swap_count;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::setSwapCount(int32_t value)
{
    m_Swap_count = value;
    m_Swap_countIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_AccountDTO::swapCountIsSet() const
{
    return m_Swap_countIsSet;
}

void SUSHISWAP_V3_ETHEREUM_AccountDTO::unsetSwap_count()
{
    m_Swap_countIsSet = false;
}
}
