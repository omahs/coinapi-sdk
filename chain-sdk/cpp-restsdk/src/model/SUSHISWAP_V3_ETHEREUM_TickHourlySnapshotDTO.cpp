...
SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO()
{
...
void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::validate()
{
    // TODO: implement validation
}

web::json::value SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::toJson() const
{
...
bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::datetime SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getEntryTime() const
{
    return m_Entry_time;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setEntryTime(const utility::datetime& value)
{
    m_Entry_time = value;
    m_Entry_timeIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::entryTimeIsSet() const
{
    return m_Entry_timeIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetEntry_time()
{
    m_Entry_timeIsSet = false;
}
utility::datetime SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getRecvTime() const
{
    return m_Recv_time;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setRecvTime(const utility::datetime& value)
{
    m_Recv_time = value;
    m_Recv_timeIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::recvTimeIsSet() const
{
    return m_Recv_timeIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetRecv_time()
{
    m_Recv_timeIsSet = false;
}
int64_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getBlockNumber() const
{
    return m_Block_number;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setBlockNumber(int64_t value)
{
    m_Block_number = value;
    m_Block_numberIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::blockNumberIsSet() const
{
    return m_Block_numberIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetBlock_number()
{
    m_Block_numberIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getId() const
{
    return m_Id;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::idIsSet() const
{
    return m_IdIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetId()
{
    m_IdIsSet = false;
}
int32_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getHourId() const
{
    return m_Hour_id;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setHourId(int32_t value)
{
    m_Hour_id = value;
    m_Hour_idIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::hourIdIsSet() const
{
    return m_Hour_idIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetHour_id()
{
    m_Hour_idIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getTick() const
{
    return m_Tick;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setTick(const utility::string_t& value)
{
    m_Tick = value;
    m_TickIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::tickIsSet() const
{
    return m_TickIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetTick()
{
    m_TickIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getPool() const
{
    return m_Pool;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setPool(const utility::string_t& value)
{
    m_Pool = value;
    m_PoolIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::poolIsSet() const
{
    return m_PoolIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetPool()
{
    m_PoolIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getLiquidityGross() const
{
    return m_Liquidity_gross;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setLiquidityGross(const utility::string_t& value)
{
    m_Liquidity_gross = value;
    m_Liquidity_grossIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::liquidityGrossIsSet() const
{
    return m_Liquidity_grossIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetLiquidity_gross()
{
    m_Liquidity_grossIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getLiquidityGrossUsd() const
{
    return m_Liquidity_gross_usd;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setLiquidityGrossUsd(const utility::string_t& value)
{
    m_Liquidity_gross_usd = value;
    m_Liquidity_gross_usdIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::liquidityGrossUsdIsSet() const
{
    return m_Liquidity_gross_usdIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetLiquidity_gross_usd()
{
    m_Liquidity_gross_usdIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getLiquidityNet() const
{
    return m_Liquidity_net;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setLiquidityNet(const utility::string_t& value)
{
    m_Liquidity_net = value;
    m_Liquidity_netIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::liquidityNetIsSet() const
{
    return m_Liquidity_netIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetLiquidity_net()
{
    m_Liquidity_netIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getLiquidityNetUsd() const
{
    return m_Liquidity_net_usd;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setLiquidityNetUsd(const utility::string_t& value)
{
    m_Liquidity_net_usd = value;
    m_Liquidity_net_usdIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::liquidityNetUsdIsSet() const
{
    return m_Liquidity_net_usdIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetLiquidity_net_usd()
{
    m_Liquidity_net_usdIsSet = false;
}
utility::string_t SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::getTimestamp() const
{
    return m_Timestamp;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::setTimestamp(const utility::string_t& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void SUSHISWAP_V3_ETHEREUM_TickHourlySnapshotDTO::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
}
