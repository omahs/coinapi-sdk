...
/*
 * Curve_HourlyVolumeDTO.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Curve_HourlyVolumeDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Curve_HourlyVolumeDTO_H_
...
/// 
/// </summary>
class  Curve_HourlyVolumeDTO
    : public ModelBase
{
public:
    Curve_HourlyVolumeDTO();
    virtual ~Curve_HourlyVolumeDTO();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Curve_HourlyVolumeDTO_H_ */
