...
/*
 * Curve_WeeklyVolumeDTO.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Curve_WeeklyVolumeDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Curve_WeeklyVolumeDTO_H_
...
/// 
/// </summary>
class  Curve_WeeklyVolumeDTO
    : public ModelBase
{
public:
    Curve_WeeklyVolumeDTO();
    virtual ~Curve_WeeklyVolumeDTO();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Curve_WeeklyVolumeDTO_H_ */
