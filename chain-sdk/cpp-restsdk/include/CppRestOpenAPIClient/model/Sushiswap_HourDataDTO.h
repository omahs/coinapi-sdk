...
/*
 * Sushiswap_HourDataDTO.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Sushiswap_HourDataDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Sushiswap_HourDataDTO_H_
...
/// 
/// </summary>
class  Sushiswap_HourDataDTO
    : public ModelBase
{
public:
    Sushiswap_HourDataDTO();
    virtual ~Sushiswap_HourDataDTO();
    ...
    /// 
    /// </summary>
    utility::string_t getUntrackedVolume() const;
    bool untrackedVolumeIsSet() const;
    void unsetUntracked_volume();

    void setUntrackedVolume(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_Untracked_volume;
    bool m_Untracked_volumeIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Sushiswap_HourDataDTO_H_ */
