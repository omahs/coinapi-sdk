...
/*
 * CURVE_FINANCE_ETHEREUM_DexAmmProtocolDTO.h
 *
 * Entity for calculating daily/hourly active users.
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CURVE_FINANCE_ETHEREUM_DexAmmProtocolDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CURVE_FINANCE_ETHEREUM_DexAmmProtocolDTO_H_
...
/// Entity for calculating daily/hourly active users.
/// </summary>
class  CURVE_FINANCE_ETHEREUM_DexAmmProtocolDTO
    : public ModelBase
{
public:
    CURVE_FINANCE_ETHEREUM_DexAmmProtocolDTO();
    virtual ~CURVE_FINANCE_ETHEREUM_DexAmmProtocolDTO();
    ...
    /////////////////////////////////////////////
    /// CURVE_FINANCE_ETHEREUM_DexAmmProtocolDTO members
    ...
    /// </summary>
    std::vector<utility::string_t>& getPoolIds();
    bool poolIdsIsSet() const;
    void unsetPool_ids();

    void setPoolIds(const std::vector<utility::string_t>& value);
...
protected:
    ...
    std::vector<utility::string_t> m_Pool_ids;
    bool m_Pool_idsIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CURVE_FINANCE_ETHEREUM_DexAmmProtocolDTO_H_ */
