...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_SwapDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_SwapDTO_H_
...
/// Swap are created for each token swap within a pair.
/// </summary>
class  UniswapV2_SwapDTO
    : public ModelBase
{
public:
    UniswapV2_SwapDTO();
    virtual ~UniswapV2_SwapDTO();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UniswapV2_SwapDTO_H_ */
