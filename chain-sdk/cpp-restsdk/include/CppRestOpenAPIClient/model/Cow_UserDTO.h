...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Cow_UserDTO_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Cow_UserDTO_H_
...
public:
    ...
    /// </summary>
    bool isIsSolver() const;
    bool isSolverIsSet() const;
    void unsetIs_solver();

    void setIsSolver(bool value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Cow_UserDTO_H_ */
