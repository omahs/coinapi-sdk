...
/*
 * UNISWAPV3ETHEREUMApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_UNISWAPV3ETHEREUMApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_UNISWAPV3ETHEREUMApi_H_
...
public:
    ...
    explicit UNISWAPV3ETHEREUMApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~UNISWAPV3ETHEREUMApi();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_UNISWAPV3ETHEREUMApi_H_ */
