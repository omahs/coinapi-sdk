...
public class SUSHISWAPV3ETHEREUMPositionDTO {
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO() {
  }

  public SUSHISWAPV3ETHEREUMPositionDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO id(String id) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO account(String account) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO pool(String pool) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO hashOpened(String hashOpened) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO hashClosed(String hashClosed) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO blockNumberOpened(String blockNumberOpened) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO timestampOpened(String timestampOpened) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO blockNumberClosed(String blockNumberClosed) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO timestampClosed(String timestampClosed) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO tickLower(String tickLower) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO tickUpper(String tickUpper) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO liquidityToken(String liquidityToken) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO liquidityTokenType(String liquidityTokenType) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO liquidity(String liquidity) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO liquidityUsd(String liquidityUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO cumulativeDepositTokenAmounts(List<String> cumulativeDepositTokenAmounts) {
    
    this.cumulativeDepositTokenAmounts = cumulativeDepositTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMPositionDTO addCumulativeDepositTokenAmountsItem(String cumulativeDepositTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO cumulativeDepositUsd(String cumulativeDepositUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO cumulativeWithdrawTokenAmounts(List<String> cumulativeWithdrawTokenAmounts) {
    
    this.cumulativeWithdrawTokenAmounts = cumulativeWithdrawTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMPositionDTO addCumulativeWithdrawTokenAmountsItem(String cumulativeWithdrawTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO cumulativeWithdrawUsd(String cumulativeWithdrawUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO cumulativeRewardUsd(List<String> cumulativeRewardUsd) {
    
    this.cumulativeRewardUsd = cumulativeRewardUsd;
    return this;
  }

  public SUSHISWAPV3ETHEREUMPositionDTO addCumulativeRewardUsdItem(String cumulativeRewardUsdItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO depositCount(Integer depositCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionDTO withdrawCount(Integer withdrawCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SUSHISWAPV3ETHEREUMPositionDTO suSHISWAPV3ETHEREUMPositionDTO = (SUSHISWAPV3ETHEREUMPositionDTO) o;
    return Objects.equals(this.entryTime, suSHISWAPV3ETHEREUMPositionDTO.entryTime) &&
        Objects.equals(this.recvTime, suSHISWAPV3ETHEREUMPositionDTO.recvTime) &&
        Objects.equals(this.blockNumber, suSHISWAPV3ETHEREUMPositionDTO.blockNumber) &&
        Objects.equals(this.id, suSHISWAPV3ETHEREUMPositionDTO.id) &&
        Objects.equals(this.account, suSHISWAPV3ETHEREUMPositionDTO.account) &&
        Objects.equals(this.pool, suSHISWAPV3ETHEREUMPositionDTO.pool) &&
        Objects.equals(this.hashOpened, suSHISWAPV3ETHEREUMPositionDTO.hashOpened) &&
        Objects.equals(this.hashClosed, suSHISWAPV3ETHEREUMPositionDTO.hashClosed) &&
        Objects.equals(this.blockNumberOpened, suSHISWAPV3ETHEREUMPositionDTO.blockNumberOpened) &&
        Objects.equals(this.timestampOpened, suSHISWAPV3ETHEREUMPositionDTO.timestampOpened) &&
        Objects.equals(this.blockNumberClosed, suSHISWAPV3ETHEREUMPositionDTO.blockNumberClosed) &&
        Objects.equals(this.timestampClosed, suSHISWAPV3ETHEREUMPositionDTO.timestampClosed) &&
        Objects.equals(this.tickLower, suSHISWAPV3ETHEREUMPositionDTO.tickLower) &&
        Objects.equals(this.tickUpper, suSHISWAPV3ETHEREUMPositionDTO.tickUpper) &&
        Objects.equals(this.liquidityToken, suSHISWAPV3ETHEREUMPositionDTO.liquidityToken) &&
        Objects.equals(this.liquidityTokenType, suSHISWAPV3ETHEREUMPositionDTO.liquidityTokenType) &&
        Objects.equals(this.liquidity, suSHISWAPV3ETHEREUMPositionDTO.liquidity) &&
        Objects.equals(this.liquidityUsd, suSHISWAPV3ETHEREUMPositionDTO.liquidityUsd) &&
        Objects.equals(this.cumulativeDepositTokenAmounts, suSHISWAPV3ETHEREUMPositionDTO.cumulativeDepositTokenAmounts) &&
        Objects.equals(this.cumulativeDepositUsd, suSHISWAPV3ETHEREUMPositionDTO.cumulativeDepositUsd) &&
        Objects.equals(this.cumulativeWithdrawTokenAmounts, suSHISWAPV3ETHEREUMPositionDTO.cumulativeWithdrawTokenAmounts) &&
        Objects.equals(this.cumulativeWithdrawUsd, suSHISWAPV3ETHEREUMPositionDTO.cumulativeWithdrawUsd) &&
        Objects.equals(this.cumulativeRewardUsd, suSHISWAPV3ETHEREUMPositionDTO.cumulativeRewardUsd) &&
        Objects.equals(this.depositCount, suSHISWAPV3ETHEREUMPositionDTO.depositCount) &&
        Objects.equals(this.withdrawCount, suSHISWAPV3ETHEREUMPositionDTO.withdrawCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class SUSHISWAPV3ETHEREUMPositionDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SUSHISWAPV3ETHEREUMPositionDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SUSHISWAPV3ETHEREUMPositionDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SUSHISWAPV3ETHEREUMPositionDTO is not found in the empty JSON string", SUSHISWAPV3ETHEREUMPositionDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SUSHISWAPV3ETHEREUMPositionDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SUSHISWAPV3ETHEREUMPositionDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SUSHISWAPV3ETHEREUMPositionDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SUSHISWAPV3ETHEREUMPositionDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SUSHISWAPV3ETHEREUMPositionDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SUSHISWAPV3ETHEREUMPositionDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SUSHISWAPV3ETHEREUMPositionDTO>() {
           @Override
           public void write(JsonWriter out, SUSHISWAPV3ETHEREUMPositionDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SUSHISWAPV3ETHEREUMPositionDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SUSHISWAPV3ETHEREUMPositionDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SUSHISWAPV3ETHEREUMPositionDTO
  * @throws IOException if the JSON string is invalid with respect to SUSHISWAPV3ETHEREUMPositionDTO
  */
  public static SUSHISWAPV3ETHEREUMPositionDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SUSHISWAPV3ETHEREUMPositionDTO.class);
  }

 /**
  * Convert an instance of SUSHISWAPV3ETHEREUMPositionDTO to an JSON string
  *
  * @return JSON string
  */
