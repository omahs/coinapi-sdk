...
public class SushiswapDayDataDTO {
  ...
  public SushiswapDayDataDTO() {
  }

  public SushiswapDayDataDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SushiswapDayDataDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SushiswapDayDataDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SushiswapDayDataDTO id(String id) {
  ...
  **/
  ...
  public SushiswapDayDataDTO date(Integer date) {
  ...
  **/
  ...
  public SushiswapDayDataDTO factory(String factory) {
  ...
  **/
  ...
  public SushiswapDayDataDTO volumeEth(String volumeEth) {
  ...
  **/
  ...
  public SushiswapDayDataDTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public SushiswapDayDataDTO untrackedVolume(String untrackedVolume) {
  ...
  **/
  ...
  public SushiswapDayDataDTO liquidityEth(String liquidityEth) {
  ...
  **/
  ...
  public SushiswapDayDataDTO liquidityUsd(String liquidityUsd) {
  ...
  **/
  ...
  public SushiswapDayDataDTO txCount(String txCount) {
  ...
  **/
  ...
  public SushiswapDayDataDTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, sushiswapDayDataDTO.entryTime) &&
        Objects.equals(this.recvTime, sushiswapDayDataDTO.recvTime) &&
        Objects.equals(this.blockNumber, sushiswapDayDataDTO.blockNumber) &&
        Objects.equals(this.id, sushiswapDayDataDTO.id) &&
        Objects.equals(this.date, sushiswapDayDataDTO.date) &&
        Objects.equals(this.factory, sushiswapDayDataDTO.factory) &&
        Objects.equals(this.volumeEth, sushiswapDayDataDTO.volumeEth) &&
        Objects.equals(this.volumeUsd, sushiswapDayDataDTO.volumeUsd) &&
        Objects.equals(this.untrackedVolume, sushiswapDayDataDTO.untrackedVolume) &&
        Objects.equals(this.liquidityEth, sushiswapDayDataDTO.liquidityEth) &&
        Objects.equals(this.liquidityUsd, sushiswapDayDataDTO.liquidityUsd) &&
        Objects.equals(this.txCount, sushiswapDayDataDTO.txCount) &&
        Objects.equals(this.vid, sushiswapDayDataDTO.vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SushiswapDayDataDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SushiswapDayDataDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SushiswapDayDataDTO is not found in the empty JSON string", SushiswapDayDataDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SushiswapDayDataDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SushiswapDayDataDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SushiswapDayDataDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SushiswapDayDataDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SushiswapDayDataDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SushiswapDayDataDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SushiswapDayDataDTO>() {
           @Override
           public void write(JsonWriter out, SushiswapDayDataDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SushiswapDayDataDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SushiswapDayDataDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SushiswapDayDataDTO
  * @throws IOException if the JSON string is invalid with respect to SushiswapDayDataDTO
  */
  public static SushiswapDayDataDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SushiswapDayDataDTO.class);
  }

 /**
  * Convert an instance of SushiswapDayDataDTO to an JSON string
  *
  * @return JSON string
  */
