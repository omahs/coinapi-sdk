...
public class UNISWAPV3ETHEREUMTickDailySnapshotDTO {
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO() {
  }

  public UNISWAPV3ETHEREUMTickDailySnapshotDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO id(String id) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO dayId(Integer dayId) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO tick(String tick) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO pool(String pool) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO liquidityGross(String liquidityGross) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO liquidityGrossUsd(String liquidityGrossUsd) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO liquidityNet(String liquidityNet) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO liquidityNetUsd(String liquidityNetUsd) {
  ...
  **/
  ...
  public UNISWAPV3ETHEREUMTickDailySnapshotDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UNISWAPV3ETHEREUMTickDailySnapshotDTO unISWAPV3ETHEREUMTickDailySnapshotDTO = (UNISWAPV3ETHEREUMTickDailySnapshotDTO) o;
    return Objects.equals(this.entryTime, unISWAPV3ETHEREUMTickDailySnapshotDTO.entryTime) &&
        ...
        Objects.equals(this.pool, unISWAPV3ETHEREUMTickDailySnapshotDTO.pool) &&
        Objects.equals(this.liquidityGross, unISWAPV3ETHEREUMTickDailySnapshotDTO.liquidityGross) &&
        Objects.equals(this.liquidityGrossUsd, unISWAPV3ETHEREUMTickDailySnapshotDTO.liquidityGrossUsd) &&
        Objects.equals(this.liquidityNet, unISWAPV3ETHEREUMTickDailySnapshotDTO.liquidityNet) &&
        Objects.equals(this.liquidityNetUsd, unISWAPV3ETHEREUMTickDailySnapshotDTO.liquidityNetUsd) &&
        Objects.equals(this.timestamp, unISWAPV3ETHEREUMTickDailySnapshotDTO.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class UNISWAPV3ETHEREUMTickDailySnapshotDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UNISWAPV3ETHEREUMTickDailySnapshotDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UNISWAPV3ETHEREUMTickDailySnapshotDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UNISWAPV3ETHEREUMTickDailySnapshotDTO is not found in the empty JSON string", UNISWAPV3ETHEREUMTickDailySnapshotDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UNISWAPV3ETHEREUMTickDailySnapshotDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UNISWAPV3ETHEREUMTickDailySnapshotDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UNISWAPV3ETHEREUMTickDailySnapshotDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UNISWAPV3ETHEREUMTickDailySnapshotDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UNISWAPV3ETHEREUMTickDailySnapshotDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UNISWAPV3ETHEREUMTickDailySnapshotDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UNISWAPV3ETHEREUMTickDailySnapshotDTO>() {
           @Override
           public void write(JsonWriter out, UNISWAPV3ETHEREUMTickDailySnapshotDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UNISWAPV3ETHEREUMTickDailySnapshotDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UNISWAPV3ETHEREUMTickDailySnapshotDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UNISWAPV3ETHEREUMTickDailySnapshotDTO
  * @throws IOException if the JSON string is invalid with respect to UNISWAPV3ETHEREUMTickDailySnapshotDTO
  */
  public static UNISWAPV3ETHEREUMTickDailySnapshotDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UNISWAPV3ETHEREUMTickDailySnapshotDTO.class);
  }

 /**
  * Convert an instance of UNISWAPV3ETHEREUMTickDailySnapshotDTO to an JSON string
  *
  * @return JSON string
  */
