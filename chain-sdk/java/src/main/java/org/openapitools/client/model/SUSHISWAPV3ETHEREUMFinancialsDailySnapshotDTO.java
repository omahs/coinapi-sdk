...
public class SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO {
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO() {
  }

  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO blockNumber(Integer blockNumber) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO id(String id) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO day(Integer day) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO protocol(String protocol) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO activeLiquidityUsd(String activeLiquidityUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO uncollectedProtocolSideValueUsd(String uncollectedProtocolSideValueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO uncollectedSupplySideValueUsd(String uncollectedSupplySideValueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO protocolControlledValueUsd(String protocolControlledValueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO dailyVolumeUsd(String dailyVolumeUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO cumulativeVolumeUsd(String cumulativeVolumeUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO dailySupplySideRevenueUsd(String dailySupplySideRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO cumulativeSupplySideRevenueUsd(String cumulativeSupplySideRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO dailyProtocolSideRevenueUsd(String dailyProtocolSideRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO cumulativeProtocolSideRevenueUsd(String cumulativeProtocolSideRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO dailyTotalRevenueUsd(String dailyTotalRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO cumulativeTotalRevenueUsd(String cumulativeTotalRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO = (SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO) o;
    return Objects.equals(this.entryTime, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.entryTime) &&
        Objects.equals(this.recvTime, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.recvTime) &&
        Objects.equals(this.blockNumber, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.blockNumber) &&
        Objects.equals(this.id, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.id) &&
        Objects.equals(this.day, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.day) &&
        Objects.equals(this.protocol, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocol) &&
        Objects.equals(this.totalValueLockedUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalValueLockedUsd) &&
        Objects.equals(this.totalLiquidityUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalLiquidityUsd) &&
        Objects.equals(this.activeLiquidityUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.activeLiquidityUsd) &&
        Objects.equals(this.uncollectedProtocolSideValueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedProtocolSideValueUsd) &&
        Objects.equals(this.uncollectedSupplySideValueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedSupplySideValueUsd) &&
        Objects.equals(this.protocolControlledValueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocolControlledValueUsd) &&
        Objects.equals(this.dailyVolumeUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyVolumeUsd) &&
        Objects.equals(this.cumulativeVolumeUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeVolumeUsd) &&
        Objects.equals(this.dailySupplySideRevenueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailySupplySideRevenueUsd) &&
        Objects.equals(this.cumulativeSupplySideRevenueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeSupplySideRevenueUsd) &&
        Objects.equals(this.dailyProtocolSideRevenueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyProtocolSideRevenueUsd) &&
        Objects.equals(this.cumulativeProtocolSideRevenueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeProtocolSideRevenueUsd) &&
        Objects.equals(this.dailyTotalRevenueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyTotalRevenueUsd) &&
        Objects.equals(this.cumulativeTotalRevenueUsd, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeTotalRevenueUsd) &&
        Objects.equals(this.timestamp, suSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO is not found in the empty JSON string", SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO>() {
           @Override
           public void write(JsonWriter out, SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO
  * @throws IOException if the JSON string is invalid with respect to SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO
  */
  public static SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.class);
  }

 /**
  * Convert an instance of SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO to an JSON string
  *
  * @return JSON string
  */
