...
public class SUSHISWAPV3ETHEREUMPositionSnapshotDTO {
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO() {
  }

  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO id(String id) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO hash(String hash) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO logIndex(Integer logIndex) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO nonce(String nonce) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO position(String position) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO liquidityTokenType(String liquidityTokenType) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO liquidity(String liquidity) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO liquidityUsd(String liquidityUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO cumulativeDepositTokenAmounts(List<String> cumulativeDepositTokenAmounts) {
    
    this.cumulativeDepositTokenAmounts = cumulativeDepositTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO addCumulativeDepositTokenAmountsItem(String cumulativeDepositTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO cumulativeDepositUsd(String cumulativeDepositUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO cumulativeWithdrawTokenAmounts(List<String> cumulativeWithdrawTokenAmounts) {
    
    this.cumulativeWithdrawTokenAmounts = cumulativeWithdrawTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO addCumulativeWithdrawTokenAmountsItem(String cumulativeWithdrawTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO cumulativeWithdrawUsd(String cumulativeWithdrawUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO cumulativeRewardTokenAmounts(List<String> cumulativeRewardTokenAmounts) {
    
    this.cumulativeRewardTokenAmounts = cumulativeRewardTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO addCumulativeRewardTokenAmountsItem(String cumulativeRewardTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO cumulativeRewardUsd(List<String> cumulativeRewardUsd) {
    
    this.cumulativeRewardUsd = cumulativeRewardUsd;
    return this;
  }

  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO addCumulativeRewardUsdItem(String cumulativeRewardUsdItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO depositCount(Integer depositCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO withdrawCount(Integer withdrawCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMPositionSnapshotDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SUSHISWAPV3ETHEREUMPositionSnapshotDTO suSHISWAPV3ETHEREUMPositionSnapshotDTO = (SUSHISWAPV3ETHEREUMPositionSnapshotDTO) o;
    return Objects.equals(this.entryTime, suSHISWAPV3ETHEREUMPositionSnapshotDTO.entryTime) &&
        Objects.equals(this.recvTime, suSHISWAPV3ETHEREUMPositionSnapshotDTO.recvTime) &&
        Objects.equals(this.blockNumber, suSHISWAPV3ETHEREUMPositionSnapshotDTO.blockNumber) &&
        Objects.equals(this.id, suSHISWAPV3ETHEREUMPositionSnapshotDTO.id) &&
        Objects.equals(this.hash, suSHISWAPV3ETHEREUMPositionSnapshotDTO.hash) &&
        Objects.equals(this.logIndex, suSHISWAPV3ETHEREUMPositionSnapshotDTO.logIndex) &&
        Objects.equals(this.nonce, suSHISWAPV3ETHEREUMPositionSnapshotDTO.nonce) &&
        Objects.equals(this.position, suSHISWAPV3ETHEREUMPositionSnapshotDTO.position) &&
        Objects.equals(this.liquidityTokenType, suSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidityTokenType) &&
        Objects.equals(this.liquidity, suSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidity) &&
        Objects.equals(this.liquidityUsd, suSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidityUsd) &&
        Objects.equals(this.cumulativeDepositTokenAmounts, suSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositTokenAmounts) &&
        Objects.equals(this.cumulativeDepositUsd, suSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositUsd) &&
        Objects.equals(this.cumulativeWithdrawTokenAmounts, suSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawTokenAmounts) &&
        Objects.equals(this.cumulativeWithdrawUsd, suSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawUsd) &&
        Objects.equals(this.cumulativeRewardTokenAmounts, suSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardTokenAmounts) &&
        Objects.equals(this.cumulativeRewardUsd, suSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardUsd) &&
        Objects.equals(this.depositCount, suSHISWAPV3ETHEREUMPositionSnapshotDTO.depositCount) &&
        Objects.equals(this.withdrawCount, suSHISWAPV3ETHEREUMPositionSnapshotDTO.withdrawCount) &&
        Objects.equals(this.timestamp, suSHISWAPV3ETHEREUMPositionSnapshotDTO.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class SUSHISWAPV3ETHEREUMPositionSnapshotDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SUSHISWAPV3ETHEREUMPositionSnapshotDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SUSHISWAPV3ETHEREUMPositionSnapshotDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SUSHISWAPV3ETHEREUMPositionSnapshotDTO is not found in the empty JSON string", SUSHISWAPV3ETHEREUMPositionSnapshotDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SUSHISWAPV3ETHEREUMPositionSnapshotDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SUSHISWAPV3ETHEREUMPositionSnapshotDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SUSHISWAPV3ETHEREUMPositionSnapshotDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SUSHISWAPV3ETHEREUMPositionSnapshotDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SUSHISWAPV3ETHEREUMPositionSnapshotDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SUSHISWAPV3ETHEREUMPositionSnapshotDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SUSHISWAPV3ETHEREUMPositionSnapshotDTO>() {
           @Override
           public void write(JsonWriter out, SUSHISWAPV3ETHEREUMPositionSnapshotDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SUSHISWAPV3ETHEREUMPositionSnapshotDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SUSHISWAPV3ETHEREUMPositionSnapshotDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SUSHISWAPV3ETHEREUMPositionSnapshotDTO
  * @throws IOException if the JSON string is invalid with respect to SUSHISWAPV3ETHEREUMPositionSnapshotDTO
  */
  public static SUSHISWAPV3ETHEREUMPositionSnapshotDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SUSHISWAPV3ETHEREUMPositionSnapshotDTO.class);
  }

 /**
  * Convert an instance of SUSHISWAPV3ETHEREUMPositionSnapshotDTO to an JSON string
  *
  * @return JSON string
  */
