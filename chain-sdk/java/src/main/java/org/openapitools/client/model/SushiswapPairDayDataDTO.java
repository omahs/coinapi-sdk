...
public class SushiswapPairDayDataDTO {
  ...
  public SushiswapPairDayDataDTO() {
  }

  public SushiswapPairDayDataDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO id(String id) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO date(Integer date) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO pair(String pair) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO token0(String token0) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO token1(String token1) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO reserve0(String reserve0) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO reserve1(String reserve1) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO totalSupply(String totalSupply) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO reserveUsd(String reserveUsd) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO volumeToken0(String volumeToken0) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO volumeToken1(String volumeToken1) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO volumeUsd(String volumeUsd) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO txCount(String txCount) {
  ...
  **/
  ...
  public SushiswapPairDayDataDTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, sushiswapPairDayDataDTO.entryTime) &&
        Objects.equals(this.recvTime, sushiswapPairDayDataDTO.recvTime) &&
        Objects.equals(this.blockNumber, sushiswapPairDayDataDTO.blockNumber) &&
        Objects.equals(this.id, sushiswapPairDayDataDTO.id) &&
        Objects.equals(this.date, sushiswapPairDayDataDTO.date) &&
        Objects.equals(this.pair, sushiswapPairDayDataDTO.pair) &&
        Objects.equals(this.token0, sushiswapPairDayDataDTO.token0) &&
        Objects.equals(this.token1, sushiswapPairDayDataDTO.token1) &&
        Objects.equals(this.reserve0, sushiswapPairDayDataDTO.reserve0) &&
        Objects.equals(this.reserve1, sushiswapPairDayDataDTO.reserve1) &&
        Objects.equals(this.totalSupply, sushiswapPairDayDataDTO.totalSupply) &&
        Objects.equals(this.reserveUsd, sushiswapPairDayDataDTO.reserveUsd) &&
        Objects.equals(this.volumeToken0, sushiswapPairDayDataDTO.volumeToken0) &&
        Objects.equals(this.volumeToken1, sushiswapPairDayDataDTO.volumeToken1) &&
        Objects.equals(this.volumeUsd, sushiswapPairDayDataDTO.volumeUsd) &&
        Objects.equals(this.txCount, sushiswapPairDayDataDTO.txCount) &&
        Objects.equals(this.vid, sushiswapPairDayDataDTO.vid);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entryTime, recvTime, blockNumber, id, date, pair, token0, token1, reserve0, reserve1, totalSupply, reserveUsd, volumeToken0, volumeToken1, volumeUsd, txCount, vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SushiswapPairDayDataDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SushiswapPairDayDataDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SushiswapPairDayDataDTO is not found in the empty JSON string", SushiswapPairDayDataDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SushiswapPairDayDataDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SushiswapPairDayDataDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SushiswapPairDayDataDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SushiswapPairDayDataDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SushiswapPairDayDataDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SushiswapPairDayDataDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SushiswapPairDayDataDTO>() {
           @Override
           public void write(JsonWriter out, SushiswapPairDayDataDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SushiswapPairDayDataDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SushiswapPairDayDataDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SushiswapPairDayDataDTO
  * @throws IOException if the JSON string is invalid with respect to SushiswapPairDayDataDTO
  */
  public static SushiswapPairDayDataDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SushiswapPairDayDataDTO.class);
  }

 /**
  * Convert an instance of SushiswapPairDayDataDTO to an JSON string
  *
  * @return JSON string
  */
