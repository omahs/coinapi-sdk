...
public class SUSHISWAPV3ETHEREUMDepositDTO {
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO() {
  }

  public SUSHISWAPV3ETHEREUMDepositDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO block(Integer block) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO id(String id) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO hash(String hash) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO nonce(String nonce) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO logIndex(Integer logIndex) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO gasLimit(String gasLimit) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO gasUsed(String gasUsed) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO gasPrice(String gasPrice) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO protocol(String protocol) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO account(String account) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO position(String position) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO pool(String pool) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO tickLower(String tickLower) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO tickUpper(String tickUpper) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO liquidity(String liquidity) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO inputTokens(List<String> inputTokens) {
    
    this.inputTokens = inputTokens;
    return this;
  }

  public SUSHISWAPV3ETHEREUMDepositDTO addInputTokensItem(String inputTokensItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO inputTokenAmounts(List<String> inputTokenAmounts) {
    
    this.inputTokenAmounts = inputTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMDepositDTO addInputTokenAmountsItem(String inputTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO reserveAmounts(List<String> reserveAmounts) {
    
    this.reserveAmounts = reserveAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMDepositDTO addReserveAmountsItem(String reserveAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO amountUsd(String amountUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMDepositDTO blockRange(String blockRange) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, suSHISWAPV3ETHEREUMDepositDTO.entryTime) &&
        Objects.equals(this.recvTime, suSHISWAPV3ETHEREUMDepositDTO.recvTime) &&
        Objects.equals(this.blockNumber, suSHISWAPV3ETHEREUMDepositDTO.blockNumber) &&
        Objects.equals(this.block, suSHISWAPV3ETHEREUMDepositDTO.block) &&
        Objects.equals(this.id, suSHISWAPV3ETHEREUMDepositDTO.id) &&
        Objects.equals(this.hash, suSHISWAPV3ETHEREUMDepositDTO.hash) &&
        Objects.equals(this.nonce, suSHISWAPV3ETHEREUMDepositDTO.nonce) &&
        Objects.equals(this.logIndex, suSHISWAPV3ETHEREUMDepositDTO.logIndex) &&
        Objects.equals(this.gasLimit, suSHISWAPV3ETHEREUMDepositDTO.gasLimit) &&
        Objects.equals(this.gasUsed, suSHISWAPV3ETHEREUMDepositDTO.gasUsed) &&
        Objects.equals(this.gasPrice, suSHISWAPV3ETHEREUMDepositDTO.gasPrice) &&
        Objects.equals(this.protocol, suSHISWAPV3ETHEREUMDepositDTO.protocol) &&
        Objects.equals(this.account, suSHISWAPV3ETHEREUMDepositDTO.account) &&
        Objects.equals(this.position, suSHISWAPV3ETHEREUMDepositDTO.position) &&
        Objects.equals(this.pool, suSHISWAPV3ETHEREUMDepositDTO.pool) &&
        Objects.equals(this.tickLower, suSHISWAPV3ETHEREUMDepositDTO.tickLower) &&
        Objects.equals(this.tickUpper, suSHISWAPV3ETHEREUMDepositDTO.tickUpper) &&
        Objects.equals(this.timestamp, suSHISWAPV3ETHEREUMDepositDTO.timestamp) &&
        Objects.equals(this.liquidity, suSHISWAPV3ETHEREUMDepositDTO.liquidity) &&
        Objects.equals(this.inputTokens, suSHISWAPV3ETHEREUMDepositDTO.inputTokens) &&
        Objects.equals(this.inputTokenAmounts, suSHISWAPV3ETHEREUMDepositDTO.inputTokenAmounts) &&
        Objects.equals(this.reserveAmounts, suSHISWAPV3ETHEREUMDepositDTO.reserveAmounts) &&
        Objects.equals(this.amountUsd, suSHISWAPV3ETHEREUMDepositDTO.amountUsd) &&
        Objects.equals(this.blockRange, suSHISWAPV3ETHEREUMDepositDTO.blockRange);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SUSHISWAPV3ETHEREUMDepositDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SUSHISWAPV3ETHEREUMDepositDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SUSHISWAPV3ETHEREUMDepositDTO is not found in the empty JSON string", SUSHISWAPV3ETHEREUMDepositDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SUSHISWAPV3ETHEREUMDepositDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SUSHISWAPV3ETHEREUMDepositDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SUSHISWAPV3ETHEREUMDepositDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SUSHISWAPV3ETHEREUMDepositDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SUSHISWAPV3ETHEREUMDepositDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SUSHISWAPV3ETHEREUMDepositDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SUSHISWAPV3ETHEREUMDepositDTO>() {
           @Override
           public void write(JsonWriter out, SUSHISWAPV3ETHEREUMDepositDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SUSHISWAPV3ETHEREUMDepositDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SUSHISWAPV3ETHEREUMDepositDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SUSHISWAPV3ETHEREUMDepositDTO
  * @throws IOException if the JSON string is invalid with respect to SUSHISWAPV3ETHEREUMDepositDTO
  */
  public static SUSHISWAPV3ETHEREUMDepositDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SUSHISWAPV3ETHEREUMDepositDTO.class);
  }

 /**
  * Convert an instance of SUSHISWAPV3ETHEREUMDepositDTO to an JSON string
  *
  * @return JSON string
  */
