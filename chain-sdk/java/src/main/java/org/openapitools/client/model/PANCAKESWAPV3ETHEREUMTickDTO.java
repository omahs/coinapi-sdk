...
public class PANCAKESWAPV3ETHEREUMTickDTO {
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO() {
  }

  public PANCAKESWAPV3ETHEREUMTickDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO id(String id) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO index(String index) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO pool(String pool) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO createdTimestamp(String createdTimestamp) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO createdBlockNumber(String createdBlockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO prices(List<String> prices) {
    
    this.prices = prices;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMTickDTO addPricesItem(String pricesItem) {
    if (this.prices == null) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO liquidityGross(String liquidityGross) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO liquidityGrossUsd(String liquidityGrossUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO liquidityNet(String liquidityNet) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO liquidityNetUsd(String liquidityNetUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO lastSnapshotDayId(Integer lastSnapshotDayId) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO lastSnapshotHourId(Integer lastSnapshotHourId) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO lastUpdateTimestamp(String lastUpdateTimestamp) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTickDTO lastUpdateBlockNumber(String lastUpdateBlockNumber) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PANCAKESWAPV3ETHEREUMTickDTO paNCAKESWAPV3ETHEREUMTickDTO = (PANCAKESWAPV3ETHEREUMTickDTO) o;
    return Objects.equals(this.entryTime, paNCAKESWAPV3ETHEREUMTickDTO.entryTime) &&
        Objects.equals(this.recvTime, paNCAKESWAPV3ETHEREUMTickDTO.recvTime) &&
        Objects.equals(this.blockNumber, paNCAKESWAPV3ETHEREUMTickDTO.blockNumber) &&
        Objects.equals(this.id, paNCAKESWAPV3ETHEREUMTickDTO.id) &&
        Objects.equals(this.index, paNCAKESWAPV3ETHEREUMTickDTO.index) &&
        Objects.equals(this.pool, paNCAKESWAPV3ETHEREUMTickDTO.pool) &&
        Objects.equals(this.createdTimestamp, paNCAKESWAPV3ETHEREUMTickDTO.createdTimestamp) &&
        Objects.equals(this.createdBlockNumber, paNCAKESWAPV3ETHEREUMTickDTO.createdBlockNumber) &&
        Objects.equals(this.prices, paNCAKESWAPV3ETHEREUMTickDTO.prices) &&
        Objects.equals(this.liquidityGross, paNCAKESWAPV3ETHEREUMTickDTO.liquidityGross) &&
        Objects.equals(this.liquidityGrossUsd, paNCAKESWAPV3ETHEREUMTickDTO.liquidityGrossUsd) &&
        Objects.equals(this.liquidityNet, paNCAKESWAPV3ETHEREUMTickDTO.liquidityNet) &&
        Objects.equals(this.liquidityNetUsd, paNCAKESWAPV3ETHEREUMTickDTO.liquidityNetUsd) &&
        Objects.equals(this.lastSnapshotDayId, paNCAKESWAPV3ETHEREUMTickDTO.lastSnapshotDayId) &&
        Objects.equals(this.lastSnapshotHourId, paNCAKESWAPV3ETHEREUMTickDTO.lastSnapshotHourId) &&
        Objects.equals(this.lastUpdateTimestamp, paNCAKESWAPV3ETHEREUMTickDTO.lastUpdateTimestamp) &&
        Objects.equals(this.lastUpdateBlockNumber, paNCAKESWAPV3ETHEREUMTickDTO.lastUpdateBlockNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class PANCAKESWAPV3ETHEREUMTickDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PANCAKESWAPV3ETHEREUMTickDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PANCAKESWAPV3ETHEREUMTickDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PANCAKESWAPV3ETHEREUMTickDTO is not found in the empty JSON string", PANCAKESWAPV3ETHEREUMTickDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PANCAKESWAPV3ETHEREUMTickDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PANCAKESWAPV3ETHEREUMTickDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PANCAKESWAPV3ETHEREUMTickDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PANCAKESWAPV3ETHEREUMTickDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PANCAKESWAPV3ETHEREUMTickDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PANCAKESWAPV3ETHEREUMTickDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PANCAKESWAPV3ETHEREUMTickDTO>() {
           @Override
           public void write(JsonWriter out, PANCAKESWAPV3ETHEREUMTickDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PANCAKESWAPV3ETHEREUMTickDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PANCAKESWAPV3ETHEREUMTickDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PANCAKESWAPV3ETHEREUMTickDTO
  * @throws IOException if the JSON string is invalid with respect to PANCAKESWAPV3ETHEREUMTickDTO
  */
  public static PANCAKESWAPV3ETHEREUMTickDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PANCAKESWAPV3ETHEREUMTickDTO.class);
  }

 /**
  * Convert an instance of PANCAKESWAPV3ETHEREUMTickDTO to an JSON string
  *
  * @return JSON string
  */
