...
public class UNISWAPV2ETHEREUMWithdrawDTO {
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO() {
  }

  public UNISWAPV2ETHEREUMWithdrawDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO block(Integer block) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO id(String id) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO hash(String hash) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO logIndex(Integer logIndex) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO protocol(String protocol) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO to(String to) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO from(String from) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO inputTokens(List<String> inputTokens) {
    
    this.inputTokens = inputTokens;
    return this;
  }

  public UNISWAPV2ETHEREUMWithdrawDTO addInputTokensItem(String inputTokensItem) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO outputToken(String outputToken) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO inputTokenAmounts(List<String> inputTokenAmounts) {
    
    this.inputTokenAmounts = inputTokenAmounts;
    return this;
  }

  public UNISWAPV2ETHEREUMWithdrawDTO addInputTokenAmountsItem(String inputTokenAmountsItem) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO outputTokenAmount(String outputTokenAmount) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO reserveAmounts(List<String> reserveAmounts) {
    
    this.reserveAmounts = reserveAmounts;
    return this;
  }

  public UNISWAPV2ETHEREUMWithdrawDTO addReserveAmountsItem(String reserveAmountsItem) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO amountUsd(String amountUsd) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO pool(String pool) {
  ...
  **/
  ...
  public UNISWAPV2ETHEREUMWithdrawDTO blockRange(String blockRange) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UNISWAPV2ETHEREUMWithdrawDTO unISWAPV2ETHEREUMWithdrawDTO = (UNISWAPV2ETHEREUMWithdrawDTO) o;
    return Objects.equals(this.entryTime, unISWAPV2ETHEREUMWithdrawDTO.entryTime) &&
        Objects.equals(this.recvTime, unISWAPV2ETHEREUMWithdrawDTO.recvTime) &&
        Objects.equals(this.blockNumber, unISWAPV2ETHEREUMWithdrawDTO.blockNumber) &&
        Objects.equals(this.block, unISWAPV2ETHEREUMWithdrawDTO.block) &&
        Objects.equals(this.id, unISWAPV2ETHEREUMWithdrawDTO.id) &&
        Objects.equals(this.hash, unISWAPV2ETHEREUMWithdrawDTO.hash) &&
        Objects.equals(this.logIndex, unISWAPV2ETHEREUMWithdrawDTO.logIndex) &&
        Objects.equals(this.protocol, unISWAPV2ETHEREUMWithdrawDTO.protocol) &&
        Objects.equals(this.to, unISWAPV2ETHEREUMWithdrawDTO.to) &&
        Objects.equals(this.from, unISWAPV2ETHEREUMWithdrawDTO.from) &&
        Objects.equals(this.timestamp, unISWAPV2ETHEREUMWithdrawDTO.timestamp) &&
        Objects.equals(this.inputTokens, unISWAPV2ETHEREUMWithdrawDTO.inputTokens) &&
        Objects.equals(this.outputToken, unISWAPV2ETHEREUMWithdrawDTO.outputToken) &&
        Objects.equals(this.inputTokenAmounts, unISWAPV2ETHEREUMWithdrawDTO.inputTokenAmounts) &&
        Objects.equals(this.outputTokenAmount, unISWAPV2ETHEREUMWithdrawDTO.outputTokenAmount) &&
        Objects.equals(this.reserveAmounts, unISWAPV2ETHEREUMWithdrawDTO.reserveAmounts) &&
        Objects.equals(this.amountUsd, unISWAPV2ETHEREUMWithdrawDTO.amountUsd) &&
        Objects.equals(this.pool, unISWAPV2ETHEREUMWithdrawDTO.pool) &&
        Objects.equals(this.blockRange, unISWAPV2ETHEREUMWithdrawDTO.blockRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class UNISWAPV2ETHEREUMWithdrawDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UNISWAPV2ETHEREUMWithdrawDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UNISWAPV2ETHEREUMWithdrawDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UNISWAPV2ETHEREUMWithdrawDTO is not found in the empty JSON string", UNISWAPV2ETHEREUMWithdrawDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UNISWAPV2ETHEREUMWithdrawDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UNISWAPV2ETHEREUMWithdrawDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UNISWAPV2ETHEREUMWithdrawDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UNISWAPV2ETHEREUMWithdrawDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UNISWAPV2ETHEREUMWithdrawDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UNISWAPV2ETHEREUMWithdrawDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UNISWAPV2ETHEREUMWithdrawDTO>() {
           @Override
           public void write(JsonWriter out, UNISWAPV2ETHEREUMWithdrawDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UNISWAPV2ETHEREUMWithdrawDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UNISWAPV2ETHEREUMWithdrawDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UNISWAPV2ETHEREUMWithdrawDTO
  * @throws IOException if the JSON string is invalid with respect to UNISWAPV2ETHEREUMWithdrawDTO
  */
  public static UNISWAPV2ETHEREUMWithdrawDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UNISWAPV2ETHEREUMWithdrawDTO.class);
  }

 /**
  * Convert an instance of UNISWAPV2ETHEREUMWithdrawDTO to an JSON string
  *
  * @return JSON string
  */
