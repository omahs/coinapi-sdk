...
public class SushiswapBurnDTO {
  ...
  public SushiswapBurnDTO() {
  }

  public SushiswapBurnDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SushiswapBurnDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SushiswapBurnDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SushiswapBurnDTO id(String id) {
  ...
  **/
  ...
  public SushiswapBurnDTO transaction(String transaction) {
  ...
  **/
  ...
  public SushiswapBurnDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public SushiswapBurnDTO pair(String pair) {
  ...
  **/
  ...
  public SushiswapBurnDTO liquidity(String liquidity) {
  ...
  **/
  ...
  public SushiswapBurnDTO sender(String sender) {
  ...
  **/
  ...
  public SushiswapBurnDTO amount0(String amount0) {
  ...
  **/
  ...
  public SushiswapBurnDTO amount1(String amount1) {
  ...
  **/
  ...
  public SushiswapBurnDTO to(String to) {
  ...
  **/
  ...
  public SushiswapBurnDTO logIndex(String logIndex) {
  ...
  **/
  ...
  public SushiswapBurnDTO amountUsd(String amountUsd) {
  ...
  **/
  ...
  public SushiswapBurnDTO complete(Boolean complete) {
  ...
  **/
  ...
  public SushiswapBurnDTO feeTo(String feeTo) {
  ...
  **/
  ...
  public SushiswapBurnDTO feeLiquidity(String feeLiquidity) {
  ...
  **/
  ...
  public SushiswapBurnDTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, sushiswapBurnDTO.entryTime) &&
        Objects.equals(this.recvTime, sushiswapBurnDTO.recvTime) &&
        Objects.equals(this.blockNumber, sushiswapBurnDTO.blockNumber) &&
        Objects.equals(this.id, sushiswapBurnDTO.id) &&
        Objects.equals(this.transaction, sushiswapBurnDTO.transaction) &&
        Objects.equals(this.timestamp, sushiswapBurnDTO.timestamp) &&
        Objects.equals(this.pair, sushiswapBurnDTO.pair) &&
        Objects.equals(this.liquidity, sushiswapBurnDTO.liquidity) &&
        Objects.equals(this.sender, sushiswapBurnDTO.sender) &&
        Objects.equals(this.amount0, sushiswapBurnDTO.amount0) &&
        Objects.equals(this.amount1, sushiswapBurnDTO.amount1) &&
        Objects.equals(this.to, sushiswapBurnDTO.to) &&
        Objects.equals(this.logIndex, sushiswapBurnDTO.logIndex) &&
        Objects.equals(this.amountUsd, sushiswapBurnDTO.amountUsd) &&
        Objects.equals(this.complete, sushiswapBurnDTO.complete) &&
        Objects.equals(this.feeTo, sushiswapBurnDTO.feeTo) &&
        Objects.equals(this.feeLiquidity, sushiswapBurnDTO.feeLiquidity) &&
        Objects.equals(this.vid, sushiswapBurnDTO.vid);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entryTime, recvTime, blockNumber, id, transaction, timestamp, pair, liquidity, sender, amount0, amount1, to, logIndex, amountUsd, complete, feeTo, feeLiquidity, vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SushiswapBurnDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SushiswapBurnDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SushiswapBurnDTO is not found in the empty JSON string", SushiswapBurnDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SushiswapBurnDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SushiswapBurnDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SushiswapBurnDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SushiswapBurnDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SushiswapBurnDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SushiswapBurnDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SushiswapBurnDTO>() {
           @Override
           public void write(JsonWriter out, SushiswapBurnDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SushiswapBurnDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SushiswapBurnDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SushiswapBurnDTO
  * @throws IOException if the JSON string is invalid with respect to SushiswapBurnDTO
  */
  public static SushiswapBurnDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SushiswapBurnDTO.class);
  }

 /**
  * Convert an instance of SushiswapBurnDTO to an JSON string
  *
  * @return JSON string
  */
