...
public class SUSHISWAPV3ETHEREUMWithdrawDTO {
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO id(String id) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO hash(String hash) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO nonce(String nonce) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO logIndex(Integer logIndex) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO gasLimit(String gasLimit) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO gasUsed(String gasUsed) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO gasPrice(String gasPrice) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO protocol(String protocol) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO account(String account) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO position(String position) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO tickLower(String tickLower) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO tickUpper(String tickUpper) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO pool(String pool) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO liquidity(String liquidity) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO inputTokens(List<String> inputTokens) {
    
    this.inputTokens = inputTokens;
    return this;
  }

  public SUSHISWAPV3ETHEREUMWithdrawDTO addInputTokensItem(String inputTokensItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO inputTokenAmounts(List<String> inputTokenAmounts) {
    
    this.inputTokenAmounts = inputTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMWithdrawDTO addInputTokenAmountsItem(String inputTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO reserveAmounts(List<String> reserveAmounts) {
    
    this.reserveAmounts = reserveAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMWithdrawDTO addReserveAmountsItem(String reserveAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMWithdrawDTO amountUsd(String amountUsd) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, suSHISWAPV3ETHEREUMWithdrawDTO.entryTime) &&
        Objects.equals(this.recvTime, suSHISWAPV3ETHEREUMWithdrawDTO.recvTime) &&
        Objects.equals(this.blockNumber, suSHISWAPV3ETHEREUMWithdrawDTO.blockNumber) &&
        Objects.equals(this.id, suSHISWAPV3ETHEREUMWithdrawDTO.id) &&
        Objects.equals(this.hash, suSHISWAPV3ETHEREUMWithdrawDTO.hash) &&
        Objects.equals(this.nonce, suSHISWAPV3ETHEREUMWithdrawDTO.nonce) &&
        Objects.equals(this.logIndex, suSHISWAPV3ETHEREUMWithdrawDTO.logIndex) &&
        Objects.equals(this.gasLimit, suSHISWAPV3ETHEREUMWithdrawDTO.gasLimit) &&
        Objects.equals(this.gasUsed, suSHISWAPV3ETHEREUMWithdrawDTO.gasUsed) &&
        Objects.equals(this.gasPrice, suSHISWAPV3ETHEREUMWithdrawDTO.gasPrice) &&
        Objects.equals(this.protocol, suSHISWAPV3ETHEREUMWithdrawDTO.protocol) &&
        Objects.equals(this.account, suSHISWAPV3ETHEREUMWithdrawDTO.account) &&
        Objects.equals(this.position, suSHISWAPV3ETHEREUMWithdrawDTO.position) &&
        Objects.equals(this.tickLower, suSHISWAPV3ETHEREUMWithdrawDTO.tickLower) &&
        Objects.equals(this.tickUpper, suSHISWAPV3ETHEREUMWithdrawDTO.tickUpper) &&
        Objects.equals(this.pool, suSHISWAPV3ETHEREUMWithdrawDTO.pool) &&
        Objects.equals(this.timestamp, suSHISWAPV3ETHEREUMWithdrawDTO.timestamp) &&
        Objects.equals(this.liquidity, suSHISWAPV3ETHEREUMWithdrawDTO.liquidity) &&
        Objects.equals(this.inputTokens, suSHISWAPV3ETHEREUMWithdrawDTO.inputTokens) &&
        Objects.equals(this.inputTokenAmounts, suSHISWAPV3ETHEREUMWithdrawDTO.inputTokenAmounts) &&
        Objects.equals(this.reserveAmounts, suSHISWAPV3ETHEREUMWithdrawDTO.reserveAmounts) &&
        Objects.equals(this.amountUsd, suSHISWAPV3ETHEREUMWithdrawDTO.amountUsd);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SUSHISWAPV3ETHEREUMWithdrawDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SUSHISWAPV3ETHEREUMWithdrawDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SUSHISWAPV3ETHEREUMWithdrawDTO is not found in the empty JSON string", SUSHISWAPV3ETHEREUMWithdrawDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SUSHISWAPV3ETHEREUMWithdrawDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SUSHISWAPV3ETHEREUMWithdrawDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SUSHISWAPV3ETHEREUMWithdrawDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SUSHISWAPV3ETHEREUMWithdrawDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SUSHISWAPV3ETHEREUMWithdrawDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SUSHISWAPV3ETHEREUMWithdrawDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SUSHISWAPV3ETHEREUMWithdrawDTO>() {
           @Override
           public void write(JsonWriter out, SUSHISWAPV3ETHEREUMWithdrawDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SUSHISWAPV3ETHEREUMWithdrawDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SUSHISWAPV3ETHEREUMWithdrawDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SUSHISWAPV3ETHEREUMWithdrawDTO
  * @throws IOException if the JSON string is invalid with respect to SUSHISWAPV3ETHEREUMWithdrawDTO
  */
  public static SUSHISWAPV3ETHEREUMWithdrawDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SUSHISWAPV3ETHEREUMWithdrawDTO.class);
  }

 /**
  * Convert an instance of SUSHISWAPV3ETHEREUMWithdrawDTO to an JSON string
  *
  * @return JSON string
  */
