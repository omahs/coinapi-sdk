...
public class UniswapV2UniswapFactoryDTO {
  ...
  public UniswapV2UniswapFactoryDTO() {
  }

  public UniswapV2UniswapFactoryDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO id(String id) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO pairCount(Integer pairCount) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO totalVolumeUsd(String totalVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO totalVolumeEth(String totalVolumeEth) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO untrackedVolumeUsd(String untrackedVolumeUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO totalLiquidityEth(String totalLiquidityEth) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO txCount(String txCount) {
  ...
  **/
  ...
  public UniswapV2UniswapFactoryDTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, uniswapV2UniswapFactoryDTO.entryTime) &&
        Objects.equals(this.recvTime, uniswapV2UniswapFactoryDTO.recvTime) &&
        Objects.equals(this.blockNumber, uniswapV2UniswapFactoryDTO.blockNumber) &&
        Objects.equals(this.id, uniswapV2UniswapFactoryDTO.id) &&
        Objects.equals(this.pairCount, uniswapV2UniswapFactoryDTO.pairCount) &&
        Objects.equals(this.totalVolumeUsd, uniswapV2UniswapFactoryDTO.totalVolumeUsd) &&
        Objects.equals(this.totalVolumeEth, uniswapV2UniswapFactoryDTO.totalVolumeEth) &&
        Objects.equals(this.untrackedVolumeUsd, uniswapV2UniswapFactoryDTO.untrackedVolumeUsd) &&
        Objects.equals(this.totalLiquidityUsd, uniswapV2UniswapFactoryDTO.totalLiquidityUsd) &&
        Objects.equals(this.totalLiquidityEth, uniswapV2UniswapFactoryDTO.totalLiquidityEth) &&
        Objects.equals(this.txCount, uniswapV2UniswapFactoryDTO.txCount) &&
        Objects.equals(this.vid, uniswapV2UniswapFactoryDTO.vid);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entryTime, recvTime, blockNumber, id, pairCount, totalVolumeUsd, totalVolumeEth, untrackedVolumeUsd, totalLiquidityUsd, totalLiquidityEth, txCount, vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniswapV2UniswapFactoryDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniswapV2UniswapFactoryDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniswapV2UniswapFactoryDTO is not found in the empty JSON string", UniswapV2UniswapFactoryDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UniswapV2UniswapFactoryDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniswapV2UniswapFactoryDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniswapV2UniswapFactoryDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniswapV2UniswapFactoryDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniswapV2UniswapFactoryDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniswapV2UniswapFactoryDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<UniswapV2UniswapFactoryDTO>() {
           @Override
           public void write(JsonWriter out, UniswapV2UniswapFactoryDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniswapV2UniswapFactoryDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniswapV2UniswapFactoryDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniswapV2UniswapFactoryDTO
  * @throws IOException if the JSON string is invalid with respect to UniswapV2UniswapFactoryDTO
  */
  public static UniswapV2UniswapFactoryDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniswapV2UniswapFactoryDTO.class);
  }

 /**
  * Convert an instance of UniswapV2UniswapFactoryDTO to an JSON string
  *
  * @return JSON string
  */
