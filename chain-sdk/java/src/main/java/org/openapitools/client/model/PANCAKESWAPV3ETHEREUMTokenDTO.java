...
public class PANCAKESWAPV3ETHEREUMTokenDTO {
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO() {
  }
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO vid(Long vid) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO blockRange(String blockRange) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO id(String id) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO name(String name) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO symbol(String symbol) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO decimals(Integer decimals) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO lastPriceUsd(String lastPriceUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO lastPriceBlockNumber(String lastPriceBlockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO lastPricePool(String lastPricePool) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO totalSupply(String totalSupply) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO largePriceChangeBuffer(Integer largePriceChangeBuffer) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMTokenDTO largeTvlImpactBuffer(Integer largeTvlImpactBuffer) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, paNCAKESWAPV3ETHEREUMTokenDTO.entryTime) &&
        Objects.equals(this.recvTime, paNCAKESWAPV3ETHEREUMTokenDTO.recvTime) &&
        Objects.equals(this.blockNumber, paNCAKESWAPV3ETHEREUMTokenDTO.blockNumber) &&
        Objects.equals(this.vid, paNCAKESWAPV3ETHEREUMTokenDTO.vid) &&
        Objects.equals(this.blockRange, paNCAKESWAPV3ETHEREUMTokenDTO.blockRange) &&
        Objects.equals(this.id, paNCAKESWAPV3ETHEREUMTokenDTO.id) &&
        Objects.equals(this.name, paNCAKESWAPV3ETHEREUMTokenDTO.name) &&
        Objects.equals(this.symbol, paNCAKESWAPV3ETHEREUMTokenDTO.symbol) &&
        Objects.equals(this.decimals, paNCAKESWAPV3ETHEREUMTokenDTO.decimals) &&
        Objects.equals(this.lastPriceUsd, paNCAKESWAPV3ETHEREUMTokenDTO.lastPriceUsd) &&
        Objects.equals(this.lastPriceBlockNumber, paNCAKESWAPV3ETHEREUMTokenDTO.lastPriceBlockNumber) &&
        Objects.equals(this.lastPricePool, paNCAKESWAPV3ETHEREUMTokenDTO.lastPricePool) &&
        Objects.equals(this.totalSupply, paNCAKESWAPV3ETHEREUMTokenDTO.totalSupply) &&
        Objects.equals(this.totalValueLockedUsd, paNCAKESWAPV3ETHEREUMTokenDTO.totalValueLockedUsd) &&
        Objects.equals(this.largePriceChangeBuffer, paNCAKESWAPV3ETHEREUMTokenDTO.largePriceChangeBuffer) &&
        Objects.equals(this.largeTvlImpactBuffer, paNCAKESWAPV3ETHEREUMTokenDTO.largeTvlImpactBuffer) &&
        Objects.equals(this.tokenSymbol, paNCAKESWAPV3ETHEREUMTokenDTO.tokenSymbol);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PANCAKESWAPV3ETHEREUMTokenDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PANCAKESWAPV3ETHEREUMTokenDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PANCAKESWAPV3ETHEREUMTokenDTO is not found in the empty JSON string", PANCAKESWAPV3ETHEREUMTokenDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PANCAKESWAPV3ETHEREUMTokenDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PANCAKESWAPV3ETHEREUMTokenDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PANCAKESWAPV3ETHEREUMTokenDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PANCAKESWAPV3ETHEREUMTokenDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PANCAKESWAPV3ETHEREUMTokenDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PANCAKESWAPV3ETHEREUMTokenDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PANCAKESWAPV3ETHEREUMTokenDTO>() {
           @Override
           public void write(JsonWriter out, PANCAKESWAPV3ETHEREUMTokenDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PANCAKESWAPV3ETHEREUMTokenDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PANCAKESWAPV3ETHEREUMTokenDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PANCAKESWAPV3ETHEREUMTokenDTO
  * @throws IOException if the JSON string is invalid with respect to PANCAKESWAPV3ETHEREUMTokenDTO
  */
  public static PANCAKESWAPV3ETHEREUMTokenDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PANCAKESWAPV3ETHEREUMTokenDTO.class);
  }

 /**
  * Convert an instance of PANCAKESWAPV3ETHEREUMTokenDTO to an JSON string
  *
  * @return JSON string
  */
