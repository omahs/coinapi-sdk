...
public class PANCAKESWAPV3ETHEREUMSwapDTO {
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO() {
  }
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO block(Integer block) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO id(String id) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO hash(String hash) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO nonce(String nonce) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO logIndex(Integer logIndex) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO gasLimit(String gasLimit) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO gasUsed(String gasUsed) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO gasPrice(String gasPrice) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO protocol(String protocol) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO account(String account) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO pool(String pool) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO tick(String tick) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO tokenIn(String tokenIn) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO amountIn(String amountIn) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO amountInUsd(String amountInUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO tokenOut(String tokenOut) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO amountOut(String amountOut) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO amountOutUsd(String amountOutUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO reserveAmounts(List<String> reserveAmounts) {
    
    this.reserveAmounts = reserveAmounts;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMSwapDTO addReserveAmountsItem(String reserveAmountsItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMSwapDTO evaluatedAggressor(TransactionsETradeAggressiveSide evaluatedAggressor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, paNCAKESWAPV3ETHEREUMSwapDTO.entryTime) &&
        Objects.equals(this.recvTime, paNCAKESWAPV3ETHEREUMSwapDTO.recvTime) &&
        Objects.equals(this.blockNumber, paNCAKESWAPV3ETHEREUMSwapDTO.blockNumber) &&
        Objects.equals(this.block, paNCAKESWAPV3ETHEREUMSwapDTO.block) &&
        Objects.equals(this.id, paNCAKESWAPV3ETHEREUMSwapDTO.id) &&
        Objects.equals(this.hash, paNCAKESWAPV3ETHEREUMSwapDTO.hash) &&
        Objects.equals(this.nonce, paNCAKESWAPV3ETHEREUMSwapDTO.nonce) &&
        Objects.equals(this.logIndex, paNCAKESWAPV3ETHEREUMSwapDTO.logIndex) &&
        Objects.equals(this.gasLimit, paNCAKESWAPV3ETHEREUMSwapDTO.gasLimit) &&
        Objects.equals(this.gasUsed, paNCAKESWAPV3ETHEREUMSwapDTO.gasUsed) &&
        Objects.equals(this.gasPrice, paNCAKESWAPV3ETHEREUMSwapDTO.gasPrice) &&
        Objects.equals(this.protocol, paNCAKESWAPV3ETHEREUMSwapDTO.protocol) &&
        Objects.equals(this.account, paNCAKESWAPV3ETHEREUMSwapDTO.account) &&
        Objects.equals(this.pool, paNCAKESWAPV3ETHEREUMSwapDTO.pool) &&
        Objects.equals(this.timestamp, paNCAKESWAPV3ETHEREUMSwapDTO.timestamp) &&
        Objects.equals(this.tick, paNCAKESWAPV3ETHEREUMSwapDTO.tick) &&
        Objects.equals(this.tokenIn, paNCAKESWAPV3ETHEREUMSwapDTO.tokenIn) &&
        Objects.equals(this.amountIn, paNCAKESWAPV3ETHEREUMSwapDTO.amountIn) &&
        Objects.equals(this.amountInUsd, paNCAKESWAPV3ETHEREUMSwapDTO.amountInUsd) &&
        Objects.equals(this.tokenOut, paNCAKESWAPV3ETHEREUMSwapDTO.tokenOut) &&
        Objects.equals(this.amountOut, paNCAKESWAPV3ETHEREUMSwapDTO.amountOut) &&
        Objects.equals(this.amountOutUsd, paNCAKESWAPV3ETHEREUMSwapDTO.amountOutUsd) &&
        Objects.equals(this.reserveAmounts, paNCAKESWAPV3ETHEREUMSwapDTO.reserveAmounts) &&
        Objects.equals(this.poolId, paNCAKESWAPV3ETHEREUMSwapDTO.poolId) &&
        Objects.equals(this.transactionId, paNCAKESWAPV3ETHEREUMSwapDTO.transactionId) &&
        Objects.equals(this.evaluatedPrice, paNCAKESWAPV3ETHEREUMSwapDTO.evaluatedPrice) &&
        Objects.equals(this.evaluatedAmount, paNCAKESWAPV3ETHEREUMSwapDTO.evaluatedAmount) &&
        Objects.equals(this.evaluatedAggressor, paNCAKESWAPV3ETHEREUMSwapDTO.evaluatedAggressor);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PANCAKESWAPV3ETHEREUMSwapDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PANCAKESWAPV3ETHEREUMSwapDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PANCAKESWAPV3ETHEREUMSwapDTO is not found in the empty JSON string", PANCAKESWAPV3ETHEREUMSwapDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PANCAKESWAPV3ETHEREUMSwapDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PANCAKESWAPV3ETHEREUMSwapDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PANCAKESWAPV3ETHEREUMSwapDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PANCAKESWAPV3ETHEREUMSwapDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PANCAKESWAPV3ETHEREUMSwapDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PANCAKESWAPV3ETHEREUMSwapDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PANCAKESWAPV3ETHEREUMSwapDTO>() {
           @Override
           public void write(JsonWriter out, PANCAKESWAPV3ETHEREUMSwapDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PANCAKESWAPV3ETHEREUMSwapDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PANCAKESWAPV3ETHEREUMSwapDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PANCAKESWAPV3ETHEREUMSwapDTO
  * @throws IOException if the JSON string is invalid with respect to PANCAKESWAPV3ETHEREUMSwapDTO
  */
  public static PANCAKESWAPV3ETHEREUMSwapDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PANCAKESWAPV3ETHEREUMSwapDTO.class);
  }

 /**
  * Convert an instance of PANCAKESWAPV3ETHEREUMSwapDTO to an JSON string
  *
  * @return JSON string
  */
