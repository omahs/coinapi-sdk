...
public class PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO {
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO() {
  }

  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO blockNumber(Integer blockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO id(String id) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO day(Integer day) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO protocol(String protocol) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO activeLiquidityUsd(String activeLiquidityUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO uncollectedProtocolSideValueUsd(String uncollectedProtocolSideValueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO uncollectedSupplySideValueUsd(String uncollectedSupplySideValueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO protocolControlledValueUsd(String protocolControlledValueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO dailyVolumeUsd(String dailyVolumeUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO cumulativeVolumeUsd(String cumulativeVolumeUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO dailySupplySideRevenueUsd(String dailySupplySideRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO cumulativeSupplySideRevenueUsd(String cumulativeSupplySideRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO dailyProtocolSideRevenueUsd(String dailyProtocolSideRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO cumulativeProtocolSideRevenueUsd(String cumulativeProtocolSideRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO dailyTotalRevenueUsd(String dailyTotalRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO cumulativeTotalRevenueUsd(String cumulativeTotalRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO = (PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO) o;
    return Objects.equals(this.entryTime, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.entryTime) &&
        Objects.equals(this.recvTime, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.recvTime) &&
        Objects.equals(this.blockNumber, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.blockNumber) &&
        Objects.equals(this.id, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.id) &&
        Objects.equals(this.day, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.day) &&
        Objects.equals(this.protocol, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocol) &&
        Objects.equals(this.totalValueLockedUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalValueLockedUsd) &&
        Objects.equals(this.totalLiquidityUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalLiquidityUsd) &&
        Objects.equals(this.activeLiquidityUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.activeLiquidityUsd) &&
        Objects.equals(this.uncollectedProtocolSideValueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedProtocolSideValueUsd) &&
        Objects.equals(this.uncollectedSupplySideValueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedSupplySideValueUsd) &&
        Objects.equals(this.protocolControlledValueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocolControlledValueUsd) &&
        Objects.equals(this.dailyVolumeUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyVolumeUsd) &&
        Objects.equals(this.cumulativeVolumeUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeVolumeUsd) &&
        Objects.equals(this.dailySupplySideRevenueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailySupplySideRevenueUsd) &&
        Objects.equals(this.cumulativeSupplySideRevenueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeSupplySideRevenueUsd) &&
        Objects.equals(this.dailyProtocolSideRevenueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyProtocolSideRevenueUsd) &&
        Objects.equals(this.cumulativeProtocolSideRevenueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeProtocolSideRevenueUsd) &&
        Objects.equals(this.dailyTotalRevenueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyTotalRevenueUsd) &&
        Objects.equals(this.cumulativeTotalRevenueUsd, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeTotalRevenueUsd) &&
        Objects.equals(this.timestamp, paNCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO is not found in the empty JSON string", PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO>() {
           @Override
           public void write(JsonWriter out, PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO
  * @throws IOException if the JSON string is invalid with respect to PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO
  */
  public static PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.class);
  }

 /**
  * Convert an instance of PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO to an JSON string
  *
  * @return JSON string
  */
