...
public class PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO {
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO() {
  }

  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO blockRange(String blockRange) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO id(String id) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO name(String name) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO slug(String slug) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO schemaVersion(String schemaVersion) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO subgraphVersion(String subgraphVersion) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO methodologyVersion(String methodologyVersion) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO activeLiquidityUsd(String activeLiquidityUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO uncollectedProtocolSideValueUsd(String uncollectedProtocolSideValueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO uncollectedSupplySideValueUsd(String uncollectedSupplySideValueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO protocolControlledValueUsd(String protocolControlledValueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO cumulativeVolumeUsd(String cumulativeVolumeUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO cumulativeSupplySideRevenueUsd(String cumulativeSupplySideRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO cumulativeProtocolSideRevenueUsd(String cumulativeProtocolSideRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO cumulativeTotalRevenueUsd(String cumulativeTotalRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO cumulativeUniqueUsers(Integer cumulativeUniqueUsers) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO cumulativeUniqueLPs(Integer cumulativeUniqueLPs) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO cumulativeUniqueTraders(Integer cumulativeUniqueTraders) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO totalPoolCount(Integer totalPoolCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO openPositionCount(Integer openPositionCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO cumulativePositionCount(Integer cumulativePositionCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO lastSnapshotDayId(Integer lastSnapshotDayId) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO lastUpdateTimestamp(String lastUpdateTimestamp) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO lastUpdateBlockNumber(String lastUpdateBlockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO regenesis(Boolean regenesis) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.entryTime) &&
        Objects.equals(this.recvTime, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.recvTime) &&
        Objects.equals(this.blockNumber, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.blockNumber) &&
        Objects.equals(this.blockRange, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.blockRange) &&
        Objects.equals(this.id, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.id) &&
        Objects.equals(this.name, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.name) &&
        Objects.equals(this.slug, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.slug) &&
        Objects.equals(this.schemaVersion, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.schemaVersion) &&
        Objects.equals(this.subgraphVersion, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.subgraphVersion) &&
        Objects.equals(this.methodologyVersion, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.methodologyVersion) &&
        Objects.equals(this.totalValueLockedUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.totalValueLockedUsd) &&
        Objects.equals(this.totalLiquidityUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.totalLiquidityUsd) &&
        Objects.equals(this.activeLiquidityUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.activeLiquidityUsd) &&
        Objects.equals(this.uncollectedProtocolSideValueUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.uncollectedProtocolSideValueUsd) &&
        Objects.equals(this.uncollectedSupplySideValueUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.uncollectedSupplySideValueUsd) &&
        Objects.equals(this.protocolControlledValueUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.protocolControlledValueUsd) &&
        Objects.equals(this.cumulativeVolumeUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeVolumeUsd) &&
        Objects.equals(this.cumulativeSupplySideRevenueUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeSupplySideRevenueUsd) &&
        Objects.equals(this.cumulativeProtocolSideRevenueUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeProtocolSideRevenueUsd) &&
        Objects.equals(this.cumulativeTotalRevenueUsd, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeTotalRevenueUsd) &&
        Objects.equals(this.cumulativeUniqueUsers, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueUsers) &&
        Objects.equals(this.cumulativeUniqueLPs, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueLPs) &&
        Objects.equals(this.cumulativeUniqueTraders, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueTraders) &&
        Objects.equals(this.totalPoolCount, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.totalPoolCount) &&
        Objects.equals(this.openPositionCount, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.openPositionCount) &&
        Objects.equals(this.cumulativePositionCount, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.cumulativePositionCount) &&
        Objects.equals(this.lastSnapshotDayId, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.lastSnapshotDayId) &&
        Objects.equals(this.lastUpdateTimestamp, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.lastUpdateTimestamp) &&
        Objects.equals(this.lastUpdateBlockNumber, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.lastUpdateBlockNumber) &&
        Objects.equals(this.regenesis, paNCAKESWAPV3ETHEREUMDexAmmProtocolDTO.regenesis);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO is not found in the empty JSON string", PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO>() {
           @Override
           public void write(JsonWriter out, PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO
  * @throws IOException if the JSON string is invalid with respect to PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO
  */
  public static PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO.class);
  }

 /**
  * Convert an instance of PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO to an JSON string
  *
  * @return JSON string
  */
