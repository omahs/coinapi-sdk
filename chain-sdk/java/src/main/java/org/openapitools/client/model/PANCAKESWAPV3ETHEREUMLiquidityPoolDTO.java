...
public class PANCAKESWAPV3ETHEREUMLiquidityPoolDTO {
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO() {
  }
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO vid(Long vid) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO blockRange(String blockRange) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO id(String id) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO protocol(String protocol) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO name(String name) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO symbol(String symbol) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO liquidityToken(String liquidityToken) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO inputTokens(List<String> inputTokens) {
    
    this.inputTokens = inputTokens;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addInputTokensItem(String inputTokensItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO rewardTokens(List<String> rewardTokens) {
    
    this.rewardTokens = rewardTokens;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addRewardTokensItem(String rewardTokensItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO fees(List<String> fees) {
    
    this.fees = fees;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addFeesItem(String feesItem) {
    if (this.fees == null) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO isSingleSided(Boolean isSingleSided) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO createdTimestamp(String createdTimestamp) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO createdBlockNumber(String createdBlockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO tick(String tick) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO totalLiquidity(String totalLiquidity) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO activeLiquidity(String activeLiquidity) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO activeLiquidityUsd(String activeLiquidityUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO uncollectedProtocolSideTokenAmounts(List<String> uncollectedProtocolSideTokenAmounts) {
    
    this.uncollectedProtocolSideTokenAmounts = uncollectedProtocolSideTokenAmounts;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addUncollectedProtocolSideTokenAmountsItem(String uncollectedProtocolSideTokenAmountsItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO uncollectedProtocolSideValuesUsd(List<String> uncollectedProtocolSideValuesUsd) {
    
    this.uncollectedProtocolSideValuesUsd = uncollectedProtocolSideValuesUsd;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addUncollectedProtocolSideValuesUsdItem(String uncollectedProtocolSideValuesUsdItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO uncollectedSupplySideTokenAmounts(List<String> uncollectedSupplySideTokenAmounts) {
    
    this.uncollectedSupplySideTokenAmounts = uncollectedSupplySideTokenAmounts;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addUncollectedSupplySideTokenAmountsItem(String uncollectedSupplySideTokenAmountsItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO uncollectedSupplySideValuesUsd(List<String> uncollectedSupplySideValuesUsd) {
    
    this.uncollectedSupplySideValuesUsd = uncollectedSupplySideValuesUsd;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addUncollectedSupplySideValuesUsdItem(String uncollectedSupplySideValuesUsdItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeSupplySideRevenueUsd(String cumulativeSupplySideRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeProtocolSideRevenueUsd(String cumulativeProtocolSideRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeTotalRevenueUsd(String cumulativeTotalRevenueUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeVolumeByTokenAmount(List<String> cumulativeVolumeByTokenAmount) {
    
    this.cumulativeVolumeByTokenAmount = cumulativeVolumeByTokenAmount;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addCumulativeVolumeByTokenAmountItem(String cumulativeVolumeByTokenAmountItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeVolumeByTokenUsd(List<String> cumulativeVolumeByTokenUsd) {
    
    this.cumulativeVolumeByTokenUsd = cumulativeVolumeByTokenUsd;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addCumulativeVolumeByTokenUsdItem(String cumulativeVolumeByTokenUsdItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeVolumeUsd(String cumulativeVolumeUsd) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO inputTokenBalances(List<String> inputTokenBalances) {
    
    this.inputTokenBalances = inputTokenBalances;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addInputTokenBalancesItem(String inputTokenBalancesItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO inputTokenBalancesUsd(List<String> inputTokenBalancesUsd) {
    
    this.inputTokenBalancesUsd = inputTokenBalancesUsd;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addInputTokenBalancesUsdItem(String inputTokenBalancesUsdItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO inputTokenWeights(List<String> inputTokenWeights) {
    
    this.inputTokenWeights = inputTokenWeights;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addInputTokenWeightsItem(String inputTokenWeightsItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO stakedOutputTokenAmount(String stakedOutputTokenAmount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO rewardTokenEmissionsAmount(List<String> rewardTokenEmissionsAmount) {
    
    this.rewardTokenEmissionsAmount = rewardTokenEmissionsAmount;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addRewardTokenEmissionsAmountItem(String rewardTokenEmissionsAmountItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO rewardTokenEmissionsUsd(List<String> rewardTokenEmissionsUsd) {
    
    this.rewardTokenEmissionsUsd = rewardTokenEmissionsUsd;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO addRewardTokenEmissionsUsdItem(String rewardTokenEmissionsUsdItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeDepositCount(Integer cumulativeDepositCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeWithdrawCount(Integer cumulativeWithdrawCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO cumulativeSwapCount(Integer cumulativeSwapCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO positionCount(Integer positionCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO openPositionCount(Integer openPositionCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO closedPositionCount(Integer closedPositionCount) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO lastSnapshotDayId(Integer lastSnapshotDayId) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO lastSnapshotHourId(Integer lastSnapshotHourId) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO lastUpdateTimestamp(String lastUpdateTimestamp) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO lastUpdateBlockNumber(String lastUpdateBlockNumber) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.entryTime) &&
        Objects.equals(this.recvTime, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.recvTime) &&
        Objects.equals(this.blockNumber, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.blockNumber) &&
        Objects.equals(this.vid, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.vid) &&
        Objects.equals(this.blockRange, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.blockRange) &&
        Objects.equals(this.id, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.id) &&
        Objects.equals(this.protocol, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.protocol) &&
        Objects.equals(this.name, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.name) &&
        Objects.equals(this.symbol, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.symbol) &&
        Objects.equals(this.liquidityToken, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.liquidityToken) &&
        Objects.equals(this.inputTokens, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.inputTokens) &&
        Objects.equals(this.rewardTokens, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.rewardTokens) &&
        Objects.equals(this.fees, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.fees) &&
        Objects.equals(this.isSingleSided, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.isSingleSided) &&
        Objects.equals(this.createdTimestamp, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.createdTimestamp) &&
        Objects.equals(this.createdBlockNumber, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.createdBlockNumber) &&
        Objects.equals(this.tick, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.tick) &&
        Objects.equals(this.totalValueLockedUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.totalValueLockedUsd) &&
        Objects.equals(this.totalLiquidity, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.totalLiquidity) &&
        Objects.equals(this.totalLiquidityUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.totalLiquidityUsd) &&
        Objects.equals(this.activeLiquidity, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.activeLiquidity) &&
        Objects.equals(this.activeLiquidityUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.activeLiquidityUsd) &&
        Objects.equals(this.uncollectedProtocolSideTokenAmounts, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.uncollectedProtocolSideTokenAmounts) &&
        Objects.equals(this.uncollectedProtocolSideValuesUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.uncollectedProtocolSideValuesUsd) &&
        Objects.equals(this.uncollectedSupplySideTokenAmounts, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.uncollectedSupplySideTokenAmounts) &&
        Objects.equals(this.uncollectedSupplySideValuesUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.uncollectedSupplySideValuesUsd) &&
        Objects.equals(this.cumulativeSupplySideRevenueUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeSupplySideRevenueUsd) &&
        Objects.equals(this.cumulativeProtocolSideRevenueUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeProtocolSideRevenueUsd) &&
        Objects.equals(this.cumulativeTotalRevenueUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeTotalRevenueUsd) &&
        Objects.equals(this.cumulativeVolumeByTokenAmount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeVolumeByTokenAmount) &&
        Objects.equals(this.cumulativeVolumeByTokenUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeVolumeByTokenUsd) &&
        Objects.equals(this.cumulativeVolumeUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeVolumeUsd) &&
        Objects.equals(this.inputTokenBalances, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.inputTokenBalances) &&
        Objects.equals(this.inputTokenBalancesUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.inputTokenBalancesUsd) &&
        Objects.equals(this.inputTokenWeights, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.inputTokenWeights) &&
        Objects.equals(this.stakedOutputTokenAmount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.stakedOutputTokenAmount) &&
        Objects.equals(this.rewardTokenEmissionsAmount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.rewardTokenEmissionsAmount) &&
        Objects.equals(this.rewardTokenEmissionsUsd, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.rewardTokenEmissionsUsd) &&
        Objects.equals(this.cumulativeDepositCount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeDepositCount) &&
        Objects.equals(this.cumulativeWithdrawCount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeWithdrawCount) &&
        Objects.equals(this.cumulativeSwapCount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.cumulativeSwapCount) &&
        Objects.equals(this.positionCount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.positionCount) &&
        Objects.equals(this.openPositionCount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.openPositionCount) &&
        Objects.equals(this.closedPositionCount, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.closedPositionCount) &&
        Objects.equals(this.lastSnapshotDayId, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.lastSnapshotDayId) &&
        Objects.equals(this.lastSnapshotHourId, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.lastSnapshotHourId) &&
        Objects.equals(this.lastUpdateTimestamp, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.lastUpdateTimestamp) &&
        Objects.equals(this.lastUpdateBlockNumber, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.lastUpdateBlockNumber) &&
        Objects.equals(this.evaluatedAsk, paNCAKESWAPV3ETHEREUMLiquidityPoolDTO.evaluatedAsk);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PANCAKESWAPV3ETHEREUMLiquidityPoolDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PANCAKESWAPV3ETHEREUMLiquidityPoolDTO is not found in the empty JSON string", PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PANCAKESWAPV3ETHEREUMLiquidityPoolDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PANCAKESWAPV3ETHEREUMLiquidityPoolDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PANCAKESWAPV3ETHEREUMLiquidityPoolDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PANCAKESWAPV3ETHEREUMLiquidityPoolDTO>() {
           @Override
           public void write(JsonWriter out, PANCAKESWAPV3ETHEREUMLiquidityPoolDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PANCAKESWAPV3ETHEREUMLiquidityPoolDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PANCAKESWAPV3ETHEREUMLiquidityPoolDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PANCAKESWAPV3ETHEREUMLiquidityPoolDTO
  * @throws IOException if the JSON string is invalid with respect to PANCAKESWAPV3ETHEREUMLiquidityPoolDTO
  */
  public static PANCAKESWAPV3ETHEREUMLiquidityPoolDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PANCAKESWAPV3ETHEREUMLiquidityPoolDTO.class);
  }

 /**
  * Convert an instance of PANCAKESWAPV3ETHEREUMLiquidityPoolDTO to an JSON string
  *
  * @return JSON string
  */
