...
public class SushiswapMintDTO {
  ...
  public SushiswapMintDTO() {
  }

  public SushiswapMintDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SushiswapMintDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SushiswapMintDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SushiswapMintDTO id(String id) {
  ...
  **/
  ...
  public SushiswapMintDTO transaction(String transaction) {
  ...
  **/
  ...
  public SushiswapMintDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public SushiswapMintDTO pair(String pair) {
  ...
  **/
  ...
  public SushiswapMintDTO to(String to) {
  ...
  **/
  ...
  public SushiswapMintDTO liquidity(String liquidity) {
  ...
  **/
  ...
  public SushiswapMintDTO sender(String sender) {
  ...
  **/
  ...
  public SushiswapMintDTO amount0(String amount0) {
  ...
  **/
  ...
  public SushiswapMintDTO amount1(String amount1) {
  ...
  **/
  ...
  public SushiswapMintDTO logIndex(String logIndex) {
  ...
  **/
  ...
  public SushiswapMintDTO amountUsd(String amountUsd) {
  ...
  **/
  ...
  public SushiswapMintDTO feeTo(String feeTo) {
  ...
  **/
  ...
  public SushiswapMintDTO feeLiquidity(String feeLiquidity) {
  ...
  **/
  ...
  public SushiswapMintDTO vid(Long vid) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryTime, sushiswapMintDTO.entryTime) &&
        Objects.equals(this.recvTime, sushiswapMintDTO.recvTime) &&
        Objects.equals(this.blockNumber, sushiswapMintDTO.blockNumber) &&
        Objects.equals(this.id, sushiswapMintDTO.id) &&
        Objects.equals(this.transaction, sushiswapMintDTO.transaction) &&
        Objects.equals(this.timestamp, sushiswapMintDTO.timestamp) &&
        Objects.equals(this.pair, sushiswapMintDTO.pair) &&
        Objects.equals(this.to, sushiswapMintDTO.to) &&
        Objects.equals(this.liquidity, sushiswapMintDTO.liquidity) &&
        Objects.equals(this.sender, sushiswapMintDTO.sender) &&
        Objects.equals(this.amount0, sushiswapMintDTO.amount0) &&
        Objects.equals(this.amount1, sushiswapMintDTO.amount1) &&
        Objects.equals(this.logIndex, sushiswapMintDTO.logIndex) &&
        Objects.equals(this.amountUsd, sushiswapMintDTO.amountUsd) &&
        Objects.equals(this.feeTo, sushiswapMintDTO.feeTo) &&
        Objects.equals(this.feeLiquidity, sushiswapMintDTO.feeLiquidity) &&
        Objects.equals(this.vid, sushiswapMintDTO.vid);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entryTime, recvTime, blockNumber, id, transaction, timestamp, pair, to, liquidity, sender, amount0, amount1, logIndex, amountUsd, feeTo, feeLiquidity, vid);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SushiswapMintDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SushiswapMintDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SushiswapMintDTO is not found in the empty JSON string", SushiswapMintDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SushiswapMintDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SushiswapMintDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SushiswapMintDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SushiswapMintDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SushiswapMintDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SushiswapMintDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SushiswapMintDTO>() {
           @Override
           public void write(JsonWriter out, SushiswapMintDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SushiswapMintDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SushiswapMintDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SushiswapMintDTO
  * @throws IOException if the JSON string is invalid with respect to SushiswapMintDTO
  */
  public static SushiswapMintDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SushiswapMintDTO.class);
  }

 /**
  * Convert an instance of SushiswapMintDTO to an JSON string
  *
  * @return JSON string
  */
