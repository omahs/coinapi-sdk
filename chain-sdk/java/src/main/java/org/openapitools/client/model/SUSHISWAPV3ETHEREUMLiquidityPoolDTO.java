...
public class SUSHISWAPV3ETHEREUMLiquidityPoolDTO {
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO() {
  }
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO vid(Long vid) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO blockRange(String blockRange) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO id(String id) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO protocol(String protocol) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO name(String name) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO symbol(String symbol) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO liquidityToken(String liquidityToken) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO inputTokens(List<String> inputTokens) {
    
    this.inputTokens = inputTokens;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addInputTokensItem(String inputTokensItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO rewardTokens(List<String> rewardTokens) {
    
    this.rewardTokens = rewardTokens;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addRewardTokensItem(String rewardTokensItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO fees(List<String> fees) {
    
    this.fees = fees;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addFeesItem(String feesItem) {
    if (this.fees == null) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO isSingleSided(Boolean isSingleSided) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO createdTimestamp(String createdTimestamp) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO createdBlockNumber(String createdBlockNumber) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO tick(String tick) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO totalValueLockedUsd(String totalValueLockedUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO totalLiquidity(String totalLiquidity) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO totalLiquidityUsd(String totalLiquidityUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO activeLiquidity(String activeLiquidity) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO activeLiquidityUsd(String activeLiquidityUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO uncollectedProtocolSideTokenAmounts(List<String> uncollectedProtocolSideTokenAmounts) {
    
    this.uncollectedProtocolSideTokenAmounts = uncollectedProtocolSideTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addUncollectedProtocolSideTokenAmountsItem(String uncollectedProtocolSideTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO uncollectedProtocolSideValuesUsd(List<String> uncollectedProtocolSideValuesUsd) {
    
    this.uncollectedProtocolSideValuesUsd = uncollectedProtocolSideValuesUsd;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addUncollectedProtocolSideValuesUsdItem(String uncollectedProtocolSideValuesUsdItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO uncollectedSupplySideTokenAmounts(List<String> uncollectedSupplySideTokenAmounts) {
    
    this.uncollectedSupplySideTokenAmounts = uncollectedSupplySideTokenAmounts;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addUncollectedSupplySideTokenAmountsItem(String uncollectedSupplySideTokenAmountsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO uncollectedSupplySideValuesUsd(List<String> uncollectedSupplySideValuesUsd) {
    
    this.uncollectedSupplySideValuesUsd = uncollectedSupplySideValuesUsd;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addUncollectedSupplySideValuesUsdItem(String uncollectedSupplySideValuesUsdItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeSupplySideRevenueUsd(String cumulativeSupplySideRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeProtocolSideRevenueUsd(String cumulativeProtocolSideRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeTotalRevenueUsd(String cumulativeTotalRevenueUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeVolumeByTokenAmount(List<String> cumulativeVolumeByTokenAmount) {
    
    this.cumulativeVolumeByTokenAmount = cumulativeVolumeByTokenAmount;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addCumulativeVolumeByTokenAmountItem(String cumulativeVolumeByTokenAmountItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeVolumeByTokenUsd(List<String> cumulativeVolumeByTokenUsd) {
    
    this.cumulativeVolumeByTokenUsd = cumulativeVolumeByTokenUsd;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addCumulativeVolumeByTokenUsdItem(String cumulativeVolumeByTokenUsdItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeVolumeUsd(String cumulativeVolumeUsd) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO inputTokenBalances(List<String> inputTokenBalances) {
    
    this.inputTokenBalances = inputTokenBalances;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addInputTokenBalancesItem(String inputTokenBalancesItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO inputTokenBalancesUsd(List<String> inputTokenBalancesUsd) {
    
    this.inputTokenBalancesUsd = inputTokenBalancesUsd;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addInputTokenBalancesUsdItem(String inputTokenBalancesUsdItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO inputTokenWeights(List<String> inputTokenWeights) {
    
    this.inputTokenWeights = inputTokenWeights;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addInputTokenWeightsItem(String inputTokenWeightsItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO stakedOutputTokenAmount(String stakedOutputTokenAmount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO rewardTokenEmissionsAmount(List<String> rewardTokenEmissionsAmount) {
    
    this.rewardTokenEmissionsAmount = rewardTokenEmissionsAmount;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addRewardTokenEmissionsAmountItem(String rewardTokenEmissionsAmountItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO rewardTokenEmissionsUsd(List<String> rewardTokenEmissionsUsd) {
    
    this.rewardTokenEmissionsUsd = rewardTokenEmissionsUsd;
    return this;
  }

  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO addRewardTokenEmissionsUsdItem(String rewardTokenEmissionsUsdItem) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeDepositCount(Integer cumulativeDepositCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeWithdrawCount(Integer cumulativeWithdrawCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO cumulativeSwapCount(Integer cumulativeSwapCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO positionCount(Integer positionCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO openPositionCount(Integer openPositionCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO closedPositionCount(Integer closedPositionCount) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO lastSnapshotDayId(Integer lastSnapshotDayId) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO lastSnapshotHourId(Integer lastSnapshotHourId) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO lastUpdateTimestamp(String lastUpdateTimestamp) {
  ...
  **/
  ...
  public SUSHISWAPV3ETHEREUMLiquidityPoolDTO lastUpdateBlockNumber(String lastUpdateBlockNumber) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SUSHISWAPV3ETHEREUMLiquidityPoolDTO suSHISWAPV3ETHEREUMLiquidityPoolDTO = (SUSHISWAPV3ETHEREUMLiquidityPoolDTO) o;
    return Objects.equals(this.entryTime, suSHISWAPV3ETHEREUMLiquidityPoolDTO.entryTime) &&
        Objects.equals(this.recvTime, suSHISWAPV3ETHEREUMLiquidityPoolDTO.recvTime) &&
        Objects.equals(this.blockNumber, suSHISWAPV3ETHEREUMLiquidityPoolDTO.blockNumber) &&
        Objects.equals(this.vid, suSHISWAPV3ETHEREUMLiquidityPoolDTO.vid) &&
        Objects.equals(this.blockRange, suSHISWAPV3ETHEREUMLiquidityPoolDTO.blockRange) &&
        Objects.equals(this.id, suSHISWAPV3ETHEREUMLiquidityPoolDTO.id) &&
        Objects.equals(this.protocol, suSHISWAPV3ETHEREUMLiquidityPoolDTO.protocol) &&
        Objects.equals(this.name, suSHISWAPV3ETHEREUMLiquidityPoolDTO.name) &&
        Objects.equals(this.symbol, suSHISWAPV3ETHEREUMLiquidityPoolDTO.symbol) &&
        Objects.equals(this.liquidityToken, suSHISWAPV3ETHEREUMLiquidityPoolDTO.liquidityToken) &&
        Objects.equals(this.inputTokens, suSHISWAPV3ETHEREUMLiquidityPoolDTO.inputTokens) &&
        Objects.equals(this.rewardTokens, suSHISWAPV3ETHEREUMLiquidityPoolDTO.rewardTokens) &&
        Objects.equals(this.fees, suSHISWAPV3ETHEREUMLiquidityPoolDTO.fees) &&
        Objects.equals(this.isSingleSided, suSHISWAPV3ETHEREUMLiquidityPoolDTO.isSingleSided) &&
        Objects.equals(this.createdTimestamp, suSHISWAPV3ETHEREUMLiquidityPoolDTO.createdTimestamp) &&
        Objects.equals(this.createdBlockNumber, suSHISWAPV3ETHEREUMLiquidityPoolDTO.createdBlockNumber) &&
        Objects.equals(this.tick, suSHISWAPV3ETHEREUMLiquidityPoolDTO.tick) &&
        Objects.equals(this.totalValueLockedUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.totalValueLockedUsd) &&
        Objects.equals(this.totalLiquidity, suSHISWAPV3ETHEREUMLiquidityPoolDTO.totalLiquidity) &&
        Objects.equals(this.totalLiquidityUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.totalLiquidityUsd) &&
        Objects.equals(this.activeLiquidity, suSHISWAPV3ETHEREUMLiquidityPoolDTO.activeLiquidity) &&
        Objects.equals(this.activeLiquidityUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.activeLiquidityUsd) &&
        Objects.equals(this.uncollectedProtocolSideTokenAmounts, suSHISWAPV3ETHEREUMLiquidityPoolDTO.uncollectedProtocolSideTokenAmounts) &&
        Objects.equals(this.uncollectedProtocolSideValuesUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.uncollectedProtocolSideValuesUsd) &&
        Objects.equals(this.uncollectedSupplySideTokenAmounts, suSHISWAPV3ETHEREUMLiquidityPoolDTO.uncollectedSupplySideTokenAmounts) &&
        Objects.equals(this.uncollectedSupplySideValuesUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.uncollectedSupplySideValuesUsd) &&
        Objects.equals(this.cumulativeSupplySideRevenueUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeSupplySideRevenueUsd) &&
        Objects.equals(this.cumulativeProtocolSideRevenueUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeProtocolSideRevenueUsd) &&
        Objects.equals(this.cumulativeTotalRevenueUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeTotalRevenueUsd) &&
        Objects.equals(this.cumulativeVolumeByTokenAmount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeVolumeByTokenAmount) &&
        Objects.equals(this.cumulativeVolumeByTokenUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeVolumeByTokenUsd) &&
        Objects.equals(this.cumulativeVolumeUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeVolumeUsd) &&
        Objects.equals(this.inputTokenBalances, suSHISWAPV3ETHEREUMLiquidityPoolDTO.inputTokenBalances) &&
        Objects.equals(this.inputTokenBalancesUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.inputTokenBalancesUsd) &&
        Objects.equals(this.inputTokenWeights, suSHISWAPV3ETHEREUMLiquidityPoolDTO.inputTokenWeights) &&
        Objects.equals(this.stakedOutputTokenAmount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.stakedOutputTokenAmount) &&
        Objects.equals(this.rewardTokenEmissionsAmount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.rewardTokenEmissionsAmount) &&
        Objects.equals(this.rewardTokenEmissionsUsd, suSHISWAPV3ETHEREUMLiquidityPoolDTO.rewardTokenEmissionsUsd) &&
        Objects.equals(this.cumulativeDepositCount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeDepositCount) &&
        Objects.equals(this.cumulativeWithdrawCount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeWithdrawCount) &&
        Objects.equals(this.cumulativeSwapCount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.cumulativeSwapCount) &&
        Objects.equals(this.positionCount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.positionCount) &&
        Objects.equals(this.openPositionCount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.openPositionCount) &&
        Objects.equals(this.closedPositionCount, suSHISWAPV3ETHEREUMLiquidityPoolDTO.closedPositionCount) &&
        Objects.equals(this.lastSnapshotDayId, suSHISWAPV3ETHEREUMLiquidityPoolDTO.lastSnapshotDayId) &&
        Objects.equals(this.lastSnapshotHourId, suSHISWAPV3ETHEREUMLiquidityPoolDTO.lastSnapshotHourId) &&
        Objects.equals(this.lastUpdateTimestamp, suSHISWAPV3ETHEREUMLiquidityPoolDTO.lastUpdateTimestamp) &&
        Objects.equals(this.lastUpdateBlockNumber, suSHISWAPV3ETHEREUMLiquidityPoolDTO.lastUpdateBlockNumber) &&
        Objects.equals(this.evaluatedAsk, suSHISWAPV3ETHEREUMLiquidityPoolDTO.evaluatedAsk);
  }
  ...
  public String toString() {
    ...
    sb.append("class SUSHISWAPV3ETHEREUMLiquidityPoolDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SUSHISWAPV3ETHEREUMLiquidityPoolDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SUSHISWAPV3ETHEREUMLiquidityPoolDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SUSHISWAPV3ETHEREUMLiquidityPoolDTO is not found in the empty JSON string", SUSHISWAPV3ETHEREUMLiquidityPoolDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SUSHISWAPV3ETHEREUMLiquidityPoolDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SUSHISWAPV3ETHEREUMLiquidityPoolDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SUSHISWAPV3ETHEREUMLiquidityPoolDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SUSHISWAPV3ETHEREUMLiquidityPoolDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SUSHISWAPV3ETHEREUMLiquidityPoolDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SUSHISWAPV3ETHEREUMLiquidityPoolDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<SUSHISWAPV3ETHEREUMLiquidityPoolDTO>() {
           @Override
           public void write(JsonWriter out, SUSHISWAPV3ETHEREUMLiquidityPoolDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SUSHISWAPV3ETHEREUMLiquidityPoolDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SUSHISWAPV3ETHEREUMLiquidityPoolDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SUSHISWAPV3ETHEREUMLiquidityPoolDTO
  * @throws IOException if the JSON string is invalid with respect to SUSHISWAPV3ETHEREUMLiquidityPoolDTO
  */
  public static SUSHISWAPV3ETHEREUMLiquidityPoolDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SUSHISWAPV3ETHEREUMLiquidityPoolDTO.class);
  }

 /**
  * Convert an instance of SUSHISWAPV3ETHEREUMLiquidityPoolDTO to an JSON string
  *
  * @return JSON string
  */
