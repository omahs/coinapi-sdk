...
public class PANCAKESWAPV3ETHEREUMWithdrawDTO {
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO() {
  }

  public PANCAKESWAPV3ETHEREUMWithdrawDTO entryTime(OffsetDateTime entryTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO recvTime(OffsetDateTime recvTime) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO blockNumber(Long blockNumber) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO id(String id) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO hash(String hash) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO nonce(String nonce) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO logIndex(Integer logIndex) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO gasLimit(String gasLimit) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO gasUsed(String gasUsed) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO gasPrice(String gasPrice) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO protocol(String protocol) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO account(String account) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO position(String position) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO tickLower(String tickLower) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO tickUpper(String tickUpper) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO pool(String pool) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO timestamp(String timestamp) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO liquidity(String liquidity) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO inputTokens(List<String> inputTokens) {
    
    this.inputTokens = inputTokens;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMWithdrawDTO addInputTokensItem(String inputTokensItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO inputTokenAmounts(List<String> inputTokenAmounts) {
    
    this.inputTokenAmounts = inputTokenAmounts;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMWithdrawDTO addInputTokenAmountsItem(String inputTokenAmountsItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO reserveAmounts(List<String> reserveAmounts) {
    
    this.reserveAmounts = reserveAmounts;
    return this;
  }

  public PANCAKESWAPV3ETHEREUMWithdrawDTO addReserveAmountsItem(String reserveAmountsItem) {
  ...
  **/
  ...
  public PANCAKESWAPV3ETHEREUMWithdrawDTO amountUsd(String amountUsd) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PANCAKESWAPV3ETHEREUMWithdrawDTO paNCAKESWAPV3ETHEREUMWithdrawDTO = (PANCAKESWAPV3ETHEREUMWithdrawDTO) o;
    return Objects.equals(this.entryTime, paNCAKESWAPV3ETHEREUMWithdrawDTO.entryTime) &&
        Objects.equals(this.recvTime, paNCAKESWAPV3ETHEREUMWithdrawDTO.recvTime) &&
        Objects.equals(this.blockNumber, paNCAKESWAPV3ETHEREUMWithdrawDTO.blockNumber) &&
        Objects.equals(this.id, paNCAKESWAPV3ETHEREUMWithdrawDTO.id) &&
        Objects.equals(this.hash, paNCAKESWAPV3ETHEREUMWithdrawDTO.hash) &&
        Objects.equals(this.nonce, paNCAKESWAPV3ETHEREUMWithdrawDTO.nonce) &&
        Objects.equals(this.logIndex, paNCAKESWAPV3ETHEREUMWithdrawDTO.logIndex) &&
        Objects.equals(this.gasLimit, paNCAKESWAPV3ETHEREUMWithdrawDTO.gasLimit) &&
        Objects.equals(this.gasUsed, paNCAKESWAPV3ETHEREUMWithdrawDTO.gasUsed) &&
        Objects.equals(this.gasPrice, paNCAKESWAPV3ETHEREUMWithdrawDTO.gasPrice) &&
        Objects.equals(this.protocol, paNCAKESWAPV3ETHEREUMWithdrawDTO.protocol) &&
        Objects.equals(this.account, paNCAKESWAPV3ETHEREUMWithdrawDTO.account) &&
        Objects.equals(this.position, paNCAKESWAPV3ETHEREUMWithdrawDTO.position) &&
        Objects.equals(this.tickLower, paNCAKESWAPV3ETHEREUMWithdrawDTO.tickLower) &&
        Objects.equals(this.tickUpper, paNCAKESWAPV3ETHEREUMWithdrawDTO.tickUpper) &&
        Objects.equals(this.pool, paNCAKESWAPV3ETHEREUMWithdrawDTO.pool) &&
        Objects.equals(this.timestamp, paNCAKESWAPV3ETHEREUMWithdrawDTO.timestamp) &&
        Objects.equals(this.liquidity, paNCAKESWAPV3ETHEREUMWithdrawDTO.liquidity) &&
        Objects.equals(this.inputTokens, paNCAKESWAPV3ETHEREUMWithdrawDTO.inputTokens) &&
        Objects.equals(this.inputTokenAmounts, paNCAKESWAPV3ETHEREUMWithdrawDTO.inputTokenAmounts) &&
        Objects.equals(this.reserveAmounts, paNCAKESWAPV3ETHEREUMWithdrawDTO.reserveAmounts) &&
        Objects.equals(this.amountUsd, paNCAKESWAPV3ETHEREUMWithdrawDTO.amountUsd);
  }
  ...
  public String toString() {
    ...
    sb.append("class PANCAKESWAPV3ETHEREUMWithdrawDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PANCAKESWAPV3ETHEREUMWithdrawDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PANCAKESWAPV3ETHEREUMWithdrawDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PANCAKESWAPV3ETHEREUMWithdrawDTO is not found in the empty JSON string", PANCAKESWAPV3ETHEREUMWithdrawDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PANCAKESWAPV3ETHEREUMWithdrawDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PANCAKESWAPV3ETHEREUMWithdrawDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PANCAKESWAPV3ETHEREUMWithdrawDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PANCAKESWAPV3ETHEREUMWithdrawDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PANCAKESWAPV3ETHEREUMWithdrawDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PANCAKESWAPV3ETHEREUMWithdrawDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<PANCAKESWAPV3ETHEREUMWithdrawDTO>() {
           @Override
           public void write(JsonWriter out, PANCAKESWAPV3ETHEREUMWithdrawDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PANCAKESWAPV3ETHEREUMWithdrawDTO read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PANCAKESWAPV3ETHEREUMWithdrawDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PANCAKESWAPV3ETHEREUMWithdrawDTO
  * @throws IOException if the JSON string is invalid with respect to PANCAKESWAPV3ETHEREUMWithdrawDTO
  */
  public static PANCAKESWAPV3ETHEREUMWithdrawDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PANCAKESWAPV3ETHEREUMWithdrawDTO.class);
  }

 /**
  * Convert an instance of PANCAKESWAPV3ETHEREUMWithdrawDTO to an JSON string
  *
  * @return JSON string
  */
