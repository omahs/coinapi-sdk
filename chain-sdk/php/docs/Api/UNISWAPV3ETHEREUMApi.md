...
```php
uNISWAPV3ETHEREUMActiveAccountsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMActiveAccountDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMActiveAccountsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMActiveAccountsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMActiveAccountDTO[]**](../Model/UNISWAPV3ETHEREUMActiveAccountDTO.md)
...
```php
uNISWAPV3ETHEREUMDepositsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMDepositDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMDepositsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMDepositsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMDepositDTO[]**](../Model/UNISWAPV3ETHEREUMDepositDTO.md)
...
```php
uNISWAPV3ETHEREUMDexAmmProtocolsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMDexAmmProtocolDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMDexAmmProtocolsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMDexAmmProtocolsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMDexAmmProtocolDTO[]**](../Model/UNISWAPV3ETHEREUMDexAmmProtocolDTO.md)
...
```php
uNISWAPV3ETHEREUMFinancialsDailySnapshotsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMFinancialsDailySnapshotsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMFinancialsDailySnapshotsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO[]**](../Model/UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO.md)
...
```php
uNISWAPV3ETHEREUMLiquidityPoolFeesCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMLiquidityPoolFeeDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMLiquidityPoolFeesCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMLiquidityPoolFeesCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMLiquidityPoolFeeDTO[]**](../Model/UNISWAPV3ETHEREUMLiquidityPoolFeeDTO.md)
...
```php
uNISWAPV3ETHEREUMPositionSnapshotsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMPositionSnapshotDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMPositionSnapshotsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMPositionSnapshotsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMPositionSnapshotDTO[]**](../Model/UNISWAPV3ETHEREUMPositionSnapshotDTO.md)
...
```php
uNISWAPV3ETHEREUMPositionsCurrent($pool): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMPositionDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMPositionsCurrent($pool);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMPositionsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMPositionDTO[]**](../Model/UNISWAPV3ETHEREUMPositionDTO.md)
...
```php
uNISWAPV3ETHEREUMRewardTokensCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMRewardTokenDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMRewardTokensCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMRewardTokensCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMRewardTokenDTO[]**](../Model/UNISWAPV3ETHEREUMRewardTokenDTO.md)
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMTickDailySnapshotDTO[]**](../Model/UNISWAPV3ETHEREUMTickDailySnapshotDTO.md)
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMTickHourlySnapshotDTO[]**](../Model/UNISWAPV3ETHEREUMTickHourlySnapshotDTO.md)
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMTickDTO[]**](../Model/UNISWAPV3ETHEREUMTickDTO.md)
...
```php
uNISWAPV3ETHEREUMTokenWhiteListSymbolsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMTokenWhiteListSymbolsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMTokenWhiteListSymbolsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO[]**](../Model/UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO.md)
...
```php
uNISWAPV3ETHEREUMTokenWhiteListsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMTokenWhiteListDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMTokenWhiteListsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMTokenWhiteListsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMTokenWhiteListDTO[]**](../Model/UNISWAPV3ETHEREUMTokenWhiteListDTO.md)
...
```php
uNISWAPV3ETHEREUMUsageMetricsDailySnapshotsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMUsageMetricsDailySnapshotsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMUsageMetricsDailySnapshotsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO[]**](../Model/UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.md)
...
```php
uNISWAPV3ETHEREUMUsageMetricsHourlySnapshotsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMUsageMetricsHourlySnapshotsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMUsageMetricsHourlySnapshotsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO[]**](../Model/UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.md)
...
```php
uNISWAPV3ETHEREUMWithdrawsCurrent(): \OpenAPI\Client\Model\UNISWAPV3ETHEREUMWithdrawDTO[]
```
...
try {
    $result = $apiInstance->uNISWAPV3ETHEREUMWithdrawsCurrent();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UNISWAPV3ETHEREUMApi->uNISWAPV3ETHEREUMWithdrawsCurrent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\UNISWAPV3ETHEREUMWithdrawDTO[]**](../Model/UNISWAPV3ETHEREUMWithdrawDTO.md)
