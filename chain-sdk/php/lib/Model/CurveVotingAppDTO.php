...
/**
 * CurveVotingAppDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CurveVotingAppDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Curve.VotingAppDTO';
    ...
    protected static $setters = [
        ...
        'minimum_time' => 'setMinimumTime',
        'required_support' => 'setRequiredSupport',
        'vote_time' => 'setVoteTime',
        'proposal_count' => 'setProposalCount',
    ...
    protected static $getters = [
        ...
        'minimum_time' => 'getMinimumTime',
        'required_support' => 'getRequiredSupport',
        'vote_time' => 'getVoteTime',
        'proposal_count' => 'getProposalCount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('minimum_time', $data ?? [], null);
        $this->setIfExists('required_support', $data ?? [], null);
        $this->setIfExists('vote_time', $data ?? [], null);
        $this->setIfExists('proposal_count', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id App address.
     *
     * @return self
     */
    ...
    {
        if (is_null($codename)) {
            array_push($this->openAPINullablesSetToNull, 'codename');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('codename', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $minimum_balance Minimum balance needed to create a proposal.
     *
     * @return self
     */
     ...
     * Sets minimum_quorum
     *
     * @param string|null $minimum_quorum Percentage of positive votes in total possible votes for a proposal to be accepted.
     *
     * @return self
     */
    ...
    {
        return $this->container['minimum_time'];
    }

    /**
     * Sets minimum_time
     *
     * @param string|null $minimum_time Minimum time needed to pass between user's previous proposal and a user creating a new proposal.
     *
     * @return self
     */
    public function setMinimumTime($minimum_time)
    {
        if (is_null($minimum_time)) {
            array_push($this->openAPINullablesSetToNull, 'minimum_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('minimum_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['minimum_time'] = $minimum_time;
     ...
     *
     * @param string|null $required_support Percentage of positive votes needed for a proposal to be accepted.
     *
     * @return self
     */
    ...
    {
        return $this->container['vote_time'];
    }

    /**
     * Sets vote_time
     *
     * @param string|null $vote_time Seconds that a proposal will be open for vote (unless enough votes have been cast to make an early decision).
     *
     * @return self
     */
    public function setVoteTime($vote_time)
    {
        if (is_null($vote_time)) {
            array_push($this->openAPINullablesSetToNull, 'vote_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vote_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['vote_time'] = $vote_time;
    ...
    {
        return $this->container['proposal_count'];
    }

    /**
     * Sets proposal_count
     *
     * @param string|null $proposal_count Number of proposals created with this app.
     *
     * @return self
     */
    public function setProposalCount($proposal_count)
    {
        if (is_null($proposal_count)) {
            array_push($this->openAPINullablesSetToNull, 'proposal_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('proposal_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['proposal_count'] = $proposal_count;
     ...
     * Sets vote_count
     *
     * @param string|null $vote_count Number of votes received by all the proposals created with this app.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Address of the token used for voting.
     *
     * @return self
     */
