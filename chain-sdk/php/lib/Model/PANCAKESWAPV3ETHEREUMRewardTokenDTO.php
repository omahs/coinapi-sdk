...
/**
 * PANCAKESWAPV3ETHEREUMRewardTokenDTO Class Doc Comment
 *
 * @category Class
 * @description Reward tokens awarded to lenders and borrowers.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PANCAKESWAPV3ETHEREUMRewardTokenDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PANCAKESWAP_V3_ETHEREUM.RewardTokenDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id (reward token type)-(smart contract address of the reward token)
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Reference to the actual token
     *
     * @return self
     */
