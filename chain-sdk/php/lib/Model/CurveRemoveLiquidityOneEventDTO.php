...
/**
 * CurveRemoveLiquidityOneEventDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CurveRemoveLiquidityOneEventDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Curve.RemoveLiquidityOneEventDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('coin_amount', $data ?? [], null);
    ...
    */
     ...
     * Sets token_amount
     *
     * @param string|null $token_amount 
     *
     * @return self
     */
    public function setTokenAmount($token_amount)
    {
        if (is_null($token_amount)) {
            array_push($this->openAPINullablesSetToNull, 'token_amount');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('token_amount', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        return $this->container['coin_amount'];
    }

    /**
     * Sets coin_amount
     *
     * @param string|null $coin_amount 
     *
     * @return self
     */
    public function setCoinAmount($coin_amount)
    {
        if (is_null($coin_amount)) {
            array_push($this->openAPINullablesSetToNull, 'coin_amount');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('coin_amount', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['coin_amount'] = $coin_amount;
