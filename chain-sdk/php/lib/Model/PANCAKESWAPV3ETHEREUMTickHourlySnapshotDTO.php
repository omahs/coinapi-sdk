...
/**
 * PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id (pool address)-(tick index)-(hour ID)
     *
     * @return self
     */
    ...
    {
        return $this->container['hour_id'];
    }

    /**
     * Sets hour_id
     *
     * @param int|null $hour_id Number of hours since Unix epoch time
     *
     * @return self
     */
    ...
    {
        if (is_null($hour_id)) {
            throw new \InvalidArgumentException('non-nullable hour_id cannot be null');
        }
        $this->container['hour_id'] = $hour_id;
     ...
     * Sets tick
     *
     * @param string|null $tick tick index
     *
     * @return self
     */
