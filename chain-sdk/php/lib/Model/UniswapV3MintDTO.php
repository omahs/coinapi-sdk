...
/**
 * UniswapV3MintDTO Class Doc Comment
 *
 * @category Class
 * @description Mint entities are created for every emitted Mint event on the Uniswap core contracts. The Mint entity stores key data about the event like token amounts, who sent the transaction, and more.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UniswapV3MintDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UniswapV3.MintDTO';
    ...
    */
     ...
     * Sets transaction
     *
     * @param string|null $transaction Which txn the mint was included in.
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param string|null $timestamp Time of transaction.
     *
     * @return self
     */
     ...
     * Sets owner
     *
     * @param string|null $owner Owner of position where liquidity minted to.
     *
     * @return self
     */
     ...
     * Sets sender
     *
     * @param string|null $sender The address that minted the liquidity.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount Amount of liquidity minted.
     *
     * @return self
     */
     ...
     * Sets amount_0
     *
     * @param string|null $amount_0 Amount of token 0 minted.
     *
     * @return self
     */
     ...
     * Sets amount_1
     *
     * @param string|null $amount_1 Amount of token 1 minted.
     *
     * @return self
     */
     ...
     * Sets log_index
     *
     * @param string|null $log_index Order within the transaction.
     *
     * @return self
     */
