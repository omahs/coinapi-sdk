...
/**
 * UNISWAPV2ETHEREUMMasterChefAddressToPidDTO Class Doc Comment
 *
 * @category Class
 * @description .
 * @package  OpenAPI\Client
 ...
 */
class UNISWAPV2ETHEREUMMasterChefAddressToPidDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNISWAP_V2_ETHEREUM.MasterChefAddressToPidDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier, format: (masterchef type) - (address of the staking pool per the masterchef pid)
     *
     * @return self
     */
     ...
     * Sets pid
     *
     * @param string|null $pid Pid referenced in the MasterChef Contract
     *
     * @return self
     */
