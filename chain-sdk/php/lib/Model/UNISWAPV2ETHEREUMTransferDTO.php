...
/**
 * UNISWAPV2ETHEREUMTransferDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class UNISWAPV2ETHEREUMTransferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNISWAP_V2_ETHEREUM.TransferDTO';
    ...
    */
     ...
     * Sets block_range
     *
     * @param string|null $block_range Entity is used to track data from the transfer events (execution of: deposit/withdraw, mint/burn).
     *
     * @return self
     */
