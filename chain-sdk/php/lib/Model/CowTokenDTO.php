...
/**
 * CowTokenDTO Class Doc Comment
 *
 * @category Class
 * @description Stores information for a specific token across all pairs that token is included in.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CowTokenDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cow.TokenDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Token's address.
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address Token's address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $first_trade_timestamp First token trade block timestamp.
     *
     * @return self
     */
    public function setFirstTradeTimestamp($first_trade_timestamp)
    {
        if (is_null($first_trade_timestamp)) {
            array_push($this->openAPINullablesSetToNull, 'first_trade_timestamp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('first_trade_timestamp', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets name
     *
     * @param string|null $name Token name fetched by ERC20 contract call.
     *
     * @return self
     */
     ...
     * Sets symbol
     *
     * @param string|null $symbol Token symbol fetched by contract call.
     *
     * @return self
     */
     ...
     * Sets decimals
     *
     * @param int|null $decimals Token decimals fetched by contract call.
     *
     * @return self
     */
     ...
     * Sets total_volume
     *
     * @param string|null $total_volume Sum of total amount traded for this token.
     *
     * @return self
     */
    public function setTotalVolume($total_volume)
    {
        if (is_null($total_volume)) {
            array_push($this->openAPINullablesSetToNull, 'total_volume');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('total_volume', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
