...
/**
 * PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('token_prices', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['token_prices'];
    }

    /**
     * Sets token_prices
     *
     * @param string[]|null $token_prices 
     *
     * @return self
     */
    public function setTokenPrices($token_prices)
    {
        if (is_null($token_prices)) {
            array_push($this->openAPINullablesSetToNull, 'token_prices');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('token_prices', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['token_prices'] = $token_prices;
