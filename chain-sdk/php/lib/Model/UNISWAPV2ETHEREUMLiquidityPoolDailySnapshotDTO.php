...
/**
 * UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id (smart contract address of the pool)-(# of days since Unix epoch time)
     *
     * @return self
     */
