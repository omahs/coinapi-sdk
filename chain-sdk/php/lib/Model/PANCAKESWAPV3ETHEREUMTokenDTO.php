...
/**
 * PANCAKESWAPV3ETHEREUMTokenDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class PANCAKESWAPV3ETHEREUMTokenDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PANCAKESWAP_V3_ETHEREUM.TokenDTO';
    ...
    protected static $setters = [
        ...
        'last_price_pool' => 'setLastPricePool',
    ...
    protected static $getters = [
        ...
        'last_price_pool' => 'getLastPricePool',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('last_price_pool', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets last_price_pool
     *
     * @return string|null
     */
    public function getLastPricePool()
    {
        return $this->container['last_price_pool'];
    }
     ...
     * @return self
     */
    public function setLastPricePool($last_price_pool)
    {
        if (is_null($last_price_pool)) {
            array_push($this->openAPINullablesSetToNull, 'last_price_pool');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_price_pool', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['last_price_pool'] = $last_price_pool;
