...
/**
 * CRYPTOPUNKSCollectionDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CRYPTOPUNKSCollectionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CRYPTOPUNKS.CollectionDTO';
    ...
    protected static $setters = [
        ...
        'buyer_count' => 'setBuyerCount',
        'seller_count' => 'setSellerCount'
    ];
    ...
    protected static $getters = [
        ...
        'buyer_count' => 'getBuyerCount',
        'seller_count' => 'getSellerCount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('buyer_count', $data ?? [], null);
        $this->setIfExists('seller_count', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['buyer_count'];
    }

    /**
     * Sets buyer_count
     *
     * @param int|null $buyer_count 
     *
     * @return self
     */
    public function setBuyerCount($buyer_count)
    {
        if (is_null($buyer_count)) {
            throw new \InvalidArgumentException('non-nullable buyer_count cannot be null');
        }
        $this->container['buyer_count'] = $buyer_count;
    ...
    {
        return $this->container['seller_count'];
    }

    /**
     * Sets seller_count
     *
     * @param int|null $seller_count 
     *
     * @return self
     */
    public function setSellerCount($seller_count)
    {
        if (is_null($seller_count)) {
            throw new \InvalidArgumentException('non-nullable seller_count cannot be null');
        }
        $this->container['seller_count'] = $seller_count;
