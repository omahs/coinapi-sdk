...
/**
 * CURVEFINANCEETHEREUMAccountDTO Class Doc Comment
 *
 * @category Class
 * @description Entity to accumulate total unique users.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CURVEFINANCEETHEREUMAccountDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURVE_FINANCE_ETHEREUM.AccountDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Address of the account
     *
     * @return self
     */
