...
/**
 * CURVEFINANCEETHEREUMTokenDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class CURVEFINANCEETHEREUMTokenDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURVE_FINANCE_ETHEREUM.TokenDTO';
    ...
    */
     ...
     * Sets last_price_usd
     *
     * @param string|null $last_price_usd Optional field to track the price of a token
     *
     * @return self
     */
