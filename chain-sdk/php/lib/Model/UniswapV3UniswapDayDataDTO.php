...
/**
 * UniswapV3UniswapDayDataDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class UniswapV3UniswapDayDataDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UniswapV3.UniswapDayDataDTO';
    ...
    protected static $setters = [
        ...
        'volume_usd_untracked' => 'setVolumeUsdUntracked',
        'fees_usd' => 'setFeesUsd',
        'tx_count' => 'setTxCount',
        'tvl_usd' => 'setTvlUsd'
    ];
    ...
    protected static $getters = [
        ...
        'volume_usd_untracked' => 'getVolumeUsdUntracked',
        'fees_usd' => 'getFeesUsd',
        'tx_count' => 'getTxCount',
        'tvl_usd' => 'getTvlUsd'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('volume_usd_untracked', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets volume_usd_untracked
     *
     * @return string|null
     */
    public function getVolumeUsdUntracked()
    {
        return $this->container['volume_usd_untracked'];
    }
     ...
     * @return self
     */
    public function setVolumeUsdUntracked($volume_usd_untracked)
    {
        if (is_null($volume_usd_untracked)) {
            array_push($this->openAPINullablesSetToNull, 'volume_usd_untracked');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('volume_usd_untracked', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['volume_usd_untracked'] = $volume_usd_untracked;
