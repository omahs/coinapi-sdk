...
/**
 * CURVEFINANCEETHEREUMLiquidityPoolFeeDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class CURVEFINANCEETHEREUMLiquidityPoolFeeDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id (fee type)-(pool address)
     *
     * @return self
     */
