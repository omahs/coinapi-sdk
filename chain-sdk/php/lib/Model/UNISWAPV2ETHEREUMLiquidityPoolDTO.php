...
/**
 * UNISWAPV2ETHEREUMLiquidityPoolDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class UNISWAPV2ETHEREUMLiquidityPoolDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNISWAP_V2_ETHEREUM.LiquidityPoolDTO';
    ...
    */
     ...
     * Sets input_tokens
     *
     * @param string[]|null $input_tokens Tokens that need to be deposited to take a position in the protocol
     *
     * @return self
     */
     ...
     * Sets reward_tokens
     *
     * @param string[]|null $reward_tokens Aditional tokens that are given as reward for position in a protocol
     *
     * @return self
     */
     ...
     * Sets fees
     *
     * @param string[]|null $fees Fees per trade incurred to the user
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_single_sided Whether this pool is single-sided
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $input_token_balances Amount of input tokens in the pool
     *
     * @return self
     */
     ...
     *
     * @param string|null $staked_output_token_amount Total supply of output tokens that are staked
     *
     * @return self
     */
