...
/**
 * PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier, format: (pool address)-(tick index)-(day ID)
     *
     * @return self
     */
     ...
     * Sets day_id
     *
     * @param int|null $day_id Number of days since Unix epoch time
     *
     * @return self
     */
    ...
    {
        if (is_null($day_id)) {
            throw new \InvalidArgumentException('non-nullable day_id cannot be null');
        }
