...
/**
 * UNISWAPV2ETHEREUMDepositDTO Class Doc Comment
 *
 * @category Class
 * @description Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UNISWAPV2ETHEREUMDepositDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNISWAP_V2_ETHEREUM.DepositDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier, format: (transaction hash)-(log index)
     *
     * @return self
     */
     ...
     * Sets input_tokens
     *
     * @param string[]|null $input_tokens Input tokens of the pool. E.g. WETH and USDC to a WETH-USDC pool
     *
     * @return self
     */
     ...
     * Sets output_token
     *
     * @param string|null $output_token Output token of the pool. E.g. the UNI-LP token
     *
     * @return self
     */
     ...
     * Sets amount_usd
     *
     * @param string|null $amount_usd USD-normalized value of the transaction of the underlying (e.g. sum of tokens deposited into a pool)
     *
     * @return self
     */
