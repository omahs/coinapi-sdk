...
/**
 * CurveCoinDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CurveCoinDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Curve.CoinDTO';
    ...
    */
    ...
    public function setUnderlying($underlying)
    {
        if (is_null($underlying)) {
            array_push($this->openAPINullablesSetToNull, 'underlying');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('underlying', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets rate
     *
     * @param string|null $rate Exchange rate between this coin and the associated underlying coin within the pool.
     *
     * @return self
     */
