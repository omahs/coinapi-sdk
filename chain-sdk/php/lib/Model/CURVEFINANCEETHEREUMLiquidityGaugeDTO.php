...
/**
 * CURVEFINANCEETHEREUMLiquidityGaugeDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class CURVEFINANCEETHEREUMLiquidityGaugeDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURVE_FINANCE_ETHEREUM.LiquidityGaugeDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Address of the Liquidity Gauge
     *
     * @return self
     */
     ...
     * Sets pool_address
     *
     * @param string|null $pool_address Address of the pool associated with this liquidity gauge
     *
     * @return self
     */
