...
/**
 * CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURVE_FINANCE_ETHEREUM.LiquidityPoolDailySnapshotDTO';
    ...
    */
     ...
     *
     * @param string|null $daily_supply_side_revenue_usd 
     *
     * @return self
     */
     ...
     *
     * @param string|null $cumulative_protocol_side_revenue_usd Daily revenue generated by the liquidity pool, accrued to the supply side.
     *
     * @return self
     */
     ...
     *
     * @param string|null $daily_protocol_side_revenue_usd All revenue generated by the liquidity pool, accrued to the protocol.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $daily_volume_by_token_amount 
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $daily_volume_by_token_usd All trade volume occurred in a given day for a specific input token, in native amount. The ordering should be the same as the pool's 'inputTokens' field.
     *
     * @return self
     */
     ...
     *
     * @param string|null $cumulative_volume_usd All trade volume occurred in a given day for a specific input token, in USD. The ordering should be the same as the pool's 'inputTokens' field.
     *
     * @return self
     */
