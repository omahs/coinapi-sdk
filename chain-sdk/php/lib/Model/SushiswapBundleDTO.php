...
/**
 * SushiswapBundleDTO Class Doc Comment
 *
 * @category Class
 * @description The Bundle is used as a global store of derived ETH price in USD.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SushiswapBundleDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sushiswap.BundleDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('eth_price', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Hardcoded to '1'.
     *
     * @return self
     */
    ...
    {
        return $this->container['eth_price'];
    }

    /**
     * Sets eth_price
     *
     * @param string|null $eth_price Price of native.
     *
     * @return self
     */
    public function setEthPrice($eth_price)
    {
        if (is_null($eth_price)) {
            array_push($this->openAPINullablesSetToNull, 'eth_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('eth_price', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['eth_price'] = $eth_price;
