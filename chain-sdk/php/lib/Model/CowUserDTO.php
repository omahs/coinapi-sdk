 ...
 */
class CowUserDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cow.UserDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_solver', $data ?? [], null);
    ...
    */
     ...
     * Sets address
     *
     * @param string|null $address User's address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $first_trade_timestamp First trade block timestamp.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getIsSolver()
    {
        return $this->container['is_solver'];
    }

    /**
     * Sets is_solver
     *
     * @param bool|null $is_solver Determines if user has solved a settlement.
     *
     * @return self
     */
    public function setIsSolver($is_solver)
    {
        if (is_null($is_solver)) {
            throw new \InvalidArgumentException('non-nullable is_solver cannot be null');
        }
        $this->container['is_solver'] = $is_solver;
