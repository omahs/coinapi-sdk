...
/**
 * UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO Class Doc Comment
 *
 * @category Class
 * @description Daily financial metrics for Uniswap V2.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO';
    ...
    */
     ...
     *
     * @param string|null $daily_protocol_side_revenue_usd Gross revenue for the protocol (revenue claimed by protocol). Examples: AMM protocol fee (Sushi’s 0.05%). OpenSea 10% sell fee.
     *
     * @return self
     */
     ...
     *
     * @param string|null $daily_total_revenue_usd ll revenue generated by the protocol. e.g. 0.30% of swap fee in Sushiswap, all yield generated by Yearn.
     *
     * @return self
     */
