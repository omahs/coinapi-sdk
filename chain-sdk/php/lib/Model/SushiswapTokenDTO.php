...
/**
 * SushiswapTokenDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class SushiswapTokenDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets decimals
     *
     * @param string|null $decimals Token decimals.
     *
     * @return self
     */
     ...
     * Sets total_supply
     *
     * @param string|null $total_supply Total supply of liquidity token.
     *
     * @return self
     */
     ...
     * Sets volume
     *
     * @param string|null $volume Amount of token traded all time across all pairs.
     *
     * @return self
     */
     ...
     * Sets volume_usd
     *
     * @param string|null $volume_usd Amount of token in USD traded all time across pairs (only for tokens with liquidity above minimum threshold).
     *
     * @return self
     */
     ...
     * Sets tx_count
     *
     * @param string|null $tx_count Amount of transactions all time in pairs including token.
     *
     * @return self
     */
     ...
     * Sets liquidity
     *
     * @param string|null $liquidity Total amount of token provided as liquidity across all pairs.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $whitelist_pairs Array of whitelisted pairs.
     *
     * @return self
     */
