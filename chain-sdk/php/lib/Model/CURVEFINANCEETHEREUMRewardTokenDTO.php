...
/**
 * CURVEFINANCEETHEREUMRewardTokenDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class CURVEFINANCEETHEREUMRewardTokenDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURVE_FINANCE_ETHEREUM.RewardTokenDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier, format: (reward token type)-(smart contract address of the reward token)
     *
     * @return self
     */
