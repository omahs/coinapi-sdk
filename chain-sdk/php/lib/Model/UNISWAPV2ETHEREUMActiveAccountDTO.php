...
/**
 * UNISWAPV2ETHEREUMActiveAccountDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class UNISWAPV2ETHEREUMActiveAccountDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNISWAP_V2_ETHEREUM.ActiveAccountDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier, format: (daily/hourly)-(address of the account)-(days/hours since unix epoch)
     *
     * @return self
     */
