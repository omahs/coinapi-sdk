...
/**
 * UNISWAPV2ETHEREUMLiquidityPoolAmountDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class UNISWAPV2ETHEREUMLiquidityPoolAmountDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO';
    ...
    */
     ...
     *
     * @param string[]|null $input_token_balances Amount of input tokens in the pool. The ordering is the same as the pool's 'inputTokens' field.
     *
     * @return self
     */
