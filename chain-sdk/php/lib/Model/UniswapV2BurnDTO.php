...
/**
 * UniswapV2BurnDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class UniswapV2BurnDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UniswapV2.BurnDTO';
    ...
    protected static $setters = [
        ...
        'needs_complete' => 'setNeedsComplete',
        'fee_to' => 'setFeeTo',
    ...
    protected static $getters = [
        ...
        'needs_complete' => 'getNeedsComplete',
        'fee_to' => 'getFeeTo',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('needs_complete', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Transaction hash plus index in the transaction burn array
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getNeedsComplete()
    {
        return $this->container['needs_complete'];
    }

    /**
     * Sets needs_complete
     *
     * @param bool|null $needs_complete 
     *
     * @return self
     */
    public function setNeedsComplete($needs_complete)
    {
        if (is_null($needs_complete)) {
            throw new \InvalidArgumentException('non-nullable needs_complete cannot be null');
        }
        $this->container['needs_complete'] = $needs_complete;
