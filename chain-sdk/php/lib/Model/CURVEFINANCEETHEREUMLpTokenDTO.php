...
/**
 * CURVEFINANCEETHEREUMLpTokenDTO Class Doc Comment
 *
 * @category Class
 * @description Entity for fetching the pool address from lpToken.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CURVEFINANCEETHEREUMLpTokenDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURVE_FINANCE_ETHEREUM.LpTokenDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Address of the LP Token.
     *
     * @return self
     */
     ...
     * Sets pool_address
     *
     * @param string|null $pool_address Address of the pool associated with this token.
     *
     * @return self
     */
     ...
     *
     * @param string|null $registry_address Address of the registry associated with this token.
     *
     * @return self
     */
