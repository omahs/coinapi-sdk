...
/**
 * DexWithdrawRequestDTO Class Doc Comment
 *
 * @category Class
 * @description Withdraw request of an user
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DexWithdrawRequestDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dex.WithdrawRequestDTO';
    ...
    protected static array $openAPINullables = [
		...
		'token_address' => true,
		'amount' => true,
		'withdrawable_from_batch_id' => true,
		'create_epoch' => true,
		'create_batch_id' => true,
		'tx_hash' => true,
		'vid' => false
    ];
    ...
    protected static $setters = [
        ...
        'amount' => 'setAmount',
        'withdrawable_from_batch_id' => 'setWithdrawableFromBatchId',
        'create_epoch' => 'setCreateEpoch',
        'create_batch_id' => 'setCreateBatchId',
        'tx_hash' => 'setTxHash',
        'vid' => 'setVid'
    ];
    ...
    protected static $getters = [
        ...
        'amount' => 'getAmount',
        'withdrawable_from_batch_id' => 'getWithdrawableFromBatchId',
        'create_epoch' => 'getCreateEpoch',
        'create_batch_id' => 'getCreateBatchId',
        'tx_hash' => 'getTxHash',
        'vid' => 'getVid'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('withdrawable_from_batch_id', $data ?? [], null);
        $this->setIfExists('create_epoch', $data ?? [], null);
        $this->setIfExists('create_batch_id', $data ?? [], null);
    ...
    */
     ...
     * Sets token_address
     *
     * @param string|null $token_address 
     *
     * @return self
     */
    public function setTokenAddress($token_address)
    {
        if (is_null($token_address)) {
            array_push($this->openAPINullablesSetToNull, 'token_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('token_address', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets withdrawable_from_batch_id
     *
     * @return string|null
     */
    public function getWithdrawableFromBatchId()
    {
        return $this->container['withdrawable_from_batch_id'];
    }

    /**
     * Sets withdrawable_from_batch_id
     *
     * @param string|null $withdrawable_from_batch_id 
     *
     * @return self
     */
    public function setWithdrawableFromBatchId($withdrawable_from_batch_id)
    {
        if (is_null($withdrawable_from_batch_id)) {
            array_push($this->openAPINullablesSetToNull, 'withdrawable_from_batch_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('withdrawable_from_batch_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['withdrawable_from_batch_id'] = $withdrawable_from_batch_id;
    ...
    /**
     * Gets create_batch_id
     *
     * @return string|null
     */
    public function getCreateBatchId()
    {
        return $this->container['create_batch_id'];
    }

    /**
     * Sets create_batch_id
     *
     * @param string|null $create_batch_id 
     *
     * @return self
     */
    public function setCreateBatchId($create_batch_id)
    {
        if (is_null($create_batch_id)) {
            array_push($this->openAPINullablesSetToNull, 'create_batch_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('create_batch_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['create_batch_id'] = $create_batch_id;
