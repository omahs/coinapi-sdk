...
/**
 * DexUserDTO Class Doc Comment
 *
 * @category Class
 * @description User of the protocol. Any ethereum account that deposited tokens or traded.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DexUserDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dex.UserDTO';
    ...
    */
     ...
     * Sets from_batch_id
     *
     * @param string|null $from_batch_id 
     *
     * @return self
     */
