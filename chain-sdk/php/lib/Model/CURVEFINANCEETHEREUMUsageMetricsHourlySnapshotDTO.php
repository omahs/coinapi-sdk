...
/**
 * CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO';
    ...
    */
     ...
     *
     * @param int|null $hourly_active_users Number of unique daily active users
     *
     * @return self
     */
