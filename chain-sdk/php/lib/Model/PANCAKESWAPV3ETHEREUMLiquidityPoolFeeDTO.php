...
/**
 * PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier, format: (fee type)-(pool address)
     *
     * @return self
     */
     ...
     * Sets fee_percentage
     *
     * @param string|null $fee_percentage Fee as a percentage of the trade (swap) amount. Does not always apply
     *
     * @return self
     */
    public function setFeePercentage($fee_percentage)
    {
        if (is_null($fee_percentage)) {
            array_push($this->openAPINullablesSetToNull, 'fee_percentage');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fee_percentage', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
