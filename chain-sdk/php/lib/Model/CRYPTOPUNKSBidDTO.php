...
/**
 * CRYPTOPUNKSBidDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CRYPTOPUNKSBidDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CRYPTOPUNKS.BidDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tokens_bid', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getTokensBid()
    {
        return $this->container['tokens_bid'];
    }

    /**
     * Sets tokens_bid
     *
     * @param string|null $tokens_bid 
     *
     * @return self
     */
    public function setTokensBid($tokens_bid)
    {
        if (is_null($tokens_bid)) {
            array_push($this->openAPINullablesSetToNull, 'tokens_bid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tokens_bid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['tokens_bid'] = $tokens_bid;
    ...
    {
        if (is_null($bidder)) {
            array_push($this->openAPINullablesSetToNull, 'bidder');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bidder', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
