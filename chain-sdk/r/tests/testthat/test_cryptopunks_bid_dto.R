...
context("Test CRYPTOPUNKSBidDTO")

model_instance <- CRYPTOPUNKSBidDTO$new()
...
test_that("tokens_bid", {
  # tests for the property `tokens_bid` (character)
  # 

  # uncomment below to test the property
  #expect_equal(model.instance$`tokens_bid`, "EXPECTED_RESULT")
})
...
test_that("bidder", {
  # tests for the property `bidder` (character)
  # 

  # uncomment below to test the property
  #expect_equal(model.instance$`bidder`, "EXPECTED_RESULT")
})
