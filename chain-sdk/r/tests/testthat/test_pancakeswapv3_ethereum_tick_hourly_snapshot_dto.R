...
context("Test PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO")

model_instance <- PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO$new()
...
test_that("hour_id", {
  # tests for the property `hour_id` (integer)
  # Number of hours since Unix epoch time

  # uncomment below to test the property
  #expect_equal(model.instance$`hour_id`, "EXPECTED_RESULT")
})
