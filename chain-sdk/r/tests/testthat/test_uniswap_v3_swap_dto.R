...
context("Test UniswapV3SwapDTO")

model_instance <- UniswapV3SwapDTO$new()
...
test_that("sqrt_price_x96", {
  # tests for the property `sqrt_price_x96` (NumericsBigInteger)
...
test_that("log_index", {
  # tests for the property `log_index` (NumericsBigInteger)
