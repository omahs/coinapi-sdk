#' Create a new SushiswapLiquidityPositionSnapshotDTO
#'
#' @description
#' This entity is used to store data about a user's liquidity position over time. This information, along with information from the pair itself can be used to provide position sizes, token deposits, and more. It gets created and never updated.
#'
#' @docType class
#' @title SushiswapLiquidityPositionSnapshotDTO
#' @description SushiswapLiquidityPositionSnapshotDTO Class
...
#' @field token_0_price_usd Snapshot of token0 price in USD. character [optional]
#' @field token_1_price_usd Snapshot of token0 price in USD. character [optional]
...
#' @export
SushiswapLiquidityPositionSnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `vid` = NULL,
    #' Initialize a new SushiswapLiquidityPositionSnapshotDTO class.
    #'
    #' @description
    #' Initialize a new SushiswapLiquidityPositionSnapshotDTO class.
    #'
    ...
    #' @param token_0_price_usd Snapshot of token0 price in USD.
    #' @param token_1_price_usd Snapshot of token0 price in USD.
    ...
    #' To JSON String
    #'
    #' @return SushiswapLiquidityPositionSnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      SushiswapLiquidityPositionSnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`liquidity_position`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["liquidity_position"]] <-
          self$`liquidity_position`
      }
      if (!is.null(self$`timestamp`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`block`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["block"]] <-
          self$`block`
      }
      if (!is.null(self$`user`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["user"]] <-
          self$`user`
      }
      if (!is.null(self$`pair`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["pair"]] <-
          self$`pair`
      }
      if (!is.null(self$`token_0_price_usd`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["token_0_price_usd"]] <-
          self$`token_0_price_usd`
      }
      if (!is.null(self$`token_1_price_usd`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["token_1_price_usd"]] <-
          self$`token_1_price_usd`
      }
      if (!is.null(self$`reserve_0`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["reserve_0"]] <-
          self$`reserve_0`
      }
      if (!is.null(self$`reserve_1`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["reserve_1"]] <-
          self$`reserve_1`
      }
      if (!is.null(self$`reserve_usd`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["reserve_usd"]] <-
          self$`reserve_usd`
      }
      if (!is.null(self$`liquidity_token_total_supply`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["liquidity_token_total_supply"]] <-
          self$`liquidity_token_total_supply`
      }
      if (!is.null(self$`liquidity_token_balance`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["liquidity_token_balance"]] <-
          self$`liquidity_token_balance`
      }
      if (!is.null(self$`vid`)) {
        SushiswapLiquidityPositionSnapshotDTOObject[["vid"]] <-
          self$`vid`
      }
      SushiswapLiquidityPositionSnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of SushiswapLiquidityPositionSnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SushiswapLiquidityPositionSnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SushiswapLiquidityPositionSnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to SushiswapLiquidityPositionSnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to SushiswapLiquidityPositionSnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SushiswapLiquidityPositionSnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SushiswapLiquidityPositionSnapshotDTO$lock()
