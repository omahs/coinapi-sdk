#' Create a new UNISWAPV3ETHEREUMPositionDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMPositionDTO
#' @description UNISWAPV3ETHEREUMPositionDTO Class
...
#' @export
UNISWAPV3ETHEREUMPositionDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `deposit_count` = NULL,
    `withdraw_count` = NULL,
    #' Initialize a new UNISWAPV3ETHEREUMPositionDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMPositionDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMPositionDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMPositionDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`account`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`pool`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`hash_opened`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["hash_opened"]] <-
          self$`hash_opened`
      }
      if (!is.null(self$`hash_closed`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["hash_closed"]] <-
          self$`hash_closed`
      }
      if (!is.null(self$`block_number_opened`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["block_number_opened"]] <-
          self$`block_number_opened`
      }
      if (!is.null(self$`timestamp_opened`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["timestamp_opened"]] <-
          self$`timestamp_opened`
      }
      if (!is.null(self$`block_number_closed`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["block_number_closed"]] <-
          self$`block_number_closed`
      }
      if (!is.null(self$`timestamp_closed`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["timestamp_closed"]] <-
          self$`timestamp_closed`
      }
      if (!is.null(self$`tick_lower`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`liquidity_token`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["liquidity_token"]] <-
          self$`liquidity_token`
      }
      if (!is.null(self$`liquidity_token_type`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["liquidity_token_type"]] <-
          self$`liquidity_token_type`
      }
      if (!is.null(self$`liquidity`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`liquidity_usd`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["liquidity_usd"]] <-
          self$`liquidity_usd`
      }
      if (!is.null(self$`cumulative_deposit_token_amounts`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["cumulative_deposit_token_amounts"]] <-
          self$`cumulative_deposit_token_amounts`
      }
      if (!is.null(self$`cumulative_deposit_usd`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["cumulative_deposit_usd"]] <-
          self$`cumulative_deposit_usd`
      }
      if (!is.null(self$`cumulative_withdraw_token_amounts`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["cumulative_withdraw_token_amounts"]] <-
          self$`cumulative_withdraw_token_amounts`
      }
      if (!is.null(self$`cumulative_withdraw_usd`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["cumulative_withdraw_usd"]] <-
          self$`cumulative_withdraw_usd`
      }
      if (!is.null(self$`cumulative_reward_usd`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["cumulative_reward_usd"]] <-
          self$`cumulative_reward_usd`
      }
      if (!is.null(self$`deposit_count`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["deposit_count"]] <-
          self$`deposit_count`
      }
      if (!is.null(self$`withdraw_count`)) {
        UNISWAPV3ETHEREUMPositionDTOObject[["withdraw_count"]] <-
          self$`withdraw_count`
      }
      UNISWAPV3ETHEREUMPositionDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMPositionDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMPositionDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMPositionDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMPositionDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMPositionDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMPositionDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMPositionDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMPositionDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMPositionDTO$lock()
