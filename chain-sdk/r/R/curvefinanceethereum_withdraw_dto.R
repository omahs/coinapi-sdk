#' Create a new CURVEFINANCEETHEREUMWithdrawDTO
#'
#' @description
#' Remove liquidity events.
#'
#' @docType class
#' @title CURVEFINANCEETHEREUMWithdrawDTO
#' @description CURVEFINANCEETHEREUMWithdrawDTO Class
...
#' @export
CURVEFINANCEETHEREUMWithdrawDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `amount_usd` = NULL,
    `pool` = NULL,
    #' Initialize a new CURVEFINANCEETHEREUMWithdrawDTO class.
    #'
    #' @description
    #' Initialize a new CURVEFINANCEETHEREUMWithdrawDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return CURVEFINANCEETHEREUMWithdrawDTO in JSON format
    #' @export
    toJSON = function() {
      CURVEFINANCEETHEREUMWithdrawDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_range`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["block_range"]] <-
          self$`block_range`
      }
      if (!is.null(self$`id`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`log_index`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`protocol`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`to`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["to"]] <-
          self$`to`
      }
      if (!is.null(self$`from`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["from"]] <-
          self$`from`
      }
      if (!is.null(self$`timestamp`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`input_tokens`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`output_token`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["output_token"]] <-
          self$`output_token`
      }
      if (!is.null(self$`input_token_amounts`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["input_token_amounts"]] <-
          self$`input_token_amounts`
      }
      if (!is.null(self$`output_token_amount`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["output_token_amount"]] <-
          self$`output_token_amount`
      }
      if (!is.null(self$`amount_usd`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`pool`)) {
        CURVEFINANCEETHEREUMWithdrawDTOObject[["pool"]] <-
          self$`pool`
      }
      CURVEFINANCEETHEREUMWithdrawDTOObject
    },
    #' Deserialize JSON string into an instance of CURVEFINANCEETHEREUMWithdrawDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of CURVEFINANCEETHEREUMWithdrawDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of CURVEFINANCEETHEREUMWithdrawDTO
    #' @export
    ...
    #' Validate JSON input with respect to CURVEFINANCEETHEREUMWithdrawDTO
    #'
    #' @description
    #' Validate JSON input with respect to CURVEFINANCEETHEREUMWithdrawDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of CURVEFINANCEETHEREUMWithdrawDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# CURVEFINANCEETHEREUMWithdrawDTO$unlock()
#
## Below is an example to define the print function
# CURVEFINANCEETHEREUMWithdrawDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CURVEFINANCEETHEREUMWithdrawDTO$lock()
