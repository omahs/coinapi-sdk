#' Create a new PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
#' @description PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO Class
#' @format An \code{R6Class} generator object
#' @field entry_time  character [optional]
#' @field recv_time  character [optional]
#' @field block_number Number of block in which entity was recorded. integer [optional]
#' @field vid  integer [optional]
#' @field id (pool address)-(tick index)-(hour ID) character [optional]
#' @field hour_id Number of hours since Unix epoch time integer [optional]
...
#' @export
PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO class.
    #'
    ...
    #' @param hour_id Number of hours since Unix epoch time
    ...
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `vid` = NULL, `id` = NULL, `hour_id` = NULL, `tick` = NULL, `pool` = NULL, `liquidity_gross` = NULL, `liquidity_gross_usd` = NULL, `liquidity_net` = NULL, `liquidity_net_usd` = NULL, `timestamp` = NULL, ...) {
      ...
      if (!is.null(`hour_id`)) {
        if (!(is.numeric(`hour_id`) && length(`hour_id`) == 1)) {
          stop(paste("Error! Invalid data for `hour_id`. Must be an integer:", `hour_id`))
        }
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hour_id`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["hour_id"]] <-
          self$`hour_id`
      }
      if (!is.null(self$`tick`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`pool`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity_gross`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`
      }
      if (!is.null(self$`liquidity_gross_usd`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_gross_usd"]] <-
          self$`liquidity_gross_usd`
      }
      if (!is.null(self$`liquidity_net`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_net"]] <-
          self$`liquidity_net`
      }
      if (!is.null(self$`liquidity_net_usd`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_net_usd"]] <-
          self$`liquidity_net_usd`
      }
      if (!is.null(self$`timestamp`)) {
        PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`hour_id`)) {
        self$`hour_id` <- this_object$`hour_id`
      }
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO$lock()
