#' Create a new PANCAKESWAPV3ETHEREUMTokenDTO
#'
#' @description
#' Stores aggregated information for a specific token across all pairs that token is included in.
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMTokenDTO
#' @description PANCAKESWAPV3ETHEREUMTokenDTO Class
...
#' @export
PANCAKESWAPV3ETHEREUMTokenDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `token_symbol` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMTokenDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMTokenDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMTokenDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMTokenDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`block_range`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["block_range"]] <-
          self$`block_range`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`symbol`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`decimals`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["decimals"]] <-
          self$`decimals`
      }
      if (!is.null(self$`last_price_usd`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["last_price_usd"]] <-
          self$`last_price_usd`
      }
      if (!is.null(self$`last_price_block_number`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["last_price_block_number"]] <-
          self$`last_price_block_number`
      }
      if (!is.null(self$`last_price_pool`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["last_price_pool"]] <-
          self$`last_price_pool`
      }
      if (!is.null(self$`total_supply`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["total_supply"]] <-
          self$`total_supply`
      }
      if (!is.null(self$`total_value_locked_usd`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["total_value_locked_usd"]] <-
          self$`total_value_locked_usd`
      }
      if (!is.null(self$`large_price_change_buffer`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["large_price_change_buffer"]] <-
          self$`large_price_change_buffer`
      }
      if (!is.null(self$`large_tvl_impact_buffer`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["large_tvl_impact_buffer"]] <-
          self$`large_tvl_impact_buffer`
      }
      if (!is.null(self$`token_symbol`)) {
        PANCAKESWAPV3ETHEREUMTokenDTOObject[["token_symbol"]] <-
          self$`token_symbol`
      }
      PANCAKESWAPV3ETHEREUMTokenDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMTokenDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMTokenDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMTokenDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMTokenDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMTokenDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMTokenDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMTokenDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMTokenDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMTokenDTO$lock()
