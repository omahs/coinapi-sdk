#' Create a new UNISWAPV3ETHEREUMTokenDTO
#'
#' @description
#' Stores aggregated information for a specific token across all pairs that token is included in.
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMTokenDTO
#' @description UNISWAPV3ETHEREUMTokenDTO Class
...
#' @export
UNISWAPV3ETHEREUMTokenDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `token_symbol` = NULL,
    #' Initialize a new UNISWAPV3ETHEREUMTokenDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMTokenDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMTokenDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMTokenDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`block_range`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["block_range"]] <-
          self$`block_range`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`symbol`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`decimals`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["decimals"]] <-
          self$`decimals`
      }
      if (!is.null(self$`last_price_usd`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["last_price_usd"]] <-
          self$`last_price_usd`
      }
      if (!is.null(self$`last_price_block_number`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["last_price_block_number"]] <-
          self$`last_price_block_number`
      }
      if (!is.null(self$`last_price_pool`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["last_price_pool"]] <-
          self$`last_price_pool`
      }
      if (!is.null(self$`total_supply`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["total_supply"]] <-
          self$`total_supply`
      }
      if (!is.null(self$`total_value_locked_usd`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["total_value_locked_usd"]] <-
          self$`total_value_locked_usd`
      }
      if (!is.null(self$`large_price_change_buffer`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["large_price_change_buffer"]] <-
          self$`large_price_change_buffer`
      }
      if (!is.null(self$`large_tvl_impact_buffer`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["large_tvl_impact_buffer"]] <-
          self$`large_tvl_impact_buffer`
      }
      if (!is.null(self$`token_symbol`)) {
        UNISWAPV3ETHEREUMTokenDTOObject[["token_symbol"]] <-
          self$`token_symbol`
      }
      UNISWAPV3ETHEREUMTokenDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMTokenDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMTokenDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMTokenDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMTokenDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMTokenDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMTokenDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMTokenDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMTokenDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMTokenDTO$lock()
