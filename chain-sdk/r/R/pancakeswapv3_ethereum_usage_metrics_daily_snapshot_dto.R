#' Create a new PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
#' @description PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO Class
...
#' @export
PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`day`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["day"]] <-
          self$`day`
      }
      if (!is.null(self$`protocol`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`daily_active_users`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_active_users"]] <-
          self$`daily_active_users`
      }
      if (!is.null(self$`cumulative_unique_users`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["cumulative_unique_users"]] <-
          self$`cumulative_unique_users`
      }
      if (!is.null(self$`daily_transaction_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_transaction_count"]] <-
          self$`daily_transaction_count`
      }
      if (!is.null(self$`total_pool_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["total_pool_count"]] <-
          self$`total_pool_count`
      }
      if (!is.null(self$`daily_deposit_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_deposit_count"]] <-
          self$`daily_deposit_count`
      }
      if (!is.null(self$`daily_withdraw_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_withdraw_count"]] <-
          self$`daily_withdraw_count`
      }
      if (!is.null(self$`daily_swap_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_swap_count"]] <-
          self$`daily_swap_count`
      }
      if (!is.null(self$`timestamp`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO$lock()
