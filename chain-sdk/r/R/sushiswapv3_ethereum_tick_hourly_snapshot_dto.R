#' Create a new SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
#' @description SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hour_id`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["hour_id"]] <-
          self$`hour_id`
      }
      if (!is.null(self$`tick`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`pool`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity_gross`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`
      }
      if (!is.null(self$`liquidity_gross_usd`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_gross_usd"]] <-
          self$`liquidity_gross_usd`
      }
      if (!is.null(self$`liquidity_net`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_net"]] <-
          self$`liquidity_net`
      }
      if (!is.null(self$`liquidity_net_usd`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_net_usd"]] <-
          self$`liquidity_net_usd`
      }
      if (!is.null(self$`timestamp`)) {
        SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO$lock()
