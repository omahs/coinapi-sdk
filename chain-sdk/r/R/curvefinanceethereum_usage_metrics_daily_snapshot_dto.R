#' Create a new CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
#' @description CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO Class
...
#' @export
CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO class.
    #'
    ...
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `id` = NULL, `protocol` = NULL, `daily_active_users` = NULL, `cumulative_unique_users` = NULL, `daily_transaction_count` = NULL, `daily_deposit_count` = NULL, `daily_withdraw_count` = NULL, `daily_swap_count` = NULL, `total_pool_count` = NULL, `timestamp` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`protocol`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`daily_active_users`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_active_users"]] <-
          self$`daily_active_users`
      }
      if (!is.null(self$`cumulative_unique_users`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["cumulative_unique_users"]] <-
          self$`cumulative_unique_users`
      }
      if (!is.null(self$`daily_transaction_count`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_transaction_count"]] <-
          self$`daily_transaction_count`
      }
      if (!is.null(self$`daily_deposit_count`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_deposit_count"]] <-
          self$`daily_deposit_count`
      }
      if (!is.null(self$`daily_withdraw_count`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_withdraw_count"]] <-
          self$`daily_withdraw_count`
      }
      if (!is.null(self$`daily_swap_count`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_swap_count"]] <-
          self$`daily_swap_count`
      }
      if (!is.null(self$`total_pool_count`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["total_pool_count"]] <-
          self$`total_pool_count`
      }
      if (!is.null(self$`timestamp`)) {
        CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO$unlock()
#
## Below is an example to define the print function
# CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO$lock()
