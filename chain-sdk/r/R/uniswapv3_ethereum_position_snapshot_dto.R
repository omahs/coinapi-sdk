#' Create a new UNISWAPV3ETHEREUMPositionSnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMPositionSnapshotDTO
#' @description UNISWAPV3ETHEREUMPositionSnapshotDTO Class
...
#' @export
UNISWAPV3ETHEREUMPositionSnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `withdraw_count` = NULL,
    `timestamp` = NULL,
    #' Initialize a new UNISWAPV3ETHEREUMPositionSnapshotDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMPositionSnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMPositionSnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMPositionSnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`log_index`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`nonce`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`position`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`liquidity_token_type`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["liquidity_token_type"]] <-
          self$`liquidity_token_type`
      }
      if (!is.null(self$`liquidity`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`liquidity_usd`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["liquidity_usd"]] <-
          self$`liquidity_usd`
      }
      if (!is.null(self$`cumulative_deposit_token_amounts`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_deposit_token_amounts"]] <-
          self$`cumulative_deposit_token_amounts`
      }
      if (!is.null(self$`cumulative_deposit_usd`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_deposit_usd"]] <-
          self$`cumulative_deposit_usd`
      }
      if (!is.null(self$`cumulative_withdraw_token_amounts`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_withdraw_token_amounts"]] <-
          self$`cumulative_withdraw_token_amounts`
      }
      if (!is.null(self$`cumulative_withdraw_usd`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_withdraw_usd"]] <-
          self$`cumulative_withdraw_usd`
      }
      if (!is.null(self$`cumulative_reward_token_amounts`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_reward_token_amounts"]] <-
          self$`cumulative_reward_token_amounts`
      }
      if (!is.null(self$`cumulative_reward_usd`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_reward_usd"]] <-
          self$`cumulative_reward_usd`
      }
      if (!is.null(self$`deposit_count`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["deposit_count"]] <-
          self$`deposit_count`
      }
      if (!is.null(self$`withdraw_count`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["withdraw_count"]] <-
          self$`withdraw_count`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV3ETHEREUMPositionSnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      UNISWAPV3ETHEREUMPositionSnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMPositionSnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMPositionSnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMPositionSnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMPositionSnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMPositionSnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMPositionSnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMPositionSnapshotDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMPositionSnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMPositionSnapshotDTO$lock()
