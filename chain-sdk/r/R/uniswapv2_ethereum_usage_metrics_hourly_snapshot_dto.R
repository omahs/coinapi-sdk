#' Create a new UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
#' @description UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO Class
...
#' @export
UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_range`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["block_range"]] <-
          self$`block_range`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`protocol`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`hourly_active_users`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_active_users"]] <-
          self$`hourly_active_users`
      }
      if (!is.null(self$`cumulative_unique_users`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["cumulative_unique_users"]] <-
          self$`cumulative_unique_users`
      }
      if (!is.null(self$`hourly_transaction_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_transaction_count"]] <-
          self$`hourly_transaction_count`
      }
      if (!is.null(self$`hourly_deposit_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_deposit_count"]] <-
          self$`hourly_deposit_count`
      }
      if (!is.null(self$`hourly_withdraw_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_withdraw_count"]] <-
          self$`hourly_withdraw_count`
      }
      if (!is.null(self$`hourly_swap_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_swap_count"]] <-
          self$`hourly_swap_count`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO$lock()
