#' Create a new UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
#' @description UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO Class
...
#' @export
UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hour`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hour"]] <-
          self$`hour`
      }
      if (!is.null(self$`protocol`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`hourly_active_users`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_active_users"]] <-
          self$`hourly_active_users`
      }
      if (!is.null(self$`cumulative_unique_users`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["cumulative_unique_users"]] <-
          self$`cumulative_unique_users`
      }
      if (!is.null(self$`hourly_transaction_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_transaction_count"]] <-
          self$`hourly_transaction_count`
      }
      if (!is.null(self$`hourly_deposit_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_deposit_count"]] <-
          self$`hourly_deposit_count`
      }
      if (!is.null(self$`hourly_withdraw_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_withdraw_count"]] <-
          self$`hourly_withdraw_count`
      }
      if (!is.null(self$`hourly_swap_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_swap_count"]] <-
          self$`hourly_swap_count`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO$lock()
