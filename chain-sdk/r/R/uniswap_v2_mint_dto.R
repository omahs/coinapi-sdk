...
#'
#' @docType class
#' @title UniswapV2MintDTO
#' @description UniswapV2MintDTO Class
#' @format An \code{R6Class} generator object
#' @field entry_time  character [optional]
#' @field recv_time  character [optional]
#' @field block_number Number of block in which entity was recorded. integer [optional]
#' @field id Transaction hash plus index in the transaction mint array. character [optional]
...
#' @field to Recipient of liquidity tokens. character [optional]
#' @field liquidity Amount of liquidity tokens minted. character [optional]
#' @field sender Address that initiated the liquidity provision. character [optional]
#' @field amount_0 Amount of token0 provided. character [optional]
#' @field amount_1 Amount of token1 provided. character [optional]
...
#' @field fee_liquidity Amount of liquidity sent to fee recipient (if fee is on). character [optional]
#' @field vid  integer [optional]
#' @field block_range  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
UniswapV2MintDTO <- R6::R6Class(
  "UniswapV2MintDTO",
  public = list(
    `entry_time` = NULL,
    `recv_time` = NULL,
    ...
    `vid` = NULL,
    `block_range` = NULL,
    #' Initialize a new UniswapV2MintDTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2MintDTO class.
    #'
    ...
    #' @param amount_0 Amount of token0 provided.
    #' @param amount_1 Amount of token1 provided.
    ...
    #' @param fee_liquidity Amount of liquidity sent to fee recipient (if fee is on).
    #' @param vid 
    #' @param block_range 
    #' @param ... Other optional arguments.
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `id` = NULL, `transaction` = NULL, `timestamp` = NULL, `pair` = NULL, `to` = NULL, `liquidity` = NULL, `sender` = NULL, `amount_0` = NULL, `amount_1` = NULL, `log_index` = NULL, `amount_usd` = NULL, `fee_to` = NULL, `fee_liquidity` = NULL, `vid` = NULL, `block_range` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return UniswapV2MintDTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2MintDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2MintDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2MintDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2MintDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV2MintDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`transaction`)) {
        UniswapV2MintDTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`timestamp`)) {
        UniswapV2MintDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`pair`)) {
        UniswapV2MintDTOObject[["pair"]] <-
          self$`pair`
      }
      if (!is.null(self$`to`)) {
        UniswapV2MintDTOObject[["to"]] <-
          self$`to`
      }
      if (!is.null(self$`liquidity`)) {
        UniswapV2MintDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`sender`)) {
        UniswapV2MintDTOObject[["sender"]] <-
          self$`sender`
      }
      if (!is.null(self$`amount_0`)) {
        UniswapV2MintDTOObject[["amount_0"]] <-
          self$`amount_0`
      }
      if (!is.null(self$`amount_1`)) {
        UniswapV2MintDTOObject[["amount_1"]] <-
          self$`amount_1`
      }
      if (!is.null(self$`log_index`)) {
        UniswapV2MintDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`amount_usd`)) {
        UniswapV2MintDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`fee_to`)) {
        UniswapV2MintDTOObject[["fee_to"]] <-
          self$`fee_to`
      }
      if (!is.null(self$`fee_liquidity`)) {
        UniswapV2MintDTOObject[["fee_liquidity"]] <-
          self$`fee_liquidity`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2MintDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`block_range`)) {
        UniswapV2MintDTOObject[["block_range"]] <-
          self$`block_range`
      }
      UniswapV2MintDTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2MintDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2MintDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2MintDTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2MintDTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2MintDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2MintDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2MintDTO$unlock()
#
## Below is an example to define the print function
# UniswapV2MintDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2MintDTO$lock()
