#' Create a new UNISWAPV3ETHEREUMTickHourlySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMTickHourlySnapshotDTO
#' @description UNISWAPV3ETHEREUMTickHourlySnapshotDTO Class
...
#' @export
UNISWAPV3ETHEREUMTickHourlySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new UNISWAPV3ETHEREUMTickHourlySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMTickHourlySnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMTickHourlySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hour_id`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["hour_id"]] <-
          self$`hour_id`
      }
      if (!is.null(self$`tick`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`pool`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity_gross`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`
      }
      if (!is.null(self$`liquidity_gross_usd`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_gross_usd"]] <-
          self$`liquidity_gross_usd`
      }
      if (!is.null(self$`liquidity_net`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_net"]] <-
          self$`liquidity_net`
      }
      if (!is.null(self$`liquidity_net_usd`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["liquidity_net_usd"]] <-
          self$`liquidity_net_usd`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      UNISWAPV3ETHEREUMTickHourlySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMTickHourlySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMTickHourlySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMTickHourlySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMTickHourlySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMTickHourlySnapshotDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMTickHourlySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMTickHourlySnapshotDTO$lock()
