#' Create a new UNISWAPV3ETHEREUMTickDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMTickDTO
#' @description UNISWAPV3ETHEREUMTickDTO Class
...
#' @export
UNISWAPV3ETHEREUMTickDTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new UNISWAPV3ETHEREUMTickDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMTickDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMTickDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMTickDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`index`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["index"]] <-
          self$`index`
      }
      if (!is.null(self$`pool`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`created_timestamp`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["created_timestamp"]] <-
          self$`created_timestamp`
      }
      if (!is.null(self$`created_block_number`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["created_block_number"]] <-
          self$`created_block_number`
      }
      if (!is.null(self$`prices`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["prices"]] <-
          self$`prices`
      }
      if (!is.null(self$`liquidity_gross`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`
      }
      if (!is.null(self$`liquidity_gross_usd`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["liquidity_gross_usd"]] <-
          self$`liquidity_gross_usd`
      }
      if (!is.null(self$`liquidity_net`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["liquidity_net"]] <-
          self$`liquidity_net`
      }
      if (!is.null(self$`liquidity_net_usd`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["liquidity_net_usd"]] <-
          self$`liquidity_net_usd`
      }
      if (!is.null(self$`last_snapshot_day_id`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["last_snapshot_day_id"]] <-
          self$`last_snapshot_day_id`
      }
      if (!is.null(self$`last_snapshot_hour_id`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["last_snapshot_hour_id"]] <-
          self$`last_snapshot_hour_id`
      }
      if (!is.null(self$`last_update_timestamp`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["last_update_timestamp"]] <-
          self$`last_update_timestamp`
      }
      if (!is.null(self$`last_update_block_number`)) {
        UNISWAPV3ETHEREUMTickDTOObject[["last_update_block_number"]] <-
          self$`last_update_block_number`
      }
      UNISWAPV3ETHEREUMTickDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMTickDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMTickDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMTickDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMTickDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMTickDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMTickDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMTickDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMTickDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMTickDTO$lock()
