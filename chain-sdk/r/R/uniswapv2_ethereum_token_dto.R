#' Create a new UNISWAPV2ETHEREUMTokenDTO
#'
#' @description
#' Stores aggregated information for a specific token across all pairs that token is included in.
#'
#' @docType class
#' @title UNISWAPV2ETHEREUMTokenDTO
#' @description UNISWAPV2ETHEREUMTokenDTO Class
...
#' @field large_price_change_buffer Buffer for large price changes integer [optional]
#' @field large_tvl_impact_buffer Buffer for large TVL impacts integer [optional]
#' @field token_symbol  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
UNISWAPV2ETHEREUMTokenDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `token_symbol` = NULL,
    #' Initialize a new UNISWAPV2ETHEREUMTokenDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV2ETHEREUMTokenDTO class.
    #'
    ...
    #' @param large_price_change_buffer Buffer for large price changes
    #' @param large_tvl_impact_buffer Buffer for large TVL impacts
    #' @param token_symbol token_symbol
    #' @param ... Other optional arguments.
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `vid` = NULL, `id` = NULL, `name` = NULL, `symbol` = NULL, `decimals` = NULL, `last_price_usd` = NULL, `last_price_block_number` = NULL, `total_supply` = NULL, `total_value_locked_usd` = NULL, `large_price_change_buffer` = NULL, `large_tvl_impact_buffer` = NULL, `token_symbol` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV2ETHEREUMTokenDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV2ETHEREUMTokenDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`symbol`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`decimals`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["decimals"]] <-
          self$`decimals`
      }
      if (!is.null(self$`last_price_usd`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["last_price_usd"]] <-
          self$`last_price_usd`
      }
      if (!is.null(self$`last_price_block_number`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["last_price_block_number"]] <-
          self$`last_price_block_number`
      }
      if (!is.null(self$`total_supply`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["total_supply"]] <-
          self$`total_supply`
      }
      if (!is.null(self$`total_value_locked_usd`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["total_value_locked_usd"]] <-
          self$`total_value_locked_usd`
      }
      if (!is.null(self$`large_price_change_buffer`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["large_price_change_buffer"]] <-
          self$`large_price_change_buffer`
      }
      if (!is.null(self$`large_tvl_impact_buffer`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["large_tvl_impact_buffer"]] <-
          self$`large_tvl_impact_buffer`
      }
      if (!is.null(self$`token_symbol`)) {
        UNISWAPV2ETHEREUMTokenDTOObject[["token_symbol"]] <-
          self$`token_symbol`
      }
      UNISWAPV2ETHEREUMTokenDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMTokenDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMTokenDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV2ETHEREUMTokenDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMTokenDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMTokenDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV2ETHEREUMTokenDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV2ETHEREUMTokenDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV2ETHEREUMTokenDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV2ETHEREUMTokenDTO$lock()
