#' Create a new SushiswapPairDayDataDTO
#'
#' @description
#' Tracks pair data across each day.
#'
#' @docType class
#' @title SushiswapPairDayDataDTO
#' @description SushiswapPairDayDataDTO Class
...
#' @field volume_token_0 Total amount of token0 swapped throughout day. character [optional]
#' @field volume_token_1 Total amount of token1 swapped throughout day. character [optional]
#' @field volume_usd Total volume within pair throughout day. character [optional]
#' @field tx_count Amount of transactions on pair throughout day. character [optional]
#' @field vid  integer [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
SushiswapPairDayDataDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `tx_count` = NULL,
    `vid` = NULL,
    #' Initialize a new SushiswapPairDayDataDTO class.
    #'
    #' @description
    #' Initialize a new SushiswapPairDayDataDTO class.
    #'
    ...
    #' @param volume_token_0 Total amount of token0 swapped throughout day.
    #' @param volume_token_1 Total amount of token1 swapped throughout day.
    #' @param volume_usd Total volume within pair throughout day.
    #' @param tx_count Amount of transactions on pair throughout day.
    #' @param vid 
    #' @param ... Other optional arguments.
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `id` = NULL, `date` = NULL, `pair` = NULL, `token_0` = NULL, `token_1` = NULL, `reserve_0` = NULL, `reserve_1` = NULL, `total_supply` = NULL, `reserve_usd` = NULL, `volume_token_0` = NULL, `volume_token_1` = NULL, `volume_usd` = NULL, `tx_count` = NULL, `vid` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return SushiswapPairDayDataDTO in JSON format
    #' @export
    toJSON = function() {
      SushiswapPairDayDataDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SushiswapPairDayDataDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SushiswapPairDayDataDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SushiswapPairDayDataDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SushiswapPairDayDataDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`date`)) {
        SushiswapPairDayDataDTOObject[["date"]] <-
          self$`date`
      }
      if (!is.null(self$`pair`)) {
        SushiswapPairDayDataDTOObject[["pair"]] <-
          self$`pair`
      }
      if (!is.null(self$`token_0`)) {
        SushiswapPairDayDataDTOObject[["token_0"]] <-
          self$`token_0`
      }
      if (!is.null(self$`token_1`)) {
        SushiswapPairDayDataDTOObject[["token_1"]] <-
          self$`token_1`
      }
      if (!is.null(self$`reserve_0`)) {
        SushiswapPairDayDataDTOObject[["reserve_0"]] <-
          self$`reserve_0`
      }
      if (!is.null(self$`reserve_1`)) {
        SushiswapPairDayDataDTOObject[["reserve_1"]] <-
          self$`reserve_1`
      }
      if (!is.null(self$`total_supply`)) {
        SushiswapPairDayDataDTOObject[["total_supply"]] <-
          self$`total_supply`
      }
      if (!is.null(self$`reserve_usd`)) {
        SushiswapPairDayDataDTOObject[["reserve_usd"]] <-
          self$`reserve_usd`
      }
      if (!is.null(self$`volume_token_0`)) {
        SushiswapPairDayDataDTOObject[["volume_token_0"]] <-
          self$`volume_token_0`
      }
      if (!is.null(self$`volume_token_1`)) {
        SushiswapPairDayDataDTOObject[["volume_token_1"]] <-
          self$`volume_token_1`
      }
      if (!is.null(self$`volume_usd`)) {
        SushiswapPairDayDataDTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`tx_count`)) {
        SushiswapPairDayDataDTOObject[["tx_count"]] <-
          self$`tx_count`
      }
      if (!is.null(self$`vid`)) {
        SushiswapPairDayDataDTOObject[["vid"]] <-
          self$`vid`
      }
      SushiswapPairDayDataDTOObject
    },
    #' Deserialize JSON string into an instance of SushiswapPairDayDataDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SushiswapPairDayDataDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SushiswapPairDayDataDTO
    #' @export
    ...
    #' Validate JSON input with respect to SushiswapPairDayDataDTO
    #'
    #' @description
    #' Validate JSON input with respect to SushiswapPairDayDataDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SushiswapPairDayDataDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SushiswapPairDayDataDTO$unlock()
#
## Below is an example to define the print function
# SushiswapPairDayDataDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SushiswapPairDayDataDTO$lock()
