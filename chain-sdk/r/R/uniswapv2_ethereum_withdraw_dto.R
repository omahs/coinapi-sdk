#' Create a new UNISWAPV2ETHEREUMWithdrawDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV2ETHEREUMWithdrawDTO
#' @description UNISWAPV2ETHEREUMWithdrawDTO Class
#' @format An \code{R6Class} generator object
#' @field entry_time  character [optional]
#' @field recv_time  character [optional]
#' @field block_number Number of block in which entity was recorded. integer [optional]
#' @field block_  integer [optional]
#' @field id Withdraw-(transaction hash)-(log index) character [optional]
...
#' @field output_token Output token of the pool (not output token of the event/transaction). E.g. the UNI-LP token character [optional]
...
#' @export
UNISWAPV2ETHEREUMWithdrawDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `pool` = NULL,
    `block_range` = NULL,
    #' Initialize a new UNISWAPV2ETHEREUMWithdrawDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV2ETHEREUMWithdrawDTO class.
    #'
    ...
    #' @param output_token Output token of the pool (not output token of the event/transaction). E.g. the UNI-LP token
    ...
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `block_` = NULL, `id` = NULL, `hash` = NULL, `log_index` = NULL, `protocol` = NULL, `to` = NULL, `from` = NULL, `timestamp` = NULL, `input_tokens` = NULL, `output_token` = NULL, `input_token_amounts` = NULL, `output_token_amount` = NULL, `reserve_amounts` = NULL, `amount_usd` = NULL, `pool` = NULL, `block_range` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV2ETHEREUMWithdrawDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV2ETHEREUMWithdrawDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["block_"]] <-
          self$`block_`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`log_index`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`protocol`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`to`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["to"]] <-
          self$`to`
      }
      if (!is.null(self$`from`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["from"]] <-
          self$`from`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`input_tokens`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`output_token`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["output_token"]] <-
          self$`output_token`
      }
      if (!is.null(self$`input_token_amounts`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["input_token_amounts"]] <-
          self$`input_token_amounts`
      }
      if (!is.null(self$`output_token_amount`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["output_token_amount"]] <-
          self$`output_token_amount`
      }
      if (!is.null(self$`reserve_amounts`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`amount_usd`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`pool`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`block_range`)) {
        UNISWAPV2ETHEREUMWithdrawDTOObject[["block_range"]] <-
          self$`block_range`
      }
      UNISWAPV2ETHEREUMWithdrawDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMWithdrawDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMWithdrawDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV2ETHEREUMWithdrawDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMWithdrawDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMWithdrawDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV2ETHEREUMWithdrawDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV2ETHEREUMWithdrawDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV2ETHEREUMWithdrawDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV2ETHEREUMWithdrawDTO$lock()
