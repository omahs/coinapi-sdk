#' Create a new UniswapV3PoolHourDataDTO
#'
#' @description
#' Hourly stats tracker for pool.
#'
#' @docType class
#' @title UniswapV3PoolHourDataDTO
#' @description UniswapV3PoolHourDataDTO Class
...
#' @export
UniswapV3PoolHourDataDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `close` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV3PoolHourDataDTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3PoolHourDataDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3PoolHourDataDTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3PoolHourDataDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3PoolHourDataDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3PoolHourDataDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3PoolHourDataDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV3PoolHourDataDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`period_start_unix`)) {
        UniswapV3PoolHourDataDTOObject[["period_start_unix"]] <-
          self$`period_start_unix`
      }
      if (!is.null(self$`pool`)) {
        UniswapV3PoolHourDataDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity`)) {
        UniswapV3PoolHourDataDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`sqrt_price`)) {
        UniswapV3PoolHourDataDTOObject[["sqrt_price"]] <-
          self$`sqrt_price`
      }
      if (!is.null(self$`token_0_price`)) {
        UniswapV3PoolHourDataDTOObject[["token_0_price"]] <-
          self$`token_0_price`
      }
      if (!is.null(self$`token_1_price`)) {
        UniswapV3PoolHourDataDTOObject[["token_1_price"]] <-
          self$`token_1_price`
      }
      if (!is.null(self$`tick`)) {
        UniswapV3PoolHourDataDTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`fee_growth_global_0x128`)) {
        UniswapV3PoolHourDataDTOObject[["fee_growth_global_0x128"]] <-
          self$`fee_growth_global_0x128`
      }
      if (!is.null(self$`fee_growth_global_1x128`)) {
        UniswapV3PoolHourDataDTOObject[["fee_growth_global_1x128"]] <-
          self$`fee_growth_global_1x128`
      }
      if (!is.null(self$`tvl_usd`)) {
        UniswapV3PoolHourDataDTOObject[["tvl_usd"]] <-
          self$`tvl_usd`
      }
      if (!is.null(self$`volume_token_0`)) {
        UniswapV3PoolHourDataDTOObject[["volume_token_0"]] <-
          self$`volume_token_0`
      }
      if (!is.null(self$`volume_token_1`)) {
        UniswapV3PoolHourDataDTOObject[["volume_token_1"]] <-
          self$`volume_token_1`
      }
      if (!is.null(self$`volume_usd`)) {
        UniswapV3PoolHourDataDTOObject[["volume_usd"]] <-
          self$`volume_usd`
      }
      if (!is.null(self$`fees_usd`)) {
        UniswapV3PoolHourDataDTOObject[["fees_usd"]] <-
          self$`fees_usd`
      }
      if (!is.null(self$`tx_count`)) {
        UniswapV3PoolHourDataDTOObject[["tx_count"]] <-
          self$`tx_count`
      }
      if (!is.null(self$`open`)) {
        UniswapV3PoolHourDataDTOObject[["open"]] <-
          self$`open`
      }
      if (!is.null(self$`high`)) {
        UniswapV3PoolHourDataDTOObject[["high"]] <-
          self$`high`
      }
      if (!is.null(self$`low`)) {
        UniswapV3PoolHourDataDTOObject[["low"]] <-
          self$`low`
      }
      if (!is.null(self$`close`)) {
        UniswapV3PoolHourDataDTOObject[["close"]] <-
          self$`close`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3PoolHourDataDTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV3PoolHourDataDTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3PoolHourDataDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3PoolHourDataDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3PoolHourDataDTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3PoolHourDataDTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3PoolHourDataDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3PoolHourDataDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
