#' Create a new SUSHISWAPV3ETHEREUMWithdrawDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMWithdrawDTO
#' @description SUSHISWAPV3ETHEREUMWithdrawDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMWithdrawDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `amount_usd` = NULL,
    #' Initialize a new SUSHISWAPV3ETHEREUMWithdrawDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMWithdrawDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMWithdrawDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMWithdrawDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`nonce`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`log_index`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`gas_limit`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["gas_limit"]] <-
          self$`gas_limit`
      }
      if (!is.null(self$`gas_used`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["gas_used"]] <-
          self$`gas_used`
      }
      if (!is.null(self$`gas_price`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["gas_price"]] <-
          self$`gas_price`
      }
      if (!is.null(self$`protocol`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`account`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`position`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`tick_lower`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`pool`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`timestamp`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`liquidity`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`input_tokens`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`input_token_amounts`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["input_token_amounts"]] <-
          self$`input_token_amounts`
      }
      if (!is.null(self$`reserve_amounts`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`amount_usd`)) {
        SUSHISWAPV3ETHEREUMWithdrawDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      SUSHISWAPV3ETHEREUMWithdrawDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMWithdrawDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMWithdrawDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMWithdrawDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMWithdrawDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMWithdrawDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMWithdrawDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMWithdrawDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMWithdrawDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMWithdrawDTO$lock()
