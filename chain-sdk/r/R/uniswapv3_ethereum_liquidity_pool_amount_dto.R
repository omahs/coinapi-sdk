#' Create a new UNISWAPV3ETHEREUMLiquidityPoolAmountDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMLiquidityPoolAmountDTO
#' @description UNISWAPV3ETHEREUMLiquidityPoolAmountDTO Class
...
#' @export
UNISWAPV3ETHEREUMLiquidityPoolAmountDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `token_prices` = NULL,
    #' Initialize a new UNISWAPV3ETHEREUMLiquidityPoolAmountDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMLiquidityPoolAmountDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMLiquidityPoolAmountDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMLiquidityPoolAmountDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      ...
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`input_tokens`)) {
        UNISWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`input_token_balances`)) {
        UNISWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["input_token_balances"]] <-
          self$`input_token_balances`
      }
      if (!is.null(self$`token_prices`)) {
        UNISWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["token_prices"]] <-
          self$`token_prices`
      }
      UNISWAPV3ETHEREUMLiquidityPoolAmountDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMLiquidityPoolAmountDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMLiquidityPoolAmountDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMLiquidityPoolAmountDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMLiquidityPoolAmountDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMLiquidityPoolAmountDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMLiquidityPoolAmountDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMLiquidityPoolAmountDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMLiquidityPoolAmountDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMLiquidityPoolAmountDTO$lock()
