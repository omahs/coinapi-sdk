#' Create a new SUSHISWAPV3ETHEREUMDepositDTO
#'
#' @description
#' Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMDepositDTO
#' @description SUSHISWAPV3ETHEREUMDepositDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMDepositDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `amount_usd` = NULL,
    `block_range` = NULL,
    #' Initialize a new SUSHISWAPV3ETHEREUMDepositDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMDepositDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMDepositDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMDepositDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["block_"]] <-
          self$`block_`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`nonce`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`log_index`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`gas_limit`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["gas_limit"]] <-
          self$`gas_limit`
      }
      if (!is.null(self$`gas_used`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["gas_used"]] <-
          self$`gas_used`
      }
      if (!is.null(self$`gas_price`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["gas_price"]] <-
          self$`gas_price`
      }
      if (!is.null(self$`protocol`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`account`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`position`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`pool`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`tick_lower`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`timestamp`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`liquidity`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`input_tokens`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`input_token_amounts`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["input_token_amounts"]] <-
          self$`input_token_amounts`
      }
      if (!is.null(self$`reserve_amounts`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`amount_usd`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`block_range`)) {
        SUSHISWAPV3ETHEREUMDepositDTOObject[["block_range"]] <-
          self$`block_range`
      }
      SUSHISWAPV3ETHEREUMDepositDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMDepositDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMDepositDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMDepositDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMDepositDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMDepositDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMDepositDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMDepositDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMDepositDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMDepositDTO$lock()
