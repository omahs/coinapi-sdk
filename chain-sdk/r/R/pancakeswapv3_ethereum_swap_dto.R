#' Create a new PANCAKESWAPV3ETHEREUMSwapDTO
#'
#' @description
#' Trade (swap) event which occurred in a pool.
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMSwapDTO
#' @description PANCAKESWAPV3ETHEREUMSwapDTO Class
...
#' @export
PANCAKESWAPV3ETHEREUMSwapDTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new PANCAKESWAPV3ETHEREUMSwapDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMSwapDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMSwapDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMSwapDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["block_"]] <-
          self$`block_`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`nonce`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`log_index`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`gas_limit`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["gas_limit"]] <-
          self$`gas_limit`
      }
      if (!is.null(self$`gas_used`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["gas_used"]] <-
          self$`gas_used`
      }
      if (!is.null(self$`gas_price`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["gas_price"]] <-
          self$`gas_price`
      }
      if (!is.null(self$`protocol`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`account`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`pool`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`timestamp`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`tick`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`token_in`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["token_in"]] <-
          self$`token_in`
      }
      if (!is.null(self$`amount_in`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["amount_in"]] <-
          self$`amount_in`
      }
      if (!is.null(self$`amount_in_usd`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["amount_in_usd"]] <-
          self$`amount_in_usd`
      }
      if (!is.null(self$`token_out`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["token_out"]] <-
          self$`token_out`
      }
      if (!is.null(self$`amount_out`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["amount_out"]] <-
          self$`amount_out`
      }
      if (!is.null(self$`amount_out_usd`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["amount_out_usd"]] <-
          self$`amount_out_usd`
      }
      if (!is.null(self$`reserve_amounts`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`pool_id`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["pool_id"]] <-
          self$`pool_id`
      }
      if (!is.null(self$`transaction_id`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["transaction_id"]] <-
          self$`transaction_id`
      }
      if (!is.null(self$`evaluated_price`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["evaluated_price"]] <-
          self$`evaluated_price`
      }
      if (!is.null(self$`evaluated_amount`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["evaluated_amount"]] <-
          self$`evaluated_amount`
      }
      if (!is.null(self$`evaluated_aggressor`)) {
        PANCAKESWAPV3ETHEREUMSwapDTOObject[["evaluated_aggressor"]] <-
          self$`evaluated_aggressor`$toJSON()
      }
      PANCAKESWAPV3ETHEREUMSwapDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMSwapDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMSwapDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMSwapDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMSwapDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMSwapDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMSwapDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMSwapDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMSwapDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMSwapDTO$lock()
