#' Create a new UniswapV2TransactionDTO
#'
#' @description
...
#'
#' @docType class
#' @title UniswapV2TransactionDTO
#' @description UniswapV2TransactionDTO Class
...
#' @export
UniswapV2TransactionDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `swaps` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV2TransactionDTO class.
    #'
    #' @description
    #' Initialize a new UniswapV2TransactionDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV2TransactionDTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV2TransactionDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV2TransactionDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV2TransactionDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV2TransactionDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV2TransactionDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`timestamp`)) {
        UniswapV2TransactionDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`mints`)) {
        UniswapV2TransactionDTOObject[["mints"]] <-
          self$`mints`
      }
      if (!is.null(self$`burns`)) {
        UniswapV2TransactionDTOObject[["burns"]] <-
          self$`burns`
      }
      if (!is.null(self$`swaps`)) {
        UniswapV2TransactionDTOObject[["swaps"]] <-
          self$`swaps`
      }
      if (!is.null(self$`vid`)) {
        UniswapV2TransactionDTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV2TransactionDTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV2TransactionDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV2TransactionDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV2TransactionDTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV2TransactionDTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV2TransactionDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV2TransactionDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV2TransactionDTO$unlock()
#
## Below is an example to define the print function
# UniswapV2TransactionDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV2TransactionDTO$lock()
