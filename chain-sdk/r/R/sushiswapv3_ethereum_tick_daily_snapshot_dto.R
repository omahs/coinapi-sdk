#' Create a new SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
#' @description SUSHISWAPV3ETHEREUMTickDailySnapshotDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMTickDailySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new SUSHISWAPV3ETHEREUMTickDailySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMTickDailySnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMTickDailySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`day_id`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["day_id"]] <-
          self$`day_id`
      }
      if (!is.null(self$`tick`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`pool`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity_gross`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`
      }
      if (!is.null(self$`liquidity_gross_usd`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["liquidity_gross_usd"]] <-
          self$`liquidity_gross_usd`
      }
      if (!is.null(self$`liquidity_net`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["liquidity_net"]] <-
          self$`liquidity_net`
      }
      if (!is.null(self$`liquidity_net_usd`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["liquidity_net_usd"]] <-
          self$`liquidity_net_usd`
      }
      if (!is.null(self$`timestamp`)) {
        SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      SUSHISWAPV3ETHEREUMTickDailySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMTickDailySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMTickDailySnapshotDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMTickDailySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMTickDailySnapshotDTO$lock()
