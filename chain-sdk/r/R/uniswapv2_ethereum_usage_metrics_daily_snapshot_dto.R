#' Create a new UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
#' @description UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO Class
...
#' @export
UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO class.
    #'
    ...
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `block_range` = NULL, `id` = NULL, `protocol` = NULL, `daily_active_users` = NULL, `cumulative_unique_users` = NULL, `daily_transaction_count` = NULL, `daily_deposit_count` = NULL, `daily_withdraw_count` = NULL, `daily_swap_count` = NULL, `total_pool_count` = NULL, `timestamp` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_range`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["block_range"]] <-
          self$`block_range`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`protocol`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`daily_active_users`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_active_users"]] <-
          self$`daily_active_users`
      }
      if (!is.null(self$`cumulative_unique_users`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["cumulative_unique_users"]] <-
          self$`cumulative_unique_users`
      }
      if (!is.null(self$`daily_transaction_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_transaction_count"]] <-
          self$`daily_transaction_count`
      }
      if (!is.null(self$`daily_deposit_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_deposit_count"]] <-
          self$`daily_deposit_count`
      }
      if (!is.null(self$`daily_withdraw_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_withdraw_count"]] <-
          self$`daily_withdraw_count`
      }
      if (!is.null(self$`daily_swap_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_swap_count"]] <-
          self$`daily_swap_count`
      }
      if (!is.null(self$`total_pool_count`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["total_pool_count"]] <-
          self$`total_pool_count`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO$lock()
