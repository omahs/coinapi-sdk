#' Create a new SUSHISWAPV3ETHEREUMTickDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMTickDTO
#' @description SUSHISWAPV3ETHEREUMTickDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMTickDTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new SUSHISWAPV3ETHEREUMTickDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMTickDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMTickDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMTickDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`index`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["index"]] <-
          self$`index`
      }
      if (!is.null(self$`pool`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`created_timestamp`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["created_timestamp"]] <-
          self$`created_timestamp`
      }
      if (!is.null(self$`created_block_number`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["created_block_number"]] <-
          self$`created_block_number`
      }
      if (!is.null(self$`prices`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["prices"]] <-
          self$`prices`
      }
      if (!is.null(self$`liquidity_gross`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`
      }
      if (!is.null(self$`liquidity_gross_usd`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["liquidity_gross_usd"]] <-
          self$`liquidity_gross_usd`
      }
      if (!is.null(self$`liquidity_net`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["liquidity_net"]] <-
          self$`liquidity_net`
      }
      if (!is.null(self$`liquidity_net_usd`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["liquidity_net_usd"]] <-
          self$`liquidity_net_usd`
      }
      if (!is.null(self$`last_snapshot_day_id`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["last_snapshot_day_id"]] <-
          self$`last_snapshot_day_id`
      }
      if (!is.null(self$`last_snapshot_hour_id`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["last_snapshot_hour_id"]] <-
          self$`last_snapshot_hour_id`
      }
      if (!is.null(self$`last_update_timestamp`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["last_update_timestamp"]] <-
          self$`last_update_timestamp`
      }
      if (!is.null(self$`last_update_block_number`)) {
        SUSHISWAPV3ETHEREUMTickDTOObject[["last_update_block_number"]] <-
          self$`last_update_block_number`
      }
      SUSHISWAPV3ETHEREUMTickDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMTickDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMTickDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMTickDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMTickDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMTickDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMTickDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMTickDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMTickDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMTickDTO$lock()
