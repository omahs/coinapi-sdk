#' Create a new PANCAKESWAPV3ETHEREUMDepositDTO
#'
#' @description
#' Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMDepositDTO
#' @description PANCAKESWAPV3ETHEREUMDepositDTO Class
#' @format An \code{R6Class} generator object
#' @field entry_time  character [optional]
#' @field recv_time  character [optional]
#' @field block_number Number of block in which entity was recorded. integer [optional]
#' @field block_  integer [optional]
#' @field id Identifier, format: (transaction hash)-(log index) character [optional]
...
#' @field liquidity Amount of liquidity minted. character [optional]
...
#' @export
PANCAKESWAPV3ETHEREUMDepositDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `amount_usd` = NULL,
    `block_range` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMDepositDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMDepositDTO class.
    #'
    ...
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `block_` = NULL, `id` = NULL, `hash` = NULL, `nonce` = NULL, `log_index` = NULL, `gas_limit` = NULL, `gas_used` = NULL, `gas_price` = NULL, `protocol` = NULL, `account` = NULL, `position` = NULL, `pool` = NULL, `tick_lower` = NULL, `tick_upper` = NULL, `timestamp` = NULL, `liquidity` = NULL, `input_tokens` = NULL, `input_token_amounts` = NULL, `reserve_amounts` = NULL, `amount_usd` = NULL, `block_range` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMDepositDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMDepositDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["block_"]] <-
          self$`block_`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`nonce`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`log_index`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`gas_limit`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["gas_limit"]] <-
          self$`gas_limit`
      }
      if (!is.null(self$`gas_used`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["gas_used"]] <-
          self$`gas_used`
      }
      if (!is.null(self$`gas_price`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["gas_price"]] <-
          self$`gas_price`
      }
      if (!is.null(self$`protocol`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`account`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`position`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`pool`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`tick_lower`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`timestamp`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`liquidity`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`input_tokens`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`input_token_amounts`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["input_token_amounts"]] <-
          self$`input_token_amounts`
      }
      if (!is.null(self$`reserve_amounts`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`amount_usd`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`block_range`)) {
        PANCAKESWAPV3ETHEREUMDepositDTOObject[["block_range"]] <-
          self$`block_range`
      }
      PANCAKESWAPV3ETHEREUMDepositDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMDepositDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMDepositDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMDepositDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMDepositDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMDepositDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMDepositDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMDepositDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMDepositDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMDepositDTO$lock()
