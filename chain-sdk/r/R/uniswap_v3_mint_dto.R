#' Create a new UniswapV3MintDTO
#'
#' @description
#' Mint entities are created for every emitted Mint event on the Uniswap core contracts. The Mint entity stores key data about the event like token amounts, who sent the transaction, and more.
#'
#' @docType class
#' @title UniswapV3MintDTO
#' @description UniswapV3MintDTO Class
...
UniswapV3MintDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `log_index` = NULL,
    `vid` = NULL,
    #' Initialize a new UniswapV3MintDTO class.
    #'
    #' @description
    #' Initialize a new UniswapV3MintDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UniswapV3MintDTO in JSON format
    #' @export
    toJSON = function() {
      UniswapV3MintDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UniswapV3MintDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UniswapV3MintDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UniswapV3MintDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UniswapV3MintDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`transaction`)) {
        UniswapV3MintDTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`timestamp`)) {
        UniswapV3MintDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`pool`)) {
        UniswapV3MintDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`token_0`)) {
        UniswapV3MintDTOObject[["token_0"]] <-
          self$`token_0`
      }
      if (!is.null(self$`token_1`)) {
        UniswapV3MintDTOObject[["token_1"]] <-
          self$`token_1`
      }
      if (!is.null(self$`owner`)) {
        UniswapV3MintDTOObject[["owner"]] <-
          self$`owner`
      }
      if (!is.null(self$`sender`)) {
        UniswapV3MintDTOObject[["sender"]] <-
          self$`sender`
      }
      if (!is.null(self$`origin`)) {
        UniswapV3MintDTOObject[["origin"]] <-
          self$`origin`
      }
      if (!is.null(self$`amount`)) {
        UniswapV3MintDTOObject[["amount"]] <-
          self$`amount`
      }
      if (!is.null(self$`amount_0`)) {
        UniswapV3MintDTOObject[["amount_0"]] <-
          self$`amount_0`
      }
      if (!is.null(self$`amount_1`)) {
        UniswapV3MintDTOObject[["amount_1"]] <-
          self$`amount_1`
      }
      if (!is.null(self$`amount_usd`)) {
        UniswapV3MintDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`tick_lower`)) {
        UniswapV3MintDTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        UniswapV3MintDTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`log_index`)) {
        UniswapV3MintDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`vid`)) {
        UniswapV3MintDTOObject[["vid"]] <-
          self$`vid`
      }
      UniswapV3MintDTOObject
    },
    #' Deserialize JSON string into an instance of UniswapV3MintDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UniswapV3MintDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UniswapV3MintDTO
    #' @export
    ...
    #' Validate JSON input with respect to UniswapV3MintDTO
    #'
    #' @description
    #' Validate JSON input with respect to UniswapV3MintDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UniswapV3MintDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UniswapV3MintDTO$unlock()
#
## Below is an example to define the print function
# UniswapV3MintDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UniswapV3MintDTO$lock()
