#' Create a new UNISWAPV2ETHEREUMDepositDTO
#'
#' @description
#' Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
#'
#' @docType class
#' @title UNISWAPV2ETHEREUMDepositDTO
#' @description UNISWAPV2ETHEREUMDepositDTO Class
...
#' @export
UNISWAPV2ETHEREUMDepositDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `pool` = NULL,
    `block_range` = NULL,
    #' Initialize a new UNISWAPV2ETHEREUMDepositDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV2ETHEREUMDepositDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV2ETHEREUMDepositDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV2ETHEREUMDepositDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["block_"]] <-
          self$`block_`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`log_index`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`protocol`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`to`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["to"]] <-
          self$`to`
      }
      if (!is.null(self$`from`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["from"]] <-
          self$`from`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`input_tokens`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`output_token`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["output_token"]] <-
          self$`output_token`
      }
      if (!is.null(self$`input_token_amounts`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["input_token_amounts"]] <-
          self$`input_token_amounts`
      }
      if (!is.null(self$`output_token_amount`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["output_token_amount"]] <-
          self$`output_token_amount`
      }
      if (!is.null(self$`reserve_amounts`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`amount_usd`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`pool`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`block_range`)) {
        UNISWAPV2ETHEREUMDepositDTOObject[["block_range"]] <-
          self$`block_range`
      }
      UNISWAPV2ETHEREUMDepositDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMDepositDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV2ETHEREUMDepositDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV2ETHEREUMDepositDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMDepositDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV2ETHEREUMDepositDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV2ETHEREUMDepositDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV2ETHEREUMDepositDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV2ETHEREUMDepositDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV2ETHEREUMDepositDTO$lock()
