#' Create a new PANCAKESWAPV3ETHEREUMWithdrawDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMWithdrawDTO
#' @description PANCAKESWAPV3ETHEREUMWithdrawDTO Class
...
#' @export
PANCAKESWAPV3ETHEREUMWithdrawDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `amount_usd` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMWithdrawDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMWithdrawDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMWithdrawDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMWithdrawDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`nonce`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`log_index`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`gas_limit`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["gas_limit"]] <-
          self$`gas_limit`
      }
      if (!is.null(self$`gas_used`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["gas_used"]] <-
          self$`gas_used`
      }
      if (!is.null(self$`gas_price`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["gas_price"]] <-
          self$`gas_price`
      }
      if (!is.null(self$`protocol`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`account`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`position`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`tick_lower`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`pool`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`timestamp`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`liquidity`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`input_tokens`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`input_token_amounts`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["input_token_amounts"]] <-
          self$`input_token_amounts`
      }
      if (!is.null(self$`reserve_amounts`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`amount_usd`)) {
        PANCAKESWAPV3ETHEREUMWithdrawDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      PANCAKESWAPV3ETHEREUMWithdrawDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMWithdrawDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMWithdrawDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMWithdrawDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMWithdrawDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMWithdrawDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMWithdrawDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMWithdrawDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMWithdrawDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMWithdrawDTO$lock()
