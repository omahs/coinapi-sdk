#' Create a new CURVEFINANCEETHEREUMSwapDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title CURVEFINANCEETHEREUMSwapDTO
#' @description CURVEFINANCEETHEREUMSwapDTO Class
...
#' @export
CURVEFINANCEETHEREUMSwapDTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new CURVEFINANCEETHEREUMSwapDTO class.
    #'
    #' @description
    #' Initialize a new CURVEFINANCEETHEREUMSwapDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return CURVEFINANCEETHEREUMSwapDTO in JSON format
    #' @export
    toJSON = function() {
      CURVEFINANCEETHEREUMSwapDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`log_index`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`protocol`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`to`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["to"]] <-
          self$`to`
      }
      if (!is.null(self$`from`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["from"]] <-
          self$`from`
      }
      if (!is.null(self$`timestamp`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`token_in`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["token_in"]] <-
          self$`token_in`
      }
      if (!is.null(self$`amount_in`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["amount_in"]] <-
          self$`amount_in`
      }
      if (!is.null(self$`amount_in_usd`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["amount_in_usd"]] <-
          self$`amount_in_usd`
      }
      if (!is.null(self$`token_out`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["token_out"]] <-
          self$`token_out`
      }
      if (!is.null(self$`amount_out`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["amount_out"]] <-
          self$`amount_out`
      }
      if (!is.null(self$`amount_out_usd`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["amount_out_usd"]] <-
          self$`amount_out_usd`
      }
      if (!is.null(self$`pool`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`pool_id`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["pool_id"]] <-
          self$`pool_id`
      }
      if (!is.null(self$`transaction_id`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["transaction_id"]] <-
          self$`transaction_id`
      }
      if (!is.null(self$`evaluated_price`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["evaluated_price"]] <-
          self$`evaluated_price`
      }
      if (!is.null(self$`evaluated_amount`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["evaluated_amount"]] <-
          self$`evaluated_amount`
      }
      if (!is.null(self$`evaluated_aggressor`)) {
        CURVEFINANCEETHEREUMSwapDTOObject[["evaluated_aggressor"]] <-
          self$`evaluated_aggressor`$toJSON()
      }
      CURVEFINANCEETHEREUMSwapDTOObject
    },
    #' Deserialize JSON string into an instance of CURVEFINANCEETHEREUMSwapDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of CURVEFINANCEETHEREUMSwapDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of CURVEFINANCEETHEREUMSwapDTO
    #' @export
    ...
    #' Validate JSON input with respect to CURVEFINANCEETHEREUMSwapDTO
    #'
    #' @description
    #' Validate JSON input with respect to CURVEFINANCEETHEREUMSwapDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of CURVEFINANCEETHEREUMSwapDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# CURVEFINANCEETHEREUMSwapDTO$unlock()
#
## Below is an example to define the print function
# CURVEFINANCEETHEREUMSwapDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CURVEFINANCEETHEREUMSwapDTO$lock()
