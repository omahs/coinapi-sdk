#' Create a new SUSHISWAPV3ETHEREUMSwapDTO
#'
#' @description
#' Trade (swap) event which occurred in a pool.
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMSwapDTO
#' @description SUSHISWAPV3ETHEREUMSwapDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMSwapDTO <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new SUSHISWAPV3ETHEREUMSwapDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMSwapDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMSwapDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMSwapDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["block_"]] <-
          self$`block_`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`nonce`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`log_index`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`gas_limit`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["gas_limit"]] <-
          self$`gas_limit`
      }
      if (!is.null(self$`gas_used`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["gas_used"]] <-
          self$`gas_used`
      }
      if (!is.null(self$`gas_price`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["gas_price"]] <-
          self$`gas_price`
      }
      if (!is.null(self$`protocol`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`account`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`pool`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`timestamp`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`tick`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`token_in`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["token_in"]] <-
          self$`token_in`
      }
      if (!is.null(self$`amount_in`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["amount_in"]] <-
          self$`amount_in`
      }
      if (!is.null(self$`amount_in_usd`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["amount_in_usd"]] <-
          self$`amount_in_usd`
      }
      if (!is.null(self$`token_out`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["token_out"]] <-
          self$`token_out`
      }
      if (!is.null(self$`amount_out`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["amount_out"]] <-
          self$`amount_out`
      }
      if (!is.null(self$`amount_out_usd`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["amount_out_usd"]] <-
          self$`amount_out_usd`
      }
      if (!is.null(self$`reserve_amounts`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`pool_id`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["pool_id"]] <-
          self$`pool_id`
      }
      if (!is.null(self$`transaction_id`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["transaction_id"]] <-
          self$`transaction_id`
      }
      if (!is.null(self$`evaluated_price`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["evaluated_price"]] <-
          self$`evaluated_price`
      }
      if (!is.null(self$`evaluated_amount`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["evaluated_amount"]] <-
          self$`evaluated_amount`
      }
      if (!is.null(self$`evaluated_aggressor`)) {
        SUSHISWAPV3ETHEREUMSwapDTOObject[["evaluated_aggressor"]] <-
          self$`evaluated_aggressor`$toJSON()
      }
      SUSHISWAPV3ETHEREUMSwapDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMSwapDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMSwapDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMSwapDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMSwapDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMSwapDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMSwapDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMSwapDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMSwapDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMSwapDTO$lock()
