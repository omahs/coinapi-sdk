#' Create a new SUSHISWAPV3ETHEREUMAccountDTO
#'
#' @description
#' SUSHISWAPV3ETHEREUMAccountDTO Class
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMAccountDTO
#' @description SUSHISWAPV3ETHEREUMAccountDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMAccountDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `withdraw_count` = NULL,
    `swap_count` = NULL,
    #' Initialize a new SUSHISWAPV3ETHEREUMAccountDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMAccountDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMAccountDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMAccountDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_range`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["block_range"]] <-
          self$`block_range`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`position_count`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["position_count"]] <-
          self$`position_count`
      }
      if (!is.null(self$`open_position_count`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["open_position_count"]] <-
          self$`open_position_count`
      }
      if (!is.null(self$`closed_position_count`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["closed_position_count"]] <-
          self$`closed_position_count`
      }
      if (!is.null(self$`deposit_count`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["deposit_count"]] <-
          self$`deposit_count`
      }
      if (!is.null(self$`withdraw_count`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["withdraw_count"]] <-
          self$`withdraw_count`
      }
      if (!is.null(self$`swap_count`)) {
        SUSHISWAPV3ETHEREUMAccountDTOObject[["swap_count"]] <-
          self$`swap_count`
      }
      SUSHISWAPV3ETHEREUMAccountDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMAccountDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMAccountDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMAccountDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMAccountDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMAccountDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMAccountDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMAccountDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMAccountDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMAccountDTO$lock()
