...
#' @docType class
#' @title DexDepositDTO
#' @description DexDepositDTO Class
...
#' @field batch_id Identifier (numerical). character [optional]
...
DexDepositDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `tx_hash` = NULL,
    `vid` = NULL,
    #' Initialize a new DexDepositDTO class.
    #'
    #' @description
    #' Initialize a new DexDepositDTO class.
    #'
    ...
    #' @param batch_id Identifier (numerical).
    #' @param create_epoch Create epoch.
    #' @param tx_hash Transaction hash.
    #' @param vid 
    #' @param ... Other optional arguments.
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `id` = NULL, `user` = NULL, `token_address` = NULL, `amount` = NULL, `batch_id` = NULL, `create_epoch` = NULL, `tx_hash` = NULL, `vid` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return DexDepositDTO in JSON format
    #' @export
    toJSON = function() {
      DexDepositDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        DexDepositDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        DexDepositDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        DexDepositDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        DexDepositDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`user`)) {
        DexDepositDTOObject[["user"]] <-
          self$`user`
      }
      if (!is.null(self$`token_address`)) {
        DexDepositDTOObject[["token_address"]] <-
          self$`token_address`
      }
      if (!is.null(self$`amount`)) {
        DexDepositDTOObject[["amount"]] <-
          self$`amount`
      }
      if (!is.null(self$`batch_id`)) {
        DexDepositDTOObject[["batch_id"]] <-
          self$`batch_id`
      }
      if (!is.null(self$`create_epoch`)) {
        DexDepositDTOObject[["create_epoch"]] <-
          self$`create_epoch`
      }
      if (!is.null(self$`tx_hash`)) {
        DexDepositDTOObject[["tx_hash"]] <-
          self$`tx_hash`
      }
      if (!is.null(self$`vid`)) {
        DexDepositDTOObject[["vid"]] <-
          self$`vid`
      }
      DexDepositDTOObject
    },
    #' Deserialize JSON string into an instance of DexDepositDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of DexDepositDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of DexDepositDTO
    #' @export
    ...
    #' Validate JSON input with respect to DexDepositDTO
    #'
    #' @description
    #' Validate JSON input with respect to DexDepositDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of DexDepositDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
