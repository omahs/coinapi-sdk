#' Create a new CURVEFINANCEETHEREUMTokenDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title CURVEFINANCEETHEREUMTokenDTO
#' @description CURVEFINANCEETHEREUMTokenDTO Class
...
#' @field last_price_usd Optional field to track the price of a token character [optional]
...
#' @export
CURVEFINANCEETHEREUMTokenDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `token_symbol` = NULL,
    #' Initialize a new CURVEFINANCEETHEREUMTokenDTO class.
    #'
    #' @description
    #' Initialize a new CURVEFINANCEETHEREUMTokenDTO class.
    #'
    ...
    #' @param last_price_usd Optional field to track the price of a token
    ...
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `vid` = NULL, `id` = NULL, `name` = NULL, `symbol` = NULL, `decimals` = NULL, `last_price_usd` = NULL, `last_price_block_number` = NULL, `token_symbol` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return CURVEFINANCEETHEREUMTokenDTO in JSON format
    #' @export
    toJSON = function() {
      CURVEFINANCEETHEREUMTokenDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`id`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`symbol`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["symbol"]] <-
          self$`symbol`
      }
      if (!is.null(self$`decimals`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["decimals"]] <-
          self$`decimals`
      }
      if (!is.null(self$`last_price_usd`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["last_price_usd"]] <-
          self$`last_price_usd`
      }
      if (!is.null(self$`last_price_block_number`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["last_price_block_number"]] <-
          self$`last_price_block_number`
      }
      if (!is.null(self$`token_symbol`)) {
        CURVEFINANCEETHEREUMTokenDTOObject[["token_symbol"]] <-
          self$`token_symbol`
      }
      CURVEFINANCEETHEREUMTokenDTOObject
    },
    #' Deserialize JSON string into an instance of CURVEFINANCEETHEREUMTokenDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of CURVEFINANCEETHEREUMTokenDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of CURVEFINANCEETHEREUMTokenDTO
    #' @export
    ...
    #' Validate JSON input with respect to CURVEFINANCEETHEREUMTokenDTO
    #'
    #' @description
    #' Validate JSON input with respect to CURVEFINANCEETHEREUMTokenDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of CURVEFINANCEETHEREUMTokenDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# CURVEFINANCEETHEREUMTokenDTO$unlock()
#
## Below is an example to define the print function
# CURVEFINANCEETHEREUMTokenDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CURVEFINANCEETHEREUMTokenDTO$lock()
