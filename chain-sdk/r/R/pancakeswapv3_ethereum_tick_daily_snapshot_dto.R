#' Create a new PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
#' @description PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO Class
...
#' @export
PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO class.
    #'
    ...
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `id` = NULL, `day_id` = NULL, `tick` = NULL, `pool` = NULL, `liquidity_gross` = NULL, `liquidity_gross_usd` = NULL, `liquidity_net` = NULL, `liquidity_net_usd` = NULL, `timestamp` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`day_id`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["day_id"]] <-
          self$`day_id`
      }
      if (!is.null(self$`tick`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["tick"]] <-
          self$`tick`
      }
      if (!is.null(self$`pool`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`liquidity_gross`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["liquidity_gross"]] <-
          self$`liquidity_gross`
      }
      if (!is.null(self$`liquidity_gross_usd`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["liquidity_gross_usd"]] <-
          self$`liquidity_gross_usd`
      }
      if (!is.null(self$`liquidity_net`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["liquidity_net"]] <-
          self$`liquidity_net`
      }
      if (!is.null(self$`liquidity_net_usd`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["liquidity_net_usd"]] <-
          self$`liquidity_net_usd`
      }
      if (!is.null(self$`timestamp`)) {
        PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO$lock()
