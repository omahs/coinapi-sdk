#' Create a new PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
#' @description PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO Class
...
#' @export
PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `token_prices` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`vid`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["vid"]] <-
          self$`vid`
      }
      if (!is.null(self$`block_range`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["block_range"]] <-
          self$`block_range`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`input_tokens`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`input_token_balances`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["input_token_balances"]] <-
          self$`input_token_balances`
      }
      if (!is.null(self$`token_prices`)) {
        PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject[["token_prices"]] <-
          self$`token_prices`
      }
      PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO$lock()
