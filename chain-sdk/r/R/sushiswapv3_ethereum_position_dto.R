#' Create a new SUSHISWAPV3ETHEREUMPositionDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMPositionDTO
#' @description SUSHISWAPV3ETHEREUMPositionDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMPositionDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `deposit_count` = NULL,
    `withdraw_count` = NULL,
    #' Initialize a new SUSHISWAPV3ETHEREUMPositionDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMPositionDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMPositionDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMPositionDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`account`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`pool`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`hash_opened`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["hash_opened"]] <-
          self$`hash_opened`
      }
      if (!is.null(self$`hash_closed`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["hash_closed"]] <-
          self$`hash_closed`
      }
      if (!is.null(self$`block_number_opened`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["block_number_opened"]] <-
          self$`block_number_opened`
      }
      if (!is.null(self$`timestamp_opened`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["timestamp_opened"]] <-
          self$`timestamp_opened`
      }
      if (!is.null(self$`block_number_closed`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["block_number_closed"]] <-
          self$`block_number_closed`
      }
      if (!is.null(self$`timestamp_closed`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["timestamp_closed"]] <-
          self$`timestamp_closed`
      }
      if (!is.null(self$`tick_lower`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`liquidity_token`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["liquidity_token"]] <-
          self$`liquidity_token`
      }
      if (!is.null(self$`liquidity_token_type`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["liquidity_token_type"]] <-
          self$`liquidity_token_type`
      }
      if (!is.null(self$`liquidity`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`liquidity_usd`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["liquidity_usd"]] <-
          self$`liquidity_usd`
      }
      if (!is.null(self$`cumulative_deposit_token_amounts`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["cumulative_deposit_token_amounts"]] <-
          self$`cumulative_deposit_token_amounts`
      }
      if (!is.null(self$`cumulative_deposit_usd`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["cumulative_deposit_usd"]] <-
          self$`cumulative_deposit_usd`
      }
      if (!is.null(self$`cumulative_withdraw_token_amounts`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["cumulative_withdraw_token_amounts"]] <-
          self$`cumulative_withdraw_token_amounts`
      }
      if (!is.null(self$`cumulative_withdraw_usd`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["cumulative_withdraw_usd"]] <-
          self$`cumulative_withdraw_usd`
      }
      if (!is.null(self$`cumulative_reward_usd`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["cumulative_reward_usd"]] <-
          self$`cumulative_reward_usd`
      }
      if (!is.null(self$`deposit_count`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["deposit_count"]] <-
          self$`deposit_count`
      }
      if (!is.null(self$`withdraw_count`)) {
        SUSHISWAPV3ETHEREUMPositionDTOObject[["withdraw_count"]] <-
          self$`withdraw_count`
      }
      SUSHISWAPV3ETHEREUMPositionDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMPositionDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMPositionDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMPositionDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMPositionDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMPositionDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMPositionDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMPositionDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMPositionDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMPositionDTO$lock()
