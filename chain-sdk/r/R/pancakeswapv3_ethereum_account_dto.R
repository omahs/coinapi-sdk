#' Create a new PANCAKESWAPV3ETHEREUMAccountDTO
#'
#' @description
#' PANCAKESWAPV3ETHEREUMAccountDTO Class
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMAccountDTO
#' @description PANCAKESWAPV3ETHEREUMAccountDTO Class
...
#' @export
PANCAKESWAPV3ETHEREUMAccountDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `withdraw_count` = NULL,
    `swap_count` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMAccountDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMAccountDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMAccountDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMAccountDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_range`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["block_range"]] <-
          self$`block_range`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`position_count`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["position_count"]] <-
          self$`position_count`
      }
      if (!is.null(self$`open_position_count`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["open_position_count"]] <-
          self$`open_position_count`
      }
      if (!is.null(self$`closed_position_count`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["closed_position_count"]] <-
          self$`closed_position_count`
      }
      if (!is.null(self$`deposit_count`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["deposit_count"]] <-
          self$`deposit_count`
      }
      if (!is.null(self$`withdraw_count`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["withdraw_count"]] <-
          self$`withdraw_count`
      }
      if (!is.null(self$`swap_count`)) {
        PANCAKESWAPV3ETHEREUMAccountDTOObject[["swap_count"]] <-
          self$`swap_count`
      }
      PANCAKESWAPV3ETHEREUMAccountDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMAccountDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMAccountDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMAccountDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMAccountDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMAccountDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMAccountDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMAccountDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMAccountDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMAccountDTO$lock()
