#' Create a new UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
#' @description UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO Class
...
#' @export
UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`day`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["day"]] <-
          self$`day`
      }
      if (!is.null(self$`protocol`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`daily_active_users`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_active_users"]] <-
          self$`daily_active_users`
      }
      if (!is.null(self$`cumulative_unique_users`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["cumulative_unique_users"]] <-
          self$`cumulative_unique_users`
      }
      if (!is.null(self$`daily_transaction_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_transaction_count"]] <-
          self$`daily_transaction_count`
      }
      if (!is.null(self$`total_pool_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["total_pool_count"]] <-
          self$`total_pool_count`
      }
      if (!is.null(self$`daily_deposit_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_deposit_count"]] <-
          self$`daily_deposit_count`
      }
      if (!is.null(self$`daily_withdraw_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_withdraw_count"]] <-
          self$`daily_withdraw_count`
      }
      if (!is.null(self$`daily_swap_count`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["daily_swap_count"]] <-
          self$`daily_swap_count`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO$lock()
