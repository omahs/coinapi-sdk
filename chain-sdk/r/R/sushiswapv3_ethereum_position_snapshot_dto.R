#' Create a new SUSHISWAPV3ETHEREUMPositionSnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title SUSHISWAPV3ETHEREUMPositionSnapshotDTO
#' @description SUSHISWAPV3ETHEREUMPositionSnapshotDTO Class
...
#' @export
SUSHISWAPV3ETHEREUMPositionSnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `withdraw_count` = NULL,
    `timestamp` = NULL,
    #' Initialize a new SUSHISWAPV3ETHEREUMPositionSnapshotDTO class.
    #'
    #' @description
    #' Initialize a new SUSHISWAPV3ETHEREUMPositionSnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return SUSHISWAPV3ETHEREUMPositionSnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`log_index`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`nonce`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`position`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`liquidity_token_type`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["liquidity_token_type"]] <-
          self$`liquidity_token_type`
      }
      if (!is.null(self$`liquidity`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`liquidity_usd`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["liquidity_usd"]] <-
          self$`liquidity_usd`
      }
      if (!is.null(self$`cumulative_deposit_token_amounts`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_deposit_token_amounts"]] <-
          self$`cumulative_deposit_token_amounts`
      }
      if (!is.null(self$`cumulative_deposit_usd`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_deposit_usd"]] <-
          self$`cumulative_deposit_usd`
      }
      if (!is.null(self$`cumulative_withdraw_token_amounts`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_withdraw_token_amounts"]] <-
          self$`cumulative_withdraw_token_amounts`
      }
      if (!is.null(self$`cumulative_withdraw_usd`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_withdraw_usd"]] <-
          self$`cumulative_withdraw_usd`
      }
      if (!is.null(self$`cumulative_reward_token_amounts`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_reward_token_amounts"]] <-
          self$`cumulative_reward_token_amounts`
      }
      if (!is.null(self$`cumulative_reward_usd`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["cumulative_reward_usd"]] <-
          self$`cumulative_reward_usd`
      }
      if (!is.null(self$`deposit_count`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["deposit_count"]] <-
          self$`deposit_count`
      }
      if (!is.null(self$`withdraw_count`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["withdraw_count"]] <-
          self$`withdraw_count`
      }
      if (!is.null(self$`timestamp`)) {
        SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      SUSHISWAPV3ETHEREUMPositionSnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMPositionSnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SUSHISWAPV3ETHEREUMPositionSnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SUSHISWAPV3ETHEREUMPositionSnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMPositionSnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to SUSHISWAPV3ETHEREUMPositionSnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SUSHISWAPV3ETHEREUMPositionSnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SUSHISWAPV3ETHEREUMPositionSnapshotDTO$unlock()
#
## Below is an example to define the print function
# SUSHISWAPV3ETHEREUMPositionSnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SUSHISWAPV3ETHEREUMPositionSnapshotDTO$lock()
