...
#'
#' @docType class
#' @title SushiswapMintDTO
#' @description SushiswapMintDTO Class
...
SushiswapMintDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `fee_liquidity` = NULL,
    `vid` = NULL,
    #' Initialize a new SushiswapMintDTO class.
    #'
    #' @description
    #' Initialize a new SushiswapMintDTO class.
    #'
    ...
    #' @export
    initialize = function(`entry_time` = NULL, `recv_time` = NULL, `block_number` = NULL, `id` = NULL, `transaction` = NULL, `timestamp` = NULL, `pair` = NULL, `to` = NULL, `liquidity` = NULL, `sender` = NULL, `amount_0` = NULL, `amount_1` = NULL, `log_index` = NULL, `amount_usd` = NULL, `fee_to` = NULL, `fee_liquidity` = NULL, `vid` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return SushiswapMintDTO in JSON format
    #' @export
    toJSON = function() {
      SushiswapMintDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        SushiswapMintDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        SushiswapMintDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        SushiswapMintDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        SushiswapMintDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`transaction`)) {
        SushiswapMintDTOObject[["transaction"]] <-
          self$`transaction`
      }
      if (!is.null(self$`timestamp`)) {
        SushiswapMintDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`pair`)) {
        SushiswapMintDTOObject[["pair"]] <-
          self$`pair`
      }
      if (!is.null(self$`to`)) {
        SushiswapMintDTOObject[["to"]] <-
          self$`to`
      }
      if (!is.null(self$`liquidity`)) {
        SushiswapMintDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`sender`)) {
        SushiswapMintDTOObject[["sender"]] <-
          self$`sender`
      }
      if (!is.null(self$`amount_0`)) {
        SushiswapMintDTOObject[["amount_0"]] <-
          self$`amount_0`
      }
      if (!is.null(self$`amount_1`)) {
        SushiswapMintDTOObject[["amount_1"]] <-
          self$`amount_1`
      }
      if (!is.null(self$`log_index`)) {
        SushiswapMintDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`amount_usd`)) {
        SushiswapMintDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`fee_to`)) {
        SushiswapMintDTOObject[["fee_to"]] <-
          self$`fee_to`
      }
      if (!is.null(self$`fee_liquidity`)) {
        SushiswapMintDTOObject[["fee_liquidity"]] <-
          self$`fee_liquidity`
      }
      if (!is.null(self$`vid`)) {
        SushiswapMintDTOObject[["vid"]] <-
          self$`vid`
      }
      SushiswapMintDTOObject
    },
    #' Deserialize JSON string into an instance of SushiswapMintDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of SushiswapMintDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of SushiswapMintDTO
    #' @export
    ...
    #' Validate JSON input with respect to SushiswapMintDTO
    #'
    #' @description
    #' Validate JSON input with respect to SushiswapMintDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SushiswapMintDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SushiswapMintDTO$unlock()
#
## Below is an example to define the print function
# SushiswapMintDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SushiswapMintDTO$lock()
