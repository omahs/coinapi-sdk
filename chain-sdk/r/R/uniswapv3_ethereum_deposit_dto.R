#' Create a new UNISWAPV3ETHEREUMDepositDTO
#'
#' @description
#' Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
#'
#' @docType class
#' @title UNISWAPV3ETHEREUMDepositDTO
#' @description UNISWAPV3ETHEREUMDepositDTO Class
...
#' @export
UNISWAPV3ETHEREUMDepositDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `amount_usd` = NULL,
    `block_range` = NULL,
    #' Initialize a new UNISWAPV3ETHEREUMDepositDTO class.
    #'
    #' @description
    #' Initialize a new UNISWAPV3ETHEREUMDepositDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return UNISWAPV3ETHEREUMDepositDTO in JSON format
    #' @export
    toJSON = function() {
      UNISWAPV3ETHEREUMDepositDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`block_`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["block_"]] <-
          self$`block_`
      }
      if (!is.null(self$`id`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hash`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["hash"]] <-
          self$`hash`
      }
      if (!is.null(self$`nonce`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["nonce"]] <-
          self$`nonce`
      }
      if (!is.null(self$`log_index`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["log_index"]] <-
          self$`log_index`
      }
      if (!is.null(self$`gas_limit`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["gas_limit"]] <-
          self$`gas_limit`
      }
      if (!is.null(self$`gas_used`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["gas_used"]] <-
          self$`gas_used`
      }
      if (!is.null(self$`gas_price`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["gas_price"]] <-
          self$`gas_price`
      }
      if (!is.null(self$`protocol`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`account`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["account"]] <-
          self$`account`
      }
      if (!is.null(self$`position`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`pool`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["pool"]] <-
          self$`pool`
      }
      if (!is.null(self$`tick_lower`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["tick_lower"]] <-
          self$`tick_lower`
      }
      if (!is.null(self$`tick_upper`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["tick_upper"]] <-
          self$`tick_upper`
      }
      if (!is.null(self$`timestamp`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      if (!is.null(self$`liquidity`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["liquidity"]] <-
          self$`liquidity`
      }
      if (!is.null(self$`input_tokens`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`input_token_amounts`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["input_token_amounts"]] <-
          self$`input_token_amounts`
      }
      if (!is.null(self$`reserve_amounts`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["reserve_amounts"]] <-
          self$`reserve_amounts`
      }
      if (!is.null(self$`amount_usd`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["amount_usd"]] <-
          self$`amount_usd`
      }
      if (!is.null(self$`block_range`)) {
        UNISWAPV3ETHEREUMDepositDTOObject[["block_range"]] <-
          self$`block_range`
      }
      UNISWAPV3ETHEREUMDepositDTOObject
    },
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMDepositDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of UNISWAPV3ETHEREUMDepositDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of UNISWAPV3ETHEREUMDepositDTO
    #' @export
    ...
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMDepositDTO
    #'
    #' @description
    #' Validate JSON input with respect to UNISWAPV3ETHEREUMDepositDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UNISWAPV3ETHEREUMDepositDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UNISWAPV3ETHEREUMDepositDTO$unlock()
#
## Below is an example to define the print function
# UNISWAPV3ETHEREUMDepositDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UNISWAPV3ETHEREUMDepositDTO$lock()
