#' Create a new PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
#'
#' @description
#' 
#'
#' @docType class
#' @title PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
#' @description PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO Class
...
#' @export
PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO <- R6::R6Class(
  ...
  public = list(
    ...
    `timestamp` = NULL,
    #' Initialize a new PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO class.
    #'
    #' @description
    #' Initialize a new PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO class.
    #'
    ...
    #' To JSON String
    #'
    #' @return PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO in JSON format
    #' @export
    toJSON = function() {
      PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject <- list()
      if (!is.null(self$`entry_time`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["entry_time"]] <-
          self$`entry_time`
      }
      if (!is.null(self$`recv_time`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["recv_time"]] <-
          self$`recv_time`
      }
      if (!is.null(self$`block_number`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["block_number"]] <-
          self$`block_number`
      }
      if (!is.null(self$`id`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`hour`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hour"]] <-
          self$`hour`
      }
      if (!is.null(self$`protocol`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`hourly_active_users`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_active_users"]] <-
          self$`hourly_active_users`
      }
      if (!is.null(self$`cumulative_unique_users`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["cumulative_unique_users"]] <-
          self$`cumulative_unique_users`
      }
      if (!is.null(self$`hourly_transaction_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_transaction_count"]] <-
          self$`hourly_transaction_count`
      }
      if (!is.null(self$`hourly_deposit_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_deposit_count"]] <-
          self$`hourly_deposit_count`
      }
      if (!is.null(self$`hourly_withdraw_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_withdraw_count"]] <-
          self$`hourly_withdraw_count`
      }
      if (!is.null(self$`hourly_swap_count`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["hourly_swap_count"]] <-
          self$`hourly_swap_count`
      }
      if (!is.null(self$`timestamp`)) {
        PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject[["timestamp"]] <-
          self$`timestamp`
      }
      PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOObject
    },
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @description
    #' Deserialize JSON string into an instance of PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @param input_json the JSON input
    #' @return the instance of PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #' @export
    ...
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #'
    #' @description
    #' Validate JSON input with respect to PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO$unlock()
#
## Below is an example to define the print function
# PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO$lock()
