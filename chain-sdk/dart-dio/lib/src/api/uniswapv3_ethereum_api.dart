...
class UNISWAPV3ETHEREUMApi {
  ...
  const UNISWAPV3ETHEREUMApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UNISWAPV3ETHEREUMAccountDTO>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<UNISWAPV3ETHEREUMAccountDTO>>> uNISWAPV3ETHEREUMAccountsCurrent({ 
    ...
    BuiltList<UNISWAPV3ETHEREUMAccountDTO>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(UNISWAPV3ETHEREUMAccountDTO)]),
      ) as BuiltList<UNISWAPV3ETHEREUMAccountDTO>;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UNISWAPV3ETHEREUMSwapDTO>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<UNISWAPV3ETHEREUMSwapDTO>>> uNISWAPV3ETHEREUMSwapsCurrent({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<UNISWAPV3ETHEREUMSwapDTO>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(UNISWAPV3ETHEREUMSwapDTO)]),
      ) as BuiltList<UNISWAPV3ETHEREUMSwapDTO>;
    ...
    return Response<BuiltList<UNISWAPV3ETHEREUMSwapDTO>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<UNISWAPV3ETHEREUMTokenDTO>>> uNISWAPV3ETHEREUMTokensCurrent({ 
    ...
    BuiltList<UNISWAPV3ETHEREUMTokenDTO>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(UNISWAPV3ETHEREUMTokenDTO)]),
      ) as BuiltList<UNISWAPV3ETHEREUMTokenDTO>;
