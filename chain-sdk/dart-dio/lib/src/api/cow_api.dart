...
class CowApi {
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CowOrderDTO>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CowOrderDTO>>> cowOrdersCurrent({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/dapps/cow/orders/current';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CowSettlementDTO>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CowSettlementDTO>>> cowSettlementsCurrent({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/dapps/cow/settlements/current';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CowTokenDTO>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CowTokenDTO>>> cowTokensCurrent({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/dapps/cow/tokens/current';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CowTradeDTO>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CowTradeDTO>>> cowTradesCurrent({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/dapps/cow/trades/current';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CowUserDTO>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CowUserDTO>>> cowUsersCurrent({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/dapps/cow/users/current';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
