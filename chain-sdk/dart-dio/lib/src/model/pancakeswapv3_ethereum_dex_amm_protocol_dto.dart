...
part 'pancakeswapv3_ethereum_dex_amm_protocol_dto.g.dart';
...
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO implements Built<PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO, PANCAKESWAPV3ETHEREUMDexAmmProtocolDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO._();

  factory PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO([void updates(PANCAKESWAPV3ETHEREUMDexAmmProtocolDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMDexAmmProtocolDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO> get serializer => _$PANCAKESWAPV3ETHEREUMDexAmmProtocolDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMDexAmmProtocolDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO, _$PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMDexAmmProtocolDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMDexAmmProtocolDTOBuilder();
