...
part 'pancakeswapv3_ethereum_swap_dto.g.dart';
...
/// * [evaluatedAggressor] 
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMSwapDTO implements Built<PANCAKESWAPV3ETHEREUMSwapDTO, PANCAKESWAPV3ETHEREUMSwapDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMSwapDTO._();

  factory PANCAKESWAPV3ETHEREUMSwapDTO([void updates(PANCAKESWAPV3ETHEREUMSwapDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMSwapDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMSwapDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMSwapDTO> get serializer => _$PANCAKESWAPV3ETHEREUMSwapDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMSwapDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMSwapDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMSwapDTO, _$PANCAKESWAPV3ETHEREUMSwapDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMSwapDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMSwapDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMSwapDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMSwapDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMSwapDTOBuilder();
