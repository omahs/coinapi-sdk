...
part 'uniswapv3_ethereum_dex_amm_protocol_dto.g.dart';
...
@BuiltValue()
abstract class UNISWAPV3ETHEREUMDexAmmProtocolDTO implements Built<UNISWAPV3ETHEREUMDexAmmProtocolDTO, UNISWAPV3ETHEREUMDexAmmProtocolDTOBuilder> {
  ...
  UNISWAPV3ETHEREUMDexAmmProtocolDTO._();

  factory UNISWAPV3ETHEREUMDexAmmProtocolDTO([void updates(UNISWAPV3ETHEREUMDexAmmProtocolDTOBuilder b)]) = _$UNISWAPV3ETHEREUMDexAmmProtocolDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV3ETHEREUMDexAmmProtocolDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV3ETHEREUMDexAmmProtocolDTO> get serializer => _$UNISWAPV3ETHEREUMDexAmmProtocolDTOSerializer();
}

class _$UNISWAPV3ETHEREUMDexAmmProtocolDTOSerializer implements PrimitiveSerializer<UNISWAPV3ETHEREUMDexAmmProtocolDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV3ETHEREUMDexAmmProtocolDTO, _$UNISWAPV3ETHEREUMDexAmmProtocolDTO];

  @override
  final String wireName = r'UNISWAPV3ETHEREUMDexAmmProtocolDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV3ETHEREUMDexAmmProtocolDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV3ETHEREUMDexAmmProtocolDTOBuilder result,
  ...
  @override
  UNISWAPV3ETHEREUMDexAmmProtocolDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV3ETHEREUMDexAmmProtocolDTOBuilder();
