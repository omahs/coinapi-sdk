...
part 'sushiswapv3_ethereum_liquidity_pool_dto.g.dart';
...
/// * [evaluatedAsk] - 
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMLiquidityPoolDTO implements Built<SUSHISWAPV3ETHEREUMLiquidityPoolDTO, SUSHISWAPV3ETHEREUMLiquidityPoolDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMLiquidityPoolDTO._();

  factory SUSHISWAPV3ETHEREUMLiquidityPoolDTO([void updates(SUSHISWAPV3ETHEREUMLiquidityPoolDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMLiquidityPoolDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMLiquidityPoolDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMLiquidityPoolDTO> get serializer => _$SUSHISWAPV3ETHEREUMLiquidityPoolDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMLiquidityPoolDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMLiquidityPoolDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMLiquidityPoolDTO, _$SUSHISWAPV3ETHEREUMLiquidityPoolDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMLiquidityPoolDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMLiquidityPoolDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMLiquidityPoolDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMLiquidityPoolDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMLiquidityPoolDTOBuilder();
