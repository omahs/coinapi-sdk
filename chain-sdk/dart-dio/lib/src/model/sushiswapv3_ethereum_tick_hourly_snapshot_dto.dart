...
part 'sushiswapv3_ethereum_tick_hourly_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO implements Built<SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO, SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO._();

  factory SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO([void updates(SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO> get serializer => _$SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO, _$SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOBuilder();
