...
part 'pancakeswapv3_ethereum_usage_metrics_hourly_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO implements Built<PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO, PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO._();

  factory PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO([void updates(PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO> get serializer => _$PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO, _$PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder();
