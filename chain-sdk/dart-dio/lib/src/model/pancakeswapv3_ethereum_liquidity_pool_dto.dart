...
part 'pancakeswapv3_ethereum_liquidity_pool_dto.g.dart';
...
/// * [evaluatedAsk] - 
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMLiquidityPoolDTO implements Built<PANCAKESWAPV3ETHEREUMLiquidityPoolDTO, PANCAKESWAPV3ETHEREUMLiquidityPoolDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMLiquidityPoolDTO._();

  factory PANCAKESWAPV3ETHEREUMLiquidityPoolDTO([void updates(PANCAKESWAPV3ETHEREUMLiquidityPoolDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMLiquidityPoolDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMLiquidityPoolDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMLiquidityPoolDTO> get serializer => _$PANCAKESWAPV3ETHEREUMLiquidityPoolDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMLiquidityPoolDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMLiquidityPoolDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMLiquidityPoolDTO, _$PANCAKESWAPV3ETHEREUMLiquidityPoolDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMLiquidityPoolDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMLiquidityPoolDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMLiquidityPoolDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMLiquidityPoolDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMLiquidityPoolDTOBuilder();
