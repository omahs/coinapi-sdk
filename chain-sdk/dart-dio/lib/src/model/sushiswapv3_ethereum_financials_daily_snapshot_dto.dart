...
part 'sushiswapv3_ethereum_financials_daily_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO implements Built<SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO, SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO._();

  factory SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO([void updates(SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO> get serializer => _$SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO, _$SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTOBuilder();
