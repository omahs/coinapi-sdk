...
part 'sushiswapv3_ethereum_position_dto.g.dart';
...
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMPositionDTO implements Built<SUSHISWAPV3ETHEREUMPositionDTO, SUSHISWAPV3ETHEREUMPositionDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMPositionDTO._();

  factory SUSHISWAPV3ETHEREUMPositionDTO([void updates(SUSHISWAPV3ETHEREUMPositionDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMPositionDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMPositionDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMPositionDTO> get serializer => _$SUSHISWAPV3ETHEREUMPositionDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMPositionDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMPositionDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMPositionDTO, _$SUSHISWAPV3ETHEREUMPositionDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMPositionDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMPositionDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMPositionDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMPositionDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMPositionDTOBuilder();
