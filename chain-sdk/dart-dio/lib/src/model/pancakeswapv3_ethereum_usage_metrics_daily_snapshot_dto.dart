...
part 'pancakeswapv3_ethereum_usage_metrics_daily_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO implements Built<PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO, PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO._();

  factory PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO([void updates(PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO> get serializer => _$PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO, _$PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder();
