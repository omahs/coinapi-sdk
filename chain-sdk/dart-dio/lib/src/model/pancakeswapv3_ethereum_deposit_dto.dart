...
part 'pancakeswapv3_ethereum_deposit_dto.g.dart';
...
/// * [blockRange] - 
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMDepositDTO implements Built<PANCAKESWAPV3ETHEREUMDepositDTO, PANCAKESWAPV3ETHEREUMDepositDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMDepositDTO._();

  factory PANCAKESWAPV3ETHEREUMDepositDTO([void updates(PANCAKESWAPV3ETHEREUMDepositDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMDepositDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMDepositDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMDepositDTO> get serializer => _$PANCAKESWAPV3ETHEREUMDepositDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMDepositDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMDepositDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMDepositDTO, _$PANCAKESWAPV3ETHEREUMDepositDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMDepositDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMDepositDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMDepositDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMDepositDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMDepositDTOBuilder();
