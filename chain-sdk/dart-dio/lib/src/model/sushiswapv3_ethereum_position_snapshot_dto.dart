...
part 'sushiswapv3_ethereum_position_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMPositionSnapshotDTO implements Built<SUSHISWAPV3ETHEREUMPositionSnapshotDTO, SUSHISWAPV3ETHEREUMPositionSnapshotDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMPositionSnapshotDTO._();

  factory SUSHISWAPV3ETHEREUMPositionSnapshotDTO([void updates(SUSHISWAPV3ETHEREUMPositionSnapshotDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMPositionSnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMPositionSnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMPositionSnapshotDTO> get serializer => _$SUSHISWAPV3ETHEREUMPositionSnapshotDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMPositionSnapshotDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMPositionSnapshotDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMPositionSnapshotDTO, _$SUSHISWAPV3ETHEREUMPositionSnapshotDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMPositionSnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMPositionSnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMPositionSnapshotDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMPositionSnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMPositionSnapshotDTOBuilder();
