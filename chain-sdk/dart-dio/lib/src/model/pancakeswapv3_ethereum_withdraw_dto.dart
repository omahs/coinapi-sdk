...
part 'pancakeswapv3_ethereum_withdraw_dto.g.dart';
...
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMWithdrawDTO implements Built<PANCAKESWAPV3ETHEREUMWithdrawDTO, PANCAKESWAPV3ETHEREUMWithdrawDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMWithdrawDTO._();

  factory PANCAKESWAPV3ETHEREUMWithdrawDTO([void updates(PANCAKESWAPV3ETHEREUMWithdrawDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMWithdrawDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMWithdrawDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMWithdrawDTO> get serializer => _$PANCAKESWAPV3ETHEREUMWithdrawDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMWithdrawDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMWithdrawDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMWithdrawDTO, _$PANCAKESWAPV3ETHEREUMWithdrawDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMWithdrawDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMWithdrawDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMWithdrawDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMWithdrawDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMWithdrawDTOBuilder();
