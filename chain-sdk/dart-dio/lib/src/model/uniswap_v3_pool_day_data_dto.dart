...
part 'uniswap_v3_pool_day_data_dto.g.dart';
...
/// * [vid] - 
@BuiltValue()
abstract class UniswapV3PoolDayDataDTO implements Built<UniswapV3PoolDayDataDTO, UniswapV3PoolDayDataDTOBuilder> {
  ...
  UniswapV3PoolDayDataDTO._();

  factory UniswapV3PoolDayDataDTO([void updates(UniswapV3PoolDayDataDTOBuilder b)]) = _$UniswapV3PoolDayDataDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UniswapV3PoolDayDataDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UniswapV3PoolDayDataDTO> get serializer => _$UniswapV3PoolDayDataDTOSerializer();
}

class _$UniswapV3PoolDayDataDTOSerializer implements PrimitiveSerializer<UniswapV3PoolDayDataDTO> {
  @override
  final Iterable<Type> types = const [UniswapV3PoolDayDataDTO, _$UniswapV3PoolDayDataDTO];

  @override
  final String wireName = r'UniswapV3PoolDayDataDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UniswapV3PoolDayDataDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UniswapV3PoolDayDataDTOBuilder result,
  ...
  @override
  UniswapV3PoolDayDataDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UniswapV3PoolDayDataDTOBuilder();
