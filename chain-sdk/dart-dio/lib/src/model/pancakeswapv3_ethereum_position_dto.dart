...
part 'pancakeswapv3_ethereum_position_dto.g.dart';
...
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMPositionDTO implements Built<PANCAKESWAPV3ETHEREUMPositionDTO, PANCAKESWAPV3ETHEREUMPositionDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMPositionDTO._();

  factory PANCAKESWAPV3ETHEREUMPositionDTO([void updates(PANCAKESWAPV3ETHEREUMPositionDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMPositionDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMPositionDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMPositionDTO> get serializer => _$PANCAKESWAPV3ETHEREUMPositionDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMPositionDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMPositionDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMPositionDTO, _$PANCAKESWAPV3ETHEREUMPositionDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMPositionDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMPositionDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMPositionDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMPositionDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMPositionDTOBuilder();
