...
part 'uniswapv3_ethereum_tick_dto.g.dart';
...
@BuiltValue()
abstract class UNISWAPV3ETHEREUMTickDTO implements Built<UNISWAPV3ETHEREUMTickDTO, UNISWAPV3ETHEREUMTickDTOBuilder> {
  ...
  UNISWAPV3ETHEREUMTickDTO._();

  factory UNISWAPV3ETHEREUMTickDTO([void updates(UNISWAPV3ETHEREUMTickDTOBuilder b)]) = _$UNISWAPV3ETHEREUMTickDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV3ETHEREUMTickDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV3ETHEREUMTickDTO> get serializer => _$UNISWAPV3ETHEREUMTickDTOSerializer();
}

class _$UNISWAPV3ETHEREUMTickDTOSerializer implements PrimitiveSerializer<UNISWAPV3ETHEREUMTickDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV3ETHEREUMTickDTO, _$UNISWAPV3ETHEREUMTickDTO];

  @override
  final String wireName = r'UNISWAPV3ETHEREUMTickDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV3ETHEREUMTickDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV3ETHEREUMTickDTOBuilder result,
  ...
  @override
  UNISWAPV3ETHEREUMTickDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV3ETHEREUMTickDTOBuilder();
