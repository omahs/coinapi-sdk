...
part 'sushiswapv3_ethereum_account_dto.g.dart';
...
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMAccountDTO implements Built<SUSHISWAPV3ETHEREUMAccountDTO, SUSHISWAPV3ETHEREUMAccountDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMAccountDTO._();

  factory SUSHISWAPV3ETHEREUMAccountDTO([void updates(SUSHISWAPV3ETHEREUMAccountDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMAccountDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMAccountDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMAccountDTO> get serializer => _$SUSHISWAPV3ETHEREUMAccountDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMAccountDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMAccountDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMAccountDTO, _$SUSHISWAPV3ETHEREUMAccountDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMAccountDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMAccountDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMAccountDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMAccountDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMAccountDTOBuilder();
