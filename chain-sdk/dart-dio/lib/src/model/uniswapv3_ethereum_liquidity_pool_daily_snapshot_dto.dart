...
part 'uniswapv3_ethereum_liquidity_pool_daily_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO implements Built<UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO, UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder> {
  ...
  UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO._();

  factory UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO([void updates(UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder b)]) = _$UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO> get serializer => _$UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOSerializer();
}

class _$UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOSerializer implements PrimitiveSerializer<UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO, _$UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO];

  @override
  final String wireName = r'UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder result,
  ...
  @override
  UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder();
