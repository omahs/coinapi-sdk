...
part 'curvefinanceethereum_deposit_dto.g.dart';
...
/// * [blockRange] - 
/// * [id] - deposit-(Transaction hash)-(log index)
...
/// * [outputToken] - Output token of the pool. E.g. the UNI-LP token
...
@BuiltValue()
abstract class CURVEFINANCEETHEREUMDepositDTO implements Built<CURVEFINANCEETHEREUMDepositDTO, CURVEFINANCEETHEREUMDepositDTOBuilder> {
  ...
  CURVEFINANCEETHEREUMDepositDTO._();

  factory CURVEFINANCEETHEREUMDepositDTO([void updates(CURVEFINANCEETHEREUMDepositDTOBuilder b)]) = _$CURVEFINANCEETHEREUMDepositDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CURVEFINANCEETHEREUMDepositDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CURVEFINANCEETHEREUMDepositDTO> get serializer => _$CURVEFINANCEETHEREUMDepositDTOSerializer();
}

class _$CURVEFINANCEETHEREUMDepositDTOSerializer implements PrimitiveSerializer<CURVEFINANCEETHEREUMDepositDTO> {
  @override
  final Iterable<Type> types = const [CURVEFINANCEETHEREUMDepositDTO, _$CURVEFINANCEETHEREUMDepositDTO];

  @override
  final String wireName = r'CURVEFINANCEETHEREUMDepositDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CURVEFINANCEETHEREUMDepositDTO object, {
  ...
  void _deserializeProperties(
    ...
    required CURVEFINANCEETHEREUMDepositDTOBuilder result,
  ...
  @override
  CURVEFINANCEETHEREUMDepositDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CURVEFINANCEETHEREUMDepositDTOBuilder();
