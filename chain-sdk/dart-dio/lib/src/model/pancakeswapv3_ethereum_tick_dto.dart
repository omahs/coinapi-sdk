...
part 'pancakeswapv3_ethereum_tick_dto.g.dart';
...
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMTickDTO implements Built<PANCAKESWAPV3ETHEREUMTickDTO, PANCAKESWAPV3ETHEREUMTickDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMTickDTO._();

  factory PANCAKESWAPV3ETHEREUMTickDTO([void updates(PANCAKESWAPV3ETHEREUMTickDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMTickDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMTickDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMTickDTO> get serializer => _$PANCAKESWAPV3ETHEREUMTickDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMTickDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMTickDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMTickDTO, _$PANCAKESWAPV3ETHEREUMTickDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMTickDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMTickDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMTickDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMTickDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMTickDTOBuilder();
