...
part 'uniswapv3_ethereum_usage_metrics_hourly_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO implements Built<UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO, UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder> {
  ...
  UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO._();

  factory UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO([void updates(UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder b)]) = _$UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO> get serializer => _$UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOSerializer();
}

class _$UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOSerializer implements PrimitiveSerializer<UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO, _$UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO];

  @override
  final String wireName = r'UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder result,
  ...
  @override
  UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder();
