...
part 'sushiswapv3_ethereum_token_dto.g.dart';
...
/// * [tokenSymbol] 
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMTokenDTO implements Built<SUSHISWAPV3ETHEREUMTokenDTO, SUSHISWAPV3ETHEREUMTokenDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMTokenDTO._();

  factory SUSHISWAPV3ETHEREUMTokenDTO([void updates(SUSHISWAPV3ETHEREUMTokenDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMTokenDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMTokenDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMTokenDTO> get serializer => _$SUSHISWAPV3ETHEREUMTokenDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMTokenDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMTokenDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMTokenDTO, _$SUSHISWAPV3ETHEREUMTokenDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMTokenDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMTokenDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMTokenDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMTokenDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMTokenDTOBuilder();
