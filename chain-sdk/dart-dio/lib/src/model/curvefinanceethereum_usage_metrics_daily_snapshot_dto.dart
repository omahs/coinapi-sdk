...
part 'curvefinanceethereum_usage_metrics_daily_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO implements Built<CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO, CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOBuilder> {
  ...
  CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO._();

  factory CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO([void updates(CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOBuilder b)]) = _$CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO> get serializer => _$CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOSerializer();
}

class _$CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOSerializer implements PrimitiveSerializer<CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO, _$CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO];

  @override
  final String wireName = r'CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOBuilder result,
  ...
  @override
  CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTOBuilder();
