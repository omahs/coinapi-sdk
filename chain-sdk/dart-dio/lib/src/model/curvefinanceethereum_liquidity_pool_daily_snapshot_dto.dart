...
part 'curvefinanceethereum_liquidity_pool_daily_snapshot_dto.g.dart';
...
/// * [cumulativeProtocolSideRevenueUsd] - Daily revenue generated by the liquidity pool, accrued to the supply side.
/// * [dailyProtocolSideRevenueUsd] - All revenue generated by the liquidity pool, accrued to the protocol.
...
/// * [dailyVolumeByTokenUsd] - All trade volume occurred in a given day for a specific input token, in native amount. The ordering should be the same as the pool's 'inputTokens' field.
/// * [cumulativeVolumeUsd] - All trade volume occurred in a given day for a specific input token, in USD. The ordering should be the same as the pool's 'inputTokens' field.
...
@BuiltValue()
abstract class CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO implements Built<CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO, CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTOBuilder> {
  ...
  CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO._();

  factory CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO([void updates(CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTOBuilder b)]) = _$CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO> get serializer => _$CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTOSerializer();
}

class _$CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTOSerializer implements PrimitiveSerializer<CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO, _$CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO];

  @override
  final String wireName = r'CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTOBuilder result,
  ...
  @override
  CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTOBuilder();
