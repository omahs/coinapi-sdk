...
part 'sushiswapv3_ethereum_liquidity_pool_daily_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO implements Built<SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO, SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO._();

  factory SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO([void updates(SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO> get serializer => _$SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO, _$SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTOBuilder();
