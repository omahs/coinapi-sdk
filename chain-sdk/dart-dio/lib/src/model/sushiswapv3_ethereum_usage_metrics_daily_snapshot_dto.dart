...
part 'sushiswapv3_ethereum_usage_metrics_daily_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO implements Built<SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO, SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO._();

  factory SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO([void updates(SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO> get serializer => _$SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO, _$SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder();
