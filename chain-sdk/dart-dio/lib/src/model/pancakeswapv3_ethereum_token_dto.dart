...
part 'pancakeswapv3_ethereum_token_dto.g.dart';
...
/// * [tokenSymbol] 
@BuiltValue()
abstract class PANCAKESWAPV3ETHEREUMTokenDTO implements Built<PANCAKESWAPV3ETHEREUMTokenDTO, PANCAKESWAPV3ETHEREUMTokenDTOBuilder> {
  ...
  PANCAKESWAPV3ETHEREUMTokenDTO._();

  factory PANCAKESWAPV3ETHEREUMTokenDTO([void updates(PANCAKESWAPV3ETHEREUMTokenDTOBuilder b)]) = _$PANCAKESWAPV3ETHEREUMTokenDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PANCAKESWAPV3ETHEREUMTokenDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PANCAKESWAPV3ETHEREUMTokenDTO> get serializer => _$PANCAKESWAPV3ETHEREUMTokenDTOSerializer();
}

class _$PANCAKESWAPV3ETHEREUMTokenDTOSerializer implements PrimitiveSerializer<PANCAKESWAPV3ETHEREUMTokenDTO> {
  @override
  final Iterable<Type> types = const [PANCAKESWAPV3ETHEREUMTokenDTO, _$PANCAKESWAPV3ETHEREUMTokenDTO];

  @override
  final String wireName = r'PANCAKESWAPV3ETHEREUMTokenDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PANCAKESWAPV3ETHEREUMTokenDTO object, {
  ...
  void _deserializeProperties(
    ...
    required PANCAKESWAPV3ETHEREUMTokenDTOBuilder result,
  ...
  @override
  PANCAKESWAPV3ETHEREUMTokenDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PANCAKESWAPV3ETHEREUMTokenDTOBuilder();
