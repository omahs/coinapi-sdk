...
part 'uniswapv3_ethereum_tick_daily_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class UNISWAPV3ETHEREUMTickDailySnapshotDTO implements Built<UNISWAPV3ETHEREUMTickDailySnapshotDTO, UNISWAPV3ETHEREUMTickDailySnapshotDTOBuilder> {
  ...
  UNISWAPV3ETHEREUMTickDailySnapshotDTO._();

  factory UNISWAPV3ETHEREUMTickDailySnapshotDTO([void updates(UNISWAPV3ETHEREUMTickDailySnapshotDTOBuilder b)]) = _$UNISWAPV3ETHEREUMTickDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV3ETHEREUMTickDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV3ETHEREUMTickDailySnapshotDTO> get serializer => _$UNISWAPV3ETHEREUMTickDailySnapshotDTOSerializer();
}

class _$UNISWAPV3ETHEREUMTickDailySnapshotDTOSerializer implements PrimitiveSerializer<UNISWAPV3ETHEREUMTickDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV3ETHEREUMTickDailySnapshotDTO, _$UNISWAPV3ETHEREUMTickDailySnapshotDTO];

  @override
  final String wireName = r'UNISWAPV3ETHEREUMTickDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV3ETHEREUMTickDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV3ETHEREUMTickDailySnapshotDTOBuilder result,
  ...
  @override
  UNISWAPV3ETHEREUMTickDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV3ETHEREUMTickDailySnapshotDTOBuilder();
