...
part 'curvefinanceethereum_withdraw_dto.g.dart';
...
@BuiltValue()
abstract class CURVEFINANCEETHEREUMWithdrawDTO implements Built<CURVEFINANCEETHEREUMWithdrawDTO, CURVEFINANCEETHEREUMWithdrawDTOBuilder> {
  ...
  CURVEFINANCEETHEREUMWithdrawDTO._();

  factory CURVEFINANCEETHEREUMWithdrawDTO([void updates(CURVEFINANCEETHEREUMWithdrawDTOBuilder b)]) = _$CURVEFINANCEETHEREUMWithdrawDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CURVEFINANCEETHEREUMWithdrawDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CURVEFINANCEETHEREUMWithdrawDTO> get serializer => _$CURVEFINANCEETHEREUMWithdrawDTOSerializer();
}

class _$CURVEFINANCEETHEREUMWithdrawDTOSerializer implements PrimitiveSerializer<CURVEFINANCEETHEREUMWithdrawDTO> {
  @override
  final Iterable<Type> types = const [CURVEFINANCEETHEREUMWithdrawDTO, _$CURVEFINANCEETHEREUMWithdrawDTO];

  @override
  final String wireName = r'CURVEFINANCEETHEREUMWithdrawDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CURVEFINANCEETHEREUMWithdrawDTO object, {
  ...
  void _deserializeProperties(
    ...
    required CURVEFINANCEETHEREUMWithdrawDTOBuilder result,
  ...
  @override
  CURVEFINANCEETHEREUMWithdrawDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CURVEFINANCEETHEREUMWithdrawDTOBuilder();
