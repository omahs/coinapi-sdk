...
part 'uniswapv3_ethereum_position_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class UNISWAPV3ETHEREUMPositionSnapshotDTO implements Built<UNISWAPV3ETHEREUMPositionSnapshotDTO, UNISWAPV3ETHEREUMPositionSnapshotDTOBuilder> {
  ...
  UNISWAPV3ETHEREUMPositionSnapshotDTO._();

  factory UNISWAPV3ETHEREUMPositionSnapshotDTO([void updates(UNISWAPV3ETHEREUMPositionSnapshotDTOBuilder b)]) = _$UNISWAPV3ETHEREUMPositionSnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV3ETHEREUMPositionSnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV3ETHEREUMPositionSnapshotDTO> get serializer => _$UNISWAPV3ETHEREUMPositionSnapshotDTOSerializer();
}

class _$UNISWAPV3ETHEREUMPositionSnapshotDTOSerializer implements PrimitiveSerializer<UNISWAPV3ETHEREUMPositionSnapshotDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV3ETHEREUMPositionSnapshotDTO, _$UNISWAPV3ETHEREUMPositionSnapshotDTO];

  @override
  final String wireName = r'UNISWAPV3ETHEREUMPositionSnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV3ETHEREUMPositionSnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV3ETHEREUMPositionSnapshotDTOBuilder result,
  ...
  @override
  UNISWAPV3ETHEREUMPositionSnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV3ETHEREUMPositionSnapshotDTOBuilder();
