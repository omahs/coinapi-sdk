...
part 'uniswapv3_ethereum_liquidity_pool_hourly_snapshot_dto.g.dart';
...
@BuiltValue()
abstract class UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO implements Built<UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO, UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTOBuilder> {
  ...
  UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO._();

  factory UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO([void updates(UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTOBuilder b)]) = _$UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO> get serializer => _$UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTOSerializer();
}

class _$UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTOSerializer implements PrimitiveSerializer<UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO, _$UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO];

  @override
  final String wireName = r'UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTOBuilder result,
  ...
  @override
  UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTOBuilder();
