...
part 'uniswapv2_ethereum_deposit_dto.g.dart';
...
/// * [blockRange] - 
@BuiltValue()
abstract class UNISWAPV2ETHEREUMDepositDTO implements Built<UNISWAPV2ETHEREUMDepositDTO, UNISWAPV2ETHEREUMDepositDTOBuilder> {
  ...
  UNISWAPV2ETHEREUMDepositDTO._();

  factory UNISWAPV2ETHEREUMDepositDTO([void updates(UNISWAPV2ETHEREUMDepositDTOBuilder b)]) = _$UNISWAPV2ETHEREUMDepositDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV2ETHEREUMDepositDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV2ETHEREUMDepositDTO> get serializer => _$UNISWAPV2ETHEREUMDepositDTOSerializer();
}

class _$UNISWAPV2ETHEREUMDepositDTOSerializer implements PrimitiveSerializer<UNISWAPV2ETHEREUMDepositDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV2ETHEREUMDepositDTO, _$UNISWAPV2ETHEREUMDepositDTO];

  @override
  final String wireName = r'UNISWAPV2ETHEREUMDepositDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV2ETHEREUMDepositDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV2ETHEREUMDepositDTOBuilder result,
  ...
  @override
  UNISWAPV2ETHEREUMDepositDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV2ETHEREUMDepositDTOBuilder();
