...
part 'uniswapv2_ethereum_financials_daily_snapshot_dto.g.dart';
...
/// * [dailyTotalRevenueUsd] - ll revenue generated by the protocol. e.g. 0.30% of swap fee in Sushiswap, all yield generated by Yearn.
...
@BuiltValue()
abstract class UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO implements Built<UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO, UNISWAPV2ETHEREUMFinancialsDailySnapshotDTOBuilder> {
  ...
  UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO._();

  factory UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO([void updates(UNISWAPV2ETHEREUMFinancialsDailySnapshotDTOBuilder b)]) = _$UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV2ETHEREUMFinancialsDailySnapshotDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO> get serializer => _$UNISWAPV2ETHEREUMFinancialsDailySnapshotDTOSerializer();
}

class _$UNISWAPV2ETHEREUMFinancialsDailySnapshotDTOSerializer implements PrimitiveSerializer<UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO, _$UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO];

  @override
  final String wireName = r'UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV2ETHEREUMFinancialsDailySnapshotDTOBuilder result,
  ...
  @override
  UNISWAPV2ETHEREUMFinancialsDailySnapshotDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV2ETHEREUMFinancialsDailySnapshotDTOBuilder();
