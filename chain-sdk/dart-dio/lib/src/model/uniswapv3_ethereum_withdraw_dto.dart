...
part 'uniswapv3_ethereum_withdraw_dto.g.dart';
...
@BuiltValue()
abstract class UNISWAPV3ETHEREUMWithdrawDTO implements Built<UNISWAPV3ETHEREUMWithdrawDTO, UNISWAPV3ETHEREUMWithdrawDTOBuilder> {
  ...
  UNISWAPV3ETHEREUMWithdrawDTO._();

  factory UNISWAPV3ETHEREUMWithdrawDTO([void updates(UNISWAPV3ETHEREUMWithdrawDTOBuilder b)]) = _$UNISWAPV3ETHEREUMWithdrawDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UNISWAPV3ETHEREUMWithdrawDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UNISWAPV3ETHEREUMWithdrawDTO> get serializer => _$UNISWAPV3ETHEREUMWithdrawDTOSerializer();
}

class _$UNISWAPV3ETHEREUMWithdrawDTOSerializer implements PrimitiveSerializer<UNISWAPV3ETHEREUMWithdrawDTO> {
  @override
  final Iterable<Type> types = const [UNISWAPV3ETHEREUMWithdrawDTO, _$UNISWAPV3ETHEREUMWithdrawDTO];

  @override
  final String wireName = r'UNISWAPV3ETHEREUMWithdrawDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UNISWAPV3ETHEREUMWithdrawDTO object, {
  ...
  void _deserializeProperties(
    ...
    required UNISWAPV3ETHEREUMWithdrawDTOBuilder result,
  ...
  @override
  UNISWAPV3ETHEREUMWithdrawDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UNISWAPV3ETHEREUMWithdrawDTOBuilder();
