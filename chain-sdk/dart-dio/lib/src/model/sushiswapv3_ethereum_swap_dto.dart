...
part 'sushiswapv3_ethereum_swap_dto.g.dart';
...
/// * [evaluatedAggressor] 
@BuiltValue()
abstract class SUSHISWAPV3ETHEREUMSwapDTO implements Built<SUSHISWAPV3ETHEREUMSwapDTO, SUSHISWAPV3ETHEREUMSwapDTOBuilder> {
  ...
  SUSHISWAPV3ETHEREUMSwapDTO._();

  factory SUSHISWAPV3ETHEREUMSwapDTO([void updates(SUSHISWAPV3ETHEREUMSwapDTOBuilder b)]) = _$SUSHISWAPV3ETHEREUMSwapDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SUSHISWAPV3ETHEREUMSwapDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SUSHISWAPV3ETHEREUMSwapDTO> get serializer => _$SUSHISWAPV3ETHEREUMSwapDTOSerializer();
}

class _$SUSHISWAPV3ETHEREUMSwapDTOSerializer implements PrimitiveSerializer<SUSHISWAPV3ETHEREUMSwapDTO> {
  @override
  final Iterable<Type> types = const [SUSHISWAPV3ETHEREUMSwapDTO, _$SUSHISWAPV3ETHEREUMSwapDTO];

  @override
  final String wireName = r'SUSHISWAPV3ETHEREUMSwapDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SUSHISWAPV3ETHEREUMSwapDTO object, {
  ...
  void _deserializeProperties(
    ...
    required SUSHISWAPV3ETHEREUMSwapDTOBuilder result,
  ...
  @override
  SUSHISWAPV3ETHEREUMSwapDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SUSHISWAPV3ETHEREUMSwapDTOBuilder();
