...
// tests for PANCAKESWAPV3ETHEREUMTokenWhiteListDTO
void main() {
  final instance = PANCAKESWAPV3ETHEREUMTokenWhiteListDTOBuilder();
  // TODO add properties to the builder and call build()

  group(PANCAKESWAPV3ETHEREUMTokenWhiteListDTO, () {
    // DateTime entryTime
