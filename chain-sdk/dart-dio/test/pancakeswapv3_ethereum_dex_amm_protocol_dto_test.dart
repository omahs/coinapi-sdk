...
// tests for PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO
void main() {
  final instance = PANCAKESWAPV3ETHEREUMDexAmmProtocolDTOBuilder();
  // TODO add properties to the builder and call build()

  group(PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO, () {
    // DateTime entryTime
