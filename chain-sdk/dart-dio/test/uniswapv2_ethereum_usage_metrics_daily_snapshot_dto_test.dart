...
// tests for UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
void main() {
  final instance = UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO, () {
    // DateTime entryTime
