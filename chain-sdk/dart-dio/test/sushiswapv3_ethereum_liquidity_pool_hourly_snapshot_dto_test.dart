...
// tests for SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO
void main() {
  final instance = SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO, () {
    // DateTime entryTime
