...
// tests for CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO
void main() {
  final instance = CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO, () {
    // DateTime entryTime
