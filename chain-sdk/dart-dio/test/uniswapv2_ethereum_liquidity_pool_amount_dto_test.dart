...
// tests for UNISWAPV2ETHEREUMLiquidityPoolAmountDTO
void main() {
  final instance = UNISWAPV2ETHEREUMLiquidityPoolAmountDTOBuilder();
  // TODO add properties to the builder and call build()

  group(UNISWAPV2ETHEREUMLiquidityPoolAmountDTO, () {
    // DateTime entryTime
