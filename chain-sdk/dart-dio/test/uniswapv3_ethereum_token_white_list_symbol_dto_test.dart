...
// tests for UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO
void main() {
  final instance = UNISWAPV3ETHEREUMTokenWhiteListSymbolDTOBuilder();
  // TODO add properties to the builder and call build()

  group(UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO, () {
    // DateTime entryTime
