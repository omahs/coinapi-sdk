...
// tests for SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
void main() {
  final instance = SUSHISWAPV3ETHEREUMTickDailySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(SUSHISWAPV3ETHEREUMTickDailySnapshotDTO, () {
    // DateTime entryTime
