...
// tests for UNISWAPV3ETHEREUMTickHourlySnapshotDTO
void main() {
  final instance = UNISWAPV3ETHEREUMTickHourlySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(UNISWAPV3ETHEREUMTickHourlySnapshotDTO, () {
    // DateTime entryTime
