...
// tests for SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO
void main() {
  final instance = SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTOBuilder();
  // TODO add properties to the builder and call build()

  group(SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO, () {
    // DateTime entryTime
