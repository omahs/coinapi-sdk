...
// tests for SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
void main() {
  final instance = SUSHISWAPV3ETHEREUMTickHourlySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO, () {
    // DateTime entryTime
