...
// tests for SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO
void main() {
  final instance = SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO, () {
    // DateTime entryTime
