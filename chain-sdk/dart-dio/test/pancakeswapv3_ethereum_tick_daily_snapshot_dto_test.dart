...
// tests for PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
void main() {
  final instance = PANCAKESWAPV3ETHEREUMTickDailySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO, () {
    // DateTime entryTime
    ...
    // int dayId
    test('to test the property `dayId`', () async {
      // TODO
    });
