...
// tests for UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
void main() {
  final instance = UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO, () {
    // DateTime entryTime
