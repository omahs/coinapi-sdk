...
// tests for SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
void main() {
  final instance = SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO, () {
    // DateTime entryTime
