...
// tests for SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTO
void main() {
  final instance = SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTOBuilder();
  // TODO add properties to the builder and call build()

  group(SUSHISWAPV3ETHEREUMTokenWhiteListSymbolDTO, () {
    // DateTime entryTime
