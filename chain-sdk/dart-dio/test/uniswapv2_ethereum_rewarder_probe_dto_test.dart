...
// tests for UNISWAPV2ETHEREUMRewarderProbeDTO
void main() {
  final instance = UNISWAPV2ETHEREUMRewarderProbeDTOBuilder();
  // TODO add properties to the builder and call build()

  group(UNISWAPV2ETHEREUMRewarderProbeDTO, () {
    // DateTime entryTime
    ...
    // String blockNum
    test('to test the property `blockNum`', () async {
      // TODO
    });
    ...
    // String lpStaked
    test('to test the property `lpStaked`', () async {
      // TODO
    });
