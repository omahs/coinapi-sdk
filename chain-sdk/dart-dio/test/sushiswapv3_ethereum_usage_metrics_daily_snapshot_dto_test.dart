...
// tests for SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
void main() {
  final instance = SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO, () {
    // DateTime entryTime
