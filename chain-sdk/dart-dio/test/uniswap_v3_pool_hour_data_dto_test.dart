...
// tests for UniswapV3PoolHourDataDTO
void main() {
  final instance = UniswapV3PoolHourDataDTOBuilder();
  // TODO add properties to the builder and call build()

  group(UniswapV3PoolHourDataDTO, () {
    // DateTime entryTime
    ...
    // String sqrtPrice
    test('to test the property `sqrtPrice`', () async {
      // TODO
    });
    ...
    test('to test the property `feeGrowthGlobal0x128`', () async {
      // TODO
    });

    // Tracker for global fee growth.
    // String feeGrowthGlobal1x128
    test('to test the property `feeGrowthGlobal1x128`', () async {
      // TODO
    });
