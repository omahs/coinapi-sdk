...
// tests for UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
void main() {
  final instance = UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTOBuilder();
  // TODO add properties to the builder and call build()

  group(UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO, () {
    // DateTime entryTime
