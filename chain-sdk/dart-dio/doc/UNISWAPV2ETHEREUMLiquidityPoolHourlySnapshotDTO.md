...
**hourlyVolumeByTokenUsd** | **BuiltList&lt;String&gt;** | All trade volume occurred in a given hour for a specific input token, in native amount. The ordering should be the same as the pool's 'inputTokens' field. | [optional] 
