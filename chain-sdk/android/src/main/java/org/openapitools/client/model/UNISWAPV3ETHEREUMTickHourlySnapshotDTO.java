...
public class UNISWAPV3ETHEREUMTickHourlySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.entryTime == null : this.entryTime.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.recvTime == null : this.recvTime.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.blockNumber == null : this.blockNumber.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.blockNumber)) &&
        (this.vid == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.vid == null : this.vid.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.vid)) &&
        (this.id == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.id == null : this.id.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.id)) &&
        (this.hourId == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.hourId == null : this.hourId.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.hourId)) &&
        (this.tick == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.tick == null : this.tick.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.tick)) &&
        (this.pool == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.pool == null : this.pool.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.pool)) &&
        (this.liquidityGross == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityGross == null : this.liquidityGross.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityGross)) &&
        (this.liquidityGrossUsd == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityGrossUsd == null : this.liquidityGrossUsd.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityGrossUsd)) &&
        (this.liquidityNet == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityNet == null : this.liquidityNet.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityNet)) &&
        (this.liquidityNetUsd == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityNetUsd == null : this.liquidityNetUsd.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityNetUsd)) &&
        (this.timestamp == null ? uNISWAPV3ETHEREUMTickHourlySnapshotDTO.timestamp == null : this.timestamp.equals(uNISWAPV3ETHEREUMTickHourlySnapshotDTO.timestamp));
  }
