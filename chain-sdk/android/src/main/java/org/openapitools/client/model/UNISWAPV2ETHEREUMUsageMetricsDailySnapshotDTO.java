...
public class UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.entryTime == null : this.entryTime.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.recvTime == null : this.recvTime.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.blockNumber == null : this.blockNumber.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.blockNumber)) &&
        (this.blockRange == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.blockRange == null : this.blockRange.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.blockRange)) &&
        (this.id == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.id == null : this.id.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.id)) &&
        (this.protocol == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.protocol == null : this.protocol.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.protocol)) &&
        (this.dailyActiveUsers == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailyActiveUsers == null : this.dailyActiveUsers.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailyActiveUsers)) &&
        (this.cumulativeUniqueUsers == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.cumulativeUniqueUsers == null : this.cumulativeUniqueUsers.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.cumulativeUniqueUsers)) &&
        (this.dailyTransactionCount == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailyTransactionCount == null : this.dailyTransactionCount.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailyTransactionCount)) &&
        (this.dailyDepositCount == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailyDepositCount == null : this.dailyDepositCount.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailyDepositCount)) &&
        (this.dailyWithdrawCount == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailyWithdrawCount == null : this.dailyWithdrawCount.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailyWithdrawCount)) &&
        (this.dailySwapCount == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailySwapCount == null : this.dailySwapCount.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.dailySwapCount)) &&
        (this.totalPoolCount == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.totalPoolCount == null : this.totalPoolCount.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.totalPoolCount)) &&
        (this.timestamp == null ? uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.timestamp == null : this.timestamp.equals(uNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO.timestamp));
  }
