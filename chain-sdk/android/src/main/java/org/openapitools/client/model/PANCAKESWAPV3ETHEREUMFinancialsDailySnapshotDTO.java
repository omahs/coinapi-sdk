 ...
 **/
@ApiModel(description = "Daily financial metrics for PancakeSwap V3.")
public class PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.entryTime == null : this.entryTime.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.recvTime == null : this.recvTime.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.blockNumber == null : this.blockNumber.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.blockNumber)) &&
        (this.id == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.id == null : this.id.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.id)) &&
        (this.day == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.day == null : this.day.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.day)) &&
        (this.protocol == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocol == null : this.protocol.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocol)) &&
        (this.totalValueLockedUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalValueLockedUsd == null : this.totalValueLockedUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalValueLockedUsd)) &&
        (this.totalLiquidityUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalLiquidityUsd == null : this.totalLiquidityUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalLiquidityUsd)) &&
        (this.activeLiquidityUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.activeLiquidityUsd == null : this.activeLiquidityUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.activeLiquidityUsd)) &&
        (this.uncollectedProtocolSideValueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedProtocolSideValueUsd == null : this.uncollectedProtocolSideValueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedProtocolSideValueUsd)) &&
        (this.uncollectedSupplySideValueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedSupplySideValueUsd == null : this.uncollectedSupplySideValueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedSupplySideValueUsd)) &&
        (this.protocolControlledValueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocolControlledValueUsd == null : this.protocolControlledValueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocolControlledValueUsd)) &&
        (this.dailyVolumeUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyVolumeUsd == null : this.dailyVolumeUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyVolumeUsd)) &&
        (this.cumulativeVolumeUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeVolumeUsd == null : this.cumulativeVolumeUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeVolumeUsd)) &&
        (this.dailySupplySideRevenueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailySupplySideRevenueUsd == null : this.dailySupplySideRevenueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailySupplySideRevenueUsd)) &&
        (this.cumulativeSupplySideRevenueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeSupplySideRevenueUsd == null : this.cumulativeSupplySideRevenueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeSupplySideRevenueUsd)) &&
        (this.dailyProtocolSideRevenueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyProtocolSideRevenueUsd == null : this.dailyProtocolSideRevenueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyProtocolSideRevenueUsd)) &&
        (this.cumulativeProtocolSideRevenueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeProtocolSideRevenueUsd == null : this.cumulativeProtocolSideRevenueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeProtocolSideRevenueUsd)) &&
        (this.dailyTotalRevenueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyTotalRevenueUsd == null : this.dailyTotalRevenueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyTotalRevenueUsd)) &&
        (this.cumulativeTotalRevenueUsd == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeTotalRevenueUsd == null : this.cumulativeTotalRevenueUsd.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeTotalRevenueUsd)) &&
        (this.timestamp == null ? pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.timestamp == null : this.timestamp.equals(pANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO.timestamp));
  }
