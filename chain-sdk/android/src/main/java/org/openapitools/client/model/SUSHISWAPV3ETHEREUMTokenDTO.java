...
public class SUSHISWAPV3ETHEREUMTokenDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMTokenDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMTokenDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMTokenDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMTokenDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMTokenDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMTokenDTO.blockNumber)) &&
        (this.vid == null ? sUSHISWAPV3ETHEREUMTokenDTO.vid == null : this.vid.equals(sUSHISWAPV3ETHEREUMTokenDTO.vid)) &&
        (this.blockRange == null ? sUSHISWAPV3ETHEREUMTokenDTO.blockRange == null : this.blockRange.equals(sUSHISWAPV3ETHEREUMTokenDTO.blockRange)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMTokenDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMTokenDTO.id)) &&
        (this.name == null ? sUSHISWAPV3ETHEREUMTokenDTO.name == null : this.name.equals(sUSHISWAPV3ETHEREUMTokenDTO.name)) &&
        (this.symbol == null ? sUSHISWAPV3ETHEREUMTokenDTO.symbol == null : this.symbol.equals(sUSHISWAPV3ETHEREUMTokenDTO.symbol)) &&
        (this.decimals == null ? sUSHISWAPV3ETHEREUMTokenDTO.decimals == null : this.decimals.equals(sUSHISWAPV3ETHEREUMTokenDTO.decimals)) &&
        (this.lastPriceUsd == null ? sUSHISWAPV3ETHEREUMTokenDTO.lastPriceUsd == null : this.lastPriceUsd.equals(sUSHISWAPV3ETHEREUMTokenDTO.lastPriceUsd)) &&
        (this.lastPriceBlockNumber == null ? sUSHISWAPV3ETHEREUMTokenDTO.lastPriceBlockNumber == null : this.lastPriceBlockNumber.equals(sUSHISWAPV3ETHEREUMTokenDTO.lastPriceBlockNumber)) &&
        (this.lastPricePool == null ? sUSHISWAPV3ETHEREUMTokenDTO.lastPricePool == null : this.lastPricePool.equals(sUSHISWAPV3ETHEREUMTokenDTO.lastPricePool)) &&
        (this.totalSupply == null ? sUSHISWAPV3ETHEREUMTokenDTO.totalSupply == null : this.totalSupply.equals(sUSHISWAPV3ETHEREUMTokenDTO.totalSupply)) &&
        (this.totalValueLockedUsd == null ? sUSHISWAPV3ETHEREUMTokenDTO.totalValueLockedUsd == null : this.totalValueLockedUsd.equals(sUSHISWAPV3ETHEREUMTokenDTO.totalValueLockedUsd)) &&
        (this.largePriceChangeBuffer == null ? sUSHISWAPV3ETHEREUMTokenDTO.largePriceChangeBuffer == null : this.largePriceChangeBuffer.equals(sUSHISWAPV3ETHEREUMTokenDTO.largePriceChangeBuffer)) &&
        (this.largeTvlImpactBuffer == null ? sUSHISWAPV3ETHEREUMTokenDTO.largeTvlImpactBuffer == null : this.largeTvlImpactBuffer.equals(sUSHISWAPV3ETHEREUMTokenDTO.largeTvlImpactBuffer)) &&
        (this.tokenSymbol == null ? sUSHISWAPV3ETHEREUMTokenDTO.tokenSymbol == null : this.tokenSymbol.equals(sUSHISWAPV3ETHEREUMTokenDTO.tokenSymbol));
  }
