...
public class SUSHISWAPV3ETHEREUMDexAmmProtocolDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.blockNumber)) &&
        (this.blockRange == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.blockRange == null : this.blockRange.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.blockRange)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.id)) &&
        (this.name == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.name == null : this.name.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.name)) &&
        (this.slug == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.slug == null : this.slug.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.slug)) &&
        (this.schemaVersion == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.schemaVersion == null : this.schemaVersion.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.schemaVersion)) &&
        (this.subgraphVersion == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.subgraphVersion == null : this.subgraphVersion.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.subgraphVersion)) &&
        (this.methodologyVersion == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.methodologyVersion == null : this.methodologyVersion.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.methodologyVersion)) &&
        (this.totalValueLockedUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.totalValueLockedUsd == null : this.totalValueLockedUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.totalValueLockedUsd)) &&
        (this.totalLiquidityUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.totalLiquidityUsd == null : this.totalLiquidityUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.totalLiquidityUsd)) &&
        (this.activeLiquidityUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.activeLiquidityUsd == null : this.activeLiquidityUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.activeLiquidityUsd)) &&
        (this.uncollectedProtocolSideValueUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.uncollectedProtocolSideValueUsd == null : this.uncollectedProtocolSideValueUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.uncollectedProtocolSideValueUsd)) &&
        (this.uncollectedSupplySideValueUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.uncollectedSupplySideValueUsd == null : this.uncollectedSupplySideValueUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.uncollectedSupplySideValueUsd)) &&
        (this.protocolControlledValueUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.protocolControlledValueUsd == null : this.protocolControlledValueUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.protocolControlledValueUsd)) &&
        (this.cumulativeVolumeUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeVolumeUsd == null : this.cumulativeVolumeUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeVolumeUsd)) &&
        (this.cumulativeSupplySideRevenueUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeSupplySideRevenueUsd == null : this.cumulativeSupplySideRevenueUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeSupplySideRevenueUsd)) &&
        (this.cumulativeProtocolSideRevenueUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeProtocolSideRevenueUsd == null : this.cumulativeProtocolSideRevenueUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeProtocolSideRevenueUsd)) &&
        (this.cumulativeTotalRevenueUsd == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeTotalRevenueUsd == null : this.cumulativeTotalRevenueUsd.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeTotalRevenueUsd)) &&
        (this.cumulativeUniqueUsers == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueUsers == null : this.cumulativeUniqueUsers.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueUsers)) &&
        (this.cumulativeUniqueLPs == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueLPs == null : this.cumulativeUniqueLPs.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueLPs)) &&
        (this.cumulativeUniqueTraders == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueTraders == null : this.cumulativeUniqueTraders.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativeUniqueTraders)) &&
        (this.totalPoolCount == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.totalPoolCount == null : this.totalPoolCount.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.totalPoolCount)) &&
        (this.openPositionCount == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.openPositionCount == null : this.openPositionCount.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.openPositionCount)) &&
        (this.cumulativePositionCount == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativePositionCount == null : this.cumulativePositionCount.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.cumulativePositionCount)) &&
        (this.lastSnapshotDayId == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.lastSnapshotDayId == null : this.lastSnapshotDayId.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.lastSnapshotDayId)) &&
        (this.lastUpdateTimestamp == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.lastUpdateTimestamp == null : this.lastUpdateTimestamp.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.lastUpdateTimestamp)) &&
        (this.lastUpdateBlockNumber == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.lastUpdateBlockNumber == null : this.lastUpdateBlockNumber.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.lastUpdateBlockNumber)) &&
        (this.regenesis == null ? sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.regenesis == null : this.regenesis.equals(sUSHISWAPV3ETHEREUMDexAmmProtocolDTO.regenesis));
  }
