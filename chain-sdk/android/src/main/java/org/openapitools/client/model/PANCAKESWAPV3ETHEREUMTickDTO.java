...
public class PANCAKESWAPV3ETHEREUMTickDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? pANCAKESWAPV3ETHEREUMTickDTO.entryTime == null : this.entryTime.equals(pANCAKESWAPV3ETHEREUMTickDTO.entryTime)) &&
        ...
        (this.createdTimestamp == null ? pANCAKESWAPV3ETHEREUMTickDTO.createdTimestamp == null : this.createdTimestamp.equals(pANCAKESWAPV3ETHEREUMTickDTO.createdTimestamp)) &&
        (this.createdBlockNumber == null ? pANCAKESWAPV3ETHEREUMTickDTO.createdBlockNumber == null : this.createdBlockNumber.equals(pANCAKESWAPV3ETHEREUMTickDTO.createdBlockNumber)) &&
        (this.prices == null ? pANCAKESWAPV3ETHEREUMTickDTO.prices == null : this.prices.equals(pANCAKESWAPV3ETHEREUMTickDTO.prices)) &&
        (this.liquidityGross == null ? pANCAKESWAPV3ETHEREUMTickDTO.liquidityGross == null : this.liquidityGross.equals(pANCAKESWAPV3ETHEREUMTickDTO.liquidityGross)) &&
        (this.liquidityGrossUsd == null ? pANCAKESWAPV3ETHEREUMTickDTO.liquidityGrossUsd == null : this.liquidityGrossUsd.equals(pANCAKESWAPV3ETHEREUMTickDTO.liquidityGrossUsd)) &&
        (this.liquidityNet == null ? pANCAKESWAPV3ETHEREUMTickDTO.liquidityNet == null : this.liquidityNet.equals(pANCAKESWAPV3ETHEREUMTickDTO.liquidityNet)) &&
        (this.liquidityNetUsd == null ? pANCAKESWAPV3ETHEREUMTickDTO.liquidityNetUsd == null : this.liquidityNetUsd.equals(pANCAKESWAPV3ETHEREUMTickDTO.liquidityNetUsd)) &&
        (this.lastSnapshotDayId == null ? pANCAKESWAPV3ETHEREUMTickDTO.lastSnapshotDayId == null : this.lastSnapshotDayId.equals(pANCAKESWAPV3ETHEREUMTickDTO.lastSnapshotDayId)) &&
        (this.lastSnapshotHourId == null ? pANCAKESWAPV3ETHEREUMTickDTO.lastSnapshotHourId == null : this.lastSnapshotHourId.equals(pANCAKESWAPV3ETHEREUMTickDTO.lastSnapshotHourId)) &&
        (this.lastUpdateTimestamp == null ? pANCAKESWAPV3ETHEREUMTickDTO.lastUpdateTimestamp == null : this.lastUpdateTimestamp.equals(pANCAKESWAPV3ETHEREUMTickDTO.lastUpdateTimestamp)) &&
        (this.lastUpdateBlockNumber == null ? pANCAKESWAPV3ETHEREUMTickDTO.lastUpdateBlockNumber == null : this.lastUpdateBlockNumber.equals(pANCAKESWAPV3ETHEREUMTickDTO.lastUpdateBlockNumber));
  }
