...
public class SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.blockNumber)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.id)) &&
        (this.day == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.day == null : this.day.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.day)) &&
        (this.protocol == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.protocol == null : this.protocol.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.protocol)) &&
        (this.dailyActiveUsers == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyActiveUsers == null : this.dailyActiveUsers.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyActiveUsers)) &&
        (this.cumulativeUniqueUsers == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.cumulativeUniqueUsers == null : this.cumulativeUniqueUsers.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.cumulativeUniqueUsers)) &&
        (this.dailyTransactionCount == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyTransactionCount == null : this.dailyTransactionCount.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyTransactionCount)) &&
        (this.totalPoolCount == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.totalPoolCount == null : this.totalPoolCount.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.totalPoolCount)) &&
        (this.dailyDepositCount == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyDepositCount == null : this.dailyDepositCount.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyDepositCount)) &&
        (this.dailyWithdrawCount == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyWithdrawCount == null : this.dailyWithdrawCount.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyWithdrawCount)) &&
        (this.dailySwapCount == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailySwapCount == null : this.dailySwapCount.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailySwapCount)) &&
        (this.timestamp == null ? sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.timestamp == null : this.timestamp.equals(sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.timestamp));
  }
