...
public class UNISWAPV3ETHEREUMPositionSnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.entryTime == null : this.entryTime.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.entryTime)) &&
        (this.recvTime == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.recvTime == null : this.recvTime.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.blockNumber == null : this.blockNumber.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.blockNumber)) &&
        (this.id == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.id == null : this.id.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.id)) &&
        (this.hash == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.hash == null : this.hash.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.hash)) &&
        (this.logIndex == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.logIndex == null : this.logIndex.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.logIndex)) &&
        (this.nonce == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.nonce == null : this.nonce.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.nonce)) &&
        (this.position == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.position == null : this.position.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.position)) &&
        (this.liquidityTokenType == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.liquidityTokenType == null : this.liquidityTokenType.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.liquidityTokenType)) &&
        (this.liquidity == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.liquidity == null : this.liquidity.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.liquidity)) &&
        (this.liquidityUsd == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.liquidityUsd == null : this.liquidityUsd.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.liquidityUsd)) &&
        (this.cumulativeDepositTokenAmounts == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositTokenAmounts == null : this.cumulativeDepositTokenAmounts.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositTokenAmounts)) &&
        (this.cumulativeDepositUsd == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositUsd == null : this.cumulativeDepositUsd.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositUsd)) &&
        (this.cumulativeWithdrawTokenAmounts == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawTokenAmounts == null : this.cumulativeWithdrawTokenAmounts.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawTokenAmounts)) &&
        (this.cumulativeWithdrawUsd == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawUsd == null : this.cumulativeWithdrawUsd.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawUsd)) &&
        (this.cumulativeRewardTokenAmounts == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardTokenAmounts == null : this.cumulativeRewardTokenAmounts.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardTokenAmounts)) &&
        (this.cumulativeRewardUsd == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardUsd == null : this.cumulativeRewardUsd.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardUsd)) &&
        (this.depositCount == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.depositCount == null : this.depositCount.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.depositCount)) &&
        (this.withdrawCount == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.withdrawCount == null : this.withdrawCount.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.withdrawCount)) &&
        (this.timestamp == null ? uNISWAPV3ETHEREUMPositionSnapshotDTO.timestamp == null : this.timestamp.equals(uNISWAPV3ETHEREUMPositionSnapshotDTO.timestamp));
  }
