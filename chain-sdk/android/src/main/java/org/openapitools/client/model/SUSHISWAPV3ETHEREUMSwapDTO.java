...
public class SUSHISWAPV3ETHEREUMSwapDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMSwapDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMSwapDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMSwapDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMSwapDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMSwapDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMSwapDTO.blockNumber)) &&
        (this.block == null ? sUSHISWAPV3ETHEREUMSwapDTO.block == null : this.block.equals(sUSHISWAPV3ETHEREUMSwapDTO.block)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMSwapDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMSwapDTO.id)) &&
        (this.hash == null ? sUSHISWAPV3ETHEREUMSwapDTO.hash == null : this.hash.equals(sUSHISWAPV3ETHEREUMSwapDTO.hash)) &&
        (this.nonce == null ? sUSHISWAPV3ETHEREUMSwapDTO.nonce == null : this.nonce.equals(sUSHISWAPV3ETHEREUMSwapDTO.nonce)) &&
        (this.logIndex == null ? sUSHISWAPV3ETHEREUMSwapDTO.logIndex == null : this.logIndex.equals(sUSHISWAPV3ETHEREUMSwapDTO.logIndex)) &&
        (this.gasLimit == null ? sUSHISWAPV3ETHEREUMSwapDTO.gasLimit == null : this.gasLimit.equals(sUSHISWAPV3ETHEREUMSwapDTO.gasLimit)) &&
        (this.gasUsed == null ? sUSHISWAPV3ETHEREUMSwapDTO.gasUsed == null : this.gasUsed.equals(sUSHISWAPV3ETHEREUMSwapDTO.gasUsed)) &&
        (this.gasPrice == null ? sUSHISWAPV3ETHEREUMSwapDTO.gasPrice == null : this.gasPrice.equals(sUSHISWAPV3ETHEREUMSwapDTO.gasPrice)) &&
        (this.protocol == null ? sUSHISWAPV3ETHEREUMSwapDTO.protocol == null : this.protocol.equals(sUSHISWAPV3ETHEREUMSwapDTO.protocol)) &&
        (this.account == null ? sUSHISWAPV3ETHEREUMSwapDTO.account == null : this.account.equals(sUSHISWAPV3ETHEREUMSwapDTO.account)) &&
        (this.pool == null ? sUSHISWAPV3ETHEREUMSwapDTO.pool == null : this.pool.equals(sUSHISWAPV3ETHEREUMSwapDTO.pool)) &&
        (this.timestamp == null ? sUSHISWAPV3ETHEREUMSwapDTO.timestamp == null : this.timestamp.equals(sUSHISWAPV3ETHEREUMSwapDTO.timestamp)) &&
        (this.tick == null ? sUSHISWAPV3ETHEREUMSwapDTO.tick == null : this.tick.equals(sUSHISWAPV3ETHEREUMSwapDTO.tick)) &&
        (this.tokenIn == null ? sUSHISWAPV3ETHEREUMSwapDTO.tokenIn == null : this.tokenIn.equals(sUSHISWAPV3ETHEREUMSwapDTO.tokenIn)) &&
        (this.amountIn == null ? sUSHISWAPV3ETHEREUMSwapDTO.amountIn == null : this.amountIn.equals(sUSHISWAPV3ETHEREUMSwapDTO.amountIn)) &&
        (this.amountInUsd == null ? sUSHISWAPV3ETHEREUMSwapDTO.amountInUsd == null : this.amountInUsd.equals(sUSHISWAPV3ETHEREUMSwapDTO.amountInUsd)) &&
        (this.tokenOut == null ? sUSHISWAPV3ETHEREUMSwapDTO.tokenOut == null : this.tokenOut.equals(sUSHISWAPV3ETHEREUMSwapDTO.tokenOut)) &&
        (this.amountOut == null ? sUSHISWAPV3ETHEREUMSwapDTO.amountOut == null : this.amountOut.equals(sUSHISWAPV3ETHEREUMSwapDTO.amountOut)) &&
        (this.amountOutUsd == null ? sUSHISWAPV3ETHEREUMSwapDTO.amountOutUsd == null : this.amountOutUsd.equals(sUSHISWAPV3ETHEREUMSwapDTO.amountOutUsd)) &&
        (this.reserveAmounts == null ? sUSHISWAPV3ETHEREUMSwapDTO.reserveAmounts == null : this.reserveAmounts.equals(sUSHISWAPV3ETHEREUMSwapDTO.reserveAmounts)) &&
        (this.poolId == null ? sUSHISWAPV3ETHEREUMSwapDTO.poolId == null : this.poolId.equals(sUSHISWAPV3ETHEREUMSwapDTO.poolId)) &&
        (this.transactionId == null ? sUSHISWAPV3ETHEREUMSwapDTO.transactionId == null : this.transactionId.equals(sUSHISWAPV3ETHEREUMSwapDTO.transactionId)) &&
        (this.evaluatedPrice == null ? sUSHISWAPV3ETHEREUMSwapDTO.evaluatedPrice == null : this.evaluatedPrice.equals(sUSHISWAPV3ETHEREUMSwapDTO.evaluatedPrice)) &&
        (this.evaluatedAmount == null ? sUSHISWAPV3ETHEREUMSwapDTO.evaluatedAmount == null : this.evaluatedAmount.equals(sUSHISWAPV3ETHEREUMSwapDTO.evaluatedAmount)) &&
        (this.evaluatedAggressor == null ? sUSHISWAPV3ETHEREUMSwapDTO.evaluatedAggressor == null : this.evaluatedAggressor.equals(sUSHISWAPV3ETHEREUMSwapDTO.evaluatedAggressor));
  }
