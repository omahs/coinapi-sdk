...
public class UNISWAPV2ETHEREUMWithdrawDTO {
   ...
   **/
  @ApiModelProperty(value = "Withdraw-(transaction hash)-(log index)")
  public String getId() {
    return id;
  }
   ...
   **/
  @ApiModelProperty(value = "Output token of the pool (not output token of the event/transaction). E.g. the UNI-LP token")
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uNISWAPV2ETHEREUMWithdrawDTO.entryTime == null : this.entryTime.equals(uNISWAPV2ETHEREUMWithdrawDTO.entryTime)) &&
        (this.recvTime == null ? uNISWAPV2ETHEREUMWithdrawDTO.recvTime == null : this.recvTime.equals(uNISWAPV2ETHEREUMWithdrawDTO.recvTime)) &&
        (this.blockNumber == null ? uNISWAPV2ETHEREUMWithdrawDTO.blockNumber == null : this.blockNumber.equals(uNISWAPV2ETHEREUMWithdrawDTO.blockNumber)) &&
        (this.block == null ? uNISWAPV2ETHEREUMWithdrawDTO.block == null : this.block.equals(uNISWAPV2ETHEREUMWithdrawDTO.block)) &&
        (this.id == null ? uNISWAPV2ETHEREUMWithdrawDTO.id == null : this.id.equals(uNISWAPV2ETHEREUMWithdrawDTO.id)) &&
        (this.hash == null ? uNISWAPV2ETHEREUMWithdrawDTO.hash == null : this.hash.equals(uNISWAPV2ETHEREUMWithdrawDTO.hash)) &&
        (this.logIndex == null ? uNISWAPV2ETHEREUMWithdrawDTO.logIndex == null : this.logIndex.equals(uNISWAPV2ETHEREUMWithdrawDTO.logIndex)) &&
        (this.protocol == null ? uNISWAPV2ETHEREUMWithdrawDTO.protocol == null : this.protocol.equals(uNISWAPV2ETHEREUMWithdrawDTO.protocol)) &&
        (this.to == null ? uNISWAPV2ETHEREUMWithdrawDTO.to == null : this.to.equals(uNISWAPV2ETHEREUMWithdrawDTO.to)) &&
        (this.from == null ? uNISWAPV2ETHEREUMWithdrawDTO.from == null : this.from.equals(uNISWAPV2ETHEREUMWithdrawDTO.from)) &&
        (this.timestamp == null ? uNISWAPV2ETHEREUMWithdrawDTO.timestamp == null : this.timestamp.equals(uNISWAPV2ETHEREUMWithdrawDTO.timestamp)) &&
        (this.inputTokens == null ? uNISWAPV2ETHEREUMWithdrawDTO.inputTokens == null : this.inputTokens.equals(uNISWAPV2ETHEREUMWithdrawDTO.inputTokens)) &&
        (this.outputToken == null ? uNISWAPV2ETHEREUMWithdrawDTO.outputToken == null : this.outputToken.equals(uNISWAPV2ETHEREUMWithdrawDTO.outputToken)) &&
        (this.inputTokenAmounts == null ? uNISWAPV2ETHEREUMWithdrawDTO.inputTokenAmounts == null : this.inputTokenAmounts.equals(uNISWAPV2ETHEREUMWithdrawDTO.inputTokenAmounts)) &&
        (this.outputTokenAmount == null ? uNISWAPV2ETHEREUMWithdrawDTO.outputTokenAmount == null : this.outputTokenAmount.equals(uNISWAPV2ETHEREUMWithdrawDTO.outputTokenAmount)) &&
        (this.reserveAmounts == null ? uNISWAPV2ETHEREUMWithdrawDTO.reserveAmounts == null : this.reserveAmounts.equals(uNISWAPV2ETHEREUMWithdrawDTO.reserveAmounts)) &&
        (this.amountUsd == null ? uNISWAPV2ETHEREUMWithdrawDTO.amountUsd == null : this.amountUsd.equals(uNISWAPV2ETHEREUMWithdrawDTO.amountUsd)) &&
        (this.pool == null ? uNISWAPV2ETHEREUMWithdrawDTO.pool == null : this.pool.equals(uNISWAPV2ETHEREUMWithdrawDTO.pool)) &&
        (this.blockRange == null ? uNISWAPV2ETHEREUMWithdrawDTO.blockRange == null : this.blockRange.equals(uNISWAPV2ETHEREUMWithdrawDTO.blockRange));
  }
