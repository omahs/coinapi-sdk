...
public class SUSHISWAPV3ETHEREUMTickDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMTickDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMTickDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMTickDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMTickDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMTickDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMTickDTO.blockNumber)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMTickDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMTickDTO.id)) &&
        (this.index == null ? sUSHISWAPV3ETHEREUMTickDTO.index == null : this.index.equals(sUSHISWAPV3ETHEREUMTickDTO.index)) &&
        (this.pool == null ? sUSHISWAPV3ETHEREUMTickDTO.pool == null : this.pool.equals(sUSHISWAPV3ETHEREUMTickDTO.pool)) &&
        (this.createdTimestamp == null ? sUSHISWAPV3ETHEREUMTickDTO.createdTimestamp == null : this.createdTimestamp.equals(sUSHISWAPV3ETHEREUMTickDTO.createdTimestamp)) &&
        (this.createdBlockNumber == null ? sUSHISWAPV3ETHEREUMTickDTO.createdBlockNumber == null : this.createdBlockNumber.equals(sUSHISWAPV3ETHEREUMTickDTO.createdBlockNumber)) &&
        (this.prices == null ? sUSHISWAPV3ETHEREUMTickDTO.prices == null : this.prices.equals(sUSHISWAPV3ETHEREUMTickDTO.prices)) &&
        (this.liquidityGross == null ? sUSHISWAPV3ETHEREUMTickDTO.liquidityGross == null : this.liquidityGross.equals(sUSHISWAPV3ETHEREUMTickDTO.liquidityGross)) &&
        (this.liquidityGrossUsd == null ? sUSHISWAPV3ETHEREUMTickDTO.liquidityGrossUsd == null : this.liquidityGrossUsd.equals(sUSHISWAPV3ETHEREUMTickDTO.liquidityGrossUsd)) &&
        (this.liquidityNet == null ? sUSHISWAPV3ETHEREUMTickDTO.liquidityNet == null : this.liquidityNet.equals(sUSHISWAPV3ETHEREUMTickDTO.liquidityNet)) &&
        (this.liquidityNetUsd == null ? sUSHISWAPV3ETHEREUMTickDTO.liquidityNetUsd == null : this.liquidityNetUsd.equals(sUSHISWAPV3ETHEREUMTickDTO.liquidityNetUsd)) &&
        (this.lastSnapshotDayId == null ? sUSHISWAPV3ETHEREUMTickDTO.lastSnapshotDayId == null : this.lastSnapshotDayId.equals(sUSHISWAPV3ETHEREUMTickDTO.lastSnapshotDayId)) &&
        (this.lastSnapshotHourId == null ? sUSHISWAPV3ETHEREUMTickDTO.lastSnapshotHourId == null : this.lastSnapshotHourId.equals(sUSHISWAPV3ETHEREUMTickDTO.lastSnapshotHourId)) &&
        (this.lastUpdateTimestamp == null ? sUSHISWAPV3ETHEREUMTickDTO.lastUpdateTimestamp == null : this.lastUpdateTimestamp.equals(sUSHISWAPV3ETHEREUMTickDTO.lastUpdateTimestamp)) &&
        (this.lastUpdateBlockNumber == null ? sUSHISWAPV3ETHEREUMTickDTO.lastUpdateBlockNumber == null : this.lastUpdateBlockNumber.equals(sUSHISWAPV3ETHEREUMTickDTO.lastUpdateBlockNumber));
  }
