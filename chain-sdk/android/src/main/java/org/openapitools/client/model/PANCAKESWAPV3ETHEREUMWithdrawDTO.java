...
public class PANCAKESWAPV3ETHEREUMWithdrawDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.entryTime == null : this.entryTime.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.entryTime)) &&
        (this.recvTime == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.recvTime == null : this.recvTime.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.recvTime)) &&
        (this.blockNumber == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.blockNumber == null : this.blockNumber.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.blockNumber)) &&
        (this.id == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.id == null : this.id.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.id)) &&
        (this.hash == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.hash == null : this.hash.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.hash)) &&
        (this.nonce == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.nonce == null : this.nonce.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.nonce)) &&
        (this.logIndex == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.logIndex == null : this.logIndex.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.logIndex)) &&
        (this.gasLimit == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.gasLimit == null : this.gasLimit.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.gasLimit)) &&
        (this.gasUsed == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.gasUsed == null : this.gasUsed.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.gasUsed)) &&
        (this.gasPrice == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.gasPrice == null : this.gasPrice.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.gasPrice)) &&
        (this.protocol == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.protocol == null : this.protocol.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.protocol)) &&
        (this.account == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.account == null : this.account.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.account)) &&
        (this.position == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.position == null : this.position.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.position)) &&
        (this.tickLower == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.tickLower == null : this.tickLower.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.tickLower)) &&
        (this.tickUpper == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.tickUpper == null : this.tickUpper.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.tickUpper)) &&
        (this.pool == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.pool == null : this.pool.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.pool)) &&
        (this.timestamp == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.timestamp == null : this.timestamp.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.timestamp)) &&
        (this.liquidity == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.liquidity == null : this.liquidity.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.liquidity)) &&
        (this.inputTokens == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.inputTokens == null : this.inputTokens.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.inputTokens)) &&
        (this.inputTokenAmounts == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.inputTokenAmounts == null : this.inputTokenAmounts.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.inputTokenAmounts)) &&
        (this.reserveAmounts == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.reserveAmounts == null : this.reserveAmounts.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.reserveAmounts)) &&
        (this.amountUsd == null ? pANCAKESWAPV3ETHEREUMWithdrawDTO.amountUsd == null : this.amountUsd.equals(pANCAKESWAPV3ETHEREUMWithdrawDTO.amountUsd));
  }
