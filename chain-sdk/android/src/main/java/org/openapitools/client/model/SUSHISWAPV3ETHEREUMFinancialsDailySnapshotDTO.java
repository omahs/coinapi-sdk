 ...
 **/
@ApiModel(description = "Daily financial metrics for Sushiswap V3.")
public class SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.blockNumber)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.id)) &&
        (this.day == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.day == null : this.day.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.day)) &&
        (this.protocol == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocol == null : this.protocol.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocol)) &&
        (this.totalValueLockedUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalValueLockedUsd == null : this.totalValueLockedUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalValueLockedUsd)) &&
        (this.totalLiquidityUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalLiquidityUsd == null : this.totalLiquidityUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.totalLiquidityUsd)) &&
        (this.activeLiquidityUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.activeLiquidityUsd == null : this.activeLiquidityUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.activeLiquidityUsd)) &&
        (this.uncollectedProtocolSideValueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedProtocolSideValueUsd == null : this.uncollectedProtocolSideValueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedProtocolSideValueUsd)) &&
        (this.uncollectedSupplySideValueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedSupplySideValueUsd == null : this.uncollectedSupplySideValueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.uncollectedSupplySideValueUsd)) &&
        (this.protocolControlledValueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocolControlledValueUsd == null : this.protocolControlledValueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.protocolControlledValueUsd)) &&
        (this.dailyVolumeUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyVolumeUsd == null : this.dailyVolumeUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyVolumeUsd)) &&
        (this.cumulativeVolumeUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeVolumeUsd == null : this.cumulativeVolumeUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeVolumeUsd)) &&
        (this.dailySupplySideRevenueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailySupplySideRevenueUsd == null : this.dailySupplySideRevenueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailySupplySideRevenueUsd)) &&
        (this.cumulativeSupplySideRevenueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeSupplySideRevenueUsd == null : this.cumulativeSupplySideRevenueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeSupplySideRevenueUsd)) &&
        (this.dailyProtocolSideRevenueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyProtocolSideRevenueUsd == null : this.dailyProtocolSideRevenueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyProtocolSideRevenueUsd)) &&
        (this.cumulativeProtocolSideRevenueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeProtocolSideRevenueUsd == null : this.cumulativeProtocolSideRevenueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeProtocolSideRevenueUsd)) &&
        (this.dailyTotalRevenueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyTotalRevenueUsd == null : this.dailyTotalRevenueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.dailyTotalRevenueUsd)) &&
        (this.cumulativeTotalRevenueUsd == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeTotalRevenueUsd == null : this.cumulativeTotalRevenueUsd.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.cumulativeTotalRevenueUsd)) &&
        (this.timestamp == null ? sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.timestamp == null : this.timestamp.equals(sUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO.timestamp));
  }
