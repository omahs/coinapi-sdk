...
public class UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.entryTime == null : this.entryTime.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.recvTime == null : this.recvTime.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.blockNumber == null : this.blockNumber.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.blockNumber)) &&
        (this.id == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.id == null : this.id.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.id)) &&
        (this.day == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.day == null : this.day.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.day)) &&
        (this.protocol == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.protocol == null : this.protocol.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.protocol)) &&
        (this.dailyActiveUsers == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyActiveUsers == null : this.dailyActiveUsers.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyActiveUsers)) &&
        (this.cumulativeUniqueUsers == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.cumulativeUniqueUsers == null : this.cumulativeUniqueUsers.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.cumulativeUniqueUsers)) &&
        (this.dailyTransactionCount == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyTransactionCount == null : this.dailyTransactionCount.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyTransactionCount)) &&
        (this.totalPoolCount == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.totalPoolCount == null : this.totalPoolCount.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.totalPoolCount)) &&
        (this.dailyDepositCount == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyDepositCount == null : this.dailyDepositCount.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyDepositCount)) &&
        (this.dailyWithdrawCount == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyWithdrawCount == null : this.dailyWithdrawCount.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailyWithdrawCount)) &&
        (this.dailySwapCount == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailySwapCount == null : this.dailySwapCount.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.dailySwapCount)) &&
        (this.timestamp == null ? uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.timestamp == null : this.timestamp.equals(uNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO.timestamp));
  }
