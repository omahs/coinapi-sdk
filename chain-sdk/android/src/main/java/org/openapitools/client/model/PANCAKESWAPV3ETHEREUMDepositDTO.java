...
public class PANCAKESWAPV3ETHEREUMDepositDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? pANCAKESWAPV3ETHEREUMDepositDTO.entryTime == null : this.entryTime.equals(pANCAKESWAPV3ETHEREUMDepositDTO.entryTime)) &&
        (this.recvTime == null ? pANCAKESWAPV3ETHEREUMDepositDTO.recvTime == null : this.recvTime.equals(pANCAKESWAPV3ETHEREUMDepositDTO.recvTime)) &&
        (this.blockNumber == null ? pANCAKESWAPV3ETHEREUMDepositDTO.blockNumber == null : this.blockNumber.equals(pANCAKESWAPV3ETHEREUMDepositDTO.blockNumber)) &&
        (this.block == null ? pANCAKESWAPV3ETHEREUMDepositDTO.block == null : this.block.equals(pANCAKESWAPV3ETHEREUMDepositDTO.block)) &&
        (this.id == null ? pANCAKESWAPV3ETHEREUMDepositDTO.id == null : this.id.equals(pANCAKESWAPV3ETHEREUMDepositDTO.id)) &&
        (this.hash == null ? pANCAKESWAPV3ETHEREUMDepositDTO.hash == null : this.hash.equals(pANCAKESWAPV3ETHEREUMDepositDTO.hash)) &&
        (this.nonce == null ? pANCAKESWAPV3ETHEREUMDepositDTO.nonce == null : this.nonce.equals(pANCAKESWAPV3ETHEREUMDepositDTO.nonce)) &&
        (this.logIndex == null ? pANCAKESWAPV3ETHEREUMDepositDTO.logIndex == null : this.logIndex.equals(pANCAKESWAPV3ETHEREUMDepositDTO.logIndex)) &&
        (this.gasLimit == null ? pANCAKESWAPV3ETHEREUMDepositDTO.gasLimit == null : this.gasLimit.equals(pANCAKESWAPV3ETHEREUMDepositDTO.gasLimit)) &&
        (this.gasUsed == null ? pANCAKESWAPV3ETHEREUMDepositDTO.gasUsed == null : this.gasUsed.equals(pANCAKESWAPV3ETHEREUMDepositDTO.gasUsed)) &&
        (this.gasPrice == null ? pANCAKESWAPV3ETHEREUMDepositDTO.gasPrice == null : this.gasPrice.equals(pANCAKESWAPV3ETHEREUMDepositDTO.gasPrice)) &&
        (this.protocol == null ? pANCAKESWAPV3ETHEREUMDepositDTO.protocol == null : this.protocol.equals(pANCAKESWAPV3ETHEREUMDepositDTO.protocol)) &&
        (this.account == null ? pANCAKESWAPV3ETHEREUMDepositDTO.account == null : this.account.equals(pANCAKESWAPV3ETHEREUMDepositDTO.account)) &&
        (this.position == null ? pANCAKESWAPV3ETHEREUMDepositDTO.position == null : this.position.equals(pANCAKESWAPV3ETHEREUMDepositDTO.position)) &&
        (this.pool == null ? pANCAKESWAPV3ETHEREUMDepositDTO.pool == null : this.pool.equals(pANCAKESWAPV3ETHEREUMDepositDTO.pool)) &&
        (this.tickLower == null ? pANCAKESWAPV3ETHEREUMDepositDTO.tickLower == null : this.tickLower.equals(pANCAKESWAPV3ETHEREUMDepositDTO.tickLower)) &&
        (this.tickUpper == null ? pANCAKESWAPV3ETHEREUMDepositDTO.tickUpper == null : this.tickUpper.equals(pANCAKESWAPV3ETHEREUMDepositDTO.tickUpper)) &&
        (this.timestamp == null ? pANCAKESWAPV3ETHEREUMDepositDTO.timestamp == null : this.timestamp.equals(pANCAKESWAPV3ETHEREUMDepositDTO.timestamp)) &&
        (this.liquidity == null ? pANCAKESWAPV3ETHEREUMDepositDTO.liquidity == null : this.liquidity.equals(pANCAKESWAPV3ETHEREUMDepositDTO.liquidity)) &&
        (this.inputTokens == null ? pANCAKESWAPV3ETHEREUMDepositDTO.inputTokens == null : this.inputTokens.equals(pANCAKESWAPV3ETHEREUMDepositDTO.inputTokens)) &&
        (this.inputTokenAmounts == null ? pANCAKESWAPV3ETHEREUMDepositDTO.inputTokenAmounts == null : this.inputTokenAmounts.equals(pANCAKESWAPV3ETHEREUMDepositDTO.inputTokenAmounts)) &&
        (this.reserveAmounts == null ? pANCAKESWAPV3ETHEREUMDepositDTO.reserveAmounts == null : this.reserveAmounts.equals(pANCAKESWAPV3ETHEREUMDepositDTO.reserveAmounts)) &&
        (this.amountUsd == null ? pANCAKESWAPV3ETHEREUMDepositDTO.amountUsd == null : this.amountUsd.equals(pANCAKESWAPV3ETHEREUMDepositDTO.amountUsd)) &&
        (this.blockRange == null ? pANCAKESWAPV3ETHEREUMDepositDTO.blockRange == null : this.blockRange.equals(pANCAKESWAPV3ETHEREUMDepositDTO.blockRange));
  }
