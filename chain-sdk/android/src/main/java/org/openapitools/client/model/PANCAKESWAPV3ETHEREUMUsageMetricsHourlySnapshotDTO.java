...
public class PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.entryTime == null : this.entryTime.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.recvTime == null : this.recvTime.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.blockNumber == null : this.blockNumber.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.blockNumber)) &&
        (this.id == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.id == null : this.id.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.id)) &&
        (this.hour == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hour == null : this.hour.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hour)) &&
        (this.protocol == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.protocol == null : this.protocol.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.protocol)) &&
        (this.hourlyActiveUsers == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlyActiveUsers == null : this.hourlyActiveUsers.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlyActiveUsers)) &&
        (this.cumulativeUniqueUsers == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.cumulativeUniqueUsers == null : this.cumulativeUniqueUsers.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.cumulativeUniqueUsers)) &&
        (this.hourlyTransactionCount == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlyTransactionCount == null : this.hourlyTransactionCount.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlyTransactionCount)) &&
        (this.hourlyDepositCount == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlyDepositCount == null : this.hourlyDepositCount.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlyDepositCount)) &&
        (this.hourlyWithdrawCount == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlyWithdrawCount == null : this.hourlyWithdrawCount.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlyWithdrawCount)) &&
        (this.hourlySwapCount == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlySwapCount == null : this.hourlySwapCount.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.hourlySwapCount)) &&
        (this.timestamp == null ? pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.timestamp == null : this.timestamp.equals(pANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO.timestamp));
  }
