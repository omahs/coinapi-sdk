...
public class SUSHISWAPV3ETHEREUMPositionDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMPositionDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMPositionDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMPositionDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMPositionDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMPositionDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMPositionDTO.blockNumber)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMPositionDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMPositionDTO.id)) &&
        (this.account == null ? sUSHISWAPV3ETHEREUMPositionDTO.account == null : this.account.equals(sUSHISWAPV3ETHEREUMPositionDTO.account)) &&
        (this.pool == null ? sUSHISWAPV3ETHEREUMPositionDTO.pool == null : this.pool.equals(sUSHISWAPV3ETHEREUMPositionDTO.pool)) &&
        (this.hashOpened == null ? sUSHISWAPV3ETHEREUMPositionDTO.hashOpened == null : this.hashOpened.equals(sUSHISWAPV3ETHEREUMPositionDTO.hashOpened)) &&
        (this.hashClosed == null ? sUSHISWAPV3ETHEREUMPositionDTO.hashClosed == null : this.hashClosed.equals(sUSHISWAPV3ETHEREUMPositionDTO.hashClosed)) &&
        (this.blockNumberOpened == null ? sUSHISWAPV3ETHEREUMPositionDTO.blockNumberOpened == null : this.blockNumberOpened.equals(sUSHISWAPV3ETHEREUMPositionDTO.blockNumberOpened)) &&
        (this.timestampOpened == null ? sUSHISWAPV3ETHEREUMPositionDTO.timestampOpened == null : this.timestampOpened.equals(sUSHISWAPV3ETHEREUMPositionDTO.timestampOpened)) &&
        (this.blockNumberClosed == null ? sUSHISWAPV3ETHEREUMPositionDTO.blockNumberClosed == null : this.blockNumberClosed.equals(sUSHISWAPV3ETHEREUMPositionDTO.blockNumberClosed)) &&
        (this.timestampClosed == null ? sUSHISWAPV3ETHEREUMPositionDTO.timestampClosed == null : this.timestampClosed.equals(sUSHISWAPV3ETHEREUMPositionDTO.timestampClosed)) &&
        (this.tickLower == null ? sUSHISWAPV3ETHEREUMPositionDTO.tickLower == null : this.tickLower.equals(sUSHISWAPV3ETHEREUMPositionDTO.tickLower)) &&
        (this.tickUpper == null ? sUSHISWAPV3ETHEREUMPositionDTO.tickUpper == null : this.tickUpper.equals(sUSHISWAPV3ETHEREUMPositionDTO.tickUpper)) &&
        (this.liquidityToken == null ? sUSHISWAPV3ETHEREUMPositionDTO.liquidityToken == null : this.liquidityToken.equals(sUSHISWAPV3ETHEREUMPositionDTO.liquidityToken)) &&
        (this.liquidityTokenType == null ? sUSHISWAPV3ETHEREUMPositionDTO.liquidityTokenType == null : this.liquidityTokenType.equals(sUSHISWAPV3ETHEREUMPositionDTO.liquidityTokenType)) &&
        (this.liquidity == null ? sUSHISWAPV3ETHEREUMPositionDTO.liquidity == null : this.liquidity.equals(sUSHISWAPV3ETHEREUMPositionDTO.liquidity)) &&
        (this.liquidityUsd == null ? sUSHISWAPV3ETHEREUMPositionDTO.liquidityUsd == null : this.liquidityUsd.equals(sUSHISWAPV3ETHEREUMPositionDTO.liquidityUsd)) &&
        (this.cumulativeDepositTokenAmounts == null ? sUSHISWAPV3ETHEREUMPositionDTO.cumulativeDepositTokenAmounts == null : this.cumulativeDepositTokenAmounts.equals(sUSHISWAPV3ETHEREUMPositionDTO.cumulativeDepositTokenAmounts)) &&
        (this.cumulativeDepositUsd == null ? sUSHISWAPV3ETHEREUMPositionDTO.cumulativeDepositUsd == null : this.cumulativeDepositUsd.equals(sUSHISWAPV3ETHEREUMPositionDTO.cumulativeDepositUsd)) &&
        (this.cumulativeWithdrawTokenAmounts == null ? sUSHISWAPV3ETHEREUMPositionDTO.cumulativeWithdrawTokenAmounts == null : this.cumulativeWithdrawTokenAmounts.equals(sUSHISWAPV3ETHEREUMPositionDTO.cumulativeWithdrawTokenAmounts)) &&
        (this.cumulativeWithdrawUsd == null ? sUSHISWAPV3ETHEREUMPositionDTO.cumulativeWithdrawUsd == null : this.cumulativeWithdrawUsd.equals(sUSHISWAPV3ETHEREUMPositionDTO.cumulativeWithdrawUsd)) &&
        (this.cumulativeRewardUsd == null ? sUSHISWAPV3ETHEREUMPositionDTO.cumulativeRewardUsd == null : this.cumulativeRewardUsd.equals(sUSHISWAPV3ETHEREUMPositionDTO.cumulativeRewardUsd)) &&
        (this.depositCount == null ? sUSHISWAPV3ETHEREUMPositionDTO.depositCount == null : this.depositCount.equals(sUSHISWAPV3ETHEREUMPositionDTO.depositCount)) &&
        (this.withdrawCount == null ? sUSHISWAPV3ETHEREUMPositionDTO.withdrawCount == null : this.withdrawCount.equals(sUSHISWAPV3ETHEREUMPositionDTO.withdrawCount));
  }
