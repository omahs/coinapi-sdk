...
public class CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.entryTime == null : this.entryTime.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.recvTime == null : this.recvTime.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.blockNumber == null : this.blockNumber.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.blockNumber)) &&
        (this.blockRange == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.blockRange == null : this.blockRange.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.blockRange)) &&
        (this.id == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.id == null : this.id.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.id)) &&
        (this.protocol == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.protocol == null : this.protocol.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.protocol)) &&
        (this.hourlyActiveUsers == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlyActiveUsers == null : this.hourlyActiveUsers.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlyActiveUsers)) &&
        (this.cumulativeUniqueUsers == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.cumulativeUniqueUsers == null : this.cumulativeUniqueUsers.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.cumulativeUniqueUsers)) &&
        (this.hourlyTransactionCount == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlyTransactionCount == null : this.hourlyTransactionCount.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlyTransactionCount)) &&
        (this.hourlyDepositCount == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlyDepositCount == null : this.hourlyDepositCount.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlyDepositCount)) &&
        (this.hourlyWithdrawCount == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlyWithdrawCount == null : this.hourlyWithdrawCount.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlyWithdrawCount)) &&
        (this.hourlySwapCount == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlySwapCount == null : this.hourlySwapCount.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.hourlySwapCount)) &&
        (this.timestamp == null ? cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.timestamp == null : this.timestamp.equals(cURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO.timestamp));
  }
