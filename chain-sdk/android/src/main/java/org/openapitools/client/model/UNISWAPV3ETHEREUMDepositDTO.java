...
public class UNISWAPV3ETHEREUMDepositDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? uNISWAPV3ETHEREUMDepositDTO.entryTime == null : this.entryTime.equals(uNISWAPV3ETHEREUMDepositDTO.entryTime)) &&
        (this.recvTime == null ? uNISWAPV3ETHEREUMDepositDTO.recvTime == null : this.recvTime.equals(uNISWAPV3ETHEREUMDepositDTO.recvTime)) &&
        (this.blockNumber == null ? uNISWAPV3ETHEREUMDepositDTO.blockNumber == null : this.blockNumber.equals(uNISWAPV3ETHEREUMDepositDTO.blockNumber)) &&
        (this.block == null ? uNISWAPV3ETHEREUMDepositDTO.block == null : this.block.equals(uNISWAPV3ETHEREUMDepositDTO.block)) &&
        (this.id == null ? uNISWAPV3ETHEREUMDepositDTO.id == null : this.id.equals(uNISWAPV3ETHEREUMDepositDTO.id)) &&
        (this.hash == null ? uNISWAPV3ETHEREUMDepositDTO.hash == null : this.hash.equals(uNISWAPV3ETHEREUMDepositDTO.hash)) &&
        (this.nonce == null ? uNISWAPV3ETHEREUMDepositDTO.nonce == null : this.nonce.equals(uNISWAPV3ETHEREUMDepositDTO.nonce)) &&
        (this.logIndex == null ? uNISWAPV3ETHEREUMDepositDTO.logIndex == null : this.logIndex.equals(uNISWAPV3ETHEREUMDepositDTO.logIndex)) &&
        (this.gasLimit == null ? uNISWAPV3ETHEREUMDepositDTO.gasLimit == null : this.gasLimit.equals(uNISWAPV3ETHEREUMDepositDTO.gasLimit)) &&
        (this.gasUsed == null ? uNISWAPV3ETHEREUMDepositDTO.gasUsed == null : this.gasUsed.equals(uNISWAPV3ETHEREUMDepositDTO.gasUsed)) &&
        (this.gasPrice == null ? uNISWAPV3ETHEREUMDepositDTO.gasPrice == null : this.gasPrice.equals(uNISWAPV3ETHEREUMDepositDTO.gasPrice)) &&
        (this.protocol == null ? uNISWAPV3ETHEREUMDepositDTO.protocol == null : this.protocol.equals(uNISWAPV3ETHEREUMDepositDTO.protocol)) &&
        (this.account == null ? uNISWAPV3ETHEREUMDepositDTO.account == null : this.account.equals(uNISWAPV3ETHEREUMDepositDTO.account)) &&
        (this.position == null ? uNISWAPV3ETHEREUMDepositDTO.position == null : this.position.equals(uNISWAPV3ETHEREUMDepositDTO.position)) &&
        (this.pool == null ? uNISWAPV3ETHEREUMDepositDTO.pool == null : this.pool.equals(uNISWAPV3ETHEREUMDepositDTO.pool)) &&
        (this.tickLower == null ? uNISWAPV3ETHEREUMDepositDTO.tickLower == null : this.tickLower.equals(uNISWAPV3ETHEREUMDepositDTO.tickLower)) &&
        (this.tickUpper == null ? uNISWAPV3ETHEREUMDepositDTO.tickUpper == null : this.tickUpper.equals(uNISWAPV3ETHEREUMDepositDTO.tickUpper)) &&
        (this.timestamp == null ? uNISWAPV3ETHEREUMDepositDTO.timestamp == null : this.timestamp.equals(uNISWAPV3ETHEREUMDepositDTO.timestamp)) &&
        (this.liquidity == null ? uNISWAPV3ETHEREUMDepositDTO.liquidity == null : this.liquidity.equals(uNISWAPV3ETHEREUMDepositDTO.liquidity)) &&
        (this.inputTokens == null ? uNISWAPV3ETHEREUMDepositDTO.inputTokens == null : this.inputTokens.equals(uNISWAPV3ETHEREUMDepositDTO.inputTokens)) &&
        (this.inputTokenAmounts == null ? uNISWAPV3ETHEREUMDepositDTO.inputTokenAmounts == null : this.inputTokenAmounts.equals(uNISWAPV3ETHEREUMDepositDTO.inputTokenAmounts)) &&
        (this.reserveAmounts == null ? uNISWAPV3ETHEREUMDepositDTO.reserveAmounts == null : this.reserveAmounts.equals(uNISWAPV3ETHEREUMDepositDTO.reserveAmounts)) &&
        (this.amountUsd == null ? uNISWAPV3ETHEREUMDepositDTO.amountUsd == null : this.amountUsd.equals(uNISWAPV3ETHEREUMDepositDTO.amountUsd)) &&
        (this.blockRange == null ? uNISWAPV3ETHEREUMDepositDTO.blockRange == null : this.blockRange.equals(uNISWAPV3ETHEREUMDepositDTO.blockRange));
  }
