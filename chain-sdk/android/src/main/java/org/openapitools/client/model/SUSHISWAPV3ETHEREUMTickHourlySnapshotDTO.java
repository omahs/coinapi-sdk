...
public class SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.blockNumber)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.id)) &&
        (this.hourId == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.hourId == null : this.hourId.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.hourId)) &&
        (this.tick == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.tick == null : this.tick.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.tick)) &&
        (this.pool == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.pool == null : this.pool.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.pool)) &&
        (this.liquidityGross == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityGross == null : this.liquidityGross.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityGross)) &&
        (this.liquidityGrossUsd == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityGrossUsd == null : this.liquidityGrossUsd.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityGrossUsd)) &&
        (this.liquidityNet == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityNet == null : this.liquidityNet.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityNet)) &&
        (this.liquidityNetUsd == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityNetUsd == null : this.liquidityNetUsd.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.liquidityNetUsd)) &&
        (this.timestamp == null ? sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.timestamp == null : this.timestamp.equals(sUSHISWAPV3ETHEREUMTickHourlySnapshotDTO.timestamp));
  }
