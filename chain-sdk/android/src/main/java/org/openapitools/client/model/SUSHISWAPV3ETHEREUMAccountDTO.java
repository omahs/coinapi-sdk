...
public class SUSHISWAPV3ETHEREUMAccountDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMAccountDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMAccountDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMAccountDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMAccountDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMAccountDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMAccountDTO.blockNumber)) &&
        (this.blockRange == null ? sUSHISWAPV3ETHEREUMAccountDTO.blockRange == null : this.blockRange.equals(sUSHISWAPV3ETHEREUMAccountDTO.blockRange)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMAccountDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMAccountDTO.id)) &&
        (this.positionCount == null ? sUSHISWAPV3ETHEREUMAccountDTO.positionCount == null : this.positionCount.equals(sUSHISWAPV3ETHEREUMAccountDTO.positionCount)) &&
        (this.openPositionCount == null ? sUSHISWAPV3ETHEREUMAccountDTO.openPositionCount == null : this.openPositionCount.equals(sUSHISWAPV3ETHEREUMAccountDTO.openPositionCount)) &&
        (this.closedPositionCount == null ? sUSHISWAPV3ETHEREUMAccountDTO.closedPositionCount == null : this.closedPositionCount.equals(sUSHISWAPV3ETHEREUMAccountDTO.closedPositionCount)) &&
        (this.depositCount == null ? sUSHISWAPV3ETHEREUMAccountDTO.depositCount == null : this.depositCount.equals(sUSHISWAPV3ETHEREUMAccountDTO.depositCount)) &&
        (this.withdrawCount == null ? sUSHISWAPV3ETHEREUMAccountDTO.withdrawCount == null : this.withdrawCount.equals(sUSHISWAPV3ETHEREUMAccountDTO.withdrawCount)) &&
        (this.swapCount == null ? sUSHISWAPV3ETHEREUMAccountDTO.swapCount == null : this.swapCount.equals(sUSHISWAPV3ETHEREUMAccountDTO.swapCount));
  }
