...
public class CURVEFINANCEETHEREUMLiquidityPoolDTO {
  ...
  @SerializedName("input_tokens_ordered")
  private List<String> inputTokensOrdered = null;
  ...
  @SerializedName("gauge_address")
  private String gaugeAddress = null;
   ...
   **/
  @ApiModelProperty(value = "inputTokens in native (contract) order")
   ...
   **/
  @ApiModelProperty(value = "Aditional tokens that are given as reward for position in a protocol, usually in liquidity mining programs. e.g. SUSHI in the Onsen program, MATIC for Aave Polygon")
   ...
   **/
  @ApiModelProperty(value = "Whether this pool is single-sided (e.g. Bancor, Platypus's Alternative Pool). The specifics of the implementation depends on the protocol.")
   ...
   **/
  @ApiModelProperty(value = "Registry that deployed this pool")
   ...
   **/
  @ApiModelProperty(value = "Liquidity Gauge assocaited with this pool")
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.entryTime == null : this.entryTime.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.entryTime)) &&
        (this.recvTime == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.recvTime == null : this.recvTime.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.recvTime)) &&
        (this.blockNumber == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.blockNumber == null : this.blockNumber.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.blockNumber)) &&
        (this.vid == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.vid == null : this.vid.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.vid)) &&
        (this.id == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.id == null : this.id.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.id)) &&
        (this.protocol == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.protocol == null : this.protocol.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.protocol)) &&
        (this.name == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.name == null : this.name.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.name)) &&
        (this.symbol == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.symbol == null : this.symbol.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.symbol)) &&
        (this.inputTokens == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.inputTokens == null : this.inputTokens.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.inputTokens)) &&
        (this.inputTokensOrdered == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.inputTokensOrdered == null : this.inputTokensOrdered.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.inputTokensOrdered)) &&
        (this.outputToken == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.outputToken == null : this.outputToken.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.outputToken)) &&
        (this.rewardTokens == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.rewardTokens == null : this.rewardTokens.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.rewardTokens)) &&
        (this.fees == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.fees == null : this.fees.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.fees)) &&
        (this.isSingleSided == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.isSingleSided == null : this.isSingleSided.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.isSingleSided)) &&
        (this.createdTimestamp == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.createdTimestamp == null : this.createdTimestamp.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.createdTimestamp)) &&
        (this.createdBlockNumber == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.createdBlockNumber == null : this.createdBlockNumber.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.createdBlockNumber)) &&
        (this.totalValueLockedUsd == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.totalValueLockedUsd == null : this.totalValueLockedUsd.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.totalValueLockedUsd)) &&
        (this.cumulativeSupplySideRevenueUsd == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.cumulativeSupplySideRevenueUsd == null : this.cumulativeSupplySideRevenueUsd.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.cumulativeSupplySideRevenueUsd)) &&
        (this.cumulativeProtocolSideRevenueUsd == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.cumulativeProtocolSideRevenueUsd == null : this.cumulativeProtocolSideRevenueUsd.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.cumulativeProtocolSideRevenueUsd)) &&
        (this.cumulativeTotalRevenueUsd == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.cumulativeTotalRevenueUsd == null : this.cumulativeTotalRevenueUsd.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.cumulativeTotalRevenueUsd)) &&
        (this.cumulativeVolumeUsd == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.cumulativeVolumeUsd == null : this.cumulativeVolumeUsd.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.cumulativeVolumeUsd)) &&
        (this.inputTokenBalances == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.inputTokenBalances == null : this.inputTokenBalances.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.inputTokenBalances)) &&
        (this.inputTokenWeights == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.inputTokenWeights == null : this.inputTokenWeights.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.inputTokenWeights)) &&
        (this.outputTokenSupply == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.outputTokenSupply == null : this.outputTokenSupply.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.outputTokenSupply)) &&
        (this.outputTokenPriceUsd == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.outputTokenPriceUsd == null : this.outputTokenPriceUsd.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.outputTokenPriceUsd)) &&
        (this.stakedOutputTokenAmount == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.stakedOutputTokenAmount == null : this.stakedOutputTokenAmount.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.stakedOutputTokenAmount)) &&
        (this.rewardTokenEmissionsAmount == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.rewardTokenEmissionsAmount == null : this.rewardTokenEmissionsAmount.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.rewardTokenEmissionsAmount)) &&
        (this.rewardTokenEmissionsUsd == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.rewardTokenEmissionsUsd == null : this.rewardTokenEmissionsUsd.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.rewardTokenEmissionsUsd)) &&
        (this.registryAddress == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.registryAddress == null : this.registryAddress.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.registryAddress)) &&
        (this.gaugeAddress == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.gaugeAddress == null : this.gaugeAddress.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.gaugeAddress)) &&
        (this.evaluatedAsk == null ? cURVEFINANCEETHEREUMLiquidityPoolDTO.evaluatedAsk == null : this.evaluatedAsk.equals(cURVEFINANCEETHEREUMLiquidityPoolDTO.evaluatedAsk));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.inputTokensOrdered == null ? 0: this.inputTokensOrdered.hashCode());
    ...
    result = 31 * result + (this.gaugeAddress == null ? 0: this.gaugeAddress.hashCode());
