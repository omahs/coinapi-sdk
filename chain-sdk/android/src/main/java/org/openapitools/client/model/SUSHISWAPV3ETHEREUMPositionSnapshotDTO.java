...
public class SUSHISWAPV3ETHEREUMPositionSnapshotDTO {
  ...
  public boolean equals(Object o) {
    ...
    return (this.entryTime == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.entryTime == null : this.entryTime.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.entryTime)) &&
        (this.recvTime == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.recvTime == null : this.recvTime.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.recvTime)) &&
        (this.blockNumber == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.blockNumber == null : this.blockNumber.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.blockNumber)) &&
        (this.id == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.id == null : this.id.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.id)) &&
        (this.hash == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.hash == null : this.hash.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.hash)) &&
        (this.logIndex == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.logIndex == null : this.logIndex.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.logIndex)) &&
        (this.nonce == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.nonce == null : this.nonce.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.nonce)) &&
        (this.position == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.position == null : this.position.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.position)) &&
        (this.liquidityTokenType == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidityTokenType == null : this.liquidityTokenType.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidityTokenType)) &&
        (this.liquidity == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidity == null : this.liquidity.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidity)) &&
        (this.liquidityUsd == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidityUsd == null : this.liquidityUsd.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.liquidityUsd)) &&
        (this.cumulativeDepositTokenAmounts == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositTokenAmounts == null : this.cumulativeDepositTokenAmounts.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositTokenAmounts)) &&
        (this.cumulativeDepositUsd == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositUsd == null : this.cumulativeDepositUsd.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeDepositUsd)) &&
        (this.cumulativeWithdrawTokenAmounts == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawTokenAmounts == null : this.cumulativeWithdrawTokenAmounts.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawTokenAmounts)) &&
        (this.cumulativeWithdrawUsd == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawUsd == null : this.cumulativeWithdrawUsd.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeWithdrawUsd)) &&
        (this.cumulativeRewardTokenAmounts == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardTokenAmounts == null : this.cumulativeRewardTokenAmounts.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardTokenAmounts)) &&
        (this.cumulativeRewardUsd == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardUsd == null : this.cumulativeRewardUsd.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.cumulativeRewardUsd)) &&
        (this.depositCount == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.depositCount == null : this.depositCount.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.depositCount)) &&
        (this.withdrawCount == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.withdrawCount == null : this.withdrawCount.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.withdrawCount)) &&
        (this.timestamp == null ? sUSHISWAPV3ETHEREUMPositionSnapshotDTO.timestamp == null : this.timestamp.equals(sUSHISWAPV3ETHEREUMPositionSnapshotDTO.timestamp));
  }
