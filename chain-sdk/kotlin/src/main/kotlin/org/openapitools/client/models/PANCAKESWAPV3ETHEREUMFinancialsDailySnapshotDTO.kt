 ...
 * @param dailyProtocolSideRevenueUsd Gross revenue for the protocol (revenue claimed by the protocol). Examples: AMM protocol fee (Sushi’s 0.05%). OpenSea 10% sell fee.
 * @param cumulativeProtocolSideRevenueUsd Gross revenue for the protocol (revenue claimed by the protocol). Examples: AMM protocol fee (Sushi’s 0.05%). OpenSea 10% sell fee.
...
data class PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO (
