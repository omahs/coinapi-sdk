 ...
 * @param poolIds All pools that belong to this protocol
 */


data class CURVEFINANCEETHEREUMDexAmmProtocolDTO (
    ...
    @Json(name = "pool_ids")
    val poolIds: kotlin.collections.List<kotlin.String>? = null
