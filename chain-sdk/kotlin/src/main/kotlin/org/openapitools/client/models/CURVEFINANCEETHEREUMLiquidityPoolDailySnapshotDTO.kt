 ...
 * @param dailySupplySideRevenueUsd 
 * @param cumulativeProtocolSideRevenueUsd Daily revenue generated by the liquidity pool, accrued to the supply side.
 * @param dailyProtocolSideRevenueUsd All revenue generated by the liquidity pool, accrued to the protocol.
 ...
 * @param dailyVolumeByTokenAmount 
 * @param dailyVolumeByTokenUsd All trade volume occurred in a given day for a specific input token, in native amount. The ordering should be the same as the pool's 'inputTokens' field.
 * @param cumulativeVolumeUsd All trade volume occurred in a given day for a specific input token, in USD. The ordering should be the same as the pool's 'inputTokens' field.
...
data class CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO (
