 ...
 * @param token0PriceUsd Snapshot of token0 price in USD.
 * @param token1PriceUsd Snapshot of token0 price in USD.
...
data class SushiswapLiquidityPositionSnapshotDTO (
