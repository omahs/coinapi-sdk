 ...
 * @param dailyDepositCount Total number of deposits (add liquidity) in an day
 * @param dailyWithdrawCount Total number of withdrawals (remove liquidity) in an day
 * @param dailySwapCount Total number of trades (swaps) in an day
 * @param timestamp Timestamp of when this snapshot was taken/last modified (May be taken after interval has passed)
 */


data class PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO (
