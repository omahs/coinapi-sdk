...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CurveVotingAppDTO']:
            return CurveVotingAppDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CurveVotingAppDTO'], typing.List['CurveVotingAppDTO']],
    ...
    def __getitem__(self, i: int) -> 'CurveVotingAppDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _curve_get_voting_apps__historical_oapg(
        self,
...
class CurveGetVotingAppsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def curve_get_voting_apps__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def curve_get_voting_apps__historical(
        ...
        return self._curve_get_voting_apps__historical_oapg(
