...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CRYPTOPUNKSBidDTO']:
            return CRYPTOPUNKSBidDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CRYPTOPUNKSBidDTO'], typing.List['CRYPTOPUNKSBidDTO']],
    ...
    def __getitem__(self, i: int) -> 'CRYPTOPUNKSBidDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _c_ryptopunksethereum_bids__current_oapg(
        self,
...
class CRyptopunksethereumBidsCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def c_ryptopunksethereum_bids__current(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def c_ryptopunksethereum_bids__current(
        ...
        return self._c_ryptopunksethereum_bids__current_oapg(
