...
class BaseApi(api_client.Api):
    @typing.overload
    def _c_ryptopunks_get_data_sources__historical_oapg(
        self,
...
class CRyptopunksGetDataSourcesHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def c_ryptopunks_get_data_sources__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def c_ryptopunks_get_data_sources__historical(
        ...
        return self._c_ryptopunks_get_data_sources__historical_oapg(
