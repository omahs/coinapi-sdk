...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SushiswapHourDataDTO']:
            return SushiswapHourDataDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SushiswapHourDataDTO'], typing.List['SushiswapHourDataDTO']],
    ...
    def __getitem__(self, i: int) -> 'SushiswapHourDataDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _sushiswap_get_hour_data__historical_oapg(
        self,
...
class SushiswapGetHourDataHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def sushiswap_get_hour_data__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def sushiswap_get_hour_data__historical(
        ...
        return self._sushiswap_get_hour_data__historical_oapg(
