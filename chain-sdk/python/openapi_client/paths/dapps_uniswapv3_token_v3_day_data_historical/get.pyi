...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UniswapV3TokenV3DayDataDTO']:
            return UniswapV3TokenV3DayDataDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UniswapV3TokenV3DayDataDTO'], typing.List['UniswapV3TokenV3DayDataDTO']],
    ...
    def __getitem__(self, i: int) -> 'UniswapV3TokenV3DayDataDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _uniswap_v3_get_token_v3_day_data__historical_oapg(
        self,
...
class UniswapV3GetTokenV3DayDataHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def uniswap_v3_get_token_v3_day_data__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def uniswap_v3_get_token_v3_day_data__historical(
        ...
        return self._uniswap_v3_get_token_v3_day_data__historical_oapg(
