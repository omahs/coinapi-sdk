...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SushiswapBurnDTO']:
            return SushiswapBurnDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SushiswapBurnDTO'], typing.List['SushiswapBurnDTO']],
    ...
    def __getitem__(self, i: int) -> 'SushiswapBurnDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _sushiswap_get_burns__historical_oapg(
        self,
...
class SushiswapGetBurnsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def sushiswap_get_burns__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def sushiswap_get_burns__historical(
        ...
        return self._sushiswap_get_burns__historical_oapg(
