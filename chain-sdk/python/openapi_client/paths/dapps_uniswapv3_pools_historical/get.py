...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UniswapV3PoolDTO']:
            return UniswapV3PoolDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UniswapV3PoolDTO'], typing.List['UniswapV3PoolDTO']],
    ...
    def __getitem__(self, i: int) -> 'UniswapV3PoolDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _uniswap_v3_get_pools__historical_oapg(
        self,
...
class UniswapV3GetPoolsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def uniswap_v3_get_pools__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def uniswap_v3_get_pools__historical(
        ...
        return self._uniswap_v3_get_pools__historical_oapg(
