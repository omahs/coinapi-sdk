...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CurveGaugeDepositDTO']:
            return CurveGaugeDepositDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CurveGaugeDepositDTO'], typing.List['CurveGaugeDepositDTO']],
    ...
    def __getitem__(self, i: int) -> 'CurveGaugeDepositDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _curve_get_gauge_deposits__historical_oapg(
        self,
...
class CurveGetGaugeDepositsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def curve_get_gauge_deposits__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def curve_get_gauge_deposits__historical(
        ...
        return self._curve_get_gauge_deposits__historical_oapg(
