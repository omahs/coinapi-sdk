...
class SchemaFor200ResponseBodyTextPlain(
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UniswapV3BurnDTO'], typing.List['UniswapV3BurnDTO']],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _uniswap_v3_get_burns__historical_oapg(
        self,
...
class UniswapV3GetBurnsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def uniswap_v3_get_burns__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def uniswap_v3_get_burns__historical(
        ...
        return self._uniswap_v3_get_burns__historical_oapg(
