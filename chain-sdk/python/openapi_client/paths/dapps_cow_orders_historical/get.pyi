...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CowOrderDTO']:
            return CowOrderDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CowOrderDTO'], typing.List['CowOrderDTO']],
    ...
    def __getitem__(self, i: int) -> 'CowOrderDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _cow_get_orders__historical_oapg(
        self,
...
class CowGetOrdersHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def cow_get_orders__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def cow_get_orders__historical(
        ...
        return self._cow_get_orders__historical_oapg(
