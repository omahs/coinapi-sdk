...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CurveHourlyVolumeDTO']:
            return CurveHourlyVolumeDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CurveHourlyVolumeDTO'], typing.List['CurveHourlyVolumeDTO']],
    ...
    def __getitem__(self, i: int) -> 'CurveHourlyVolumeDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _curve_get_hourly_volumes__historical_oapg(
        self,
...
class CurveGetHourlyVolumesHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def curve_get_hourly_volumes__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def curve_get_hourly_volumes__historical(
        ...
        return self._curve_get_hourly_volumes__historical_oapg(
