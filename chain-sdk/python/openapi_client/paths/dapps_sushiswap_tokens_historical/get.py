...
class SchemaFor200ResponseBodyTextPlain(
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SushiswapTokenDTO'], typing.List['SushiswapTokenDTO']],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _sushiswap_get_tokens__historical_oapg(
        self,
...
class SushiswapGetTokensHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def sushiswap_get_tokens__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def sushiswap_get_tokens__historical(
        ...
        return self._sushiswap_get_tokens__historical_oapg(
