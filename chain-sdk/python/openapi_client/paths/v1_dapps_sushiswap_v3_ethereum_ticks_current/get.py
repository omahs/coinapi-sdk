...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SUSHISWAPV3ETHEREUMTickDTO']:
            return SUSHISWAPV3ETHEREUMTickDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SUSHISWAPV3ETHEREUMTickDTO'], typing.List['SUSHISWAPV3ETHEREUMTickDTO']],
    ...
    def __getitem__(self, i: int) -> 'SUSHISWAPV3ETHEREUMTickDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _s_ushiswapv3_ethereum_ticks__current_oapg(
        self,
...
class SUshiswapv3EthereumTicksCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def s_ushiswapv3_ethereum_ticks__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def s_ushiswapv3_ethereum_ticks__current(
        ...
        return self._s_ushiswapv3_ethereum_ticks__current_oapg(
