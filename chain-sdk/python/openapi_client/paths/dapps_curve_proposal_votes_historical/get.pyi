...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CurveProposalVoteDTO']:
            return CurveProposalVoteDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CurveProposalVoteDTO'], typing.List['CurveProposalVoteDTO']],
    ...
    def __getitem__(self, i: int) -> 'CurveProposalVoteDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _curve_get_proposal_votes__historical_oapg(
        self,
...
class CurveGetProposalVotesHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def curve_get_proposal_votes__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def curve_get_proposal_votes__historical(
        ...
        return self._curve_get_proposal_votes__historical_oapg(
