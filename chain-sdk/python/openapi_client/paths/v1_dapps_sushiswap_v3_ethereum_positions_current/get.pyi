...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SUSHISWAPV3ETHEREUMPositionDTO']:
            return SUSHISWAPV3ETHEREUMPositionDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SUSHISWAPV3ETHEREUMPositionDTO'], typing.List['SUSHISWAPV3ETHEREUMPositionDTO']],
    ...
    def __getitem__(self, i: int) -> 'SUSHISWAPV3ETHEREUMPositionDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _s_ushiswapv3_ethereum_positions__current_oapg(
        self,
...
class SUshiswapv3EthereumPositionsCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def s_ushiswapv3_ethereum_positions__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def s_ushiswapv3_ethereum_positions__current(
        ...
        return self._s_ushiswapv3_ethereum_positions__current_oapg(
