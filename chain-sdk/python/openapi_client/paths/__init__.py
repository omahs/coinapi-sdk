...
class PathValues(str, enum.Enum):
    ...
    DAPPS_CRYPTOPUNKS_BIDS_HISTORICAL = "/dapps/cryptopunks/bids/historical"
    DAPPS_CRYPTOPUNKS_BIDS_CURRENT = "/dapps/cryptopunks/bids/current"
    DAPPS_CRYPTOPUNKS_COLLECTION_DAILY_SNAPSHOTS_HISTORICAL = "/dapps/cryptopunks/collectionDailySnapshots/historical"
    DAPPS_CRYPTOPUNKS_COLLECTION_DAILY_SNAPSHOTS_CURRENT = "/dapps/cryptopunks/collectionDailySnapshots/current"
    DAPPS_CRYPTOPUNKS_COLLECTIONS_HISTORICAL = "/dapps/cryptopunks/collections/historical"
    DAPPS_CRYPTOPUNKS_COLLECTIONS_CURRENT = "/dapps/cryptopunks/collections/current"
    DAPPS_CRYPTOPUNKS_DATA_SOURCES_HISTORICAL = "/dapps/cryptopunks/dataSources/historical"
    DAPPS_CRYPTOPUNKS_DATA_SOURCES_CURRENT = "/dapps/cryptopunks/dataSources/current"
    DAPPS_CRYPTOPUNKS_ITEMS_HISTORICAL = "/dapps/cryptopunks/items/historical"
    DAPPS_CRYPTOPUNKS_ITEMS_CURRENT = "/dapps/cryptopunks/items/current"
    DAPPS_CRYPTOPUNKS_MARKETPLACE_DAILY_SNAPSHOTS_HISTORICAL = "/dapps/cryptopunks/marketplaceDailySnapshots/historical"
    DAPPS_CRYPTOPUNKS_MARKETPLACE_DAILY_SNAPSHOTS_CURRENT = "/dapps/cryptopunks/marketplaceDailySnapshots/current"
    DAPPS_CRYPTOPUNKS_MARKET_PLACES_HISTORICAL = "/dapps/cryptopunks/marketPlaces/historical"
    DAPPS_CRYPTOPUNKS_MARKET_PLACES_CURRENT = "/dapps/cryptopunks/marketPlaces/current"
    DAPPS_CRYPTOPUNKS_TRADES_HISTORICAL = "/dapps/cryptopunks/trades/historical"
    DAPPS_CRYPTOPUNKS_TRADES_CURRENT = "/dapps/cryptopunks/trades/current"
    DAPPS_CRYPTOPUNKS_USERS_HISTORICAL = "/dapps/cryptopunks/users/historical"
