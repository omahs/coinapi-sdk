...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UNISWAPV3ETHEREUMTickDTO']:
            return UNISWAPV3ETHEREUMTickDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UNISWAPV3ETHEREUMTickDTO'], typing.List['UNISWAPV3ETHEREUMTickDTO']],
    ...
    def __getitem__(self, i: int) -> 'UNISWAPV3ETHEREUMTickDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _u_niswapv3_ethereum_ticks__current_oapg(
        self,
...
class UNiswapv3EthereumTicksCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def u_niswapv3_ethereum_ticks__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def u_niswapv3_ethereum_ticks__current(
        ...
        return self._u_niswapv3_ethereum_ticks__current_oapg(
