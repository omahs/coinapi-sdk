...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO']:
            return SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO'], typing.List['SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO']],
    ...
    def __getitem__(self, i: int) -> 'SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _s_ushiswapv3_ethereum_tick_hourly_snapshots__current_oapg(
        self,
...
class SUshiswapv3EthereumTickHourlySnapshotsCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def s_ushiswapv3_ethereum_tick_hourly_snapshots__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def s_ushiswapv3_ethereum_tick_hourly_snapshots__current(
        ...
        return self._s_ushiswapv3_ethereum_tick_hourly_snapshots__current_oapg(
