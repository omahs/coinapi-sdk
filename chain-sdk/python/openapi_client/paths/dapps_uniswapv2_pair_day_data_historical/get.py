...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'token_0': typing.Union[Token0Schema, str, ],
        'token_1': typing.Union[Token1Schema, str, ],
    },
    total=False
)
...
request_query_token_0 = api_client.QueryParameter(
    name="token_0",
    style=api_client.ParameterStyle.FORM,
    schema=Token0Schema,
    explode=True,
)
request_query_token_1 = api_client.QueryParameter(
    name="token_1",
    style=api_client.ParameterStyle.FORM,
    schema=Token1Schema,
    explode=True,
...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UniswapV2PairDayDataDTO']:
            return UniswapV2PairDayDataDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UniswapV2PairDayDataDTO'], typing.List['UniswapV2PairDayDataDTO']],
    ...
    def __getitem__(self, i: int) -> 'UniswapV2PairDayDataDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _uniswap_v2_get_pair_day_data__historical_oapg(
        self,
    ...
    def _uniswap_v2_get_pair_day_data__historical_oapg(
        ...
        for parameter in (
            ...
            request_query_id,
            request_query_token_0,
            request_query_token_1,
        ):
...
class UniswapV2GetPairDayDataHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def uniswap_v2_get_pair_day_data__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def uniswap_v2_get_pair_day_data__historical(
        ...
        return self._uniswap_v2_get_pair_day_data__historical_oapg(
