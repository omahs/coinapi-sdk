...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UniswapV2TokenDTO']:
            return UniswapV2TokenDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UniswapV2TokenDTO'], typing.List['UniswapV2TokenDTO']],
    ...
    def __getitem__(self, i: int) -> 'UniswapV2TokenDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _uniswap_v2_get_tokens__historical_oapg(
        self,
...
class UniswapV2GetTokensHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def uniswap_v2_get_tokens__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def uniswap_v2_get_tokens__historical(
        ...
        return self._uniswap_v2_get_tokens__historical_oapg(
