...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO']:
            return PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO'], typing.List['PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO']],
    ...
    def __getitem__(self, i: int) -> 'PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _p_ancakeswapv3_ethereum_tick_daily_snapshots__current_oapg(
        self,
...
class PAncakeswapv3EthereumTickDailySnapshotsCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def p_ancakeswapv3_ethereum_tick_daily_snapshots__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def p_ancakeswapv3_ethereum_tick_daily_snapshots__current(
        ...
        return self._p_ancakeswapv3_ethereum_tick_daily_snapshots__current_oapg(
