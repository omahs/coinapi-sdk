...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CurveFeeChangeLogDTO']:
            return CurveFeeChangeLogDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CurveFeeChangeLogDTO'], typing.List['CurveFeeChangeLogDTO']],
    ...
    def __getitem__(self, i: int) -> 'CurveFeeChangeLogDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _curve_get_fee_change_logs__historical_oapg(
        self,
...
class CurveGetFeeChangeLogsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def curve_get_fee_change_logs__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def curve_get_fee_change_logs__historical(
        ...
        return self._curve_get_fee_change_logs__historical_oapg(
