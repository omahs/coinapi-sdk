...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PANCAKESWAPV3ETHEREUMTickDTO']:
            return PANCAKESWAPV3ETHEREUMTickDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PANCAKESWAPV3ETHEREUMTickDTO'], typing.List['PANCAKESWAPV3ETHEREUMTickDTO']],
    ...
    def __getitem__(self, i: int) -> 'PANCAKESWAPV3ETHEREUMTickDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _p_ancakeswapv3_ethereum_ticks__current_oapg(
        self,
...
class PAncakeswapv3EthereumTicksCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def p_ancakeswapv3_ethereum_ticks__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def p_ancakeswapv3_ethereum_ticks__current(
        ...
        return self._p_ancakeswapv3_ethereum_ticks__current_oapg(
