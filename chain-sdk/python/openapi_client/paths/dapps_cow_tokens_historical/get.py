...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CowTokenDTO']:
            return CowTokenDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CowTokenDTO'], typing.List['CowTokenDTO']],
    ...
    def __getitem__(self, i: int) -> 'CowTokenDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _cow_get_tokens__historical_oapg(
        self,
...
class CowGetTokensHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def cow_get_tokens__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def cow_get_tokens__historical(
        ...
        return self._cow_get_tokens__historical_oapg(
