...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DexWithdrawRequestDTO']:
            return DexWithdrawRequestDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['DexWithdrawRequestDTO'], typing.List['DexWithdrawRequestDTO']],
    ...
    def __getitem__(self, i: int) -> 'DexWithdrawRequestDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _dex_get_withdraw_requests__historical_oapg(
        self,
...
class DexGetWithdrawRequestsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dex_get_withdraw_requests__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def dex_get_withdraw_requests__historical(
        ...
        return self._dex_get_withdraw_requests__historical_oapg(
