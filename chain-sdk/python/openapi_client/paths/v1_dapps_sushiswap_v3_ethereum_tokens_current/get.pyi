...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SUSHISWAPV3ETHEREUMTokenDTO']:
            return SUSHISWAPV3ETHEREUMTokenDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['SUSHISWAPV3ETHEREUMTokenDTO'], typing.List['SUSHISWAPV3ETHEREUMTokenDTO']],
    ...
    def __getitem__(self, i: int) -> 'SUSHISWAPV3ETHEREUMTokenDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _s_ushiswapv3_ethereum_tokens__current_oapg(
        self,
...
class SUshiswapv3EthereumTokensCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def s_ushiswapv3_ethereum_tokens__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def s_ushiswapv3_ethereum_tokens__current(
        ...
        return self._s_ushiswapv3_ethereum_tokens__current_oapg(
