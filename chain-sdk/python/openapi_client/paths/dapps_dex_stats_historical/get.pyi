...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DexStatsDTO']:
            return DexStatsDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['DexStatsDTO'], typing.List['DexStatsDTO']],
    ...
    def __getitem__(self, i: int) -> 'DexStatsDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _dex_get_stats__historical_oapg(
        self,
...
class DexGetStatsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dex_get_stats__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def dex_get_stats__historical(
        ...
        return self._dex_get_stats__historical_oapg(
