...
class BaseApi(api_client.Api):
    @typing.overload
    def _c_ryptopunks_get_bids__historical_oapg(
        self,
...
class CRyptopunksGetBidsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def c_ryptopunks_get_bids__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def c_ryptopunks_get_bids__historical(
        ...
        return self._c_ryptopunks_get_bids__historical_oapg(
