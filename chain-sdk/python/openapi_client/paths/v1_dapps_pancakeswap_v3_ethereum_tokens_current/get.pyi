...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PANCAKESWAPV3ETHEREUMTokenDTO']:
            return PANCAKESWAPV3ETHEREUMTokenDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PANCAKESWAPV3ETHEREUMTokenDTO'], typing.List['PANCAKESWAPV3ETHEREUMTokenDTO']],
    ...
    def __getitem__(self, i: int) -> 'PANCAKESWAPV3ETHEREUMTokenDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _p_ancakeswapv3_ethereum_tokens__current_oapg(
        self,
...
class PAncakeswapv3EthereumTokensCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def p_ancakeswapv3_ethereum_tokens__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def p_ancakeswapv3_ethereum_tokens__current(
        ...
        return self._p_ancakeswapv3_ethereum_tokens__current_oapg(
