...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CurveSystemStateDTO']:
            return CurveSystemStateDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CurveSystemStateDTO'], typing.List['CurveSystemStateDTO']],
    ...
    def __getitem__(self, i: int) -> 'CurveSystemStateDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _curve_get_system_states__historical_oapg(
        self,
...
class CurveGetSystemStatesHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def curve_get_system_states__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def curve_get_system_states__historical(
        ...
        return self._curve_get_system_states__historical_oapg(
