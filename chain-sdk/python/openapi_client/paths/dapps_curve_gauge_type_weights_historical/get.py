...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CurveGaugeTypeWeightDTO']:
            return CurveGaugeTypeWeightDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['CurveGaugeTypeWeightDTO'], typing.List['CurveGaugeTypeWeightDTO']],
    ...
    def __getitem__(self, i: int) -> 'CurveGaugeTypeWeightDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _curve_get_gauge_type_weights__historical_oapg(
        self,
...
class CurveGetGaugeTypeWeightsHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def curve_get_gauge_type_weights__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def curve_get_gauge_type_weights__historical(
        ...
        return self._curve_get_gauge_type_weights__historical_oapg(
