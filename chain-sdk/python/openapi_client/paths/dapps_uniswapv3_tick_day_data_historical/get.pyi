...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UniswapV3TickDayDataDTO']:
            return UniswapV3TickDayDataDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UniswapV3TickDayDataDTO'], typing.List['UniswapV3TickDayDataDTO']],
    ...
    def __getitem__(self, i: int) -> 'UniswapV3TickDayDataDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _uniswap_v3_get_tick_day_data__historical_oapg(
        self,
...
class UniswapV3GetTickDayDataHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def uniswap_v3_get_tick_day_data__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def uniswap_v3_get_tick_day_data__historical(
        ...
        return self._uniswap_v3_get_tick_day_data__historical_oapg(
