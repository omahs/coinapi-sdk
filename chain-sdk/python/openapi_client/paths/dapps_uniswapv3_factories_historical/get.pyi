...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UniswapV3FactoryDTO']:
            return UniswapV3FactoryDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UniswapV3FactoryDTO'], typing.List['UniswapV3FactoryDTO']],
    ...
    def __getitem__(self, i: int) -> 'UniswapV3FactoryDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _uniswap_v3_get_factories__historical_oapg(
        self,
...
class UniswapV3GetFactoriesHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def uniswap_v3_get_factories__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def uniswap_v3_get_factories__historical(
        ...
        return self._uniswap_v3_get_factories__historical_oapg(
