...
BuyTokenSchema = schemas.StrSchema
SellTokenSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'buy_token': typing.Union[BuyTokenSchema, str, ],
        'sell_token': typing.Union[SellTokenSchema, str, ],
    },
    total=False
)
...
request_query_buy_token = api_client.QueryParameter(
    name="buy_token",
    style=api_client.ParameterStyle.FORM,
    schema=BuyTokenSchema,
    explode=True,
)
request_query_sell_token = api_client.QueryParameter(
    name="sell_token",
    style=api_client.ParameterStyle.FORM,
...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DexTradeDTO']:
            return DexTradeDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['DexTradeDTO'], typing.List['DexTradeDTO']],
    ...
    def __getitem__(self, i: int) -> 'DexTradeDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _dex_get_trades__historical_oapg(
        self,
    ...
    def _dex_get_trades__historical_oapg(
        ...
        for parameter in (
            ...
            request_query_id,
            request_query_buy_token,
            request_query_sell_token,
        ):
...
class DexGetTradesHistorical(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def dex_get_trades__historical(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def dex_get_trades__historical(
        ...
        return self._dex_get_trades__historical_oapg(
