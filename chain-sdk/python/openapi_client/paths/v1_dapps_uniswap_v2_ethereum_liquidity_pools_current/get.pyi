...
class SchemaFor200ResponseBodyTextPlain(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UNISWAPV2ETHEREUMLiquidityPoolDTO']:
            return UNISWAPV2ETHEREUMLiquidityPoolDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UNISWAPV2ETHEREUMLiquidityPoolDTO'], typing.List['UNISWAPV2ETHEREUMLiquidityPoolDTO']],
    ...
    def __getitem__(self, i: int) -> 'UNISWAPV2ETHEREUMLiquidityPoolDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _u_niswapv2_ethereum_liquidity_pools__current_oapg(
        self,
...
class UNiswapv2EthereumLiquidityPoolsCurrent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def u_niswapv2_ethereum_liquidity_pools__current(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def u_niswapv2_ethereum_liquidity_pools__current(
        ...
        return self._u_niswapv2_ethereum_liquidity_pools__current_oapg(
