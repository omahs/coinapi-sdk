...
class CowSettlementDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["solver"], typing_extensions.Literal["tx_hash"], typing_extensions.Literal["first_trade_timestamp"], typing_extensions.Literal["vid"], ]):
