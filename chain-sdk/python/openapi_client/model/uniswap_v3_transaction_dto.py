...
class UniswapV3TransactionDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["gas_used"], typing_extensions.Literal["gas_price"], typing_extensions.Literal["vid"], ]):
