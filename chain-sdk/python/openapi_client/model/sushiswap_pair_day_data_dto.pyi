...
class SushiswapPairDayDataDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["date"], typing_extensions.Literal["pair"], typing_extensions.Literal["token_0"], typing_extensions.Literal["token_1"], typing_extensions.Literal["reserve_0"], typing_extensions.Literal["reserve_1"], typing_extensions.Literal["total_supply"], typing_extensions.Literal["reserve_usd"], typing_extensions.Literal["volume_token_0"], typing_extensions.Literal["volume_token_1"], typing_extensions.Literal["volume_usd"], typing_extensions.Literal["tx_count"], typing_extensions.Literal["vid"], ]):
