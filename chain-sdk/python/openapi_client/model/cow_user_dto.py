...
class CowUserDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["is_solver"]) -> MetaOapg.properties.is_solver: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["vid"]) -> MetaOapg.properties.vid: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["address"], typing_extensions.Literal["first_trade_timestamp"], typing_extensions.Literal["is_solver"], typing_extensions.Literal["vid"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_solver"]) -> typing.Union[MetaOapg.properties.is_solver, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        is_solver: typing.Union[MetaOapg.properties.is_solver, bool, schemas.Unset] = schemas.unset,
