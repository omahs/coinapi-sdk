...
class SushiswapTokenDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["whitelist_pairs"]) -> MetaOapg.properties.whitelist_pairs: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["factory"], typing_extensions.Literal["symbol"], typing_extensions.Literal["name"], typing_extensions.Literal["decimals"], typing_extensions.Literal["total_supply"], typing_extensions.Literal["volume"], typing_extensions.Literal["volume_usd"], typing_extensions.Literal["untracked_volume_usd"], typing_extensions.Literal["tx_count"], typing_extensions.Literal["liquidity"], typing_extensions.Literal["derived_eth"], typing_extensions.Literal["whitelist_pairs"], typing_extensions.Literal["vid"], typing_extensions.Literal["token_symbol"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["whitelist_pairs"]) -> typing.Union[MetaOapg.properties.whitelist_pairs, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        whitelist_pairs: typing.Union[MetaOapg.properties.whitelist_pairs, list, tuple, None, schemas.Unset] = schemas.unset,
