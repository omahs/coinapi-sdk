...
class PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["token_prices"]) -> MetaOapg.properties.token_prices: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["vid"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["input_tokens"], typing_extensions.Literal["input_token_balances"], typing_extensions.Literal["token_prices"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["token_prices"]) -> typing.Union[MetaOapg.properties.token_prices, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        token_prices: typing.Union[MetaOapg.properties.token_prices, list, tuple, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
