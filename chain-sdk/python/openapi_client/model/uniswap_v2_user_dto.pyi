...
class UniswapV2UserDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["usd_swapped"]) -> MetaOapg.properties.usd_swapped: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["vid"]) -> MetaOapg.properties.vid: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["usd_swapped"], typing_extensions.Literal["vid"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["usd_swapped"]) -> typing.Union[MetaOapg.properties.usd_swapped, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["vid"]) -> typing.Union[MetaOapg.properties.vid, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["usd_swapped"], typing_extensions.Literal["vid"], ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        usd_swapped: typing.Union[MetaOapg.properties.usd_swapped, None, str, schemas.Unset] = schemas.unset,
