...
class SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["hour_id"]) -> MetaOapg.properties.hour_id: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["hour_id"]) -> typing.Union[MetaOapg.properties.hour_id, schemas.Unset]: ...
