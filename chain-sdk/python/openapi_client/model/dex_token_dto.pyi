...
class DexTokenDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["address"], typing_extensions.Literal["from_batch_id"], typing_extensions.Literal["symbol"], typing_extensions.Literal["decimals"], typing_extensions.Literal["name"], typing_extensions.Literal["sell_volume"], typing_extensions.Literal["create_epoch"], typing_extensions.Literal["tx_hash"], typing_extensions.Literal["vid"], typing_extensions.Literal["token_symbol"], ]):
