...
class CURVEFINANCEETHEREUMLiquidityPoolFeeDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fee_percentage"]) -> MetaOapg.properties.fee_percentage: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["fee_percentage"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fee_percentage"]) -> typing.Union[MetaOapg.properties.fee_percentage, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["fee_percentage"], ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        fee_percentage: typing.Union[MetaOapg.properties.fee_percentage, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
