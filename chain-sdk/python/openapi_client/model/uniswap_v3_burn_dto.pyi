...
class UniswapV3BurnDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["transaction"], typing_extensions.Literal["pool"], typing_extensions.Literal["token_0"], typing_extensions.Literal["token_1"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["owner"], typing_extensions.Literal["origin"], typing_extensions.Literal["amount"], typing_extensions.Literal["amount_0"], typing_extensions.Literal["amount_1"], typing_extensions.Literal["amount_usd"], typing_extensions.Literal["tick_lower"], typing_extensions.Literal["tick_upper"], typing_extensions.Literal["log_index"], typing_extensions.Literal["vid"], ]):
