...
class CRYPTOPUNKSCollectionDailySnapshotDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["daily_min_sale_price"]) -> MetaOapg.properties.daily_min_sale_price: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["daily_max_sale_price"]) -> MetaOapg.properties.daily_max_sale_price: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["daily_trade_volume_eth"]) -> MetaOapg.properties.daily_trade_volume_eth: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["vid"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["collection"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["royalty_fee"], typing_extensions.Literal["daily_min_sale_price"], typing_extensions.Literal["daily_max_sale_price"], typing_extensions.Literal["cumulative_trade_volume_eth"], typing_extensions.Literal["daily_trade_volume_eth"], typing_extensions.Literal["marketplace_revenue_eth"], typing_extensions.Literal["creator_revenue_eth"], typing_extensions.Literal["total_revenue_eth"], typing_extensions.Literal["trade_count"], typing_extensions.Literal["daily_traded_item_count"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["daily_min_sale_price"]) -> typing.Union[MetaOapg.properties.daily_min_sale_price, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["daily_max_sale_price"]) -> typing.Union[MetaOapg.properties.daily_max_sale_price, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["daily_trade_volume_eth"]) -> typing.Union[MetaOapg.properties.daily_trade_volume_eth, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        daily_min_sale_price: typing.Union[MetaOapg.properties.daily_min_sale_price, None, str, schemas.Unset] = schemas.unset,
        daily_max_sale_price: typing.Union[MetaOapg.properties.daily_max_sale_price, None, str, schemas.Unset] = schemas.unset,
        ...
        daily_trade_volume_eth: typing.Union[MetaOapg.properties.daily_trade_volume_eth, None, str, schemas.Unset] = schemas.unset,
