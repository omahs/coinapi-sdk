...
class CRYPTOPUNKSBidDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tokens_bid"]) -> MetaOapg.properties.tokens_bid: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bidder"]) -> MetaOapg.properties.bidder: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["vid"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["tokens_bid"], typing_extensions.Literal["token_id"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["bidder"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tokens_bid"]) -> typing.Union[MetaOapg.properties.tokens_bid, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bidder"]) -> typing.Union[MetaOapg.properties.bidder, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tokens_bid: typing.Union[MetaOapg.properties.tokens_bid, None, str, schemas.Unset] = schemas.unset,
        ...
        bidder: typing.Union[MetaOapg.properties.bidder, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'CRYPTOPUNKSBidDTO':
        return super().__new__(
            cls,
