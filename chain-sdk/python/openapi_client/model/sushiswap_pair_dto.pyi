...
class SushiswapPairDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["factory"], typing_extensions.Literal["name"], typing_extensions.Literal["token_0"], typing_extensions.Literal["token_1"], typing_extensions.Literal["reserve_0"], typing_extensions.Literal["reserve_1"], typing_extensions.Literal["total_supply"], typing_extensions.Literal["reserve_eth"], typing_extensions.Literal["reserve_usd"], typing_extensions.Literal["tracked_reserve_eth"], typing_extensions.Literal["token_0_price"], typing_extensions.Literal["token_1_price"], typing_extensions.Literal["volume_token_0"], typing_extensions.Literal["volume_token_1"], typing_extensions.Literal["volume_usd"], typing_extensions.Literal["untracked_volume_usd"], typing_extensions.Literal["tx_count"], typing_extensions.Literal["liquidity_provider_count"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["block"], typing_extensions.Literal["vid"], typing_extensions.Literal["evaluated_ask"], ]):
