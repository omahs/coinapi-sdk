...
class CowTokenDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["address"], typing_extensions.Literal["first_trade_timestamp"], typing_extensions.Literal["name"], typing_extensions.Literal["symbol"], typing_extensions.Literal["decimals"], typing_extensions.Literal["total_volume"], typing_extensions.Literal["vid"], typing_extensions.Literal["token_symbol"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["total_volume"]) -> typing.Union[MetaOapg.properties.total_volume, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        first_trade_timestamp: typing.Union[MetaOapg.properties.first_trade_timestamp, None, str, schemas.Unset] = schemas.unset,
        ...
        total_volume: typing.Union[MetaOapg.properties.total_volume, None, str, schemas.Unset] = schemas.unset,
