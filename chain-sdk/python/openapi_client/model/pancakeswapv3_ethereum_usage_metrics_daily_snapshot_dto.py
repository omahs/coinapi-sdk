...
class PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["day"], typing_extensions.Literal["protocol"], typing_extensions.Literal["daily_active_users"], typing_extensions.Literal["cumulative_unique_users"], typing_extensions.Literal["daily_transaction_count"], typing_extensions.Literal["total_pool_count"], typing_extensions.Literal["daily_deposit_count"], typing_extensions.Literal["daily_withdraw_count"], typing_extensions.Literal["daily_swap_count"], typing_extensions.Literal["timestamp"], ]):
