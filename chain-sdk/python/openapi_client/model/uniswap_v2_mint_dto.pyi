...
class UniswapV2MintDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["transaction"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["pair"], typing_extensions.Literal["to"], typing_extensions.Literal["liquidity"], typing_extensions.Literal["sender"], typing_extensions.Literal["amount_0"], typing_extensions.Literal["amount_1"], typing_extensions.Literal["log_index"], typing_extensions.Literal["amount_usd"], typing_extensions.Literal["fee_to"], typing_extensions.Literal["fee_liquidity"], typing_extensions.Literal["vid"], typing_extensions.Literal["block_range"], ]):
