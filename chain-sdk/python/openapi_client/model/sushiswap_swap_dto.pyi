...
class SushiswapSwapDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["transaction"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["pair"], typing_extensions.Literal["sender"], typing_extensions.Literal["amount_0_in"], typing_extensions.Literal["amount_1_in"], typing_extensions.Literal["amount_0_out"], typing_extensions.Literal["amount_1_out"], typing_extensions.Literal["to"], typing_extensions.Literal["log_index"], typing_extensions.Literal["amount_usd"], typing_extensions.Literal["vid"], typing_extensions.Literal["pool_id"], typing_extensions.Literal["transaction_id"], typing_extensions.Literal["evaluated_price"], typing_extensions.Literal["evaluated_amount"], typing_extensions.Literal["evaluated_aggressor"], ]):
