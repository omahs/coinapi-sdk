...
class UniswapV2BurnDTO(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            needs_complete = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["needs_complete"]) -> MetaOapg.properties.needs_complete: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["transaction"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["pair"], typing_extensions.Literal["liquidity"], typing_extensions.Literal["sender"], typing_extensions.Literal["amount_0"], typing_extensions.Literal["amount_1"], typing_extensions.Literal["to"], typing_extensions.Literal["log_index"], typing_extensions.Literal["amount_usd"], typing_extensions.Literal["needs_complete"], typing_extensions.Literal["fee_to"], typing_extensions.Literal["fee_liquidity"], typing_extensions.Literal["vid"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["needs_complete"]) -> typing.Union[MetaOapg.properties.needs_complete, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        needs_complete: typing.Union[MetaOapg.properties.needs_complete, bool, schemas.Unset] = schemas.unset,
