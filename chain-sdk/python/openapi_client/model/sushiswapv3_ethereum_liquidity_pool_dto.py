...
class SUSHISWAPV3ETHEREUMLiquidityPoolDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["vid"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["protocol"], typing_extensions.Literal["name"], typing_extensions.Literal["symbol"], typing_extensions.Literal["liquidity_token"], typing_extensions.Literal["input_tokens"], typing_extensions.Literal["reward_tokens"], typing_extensions.Literal["fees"], typing_extensions.Literal["is_single_sided"], typing_extensions.Literal["created_timestamp"], typing_extensions.Literal["created_block_number"], typing_extensions.Literal["tick"], typing_extensions.Literal["total_value_locked_usd"], typing_extensions.Literal["total_liquidity"], typing_extensions.Literal["total_liquidity_usd"], typing_extensions.Literal["active_liquidity"], typing_extensions.Literal["active_liquidity_usd"], typing_extensions.Literal["uncollected_protocol_side_token_amounts"], typing_extensions.Literal["uncollected_protocol_side_values_usd"], typing_extensions.Literal["uncollected_supply_side_token_amounts"], typing_extensions.Literal["uncollected_supply_side_values_usd"], typing_extensions.Literal["cumulative_supply_side_revenue_usd"], typing_extensions.Literal["cumulative_protocol_side_revenue_usd"], typing_extensions.Literal["cumulative_total_revenue_usd"], typing_extensions.Literal["cumulative_volume_by_token_amount"], typing_extensions.Literal["cumulative_volume_by_token_usd"], typing_extensions.Literal["cumulative_volume_usd"], typing_extensions.Literal["input_token_balances"], typing_extensions.Literal["input_token_balances_usd"], typing_extensions.Literal["input_token_weights"], typing_extensions.Literal["staked_output_token_amount"], typing_extensions.Literal["reward_token_emissions_amount"], typing_extensions.Literal["reward_token_emissions_usd"], typing_extensions.Literal["cumulative_deposit_count"], typing_extensions.Literal["cumulative_withdraw_count"], typing_extensions.Literal["cumulative_swap_count"], typing_extensions.Literal["position_count"], typing_extensions.Literal["open_position_count"], typing_extensions.Literal["closed_position_count"], typing_extensions.Literal["last_snapshot_day_id"], typing_extensions.Literal["last_snapshot_hour_id"], typing_extensions.Literal["last_update_timestamp"], typing_extensions.Literal["last_update_block_number"], typing_extensions.Literal["evaluated_ask"], ]):
