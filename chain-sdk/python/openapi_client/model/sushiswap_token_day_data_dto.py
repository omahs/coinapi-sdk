...
class SushiswapTokenDayDataDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["date"], typing_extensions.Literal["token"], typing_extensions.Literal["volume"], typing_extensions.Literal["volume_eth"], typing_extensions.Literal["volume_usd"], typing_extensions.Literal["tx_count"], typing_extensions.Literal["liquidity"], typing_extensions.Literal["liquidity_eth"], typing_extensions.Literal["liquidity_usd"], typing_extensions.Literal["price_usd"], typing_extensions.Literal["vid"], ]):
