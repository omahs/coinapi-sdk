...
class CurveContractVersionDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["contract"], typing_extensions.Literal["address"], typing_extensions.Literal["version"], typing_extensions.Literal["added"], typing_extensions.Literal["added_at_block"], typing_extensions.Literal["added_at_transaction"], typing_extensions.Literal["vid"], ]):
