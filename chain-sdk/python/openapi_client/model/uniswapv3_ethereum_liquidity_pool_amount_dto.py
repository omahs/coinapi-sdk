...
class UNISWAPV3ETHEREUMLiquidityPoolAmountDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["input_tokens"], typing_extensions.Literal["input_token_balances"], typing_extensions.Literal["token_prices"], ]):
