...
class CURVEFINANCEETHEREUMDepositDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["hash"], typing_extensions.Literal["log_index"], typing_extensions.Literal["protocol"], typing_extensions.Literal["to"], typing_extensions.Literal["from"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["input_tokens"], typing_extensions.Literal["output_token"], typing_extensions.Literal["input_token_amounts"], typing_extensions.Literal["output_token_amount"], typing_extensions.Literal["amount_usd"], typing_extensions.Literal["pool"], ]):
