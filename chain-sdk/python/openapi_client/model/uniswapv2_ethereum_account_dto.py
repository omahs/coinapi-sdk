...
class UNISWAPV2ETHEREUMAccountDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["block_"], typing_extensions.Literal["id"], typing_extensions.Literal["block_range"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["block_"], typing_extensions.Literal["id"], typing_extensions.Literal["block_range"], ]):
