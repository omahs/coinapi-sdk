...
class CurveRemoveLiquidityEventDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["pool"], typing_extensions.Literal["provider"], typing_extensions.Literal["token_amounts"], typing_extensions.Literal["fees"], typing_extensions.Literal["token_supply"], typing_extensions.Literal["invariant"], typing_extensions.Literal["block"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["transaction"], typing_extensions.Literal["vid"], ]):
