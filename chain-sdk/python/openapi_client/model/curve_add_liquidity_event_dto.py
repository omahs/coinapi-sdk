...
class CurveAddLiquidityEventDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["token_amounts"]) -> MetaOapg.properties.token_amounts: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fees"]) -> MetaOapg.properties.fees: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["invariant"]) -> MetaOapg.properties.invariant: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["token_supply"]) -> MetaOapg.properties.token_supply: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["pool"], typing_extensions.Literal["provider"], typing_extensions.Literal["token_amounts"], typing_extensions.Literal["fees"], typing_extensions.Literal["invariant"], typing_extensions.Literal["token_supply"], typing_extensions.Literal["block"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["transaction"], typing_extensions.Literal["vid"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["token_amounts"]) -> typing.Union[MetaOapg.properties.token_amounts, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fees"]) -> typing.Union[MetaOapg.properties.fees, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["invariant"]) -> typing.Union[MetaOapg.properties.invariant, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["token_supply"]) -> typing.Union[MetaOapg.properties.token_supply, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        token_amounts: typing.Union[MetaOapg.properties.token_amounts, list, tuple, None, schemas.Unset] = schemas.unset,
        fees: typing.Union[MetaOapg.properties.fees, list, tuple, None, schemas.Unset] = schemas.unset,
        invariant: typing.Union[MetaOapg.properties.invariant, None, str, schemas.Unset] = schemas.unset,
        token_supply: typing.Union[MetaOapg.properties.token_supply, None, str, schemas.Unset] = schemas.unset,
