...
class CurveGaugeWeightVoteDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["id"], typing_extensions.Literal["gauge"], typing_extensions.Literal["user"], typing_extensions.Literal["time"], typing_extensions.Literal["weight"], typing_extensions.Literal["vid"], ]):
