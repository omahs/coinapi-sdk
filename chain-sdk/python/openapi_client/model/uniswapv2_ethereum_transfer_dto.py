...
class UNISWAPV2ETHEREUMTransferDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entry_time"], typing_extensions.Literal["recv_time"], typing_extensions.Literal["block_number"], typing_extensions.Literal["block_range"], typing_extensions.Literal["id"], typing_extensions.Literal["timestamp"], typing_extensions.Literal["sender"], typing_extensions.Literal["type"], typing_extensions.Literal["liquidity"], ]):
