# openapi_client.model.pancakeswapv3_ethereum_liquidity_pool_daily_snapshot_dto.PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Represents a liquidity pool daily snapshot for PancakeSwap V3. | 
...
**block_** | decimal.Decimal, int,  | decimal.Decimal,  | The Ethereum block number associated with the liquidity pool daily snapshot. | [optional] value must be a 32 bit integer
...
**protocol** | None, str,  | NoneClass, str,  | Protocol associated with the liquidity pool. | [optional] 
**pool** | None, str,  | NoneClass, str,  | Pool this snapshot belongs to. | [optional] 
...
**daily_supply_side_revenue_usd** | None, str,  | NoneClass, str,  | Daily revenue generated by the liquidity pool, accrued to the supply side. | [optional] 
