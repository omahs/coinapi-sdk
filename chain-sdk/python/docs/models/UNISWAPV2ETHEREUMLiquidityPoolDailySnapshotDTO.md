# openapi_client.model.uniswapv2_ethereum_liquidity_pool_daily_snapshot_dto.UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Represents a liquidity pool daily snapshot for Uniswap V2. | 
...
**id** | None, str,  | NoneClass, str,  | (smart contract address of the pool)-(# of days since Unix epoch time) | [optional] 
