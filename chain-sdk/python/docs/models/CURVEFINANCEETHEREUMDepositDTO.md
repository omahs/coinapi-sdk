# openapi_client.model.curvefinanceethereum_deposit_dto.CURVEFINANCEETHEREUMDepositDTO
...
**id** | None, str,  | NoneClass, str,  | deposit-(Transaction hash)-(log index) | [optional] 
...
**output_token** | None, str,  | NoneClass, str,  | Output token of the pool. E.g. the UNI-LP token | [optional] 
