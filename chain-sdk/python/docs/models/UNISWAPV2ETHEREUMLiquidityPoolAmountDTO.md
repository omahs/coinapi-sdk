# openapi_client.model.uniswapv2_ethereum_liquidity_pool_amount_dto.UNISWAPV2ETHEREUMLiquidityPoolAmountDTO
...
**[input_token_balances](#input_token_balances)** | list, tuple, None,  | tuple, NoneClass,  | Amount of input tokens in the pool. The ordering is the same as the pool&#x27;s &#x27;inputTokens&#x27; field. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple, None,  | tuple, NoneClass,  | Amount of input tokens in the pool. The ordering is the same as the pool&#x27;s &#x27;inputTokens&#x27; field. | 
