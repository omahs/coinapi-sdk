...
module OpenapiClient
  ...
  class UniswapV2PairDayDataDTO
    ...
    attr_accessor :daily_volume_token_0

    # Total amount of token1 swapped throughout day.
    attr_accessor :daily_volume_token_1
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UniswapV2PairDayDataDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UniswapV2PairDayDataDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pair_address')
        self.pair_address = attributes[:'pair_address']
      end
      ...
      if attributes.key?(:'daily_volume_token_0')
        self.daily_volume_token_0 = attributes[:'daily_volume_token_0']
      end

      if attributes.key?(:'daily_volume_token_1')
        self.daily_volume_token_1 = attributes[:'daily_volume_token_1']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          daily_volume_token_0 == o.daily_volume_token_0 &&
          daily_volume_token_1 == o.daily_volume_token_1 &&
    ...
    def hash
      [entry_time, recv_time, block_number, id, date, pair_address, token_0, token_1, reserve_0, reserve_1, total_supply, reserve_usd, daily_volume_token_0, daily_volume_token_1, daily_volume_usd, daily_txns, vid].hash
    end
