  ...
  class UniswapV2TokenDTO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UniswapV2TokenDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UniswapV2TokenDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'trade_volume_usd')
        self.trade_volume_usd = attributes[:'trade_volume_usd']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          trade_volume_usd == o.trade_volume_usd &&
    ...
    def hash
      [entry_time, recv_time, block_number, vid, id, symbol, name, decimals, total_supply, trade_volume, trade_volume_usd, untracked_volume_usd, tx_count, total_liquidity, derived_eth, token_symbol].hash
    end
