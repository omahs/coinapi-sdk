...
module OpenapiClient
  ...
  class UNISWAPV2ETHEREUMWithdrawDTO
    ...
    attr_accessor :output_token_amount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UNISWAPV2ETHEREUMWithdrawDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UNISWAPV2ETHEREUMWithdrawDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'output_token_amount')
        self.output_token_amount = attributes[:'output_token_amount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          output_token_amount == o.output_token_amount &&
    ...
    def hash
      [entry_time, recv_time, block_number, block_, id, hash, log_index, protocol, to, from, timestamp, input_tokens, output_token, input_token_amounts, output_token_amount, reserve_amounts, amount_usd, pool, block_range].hash
    end
