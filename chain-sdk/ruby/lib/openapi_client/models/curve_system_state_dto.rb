...
module OpenapiClient
  class CurveSystemStateDTO
    ...
    attr_accessor :registry_contract
    ...
    attr_accessor :gauge_type_count
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CurveSystemStateDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CurveSystemStateDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'registry_contract')
        self.registry_contract = attributes[:'registry_contract']
      end
      ...
      if attributes.key?(:'gauge_type_count')
        self.gauge_type_count = attributes[:'gauge_type_count']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          registry_contract == o.registry_contract &&
          contract_count == o.contract_count &&
          gauge_count == o.gauge_count &&
          gauge_type_count == o.gauge_type_count &&
    ...
    def hash
      [entry_time, recv_time, block_number, id, registry_contract, contract_count, gauge_count, gauge_type_count, pool_count, token_count, total_pool_count, updated, updated_at_block, updated_at_transaction, vid].hash
    end
