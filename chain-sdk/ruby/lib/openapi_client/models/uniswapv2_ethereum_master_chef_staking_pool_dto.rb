  ...
  class UNISWAPV2ETHEREUMMasterChefStakingPoolDTO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UNISWAPV2ETHEREUMMasterChefStakingPoolDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UNISWAPV2ETHEREUMMasterChefStakingPoolDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pool_alloc_point')
        self.pool_alloc_point = attributes[:'pool_alloc_point']
      end
      ...
      if attributes.key?(:'last_reward_block')
        self.last_reward_block = attributes[:'last_reward_block']
      end

      if attributes.key?(:'rewarder')
        self.rewarder = attributes[:'rewarder']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pool_alloc_point == o.pool_alloc_point &&
          multiplier == o.multiplier &&
          last_reward_block == o.last_reward_block &&
          rewarder == o.rewarder
    end
    ...
    def hash
      [entry_time, recv_time, block_number, block_range, id, pool_address, pool_alloc_point, multiplier, last_reward_block, rewarder].hash
    end
