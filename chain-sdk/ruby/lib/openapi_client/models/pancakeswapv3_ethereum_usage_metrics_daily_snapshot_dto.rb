...
module OpenapiClient
  ...
  class PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
    ...
    attr_accessor :daily_active_users
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'daily_active_users')
        self.daily_active_users = attributes[:'daily_active_users']
      end
      ...
      if attributes.key?(:'daily_transaction_count')
        self.daily_transaction_count = attributes[:'daily_transaction_count']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          day == o.day &&
          protocol == o.protocol &&
          daily_active_users == o.daily_active_users &&
          cumulative_unique_users == o.cumulative_unique_users &&
          daily_transaction_count == o.daily_transaction_count &&
    ...
    def hash
      [entry_time, recv_time, block_number, id, day, protocol, daily_active_users, cumulative_unique_users, daily_transaction_count, total_pool_count, daily_deposit_count, daily_withdraw_count, daily_swap_count, timestamp].hash
    end
