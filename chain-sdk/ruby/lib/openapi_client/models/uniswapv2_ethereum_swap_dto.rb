  ...
  class UNISWAPV2ETHEREUMSwapDTO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UNISWAPV2ETHEREUMSwapDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UNISWAPV2ETHEREUMSwapDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'token_in')
        self.token_in = attributes[:'token_in']
      end
      ...
      if attributes.key?(:'token_out')
        self.token_out = attributes[:'token_out']
      end
      ...
      if attributes.key?(:'amount_out_usd')
        self.amount_out_usd = attributes[:'amount_out_usd']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount_out_usd == o.amount_out_usd &&
    ...
    def hash
      [entry_time, recv_time, block_number, block_, id, hash, log_index, protocol, to, from, timestamp, token_in, amount_in, amount_in_usd, token_out, amount_out, amount_out_usd, reserve_amounts, pool, block_range, pool_id, transaction_id, evaluated_price, evaluated_amount, evaluated_aggressor].hash
    end
