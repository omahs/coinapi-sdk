...
module OpenapiClient
  ...
  class PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO
    ...
    attr_accessor :hourly_volume_by_token_amount
    ...
    attr_accessor :hourly_volume_by_token_usd
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hourly_supply_side_revenue_usd')
        self.hourly_supply_side_revenue_usd = attributes[:'hourly_supply_side_revenue_usd']
      end
      ...
      if attributes.key?(:'hourly_protocol_side_revenue_usd')
        self.hourly_protocol_side_revenue_usd = attributes[:'hourly_protocol_side_revenue_usd']
      end
      ...
      if attributes.key?(:'hourly_total_revenue_usd')
        self.hourly_total_revenue_usd = attributes[:'hourly_total_revenue_usd']
      end
      ...
      if attributes.key?(:'hourly_volume_usd')
        self.hourly_volume_usd = attributes[:'hourly_volume_usd']
      end
      ...
      if attributes.key?(:'hourly_volume_by_token_amount')
        if (value = attributes[:'hourly_volume_by_token_amount']).is_a?(Array)
          self.hourly_volume_by_token_amount = value
        end
      end
      ...
      if attributes.key?(:'hourly_volume_by_token_usd')
        if (value = attributes[:'hourly_volume_by_token_usd']).is_a?(Array)
          self.hourly_volume_by_token_usd = value
        end
      end
      ...
      if attributes.key?(:'hourly_deposit_count')
        self.hourly_deposit_count = attributes[:'hourly_deposit_count']
      end
      ...
      if attributes.key?(:'hourly_withdraw_count')
        self.hourly_withdraw_count = attributes[:'hourly_withdraw_count']
      end
      ...
      if attributes.key?(:'hourly_swap_count')
        self.hourly_swap_count = attributes[:'hourly_swap_count']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          hourly_supply_side_revenue_usd == o.hourly_supply_side_revenue_usd &&
          cumulative_protocol_side_revenue_usd == o.cumulative_protocol_side_revenue_usd &&
          hourly_protocol_side_revenue_usd == o.hourly_protocol_side_revenue_usd &&
          cumulative_total_revenue_usd == o.cumulative_total_revenue_usd &&
          hourly_total_revenue_usd == o.hourly_total_revenue_usd &&
          cumulative_volume_usd == o.cumulative_volume_usd &&
          hourly_volume_usd == o.hourly_volume_usd &&
          cumulative_volume_by_token_amount == o.cumulative_volume_by_token_amount &&
          hourly_volume_by_token_amount == o.hourly_volume_by_token_amount &&
          cumulative_volume_by_token_usd == o.cumulative_volume_by_token_usd &&
          hourly_volume_by_token_usd == o.hourly_volume_by_token_usd &&
          ...
          hourly_deposit_count == o.hourly_deposit_count &&
          cumulative_withdraw_count == o.cumulative_withdraw_count &&
          hourly_withdraw_count == o.hourly_withdraw_count &&
          cumulative_swap_count == o.cumulative_swap_count &&
          hourly_swap_count == o.hourly_swap_count &&
