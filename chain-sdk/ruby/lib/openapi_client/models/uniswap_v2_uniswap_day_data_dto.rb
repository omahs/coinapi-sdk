...
module OpenapiClient
  ...
  class UniswapV2UniswapDayDataDTO
    ...
    attr_accessor :daily_volume_untracked
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UniswapV2UniswapDayDataDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UniswapV2UniswapDayDataDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'daily_volume_untracked')
        self.daily_volume_untracked = attributes[:'daily_volume_untracked']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          daily_volume_untracked == o.daily_volume_untracked &&
    ...
    def hash
      [entry_time, recv_time, block_number, id, date, daily_volume_eth, daily_volume_usd, daily_volume_untracked, total_volume_eth, total_liquidity_eth, total_volume_usd, total_liquidity_usd, tx_count, vid].hash
    end
