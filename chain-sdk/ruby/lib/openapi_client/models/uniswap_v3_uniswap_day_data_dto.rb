  ...
  class UniswapV3UniswapDayDataDTO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UniswapV3UniswapDayDataDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UniswapV3UniswapDayDataDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'volume_usd_untracked')
        self.volume_usd_untracked = attributes[:'volume_usd_untracked']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          volume_usd_untracked == o.volume_usd_untracked &&
          fees_usd == o.fees_usd &&
          tx_count == o.tx_count &&
          tvl_usd == o.tvl_usd
    end
    ...
    def hash
      [entry_time, recv_time, block_number, vid, id, date, volume_eth, volume_usd, volume_usd_untracked, fees_usd, tx_count, tvl_usd].hash
    end
