...
module OpenapiClient
  class CurveExchangeDTO
    ...
    # 
    attr_accessor :token_sold

    # 
    attr_accessor :token_bought

    # 
    attr_accessor :amount_sold

    # 
    attr_accessor :amount_bought
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CurveExchangeDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CurveExchangeDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'token_sold')
        self.token_sold = attributes[:'token_sold']
      end

      if attributes.key?(:'token_bought')
        self.token_bought = attributes[:'token_bought']
      end

      if attributes.key?(:'amount_sold')
        self.amount_sold = attributes[:'amount_sold']
      end

      if attributes.key?(:'amount_bought')
        self.amount_bought = attributes[:'amount_bought']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          buyer == o.buyer &&
          receiver == o.receiver &&
          token_sold == o.token_sold &&
          token_bought == o.token_bought &&
          amount_sold == o.amount_sold &&
          amount_bought == o.amount_bought &&
          block == o.block &&
    ...
    def hash
      [entry_time, recv_time, block_number, id, pool, buyer, receiver, token_sold, token_bought, amount_sold, amount_bought, block, timestamp, transaction, vid, evaluated_price, evaluated_amount, evaluated_aggressor, pool_id, transaction_id].hash
    end
