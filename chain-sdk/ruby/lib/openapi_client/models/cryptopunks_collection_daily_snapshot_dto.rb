...
module OpenapiClient
  class CRYPTOPUNKSCollectionDailySnapshotDTO
    ...
    # 
    attr_accessor :daily_min_sale_price

    # 
    attr_accessor :daily_max_sale_price

    # 
    attr_accessor :cumulative_trade_volume_eth

    # 
    attr_accessor :daily_trade_volume_eth
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CRYPTOPUNKSCollectionDailySnapshotDTO` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CRYPTOPUNKSCollectionDailySnapshotDTO`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'daily_min_sale_price')
        self.daily_min_sale_price = attributes[:'daily_min_sale_price']
      end

      if attributes.key?(:'daily_max_sale_price')
        self.daily_max_sale_price = attributes[:'daily_max_sale_price']
      end
      ...
      if attributes.key?(:'daily_trade_volume_eth')
        self.daily_trade_volume_eth = attributes[:'daily_trade_volume_eth']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          daily_min_sale_price == o.daily_min_sale_price &&
          daily_max_sale_price == o.daily_max_sale_price &&
          cumulative_trade_volume_eth == o.cumulative_trade_volume_eth &&
          daily_trade_volume_eth == o.daily_trade_volume_eth &&
    ...
    def hash
      [entry_time, recv_time, block_number, vid, block_range, id, collection, timestamp, royalty_fee, daily_min_sale_price, daily_max_sale_price, cumulative_trade_volume_eth, daily_trade_volume_eth, marketplace_revenue_eth, creator_revenue_eth, total_revenue_eth, trade_count, daily_traded_item_count].hash
    end
