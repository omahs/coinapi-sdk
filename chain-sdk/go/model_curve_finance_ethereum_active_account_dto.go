...
// checks if the CURVEFINANCEETHEREUMActiveAccountDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CURVEFINANCEETHEREUMActiveAccountDTO{}

// CURVEFINANCEETHEREUMActiveAccountDTO Entity for calculating daily/hourly active users.
type CURVEFINANCEETHEREUMActiveAccountDTO struct {
...
func NewCURVEFINANCEETHEREUMActiveAccountDTO() *CURVEFINANCEETHEREUMActiveAccountDTO {
	this := CURVEFINANCEETHEREUMActiveAccountDTO{}
	return &this
}
...
func (o *CURVEFINANCEETHEREUMActiveAccountDTO) SetBlockRangeNil() {
...
func (o *CURVEFINANCEETHEREUMActiveAccountDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o CURVEFINANCEETHEREUMActiveAccountDTO) MarshalJSON() ([]byte, error) {
...
func (o CURVEFINANCEETHEREUMActiveAccountDTO) ToMap() (map[string]interface{}, error) {
...
type NullableCURVEFINANCEETHEREUMActiveAccountDTO struct {
	value *CURVEFINANCEETHEREUMActiveAccountDTO
	isSet bool
}

func (v NullableCURVEFINANCEETHEREUMActiveAccountDTO) Get() *CURVEFINANCEETHEREUMActiveAccountDTO {
	return v.value
}

func (v *NullableCURVEFINANCEETHEREUMActiveAccountDTO) Set(val *CURVEFINANCEETHEREUMActiveAccountDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableCURVEFINANCEETHEREUMActiveAccountDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableCURVEFINANCEETHEREUMActiveAccountDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCURVEFINANCEETHEREUMActiveAccountDTO(val *CURVEFINANCEETHEREUMActiveAccountDTO) *NullableCURVEFINANCEETHEREUMActiveAccountDTO {
	return &NullableCURVEFINANCEETHEREUMActiveAccountDTO{value: val, isSet: true}
}

func (v NullableCURVEFINANCEETHEREUMActiveAccountDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCURVEFINANCEETHEREUMActiveAccountDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
