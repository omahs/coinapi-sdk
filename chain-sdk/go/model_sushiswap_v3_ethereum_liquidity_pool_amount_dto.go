...
// checks if the SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO{}

// SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO 
type SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO struct {
...
func NewSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO() *SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO {
	this := SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) SetBlockRangeNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO struct {
	value *SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) Get() *SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) Set(val *SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO(val *SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) *NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO {
	return &NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
