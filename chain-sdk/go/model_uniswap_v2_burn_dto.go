...
// checks if the UniswapV2BurnDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniswapV2BurnDTO{}

// UniswapV2BurnDTO Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned LP tokens, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
type UniswapV2BurnDTO struct {
	...
	// 
	NeedsComplete *bool `json:"needs_complete,omitempty"`
...
func (o *UniswapV2BurnDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetTransactionNil() {
...
func (o *UniswapV2BurnDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetPairNil() {
	o.Pair.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetSenderNil() {
	o.Sender.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetAmount0Nil() {
	o.Amount0.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetAmount1Nil() {
	o.Amount1.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetToNil() {
	o.To.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetLogIndexNil() {
	o.LogIndex.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
// GetNeedsComplete returns the NeedsComplete field value if set, zero value otherwise.
func (o *UniswapV2BurnDTO) GetNeedsComplete() bool {
	if o == nil || IsNil(o.NeedsComplete) {
		var ret bool
		return ret
	}
	return *o.NeedsComplete
}

// GetNeedsCompleteOk returns a tuple with the NeedsComplete field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UniswapV2BurnDTO) GetNeedsCompleteOk() (*bool, bool) {
	if o == nil || IsNil(o.NeedsComplete) {
		return nil, false
	}
	return o.NeedsComplete, true
}
...
// SetNeedsComplete gets a reference to the given bool and assigns it to the NeedsComplete field.
...
func (o *UniswapV2BurnDTO) SetFeeToNil() {
	o.FeeTo.Set(nil)
}
...
func (o *UniswapV2BurnDTO) SetFeeLiquidityNil() {
...
func (o UniswapV2BurnDTO) MarshalJSON() ([]byte, error) {
...
func (o UniswapV2BurnDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NeedsComplete) {
		toSerialize["needs_complete"] = o.NeedsComplete
	}
	if o.FeeTo.IsSet() {
...
type NullableUniswapV2BurnDTO struct {
	value *UniswapV2BurnDTO
	isSet bool
}

func (v NullableUniswapV2BurnDTO) Get() *UniswapV2BurnDTO {
	return v.value
}

func (v *NullableUniswapV2BurnDTO) Set(val *UniswapV2BurnDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV2BurnDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV2BurnDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV2BurnDTO(val *UniswapV2BurnDTO) *NullableUniswapV2BurnDTO {
	return &NullableUniswapV2BurnDTO{value: val, isSet: true}
}

func (v NullableUniswapV2BurnDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV2BurnDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
