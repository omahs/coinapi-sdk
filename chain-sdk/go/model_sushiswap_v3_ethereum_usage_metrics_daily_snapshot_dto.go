...
// checks if the SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO{}

// SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO 
type SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO struct {
...
func NewSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO() *SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
	this := SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO struct {
	value *SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) Get() *SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) Set(val *SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO(val *SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) *NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
	return &NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
