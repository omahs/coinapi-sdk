...
// checks if the UNISWAPV3ETHEREUMWithdrawDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UNISWAPV3ETHEREUMWithdrawDTO{}

// UNISWAPV3ETHEREUMWithdrawDTO 
type UNISWAPV3ETHEREUMWithdrawDTO struct {
...
func NewUNISWAPV3ETHEREUMWithdrawDTO() *UNISWAPV3ETHEREUMWithdrawDTO {
	this := UNISWAPV3ETHEREUMWithdrawDTO{}
	return &this
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetNonceNil() {
	o.Nonce.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetGasLimitNil() {
	o.GasLimit.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetGasUsedNil() {
	o.GasUsed.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetGasPriceNil() {
	o.GasPrice.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMWithdrawDTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o UNISWAPV3ETHEREUMWithdrawDTO) MarshalJSON() ([]byte, error) {
...
func (o UNISWAPV3ETHEREUMWithdrawDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUNISWAPV3ETHEREUMWithdrawDTO struct {
	value *UNISWAPV3ETHEREUMWithdrawDTO
	isSet bool
}

func (v NullableUNISWAPV3ETHEREUMWithdrawDTO) Get() *UNISWAPV3ETHEREUMWithdrawDTO {
	return v.value
}

func (v *NullableUNISWAPV3ETHEREUMWithdrawDTO) Set(val *UNISWAPV3ETHEREUMWithdrawDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUNISWAPV3ETHEREUMWithdrawDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUNISWAPV3ETHEREUMWithdrawDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUNISWAPV3ETHEREUMWithdrawDTO(val *UNISWAPV3ETHEREUMWithdrawDTO) *NullableUNISWAPV3ETHEREUMWithdrawDTO {
	return &NullableUNISWAPV3ETHEREUMWithdrawDTO{value: val, isSet: true}
}

func (v NullableUNISWAPV3ETHEREUMWithdrawDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUNISWAPV3ETHEREUMWithdrawDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
