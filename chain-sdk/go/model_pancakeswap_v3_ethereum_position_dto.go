...
// checks if the PANCAKESWAPV3ETHEREUMPositionDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMPositionDTO{}

// PANCAKESWAPV3ETHEREUMPositionDTO 
type PANCAKESWAPV3ETHEREUMPositionDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMPositionDTO() *PANCAKESWAPV3ETHEREUMPositionDTO {
	this := PANCAKESWAPV3ETHEREUMPositionDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetHashOpenedNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetHashClosedNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetBlockNumberOpenedNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetTimestampOpenedNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetBlockNumberClosedNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetTimestampClosedNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetLiquidityTokenNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetLiquidityTokenTypeNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetLiquidityUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetCumulativeDepositUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionDTO) SetCumulativeWithdrawUsdNil() {
...
func (o PANCAKESWAPV3ETHEREUMPositionDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMPositionDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMPositionDTO struct {
	value *PANCAKESWAPV3ETHEREUMPositionDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMPositionDTO) Get() *PANCAKESWAPV3ETHEREUMPositionDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMPositionDTO) Set(val *PANCAKESWAPV3ETHEREUMPositionDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMPositionDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMPositionDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMPositionDTO(val *PANCAKESWAPV3ETHEREUMPositionDTO) *NullablePANCAKESWAPV3ETHEREUMPositionDTO {
	return &NullablePANCAKESWAPV3ETHEREUMPositionDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMPositionDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMPositionDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
