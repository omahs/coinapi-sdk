...
// checks if the PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO{}

// PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO 
type PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO() *PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO {
	this := PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) SetBlockRangeNil() {
...
func (o *PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) SetFeePercentageNil() {
...
func (o PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO struct {
	value *PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) Get() *PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) Set(val *PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO(val *PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) *NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO {
	return &NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
