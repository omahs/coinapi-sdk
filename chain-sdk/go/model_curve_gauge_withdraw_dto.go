...
// checks if the CurveGaugeWithdrawDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurveGaugeWithdrawDTO{}
...
func (o CurveGaugeWithdrawDTO) ToMap() (map[string]interface{}, error) {
