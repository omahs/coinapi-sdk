...
// checks if the UniswapV3BurnDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniswapV3BurnDTO{}

// UniswapV3BurnDTO Burn entities are created for every emitted Burn event on the Uniswap core contracts. The Burn entity stores key data about the event like token amounts, who burned, who received tokens, and more. This entity can be used to track liquidity removals on pairs.
type UniswapV3BurnDTO struct {
...
func (o *UniswapV3BurnDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetTransactionNil() {
...
func (o *UniswapV3BurnDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetToken0Nil() {
	o.Token0.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetToken1Nil() {
	o.Token1.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetOriginNil() {
	o.Origin.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetAmountNil() {
	o.Amount.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetAmount0Nil() {
	o.Amount0.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetAmount1Nil() {
	o.Amount1.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *UniswapV3BurnDTO) SetLogIndexNil() {
	o.LogIndex.Set(nil)
}
...
func (o UniswapV3BurnDTO) MarshalJSON() ([]byte, error) {
...
func (o UniswapV3BurnDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUniswapV3BurnDTO struct {
	value *UniswapV3BurnDTO
	isSet bool
}

func (v NullableUniswapV3BurnDTO) Get() *UniswapV3BurnDTO {
	return v.value
}

func (v *NullableUniswapV3BurnDTO) Set(val *UniswapV3BurnDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3BurnDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3BurnDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3BurnDTO(val *UniswapV3BurnDTO) *NullableUniswapV3BurnDTO {
	return &NullableUniswapV3BurnDTO{value: val, isSet: true}
}

func (v NullableUniswapV3BurnDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3BurnDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
