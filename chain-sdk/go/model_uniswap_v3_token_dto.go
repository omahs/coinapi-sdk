...
// checks if the UniswapV3TokenDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniswapV3TokenDTO{}
...
func (o UniswapV3TokenDTO) ToMap() (map[string]interface{}, error) {
