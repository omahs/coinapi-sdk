...
// checks if the SUSHISWAPV3ETHEREUMTickDailySnapshotDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMTickDailySnapshotDTO{}

// SUSHISWAPV3ETHEREUMTickDailySnapshotDTO 
type SUSHISWAPV3ETHEREUMTickDailySnapshotDTO struct {
...
func NewSUSHISWAPV3ETHEREUMTickDailySnapshotDTO() *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO {
	this := SUSHISWAPV3ETHEREUMTickDailySnapshotDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) SetTickNil() {
	o.Tick.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) SetLiquidityGrossNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) SetLiquidityGrossUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) SetLiquidityNetNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) SetLiquidityNetUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO struct {
	value *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO) Get() *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO) Set(val *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO(val *SUSHISWAPV3ETHEREUMTickDailySnapshotDTO) *NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO {
	return &NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMTickDailySnapshotDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
