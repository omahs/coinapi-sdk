...
// checks if the UNISWAPV3ETHEREUMDexAmmProtocolDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UNISWAPV3ETHEREUMDexAmmProtocolDTO{}

// UNISWAPV3ETHEREUMDexAmmProtocolDTO  Decentralized exchange (Dex) automated market maker (Amm) protocol. It's an entity that represents a protocol involving a smart contract that use automated market makers.
type UNISWAPV3ETHEREUMDexAmmProtocolDTO struct {
...
func NewUNISWAPV3ETHEREUMDexAmmProtocolDTO() *UNISWAPV3ETHEREUMDexAmmProtocolDTO {
	this := UNISWAPV3ETHEREUMDexAmmProtocolDTO{}
	return &this
}
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetBlockRangeNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) GetName() string {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetSlugNil() {
	o.Slug.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetSchemaVersionNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) GetSubgraphVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetSubgraphVersionNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetMethodologyVersionNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetTotalValueLockedUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetTotalLiquidityUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetActiveLiquidityUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetUncollectedProtocolSideValueUsdNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) GetUncollectedSupplySideValueUsdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetUncollectedSupplySideValueUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetProtocolControlledValueUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetCumulativeVolumeUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetCumulativeSupplySideRevenueUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetCumulativeProtocolSideRevenueUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetCumulativeTotalRevenueUsdNil() {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) GetCumulativeUniqueUsers() int32 {
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetLastUpdateTimestampNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) GetLastUpdateBlockNumberOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UNISWAPV3ETHEREUMDexAmmProtocolDTO) SetLastUpdateBlockNumberNil() {
...
func (o UNISWAPV3ETHEREUMDexAmmProtocolDTO) MarshalJSON() ([]byte, error) {
...
func (o UNISWAPV3ETHEREUMDexAmmProtocolDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO struct {
	value *UNISWAPV3ETHEREUMDexAmmProtocolDTO
	isSet bool
}

func (v NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO) Get() *UNISWAPV3ETHEREUMDexAmmProtocolDTO {
	return v.value
}

func (v *NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO) Set(val *UNISWAPV3ETHEREUMDexAmmProtocolDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUNISWAPV3ETHEREUMDexAmmProtocolDTO(val *UNISWAPV3ETHEREUMDexAmmProtocolDTO) *NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO {
	return &NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO{value: val, isSet: true}
}

func (v NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUNISWAPV3ETHEREUMDexAmmProtocolDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
