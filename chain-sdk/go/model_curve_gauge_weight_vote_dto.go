...
// checks if the CurveGaugeWeightVoteDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurveGaugeWeightVoteDTO{}

// CurveGaugeWeightVoteDTO struct for CurveGaugeWeightVoteDTO
type CurveGaugeWeightVoteDTO struct {
...
func (o *CurveGaugeWeightVoteDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *CurveGaugeWeightVoteDTO) SetGaugeNil() {
	o.Gauge.Set(nil)
}
...
func (o *CurveGaugeWeightVoteDTO) SetUserNil() {
	o.User.Set(nil)
}
...
func (o *CurveGaugeWeightVoteDTO) SetTimeNil() {
	o.Time.Set(nil)
}
...
func (o *CurveGaugeWeightVoteDTO) SetWeightNil() {
	o.Weight.Set(nil)
}
...
func (o CurveGaugeWeightVoteDTO) MarshalJSON() ([]byte, error) {
...
type NullableCurveGaugeWeightVoteDTO struct {
	value *CurveGaugeWeightVoteDTO
	isSet bool
}

func (v NullableCurveGaugeWeightVoteDTO) Get() *CurveGaugeWeightVoteDTO {
	return v.value
}

func (v *NullableCurveGaugeWeightVoteDTO) Set(val *CurveGaugeWeightVoteDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableCurveGaugeWeightVoteDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableCurveGaugeWeightVoteDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCurveGaugeWeightVoteDTO(val *CurveGaugeWeightVoteDTO) *NullableCurveGaugeWeightVoteDTO {
	return &NullableCurveGaugeWeightVoteDTO{value: val, isSet: true}
}

func (v NullableCurveGaugeWeightVoteDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCurveGaugeWeightVoteDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
