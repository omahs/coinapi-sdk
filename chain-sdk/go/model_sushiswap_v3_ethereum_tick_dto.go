...
// checks if the SUSHISWAPV3ETHEREUMTickDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMTickDTO{}

// SUSHISWAPV3ETHEREUMTickDTO 
type SUSHISWAPV3ETHEREUMTickDTO struct {
...
func NewSUSHISWAPV3ETHEREUMTickDTO() *SUSHISWAPV3ETHEREUMTickDTO {
	this := SUSHISWAPV3ETHEREUMTickDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetIndexNil() {
	o.Index.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetCreatedTimestampNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetCreatedBlockNumberNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetLiquidityGrossNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetLiquidityGrossUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetLiquidityNetNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetLiquidityNetUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetLastUpdateTimestampNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickDTO) SetLastUpdateBlockNumberNil() {
...
func (o SUSHISWAPV3ETHEREUMTickDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMTickDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMTickDTO struct {
	value *SUSHISWAPV3ETHEREUMTickDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMTickDTO) Get() *SUSHISWAPV3ETHEREUMTickDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMTickDTO) Set(val *SUSHISWAPV3ETHEREUMTickDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMTickDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMTickDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMTickDTO(val *SUSHISWAPV3ETHEREUMTickDTO) *NullableSUSHISWAPV3ETHEREUMTickDTO {
	return &NullableSUSHISWAPV3ETHEREUMTickDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMTickDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMTickDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
