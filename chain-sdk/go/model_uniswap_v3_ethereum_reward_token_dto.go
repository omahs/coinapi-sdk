...
// checks if the UNISWAPV3ETHEREUMRewardTokenDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UNISWAPV3ETHEREUMRewardTokenDTO{}

// UNISWAPV3ETHEREUMRewardTokenDTO Reward tokens awarded to lenders and borrowers.
type UNISWAPV3ETHEREUMRewardTokenDTO struct {
...
func NewUNISWAPV3ETHEREUMRewardTokenDTO() *UNISWAPV3ETHEREUMRewardTokenDTO {
	this := UNISWAPV3ETHEREUMRewardTokenDTO{}
	return &this
}
...
func (o *UNISWAPV3ETHEREUMRewardTokenDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMRewardTokenDTO) SetTokenNil() {
	o.Token.Set(nil)
}
...
func (o UNISWAPV3ETHEREUMRewardTokenDTO) MarshalJSON() ([]byte, error) {
...
func (o UNISWAPV3ETHEREUMRewardTokenDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUNISWAPV3ETHEREUMRewardTokenDTO struct {
	value *UNISWAPV3ETHEREUMRewardTokenDTO
	isSet bool
}

func (v NullableUNISWAPV3ETHEREUMRewardTokenDTO) Get() *UNISWAPV3ETHEREUMRewardTokenDTO {
	return v.value
}

func (v *NullableUNISWAPV3ETHEREUMRewardTokenDTO) Set(val *UNISWAPV3ETHEREUMRewardTokenDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUNISWAPV3ETHEREUMRewardTokenDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUNISWAPV3ETHEREUMRewardTokenDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUNISWAPV3ETHEREUMRewardTokenDTO(val *UNISWAPV3ETHEREUMRewardTokenDTO) *NullableUNISWAPV3ETHEREUMRewardTokenDTO {
	return &NullableUNISWAPV3ETHEREUMRewardTokenDTO{value: val, isSet: true}
}

func (v NullableUNISWAPV3ETHEREUMRewardTokenDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUNISWAPV3ETHEREUMRewardTokenDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
