...
// checks if the UniswapV3SwapDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniswapV3SwapDTO{}
...
func (o UniswapV3SwapDTO) ToMap() (map[string]interface{}, error) {
