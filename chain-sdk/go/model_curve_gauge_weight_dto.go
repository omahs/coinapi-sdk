...
// checks if the CurveGaugeWeightDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurveGaugeWeightDTO{}

// CurveGaugeWeightDTO struct for CurveGaugeWeightDTO
type CurveGaugeWeightDTO struct {
...
func (o *CurveGaugeWeightDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *CurveGaugeWeightDTO) SetGaugeNil() {
	o.Gauge.Set(nil)
}
...
func (o *CurveGaugeWeightDTO) SetTimeNil() {
	o.Time.Set(nil)
}
...
func (o *CurveGaugeWeightDTO) SetWeightNil() {
	o.Weight.Set(nil)
}
...
func (o CurveGaugeWeightDTO) MarshalJSON() ([]byte, error) {
...
func (o CurveGaugeWeightDTO) ToMap() (map[string]interface{}, error) {
...
type NullableCurveGaugeWeightDTO struct {
	value *CurveGaugeWeightDTO
	isSet bool
}

func (v NullableCurveGaugeWeightDTO) Get() *CurveGaugeWeightDTO {
	return v.value
}

func (v *NullableCurveGaugeWeightDTO) Set(val *CurveGaugeWeightDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableCurveGaugeWeightDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableCurveGaugeWeightDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCurveGaugeWeightDTO(val *CurveGaugeWeightDTO) *NullableCurveGaugeWeightDTO {
	return &NullableCurveGaugeWeightDTO{value: val, isSet: true}
}

func (v NullableCurveGaugeWeightDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCurveGaugeWeightDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
