...
// checks if the PANCAKESWAPV3ETHEREUMAccountDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMAccountDTO{}

// PANCAKESWAPV3ETHEREUMAccountDTO struct for PANCAKESWAPV3ETHEREUMAccountDTO
type PANCAKESWAPV3ETHEREUMAccountDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMAccountDTO() *PANCAKESWAPV3ETHEREUMAccountDTO {
	this := PANCAKESWAPV3ETHEREUMAccountDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMAccountDTO) SetBlockRangeNil() {
...
func (o *PANCAKESWAPV3ETHEREUMAccountDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o PANCAKESWAPV3ETHEREUMAccountDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMAccountDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMAccountDTO struct {
	value *PANCAKESWAPV3ETHEREUMAccountDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMAccountDTO) Get() *PANCAKESWAPV3ETHEREUMAccountDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMAccountDTO) Set(val *PANCAKESWAPV3ETHEREUMAccountDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMAccountDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMAccountDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMAccountDTO(val *PANCAKESWAPV3ETHEREUMAccountDTO) *NullablePANCAKESWAPV3ETHEREUMAccountDTO {
	return &NullablePANCAKESWAPV3ETHEREUMAccountDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMAccountDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMAccountDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
