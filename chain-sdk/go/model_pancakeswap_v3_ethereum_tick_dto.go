...
// checks if the PANCAKESWAPV3ETHEREUMTickDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMTickDTO{}

// PANCAKESWAPV3ETHEREUMTickDTO 
type PANCAKESWAPV3ETHEREUMTickDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMTickDTO() *PANCAKESWAPV3ETHEREUMTickDTO {
	this := PANCAKESWAPV3ETHEREUMTickDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetIndexNil() {
	o.Index.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetCreatedTimestampNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetCreatedBlockNumberNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetLiquidityGrossNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetLiquidityGrossUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetLiquidityNetNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetLiquidityNetUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetLastUpdateTimestampNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTickDTO) SetLastUpdateBlockNumberNil() {
...
func (o PANCAKESWAPV3ETHEREUMTickDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMTickDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMTickDTO struct {
	value *PANCAKESWAPV3ETHEREUMTickDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMTickDTO) Get() *PANCAKESWAPV3ETHEREUMTickDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMTickDTO) Set(val *PANCAKESWAPV3ETHEREUMTickDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMTickDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMTickDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMTickDTO(val *PANCAKESWAPV3ETHEREUMTickDTO) *NullablePANCAKESWAPV3ETHEREUMTickDTO {
	return &NullablePANCAKESWAPV3ETHEREUMTickDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMTickDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMTickDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
