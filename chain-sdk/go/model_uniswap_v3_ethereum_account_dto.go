...
// checks if the UNISWAPV3ETHEREUMAccountDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UNISWAPV3ETHEREUMAccountDTO{}

// UNISWAPV3ETHEREUMAccountDTO struct for UNISWAPV3ETHEREUMAccountDTO
type UNISWAPV3ETHEREUMAccountDTO struct {
...
func NewUNISWAPV3ETHEREUMAccountDTO() *UNISWAPV3ETHEREUMAccountDTO {
	this := UNISWAPV3ETHEREUMAccountDTO{}
	return &this
}
...
func (o *UNISWAPV3ETHEREUMAccountDTO) SetBlockRangeNil() {
...
func (o *UNISWAPV3ETHEREUMAccountDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o UNISWAPV3ETHEREUMAccountDTO) MarshalJSON() ([]byte, error) {
...
func (o UNISWAPV3ETHEREUMAccountDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUNISWAPV3ETHEREUMAccountDTO struct {
	value *UNISWAPV3ETHEREUMAccountDTO
	isSet bool
}

func (v NullableUNISWAPV3ETHEREUMAccountDTO) Get() *UNISWAPV3ETHEREUMAccountDTO {
	return v.value
}

func (v *NullableUNISWAPV3ETHEREUMAccountDTO) Set(val *UNISWAPV3ETHEREUMAccountDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUNISWAPV3ETHEREUMAccountDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUNISWAPV3ETHEREUMAccountDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUNISWAPV3ETHEREUMAccountDTO(val *UNISWAPV3ETHEREUMAccountDTO) *NullableUNISWAPV3ETHEREUMAccountDTO {
	return &NullableUNISWAPV3ETHEREUMAccountDTO{value: val, isSet: true}
}

func (v NullableUNISWAPV3ETHEREUMAccountDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUNISWAPV3ETHEREUMAccountDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
