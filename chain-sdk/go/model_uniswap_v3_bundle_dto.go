...
func (o *UniswapV3BundleDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UniswapV3BundleDTO) GetEthPriceUsd() string {
	if o == nil || IsNil(o.EthPriceUsd.Get()) {
		var ret string
		return ret
	}
...
func (o *UniswapV3BundleDTO) SetEthPriceUsdNil() {
...
type NullableUniswapV3BundleDTO struct {
	value *UniswapV3BundleDTO
	isSet bool
}

func (v NullableUniswapV3BundleDTO) Get() *UniswapV3BundleDTO {
	return v.value
}

func (v *NullableUniswapV3BundleDTO) Set(val *UniswapV3BundleDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUniswapV3BundleDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUniswapV3BundleDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniswapV3BundleDTO(val *UniswapV3BundleDTO) *NullableUniswapV3BundleDTO {
	return &NullableUniswapV3BundleDTO{value: val, isSet: true}
}

func (v NullableUniswapV3BundleDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniswapV3BundleDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
