...
// checks if the SUSHISWAPV3ETHEREUMWithdrawDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMWithdrawDTO{}

// SUSHISWAPV3ETHEREUMWithdrawDTO 
type SUSHISWAPV3ETHEREUMWithdrawDTO struct {
...
func NewSUSHISWAPV3ETHEREUMWithdrawDTO() *SUSHISWAPV3ETHEREUMWithdrawDTO {
	this := SUSHISWAPV3ETHEREUMWithdrawDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetNonceNil() {
	o.Nonce.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetGasLimitNil() {
	o.GasLimit.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetGasUsedNil() {
	o.GasUsed.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetGasPriceNil() {
	o.GasPrice.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMWithdrawDTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o SUSHISWAPV3ETHEREUMWithdrawDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMWithdrawDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMWithdrawDTO struct {
	value *SUSHISWAPV3ETHEREUMWithdrawDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMWithdrawDTO) Get() *SUSHISWAPV3ETHEREUMWithdrawDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMWithdrawDTO) Set(val *SUSHISWAPV3ETHEREUMWithdrawDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMWithdrawDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMWithdrawDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMWithdrawDTO(val *SUSHISWAPV3ETHEREUMWithdrawDTO) *NullableSUSHISWAPV3ETHEREUMWithdrawDTO {
	return &NullableSUSHISWAPV3ETHEREUMWithdrawDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMWithdrawDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMWithdrawDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
