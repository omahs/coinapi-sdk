...
func (o *SushiswapBundleDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SushiswapBundleDTO) SetEthPriceNil() {
	o.EthPrice.Set(nil)
}
...
type NullableSushiswapBundleDTO struct {
	value *SushiswapBundleDTO
	isSet bool
}

func (v NullableSushiswapBundleDTO) Get() *SushiswapBundleDTO {
	return v.value
}

func (v *NullableSushiswapBundleDTO) Set(val *SushiswapBundleDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSushiswapBundleDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSushiswapBundleDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSushiswapBundleDTO(val *SushiswapBundleDTO) *NullableSushiswapBundleDTO {
	return &NullableSushiswapBundleDTO{value: val, isSet: true}
}

func (v NullableSushiswapBundleDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSushiswapBundleDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
