...
// checks if the PANCAKESWAPV3ETHEREUMDepositDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMDepositDTO{}

// PANCAKESWAPV3ETHEREUMDepositDTO Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
type PANCAKESWAPV3ETHEREUMDepositDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMDepositDTO() *PANCAKESWAPV3ETHEREUMDepositDTO {
	this := PANCAKESWAPV3ETHEREUMDepositDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetNonceNil() {
	o.Nonce.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetGasLimitNil() {
	o.GasLimit.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetGasUsedNil() {
	o.GasUsed.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetGasPriceNil() {
	o.GasPrice.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMDepositDTO) SetBlockRangeNil() {
...
func (o PANCAKESWAPV3ETHEREUMDepositDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMDepositDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMDepositDTO struct {
	value *PANCAKESWAPV3ETHEREUMDepositDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMDepositDTO) Get() *PANCAKESWAPV3ETHEREUMDepositDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMDepositDTO) Set(val *PANCAKESWAPV3ETHEREUMDepositDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMDepositDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMDepositDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMDepositDTO(val *PANCAKESWAPV3ETHEREUMDepositDTO) *NullablePANCAKESWAPV3ETHEREUMDepositDTO {
	return &NullablePANCAKESWAPV3ETHEREUMDepositDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMDepositDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMDepositDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
