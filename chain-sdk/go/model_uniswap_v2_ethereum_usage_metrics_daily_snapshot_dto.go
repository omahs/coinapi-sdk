...
// checks if the UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO{}

// UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO 
type UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO struct {
...
func NewUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO() *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO {
	this := UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO{}
	return &this
}
...
func (o *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) SetBlockRangeNil() {
...
func (o *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) MarshalJSON() ([]byte, error) {
...
func (o UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO struct {
	value *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
	isSet bool
}

func (v NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) Get() *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO {
	return v.value
}

func (v *NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) Set(val *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO(val *UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) *NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO {
	return &NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO{value: val, isSet: true}
}

func (v NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
