...
// checks if the UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO{}

// UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO 
type UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO struct {
...
func NewUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO() *UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
	this := UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO{}
	return &this
}
...
func (o *UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) MarshalJSON() ([]byte, error) {
...
func (o UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO struct {
	value *UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
	isSet bool
}

func (v NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) Get() *UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
	return v.value
}

func (v *NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) Set(val *UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO(val *UNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) *NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
	return &NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO{value: val, isSet: true}
}

func (v NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUNISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
