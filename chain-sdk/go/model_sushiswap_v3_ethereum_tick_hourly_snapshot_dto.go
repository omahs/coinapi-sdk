...
// checks if the SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO{}

// SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO 
type SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO struct {
...
func NewSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO() *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO {
	this := SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) SetTickNil() {
	o.Tick.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) SetLiquidityGrossNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) SetLiquidityGrossUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) SetLiquidityNetNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) SetLiquidityNetUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO struct {
	value *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) Get() *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) Set(val *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO(val *SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) *NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO {
	return &NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMTickHourlySnapshotDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
