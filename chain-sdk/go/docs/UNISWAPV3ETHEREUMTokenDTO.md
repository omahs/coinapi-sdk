...
**LastPriceUsd** | Pointer to **NullableString** |  | [optional] 
**LastPriceBlockNumber** | Pointer to **NullableString** |  | [optional] 
**LastPricePool** | Pointer to **NullableString** |  | [optional] 
**TotalSupply** | Pointer to **NullableString** |  | [optional] 
**TotalValueLockedUsd** | Pointer to **NullableString** |  | [optional] 
**LargePriceChangeBuffer** | Pointer to **int32** |  | [optional] 
**LargeTvlImpactBuffer** | Pointer to **int32** |  | [optional] 
