...
// checks if the DexUserDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DexUserDTO{}
...
func (o DexUserDTO) ToMap() (map[string]interface{}, error) {
