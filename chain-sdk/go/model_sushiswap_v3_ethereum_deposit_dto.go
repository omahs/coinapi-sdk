...
// checks if the SUSHISWAPV3ETHEREUMDepositDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMDepositDTO{}

// SUSHISWAPV3ETHEREUMDepositDTO Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
type SUSHISWAPV3ETHEREUMDepositDTO struct {
...
func NewSUSHISWAPV3ETHEREUMDepositDTO() *SUSHISWAPV3ETHEREUMDepositDTO {
	this := SUSHISWAPV3ETHEREUMDepositDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetNonceNil() {
	o.Nonce.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetGasLimitNil() {
	o.GasLimit.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetGasUsedNil() {
	o.GasUsed.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetGasPriceNil() {
	o.GasPrice.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetAmountUsdNil() {
	o.AmountUsd.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDepositDTO) SetBlockRangeNil() {
...
func (o SUSHISWAPV3ETHEREUMDepositDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMDepositDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMDepositDTO struct {
	value *SUSHISWAPV3ETHEREUMDepositDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMDepositDTO) Get() *SUSHISWAPV3ETHEREUMDepositDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMDepositDTO) Set(val *SUSHISWAPV3ETHEREUMDepositDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMDepositDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMDepositDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMDepositDTO(val *SUSHISWAPV3ETHEREUMDepositDTO) *NullableSUSHISWAPV3ETHEREUMDepositDTO {
	return &NullableSUSHISWAPV3ETHEREUMDepositDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMDepositDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMDepositDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
