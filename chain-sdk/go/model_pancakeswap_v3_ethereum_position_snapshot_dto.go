...
// checks if the PANCAKESWAPV3ETHEREUMPositionSnapshotDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMPositionSnapshotDTO{}

// PANCAKESWAPV3ETHEREUMPositionSnapshotDTO 
type PANCAKESWAPV3ETHEREUMPositionSnapshotDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMPositionSnapshotDTO() *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO {
	this := PANCAKESWAPV3ETHEREUMPositionSnapshotDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetNonceNil() {
	o.Nonce.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetLiquidityTokenTypeNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetLiquidityUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetCumulativeDepositUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetCumulativeWithdrawUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO struct {
	value *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO) Get() *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO) Set(val *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO(val *PANCAKESWAPV3ETHEREUMPositionSnapshotDTO) *NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO {
	return &NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMPositionSnapshotDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
