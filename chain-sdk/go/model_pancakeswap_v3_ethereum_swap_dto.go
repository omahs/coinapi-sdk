...
// checks if the PANCAKESWAPV3ETHEREUMSwapDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMSwapDTO{}

// PANCAKESWAPV3ETHEREUMSwapDTO Trade (swap) event which occurred in a pool.
type PANCAKESWAPV3ETHEREUMSwapDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMSwapDTO() *PANCAKESWAPV3ETHEREUMSwapDTO {
	this := PANCAKESWAPV3ETHEREUMSwapDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetNonceNil() {
	o.Nonce.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetGasLimitNil() {
	o.GasLimit.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetGasUsedNil() {
	o.GasUsed.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetGasPriceNil() {
	o.GasPrice.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetTickNil() {
	o.Tick.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetTokenInNil() {
	o.TokenIn.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetAmountInNil() {
	o.AmountIn.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetAmountInUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetTokenOutNil() {
	o.TokenOut.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetAmountOutNil() {
	o.AmountOut.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetAmountOutUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetPoolIdNil() {
	o.PoolId.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMSwapDTO) SetTransactionIdNil() {
...
func (o PANCAKESWAPV3ETHEREUMSwapDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMSwapDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMSwapDTO struct {
	value *PANCAKESWAPV3ETHEREUMSwapDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMSwapDTO) Get() *PANCAKESWAPV3ETHEREUMSwapDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMSwapDTO) Set(val *PANCAKESWAPV3ETHEREUMSwapDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMSwapDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMSwapDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMSwapDTO(val *PANCAKESWAPV3ETHEREUMSwapDTO) *NullablePANCAKESWAPV3ETHEREUMSwapDTO {
	return &NullablePANCAKESWAPV3ETHEREUMSwapDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMSwapDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMSwapDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
