...
// checks if the SUSHISWAPV3ETHEREUMLiquidityPoolDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMLiquidityPoolDTO{}

// SUSHISWAPV3ETHEREUMLiquidityPoolDTO Pool-level metadata.
type SUSHISWAPV3ETHEREUMLiquidityPoolDTO struct {
...
func NewSUSHISWAPV3ETHEREUMLiquidityPoolDTO() *SUSHISWAPV3ETHEREUMLiquidityPoolDTO {
	this := SUSHISWAPV3ETHEREUMLiquidityPoolDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetBlockRangeNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetSymbolNil() {
	o.Symbol.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetLiquidityTokenNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetCreatedTimestampNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetCreatedBlockNumberNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetTickNil() {
	o.Tick.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetTotalValueLockedUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetTotalLiquidityNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetTotalLiquidityUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetActiveLiquidityNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetActiveLiquidityUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetCumulativeSupplySideRevenueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetCumulativeProtocolSideRevenueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetCumulativeTotalRevenueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetCumulativeVolumeUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetStakedOutputTokenAmountNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetLastUpdateTimestampNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) SetLastUpdateBlockNumberNil() {
...
func (o SUSHISWAPV3ETHEREUMLiquidityPoolDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMLiquidityPoolDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO struct {
	value *SUSHISWAPV3ETHEREUMLiquidityPoolDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO) Get() *SUSHISWAPV3ETHEREUMLiquidityPoolDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO) Set(val *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO(val *SUSHISWAPV3ETHEREUMLiquidityPoolDTO) *NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO {
	return &NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
