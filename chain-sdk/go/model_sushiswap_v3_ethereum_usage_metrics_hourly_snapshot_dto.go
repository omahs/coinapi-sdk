...
// checks if the SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO{}

// SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO 
type SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO struct {
...
func NewSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO() *SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
	this := SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO struct {
	value *SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) Get() *SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) Set(val *SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO(val *SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) *NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
	return &NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
