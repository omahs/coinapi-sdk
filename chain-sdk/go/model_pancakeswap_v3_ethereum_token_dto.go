...
// checks if the PANCAKESWAPV3ETHEREUMTokenDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMTokenDTO{}

// PANCAKESWAPV3ETHEREUMTokenDTO Stores aggregated information for a specific token across all pairs that token is included in.
type PANCAKESWAPV3ETHEREUMTokenDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMTokenDTO() *PANCAKESWAPV3ETHEREUMTokenDTO {
	this := PANCAKESWAPV3ETHEREUMTokenDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetBlockRangeNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetSymbolNil() {
	o.Symbol.Set(nil)
}
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetLastPriceUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetLastPriceBlockNumberNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetLastPricePoolNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetTotalSupplyNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetTotalValueLockedUsdNil() {
...
func (o *PANCAKESWAPV3ETHEREUMTokenDTO) SetTokenSymbolNil() {
...
func (o PANCAKESWAPV3ETHEREUMTokenDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMTokenDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMTokenDTO struct {
	value *PANCAKESWAPV3ETHEREUMTokenDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMTokenDTO) Get() *PANCAKESWAPV3ETHEREUMTokenDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMTokenDTO) Set(val *PANCAKESWAPV3ETHEREUMTokenDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMTokenDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMTokenDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMTokenDTO(val *PANCAKESWAPV3ETHEREUMTokenDTO) *NullablePANCAKESWAPV3ETHEREUMTokenDTO {
	return &NullablePANCAKESWAPV3ETHEREUMTokenDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMTokenDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMTokenDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
