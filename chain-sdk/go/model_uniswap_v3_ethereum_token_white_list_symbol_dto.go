...
// checks if the UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO{}

// UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO 
type UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO struct {
...
func NewUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO() *UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO {
	this := UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO{}
	return &this
}
...
func (o *UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) SetAddressNil() {
	o.Address.Set(nil)
}
...
func (o UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) MarshalJSON() ([]byte, error) {
...
func (o UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO struct {
	value *UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO
	isSet bool
}

func (v NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) Get() *UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO {
	return v.value
}

func (v *NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) Set(val *UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO(val *UNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) *NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO {
	return &NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO{value: val, isSet: true}
}

func (v NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUNISWAPV3ETHEREUMTokenWhiteListSymbolDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
