...
// checks if the SUSHISWAPV3ETHEREUMPositionSnapshotDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMPositionSnapshotDTO{}

// SUSHISWAPV3ETHEREUMPositionSnapshotDTO 
type SUSHISWAPV3ETHEREUMPositionSnapshotDTO struct {
...
func NewSUSHISWAPV3ETHEREUMPositionSnapshotDTO() *SUSHISWAPV3ETHEREUMPositionSnapshotDTO {
	this := SUSHISWAPV3ETHEREUMPositionSnapshotDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetNonceNil() {
	o.Nonce.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetPositionNil() {
	o.Position.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetLiquidityTokenTypeNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetLiquidityUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetCumulativeDepositUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetCumulativeWithdrawUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o SUSHISWAPV3ETHEREUMPositionSnapshotDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMPositionSnapshotDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO struct {
	value *SUSHISWAPV3ETHEREUMPositionSnapshotDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO) Get() *SUSHISWAPV3ETHEREUMPositionSnapshotDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO) Set(val *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO(val *SUSHISWAPV3ETHEREUMPositionSnapshotDTO) *NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO {
	return &NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMPositionSnapshotDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
