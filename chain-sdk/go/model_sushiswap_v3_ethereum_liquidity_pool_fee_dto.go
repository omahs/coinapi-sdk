...
// checks if the SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO{}

// SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO 
type SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO struct {
...
func NewSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO() *SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO {
	this := SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) SetBlockRangeNil() {
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) SetFeePercentageNil() {
...
func (o SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO struct {
	value *SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) Get() *SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) Set(val *SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO(val *SUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) *NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO {
	return &NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMLiquidityPoolFeeDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
