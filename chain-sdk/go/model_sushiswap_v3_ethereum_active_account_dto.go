...
// checks if the SUSHISWAPV3ETHEREUMActiveAccountDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMActiveAccountDTO{}

// SUSHISWAPV3ETHEREUMActiveAccountDTO Entity for calculating daily/hourly active users.
type SUSHISWAPV3ETHEREUMActiveAccountDTO struct {
...
func NewSUSHISWAPV3ETHEREUMActiveAccountDTO() *SUSHISWAPV3ETHEREUMActiveAccountDTO {
	this := SUSHISWAPV3ETHEREUMActiveAccountDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMActiveAccountDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMActiveAccountDTO) SetBlockRangeNil() {
...
func (o SUSHISWAPV3ETHEREUMActiveAccountDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMActiveAccountDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMActiveAccountDTO struct {
	value *SUSHISWAPV3ETHEREUMActiveAccountDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMActiveAccountDTO) Get() *SUSHISWAPV3ETHEREUMActiveAccountDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMActiveAccountDTO) Set(val *SUSHISWAPV3ETHEREUMActiveAccountDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMActiveAccountDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMActiveAccountDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMActiveAccountDTO(val *SUSHISWAPV3ETHEREUMActiveAccountDTO) *NullableSUSHISWAPV3ETHEREUMActiveAccountDTO {
	return &NullableSUSHISWAPV3ETHEREUMActiveAccountDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMActiveAccountDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMActiveAccountDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
