...
// checks if the PANCAKESWAPV3ETHEREUMTokenWhiteListDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANCAKESWAPV3ETHEREUMTokenWhiteListDTO{}

// PANCAKESWAPV3ETHEREUMTokenWhiteListDTO 
type PANCAKESWAPV3ETHEREUMTokenWhiteListDTO struct {
...
func NewPANCAKESWAPV3ETHEREUMTokenWhiteListDTO() *PANCAKESWAPV3ETHEREUMTokenWhiteListDTO {
	this := PANCAKESWAPV3ETHEREUMTokenWhiteListDTO{}
	return &this
}
...
func (o *PANCAKESWAPV3ETHEREUMTokenWhiteListDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o PANCAKESWAPV3ETHEREUMTokenWhiteListDTO) MarshalJSON() ([]byte, error) {
...
func (o PANCAKESWAPV3ETHEREUMTokenWhiteListDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO struct {
	value *PANCAKESWAPV3ETHEREUMTokenWhiteListDTO
	isSet bool
}

func (v NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO) Get() *PANCAKESWAPV3ETHEREUMTokenWhiteListDTO {
	return v.value
}

func (v *NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO) Set(val *PANCAKESWAPV3ETHEREUMTokenWhiteListDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO(val *PANCAKESWAPV3ETHEREUMTokenWhiteListDTO) *NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO {
	return &NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO{value: val, isSet: true}
}

func (v NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePANCAKESWAPV3ETHEREUMTokenWhiteListDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
