...
// checks if the SUSHISWAPV3ETHEREUMDexAmmProtocolDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMDexAmmProtocolDTO{}

// SUSHISWAPV3ETHEREUMDexAmmProtocolDTO  Decentralized exchange (Dex) automated market maker (Amm) protocol. It's an entity that represents a protocol involving a smart contract that use automated market makers.
type SUSHISWAPV3ETHEREUMDexAmmProtocolDTO struct {
...
func NewSUSHISWAPV3ETHEREUMDexAmmProtocolDTO() *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO {
	this := SUSHISWAPV3ETHEREUMDexAmmProtocolDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetBlockRangeNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetSlugNil() {
	o.Slug.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetSchemaVersionNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetSubgraphVersionNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetMethodologyVersionNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetTotalValueLockedUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetTotalLiquidityUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetActiveLiquidityUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetUncollectedProtocolSideValueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetUncollectedSupplySideValueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetProtocolControlledValueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetCumulativeVolumeUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetCumulativeSupplySideRevenueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetCumulativeProtocolSideRevenueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetCumulativeTotalRevenueUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetLastUpdateTimestampNil() {
...
func (o *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) SetLastUpdateBlockNumberNil() {
...
func (o SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO struct {
	value *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO) Get() *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO) Set(val *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO(val *SUSHISWAPV3ETHEREUMDexAmmProtocolDTO) *NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO {
	return &NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMDexAmmProtocolDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
