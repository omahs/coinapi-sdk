...
// checks if the SUSHISWAPV3ETHEREUMSwapDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMSwapDTO{}

// SUSHISWAPV3ETHEREUMSwapDTO Trade (swap) event which occurred in a pool.
type SUSHISWAPV3ETHEREUMSwapDTO struct {
...
func NewSUSHISWAPV3ETHEREUMSwapDTO() *SUSHISWAPV3ETHEREUMSwapDTO {
	this := SUSHISWAPV3ETHEREUMSwapDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetHashNil() {
	o.Hash.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetNonceNil() {
	o.Nonce.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetGasLimitNil() {
	o.GasLimit.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetGasUsedNil() {
	o.GasUsed.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetGasPriceNil() {
	o.GasPrice.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetTickNil() {
	o.Tick.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetTokenInNil() {
	o.TokenIn.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetAmountInNil() {
	o.AmountIn.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetAmountInUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetTokenOutNil() {
	o.TokenOut.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetAmountOutNil() {
	o.AmountOut.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetAmountOutUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetPoolIdNil() {
	o.PoolId.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMSwapDTO) SetTransactionIdNil() {
...
func (o SUSHISWAPV3ETHEREUMSwapDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMSwapDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMSwapDTO struct {
	value *SUSHISWAPV3ETHEREUMSwapDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMSwapDTO) Get() *SUSHISWAPV3ETHEREUMSwapDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMSwapDTO) Set(val *SUSHISWAPV3ETHEREUMSwapDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMSwapDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMSwapDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMSwapDTO(val *SUSHISWAPV3ETHEREUMSwapDTO) *NullableSUSHISWAPV3ETHEREUMSwapDTO {
	return &NullableSUSHISWAPV3ETHEREUMSwapDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMSwapDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMSwapDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
