...
// checks if the UNISWAPV2ETHEREUMAccountDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UNISWAPV2ETHEREUMAccountDTO{}

// UNISWAPV2ETHEREUMAccountDTO struct for UNISWAPV2ETHEREUMAccountDTO
type UNISWAPV2ETHEREUMAccountDTO struct {
...
func NewUNISWAPV2ETHEREUMAccountDTO() *UNISWAPV2ETHEREUMAccountDTO {
	this := UNISWAPV2ETHEREUMAccountDTO{}
	return &this
}
...
func (o *UNISWAPV2ETHEREUMAccountDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UNISWAPV2ETHEREUMAccountDTO) SetBlockRangeNil() {
...
func (o UNISWAPV2ETHEREUMAccountDTO) MarshalJSON() ([]byte, error) {
...
func (o UNISWAPV2ETHEREUMAccountDTO) ToMap() (map[string]interface{}, error) {
...
type NullableUNISWAPV2ETHEREUMAccountDTO struct {
	value *UNISWAPV2ETHEREUMAccountDTO
	isSet bool
}

func (v NullableUNISWAPV2ETHEREUMAccountDTO) Get() *UNISWAPV2ETHEREUMAccountDTO {
	return v.value
}

func (v *NullableUNISWAPV2ETHEREUMAccountDTO) Set(val *UNISWAPV2ETHEREUMAccountDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableUNISWAPV2ETHEREUMAccountDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableUNISWAPV2ETHEREUMAccountDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUNISWAPV2ETHEREUMAccountDTO(val *UNISWAPV2ETHEREUMAccountDTO) *NullableUNISWAPV2ETHEREUMAccountDTO {
	return &NullableUNISWAPV2ETHEREUMAccountDTO{value: val, isSet: true}
}

func (v NullableUNISWAPV2ETHEREUMAccountDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUNISWAPV2ETHEREUMAccountDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
