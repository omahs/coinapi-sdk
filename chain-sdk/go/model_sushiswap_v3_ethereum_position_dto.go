...
// checks if the SUSHISWAPV3ETHEREUMPositionDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SUSHISWAPV3ETHEREUMPositionDTO{}

// SUSHISWAPV3ETHEREUMPositionDTO 
type SUSHISWAPV3ETHEREUMPositionDTO struct {
...
func NewSUSHISWAPV3ETHEREUMPositionDTO() *SUSHISWAPV3ETHEREUMPositionDTO {
	this := SUSHISWAPV3ETHEREUMPositionDTO{}
	return &this
}
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetPoolNil() {
	o.Pool.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetHashOpenedNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetHashClosedNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetBlockNumberOpenedNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetTimestampOpenedNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetBlockNumberClosedNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetTimestampClosedNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetTickLowerNil() {
	o.TickLower.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetTickUpperNil() {
	o.TickUpper.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetLiquidityTokenNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetLiquidityTokenTypeNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetLiquidityNil() {
	o.Liquidity.Set(nil)
}
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetLiquidityUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetCumulativeDepositUsdNil() {
...
func (o *SUSHISWAPV3ETHEREUMPositionDTO) SetCumulativeWithdrawUsdNil() {
...
func (o SUSHISWAPV3ETHEREUMPositionDTO) MarshalJSON() ([]byte, error) {
...
func (o SUSHISWAPV3ETHEREUMPositionDTO) ToMap() (map[string]interface{}, error) {
...
type NullableSUSHISWAPV3ETHEREUMPositionDTO struct {
	value *SUSHISWAPV3ETHEREUMPositionDTO
	isSet bool
}

func (v NullableSUSHISWAPV3ETHEREUMPositionDTO) Get() *SUSHISWAPV3ETHEREUMPositionDTO {
	return v.value
}

func (v *NullableSUSHISWAPV3ETHEREUMPositionDTO) Set(val *SUSHISWAPV3ETHEREUMPositionDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableSUSHISWAPV3ETHEREUMPositionDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableSUSHISWAPV3ETHEREUMPositionDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSUSHISWAPV3ETHEREUMPositionDTO(val *SUSHISWAPV3ETHEREUMPositionDTO) *NullableSUSHISWAPV3ETHEREUMPositionDTO {
	return &NullableSUSHISWAPV3ETHEREUMPositionDTO{value: val, isSet: true}
}

func (v NullableSUSHISWAPV3ETHEREUMPositionDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSUSHISWAPV3ETHEREUMPositionDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
