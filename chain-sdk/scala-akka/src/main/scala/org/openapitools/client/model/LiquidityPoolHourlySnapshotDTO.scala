...
case class LiquidityPoolHourlySnapshotDTO (
  ...
  hourlyVolumeByTokenAmount: Option[Seq[String]] = None,
  ...
  hourlyVolumeByTokenUsd: Option[Seq[String]] = None,
