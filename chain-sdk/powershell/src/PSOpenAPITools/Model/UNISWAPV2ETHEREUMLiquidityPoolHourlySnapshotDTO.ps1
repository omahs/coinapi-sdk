...
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMLiquidityPoolHourlySnapshotDTO
