...
UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
...
UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV3ETHEREUMFinancialsDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV3ETHEREUMFinancialsDailySnapshotDTO
