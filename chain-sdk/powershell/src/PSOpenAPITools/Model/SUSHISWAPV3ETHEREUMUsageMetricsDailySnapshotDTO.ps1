...
SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
