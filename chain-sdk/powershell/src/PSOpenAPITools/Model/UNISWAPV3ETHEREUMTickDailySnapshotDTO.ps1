...
UNISWAPV3ETHEREUMTickDailySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV3ETHEREUMTickDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMTickDailySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV3ETHEREUMTickDailySnapshotDTO<PSCustomObject>
...
UNISWAPV3ETHEREUMTickDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV3ETHEREUMTickDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMTickDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV3ETHEREUMTickDailySnapshotDTO
