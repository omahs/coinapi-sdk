...
UniswapV2SwapDTO<PSCustomObject>
#>

function Initialize-UniswapV2SwapDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2SwapDTO' | Write-Debug
...
Convert from JSON to UniswapV2SwapDTO<PSCustomObject>
...
UniswapV2SwapDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2SwapDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2SwapDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2SwapDTO
