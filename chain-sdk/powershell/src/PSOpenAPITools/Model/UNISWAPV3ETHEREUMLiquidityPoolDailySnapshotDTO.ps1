...
UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
...
UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
