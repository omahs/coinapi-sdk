...
UNISWAPV2ETHEREUMTokenDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMTokenDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMTokenDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMTokenDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMTokenDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMTokenDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMTokenDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMTokenDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "vid", "id", "name", "symbol", "decimals", "last_price_usd", "last_price_block_number", "total_supply", "total_value_locked_usd", "large_price_change_buffer", "large_tvl_impact_buffer", "token_symbol")
