...
UniswapV3PoolHourDataDTO<PSCustomObject>
#>

function Initialize-UniswapV3PoolHourDataDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV3PoolHourDataDTO' | Write-Debug
...
Convert from JSON to UniswapV3PoolHourDataDTO<PSCustomObject>
...
UniswapV3PoolHourDataDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV3PoolHourDataDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV3PoolHourDataDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV3PoolHourDataDTO
