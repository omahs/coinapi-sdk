...
SUSHISWAPV3ETHEREUMTickDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMTickDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMTickDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMTickDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMTickDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMTickDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMTickDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMTickDTO
