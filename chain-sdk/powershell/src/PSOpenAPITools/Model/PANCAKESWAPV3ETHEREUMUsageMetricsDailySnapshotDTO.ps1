...
PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO
