...
CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
#>

function Initialize-CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO' | Write-Debug
...
Convert from JSON to CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
...
CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToCURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO
