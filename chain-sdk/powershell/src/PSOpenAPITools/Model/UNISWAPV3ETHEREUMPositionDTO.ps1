...
UNISWAPV3ETHEREUMPositionDTO<PSCustomObject>
#>

function Initialize-UNISWAPV3ETHEREUMPositionDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMPositionDTO' | Write-Debug
...
Convert from JSON to UNISWAPV3ETHEREUMPositionDTO<PSCustomObject>
...
UNISWAPV3ETHEREUMPositionDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV3ETHEREUMPositionDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMPositionDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
