...
SUSHISWAPV3ETHEREUMPositionSnapshotDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMPositionSnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMPositionSnapshotDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMPositionSnapshotDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMPositionSnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMPositionSnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMPositionSnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMPositionSnapshotDTO
