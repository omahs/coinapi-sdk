...
UNISWAPV2ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMLiquidityPoolAmountDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMLiquidityPoolAmountDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMLiquidityPoolAmountDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMLiquidityPoolAmountDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMLiquidityPoolAmountDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "vid", "block_range", "id", "input_tokens", "input_token_balances")
