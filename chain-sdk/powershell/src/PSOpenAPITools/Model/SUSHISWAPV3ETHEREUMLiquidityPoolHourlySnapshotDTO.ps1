...
SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO
