...
UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMLiquidityPoolDailySnapshotDTO
