...
PANCAKESWAPV3ETHEREUMTokenDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMTokenDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMTokenDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMTokenDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMTokenDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMTokenDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMTokenDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMTokenDTO
