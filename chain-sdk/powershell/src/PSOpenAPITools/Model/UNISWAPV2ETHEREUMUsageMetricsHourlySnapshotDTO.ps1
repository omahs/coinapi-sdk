...
UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO
