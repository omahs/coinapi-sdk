...
PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMTickDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "vid", "id", "day_id", "tick", "pool", "liquidity_gross", "liquidity_gross_usd", "liquidity_net", "liquidity_net_usd", "timestamp")
