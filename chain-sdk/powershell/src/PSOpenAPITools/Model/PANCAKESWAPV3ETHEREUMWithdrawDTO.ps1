...
PANCAKESWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMWithdrawDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMWithdrawDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMWithdrawDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMWithdrawDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMWithdrawDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "id", "hash", "nonce", "log_index", "gas_limit", "gas_used", "gas_price", "protocol", "account", "position", "tick_lower", "tick_upper", "pool", "timestamp", "liquidity", "input_tokens", "input_token_amounts", "reserve_amounts", "amount_usd")
