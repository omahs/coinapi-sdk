...
SUSHISWAPV3ETHEREUMDexAmmProtocolDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMDexAmmProtocolDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMDexAmmProtocolDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMDexAmmProtocolDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMDexAmmProtocolDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMDexAmmProtocolDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMDexAmmProtocolDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMDexAmmProtocolDTO
