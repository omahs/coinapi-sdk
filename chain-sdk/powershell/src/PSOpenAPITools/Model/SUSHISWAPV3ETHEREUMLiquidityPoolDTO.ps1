...
SUSHISWAPV3ETHEREUMLiquidityPoolDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMLiquidityPoolDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMLiquidityPoolDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMLiquidityPoolDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMLiquidityPoolDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMLiquidityPoolDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMLiquidityPoolDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMLiquidityPoolDTO
