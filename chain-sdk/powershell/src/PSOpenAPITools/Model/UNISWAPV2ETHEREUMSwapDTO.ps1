...
UNISWAPV2ETHEREUMSwapDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMSwapDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMSwapDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMSwapDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMSwapDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMSwapDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMSwapDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMSwapDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "block_", "id", "hash", "log_index", "protocol", "to", "from", "timestamp", "token_in", "amount_in", "amount_in_usd", "token_out", "amount_out", "amount_out_usd", "reserve_amounts", "pool", "block_range", "pool_id", "transaction_id", "evaluated_price", "evaluated_amount", "evaluated_aggressor")
