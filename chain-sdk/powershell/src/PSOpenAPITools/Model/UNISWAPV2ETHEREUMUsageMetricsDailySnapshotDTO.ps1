...
UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "block_range", "id", "protocol", "daily_active_users", "cumulative_unique_users", "daily_transaction_count", "daily_deposit_count", "daily_withdraw_count", "daily_swap_count", "total_pool_count", "timestamp")
