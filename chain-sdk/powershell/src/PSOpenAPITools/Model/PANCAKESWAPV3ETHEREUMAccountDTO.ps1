...
PANCAKESWAPV3ETHEREUMAccountDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMAccountDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMAccountDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMAccountDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMAccountDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMAccountDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMAccountDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMAccountDTO
