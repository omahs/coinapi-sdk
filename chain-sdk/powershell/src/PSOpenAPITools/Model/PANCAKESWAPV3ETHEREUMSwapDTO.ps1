...
PANCAKESWAPV3ETHEREUMSwapDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMSwapDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMSwapDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMSwapDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMSwapDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMSwapDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMSwapDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMSwapDTO
