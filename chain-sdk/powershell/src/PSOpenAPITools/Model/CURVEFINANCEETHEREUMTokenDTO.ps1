...
CURVEFINANCEETHEREUMTokenDTO<PSCustomObject>
#>

function Initialize-CURVEFINANCEETHEREUMTokenDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMTokenDTO' | Write-Debug
...
Convert from JSON to CURVEFINANCEETHEREUMTokenDTO<PSCustomObject>
...
CURVEFINANCEETHEREUMTokenDTO<PSCustomObject>
#>
function ConvertFrom-JsonToCURVEFINANCEETHEREUMTokenDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMTokenDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CURVEFINANCEETHEREUMTokenDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "vid", "id", "name", "symbol", "decimals", "last_price_usd", "last_price_block_number", "token_symbol")
