...
CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
...
CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToCURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "block_range", "id", "protocol", "hourly_active_users", "cumulative_unique_users", "hourly_transaction_count", "hourly_deposit_count", "hourly_withdraw_count", "hourly_swap_count", "timestamp")
