...
CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
#>

function Initialize-CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO' | Write-Debug
...
Convert from JSON to CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
...
CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToCURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "id", "protocol", "daily_active_users", "cumulative_unique_users", "daily_transaction_count", "daily_deposit_count", "daily_withdraw_count", "daily_swap_count", "total_pool_count", "timestamp")
