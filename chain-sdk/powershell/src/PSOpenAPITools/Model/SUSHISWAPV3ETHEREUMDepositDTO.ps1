...
SUSHISWAPV3ETHEREUMDepositDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMDepositDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMDepositDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMDepositDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMDepositDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMDepositDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMDepositDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMDepositDTO
