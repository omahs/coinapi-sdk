...
SUSHISWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMWithdrawDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMWithdrawDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMWithdrawDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMWithdrawDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMWithdrawDTO
