...
CURVEFINANCEETHEREUMDepositDTO<PSCustomObject>
#>

function Initialize-CURVEFINANCEETHEREUMDepositDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMDepositDTO' | Write-Debug
...
Convert from JSON to CURVEFINANCEETHEREUMDepositDTO<PSCustomObject>
...
CURVEFINANCEETHEREUMDepositDTO<PSCustomObject>
#>
function ConvertFrom-JsonToCURVEFINANCEETHEREUMDepositDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMDepositDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CURVEFINANCEETHEREUMDepositDTO
