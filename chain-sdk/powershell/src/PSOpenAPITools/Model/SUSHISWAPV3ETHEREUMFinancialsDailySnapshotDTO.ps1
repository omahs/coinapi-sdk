...
SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO
