...
PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMTickHourlySnapshotDTO
