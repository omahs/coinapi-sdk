...
SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO
