...
UNISWAPV2ETHEREUMDexAmmProtocolDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMDexAmmProtocolDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMDexAmmProtocolDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMDexAmmProtocolDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMDexAmmProtocolDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMDexAmmProtocolDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMDexAmmProtocolDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMDexAmmProtocolDTO
