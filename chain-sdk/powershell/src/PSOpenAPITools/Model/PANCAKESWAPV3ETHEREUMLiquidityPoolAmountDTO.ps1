...
PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMLiquidityPoolAmountDTO
