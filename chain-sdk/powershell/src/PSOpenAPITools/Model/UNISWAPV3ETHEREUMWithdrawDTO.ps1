...
UNISWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
#>

function Initialize-UNISWAPV3ETHEREUMWithdrawDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMWithdrawDTO' | Write-Debug
...
Convert from JSON to UNISWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
...
UNISWAPV3ETHEREUMWithdrawDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV3ETHEREUMWithdrawDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMWithdrawDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV3ETHEREUMWithdrawDTO
