...
UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
...
UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
