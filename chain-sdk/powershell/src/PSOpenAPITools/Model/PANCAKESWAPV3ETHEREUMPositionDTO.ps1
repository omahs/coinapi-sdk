...
PANCAKESWAPV3ETHEREUMPositionDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMPositionDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMPositionDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMPositionDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMPositionDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMPositionDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMPositionDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMPositionDTO
