...
PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO
