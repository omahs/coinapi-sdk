...
DexWithdrawDTO<PSCustomObject>
#>

function Initialize-DexWithdrawDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DexWithdrawDTO' | Write-Debug
...
Convert from JSON to DexWithdrawDTO<PSCustomObject>
...
DexWithdrawDTO<PSCustomObject>
#>
function ConvertFrom-JsonToDexWithdrawDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DexWithdrawDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DexWithdrawDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "id", "user", "token_address", "amount", "create_epoch", "create_batch_id", "tx_hash", "vid")
