...
PANCAKESWAPV3ETHEREUMDepositDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMDepositDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMDepositDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMDepositDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMDepositDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMDepositDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMDepositDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMDepositDTO
