...
UniswapV2LiquidityPositionSnapshotDTO<PSCustomObject>
#>

function Initialize-UniswapV2LiquidityPositionSnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UniswapV2LiquidityPositionSnapshotDTO' | Write-Debug
...
Convert from JSON to UniswapV2LiquidityPositionSnapshotDTO<PSCustomObject>
...
UniswapV2LiquidityPositionSnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUniswapV2LiquidityPositionSnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UniswapV2LiquidityPositionSnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UniswapV2LiquidityPositionSnapshotDTO
        $AllProperties = ("entry_time", "recv_time", "block_number", "id", "liquidity_position", "timestamp", "block", "user", "pair", "token_0_price_usd", "token_1_price_usd", "reserve_0", "reserve_1", "reserve_usd", "liquidity_token_total_supply", "liquidity_token_balance", "vid", "block_range")
