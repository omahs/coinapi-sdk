...
UNISWAPV2ETHEREUMDepositDTO<PSCustomObject>
#>

function Initialize-UNISWAPV2ETHEREUMDepositDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMDepositDTO' | Write-Debug
...
Convert from JSON to UNISWAPV2ETHEREUMDepositDTO<PSCustomObject>
...
UNISWAPV2ETHEREUMDepositDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV2ETHEREUMDepositDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV2ETHEREUMDepositDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV2ETHEREUMDepositDTO
