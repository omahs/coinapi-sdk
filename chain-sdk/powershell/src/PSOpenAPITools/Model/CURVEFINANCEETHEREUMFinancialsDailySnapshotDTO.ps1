...
CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
#>

function Initialize-CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO' | Write-Debug
...
Convert from JSON to CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
...
CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToCURVEFINANCEETHEREUMFinancialsDailySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO
