...
UNISWAPV3ETHEREUMTickHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV3ETHEREUMTickHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMTickHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV3ETHEREUMTickHourlySnapshotDTO<PSCustomObject>
...
UNISWAPV3ETHEREUMTickHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV3ETHEREUMTickHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMTickHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
