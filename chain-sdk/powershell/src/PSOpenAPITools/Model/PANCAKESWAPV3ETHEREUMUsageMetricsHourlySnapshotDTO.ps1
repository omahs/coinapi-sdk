...
PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
