...
SUSHISWAPV3ETHEREUMAccountDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMAccountDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMAccountDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMAccountDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMAccountDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMAccountDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMAccountDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMAccountDTO
