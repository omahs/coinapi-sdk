...
SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
#>

function Initialize-SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO' | Write-Debug
...
Convert from JSON to SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
...
SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToSUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO
