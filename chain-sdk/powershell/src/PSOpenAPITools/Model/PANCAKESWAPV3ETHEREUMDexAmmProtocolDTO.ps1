...
PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO<PSCustomObject>
#>

function Initialize-PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO' | Write-Debug
...
Convert from JSON to PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO<PSCustomObject>
...
PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO<PSCustomObject>
#>
function ConvertFrom-JsonToPANCAKESWAPV3ETHEREUMDexAmmProtocolDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PANCAKESWAPV3ETHEREUMDexAmmProtocolDTO
