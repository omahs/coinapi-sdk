...
UNISWAPV3ETHEREUMPositionSnapshotDTO<PSCustomObject>
#>

function Initialize-UNISWAPV3ETHEREUMPositionSnapshotDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMPositionSnapshotDTO' | Write-Debug
...
Convert from JSON to UNISWAPV3ETHEREUMPositionSnapshotDTO<PSCustomObject>
...
UNISWAPV3ETHEREUMPositionSnapshotDTO<PSCustomObject>
#>
function ConvertFrom-JsonToUNISWAPV3ETHEREUMPositionSnapshotDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UNISWAPV3ETHEREUMPositionSnapshotDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UNISWAPV3ETHEREUMPositionSnapshotDTO
