...
```powershell
$UNISWAPV3ETHEREUMTickHourlySnapshotDTO = Initialize-PSOpenAPIToolsUNISWAPV3ETHEREUMTickHourlySnapshotDTO  -EntryTime null `
 -RecvTime null `
 -BlockNumber null `
 -Vid null `
 -Id null `
...
```powershell
$UNISWAPV3ETHEREUMTickHourlySnapshotDTO | ConvertTo-JSON
```
