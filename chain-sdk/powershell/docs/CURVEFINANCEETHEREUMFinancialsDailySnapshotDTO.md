...
```powershell
$CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO = Initialize-PSOpenAPIToolsCURVEFINANCEETHEREUMFinancialsDailySnapshotDTO  -EntryTime null `
 -RecvTime null `
 -BlockNumber null `
 -BlockRange null `
 -Id null `
...
```powershell
$CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO | ConvertTo-JSON
```
