...
```powershell
$SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO = Initialize-PSOpenAPIToolsSUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO  -EntryTime null `
 -RecvTime null `
 -BlockNumber null `
 -Vid null `
 -BlockRange null `
...
```powershell
$SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO | ConvertTo-JSON
```
