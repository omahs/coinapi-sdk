...
```powershell
$SUSHISWAPV3ETHEREUMTickDailySnapshotDTO = Initialize-PSOpenAPIToolsSUSHISWAPV3ETHEREUMTickDailySnapshotDTO  -EntryTime null `
 -RecvTime null `
 -BlockNumber null `
 -Id null `
 -DayId null `
...
```powershell
$SUSHISWAPV3ETHEREUMTickDailySnapshotDTO | ConvertTo-JSON
```
