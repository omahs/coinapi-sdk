...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO :  IEquatable<PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO input)
        {
            if (input == null)
                return false;
