...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO :  IEquatable<CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO" /> class.
        /// </summary>
        ...
        /// <param name="hourlyActiveUsers">Number of unique daily active users.</param>
        ...
        {
            return this.Equals(input as CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO);
        }

        /// <summary>
        /// Returns true if CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CURVEFINANCEETHEREUMUsageMetricsHourlySnapshotDTO input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.HourlyTransactionCount != null &&
