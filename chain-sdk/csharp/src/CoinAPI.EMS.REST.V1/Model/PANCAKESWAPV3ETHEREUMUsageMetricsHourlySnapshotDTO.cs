...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO :  IEquatable<PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO input)
        {
            if (input == null)
                return false;
