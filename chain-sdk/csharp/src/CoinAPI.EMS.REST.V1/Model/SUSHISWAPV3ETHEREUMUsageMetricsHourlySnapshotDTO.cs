...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO :  IEquatable<SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshotDTO input)
        {
            if (input == null)
                return false;
