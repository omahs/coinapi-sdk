...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO :  IEquatable<SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshotDTO input)
        {
            if (input == null)
                return false;
