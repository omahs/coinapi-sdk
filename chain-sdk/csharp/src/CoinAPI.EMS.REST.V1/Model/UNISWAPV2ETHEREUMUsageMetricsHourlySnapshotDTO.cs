...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO :  IEquatable<UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV2ETHEREUMUsageMetricsHourlySnapshotDTO input)
        {
            if (input == null)
                return false;
