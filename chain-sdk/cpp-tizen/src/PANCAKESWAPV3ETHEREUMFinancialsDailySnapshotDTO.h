/*
 * PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO.h
 *
 * Daily financial metrics for PancakeSwap V3.
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO_H_
...
/*! \brief Daily financial metrics for PancakeSwap V3.
 *
 *  \ingroup Models
 *
 */

class PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO();
	PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO_H_ */
