/*
 * CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO.h
 *
 * 
 */

#ifndef _CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_
#define _CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_
...
class CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO();
	CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO();
...
#endif /* _CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_ */
