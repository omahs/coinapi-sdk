/*
 * CURVE_FINANCE_ETHEREUM.TokenDTO.h
 *
 * 
 */

#ifndef _CURVE_FINANCE_ETHEREUM.TokenDTO_H_
#define _CURVE_FINANCE_ETHEREUM.TokenDTO_H_
...
class CURVE_FINANCE_ETHEREUM.TokenDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	CURVE_FINANCE_ETHEREUM.TokenDTO();
	CURVE_FINANCE_ETHEREUM.TokenDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~CURVE_FINANCE_ETHEREUM.TokenDTO();
	...
	/*! \brief Get Optional field to track the price of a token
	 */
	std::string getLastPriceUsd();

	/*! \brief Set Optional field to track the price of a token
	 */
...
#endif /* _CURVE_FINANCE_ETHEREUM.TokenDTO_H_ */
