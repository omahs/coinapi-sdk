...
UNISWAP_V2_ETHEREUM.DepositDTO::UNISWAP_V2_ETHEREUM.DepositDTO()
{
	//__init();
}
...
void
UNISWAP_V2_ETHEREUM.DepositDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V2_ETHEREUM.DepositDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V2_ETHEREUM.DepositDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V2_ETHEREUM.DepositDTO::UNISWAP_V2_ETHEREUM.DepositDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V2_ETHEREUM.DepositDTO::toJson()
{
...
std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V2_ETHEREUM.DepositDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

int
UNISWAP_V2_ETHEREUM.DepositDTO::getBlock()
{
	return block_;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setBlock(int  block_)
{
	this->block_ = block_;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getId()
{
	return id;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getHash()
{
	return hash;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setHash(std::string  hash)
{
	this->hash = hash;
}

int
UNISWAP_V2_ETHEREUM.DepositDTO::getLogIndex()
{
	return log_index;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setLogIndex(int  log_index)
{
	this->log_index = log_index;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getTo()
{
	return to;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setTo(std::string  to)
{
	this->to = to;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getFrom()
{
	return from;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setFrom(std::string  from)
{
	this->from = from;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.DepositDTO::getInputTokens()
{
	return input_tokens;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setInputTokens(std::list <std::string> input_tokens)
{
	this->input_tokens = input_tokens;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getOutputToken()
{
	return output_token;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setOutputToken(std::string  output_token)
{
	this->output_token = output_token;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.DepositDTO::getInputTokenAmounts()
{
	return input_token_amounts;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setInputTokenAmounts(std::list <std::string> input_token_amounts)
{
	this->input_token_amounts = input_token_amounts;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getOutputTokenAmount()
{
	return output_token_amount;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setOutputTokenAmount(std::string  output_token_amount)
{
	this->output_token_amount = output_token_amount;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.DepositDTO::getReserveAmounts()
{
	return reserve_amounts;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setReserveAmounts(std::list <std::string> reserve_amounts)
{
	this->reserve_amounts = reserve_amounts;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getAmountUsd()
{
	return amount_usd;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setAmountUsd(std::string  amount_usd)
{
	this->amount_usd = amount_usd;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getPool()
{
	return pool;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
UNISWAP_V2_ETHEREUM.DepositDTO::getBlockRange()
{
	return block_range;
}

void
UNISWAP_V2_ETHEREUM.DepositDTO::setBlockRange(std::string  block_range)
{
