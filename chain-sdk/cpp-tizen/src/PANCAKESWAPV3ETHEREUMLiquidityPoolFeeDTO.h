/*
 * PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO();
	PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO_H_ */
