/*
 * UNISWAP_V3_ETHEREUM.TickDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V3_ETHEREUM.TickDTO_H_
#define _UNISWAP_V3_ETHEREUM.TickDTO_H_
...
class UNISWAP_V3_ETHEREUM.TickDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.TickDTO();
	UNISWAP_V3_ETHEREUM.TickDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.TickDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.TickDTO_H_ */
