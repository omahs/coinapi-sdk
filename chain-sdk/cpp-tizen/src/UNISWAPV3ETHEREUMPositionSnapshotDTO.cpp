...
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::UNISWAP_V3_ETHEREUM.PositionSnapshotDTO()
{
	//__init();
}
...
void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::UNISWAP_V3_ETHEREUM.PositionSnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::toJson()
{
...
std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getId()
{
	return id;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getHash()
{
	return hash;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setHash(std::string  hash)
{
	this->hash = hash;
}

int
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getLogIndex()
{
	return log_index;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setLogIndex(int  log_index)
{
	this->log_index = log_index;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getNonce()
{
	return nonce;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setNonce(std::string  nonce)
{
	this->nonce = nonce;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getPosition()
{
	return position;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setPosition(std::string  position)
{
	this->position = position;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getLiquidityTokenType()
{
	return liquidity_token_type;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setLiquidityTokenType(std::string  liquidity_token_type)
{
	this->liquidity_token_type = liquidity_token_type;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getLiquidity()
{
	return liquidity;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getLiquidityUsd()
{
	return liquidity_usd;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setLiquidityUsd(std::string  liquidity_usd)
{
	this->liquidity_usd = liquidity_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getCumulativeDepositTokenAmounts()
{
	return cumulative_deposit_token_amounts;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setCumulativeDepositTokenAmounts(std::list <std::string> cumulative_deposit_token_amounts)
{
	this->cumulative_deposit_token_amounts = cumulative_deposit_token_amounts;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getCumulativeDepositUsd()
{
	return cumulative_deposit_usd;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setCumulativeDepositUsd(std::string  cumulative_deposit_usd)
{
	this->cumulative_deposit_usd = cumulative_deposit_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getCumulativeWithdrawTokenAmounts()
{
	return cumulative_withdraw_token_amounts;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setCumulativeWithdrawTokenAmounts(std::list <std::string> cumulative_withdraw_token_amounts)
{
	this->cumulative_withdraw_token_amounts = cumulative_withdraw_token_amounts;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getCumulativeWithdrawUsd()
{
	return cumulative_withdraw_usd;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setCumulativeWithdrawUsd(std::string  cumulative_withdraw_usd)
{
	this->cumulative_withdraw_usd = cumulative_withdraw_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getCumulativeRewardTokenAmounts()
{
	return cumulative_reward_token_amounts;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setCumulativeRewardTokenAmounts(std::list <std::string> cumulative_reward_token_amounts)
{
	this->cumulative_reward_token_amounts = cumulative_reward_token_amounts;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getCumulativeRewardUsd()
{
	return cumulative_reward_usd;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setCumulativeRewardUsd(std::list <std::string> cumulative_reward_usd)
{
	this->cumulative_reward_usd = cumulative_reward_usd;
}

int
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getDepositCount()
{
	return deposit_count;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setDepositCount(int  deposit_count)
{
	this->deposit_count = deposit_count;
}

int
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getWithdrawCount()
{
	return withdraw_count;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setWithdrawCount(int  withdraw_count)
{
	this->withdraw_count = withdraw_count;
}

std::string
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V3_ETHEREUM.PositionSnapshotDTO::setTimestamp(std::string  timestamp)
{
