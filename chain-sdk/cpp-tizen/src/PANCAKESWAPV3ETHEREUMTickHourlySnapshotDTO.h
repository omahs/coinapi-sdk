/*
 * PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO();
	PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.TickHourlySnapshotDTO_H_ */
