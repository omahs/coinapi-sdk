/*
 * SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO.h
 *
 * Pool-level metadata.
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO();
	SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO_H_ */
