/*
 * PANCAKESWAP_V3_ETHEREUM.PositionSnapshotDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.PositionSnapshotDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.PositionSnapshotDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.PositionSnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.PositionSnapshotDTO();
	PANCAKESWAP_V3_ETHEREUM.PositionSnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.PositionSnapshotDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.PositionSnapshotDTO_H_ */
