/*
 * SUSHISWAP_V3_ETHEREUM.SwapDTO.h
 *
 * Trade (swap) event which occurred in a pool.
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.SwapDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.SwapDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.SwapDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.SwapDTO();
	SUSHISWAP_V3_ETHEREUM.SwapDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.SwapDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.SwapDTO_H_ */
