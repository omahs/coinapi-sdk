/*
 * CURVE_FINANCE_ETHEREUM.DepositDTO.h
 *
 * Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
 */

#ifndef _CURVE_FINANCE_ETHEREUM.DepositDTO_H_
#define _CURVE_FINANCE_ETHEREUM.DepositDTO_H_
...
class CURVE_FINANCE_ETHEREUM.DepositDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	CURVE_FINANCE_ETHEREUM.DepositDTO();
	CURVE_FINANCE_ETHEREUM.DepositDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~CURVE_FINANCE_ETHEREUM.DepositDTO();
	...
	/*! \brief Get deposit-(Transaction hash)-(log index)
	 */
	std::string getId();

	/*! \brief Set deposit-(Transaction hash)-(log index)
	 */
...
#endif /* _CURVE_FINANCE_ETHEREUM.DepositDTO_H_ */
