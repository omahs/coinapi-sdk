/*
 * PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO();
	PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO_H_ */
