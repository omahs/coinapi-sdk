...
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO()
{
	//__init();
}
...
void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::toJson()
{
...
std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getBlockRange()
{
	return block_range;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getId()
{
	return id;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getPool()
{
	return pool;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlySupplySideRevenueUsd()
{
	return hourly_supply_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlySupplySideRevenueUsd(std::string  hourly_supply_side_revenue_usd)
{
	this->hourly_supply_side_revenue_usd = hourly_supply_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyProtocolSideRevenueUsd()
{
	return hourly_protocol_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyProtocolSideRevenueUsd(std::string  hourly_protocol_side_revenue_usd)
{
	this->hourly_protocol_side_revenue_usd = hourly_protocol_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyTotalRevenueUsd()
{
	return hourly_total_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyTotalRevenueUsd(std::string  hourly_total_revenue_usd)
{
	this->hourly_total_revenue_usd = hourly_total_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyVolumeUsd()
{
	return hourly_volume_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyVolumeUsd(std::string  hourly_volume_usd)
{
	this->hourly_volume_usd = hourly_volume_usd;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyVolumeByTokenAmount()
{
	return hourly_volume_by_token_amount;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyVolumeByTokenAmount(std::list <std::string> hourly_volume_by_token_amount)
{
	this->hourly_volume_by_token_amount = hourly_volume_by_token_amount;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyVolumeByTokenUsd()
{
	return hourly_volume_by_token_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyVolumeByTokenUsd(std::list <std::string> hourly_volume_by_token_usd)
{
	this->hourly_volume_by_token_usd = hourly_volume_by_token_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getInputTokenBalances()
{
	return input_token_balances;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setInputTokenBalances(std::list <std::string> input_token_balances)
{
	this->input_token_balances = input_token_balances;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getInputTokenWeights()
{
	return input_token_weights;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setInputTokenWeights(std::list <std::string> input_token_weights)
{
	this->input_token_weights = input_token_weights;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getOutputTokenSupply()
{
	return output_token_supply;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setOutputTokenSupply(std::string  output_token_supply)
{
	this->output_token_supply = output_token_supply;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getOutputTokenPriceUsd()
{
	return output_token_price_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setOutputTokenPriceUsd(std::string  output_token_price_usd)
{
	this->output_token_price_usd = output_token_price_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getStakedOutputTokenAmount()
{
	return staked_output_token_amount;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setStakedOutputTokenAmount(std::string  staked_output_token_amount)
{
	this->staked_output_token_amount = staked_output_token_amount;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getRewardTokenEmissionsAmount()
{
	return reward_token_emissions_amount;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setRewardTokenEmissionsAmount(std::list <std::string> reward_token_emissions_amount)
{
	this->reward_token_emissions_amount = reward_token_emissions_amount;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getRewardTokenEmissionsUsd()
{
	return reward_token_emissions_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setRewardTokenEmissionsUsd(std::list <std::string> reward_token_emissions_usd)
{
