/*
 * CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO.h
 *
 * 
 */

#ifndef _CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO_H_
#define _CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO_H_
...
class CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO();
	CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO();
...
#endif /* _CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO_H_ */
