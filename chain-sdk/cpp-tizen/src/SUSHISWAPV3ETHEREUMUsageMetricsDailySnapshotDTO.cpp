...
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO()
{
	//__init();
}
...
void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::fromJson(char* jsonStr)
{
...
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::toJson()
{
...
std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getId()
{
	return id;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getDay()
{
	return day;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setDay(int  day)
{
	this->day = day;
}

std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getProtocol()
{
	return protocol;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailyActiveUsers()
{
	return daily_active_users;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailyActiveUsers(int  daily_active_users)
{
	this->daily_active_users = daily_active_users;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getCumulativeUniqueUsers()
{
	return cumulative_unique_users;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setCumulativeUniqueUsers(int  cumulative_unique_users)
{
	this->cumulative_unique_users = cumulative_unique_users;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailyTransactionCount()
{
	return daily_transaction_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailyTransactionCount(int  daily_transaction_count)
{
	this->daily_transaction_count = daily_transaction_count;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getTotalPoolCount()
{
	return total_pool_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setTotalPoolCount(int  total_pool_count)
{
	this->total_pool_count = total_pool_count;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailyDepositCount()
{
	return daily_deposit_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailyDepositCount(int  daily_deposit_count)
{
	this->daily_deposit_count = daily_deposit_count;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailyWithdrawCount()
{
	return daily_withdraw_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailyWithdrawCount(int  daily_withdraw_count)
{
	this->daily_withdraw_count = daily_withdraw_count;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailySwapCount()
{
	return daily_swap_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailySwapCount(int  daily_swap_count)
{
	this->daily_swap_count = daily_swap_count;
}

std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO::setTimestamp(std::string  timestamp)
{
