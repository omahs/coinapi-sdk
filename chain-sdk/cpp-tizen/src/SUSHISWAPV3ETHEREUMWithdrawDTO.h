/*
 * SUSHISWAP_V3_ETHEREUM.WithdrawDTO.h
 *
 * 
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.WithdrawDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.WithdrawDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.WithdrawDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.WithdrawDTO();
	SUSHISWAP_V3_ETHEREUM.WithdrawDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.WithdrawDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.WithdrawDTO_H_ */
