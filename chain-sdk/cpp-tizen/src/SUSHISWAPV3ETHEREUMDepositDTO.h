/*
 * SUSHISWAP_V3_ETHEREUM.DepositDTO.h
 *
 * Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.DepositDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.DepositDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.DepositDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.DepositDTO();
	SUSHISWAP_V3_ETHEREUM.DepositDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.DepositDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.DepositDTO_H_ */
