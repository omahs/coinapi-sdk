...
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::PANCAKESWAP_V3_ETHEREUM.WithdrawDTO()
{
	//__init();
}
...
void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::fromJson(char* jsonStr)
{
...
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::PANCAKESWAP_V3_ETHEREUM.WithdrawDTO(char* json)
{
	this->fromJson(json);
}

char*
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::toJson()
{
...
std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getEntryTime()
{
	return entry_time;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getRecvTime()
{
	return recv_time;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getBlockNumber()
{
	return block_number;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getId()
{
	return id;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getHash()
{
	return hash;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setHash(std::string  hash)
{
	this->hash = hash;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getNonce()
{
	return nonce;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setNonce(std::string  nonce)
{
	this->nonce = nonce;
}

int
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getLogIndex()
{
	return log_index;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setLogIndex(int  log_index)
{
	this->log_index = log_index;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getGasLimit()
{
	return gas_limit;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setGasLimit(std::string  gas_limit)
{
	this->gas_limit = gas_limit;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getGasUsed()
{
	return gas_used;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setGasUsed(std::string  gas_used)
{
	this->gas_used = gas_used;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getGasPrice()
{
	return gas_price;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setGasPrice(std::string  gas_price)
{
	this->gas_price = gas_price;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getProtocol()
{
	return protocol;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getAccount()
{
	return account;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setAccount(std::string  account)
{
	this->account = account;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getPosition()
{
	return position;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setPosition(std::string  position)
{
	this->position = position;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getTickLower()
{
	return tick_lower;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setTickLower(std::string  tick_lower)
{
	this->tick_lower = tick_lower;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getTickUpper()
{
	return tick_upper;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setTickUpper(std::string  tick_upper)
{
	this->tick_upper = tick_upper;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getPool()
{
	return pool;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getTimestamp()
{
	return timestamp;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getLiquidity()
{
	return liquidity;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::list<std::string>
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getInputTokens()
{
	return input_tokens;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setInputTokens(std::list <std::string> input_tokens)
{
	this->input_tokens = input_tokens;
}

std::list<std::string>
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getInputTokenAmounts()
{
	return input_token_amounts;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setInputTokenAmounts(std::list <std::string> input_token_amounts)
{
	this->input_token_amounts = input_token_amounts;
}

std::list<std::string>
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getReserveAmounts()
{
	return reserve_amounts;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setReserveAmounts(std::list <std::string> reserve_amounts)
{
	this->reserve_amounts = reserve_amounts;
}

std::string
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::getAmountUsd()
{
	return amount_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.WithdrawDTO::setAmountUsd(std::string  amount_usd)
{
