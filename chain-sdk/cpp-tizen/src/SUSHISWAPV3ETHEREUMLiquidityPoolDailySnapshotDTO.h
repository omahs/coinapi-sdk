/*
 * SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO.h
 *
 * Represents a liquidity pool daily snapshot for Sushiswap V3.
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_
...
/*! \brief Represents a liquidity pool daily snapshot for Sushiswap V3.
 *
 *  \ingroup Models
 *
 */

class SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO();
	SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_ */
