/*
 * SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO.h
 *
 * 
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO();
	SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO_H_ */
