...
UNISWAP_V3_ETHEREUM.TickDTO::UNISWAP_V3_ETHEREUM.TickDTO()
{
	//__init();
}
...
void
UNISWAP_V3_ETHEREUM.TickDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V3_ETHEREUM.TickDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V3_ETHEREUM.TickDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V3_ETHEREUM.TickDTO::UNISWAP_V3_ETHEREUM.TickDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V3_ETHEREUM.TickDTO::toJson()
{
...
std::string
UNISWAP_V3_ETHEREUM.TickDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V3_ETHEREUM.TickDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

long long
UNISWAP_V3_ETHEREUM.TickDTO::getVid()
{
	return vid;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getId()
{
	return id;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getIndex()
{
	return index;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setIndex(std::string  index)
{
	this->index = index;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getPool()
{
	return pool;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getCreatedTimestamp()
{
	return created_timestamp;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setCreatedTimestamp(std::string  created_timestamp)
{
	this->created_timestamp = created_timestamp;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getCreatedBlockNumber()
{
	return created_block_number;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setCreatedBlockNumber(std::string  created_block_number)
{
	this->created_block_number = created_block_number;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.TickDTO::getPrices()
{
	return prices;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setPrices(std::list <std::string> prices)
{
	this->prices = prices;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getLiquidityGross()
{
	return liquidity_gross;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setLiquidityGross(std::string  liquidity_gross)
{
	this->liquidity_gross = liquidity_gross;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getLiquidityGrossUsd()
{
	return liquidity_gross_usd;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setLiquidityGrossUsd(std::string  liquidity_gross_usd)
{
	this->liquidity_gross_usd = liquidity_gross_usd;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getLiquidityNet()
{
	return liquidity_net;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setLiquidityNet(std::string  liquidity_net)
{
	this->liquidity_net = liquidity_net;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getLiquidityNetUsd()
{
	return liquidity_net_usd;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setLiquidityNetUsd(std::string  liquidity_net_usd)
{
	this->liquidity_net_usd = liquidity_net_usd;
}

int
UNISWAP_V3_ETHEREUM.TickDTO::getLastSnapshotDayId()
{
	return last_snapshot_day_id;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setLastSnapshotDayId(int  last_snapshot_day_id)
{
	this->last_snapshot_day_id = last_snapshot_day_id;
}

int
UNISWAP_V3_ETHEREUM.TickDTO::getLastSnapshotHourId()
{
	return last_snapshot_hour_id;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setLastSnapshotHourId(int  last_snapshot_hour_id)
{
	this->last_snapshot_hour_id = last_snapshot_hour_id;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getLastUpdateTimestamp()
{
	return last_update_timestamp;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setLastUpdateTimestamp(std::string  last_update_timestamp)
{
	this->last_update_timestamp = last_update_timestamp;
}

std::string
UNISWAP_V3_ETHEREUM.TickDTO::getLastUpdateBlockNumber()
{
	return last_update_block_number;
}

void
UNISWAP_V3_ETHEREUM.TickDTO::setLastUpdateBlockNumber(std::string  last_update_block_number)
{
