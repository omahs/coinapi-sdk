...
PANCAKESWAP_V3_ETHEREUM.AccountDTO::PANCAKESWAP_V3_ETHEREUM.AccountDTO()
{
	//__init();
}
...
void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::fromJson(char* jsonStr)
{
...
PANCAKESWAP_V3_ETHEREUM.AccountDTO::PANCAKESWAP_V3_ETHEREUM.AccountDTO(char* json)
{
	this->fromJson(json);
}

char*
PANCAKESWAP_V3_ETHEREUM.AccountDTO::toJson()
{
...
std::string
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getEntryTime()
{
	return entry_time;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getRecvTime()
{
	return recv_time;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getBlockNumber()
{
	return block_number;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getBlockRange()
{
	return block_range;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getId()
{
	return id;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setId(std::string  id)
{
	this->id = id;
}

int
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getPositionCount()
{
	return position_count;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setPositionCount(int  position_count)
{
	this->position_count = position_count;
}

int
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getOpenPositionCount()
{
	return open_position_count;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setOpenPositionCount(int  open_position_count)
{
	this->open_position_count = open_position_count;
}

int
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getClosedPositionCount()
{
	return closed_position_count;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setClosedPositionCount(int  closed_position_count)
{
	this->closed_position_count = closed_position_count;
}

int
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getDepositCount()
{
	return deposit_count;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setDepositCount(int  deposit_count)
{
	this->deposit_count = deposit_count;
}

int
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getWithdrawCount()
{
	return withdraw_count;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setWithdrawCount(int  withdraw_count)
{
	this->withdraw_count = withdraw_count;
}

int
PANCAKESWAP_V3_ETHEREUM.AccountDTO::getSwapCount()
{
	return swap_count;
}

void
PANCAKESWAP_V3_ETHEREUM.AccountDTO::setSwapCount(int  swap_count)
{
