/*
 * PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO.h
 *
...
#ifndef _PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO();
	PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO_H_ */
