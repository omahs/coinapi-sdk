...
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO()
{
	//__init();
}
...
void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::toJson()
{
...
std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getBlockNumber()
{
	return block_number;
}
...
std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getId()
{
	return id;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHour()
{
	return hour;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHour(int  hour)
{
	this->hour = hour;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getPool()
{
	return pool;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getTick()
{
	return tick;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setTick(std::string  tick)
{
	this->tick = tick;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getTotalLiquidity()
{
	return total_liquidity;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setTotalLiquidity(std::string  total_liquidity)
{
	this->total_liquidity = total_liquidity;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getTotalLiquidityUsd()
{
	return total_liquidity_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setTotalLiquidityUsd(std::string  total_liquidity_usd)
{
	this->total_liquidity_usd = total_liquidity_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getActiveLiquidity()
{
	return active_liquidity;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setActiveLiquidity(std::string  active_liquidity)
{
	this->active_liquidity = active_liquidity;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getActiveLiquidityUsd()
{
	return active_liquidity_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setActiveLiquidityUsd(std::string  active_liquidity_usd)
{
	this->active_liquidity_usd = active_liquidity_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getUncollectedProtocolSideTokenAmounts()
{
	return uncollected_protocol_side_token_amounts;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setUncollectedProtocolSideTokenAmounts(std::list <std::string> uncollected_protocol_side_token_amounts)
{
	this->uncollected_protocol_side_token_amounts = uncollected_protocol_side_token_amounts;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getUncollectedProtocolSideValuesUsd()
{
	return uncollected_protocol_side_values_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setUncollectedProtocolSideValuesUsd(std::list <std::string> uncollected_protocol_side_values_usd)
{
	this->uncollected_protocol_side_values_usd = uncollected_protocol_side_values_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getUncollectedSupplySideTokenAmounts()
{
	return uncollected_supply_side_token_amounts;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setUncollectedSupplySideTokenAmounts(std::list <std::string> uncollected_supply_side_token_amounts)
{
	this->uncollected_supply_side_token_amounts = uncollected_supply_side_token_amounts;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getUncollectedSupplySideValuesUsd()
{
	return uncollected_supply_side_values_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setUncollectedSupplySideValuesUsd(std::list <std::string> uncollected_supply_side_values_usd)
{
	this->uncollected_supply_side_values_usd = uncollected_supply_side_values_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlySupplySideRevenueUsd()
{
	return hourly_supply_side_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlySupplySideRevenueUsd(std::string  hourly_supply_side_revenue_usd)
{
	this->hourly_supply_side_revenue_usd = hourly_supply_side_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyProtocolSideRevenueUsd()
{
	return hourly_protocol_side_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyProtocolSideRevenueUsd(std::string  hourly_protocol_side_revenue_usd)
{
	this->hourly_protocol_side_revenue_usd = hourly_protocol_side_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyTotalRevenueUsd()
{
	return hourly_total_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyTotalRevenueUsd(std::string  hourly_total_revenue_usd)
{
	this->hourly_total_revenue_usd = hourly_total_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyVolumeUsd()
{
	return hourly_volume_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyVolumeUsd(std::string  hourly_volume_usd)
{
	this->hourly_volume_usd = hourly_volume_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeVolumeByTokenAmount()
{
	return cumulative_volume_by_token_amount;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeVolumeByTokenAmount(std::list <std::string> cumulative_volume_by_token_amount)
{
	this->cumulative_volume_by_token_amount = cumulative_volume_by_token_amount;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyVolumeByTokenAmount()
{
	return hourly_volume_by_token_amount;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyVolumeByTokenAmount(std::list <std::string> hourly_volume_by_token_amount)
{
	this->hourly_volume_by_token_amount = hourly_volume_by_token_amount;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeVolumeByTokenUsd()
{
	return cumulative_volume_by_token_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeVolumeByTokenUsd(std::list <std::string> cumulative_volume_by_token_usd)
{
	this->cumulative_volume_by_token_usd = cumulative_volume_by_token_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyVolumeByTokenUsd()
{
	return hourly_volume_by_token_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyVolumeByTokenUsd(std::list <std::string> hourly_volume_by_token_usd)
{
	this->hourly_volume_by_token_usd = hourly_volume_by_token_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getInputTokenBalances()
{
	return input_token_balances;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setInputTokenBalances(std::list <std::string> input_token_balances)
{
	this->input_token_balances = input_token_balances;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getInputTokenBalancesUsd()
{
	return input_token_balances_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setInputTokenBalancesUsd(std::list <std::string> input_token_balances_usd)
{
	this->input_token_balances_usd = input_token_balances_usd;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getInputTokenWeights()
{
	return input_token_weights;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setInputTokenWeights(std::list <std::string> input_token_weights)
{
	this->input_token_weights = input_token_weights;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getStakedOutputTokenAmount()
{
	return staked_output_token_amount;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setStakedOutputTokenAmount(std::string  staked_output_token_amount)
{
	this->staked_output_token_amount = staked_output_token_amount;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getRewardTokenEmissionsAmount()
{
	return reward_token_emissions_amount;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setRewardTokenEmissionsAmount(std::list <std::string> reward_token_emissions_amount)
{
	this->reward_token_emissions_amount = reward_token_emissions_amount;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getRewardTokenEmissionsUsd()
{
	return reward_token_emissions_usd;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setRewardTokenEmissionsUsd(std::list <std::string> reward_token_emissions_usd)
{
	this->reward_token_emissions_usd = reward_token_emissions_usd;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeDepositCount()
{
	return cumulative_deposit_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeDepositCount(int  cumulative_deposit_count)
{
	this->cumulative_deposit_count = cumulative_deposit_count;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyDepositCount()
{
	return hourly_deposit_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyDepositCount(int  hourly_deposit_count)
{
	this->hourly_deposit_count = hourly_deposit_count;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeWithdrawCount()
{
	return cumulative_withdraw_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeWithdrawCount(int  cumulative_withdraw_count)
{
	this->cumulative_withdraw_count = cumulative_withdraw_count;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlyWithdrawCount()
{
	return hourly_withdraw_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlyWithdrawCount(int  hourly_withdraw_count)
{
	this->hourly_withdraw_count = hourly_withdraw_count;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getCumulativeSwapCount()
{
	return cumulative_swap_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setCumulativeSwapCount(int  cumulative_swap_count)
{
	this->cumulative_swap_count = cumulative_swap_count;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getHourlySwapCount()
{
	return hourly_swap_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setHourlySwapCount(int  hourly_swap_count)
{
	this->hourly_swap_count = hourly_swap_count;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getPositionCount()
{
	return position_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setPositionCount(int  position_count)
{
	this->position_count = position_count;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getOpenPositionCount()
{
	return open_position_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setOpenPositionCount(int  open_position_count)
{
	this->open_position_count = open_position_count;
}

int
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getClosedPositionCount()
{
	return closed_position_count;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setClosedPositionCount(int  closed_position_count)
{
	this->closed_position_count = closed_position_count;
}

std::string
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO::setTimestamp(std::string  timestamp)
{
