...
CURVE_FINANCE_ETHEREUM.DepositDTO::CURVE_FINANCE_ETHEREUM.DepositDTO()
{
	//__init();
}
...
void
CURVE_FINANCE_ETHEREUM.DepositDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
CURVE_FINANCE_ETHEREUM.DepositDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
CURVE_FINANCE_ETHEREUM.DepositDTO::fromJson(char* jsonStr)
{
...
CURVE_FINANCE_ETHEREUM.DepositDTO::CURVE_FINANCE_ETHEREUM.DepositDTO(char* json)
{
	this->fromJson(json);
}

char*
CURVE_FINANCE_ETHEREUM.DepositDTO::toJson()
{
...
std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getEntryTime()
{
	return entry_time;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getRecvTime()
{
	return recv_time;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
CURVE_FINANCE_ETHEREUM.DepositDTO::getBlockNumber()
{
	return block_number;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getBlockRange()
{
	return block_range;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getId()
{
	return id;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getHash()
{
	return hash;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setHash(std::string  hash)
{
	this->hash = hash;
}

int
CURVE_FINANCE_ETHEREUM.DepositDTO::getLogIndex()
{
	return log_index;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setLogIndex(int  log_index)
{
	this->log_index = log_index;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getProtocol()
{
	return protocol;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getTo()
{
	return to;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setTo(std::string  to)
{
	this->to = to;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getFrom()
{
	return from;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setFrom(std::string  from)
{
	this->from = from;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getTimestamp()
{
	return timestamp;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.DepositDTO::getInputTokens()
{
	return input_tokens;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setInputTokens(std::list <std::string> input_tokens)
{
	this->input_tokens = input_tokens;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getOutputToken()
{
	return output_token;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setOutputToken(std::string  output_token)
{
	this->output_token = output_token;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.DepositDTO::getInputTokenAmounts()
{
	return input_token_amounts;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setInputTokenAmounts(std::list <std::string> input_token_amounts)
{
	this->input_token_amounts = input_token_amounts;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getOutputTokenAmount()
{
	return output_token_amount;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setOutputTokenAmount(std::string  output_token_amount)
{
	this->output_token_amount = output_token_amount;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getAmountUsd()
{
	return amount_usd;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setAmountUsd(std::string  amount_usd)
{
	this->amount_usd = amount_usd;
}

std::string
CURVE_FINANCE_ETHEREUM.DepositDTO::getPool()
{
	return pool;
}

void
CURVE_FINANCE_ETHEREUM.DepositDTO::setPool(std::string  pool)
{
	this->pool = pool;
}
