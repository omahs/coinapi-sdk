...
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::SUSHISWAP_V3_ETHEREUM.WithdrawDTO()
{
	//__init();
}
...
void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::fromJson(char* jsonStr)
{
...
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::SUSHISWAP_V3_ETHEREUM.WithdrawDTO(char* json)
{
	this->fromJson(json);
}

char*
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::toJson()
{
...
std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getEntryTime()
{
	return entry_time;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getRecvTime()
{
	return recv_time;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getBlockNumber()
{
	return block_number;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getId()
{
	return id;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getHash()
{
	return hash;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setHash(std::string  hash)
{
	this->hash = hash;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getNonce()
{
	return nonce;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setNonce(std::string  nonce)
{
	this->nonce = nonce;
}

int
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getLogIndex()
{
	return log_index;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setLogIndex(int  log_index)
{
	this->log_index = log_index;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getGasLimit()
{
	return gas_limit;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setGasLimit(std::string  gas_limit)
{
	this->gas_limit = gas_limit;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getGasUsed()
{
	return gas_used;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setGasUsed(std::string  gas_used)
{
	this->gas_used = gas_used;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getGasPrice()
{
	return gas_price;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setGasPrice(std::string  gas_price)
{
	this->gas_price = gas_price;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getProtocol()
{
	return protocol;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getAccount()
{
	return account;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setAccount(std::string  account)
{
	this->account = account;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getPosition()
{
	return position;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setPosition(std::string  position)
{
	this->position = position;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getTickLower()
{
	return tick_lower;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setTickLower(std::string  tick_lower)
{
	this->tick_lower = tick_lower;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getTickUpper()
{
	return tick_upper;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setTickUpper(std::string  tick_upper)
{
	this->tick_upper = tick_upper;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getPool()
{
	return pool;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getTimestamp()
{
	return timestamp;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getLiquidity()
{
	return liquidity;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getInputTokens()
{
	return input_tokens;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setInputTokens(std::list <std::string> input_tokens)
{
	this->input_tokens = input_tokens;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getInputTokenAmounts()
{
	return input_token_amounts;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setInputTokenAmounts(std::list <std::string> input_token_amounts)
{
	this->input_token_amounts = input_token_amounts;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getReserveAmounts()
{
	return reserve_amounts;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setReserveAmounts(std::list <std::string> reserve_amounts)
{
	this->reserve_amounts = reserve_amounts;
}

std::string
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::getAmountUsd()
{
	return amount_usd;
}

void
SUSHISWAP_V3_ETHEREUM.WithdrawDTO::setAmountUsd(std::string  amount_usd)
{
