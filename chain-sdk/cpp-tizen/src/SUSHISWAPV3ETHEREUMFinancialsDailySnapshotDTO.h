/*
 * SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO.h
 *
 * Daily financial metrics for Sushiswap V3.
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO_H_
...
/*! \brief Daily financial metrics for Sushiswap V3.
 *
 *  \ingroup Models
 *
 */

class SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO();
	SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO_H_ */
