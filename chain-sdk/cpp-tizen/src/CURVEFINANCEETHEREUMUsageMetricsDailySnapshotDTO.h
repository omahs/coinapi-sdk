/*
 * CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO.h
 *
 * 
 */

#ifndef _CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO_H_
#define _CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO_H_
...
class CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO();
	CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO();
...
#endif /* _CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO_H_ */
