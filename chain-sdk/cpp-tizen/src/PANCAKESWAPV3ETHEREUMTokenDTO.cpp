...
PANCAKESWAP_V3_ETHEREUM.TokenDTO::PANCAKESWAP_V3_ETHEREUM.TokenDTO()
{
	//__init();
}
...
void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::fromJson(char* jsonStr)
{
...
PANCAKESWAP_V3_ETHEREUM.TokenDTO::PANCAKESWAP_V3_ETHEREUM.TokenDTO(char* json)
{
	this->fromJson(json);
}

char*
PANCAKESWAP_V3_ETHEREUM.TokenDTO::toJson()
{
...
std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getEntryTime()
{
	return entry_time;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getRecvTime()
{
	return recv_time;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getBlockNumber()
{
	return block_number;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

long long
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getVid()
{
	return vid;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getBlockRange()
{
	return block_range;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getId()
{
	return id;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getName()
{
	return name;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setName(std::string  name)
{
	this->name = name;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getSymbol()
{
	return symbol;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

int
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getDecimals()
{
	return decimals;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setDecimals(int  decimals)
{
	this->decimals = decimals;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getLastPriceUsd()
{
	return last_price_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setLastPriceUsd(std::string  last_price_usd)
{
	this->last_price_usd = last_price_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getLastPriceBlockNumber()
{
	return last_price_block_number;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setLastPriceBlockNumber(std::string  last_price_block_number)
{
	this->last_price_block_number = last_price_block_number;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getLastPricePool()
{
	return last_price_pool;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setLastPricePool(std::string  last_price_pool)
{
	this->last_price_pool = last_price_pool;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getTotalSupply()
{
	return total_supply;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setTotalSupply(std::string  total_supply)
{
	this->total_supply = total_supply;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

int
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getLargePriceChangeBuffer()
{
	return large_price_change_buffer;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setLargePriceChangeBuffer(int  large_price_change_buffer)
{
	this->large_price_change_buffer = large_price_change_buffer;
}

int
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getLargeTvlImpactBuffer()
{
	return large_tvl_impact_buffer;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setLargeTvlImpactBuffer(int  large_tvl_impact_buffer)
{
	this->large_tvl_impact_buffer = large_tvl_impact_buffer;
}

std::string
PANCAKESWAP_V3_ETHEREUM.TokenDTO::getTokenSymbol()
{
	return token_symbol;
}

void
PANCAKESWAP_V3_ETHEREUM.TokenDTO::setTokenSymbol(std::string  token_symbol)
{
