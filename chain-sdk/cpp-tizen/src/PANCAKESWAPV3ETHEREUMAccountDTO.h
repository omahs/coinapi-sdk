/*
 * PANCAKESWAP_V3_ETHEREUM.AccountDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.AccountDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.AccountDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.AccountDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.AccountDTO();
	PANCAKESWAP_V3_ETHEREUM.AccountDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.AccountDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.AccountDTO_H_ */
