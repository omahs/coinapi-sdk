/*
 * PANCAKESWAP_V3_ETHEREUM.TokenDTO.h
 *
 * Stores aggregated information for a specific token across all pairs that token is included in.
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.TokenDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.TokenDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.TokenDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.TokenDTO();
	PANCAKESWAP_V3_ETHEREUM.TokenDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.TokenDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.TokenDTO_H_ */
