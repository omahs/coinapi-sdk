/*
 * PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO.h
 *
 * Pool-level metadata.
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO();
	PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO_H_ */
