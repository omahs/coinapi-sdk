/*
 * PANCAKESWAP_V3_ETHEREUM.SwapDTO.h
 *
 * Trade (swap) event which occurred in a pool.
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.SwapDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.SwapDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.SwapDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.SwapDTO();
	PANCAKESWAP_V3_ETHEREUM.SwapDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.SwapDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.SwapDTO_H_ */
