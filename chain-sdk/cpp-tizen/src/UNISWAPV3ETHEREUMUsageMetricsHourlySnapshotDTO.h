/*
 * UNISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_
#define _UNISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_
...
class UNISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO();
	UNISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_ */
