/*
 * SUSHISWAP_V3_ETHEREUM.PositionDTO.h
 *
 * 
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.PositionDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.PositionDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.PositionDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.PositionDTO();
	SUSHISWAP_V3_ETHEREUM.PositionDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.PositionDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.PositionDTO_H_ */
