/*
 * CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO.h
 *
 * 
 */

#ifndef _CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_
#define _CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_
...
class CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO();
	CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO();
...
#endif /* _CURVE_FINANCE_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_ */
