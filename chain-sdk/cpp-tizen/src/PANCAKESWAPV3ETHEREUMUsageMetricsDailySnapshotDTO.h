/*
 * PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO();
	PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO_H_ */
