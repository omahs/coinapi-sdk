...
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO()
{
	//__init();
}
...
void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::fromJson(char* jsonStr)
{
...
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::toJson()
{
...
std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getId()
{
	return id;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHour()
{
	return hour;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHour(int  hour)
{
	this->hour = hour;
}

std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getProtocol()
{
	return protocol;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlyActiveUsers()
{
	return hourly_active_users;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlyActiveUsers(int  hourly_active_users)
{
	this->hourly_active_users = hourly_active_users;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getCumulativeUniqueUsers()
{
	return cumulative_unique_users;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setCumulativeUniqueUsers(int  cumulative_unique_users)
{
	this->cumulative_unique_users = cumulative_unique_users;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlyTransactionCount()
{
	return hourly_transaction_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlyTransactionCount(int  hourly_transaction_count)
{
	this->hourly_transaction_count = hourly_transaction_count;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlyDepositCount()
{
	return hourly_deposit_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlyDepositCount(int  hourly_deposit_count)
{
	this->hourly_deposit_count = hourly_deposit_count;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlyWithdrawCount()
{
	return hourly_withdraw_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlyWithdrawCount(int  hourly_withdraw_count)
{
	this->hourly_withdraw_count = hourly_withdraw_count;
}

int
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlySwapCount()
{
	return hourly_swap_count;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlySwapCount(int  hourly_swap_count)
{
	this->hourly_swap_count = hourly_swap_count;
}

std::string
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO::setTimestamp(std::string  timestamp)
{
