...
CURVE_FINANCE_ETHEREUM.TokenDTO::CURVE_FINANCE_ETHEREUM.TokenDTO()
{
	//__init();
}
...
void
CURVE_FINANCE_ETHEREUM.TokenDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
CURVE_FINANCE_ETHEREUM.TokenDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
CURVE_FINANCE_ETHEREUM.TokenDTO::fromJson(char* jsonStr)
{
...
CURVE_FINANCE_ETHEREUM.TokenDTO::CURVE_FINANCE_ETHEREUM.TokenDTO(char* json)
{
	this->fromJson(json);
}

char*
CURVE_FINANCE_ETHEREUM.TokenDTO::toJson()
{
...
std::string
CURVE_FINANCE_ETHEREUM.TokenDTO::getEntryTime()
{
	return entry_time;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
CURVE_FINANCE_ETHEREUM.TokenDTO::getRecvTime()
{
	return recv_time;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
CURVE_FINANCE_ETHEREUM.TokenDTO::getBlockNumber()
{
	return block_number;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

long long
CURVE_FINANCE_ETHEREUM.TokenDTO::getVid()
{
	return vid;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
CURVE_FINANCE_ETHEREUM.TokenDTO::getId()
{
	return id;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
CURVE_FINANCE_ETHEREUM.TokenDTO::getName()
{
	return name;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setName(std::string  name)
{
	this->name = name;
}

std::string
CURVE_FINANCE_ETHEREUM.TokenDTO::getSymbol()
{
	return symbol;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

int
CURVE_FINANCE_ETHEREUM.TokenDTO::getDecimals()
{
	return decimals;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setDecimals(int  decimals)
{
	this->decimals = decimals;
}

std::string
CURVE_FINANCE_ETHEREUM.TokenDTO::getLastPriceUsd()
{
	return last_price_usd;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setLastPriceUsd(std::string  last_price_usd)
{
	this->last_price_usd = last_price_usd;
}

std::string
CURVE_FINANCE_ETHEREUM.TokenDTO::getLastPriceBlockNumber()
{
	return last_price_block_number;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setLastPriceBlockNumber(std::string  last_price_block_number)
{
	this->last_price_block_number = last_price_block_number;
}

std::string
CURVE_FINANCE_ETHEREUM.TokenDTO::getTokenSymbol()
{
	return token_symbol;
}

void
CURVE_FINANCE_ETHEREUM.TokenDTO::setTokenSymbol(std::string  token_symbol)
{
