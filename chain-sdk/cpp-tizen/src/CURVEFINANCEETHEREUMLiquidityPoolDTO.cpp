...
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO()
{
	//__init();
}
...
void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
	...
	//new std::list()std::list> input_tokens_ordered;
	...
	//gauge_address = std::string();
	//evaluated_ask = double(0);
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
	...
	//input_tokens_ordered.RemoveAll(true);
	//delete input_tokens_ordered;
	...
	//}
	//if(gauge_address != NULL) {
	//
	//delete gauge_address;
	//gauge_address = NULL;
	//}
...
void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::fromJson(char* jsonStr)
{
	...
	const gchar *input_tokens_orderedKey = "input_tokens_ordered";
	node = json_object_get_member(pJsonObject, input_tokens_orderedKey);
	if (node !=NULL) {
	...
	const gchar *gauge_addressKey = "gauge_address";
	node = json_object_get_member(pJsonObject, gauge_addressKey);
	if (node !=NULL) {
	

		if (isprimitive("std::string")) {
			jsonToValue(&gauge_address, node, "std::string", "");
		} else {
...
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO(char* json)
{
	this->fromJson(json);
}

char*
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::toJson()
{
	...
	if (isprimitive("std::string")) {
		list<std::string> new_list = static_cast<list <std::string> > (getInputTokensOrdered());
		node = converttoJson(&new_list, "std::string", "array");
	} else {
		node = json_node_alloc();
		list<std::string> new_list = static_cast<list <std::string> > (getInputTokensOrdered());
	...
	const gchar *input_tokens_orderedKey = "input_tokens_ordered";
	json_object_set_member(pJsonObject, input_tokens_orderedKey, node);
	if (isprimitive("std::string")) {
	...
	if (isprimitive("std::string")) {
		std::string obj = getGaugeAddress();
		node = converttoJson(&obj, "std::string", "");
	}
	else {
	...
	const gchar *gauge_addressKey = "gauge_address";
	json_object_set_member(pJsonObject, gauge_addressKey, node);
	if (isprimitive("double")) {
...
std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getEntryTime()
{
	return entry_time;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getRecvTime()
{
	return recv_time;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getBlockNumber()
{
	return block_number;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

long long
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getVid()
{
	return vid;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getId()
{
	return id;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getProtocol()
{
	return protocol;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getName()
{
	return name;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setName(std::string  name)
{
	this->name = name;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getSymbol()
{
	return symbol;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getInputTokens()
{
	return input_tokens;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setInputTokens(std::list <std::string> input_tokens)
{
	this->input_tokens = input_tokens;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getInputTokensOrdered()
{
	return input_tokens_ordered;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setInputTokensOrdered(std::list <std::string> input_tokens_ordered)
{
	this->input_tokens_ordered = input_tokens_ordered;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getOutputToken()
{
	return output_token;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setOutputToken(std::string  output_token)
{
	this->output_token = output_token;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getRewardTokens()
{
	return reward_tokens;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setRewardTokens(std::list <std::string> reward_tokens)
{
	this->reward_tokens = reward_tokens;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getFees()
{
	return fees;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setFees(std::list <std::string> fees)
{
	this->fees = fees;
}

bool
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getIsSingleSided()
{
	return is_single_sided;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setIsSingleSided(bool  is_single_sided)
{
	this->is_single_sided = is_single_sided;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getCreatedTimestamp()
{
	return created_timestamp;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setCreatedTimestamp(std::string  created_timestamp)
{
	this->created_timestamp = created_timestamp;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getCreatedBlockNumber()
{
	return created_block_number;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setCreatedBlockNumber(std::string  created_block_number)
{
	this->created_block_number = created_block_number;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getInputTokenBalances()
{
	return input_token_balances;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setInputTokenBalances(std::list <std::string> input_token_balances)
{
	this->input_token_balances = input_token_balances;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getInputTokenWeights()
{
	return input_token_weights;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setInputTokenWeights(std::list <std::string> input_token_weights)
{
	this->input_token_weights = input_token_weights;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getOutputTokenSupply()
{
	return output_token_supply;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setOutputTokenSupply(std::string  output_token_supply)
{
	this->output_token_supply = output_token_supply;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getOutputTokenPriceUsd()
{
	return output_token_price_usd;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setOutputTokenPriceUsd(std::string  output_token_price_usd)
{
	this->output_token_price_usd = output_token_price_usd;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getStakedOutputTokenAmount()
{
	return staked_output_token_amount;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setStakedOutputTokenAmount(std::string  staked_output_token_amount)
{
	this->staked_output_token_amount = staked_output_token_amount;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getRewardTokenEmissionsAmount()
{
	return reward_token_emissions_amount;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setRewardTokenEmissionsAmount(std::list <std::string> reward_token_emissions_amount)
{
	this->reward_token_emissions_amount = reward_token_emissions_amount;
}

std::list<std::string>
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getRewardTokenEmissionsUsd()
{
	return reward_token_emissions_usd;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setRewardTokenEmissionsUsd(std::list <std::string> reward_token_emissions_usd)
{
	this->reward_token_emissions_usd = reward_token_emissions_usd;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getRegistryAddress()
{
	return registry_address;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setRegistryAddress(std::string  registry_address)
{
	this->registry_address = registry_address;
}

std::string
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getGaugeAddress()
{
	return gauge_address;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setGaugeAddress(std::string  gauge_address)
{
	this->gauge_address = gauge_address;
}

double
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::getEvaluatedAsk()
{
	return evaluated_ask;
}

void
CURVE_FINANCE_ETHEREUM.LiquidityPoolDTO::setEvaluatedAsk(double  evaluated_ask)
{
