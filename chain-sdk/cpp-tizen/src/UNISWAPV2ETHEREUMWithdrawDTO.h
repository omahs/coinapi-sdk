/*
 * UNISWAP_V2_ETHEREUM.WithdrawDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V2_ETHEREUM.WithdrawDTO_H_
#define _UNISWAP_V2_ETHEREUM.WithdrawDTO_H_
...
class UNISWAP_V2_ETHEREUM.WithdrawDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V2_ETHEREUM.WithdrawDTO();
	UNISWAP_V2_ETHEREUM.WithdrawDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V2_ETHEREUM.WithdrawDTO();
...
#endif /* _UNISWAP_V2_ETHEREUM.WithdrawDTO_H_ */
