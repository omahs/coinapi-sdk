...
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO()
{
	//__init();
}
...
void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::toJson()
{
...
std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getBlockRange()
{
	return block_range;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getId()
{
	return id;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getProtocolControlledValueUsd()
{
	return protocol_controlled_value_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setProtocolControlledValueUsd(std::string  protocol_controlled_value_usd)
{
	this->protocol_controlled_value_usd = protocol_controlled_value_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getDailyVolumeUsd()
{
	return daily_volume_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setDailyVolumeUsd(std::string  daily_volume_usd)
{
	this->daily_volume_usd = daily_volume_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getDailySupplySideRevenueUsd()
{
	return daily_supply_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setDailySupplySideRevenueUsd(std::string  daily_supply_side_revenue_usd)
{
	this->daily_supply_side_revenue_usd = daily_supply_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getDailyProtocolSideRevenueUsd()
{
	return daily_protocol_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setDailyProtocolSideRevenueUsd(std::string  daily_protocol_side_revenue_usd)
{
	this->daily_protocol_side_revenue_usd = daily_protocol_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getDailyTotalRevenueUsd()
{
	return daily_total_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setDailyTotalRevenueUsd(std::string  daily_total_revenue_usd)
{
	this->daily_total_revenue_usd = daily_total_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO::setTimestamp(std::string  timestamp)
{
