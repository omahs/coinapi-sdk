/*
 * SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO.h
 *
 * 
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO();
	SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO_H_ */
