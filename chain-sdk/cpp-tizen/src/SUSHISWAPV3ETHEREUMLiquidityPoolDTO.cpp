...
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO()
{
	//__init();
}
...
void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::fromJson(char* jsonStr)
{
...
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO(char* json)
{
	this->fromJson(json);
}

char*
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::toJson()
{
...
std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getEntryTime()
{
	return entry_time;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getRecvTime()
{
	return recv_time;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getBlockNumber()
{
	return block_number;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

long long
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getVid()
{
	return vid;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getBlockRange()
{
	return block_range;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getId()
{
	return id;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getProtocol()
{
	return protocol;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getName()
{
	return name;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setName(std::string  name)
{
	this->name = name;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getSymbol()
{
	return symbol;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getLiquidityToken()
{
	return liquidity_token;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setLiquidityToken(std::string  liquidity_token)
{
	this->liquidity_token = liquidity_token;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getInputTokens()
{
	return input_tokens;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setInputTokens(std::list <std::string> input_tokens)
{
	this->input_tokens = input_tokens;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getRewardTokens()
{
	return reward_tokens;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setRewardTokens(std::list <std::string> reward_tokens)
{
	this->reward_tokens = reward_tokens;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getFees()
{
	return fees;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setFees(std::list <std::string> fees)
{
	this->fees = fees;
}

bool
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getIsSingleSided()
{
	return is_single_sided;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setIsSingleSided(bool  is_single_sided)
{
	this->is_single_sided = is_single_sided;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCreatedTimestamp()
{
	return created_timestamp;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCreatedTimestamp(std::string  created_timestamp)
{
	this->created_timestamp = created_timestamp;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCreatedBlockNumber()
{
	return created_block_number;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCreatedBlockNumber(std::string  created_block_number)
{
	this->created_block_number = created_block_number;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getTick()
{
	return tick;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setTick(std::string  tick)
{
	this->tick = tick;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getTotalLiquidity()
{
	return total_liquidity;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setTotalLiquidity(std::string  total_liquidity)
{
	this->total_liquidity = total_liquidity;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getTotalLiquidityUsd()
{
	return total_liquidity_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setTotalLiquidityUsd(std::string  total_liquidity_usd)
{
	this->total_liquidity_usd = total_liquidity_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getActiveLiquidity()
{
	return active_liquidity;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setActiveLiquidity(std::string  active_liquidity)
{
	this->active_liquidity = active_liquidity;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getActiveLiquidityUsd()
{
	return active_liquidity_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setActiveLiquidityUsd(std::string  active_liquidity_usd)
{
	this->active_liquidity_usd = active_liquidity_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getUncollectedProtocolSideTokenAmounts()
{
	return uncollected_protocol_side_token_amounts;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setUncollectedProtocolSideTokenAmounts(std::list <std::string> uncollected_protocol_side_token_amounts)
{
	this->uncollected_protocol_side_token_amounts = uncollected_protocol_side_token_amounts;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getUncollectedProtocolSideValuesUsd()
{
	return uncollected_protocol_side_values_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setUncollectedProtocolSideValuesUsd(std::list <std::string> uncollected_protocol_side_values_usd)
{
	this->uncollected_protocol_side_values_usd = uncollected_protocol_side_values_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getUncollectedSupplySideTokenAmounts()
{
	return uncollected_supply_side_token_amounts;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setUncollectedSupplySideTokenAmounts(std::list <std::string> uncollected_supply_side_token_amounts)
{
	this->uncollected_supply_side_token_amounts = uncollected_supply_side_token_amounts;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getUncollectedSupplySideValuesUsd()
{
	return uncollected_supply_side_values_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setUncollectedSupplySideValuesUsd(std::list <std::string> uncollected_supply_side_values_usd)
{
	this->uncollected_supply_side_values_usd = uncollected_supply_side_values_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeVolumeByTokenAmount()
{
	return cumulative_volume_by_token_amount;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeVolumeByTokenAmount(std::list <std::string> cumulative_volume_by_token_amount)
{
	this->cumulative_volume_by_token_amount = cumulative_volume_by_token_amount;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeVolumeByTokenUsd()
{
	return cumulative_volume_by_token_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeVolumeByTokenUsd(std::list <std::string> cumulative_volume_by_token_usd)
{
	this->cumulative_volume_by_token_usd = cumulative_volume_by_token_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getInputTokenBalances()
{
	return input_token_balances;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setInputTokenBalances(std::list <std::string> input_token_balances)
{
	this->input_token_balances = input_token_balances;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getInputTokenBalancesUsd()
{
	return input_token_balances_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setInputTokenBalancesUsd(std::list <std::string> input_token_balances_usd)
{
	this->input_token_balances_usd = input_token_balances_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getInputTokenWeights()
{
	return input_token_weights;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setInputTokenWeights(std::list <std::string> input_token_weights)
{
	this->input_token_weights = input_token_weights;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getStakedOutputTokenAmount()
{
	return staked_output_token_amount;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setStakedOutputTokenAmount(std::string  staked_output_token_amount)
{
	this->staked_output_token_amount = staked_output_token_amount;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getRewardTokenEmissionsAmount()
{
	return reward_token_emissions_amount;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setRewardTokenEmissionsAmount(std::list <std::string> reward_token_emissions_amount)
{
	this->reward_token_emissions_amount = reward_token_emissions_amount;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getRewardTokenEmissionsUsd()
{
	return reward_token_emissions_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setRewardTokenEmissionsUsd(std::list <std::string> reward_token_emissions_usd)
{
	this->reward_token_emissions_usd = reward_token_emissions_usd;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeDepositCount()
{
	return cumulative_deposit_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeDepositCount(int  cumulative_deposit_count)
{
	this->cumulative_deposit_count = cumulative_deposit_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeWithdrawCount()
{
	return cumulative_withdraw_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeWithdrawCount(int  cumulative_withdraw_count)
{
	this->cumulative_withdraw_count = cumulative_withdraw_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getCumulativeSwapCount()
{
	return cumulative_swap_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setCumulativeSwapCount(int  cumulative_swap_count)
{
	this->cumulative_swap_count = cumulative_swap_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getPositionCount()
{
	return position_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setPositionCount(int  position_count)
{
	this->position_count = position_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getOpenPositionCount()
{
	return open_position_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setOpenPositionCount(int  open_position_count)
{
	this->open_position_count = open_position_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getClosedPositionCount()
{
	return closed_position_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setClosedPositionCount(int  closed_position_count)
{
	this->closed_position_count = closed_position_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getLastSnapshotDayId()
{
	return last_snapshot_day_id;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setLastSnapshotDayId(int  last_snapshot_day_id)
{
	this->last_snapshot_day_id = last_snapshot_day_id;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getLastSnapshotHourId()
{
	return last_snapshot_hour_id;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setLastSnapshotHourId(int  last_snapshot_hour_id)
{
	this->last_snapshot_hour_id = last_snapshot_hour_id;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getLastUpdateTimestamp()
{
	return last_update_timestamp;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setLastUpdateTimestamp(std::string  last_update_timestamp)
{
	this->last_update_timestamp = last_update_timestamp;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getLastUpdateBlockNumber()
{
	return last_update_block_number;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setLastUpdateBlockNumber(std::string  last_update_block_number)
{
	this->last_update_block_number = last_update_block_number;
}

double
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::getEvaluatedAsk()
{
	return evaluated_ask;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO::setEvaluatedAsk(double  evaluated_ask)
{
