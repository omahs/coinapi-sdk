...
PANCAKESWAP_V3_ETHEREUM.DepositDTO::PANCAKESWAP_V3_ETHEREUM.DepositDTO()
{
	//__init();
}
...
void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::fromJson(char* jsonStr)
{
...
PANCAKESWAP_V3_ETHEREUM.DepositDTO::PANCAKESWAP_V3_ETHEREUM.DepositDTO(char* json)
{
	this->fromJson(json);
}

char*
PANCAKESWAP_V3_ETHEREUM.DepositDTO::toJson()
{
...
std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getEntryTime()
{
	return entry_time;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getRecvTime()
{
	return recv_time;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getBlockNumber()
{
	return block_number;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

int
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getBlock()
{
	return block_;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setBlock(int  block_)
{
	this->block_ = block_;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getId()
{
	return id;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getHash()
{
	return hash;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setHash(std::string  hash)
{
	this->hash = hash;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getNonce()
{
	return nonce;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setNonce(std::string  nonce)
{
	this->nonce = nonce;
}

int
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getLogIndex()
{
	return log_index;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setLogIndex(int  log_index)
{
	this->log_index = log_index;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getGasLimit()
{
	return gas_limit;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setGasLimit(std::string  gas_limit)
{
	this->gas_limit = gas_limit;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getGasUsed()
{
	return gas_used;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setGasUsed(std::string  gas_used)
{
	this->gas_used = gas_used;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getGasPrice()
{
	return gas_price;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setGasPrice(std::string  gas_price)
{
	this->gas_price = gas_price;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getProtocol()
{
	return protocol;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getAccount()
{
	return account;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setAccount(std::string  account)
{
	this->account = account;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getPosition()
{
	return position;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setPosition(std::string  position)
{
	this->position = position;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getPool()
{
	return pool;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getTickLower()
{
	return tick_lower;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setTickLower(std::string  tick_lower)
{
	this->tick_lower = tick_lower;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getTickUpper()
{
	return tick_upper;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setTickUpper(std::string  tick_upper)
{
	this->tick_upper = tick_upper;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getTimestamp()
{
	return timestamp;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getLiquidity()
{
	return liquidity;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::list<std::string>
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getInputTokens()
{
	return input_tokens;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setInputTokens(std::list <std::string> input_tokens)
{
	this->input_tokens = input_tokens;
}

std::list<std::string>
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getInputTokenAmounts()
{
	return input_token_amounts;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setInputTokenAmounts(std::list <std::string> input_token_amounts)
{
	this->input_token_amounts = input_token_amounts;
}

std::list<std::string>
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getReserveAmounts()
{
	return reserve_amounts;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setReserveAmounts(std::list <std::string> reserve_amounts)
{
	this->reserve_amounts = reserve_amounts;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getAmountUsd()
{
	return amount_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setAmountUsd(std::string  amount_usd)
{
	this->amount_usd = amount_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DepositDTO::getBlockRange()
{
	return block_range;
}

void
PANCAKESWAP_V3_ETHEREUM.DepositDTO::setBlockRange(std::string  block_range)
{
