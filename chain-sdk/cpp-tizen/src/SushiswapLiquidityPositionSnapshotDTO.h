/*
 * Sushiswap.LiquidityPositionSnapshotDTO.h
 *
 * This entity is used to store data about a user&#39;s liquidity position over time. This information, along with information from the pair itself can be used to provide position sizes, token deposits, and more. It gets created and never updated.
 */

#ifndef _Sushiswap.LiquidityPositionSnapshotDTO_H_
#define _Sushiswap.LiquidityPositionSnapshotDTO_H_
...
class Sushiswap.LiquidityPositionSnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	Sushiswap.LiquidityPositionSnapshotDTO();
	Sushiswap.LiquidityPositionSnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~Sushiswap.LiquidityPositionSnapshotDTO();
	...
	/*! \brief Get Block in which snapshot has been created.
	 */
	int getBlock();

	/*! \brief Set Block in which snapshot has been created.
	 */
	...
	/*! \brief Get Snapshot of token0 price in USD.
	 */
	std::string getToken0PriceUsd();

	/*! \brief Set Snapshot of token0 price in USD.
	 */
...
#endif /* _Sushiswap.LiquidityPositionSnapshotDTO_H_ */
