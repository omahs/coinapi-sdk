/*
 * UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO.h
 *
 * Daily financial metrics for Uniswap V2.
 */

#ifndef _UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO_H_
#define _UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO_H_
...
/*! \brief Daily financial metrics for Uniswap V2.
 *
 *  \ingroup Models
 *
 */

class UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO();
	UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO();
	...
	/*! \brief Get ll revenue generated by the protocol. e.g. 0.30% of swap fee in Sushiswap, all yield generated by Yearn.
	 */
	std::string getDailyTotalRevenueUsd();

	/*! \brief Set ll revenue generated by the protocol. e.g. 0.30% of swap fee in Sushiswap, all yield generated by Yearn.
	 */
...
#endif /* _UNISWAP_V2_ETHEREUM.FinancialsDailySnapshotDTO_H_ */
