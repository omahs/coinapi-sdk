...
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO()
{
	//__init();
}
...
void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::toJson()
{
...
std::string
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getBlockRange()
{
	return block_range;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getId()
{
	return id;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailyActiveUsers()
{
	return daily_active_users;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailyActiveUsers(int  daily_active_users)
{
	this->daily_active_users = daily_active_users;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getCumulativeUniqueUsers()
{
	return cumulative_unique_users;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setCumulativeUniqueUsers(int  cumulative_unique_users)
{
	this->cumulative_unique_users = cumulative_unique_users;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailyTransactionCount()
{
	return daily_transaction_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailyTransactionCount(int  daily_transaction_count)
{
	this->daily_transaction_count = daily_transaction_count;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailyDepositCount()
{
	return daily_deposit_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailyDepositCount(int  daily_deposit_count)
{
	this->daily_deposit_count = daily_deposit_count;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailyWithdrawCount()
{
	return daily_withdraw_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailyWithdrawCount(int  daily_withdraw_count)
{
	this->daily_withdraw_count = daily_withdraw_count;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getDailySwapCount()
{
	return daily_swap_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setDailySwapCount(int  daily_swap_count)
{
	this->daily_swap_count = daily_swap_count;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getTotalPoolCount()
{
	return total_pool_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setTotalPoolCount(int  total_pool_count)
{
	this->total_pool_count = total_pool_count;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO::setTimestamp(std::string  timestamp)
{
