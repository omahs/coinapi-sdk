/*
 * SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO.h
 *
 * 
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO();
	SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO_H_ */
