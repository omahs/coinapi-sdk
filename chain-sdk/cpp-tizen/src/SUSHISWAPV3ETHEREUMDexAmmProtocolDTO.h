/*
 * SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO.h
 *
...
#ifndef _SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO();
	SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO_H_ */
