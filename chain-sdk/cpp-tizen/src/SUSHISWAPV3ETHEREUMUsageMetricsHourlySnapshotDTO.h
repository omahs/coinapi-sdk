/*
 * SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO.h
 *
 * 
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO();
	SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO_H_ */
