/*
 * PANCAKESWAP_V3_ETHEREUM.WithdrawDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.WithdrawDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.WithdrawDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.WithdrawDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.WithdrawDTO();
	PANCAKESWAP_V3_ETHEREUM.WithdrawDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.WithdrawDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.WithdrawDTO_H_ */
