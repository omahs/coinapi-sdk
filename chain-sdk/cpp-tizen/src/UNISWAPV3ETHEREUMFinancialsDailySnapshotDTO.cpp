...
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO()
{
	//__init();
}
...
void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::toJson()
{
...
std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setRecvTime(std::string  recv_time)
{
...
std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getId()
{
	return id;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

int
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getDay()
{
	return day;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setDay(int  day)
{
	this->day = day;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getTotalLiquidityUsd()
{
	return total_liquidity_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setTotalLiquidityUsd(std::string  total_liquidity_usd)
{
	this->total_liquidity_usd = total_liquidity_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getActiveLiquidityUsd()
{
	return active_liquidity_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setActiveLiquidityUsd(std::string  active_liquidity_usd)
{
	this->active_liquidity_usd = active_liquidity_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getUncollectedProtocolSideValueUsd()
{
	return uncollected_protocol_side_value_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setUncollectedProtocolSideValueUsd(std::string  uncollected_protocol_side_value_usd)
{
	this->uncollected_protocol_side_value_usd = uncollected_protocol_side_value_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getUncollectedSupplySideValueUsd()
{
	return uncollected_supply_side_value_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setUncollectedSupplySideValueUsd(std::string  uncollected_supply_side_value_usd)
{
	this->uncollected_supply_side_value_usd = uncollected_supply_side_value_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getProtocolControlledValueUsd()
{
	return protocol_controlled_value_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setProtocolControlledValueUsd(std::string  protocol_controlled_value_usd)
{
	this->protocol_controlled_value_usd = protocol_controlled_value_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getDailyVolumeUsd()
{
	return daily_volume_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setDailyVolumeUsd(std::string  daily_volume_usd)
{
	this->daily_volume_usd = daily_volume_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getDailySupplySideRevenueUsd()
{
	return daily_supply_side_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setDailySupplySideRevenueUsd(std::string  daily_supply_side_revenue_usd)
{
	this->daily_supply_side_revenue_usd = daily_supply_side_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getDailyProtocolSideRevenueUsd()
{
	return daily_protocol_side_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setDailyProtocolSideRevenueUsd(std::string  daily_protocol_side_revenue_usd)
{
	this->daily_protocol_side_revenue_usd = daily_protocol_side_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getDailyTotalRevenueUsd()
{
	return daily_total_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setDailyTotalRevenueUsd(std::string  daily_total_revenue_usd)
{
	this->daily_total_revenue_usd = daily_total_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

std::string
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO::setTimestamp(std::string  timestamp)
{
