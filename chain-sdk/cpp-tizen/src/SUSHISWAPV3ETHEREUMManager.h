...
#include "SUSHISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.PositionDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.RewardTokenDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.SwapDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.TickDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.TickHourlySnapshotDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.TokenDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.TokenWhiteListDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.TokenWhiteListSymbolDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.UsageMetricsHourlySnapshotDTO.h"
#include "SUSHISWAP_V3_ETHEREUM.WithdrawDTO.h"
#include "Error.h"
 ...
 */
bool sUSHISWAPV3ETHEREUMAccounts (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMAccounts (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMActiveAccounts (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMActiveAccounts (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMDeposits (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMDeposits (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMDexAmmProtocols (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMDexAmmProtocols (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMFinancialsDailySnapshots (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMFinancialsDailySnapshots (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMLiquidityPoolAmounts (current)Sync(char * accessToken,
	std::string id, 
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMLiquidityPoolAmounts (current)Async(char * accessToken,
	std::string id, 
	void(* handler)(std::list<SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO>, Error, void* )
	, void* userData);
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshots (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshots (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMLiquidityPoolFees (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMLiquidityPoolFees (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshots (current)Sync(char * accessToken,
	std::string pool, 
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMLiquidityPoolHourlySnapshots (current)Async(char * accessToken,
	std::string pool, 
	void(* handler)(std::list<SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO>, Error, void* )
	, void* userData);
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMPositionSnapshots (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMPositionSnapshots (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMPositions (current)Sync(char * accessToken,
	std::string pool, 
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMPositions (current)Async(char * accessToken,
	std::string pool, 
	void(* handler)(std::list<SUSHISWAP_V3_ETHEREUM.PositionDTO>, Error, void* )
	, void* userData);
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMRewardTokens (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMRewardTokens (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTickDailySnapshots (current)Sync(char * accessToken,
	std::string pool, 
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTickDailySnapshots (current)Async(char * accessToken,
	std::string pool, 
	void(* handler)(std::list<SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO>, Error, void* )
	, void* userData);
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTickHourlySnapshots (current)Sync(char * accessToken,
	std::string pool, 
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTickHourlySnapshots (current)Async(char * accessToken,
	std::string pool, 
	void(* handler)(std::list<SUSHISWAP_V3_ETHEREUM.TickHourlySnapshotDTO>, Error, void* )
	, void* userData);
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTicks (current)Sync(char * accessToken,
	std::string pool, 
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTicks (current)Async(char * accessToken,
	std::string pool, 
	void(* handler)(std::list<SUSHISWAP_V3_ETHEREUM.TickDTO>, Error, void* )
	, void* userData);
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTokenWhiteListSymbols (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTokenWhiteListSymbols (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTokenWhiteLists (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMTokenWhiteLists (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshots (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMUsageMetricsDailySnapshots (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshots (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMUsageMetricsHourlySnapshots (current)Async(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMWithdraws (current)Sync(char * accessToken,
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool sUSHISWAPV3ETHEREUMWithdraws (current)Async(char * accessToken,
