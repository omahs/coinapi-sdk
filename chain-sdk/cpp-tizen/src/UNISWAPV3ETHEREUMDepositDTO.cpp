...
UNISWAP_V3_ETHEREUM.DepositDTO::UNISWAP_V3_ETHEREUM.DepositDTO()
{
	//__init();
}
...
void
UNISWAP_V3_ETHEREUM.DepositDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V3_ETHEREUM.DepositDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V3_ETHEREUM.DepositDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V3_ETHEREUM.DepositDTO::UNISWAP_V3_ETHEREUM.DepositDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V3_ETHEREUM.DepositDTO::toJson()
{
...
std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V3_ETHEREUM.DepositDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

int
UNISWAP_V3_ETHEREUM.DepositDTO::getBlock()
{
	return block_;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setBlock(int  block_)
{
	this->block_ = block_;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getId()
{
	return id;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getHash()
{
	return hash;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setHash(std::string  hash)
{
	this->hash = hash;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getNonce()
{
	return nonce;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setNonce(std::string  nonce)
{
	this->nonce = nonce;
}

int
UNISWAP_V3_ETHEREUM.DepositDTO::getLogIndex()
{
	return log_index;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setLogIndex(int  log_index)
{
	this->log_index = log_index;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getGasLimit()
{
	return gas_limit;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setGasLimit(std::string  gas_limit)
{
	this->gas_limit = gas_limit;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getGasUsed()
{
	return gas_used;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setGasUsed(std::string  gas_used)
{
	this->gas_used = gas_used;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getGasPrice()
{
	return gas_price;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setGasPrice(std::string  gas_price)
{
	this->gas_price = gas_price;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getAccount()
{
	return account;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setAccount(std::string  account)
{
	this->account = account;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getPosition()
{
	return position;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setPosition(std::string  position)
{
	this->position = position;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getPool()
{
	return pool;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getTickLower()
{
	return tick_lower;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setTickLower(std::string  tick_lower)
{
	this->tick_lower = tick_lower;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getTickUpper()
{
	return tick_upper;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setTickUpper(std::string  tick_upper)
{
	this->tick_upper = tick_upper;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getLiquidity()
{
	return liquidity;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.DepositDTO::getInputTokens()
{
	return input_tokens;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setInputTokens(std::list <std::string> input_tokens)
{
	this->input_tokens = input_tokens;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.DepositDTO::getInputTokenAmounts()
{
	return input_token_amounts;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setInputTokenAmounts(std::list <std::string> input_token_amounts)
{
	this->input_token_amounts = input_token_amounts;
}

std::list<std::string>
UNISWAP_V3_ETHEREUM.DepositDTO::getReserveAmounts()
{
	return reserve_amounts;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setReserveAmounts(std::list <std::string> reserve_amounts)
{
	this->reserve_amounts = reserve_amounts;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getAmountUsd()
{
	return amount_usd;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setAmountUsd(std::string  amount_usd)
{
	this->amount_usd = amount_usd;
}

std::string
UNISWAP_V3_ETHEREUM.DepositDTO::getBlockRange()
{
	return block_range;
}

void
UNISWAP_V3_ETHEREUM.DepositDTO::setBlockRange(std::string  block_range)
{
