/*
 * UNISWAP_V3_ETHEREUM.TokenWhiteListDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V3_ETHEREUM.TokenWhiteListDTO_H_
#define _UNISWAP_V3_ETHEREUM.TokenWhiteListDTO_H_
...
class UNISWAP_V3_ETHEREUM.TokenWhiteListDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.TokenWhiteListDTO();
	UNISWAP_V3_ETHEREUM.TokenWhiteListDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.TokenWhiteListDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.TokenWhiteListDTO_H_ */
