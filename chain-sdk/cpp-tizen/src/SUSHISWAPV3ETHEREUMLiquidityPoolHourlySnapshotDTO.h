/*
 * SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO.h
 *
 * 
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO();
	SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_ */
