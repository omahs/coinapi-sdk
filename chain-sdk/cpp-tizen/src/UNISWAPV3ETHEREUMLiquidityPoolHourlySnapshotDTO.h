/*
 * UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_
#define _UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_
...
class UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO();
	UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.LiquidityPoolHourlySnapshotDTO_H_ */
