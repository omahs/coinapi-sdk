/*
 * SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO.h
 *
 * 
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO();
	SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO_H_ */
