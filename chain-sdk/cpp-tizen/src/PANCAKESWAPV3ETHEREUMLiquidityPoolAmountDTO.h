/*
 * PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO();
	PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolAmountDTO_H_ */
