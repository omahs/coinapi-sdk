/*
 * UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO_H_
#define _UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO_H_
...
class UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO();
	UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO_H_ */
