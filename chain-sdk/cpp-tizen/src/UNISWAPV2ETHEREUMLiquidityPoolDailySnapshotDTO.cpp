...
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO()
{
	//__init();
}
...
void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::toJson()
{
...
std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getBlockRange()
{
	return block_range;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getId()
{
	return id;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getPool()
{
	return pool;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setTimestamp(std::string  timestamp)
{
	this->timestamp = timestamp;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailySupplySideRevenueUsd()
{
	return daily_supply_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailySupplySideRevenueUsd(std::string  daily_supply_side_revenue_usd)
{
	this->daily_supply_side_revenue_usd = daily_supply_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyProtocolSideRevenueUsd()
{
	return daily_protocol_side_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyProtocolSideRevenueUsd(std::string  daily_protocol_side_revenue_usd)
{
	this->daily_protocol_side_revenue_usd = daily_protocol_side_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyTotalRevenueUsd()
{
	return daily_total_revenue_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyTotalRevenueUsd(std::string  daily_total_revenue_usd)
{
	this->daily_total_revenue_usd = daily_total_revenue_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyVolumeUsd()
{
	return daily_volume_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyVolumeUsd(std::string  daily_volume_usd)
{
	this->daily_volume_usd = daily_volume_usd;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyVolumeByTokenAmount()
{
	return daily_volume_by_token_amount;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyVolumeByTokenAmount(std::list <std::string> daily_volume_by_token_amount)
{
	this->daily_volume_by_token_amount = daily_volume_by_token_amount;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyVolumeByTokenUsd()
{
	return daily_volume_by_token_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyVolumeByTokenUsd(std::list <std::string> daily_volume_by_token_usd)
{
	this->daily_volume_by_token_usd = daily_volume_by_token_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getInputTokenBalances()
{
	return input_token_balances;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setInputTokenBalances(std::list <std::string> input_token_balances)
{
	this->input_token_balances = input_token_balances;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getInputTokenWeights()
{
	return input_token_weights;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setInputTokenWeights(std::list <std::string> input_token_weights)
{
	this->input_token_weights = input_token_weights;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getOutputTokenSupply()
{
	return output_token_supply;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setOutputTokenSupply(std::string  output_token_supply)
{
	this->output_token_supply = output_token_supply;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getOutputTokenPriceUsd()
{
	return output_token_price_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setOutputTokenPriceUsd(std::string  output_token_price_usd)
{
	this->output_token_price_usd = output_token_price_usd;
}

std::string
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getStakedOutputTokenAmount()
{
	return staked_output_token_amount;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setStakedOutputTokenAmount(std::string  staked_output_token_amount)
{
	this->staked_output_token_amount = staked_output_token_amount;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getRewardTokenEmissionsAmount()
{
	return reward_token_emissions_amount;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setRewardTokenEmissionsAmount(std::list <std::string> reward_token_emissions_amount)
{
	this->reward_token_emissions_amount = reward_token_emissions_amount;
}

std::list<std::string>
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::getRewardTokenEmissionsUsd()
{
	return reward_token_emissions_usd;
}

void
UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO::setRewardTokenEmissionsUsd(std::list <std::string> reward_token_emissions_usd)
{
