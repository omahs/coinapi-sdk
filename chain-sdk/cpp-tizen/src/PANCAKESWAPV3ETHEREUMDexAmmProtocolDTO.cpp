...
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO()
{
	//__init();
}
...
void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::fromJson(char* jsonStr)
{
...
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO(char* json)
{
	this->fromJson(json);
}

char*
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::toJson()
{
...
std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getEntryTime()
{
	return entry_time;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getRecvTime()
{
	return recv_time;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getBlockNumber()
{
	return block_number;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getBlockRange()
{
	return block_range;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getId()
{
	return id;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getName()
{
	return name;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setName(std::string  name)
{
	this->name = name;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getSlug()
{
	return slug;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setSlug(std::string  slug)
{
	this->slug = slug;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getSchemaVersion()
{
	return schema_version;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setSchemaVersion(std::string  schema_version)
{
	this->schema_version = schema_version;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getSubgraphVersion()
{
	return subgraph_version;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setSubgraphVersion(std::string  subgraph_version)
{
	this->subgraph_version = subgraph_version;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getMethodologyVersion()
{
	return methodology_version;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setMethodologyVersion(std::string  methodology_version)
{
	this->methodology_version = methodology_version;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getTotalLiquidityUsd()
{
	return total_liquidity_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setTotalLiquidityUsd(std::string  total_liquidity_usd)
{
	this->total_liquidity_usd = total_liquidity_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getActiveLiquidityUsd()
{
	return active_liquidity_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setActiveLiquidityUsd(std::string  active_liquidity_usd)
{
	this->active_liquidity_usd = active_liquidity_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getUncollectedProtocolSideValueUsd()
{
	return uncollected_protocol_side_value_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setUncollectedProtocolSideValueUsd(std::string  uncollected_protocol_side_value_usd)
{
	this->uncollected_protocol_side_value_usd = uncollected_protocol_side_value_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getUncollectedSupplySideValueUsd()
{
	return uncollected_supply_side_value_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setUncollectedSupplySideValueUsd(std::string  uncollected_supply_side_value_usd)
{
	this->uncollected_supply_side_value_usd = uncollected_supply_side_value_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getProtocolControlledValueUsd()
{
	return protocol_controlled_value_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setProtocolControlledValueUsd(std::string  protocol_controlled_value_usd)
{
	this->protocol_controlled_value_usd = protocol_controlled_value_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

int
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getCumulativeUniqueUsers()
{
	return cumulative_unique_users;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setCumulativeUniqueUsers(int  cumulative_unique_users)
{
	this->cumulative_unique_users = cumulative_unique_users;
}

int
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getCumulativeUniqueLPs()
{
	return cumulative_unique_l_ps;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setCumulativeUniqueLPs(int  cumulative_unique_l_ps)
{
	this->cumulative_unique_l_ps = cumulative_unique_l_ps;
}

int
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getCumulativeUniqueTraders()
{
	return cumulative_unique_traders;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setCumulativeUniqueTraders(int  cumulative_unique_traders)
{
	this->cumulative_unique_traders = cumulative_unique_traders;
}

int
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getTotalPoolCount()
{
	return total_pool_count;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setTotalPoolCount(int  total_pool_count)
{
	this->total_pool_count = total_pool_count;
}

int
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getOpenPositionCount()
{
	return open_position_count;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setOpenPositionCount(int  open_position_count)
{
	this->open_position_count = open_position_count;
}

int
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getCumulativePositionCount()
{
	return cumulative_position_count;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setCumulativePositionCount(int  cumulative_position_count)
{
	this->cumulative_position_count = cumulative_position_count;
}

int
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getLastSnapshotDayId()
{
	return last_snapshot_day_id;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setLastSnapshotDayId(int  last_snapshot_day_id)
{
	this->last_snapshot_day_id = last_snapshot_day_id;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getLastUpdateTimestamp()
{
	return last_update_timestamp;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setLastUpdateTimestamp(std::string  last_update_timestamp)
{
	this->last_update_timestamp = last_update_timestamp;
}

std::string
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getLastUpdateBlockNumber()
{
	return last_update_block_number;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setLastUpdateBlockNumber(std::string  last_update_block_number)
{
	this->last_update_block_number = last_update_block_number;
}

bool
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::getRegenesis()
{
	return regenesis;
}

void
PANCAKESWAP_V3_ETHEREUM.DexAmmProtocolDTO::setRegenesis(bool  regenesis)
{
