/*
 * UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO_H_
#define _UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO_H_
...
class UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO();
	UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO();
	...
	/*! \brief Get Amount of input tokens in the pool. The ordering is the same as the pool's 'inputTokens' field.
	 */
	std::list<std::string> getInputTokenBalances();

	/*! \brief Set Amount of input tokens in the pool. The ordering is the same as the pool's 'inputTokens' field.
	 */
...
#endif /* _UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO_H_ */
