/*
 * UNISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO_H_
#define _UNISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO_H_
...
class UNISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO();
	UNISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.LiquidityPoolFeeDTO_H_ */
