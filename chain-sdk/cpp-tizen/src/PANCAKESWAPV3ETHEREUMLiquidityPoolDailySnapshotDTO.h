/*
 * PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO.h
 *
 * Represents a liquidity pool daily snapshot for PancakeSwap V3.
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_
...
/*! \brief Represents a liquidity pool daily snapshot for PancakeSwap V3.
 *
 *  \ingroup Models
 *
 */

class PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO();
	PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_ */
