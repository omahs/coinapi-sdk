/*
 * UNISWAP_V3_ETHEREUM.PositionDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V3_ETHEREUM.PositionDTO_H_
#define _UNISWAP_V3_ETHEREUM.PositionDTO_H_
...
class UNISWAP_V3_ETHEREUM.PositionDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.PositionDTO();
	UNISWAP_V3_ETHEREUM.PositionDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.PositionDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.PositionDTO_H_ */
