...
UNISWAP_V2_ETHEREUM.TokenDTO::UNISWAP_V2_ETHEREUM.TokenDTO()
{
	//__init();
}
...
void
UNISWAP_V2_ETHEREUM.TokenDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V2_ETHEREUM.TokenDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V2_ETHEREUM.TokenDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V2_ETHEREUM.TokenDTO::UNISWAP_V2_ETHEREUM.TokenDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V2_ETHEREUM.TokenDTO::toJson()
{
...
std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V2_ETHEREUM.TokenDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

long long
UNISWAP_V2_ETHEREUM.TokenDTO::getVid()
{
	return vid;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setVid(long long  vid)
{
	this->vid = vid;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getId()
{
	return id;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getName()
{
	return name;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setName(std::string  name)
{
	this->name = name;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getSymbol()
{
	return symbol;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setSymbol(std::string  symbol)
{
	this->symbol = symbol;
}

int
UNISWAP_V2_ETHEREUM.TokenDTO::getDecimals()
{
	return decimals;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setDecimals(int  decimals)
{
	this->decimals = decimals;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getLastPriceUsd()
{
	return last_price_usd;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setLastPriceUsd(std::string  last_price_usd)
{
	this->last_price_usd = last_price_usd;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getLastPriceBlockNumber()
{
	return last_price_block_number;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setLastPriceBlockNumber(std::string  last_price_block_number)
{
	this->last_price_block_number = last_price_block_number;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getTotalSupply()
{
	return total_supply;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setTotalSupply(std::string  total_supply)
{
	this->total_supply = total_supply;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

int
UNISWAP_V2_ETHEREUM.TokenDTO::getLargePriceChangeBuffer()
{
	return large_price_change_buffer;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setLargePriceChangeBuffer(int  large_price_change_buffer)
{
	this->large_price_change_buffer = large_price_change_buffer;
}

int
UNISWAP_V2_ETHEREUM.TokenDTO::getLargeTvlImpactBuffer()
{
	return large_tvl_impact_buffer;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setLargeTvlImpactBuffer(int  large_tvl_impact_buffer)
{
	this->large_tvl_impact_buffer = large_tvl_impact_buffer;
}

std::string
UNISWAP_V2_ETHEREUM.TokenDTO::getTokenSymbol()
{
	return token_symbol;
}

void
UNISWAP_V2_ETHEREUM.TokenDTO::setTokenSymbol(std::string  token_symbol)
{
