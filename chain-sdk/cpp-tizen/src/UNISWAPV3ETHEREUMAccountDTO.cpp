...
UNISWAP_V3_ETHEREUM.AccountDTO::UNISWAP_V3_ETHEREUM.AccountDTO()
{
	//__init();
}
...
void
UNISWAP_V3_ETHEREUM.AccountDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V3_ETHEREUM.AccountDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V3_ETHEREUM.AccountDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V3_ETHEREUM.AccountDTO::UNISWAP_V3_ETHEREUM.AccountDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V3_ETHEREUM.AccountDTO::toJson()
{
...
std::string
UNISWAP_V3_ETHEREUM.AccountDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V3_ETHEREUM.AccountDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V3_ETHEREUM.AccountDTO::getBlockNumber()
{
	return block_number;
}
...
std::string
UNISWAP_V3_ETHEREUM.AccountDTO::getBlockRange()
{
	return block_range;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
UNISWAP_V3_ETHEREUM.AccountDTO::getId()
{
	return id;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setId(std::string  id)
{
	this->id = id;
}

int
UNISWAP_V3_ETHEREUM.AccountDTO::getPositionCount()
{
	return position_count;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setPositionCount(int  position_count)
{
	this->position_count = position_count;
}

int
UNISWAP_V3_ETHEREUM.AccountDTO::getOpenPositionCount()
{
	return open_position_count;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setOpenPositionCount(int  open_position_count)
{
	this->open_position_count = open_position_count;
}

int
UNISWAP_V3_ETHEREUM.AccountDTO::getClosedPositionCount()
{
	return closed_position_count;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setClosedPositionCount(int  closed_position_count)
{
	this->closed_position_count = closed_position_count;
}

int
UNISWAP_V3_ETHEREUM.AccountDTO::getDepositCount()
{
	return deposit_count;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setDepositCount(int  deposit_count)
{
	this->deposit_count = deposit_count;
}

int
UNISWAP_V3_ETHEREUM.AccountDTO::getWithdrawCount()
{
	return withdraw_count;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setWithdrawCount(int  withdraw_count)
{
	this->withdraw_count = withdraw_count;
}

int
UNISWAP_V3_ETHEREUM.AccountDTO::getSwapCount()
{
	return swap_count;
}

void
UNISWAP_V3_ETHEREUM.AccountDTO::setSwapCount(int  swap_count)
{
