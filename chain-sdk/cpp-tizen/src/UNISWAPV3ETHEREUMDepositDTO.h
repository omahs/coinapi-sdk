/*
 * UNISWAP_V3_ETHEREUM.DepositDTO.h
 *
 * Entity represents a user action in the protocol involving the addition of funds to a liquidity pool.
 */

#ifndef _UNISWAP_V3_ETHEREUM.DepositDTO_H_
#define _UNISWAP_V3_ETHEREUM.DepositDTO_H_
...
class UNISWAP_V3_ETHEREUM.DepositDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.DepositDTO();
	UNISWAP_V3_ETHEREUM.DepositDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.DepositDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.DepositDTO_H_ */
