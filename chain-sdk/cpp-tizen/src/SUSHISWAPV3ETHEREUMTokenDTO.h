/*
 * SUSHISWAP_V3_ETHEREUM.TokenDTO.h
 *
 * Stores aggregated information for a specific token across all pairs that token is included in.
 */

#ifndef _SUSHISWAP_V3_ETHEREUM.TokenDTO_H_
#define _SUSHISWAP_V3_ETHEREUM.TokenDTO_H_
...
class SUSHISWAP_V3_ETHEREUM.TokenDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	SUSHISWAP_V3_ETHEREUM.TokenDTO();
	SUSHISWAP_V3_ETHEREUM.TokenDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~SUSHISWAP_V3_ETHEREUM.TokenDTO();
...
#endif /* _SUSHISWAP_V3_ETHEREUM.TokenDTO_H_ */
