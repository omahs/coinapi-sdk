/*
 * UNISWAP_V3_ETHEREUM.ActiveAccountDTO.h
 *
 * Entity for calculating daily/hourly active users.
 */

#ifndef _UNISWAP_V3_ETHEREUM.ActiveAccountDTO_H_
#define _UNISWAP_V3_ETHEREUM.ActiveAccountDTO_H_
...
class UNISWAP_V3_ETHEREUM.ActiveAccountDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.ActiveAccountDTO();
	UNISWAP_V3_ETHEREUM.ActiveAccountDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.ActiveAccountDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.ActiveAccountDTO_H_ */
