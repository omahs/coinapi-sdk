...
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO()
{
	//__init();
}
...
void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::fromJson(char* jsonStr)
{
...
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::toJson()
{
...
std::string
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getBlockRange()
{
	return block_range;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setBlockRange(std::string  block_range)
{
	this->block_range = block_range;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getId()
{
	return id;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getProtocol()
{
	return protocol;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlyActiveUsers()
{
	return hourly_active_users;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlyActiveUsers(int  hourly_active_users)
{
	this->hourly_active_users = hourly_active_users;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getCumulativeUniqueUsers()
{
	return cumulative_unique_users;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setCumulativeUniqueUsers(int  cumulative_unique_users)
{
	this->cumulative_unique_users = cumulative_unique_users;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlyTransactionCount()
{
	return hourly_transaction_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlyTransactionCount(int  hourly_transaction_count)
{
	this->hourly_transaction_count = hourly_transaction_count;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlyDepositCount()
{
	return hourly_deposit_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlyDepositCount(int  hourly_deposit_count)
{
	this->hourly_deposit_count = hourly_deposit_count;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlyWithdrawCount()
{
	return hourly_withdraw_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlyWithdrawCount(int  hourly_withdraw_count)
{
	this->hourly_withdraw_count = hourly_withdraw_count;
}

int
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getHourlySwapCount()
{
	return hourly_swap_count;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setHourlySwapCount(int  hourly_swap_count)
{
	this->hourly_swap_count = hourly_swap_count;
}

std::string
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
UNISWAP_V2_ETHEREUM.UsageMetricsHourlySnapshotDTO::setTimestamp(std::string  timestamp)
{
