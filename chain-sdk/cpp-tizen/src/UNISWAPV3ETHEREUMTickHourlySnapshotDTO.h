/*
 * UNISWAP_V3_ETHEREUM.TickHourlySnapshotDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V3_ETHEREUM.TickHourlySnapshotDTO_H_
#define _UNISWAP_V3_ETHEREUM.TickHourlySnapshotDTO_H_
...
class UNISWAP_V3_ETHEREUM.TickHourlySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V3_ETHEREUM.TickHourlySnapshotDTO();
	UNISWAP_V3_ETHEREUM.TickHourlySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V3_ETHEREUM.TickHourlySnapshotDTO();
...
#endif /* _UNISWAP_V3_ETHEREUM.TickHourlySnapshotDTO_H_ */
