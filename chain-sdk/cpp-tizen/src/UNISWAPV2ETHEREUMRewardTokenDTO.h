/*
 * UNISWAP_V2_ETHEREUM.RewardTokenDTO.h
 *
 * 
 */

#ifndef _UNISWAP_V2_ETHEREUM.RewardTokenDTO_H_
#define _UNISWAP_V2_ETHEREUM.RewardTokenDTO_H_
...
class UNISWAP_V2_ETHEREUM.RewardTokenDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V2_ETHEREUM.RewardTokenDTO();
	UNISWAP_V2_ETHEREUM.RewardTokenDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V2_ETHEREUM.RewardTokenDTO();
...
#endif /* _UNISWAP_V2_ETHEREUM.RewardTokenDTO_H_ */
