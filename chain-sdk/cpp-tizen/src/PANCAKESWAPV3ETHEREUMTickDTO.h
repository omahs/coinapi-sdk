/*
 * PANCAKESWAP_V3_ETHEREUM.TickDTO.h
 *
 * 
 */

#ifndef _PANCAKESWAP_V3_ETHEREUM.TickDTO_H_
#define _PANCAKESWAP_V3_ETHEREUM.TickDTO_H_
...
class PANCAKESWAP_V3_ETHEREUM.TickDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	PANCAKESWAP_V3_ETHEREUM.TickDTO();
	PANCAKESWAP_V3_ETHEREUM.TickDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~PANCAKESWAP_V3_ETHEREUM.TickDTO();
...
#endif /* _PANCAKESWAP_V3_ETHEREUM.TickDTO_H_ */
