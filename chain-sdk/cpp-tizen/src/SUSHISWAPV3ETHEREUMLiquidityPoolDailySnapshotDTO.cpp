...
#include "SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO.h"

using namespace std;
using namespace Tizen::ArtikCloud;

SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO()
{
	//__init();
}
...
void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::fromJson(char* jsonStr)
{
...
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::toJson()
{
...
std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getBlock()
{
	return block_;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setBlock(int  block_)
{
	this->block_ = block_;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getId()
{
	return id;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDay()
{
	return day;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDay(int  day)
{
	this->day = day;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getProtocol()
{
	return protocol;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setProtocol(std::string  protocol)
{
	this->protocol = protocol;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getPool()
{
	return pool;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getTick()
{
	return tick;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setTick(std::string  tick)
{
	this->tick = tick;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getTotalValueLockedUsd()
{
	return total_value_locked_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setTotalValueLockedUsd(std::string  total_value_locked_usd)
{
	this->total_value_locked_usd = total_value_locked_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getTotalLiquidity()
{
	return total_liquidity;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setTotalLiquidity(std::string  total_liquidity)
{
	this->total_liquidity = total_liquidity;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getTotalLiquidityUsd()
{
	return total_liquidity_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setTotalLiquidityUsd(std::string  total_liquidity_usd)
{
	this->total_liquidity_usd = total_liquidity_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getActiveLiquidity()
{
	return active_liquidity;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setActiveLiquidity(std::string  active_liquidity)
{
	this->active_liquidity = active_liquidity;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getActiveLiquidityUsd()
{
	return active_liquidity_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setActiveLiquidityUsd(std::string  active_liquidity_usd)
{
	this->active_liquidity_usd = active_liquidity_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getUncollectedProtocolSideTokenAmounts()
{
	return uncollected_protocol_side_token_amounts;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setUncollectedProtocolSideTokenAmounts(std::list <std::string> uncollected_protocol_side_token_amounts)
{
	this->uncollected_protocol_side_token_amounts = uncollected_protocol_side_token_amounts;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getUncollectedProtocolSideValuesUsd()
{
	return uncollected_protocol_side_values_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setUncollectedProtocolSideValuesUsd(std::list <std::string> uncollected_protocol_side_values_usd)
{
	this->uncollected_protocol_side_values_usd = uncollected_protocol_side_values_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getUncollectedSupplySideTokenAmounts()
{
	return uncollected_supply_side_token_amounts;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setUncollectedSupplySideTokenAmounts(std::list <std::string> uncollected_supply_side_token_amounts)
{
	this->uncollected_supply_side_token_amounts = uncollected_supply_side_token_amounts;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getUncollectedSupplySideValuesUsd()
{
	return uncollected_supply_side_values_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setUncollectedSupplySideValuesUsd(std::list <std::string> uncollected_supply_side_values_usd)
{
	this->uncollected_supply_side_values_usd = uncollected_supply_side_values_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeSupplySideRevenueUsd()
{
	return cumulative_supply_side_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeSupplySideRevenueUsd(std::string  cumulative_supply_side_revenue_usd)
{
	this->cumulative_supply_side_revenue_usd = cumulative_supply_side_revenue_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailySupplySideRevenueUsd()
{
	return daily_supply_side_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailySupplySideRevenueUsd(std::string  daily_supply_side_revenue_usd)
{
	this->daily_supply_side_revenue_usd = daily_supply_side_revenue_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeProtocolSideRevenueUsd()
{
	return cumulative_protocol_side_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeProtocolSideRevenueUsd(std::string  cumulative_protocol_side_revenue_usd)
{
	this->cumulative_protocol_side_revenue_usd = cumulative_protocol_side_revenue_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyProtocolSideRevenueUsd()
{
	return daily_protocol_side_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyProtocolSideRevenueUsd(std::string  daily_protocol_side_revenue_usd)
{
	this->daily_protocol_side_revenue_usd = daily_protocol_side_revenue_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeTotalRevenueUsd()
{
	return cumulative_total_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeTotalRevenueUsd(std::string  cumulative_total_revenue_usd)
{
	this->cumulative_total_revenue_usd = cumulative_total_revenue_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyTotalRevenueUsd()
{
	return daily_total_revenue_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyTotalRevenueUsd(std::string  daily_total_revenue_usd)
{
	this->daily_total_revenue_usd = daily_total_revenue_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeVolumeUsd()
{
	return cumulative_volume_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeVolumeUsd(std::string  cumulative_volume_usd)
{
	this->cumulative_volume_usd = cumulative_volume_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyVolumeUsd()
{
	return daily_volume_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyVolumeUsd(std::string  daily_volume_usd)
{
	this->daily_volume_usd = daily_volume_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeVolumeByTokenAmount()
{
	return cumulative_volume_by_token_amount;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeVolumeByTokenAmount(std::list <std::string> cumulative_volume_by_token_amount)
{
	this->cumulative_volume_by_token_amount = cumulative_volume_by_token_amount;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyVolumeByTokenAmount()
{
	return daily_volume_by_token_amount;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyVolumeByTokenAmount(std::list <std::string> daily_volume_by_token_amount)
{
	this->daily_volume_by_token_amount = daily_volume_by_token_amount;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeVolumeByTokenUsd()
{
	return cumulative_volume_by_token_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeVolumeByTokenUsd(std::list <std::string> cumulative_volume_by_token_usd)
{
	this->cumulative_volume_by_token_usd = cumulative_volume_by_token_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyVolumeByTokenUsd()
{
	return daily_volume_by_token_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyVolumeByTokenUsd(std::list <std::string> daily_volume_by_token_usd)
{
	this->daily_volume_by_token_usd = daily_volume_by_token_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getInputTokenBalances()
{
	return input_token_balances;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setInputTokenBalances(std::list <std::string> input_token_balances)
{
	this->input_token_balances = input_token_balances;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getInputTokenBalancesUsd()
{
	return input_token_balances_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setInputTokenBalancesUsd(std::list <std::string> input_token_balances_usd)
{
	this->input_token_balances_usd = input_token_balances_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getInputTokenWeights()
{
	return input_token_weights;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setInputTokenWeights(std::list <std::string> input_token_weights)
{
	this->input_token_weights = input_token_weights;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getStakedOutputTokenAmount()
{
	return staked_output_token_amount;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setStakedOutputTokenAmount(std::string  staked_output_token_amount)
{
	this->staked_output_token_amount = staked_output_token_amount;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getRewardTokenEmissionsAmount()
{
	return reward_token_emissions_amount;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setRewardTokenEmissionsAmount(std::list <std::string> reward_token_emissions_amount)
{
	this->reward_token_emissions_amount = reward_token_emissions_amount;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getRewardTokenEmissionsUsd()
{
	return reward_token_emissions_usd;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setRewardTokenEmissionsUsd(std::list <std::string> reward_token_emissions_usd)
{
	this->reward_token_emissions_usd = reward_token_emissions_usd;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeDepositCount()
{
	return cumulative_deposit_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeDepositCount(int  cumulative_deposit_count)
{
	this->cumulative_deposit_count = cumulative_deposit_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyDepositCount()
{
	return daily_deposit_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyDepositCount(int  daily_deposit_count)
{
	this->daily_deposit_count = daily_deposit_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeWithdrawCount()
{
	return cumulative_withdraw_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeWithdrawCount(int  cumulative_withdraw_count)
{
	this->cumulative_withdraw_count = cumulative_withdraw_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailyWithdrawCount()
{
	return daily_withdraw_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailyWithdrawCount(int  daily_withdraw_count)
{
	this->daily_withdraw_count = daily_withdraw_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getCumulativeSwapCount()
{
	return cumulative_swap_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setCumulativeSwapCount(int  cumulative_swap_count)
{
	this->cumulative_swap_count = cumulative_swap_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getDailySwapCount()
{
	return daily_swap_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setDailySwapCount(int  daily_swap_count)
{
	this->daily_swap_count = daily_swap_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getPositionCount()
{
	return position_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setPositionCount(int  position_count)
{
	this->position_count = position_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getOpenPositionCount()
{
	return open_position_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setOpenPositionCount(int  open_position_count)
{
	this->open_position_count = open_position_count;
}

int
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getClosedPositionCount()
{
	return closed_position_count;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setClosedPositionCount(int  closed_position_count)
{
	this->closed_position_count = closed_position_count;
}

std::string
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO::setTimestamp(std::string  timestamp)
{
