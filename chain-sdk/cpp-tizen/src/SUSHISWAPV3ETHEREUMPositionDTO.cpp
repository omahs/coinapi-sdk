...
SUSHISWAP_V3_ETHEREUM.PositionDTO::SUSHISWAP_V3_ETHEREUM.PositionDTO()
{
	//__init();
}
...
void
SUSHISWAP_V3_ETHEREUM.PositionDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
SUSHISWAP_V3_ETHEREUM.PositionDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
SUSHISWAP_V3_ETHEREUM.PositionDTO::fromJson(char* jsonStr)
{
...
SUSHISWAP_V3_ETHEREUM.PositionDTO::SUSHISWAP_V3_ETHEREUM.PositionDTO(char* json)
{
	this->fromJson(json);
}

char*
SUSHISWAP_V3_ETHEREUM.PositionDTO::toJson()
{
...
std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getEntryTime()
{
	return entry_time;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getRecvTime()
{
	return recv_time;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
SUSHISWAP_V3_ETHEREUM.PositionDTO::getBlockNumber()
{
	return block_number;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getId()
{
	return id;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setId(std::string  id)
{
	this->id = id;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getAccount()
{
	return account;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setAccount(std::string  account)
{
	this->account = account;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getPool()
{
	return pool;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getHashOpened()
{
	return hash_opened;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setHashOpened(std::string  hash_opened)
{
	this->hash_opened = hash_opened;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getHashClosed()
{
	return hash_closed;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setHashClosed(std::string  hash_closed)
{
	this->hash_closed = hash_closed;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getBlockNumberOpened()
{
	return block_number_opened;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setBlockNumberOpened(std::string  block_number_opened)
{
	this->block_number_opened = block_number_opened;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getTimestampOpened()
{
	return timestamp_opened;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setTimestampOpened(std::string  timestamp_opened)
{
	this->timestamp_opened = timestamp_opened;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getBlockNumberClosed()
{
	return block_number_closed;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setBlockNumberClosed(std::string  block_number_closed)
{
	this->block_number_closed = block_number_closed;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getTimestampClosed()
{
	return timestamp_closed;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setTimestampClosed(std::string  timestamp_closed)
{
	this->timestamp_closed = timestamp_closed;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getTickLower()
{
	return tick_lower;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setTickLower(std::string  tick_lower)
{
	this->tick_lower = tick_lower;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getTickUpper()
{
	return tick_upper;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setTickUpper(std::string  tick_upper)
{
	this->tick_upper = tick_upper;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getLiquidityToken()
{
	return liquidity_token;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setLiquidityToken(std::string  liquidity_token)
{
	this->liquidity_token = liquidity_token;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getLiquidityTokenType()
{
	return liquidity_token_type;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setLiquidityTokenType(std::string  liquidity_token_type)
{
	this->liquidity_token_type = liquidity_token_type;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getLiquidity()
{
	return liquidity;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setLiquidity(std::string  liquidity)
{
	this->liquidity = liquidity;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getLiquidityUsd()
{
	return liquidity_usd;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setLiquidityUsd(std::string  liquidity_usd)
{
	this->liquidity_usd = liquidity_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.PositionDTO::getCumulativeDepositTokenAmounts()
{
	return cumulative_deposit_token_amounts;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setCumulativeDepositTokenAmounts(std::list <std::string> cumulative_deposit_token_amounts)
{
	this->cumulative_deposit_token_amounts = cumulative_deposit_token_amounts;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getCumulativeDepositUsd()
{
	return cumulative_deposit_usd;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setCumulativeDepositUsd(std::string  cumulative_deposit_usd)
{
	this->cumulative_deposit_usd = cumulative_deposit_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.PositionDTO::getCumulativeWithdrawTokenAmounts()
{
	return cumulative_withdraw_token_amounts;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setCumulativeWithdrawTokenAmounts(std::list <std::string> cumulative_withdraw_token_amounts)
{
	this->cumulative_withdraw_token_amounts = cumulative_withdraw_token_amounts;
}

std::string
SUSHISWAP_V3_ETHEREUM.PositionDTO::getCumulativeWithdrawUsd()
{
	return cumulative_withdraw_usd;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setCumulativeWithdrawUsd(std::string  cumulative_withdraw_usd)
{
	this->cumulative_withdraw_usd = cumulative_withdraw_usd;
}

std::list<std::string>
SUSHISWAP_V3_ETHEREUM.PositionDTO::getCumulativeRewardUsd()
{
	return cumulative_reward_usd;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setCumulativeRewardUsd(std::list <std::string> cumulative_reward_usd)
{
	this->cumulative_reward_usd = cumulative_reward_usd;
}

int
SUSHISWAP_V3_ETHEREUM.PositionDTO::getDepositCount()
{
	return deposit_count;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setDepositCount(int  deposit_count)
{
	this->deposit_count = deposit_count;
}

int
SUSHISWAP_V3_ETHEREUM.PositionDTO::getWithdrawCount()
{
	return withdraw_count;
}

void
SUSHISWAP_V3_ETHEREUM.PositionDTO::setWithdrawCount(int  withdraw_count)
{
