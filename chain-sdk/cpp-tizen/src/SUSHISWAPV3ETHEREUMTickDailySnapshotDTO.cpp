...
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO()
{
	//__init();
}
...
void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::__init()
{
	//entry_time = null;
	//recv_time = null;
	//block_number = long(0);
...
void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::__cleanup()
{
	//if(entry_time != NULL) {
	//
	//delete entry_time;
...
void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::fromJson(char* jsonStr)
{
...
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO(char* json)
{
	this->fromJson(json);
}

char*
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::toJson()
{
...
std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getEntryTime()
{
	return entry_time;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setEntryTime(std::string  entry_time)
{
	this->entry_time = entry_time;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getRecvTime()
{
	return recv_time;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setRecvTime(std::string  recv_time)
{
	this->recv_time = recv_time;
}

long long
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getBlockNumber()
{
	return block_number;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setBlockNumber(long long  block_number)
{
	this->block_number = block_number;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getId()
{
	return id;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setId(std::string  id)
{
	this->id = id;
}

int
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getDayId()
{
	return day_id;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setDayId(int  day_id)
{
	this->day_id = day_id;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getTick()
{
	return tick;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setTick(std::string  tick)
{
	this->tick = tick;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getPool()
{
	return pool;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setPool(std::string  pool)
{
	this->pool = pool;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getLiquidityGross()
{
	return liquidity_gross;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setLiquidityGross(std::string  liquidity_gross)
{
	this->liquidity_gross = liquidity_gross;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getLiquidityGrossUsd()
{
	return liquidity_gross_usd;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setLiquidityGrossUsd(std::string  liquidity_gross_usd)
{
	this->liquidity_gross_usd = liquidity_gross_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getLiquidityNet()
{
	return liquidity_net;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setLiquidityNet(std::string  liquidity_net)
{
	this->liquidity_net = liquidity_net;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getLiquidityNetUsd()
{
	return liquidity_net_usd;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setLiquidityNetUsd(std::string  liquidity_net_usd)
{
	this->liquidity_net_usd = liquidity_net_usd;
}

std::string
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::getTimestamp()
{
	return timestamp;
}

void
SUSHISWAP_V3_ETHEREUM.TickDailySnapshotDTO::setTimestamp(std::string  timestamp)
{
