/*
 * UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO.h
 *
 * Represents a liquidity pool daily snapshot for Uniswap V2.
 */

#ifndef _UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_
#define _UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_
...
/*! \brief Represents a liquidity pool daily snapshot for Uniswap V2.
 *
 *  \ingroup Models
 *
 */

class UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO : public Object {
public:
	/*! \brief Constructor.
	 */
	UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO();
	UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO(char* str);

	/*! \brief Destructor.
	 */
	virtual ~UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO();
	...
	/*! \brief Get (smart contract address of the pool)-(# of days since Unix epoch time)
	 */
	std::string getId();

	/*! \brief Set (smart contract address of the pool)-(# of days since Unix epoch time)
	 */
...
#endif /* _UNISWAP_V2_ETHEREUM.LiquidityPoolDailySnapshotDTO_H_ */
