...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV3.TokenHourDataDTO")]
    public partial class UniswapV3TokenHourDataDTO : IEquatable<UniswapV3TokenHourDataDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3TokenHourDataDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV3TokenHourDataDTO);
        }

        /// <summary>
        /// Returns true if UniswapV3TokenHourDataDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3TokenHourDataDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3TokenHourDataDTO input)
        {
            if (input == null)
            {
                return false;
