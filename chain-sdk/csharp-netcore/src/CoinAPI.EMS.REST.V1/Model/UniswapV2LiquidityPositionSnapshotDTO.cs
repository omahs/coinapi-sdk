...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.LiquidityPositionSnapshotDTO")]
    public partial class UniswapV2LiquidityPositionSnapshotDTO : IEquatable<UniswapV2LiquidityPositionSnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2LiquidityPositionSnapshotDTO" /> class.
        /// </summary>
        ...
        public UniswapV2LiquidityPositionSnapshotDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string liquidityPosition = default(string), int timestamp = default(int), int block = default(int), string user = default(string), string pair = default(string), string token0PriceUsd = default(string), string token1PriceUsd = default(string), string reserve0 = default(string), string reserve1 = default(string), string reserveUsd = default(string), string liquidityTokenTotalSupply = default(string), string liquidityTokenBalance = default(string), long vid = default(long), string blockRange = default(string))
        {
        ...
        {
            return this.Equals(input as UniswapV2LiquidityPositionSnapshotDTO);
        }

        /// <summary>
        /// Returns true if UniswapV2LiquidityPositionSnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2LiquidityPositionSnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2LiquidityPositionSnapshotDTO input)
        {
            if (input == null)
            {
                return false;
