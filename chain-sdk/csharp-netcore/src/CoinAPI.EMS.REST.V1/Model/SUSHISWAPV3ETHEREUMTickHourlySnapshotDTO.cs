...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.TickHourlySnapshotDTO")]
    public partial class SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO : IEquatable<SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO" /> class.
        /// </summary>
        ...
        public SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), int hourId = default(int), string tick = default(string), string pool = default(string), string liquidityGross = default(string), string liquidityGrossUsd = default(string), string liquidityNet = default(string), string liquidityNetUsd = default(string), string timestamp = default(string))
        {
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMTickHourlySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
