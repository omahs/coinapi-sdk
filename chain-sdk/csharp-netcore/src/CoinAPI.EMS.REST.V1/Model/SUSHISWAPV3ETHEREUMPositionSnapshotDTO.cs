...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.PositionSnapshotDTO")]
    public partial class SUSHISWAPV3ETHEREUMPositionSnapshotDTO : IEquatable<SUSHISWAPV3ETHEREUMPositionSnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMPositionSnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMPositionSnapshotDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMPositionSnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMPositionSnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMPositionSnapshotDTO input)
        {
            if (input == null)
            {
                return false;
