...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CURVE_FINANCE_ETHEREUM.FinancialsDailySnapshotDTO")]
    public partial class CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO : IEquatable<CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CURVEFINANCEETHEREUMFinancialsDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
