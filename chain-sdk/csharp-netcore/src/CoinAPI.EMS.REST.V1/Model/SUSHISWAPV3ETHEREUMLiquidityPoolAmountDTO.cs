...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.LiquidityPoolAmountDTO")]
    public partial class SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO : IEquatable<SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO" /> class.
        /// </summary>
        ...
        public SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string blockRange = default(string), string id = default(string), List<string> inputTokens = default(List<string>), List<string> inputTokenBalances = default(List<string>), List<string> tokenPrices = default(List<string>))
        {
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMLiquidityPoolAmountDTO input)
        {
            if (input == null)
            {
                return false;
