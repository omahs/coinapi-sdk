...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.WithdrawDTO")]
    public partial class PANCAKESWAPV3ETHEREUMWithdrawDTO : IEquatable<PANCAKESWAPV3ETHEREUMWithdrawDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMWithdrawDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMWithdrawDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMWithdrawDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMWithdrawDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMWithdrawDTO input)
        {
            if (input == null)
            {
                return false;
