...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V2_ETHEREUM.UsageMetricsDailySnapshotDTO")]
    public partial class UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO : IEquatable<UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV2ETHEREUMUsageMetricsDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
