...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.DepositDTO")]
    public partial class PANCAKESWAPV3ETHEREUMDepositDTO : IEquatable<PANCAKESWAPV3ETHEREUMDepositDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMDepositDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMDepositDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMDepositDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMDepositDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMDepositDTO input)
        {
            if (input == null)
            {
                return false;
