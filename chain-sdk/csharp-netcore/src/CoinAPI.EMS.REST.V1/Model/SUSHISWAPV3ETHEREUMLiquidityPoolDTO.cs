...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// Pool-level metadata.
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.LiquidityPoolDTO")]
    public partial class SUSHISWAPV3ETHEREUMLiquidityPoolDTO : IEquatable<SUSHISWAPV3ETHEREUMLiquidityPoolDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMLiquidityPoolDTO" /> class.
        /// </summary>
        /// <param name="entryTime">entryTime.</param>
        /// <param name="recvTime">recvTime.</param>
        /// <param name="blockNumber">Number of block in which entity was recorded..</param>
        /// <param name="vid">..</param>
        /// <param name="blockRange">Block range of the liquidity pool..</param>
        /// <param name="id">Smart contract address of the pool..</param>
        /// <param name="protocol">Protocol this pool belongs to..</param>
        ...
        /// <param name="rewardTokens">Additional tokens that are given as reward for position in a protocol, usually in liquidity mining programs. e.g. SUSHI in the Onsen program, MATIC for Aave Polygon, usually in liquidity mining programs. e.g. SUSHI in the Onsen program, MATIC for Aave Polygon..</param>
        ...
        /// <param name="isSingleSided">Specifies whether this pool is single-sided (e.g. Bancor, Platypus&#39;s Alternative Pool). The specifics of the implementation depends on the protocol..</param>
        /// <param name="createdTimestamp">Timestamp when the liquidity pool was created..</param>
        /// <param name="createdBlockNumber">Block number when the liquidity pool was created..</param>
        ...
        /// <param name="totalLiquidity">Sum of all active and non-active liquidity for this pool..</param>
        ...
        /// <param name="cumulativeVolumeByTokenAmount">All trade volume occurred for a specific input token, in native amount. The ordering should be the same as the pool&#39;s &#x60;inputTokens&#x60; field..</param>
        /// <param name="cumulativeVolumeByTokenUsd">All trade volume occurred for a specific input token, in USD. The ordering should be the same as the pool&#39;s &#x60;inputTokens&#x60; field..</param>
        /// <param name="cumulativeVolumeUsd">All trade volume occurred for a specific input token, in USD. The ordering should be the same as the pool&#39;s &#x60;inputTokens&#x60; field..</param>
        ...
        public SUSHISWAPV3ETHEREUMLiquidityPoolDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string blockRange = default(string), string id = default(string), string protocol = default(string), string name = default(string), string symbol = default(string), string liquidityToken = default(string), List<string> inputTokens = default(List<string>), List<string> rewardTokens = default(List<string>), List<string> fees = default(List<string>), bool isSingleSided = default(bool), string createdTimestamp = default(string), string createdBlockNumber = default(string), string tick = default(string), string totalValueLockedUsd = default(string), string totalLiquidity = default(string), string totalLiquidityUsd = default(string), string activeLiquidity = default(string), string activeLiquidityUsd = default(string), List<string> uncollectedProtocolSideTokenAmounts = default(List<string>), List<string> uncollectedProtocolSideValuesUsd = default(List<string>), List<string> uncollectedSupplySideTokenAmounts = default(List<string>), List<string> uncollectedSupplySideValuesUsd = default(List<string>), string cumulativeSupplySideRevenueUsd = default(string), string cumulativeProtocolSideRevenueUsd = default(string), string cumulativeTotalRevenueUsd = default(string), List<string> cumulativeVolumeByTokenAmount = default(List<string>), List<string> cumulativeVolumeByTokenUsd = default(List<string>), string cumulativeVolumeUsd = default(string), List<string> inputTokenBalances = default(List<string>), List<string> inputTokenBalancesUsd = default(List<string>), List<string> inputTokenWeights = default(List<string>), string stakedOutputTokenAmount = default(string), List<string> rewardTokenEmissionsAmount = default(List<string>), List<string> rewardTokenEmissionsUsd = default(List<string>), int cumulativeDepositCount = default(int), int cumulativeWithdrawCount = default(int), int cumulativeSwapCount = default(int), int positionCount = default(int), int openPositionCount = default(int), int closedPositionCount = default(int), int lastSnapshotDayId = default(int), int lastSnapshotHourId = default(int), string lastUpdateTimestamp = default(string), string lastUpdateBlockNumber = default(string))
        {
        ...
        /// </summary>
        /// <value>Block range of the liquidity pool.</value>
        ...
        /// </summary>
        /// <value>Protocol this pool belongs to.</value>
        ...
        /// </summary>
        /// <value>Additional tokens that are given as reward for position in a protocol, usually in liquidity mining programs. e.g. SUSHI in the Onsen program, MATIC for Aave Polygon, usually in liquidity mining programs. e.g. SUSHI in the Onsen program, MATIC for Aave Polygon.</value>
        ...
        /// </summary>
        /// <value>Specifies whether this pool is single-sided (e.g. Bancor, Platypus&#39;s Alternative Pool). The specifics of the implementation depends on the protocol.</value>
        ...
        /// </summary>
        /// <value>Timestamp when the liquidity pool was created.</value>
        ...
        /// </summary>
        /// <value>Block number when the liquidity pool was created.</value>
        ...
        /// </summary>
        /// <value>Sum of all active and non-active liquidity for this pool.</value>
        ...
        /// </summary>
        /// <value>All trade volume occurred for a specific input token, in native amount. The ordering should be the same as the pool&#39;s &#x60;inputTokens&#x60; field.</value>
        ...
        /// </summary>
        /// <value>All trade volume occurred for a specific input token, in USD. The ordering should be the same as the pool&#39;s &#x60;inputTokens&#x60; field.</value>
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMLiquidityPoolDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMLiquidityPoolDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMLiquidityPoolDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMLiquidityPoolDTO input)
        {
            if (input == null)
            {
                return false;
