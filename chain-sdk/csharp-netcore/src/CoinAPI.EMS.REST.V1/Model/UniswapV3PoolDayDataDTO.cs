...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV3.PoolDayDataDTO")]
    public partial class UniswapV3PoolDayDataDTO : IEquatable<UniswapV3PoolDayDataDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3PoolDayDataDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV3PoolDayDataDTO);
        }

        /// <summary>
        /// Returns true if UniswapV3PoolDayDataDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3PoolDayDataDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3PoolDayDataDTO input)
        {
            if (input == null)
            {
                return false;
