...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.TokenDTO")]
    public partial class SUSHISWAPV3ETHEREUMTokenDTO : IEquatable<SUSHISWAPV3ETHEREUMTokenDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMTokenDTO" /> class.
        /// </summary>
        ...
        public SUSHISWAPV3ETHEREUMTokenDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string blockRange = default(string), string id = default(string), string name = default(string), string symbol = default(string), int decimals = default(int), string lastPriceUsd = default(string), string lastPriceBlockNumber = default(string), string lastPricePool = default(string), string totalSupply = default(string), string totalValueLockedUsd = default(string), int largePriceChangeBuffer = default(int), int largeTvlImpactBuffer = default(int))
        {
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMTokenDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMTokenDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMTokenDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMTokenDTO input)
        {
            if (input == null)
            {
                return false;
