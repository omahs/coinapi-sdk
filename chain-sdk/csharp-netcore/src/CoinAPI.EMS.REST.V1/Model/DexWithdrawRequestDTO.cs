...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Dex.WithdrawRequestDTO")]
    public partial class DexWithdrawRequestDTO : IEquatable<DexWithdrawRequestDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DexWithdrawRequestDTO" /> class.
        /// </summary>
        ...
        /// <param name="withdrawableFromBatchId">withdrawableFromBatchId.</param>
        /// <param name="createEpoch">createEpoch.</param>
        /// <param name="createBatchId">createBatchId.</param>
        /// <param name="txHash">txHash.</param>
        /// <param name="vid">vid.</param>
        public DexWithdrawRequestDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string user = default(string), string tokenAddress = default(string), string amount = default(string), string withdrawableFromBatchId = default(string), string createEpoch = default(string), string createBatchId = default(string), string txHash = default(string), long vid = default(long))
        {
        ...
        /// <summary>
        /// Gets or Sets WithdrawableFromBatchId
        /// </summary>
        [DataMember(Name = "withdrawable_from_batch_id", EmitDefaultValue = true)]
        public string WithdrawableFromBatchId { get; set; }
        ...
        {
            return this.Equals(input as DexWithdrawRequestDTO);
        }

        /// <summary>
        /// Returns true if DexWithdrawRequestDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of DexWithdrawRequestDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DexWithdrawRequestDTO input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.WithdrawableFromBatchId == input.WithdrawableFromBatchId ||
                    (this.WithdrawableFromBatchId != null &&
                    this.WithdrawableFromBatchId.Equals(input.WithdrawableFromBatchId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.WithdrawableFromBatchId.GetHashCode();
                }
