...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Cow.SettlementDTO")]
    public partial class CowSettlementDTO : IEquatable<CowSettlementDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CowSettlementDTO" /> class.
        /// </summary>
        /// <param name="entryTime">entryTime.</param>
        /// <param name="recvTime">recvTime.</param>
        /// <param name="blockNumber">Number of block in which entity was recorded..</param>
        /// <param name="id">Transaction hash..</param>
        /// <param name="solver">Solver&#39;s address..</param>
        /// <param name="txHash">Transaction hash..</param>
        /// <param name="firstTradeTimestamp">First trade timestamp..</param>
        /// <param name="vid">vid.</param>
        public CowSettlementDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string solver = default(string), string txHash = default(string), string firstTradeTimestamp = default(string), long vid = default(long))
        {
        ...
        /// </summary>
        /// <value>First trade timestamp.</value>
        ...
        {
            return this.Equals(input as CowSettlementDTO);
        }

        /// <summary>
        /// Returns true if CowSettlementDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CowSettlementDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CowSettlementDTO input)
        {
            if (input == null)
            {
                return false;
