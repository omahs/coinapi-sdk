...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.SwapDTO")]
    public partial class UniswapV2SwapDTO : IEquatable<UniswapV2SwapDTO>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2SwapDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV2SwapDTO);
        }

        /// <summary>
        /// Returns true if UniswapV2SwapDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2SwapDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2SwapDTO input)
        {
            if (input == null)
            {
                return false;
