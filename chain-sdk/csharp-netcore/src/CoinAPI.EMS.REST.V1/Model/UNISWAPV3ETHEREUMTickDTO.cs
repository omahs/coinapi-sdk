...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V3_ETHEREUM.TickDTO")]
    public partial class UNISWAPV3ETHEREUMTickDTO : IEquatable<UNISWAPV3ETHEREUMTickDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV3ETHEREUMTickDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV3ETHEREUMTickDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV3ETHEREUMTickDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV3ETHEREUMTickDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV3ETHEREUMTickDTO input)
        {
            if (input == null)
            {
                return false;
