...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.LiquidityPoolFeeDTO")]
    public partial class PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO : IEquatable<PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO" /> class.
        /// </summary>
        ...
        public PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string blockRange = default(string), string id = default(string), string feePercentage = default(string))
        {
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMLiquidityPoolFeeDTO input)
        {
            if (input == null)
            {
                return false;
