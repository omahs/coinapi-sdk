...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V2_ETHEREUM.LiquidityPoolAmountDTO")]
    public partial class UNISWAPV2ETHEREUMLiquidityPoolAmountDTO : IEquatable<UNISWAPV2ETHEREUMLiquidityPoolAmountDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV2ETHEREUMLiquidityPoolAmountDTO" /> class.
        /// </summary>
        ...
        /// <param name="inputTokenBalances">Amount of input tokens in the pool. The ordering is the same as the pool&#39;s &#39;inputTokens&#39; field..</param>
        public UNISWAPV2ETHEREUMLiquidityPoolAmountDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string blockRange = default(string), string id = default(string), List<string> inputTokens = default(List<string>), List<string> inputTokenBalances = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Amount of input tokens in the pool. The ordering is the same as the pool&#39;s &#39;inputTokens&#39; field.</value>
        ...
        {
            return this.Equals(input as UNISWAPV2ETHEREUMLiquidityPoolAmountDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV2ETHEREUMLiquidityPoolAmountDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV2ETHEREUMLiquidityPoolAmountDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV2ETHEREUMLiquidityPoolAmountDTO input)
        {
            if (input == null)
            {
                return false;
