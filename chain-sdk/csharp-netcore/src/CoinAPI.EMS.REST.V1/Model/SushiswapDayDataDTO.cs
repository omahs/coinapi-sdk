...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Sushiswap.DayDataDTO")]
    public partial class SushiswapDayDataDTO : IEquatable<SushiswapDayDataDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SushiswapDayDataDTO" /> class.
        /// </summary>
        ...
        /// <param name="untrackedVolume">Total volume across all pairs on this day, untracked.</param>
        /// <param name="liquidityEth">Total liquidity across all pairs in ETH up to and including this day..</param>
        /// <param name="liquidityUsd">Total liquidity across all pairs in USD up to and including this day..</param>
        /// <param name="txCount">Number of transactions throughout this day..</param>
        /// <param name="vid">vid.</param>
        public SushiswapDayDataDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), int date = default(int), string factory = default(string), string volumeEth = default(string), string volumeUsd = default(string), string untrackedVolume = default(string), string liquidityEth = default(string), string liquidityUsd = default(string), string txCount = default(string), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as SushiswapDayDataDTO);
        }

        /// <summary>
        /// Returns true if SushiswapDayDataDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SushiswapDayDataDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SushiswapDayDataDTO input)
        {
            if (input == null)
            {
                return false;
