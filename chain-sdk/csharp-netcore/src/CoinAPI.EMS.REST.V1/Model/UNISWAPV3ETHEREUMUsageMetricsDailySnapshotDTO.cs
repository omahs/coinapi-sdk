...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO")]
    public partial class UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO : IEquatable<UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV3ETHEREUMUsageMetricsDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
