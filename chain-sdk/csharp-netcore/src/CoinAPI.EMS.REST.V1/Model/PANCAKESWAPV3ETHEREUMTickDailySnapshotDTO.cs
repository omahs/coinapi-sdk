...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.TickDailySnapshotDTO")]
    public partial class PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO : IEquatable<PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO" /> class.
        /// </summary>
        ...
        public PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string id = default(string), int dayId = default(int), string tick = default(string), string pool = default(string), string liquidityGross = default(string), string liquidityGrossUsd = default(string), string liquidityNet = default(string), string liquidityNetUsd = default(string), string timestamp = default(string))
        {
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
