...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    public partial class PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO : IEquatable<PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO>, IValidatableObject
    {
        ...
        public PANCAKESWAPV3ETHEREUMTickDailySnapshotDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), int dayId = default(int), string tick = default(string), string pool = default(string), string liquidityGross = default(string), string liquidityGrossUsd = default(string), string liquidityNet = default(string), string liquidityNetUsd = default(string), string timestamp = default(string))
        {
