...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// Deposit of an user.
    /// </summary>
    [DataContract(Name = "Dex.DepositDTO")]
    public partial class DexDepositDTO : IEquatable<DexDepositDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DexDepositDTO" /> class.
        /// </summary>
        /// <param name="entryTime">entryTime.</param>
        /// <param name="recvTime">recvTime.</param>
        /// <param name="blockNumber">Number of block in which entity was recorded..</param>
        /// <param name="id">Identifier, format: (transaction hash)-(token id)..</param>
        /// <param name="user">User address..</param>
        /// <param name="tokenAddress">Token address..</param>
        /// <param name="amount">Amount of deposit..</param>
        /// <param name="batchId">Identifier (numerical)..</param>
        /// <param name="createEpoch">Create epoch..</param>
        /// <param name="txHash">Transaction hash..</param>
        /// <param name="vid">vid.</param>
        public DexDepositDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string user = default(string), string tokenAddress = default(string), string amount = default(string), string batchId = default(string), string createEpoch = default(string), string txHash = default(string), long vid = default(long))
        {
        ...
        /// </summary>
        /// <value>Identifier, format: (transaction hash)-(token id).</value>
        ...
        /// </summary>
        /// <value>Identifier (numerical).</value>
        ...
        {
            return this.Equals(input as DexDepositDTO);
        }

        /// <summary>
        /// Returns true if DexDepositDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of DexDepositDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DexDepositDTO input)
        {
            if (input == null)
            {
                return false;
