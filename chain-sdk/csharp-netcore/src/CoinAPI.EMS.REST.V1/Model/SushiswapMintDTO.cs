...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Sushiswap.MintDTO")]
    public partial class SushiswapMintDTO : IEquatable<SushiswapMintDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SushiswapMintDTO" /> class.
        /// </summary>
        ...
        public SushiswapMintDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string transaction = default(string), string timestamp = default(string), string pair = default(string), string to = default(string), string liquidity = default(string), string sender = default(string), string amount0 = default(string), string amount1 = default(string), string logIndex = default(string), string amountUsd = default(string), string feeTo = default(string), string feeLiquidity = default(string), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as SushiswapMintDTO);
        }

        /// <summary>
        /// Returns true if SushiswapMintDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SushiswapMintDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SushiswapMintDTO input)
        {
            if (input == null)
            {
                return false;
