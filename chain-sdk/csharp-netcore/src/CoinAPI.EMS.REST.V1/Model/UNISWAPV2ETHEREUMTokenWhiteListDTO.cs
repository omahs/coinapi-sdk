...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V2_ETHEREUM.TokenWhiteListDTO")]
    public partial class UNISWAPV2ETHEREUMTokenWhiteListDTO : IEquatable<UNISWAPV2ETHEREUMTokenWhiteListDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV2ETHEREUMTokenWhiteListDTO" /> class.
        /// </summary>
        ...
        public UNISWAPV2ETHEREUMTokenWhiteListDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string blockRange = default(string), string id = default(string), List<string> whitelistPools = default(List<string>))
        {
        ...
        {
            return this.Equals(input as UNISWAPV2ETHEREUMTokenWhiteListDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV2ETHEREUMTokenWhiteListDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV2ETHEREUMTokenWhiteListDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV2ETHEREUMTokenWhiteListDTO input)
        {
            if (input == null)
            {
                return false;
