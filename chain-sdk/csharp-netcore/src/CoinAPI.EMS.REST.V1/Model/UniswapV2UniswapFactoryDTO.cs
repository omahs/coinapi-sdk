...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.UniswapFactoryDTO")]
    public partial class UniswapV2UniswapFactoryDTO : IEquatable<UniswapV2UniswapFactoryDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2UniswapFactoryDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV2UniswapFactoryDTO);
        }

        /// <summary>
        /// Returns true if UniswapV2UniswapFactoryDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2UniswapFactoryDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2UniswapFactoryDTO input)
        {
            if (input == null)
            {
                return false;
