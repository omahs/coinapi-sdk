...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CURVE_FINANCE_ETHEREUM.UsageMetricsDailySnapshotDTO")]
    public partial class CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO : IEquatable<CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO" /> class.
        /// </summary>
        ...
        public CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string protocol = default(string), int dailyActiveUsers = default(int), int cumulativeUniqueUsers = default(int), int dailyTransactionCount = default(int), int dailyDepositCount = default(int), int dailyWithdrawCount = default(int), int dailySwapCount = default(int), int totalPoolCount = default(int), string timestamp = default(string))
        {
        ...
        {
            return this.Equals(input as CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CURVEFINANCEETHEREUMUsageMetricsDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
