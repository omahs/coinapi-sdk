...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO")]
    public partial class SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO : IEquatable<SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMFinancialsDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
