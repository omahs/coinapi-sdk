...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V2_ETHEREUM.SwapDTO")]
    public partial class UNISWAPV2ETHEREUMSwapDTO : IEquatable<UNISWAPV2ETHEREUMSwapDTO>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV2ETHEREUMSwapDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV2ETHEREUMSwapDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV2ETHEREUMSwapDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV2ETHEREUMSwapDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV2ETHEREUMSwapDTO input)
        {
            if (input == null)
            {
                return false;
