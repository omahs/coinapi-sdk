...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.SwapDTO")]
    public partial class SUSHISWAPV3ETHEREUMSwapDTO : IEquatable<SUSHISWAPV3ETHEREUMSwapDTO>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMSwapDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMSwapDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMSwapDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMSwapDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMSwapDTO input)
        {
            if (input == null)
            {
                return false;
