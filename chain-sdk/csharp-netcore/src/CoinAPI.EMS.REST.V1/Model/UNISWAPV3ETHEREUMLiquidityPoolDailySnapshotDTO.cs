...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO")]
    public partial class UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO : IEquatable<UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
