...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V3_ETHEREUM.AccountDTO")]
    public partial class UNISWAPV3ETHEREUMAccountDTO : IEquatable<UNISWAPV3ETHEREUMAccountDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV3ETHEREUMAccountDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV3ETHEREUMAccountDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV3ETHEREUMAccountDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV3ETHEREUMAccountDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV3ETHEREUMAccountDTO input)
        {
            if (input == null)
            {
                return false;
