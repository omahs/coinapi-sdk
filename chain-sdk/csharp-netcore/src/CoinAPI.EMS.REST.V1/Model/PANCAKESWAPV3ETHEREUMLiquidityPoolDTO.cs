...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// Pool-level metadata.
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.LiquidityPoolDTO")]
    public partial class PANCAKESWAPV3ETHEREUMLiquidityPoolDTO : IEquatable<PANCAKESWAPV3ETHEREUMLiquidityPoolDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMLiquidityPoolDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMLiquidityPoolDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMLiquidityPoolDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMLiquidityPoolDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMLiquidityPoolDTO input)
        {
            if (input == null)
            {
                return false;
