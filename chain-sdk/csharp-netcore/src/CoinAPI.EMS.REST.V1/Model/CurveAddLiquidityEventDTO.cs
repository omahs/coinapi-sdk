...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Curve.AddLiquidityEventDTO")]
    public partial class CurveAddLiquidityEventDTO : IEquatable<CurveAddLiquidityEventDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurveAddLiquidityEventDTO" /> class.
        /// </summary>
        ...
        public CurveAddLiquidityEventDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string pool = default(string), string provider = default(string), List<string> tokenAmounts = default(List<string>), List<string> fees = default(List<string>), string invariant = default(string), string tokenSupply = default(string), string block = default(string), string timestamp = default(string), string transaction = default(string), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as CurveAddLiquidityEventDTO);
        }

        /// <summary>
        /// Returns true if CurveAddLiquidityEventDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CurveAddLiquidityEventDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurveAddLiquidityEventDTO input)
        {
            if (input == null)
            {
                return false;
