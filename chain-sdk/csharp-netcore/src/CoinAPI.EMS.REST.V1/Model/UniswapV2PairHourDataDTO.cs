...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV2.PairHourDataDTO")]
    public partial class UniswapV2PairHourDataDTO : IEquatable<UniswapV2PairHourDataDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV2PairHourDataDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UniswapV2PairHourDataDTO);
        }

        /// <summary>
        /// Returns true if UniswapV2PairHourDataDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV2PairHourDataDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV2PairHourDataDTO input)
        {
            if (input == null)
            {
                return false;
