...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V3_ETHEREUM.TickDailySnapshotDTO")]
    public partial class UNISWAPV3ETHEREUMTickDailySnapshotDTO : IEquatable<UNISWAPV3ETHEREUMTickDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV3ETHEREUMTickDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV3ETHEREUMTickDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV3ETHEREUMTickDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV3ETHEREUMTickDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV3ETHEREUMTickDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
