...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.AccountDTO")]
    public partial class PANCAKESWAPV3ETHEREUMAccountDTO : IEquatable<PANCAKESWAPV3ETHEREUMAccountDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMAccountDTO" /> class.
        /// </summary>
        ...
        public PANCAKESWAPV3ETHEREUMAccountDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string blockRange = default(string), string id = default(string), int positionCount = default(int), int openPositionCount = default(int), int closedPositionCount = default(int), int depositCount = default(int), int withdrawCount = default(int), int swapCount = default(int))
        {
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMAccountDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMAccountDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMAccountDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMAccountDTO input)
        {
            if (input == null)
            {
                return false;
