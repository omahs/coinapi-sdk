...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CURVE_FINANCE_ETHEREUM.LiquidityPoolFeeDTO")]
    public partial class CURVEFINANCEETHEREUMLiquidityPoolFeeDTO : IEquatable<CURVEFINANCEETHEREUMLiquidityPoolFeeDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CURVEFINANCEETHEREUMLiquidityPoolFeeDTO" /> class.
        /// </summary>
        ...
        public CURVEFINANCEETHEREUMLiquidityPoolFeeDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string blockRange = default(string), string id = default(string), string feePercentage = default(string))
        {
        ...
        {
            return this.Equals(input as CURVEFINANCEETHEREUMLiquidityPoolFeeDTO);
        }

        /// <summary>
        /// Returns true if CURVEFINANCEETHEREUMLiquidityPoolFeeDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CURVEFINANCEETHEREUMLiquidityPoolFeeDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CURVEFINANCEETHEREUMLiquidityPoolFeeDTO input)
        {
            if (input == null)
            {
                return false;
