...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.FinancialsDailySnapshotDTO")]
    public partial class PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO : IEquatable<PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMFinancialsDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
