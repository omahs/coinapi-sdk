...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    public partial class UNISWAPV3ETHEREUMTickHourlySnapshotDTO : IEquatable<UNISWAPV3ETHEREUMTickHourlySnapshotDTO>, IValidatableObject
    {
        ...
        public UNISWAPV3ETHEREUMTickHourlySnapshotDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), int hourId = default(int), string tick = default(string), string pool = default(string), string liquidityGross = default(string), string liquidityGrossUsd = default(string), string liquidityNet = default(string), string liquidityNetUsd = default(string), string timestamp = default(string))
        {
