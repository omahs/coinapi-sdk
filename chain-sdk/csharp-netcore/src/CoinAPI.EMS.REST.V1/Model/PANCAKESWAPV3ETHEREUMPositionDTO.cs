...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.PositionDTO")]
    public partial class PANCAKESWAPV3ETHEREUMPositionDTO : IEquatable<PANCAKESWAPV3ETHEREUMPositionDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMPositionDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMPositionDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMPositionDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMPositionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMPositionDTO input)
        {
            if (input == null)
            {
                return false;
