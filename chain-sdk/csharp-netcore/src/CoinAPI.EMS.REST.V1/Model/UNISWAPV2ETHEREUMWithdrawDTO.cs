...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V2_ETHEREUM.WithdrawDTO")]
    public partial class UNISWAPV2ETHEREUMWithdrawDTO : IEquatable<UNISWAPV2ETHEREUMWithdrawDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV2ETHEREUMWithdrawDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV2ETHEREUMWithdrawDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV2ETHEREUMWithdrawDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV2ETHEREUMWithdrawDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV2ETHEREUMWithdrawDTO input)
        {
            if (input == null)
            {
                return false;
