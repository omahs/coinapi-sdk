...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CURVE_FINANCE_ETHEREUM.WithdrawDTO")]
    public partial class CURVEFINANCEETHEREUMWithdrawDTO : IEquatable<CURVEFINANCEETHEREUMWithdrawDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CURVEFINANCEETHEREUMWithdrawDTO" /> class.
        /// </summary>
        /// <param name="entryTime">entryTime.</param>
        /// <param name="recvTime">recvTime.</param>
        /// <param name="blockNumber">Number of block in which entity was recorded..</param>
        /// <param name="blockRange">blockRange.</param>
        /// <param name="id">withdraw-(transaction hash)-(log index).</param>
        ...
        /// <param name="outputToken">Output token of the pool (not output token of the event/transaction). E.g. the UNI-LP token.</param>
        ...
        public CURVEFINANCEETHEREUMWithdrawDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string blockRange = default(string), string id = default(string), string hash = default(string), int logIndex = default(int), string protocol = default(string), string to = default(string), string from = default(string), string timestamp = default(string), List<string> inputTokens = default(List<string>), string outputToken = default(string), List<string> inputTokenAmounts = default(List<string>), string outputTokenAmount = default(string), string amountUsd = default(string), string pool = default(string))
        {
        ...
        /// </summary>
        /// <value>withdraw-(transaction hash)-(log index)</value>
        ...
        /// </summary>
        /// <value>Output token of the pool (not output token of the event/transaction). E.g. the UNI-LP token</value>
        ...
        {
            return this.Equals(input as CURVEFINANCEETHEREUMWithdrawDTO);
        }

        /// <summary>
        /// Returns true if CURVEFINANCEETHEREUMWithdrawDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CURVEFINANCEETHEREUMWithdrawDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CURVEFINANCEETHEREUMWithdrawDTO input)
        {
            if (input == null)
            {
                return false;
