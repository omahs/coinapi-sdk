...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V3_ETHEREUM.PositionSnapshotDTO")]
    public partial class UNISWAPV3ETHEREUMPositionSnapshotDTO : IEquatable<UNISWAPV3ETHEREUMPositionSnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV3ETHEREUMPositionSnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV3ETHEREUMPositionSnapshotDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV3ETHEREUMPositionSnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV3ETHEREUMPositionSnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV3ETHEREUMPositionSnapshotDTO input)
        {
            if (input == null)
            {
                return false;
