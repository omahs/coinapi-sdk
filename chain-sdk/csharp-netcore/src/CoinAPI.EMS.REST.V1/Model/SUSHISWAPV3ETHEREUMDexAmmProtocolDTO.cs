...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.DexAmmProtocolDTO")]
    public partial class SUSHISWAPV3ETHEREUMDexAmmProtocolDTO : IEquatable<SUSHISWAPV3ETHEREUMDexAmmProtocolDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMDexAmmProtocolDTO" /> class.
        /// </summary>
        ...
        public SUSHISWAPV3ETHEREUMDexAmmProtocolDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string blockRange = default(string), string id = default(string), string name = default(string), string slug = default(string), string schemaVersion = default(string), string subgraphVersion = default(string), string methodologyVersion = default(string), string totalValueLockedUsd = default(string), string totalLiquidityUsd = default(string), string activeLiquidityUsd = default(string), string uncollectedProtocolSideValueUsd = default(string), string uncollectedSupplySideValueUsd = default(string), string protocolControlledValueUsd = default(string), string cumulativeVolumeUsd = default(string), string cumulativeSupplySideRevenueUsd = default(string), string cumulativeProtocolSideRevenueUsd = default(string), string cumulativeTotalRevenueUsd = default(string), int cumulativeUniqueUsers = default(int), int cumulativeUniqueLPs = default(int), int cumulativeUniqueTraders = default(int), int totalPoolCount = default(int), int openPositionCount = default(int), int cumulativePositionCount = default(int), int lastSnapshotDayId = default(int), string lastUpdateTimestamp = default(string), string lastUpdateBlockNumber = default(string), bool regenesis = default(bool))
        {
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMDexAmmProtocolDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMDexAmmProtocolDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMDexAmmProtocolDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMDexAmmProtocolDTO input)
        {
            if (input == null)
            {
                return false;
