...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V2_ETHEREUM.DexAmmProtocolDTO")]
    public partial class UNISWAPV2ETHEREUMDexAmmProtocolDTO : IEquatable<UNISWAPV2ETHEREUMDexAmmProtocolDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV2ETHEREUMDexAmmProtocolDTO" /> class.
        /// </summary>
        ...
        public UNISWAPV2ETHEREUMDexAmmProtocolDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string blockRange = default(string), string id = default(string), string name = default(string), string slug = default(string), string schemaVersion = default(string), string subgraphVersion = default(string), string methodologyVersion = default(string), string totalValueLockedUsd = default(string), string protocolControlledValueUsd = default(string), string cumulativeVolumeUsd = default(string), string cumulativeSupplySideRevenueUsd = default(string), string cumulativeProtocolSideRevenueUsd = default(string), string cumulativeTotalRevenueUsd = default(string), int cumulativeUniqueUsers = default(int), int totalPoolCount = default(int))
        {
        ...
        {
            return this.Equals(input as UNISWAPV2ETHEREUMDexAmmProtocolDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV2ETHEREUMDexAmmProtocolDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV2ETHEREUMDexAmmProtocolDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV2ETHEREUMDexAmmProtocolDTO input)
        {
            if (input == null)
            {
                return false;
