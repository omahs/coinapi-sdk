...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CURVE_FINANCE_ETHEREUM.LiquidityPoolHourlySnapshotDTO")]
    public partial class CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO : IEquatable<CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO);
        }

        /// <summary>
        /// Returns true if CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CURVEFINANCEETHEREUMLiquidityPoolHourlySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
