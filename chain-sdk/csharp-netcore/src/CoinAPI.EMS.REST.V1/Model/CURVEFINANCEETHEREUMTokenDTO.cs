...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CURVE_FINANCE_ETHEREUM.TokenDTO")]
    public partial class CURVEFINANCEETHEREUMTokenDTO : IEquatable<CURVEFINANCEETHEREUMTokenDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CURVEFINANCEETHEREUMTokenDTO" /> class.
        /// </summary>
        ...
        /// <param name="lastPriceUsd">Optional field to track the price of a token.</param>
        /// <param name="lastPriceBlockNumber">Optional field to track the block number of the last token price .</param>
        public CURVEFINANCEETHEREUMTokenDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), long vid = default(long), string id = default(string), string name = default(string), string symbol = default(string), int decimals = default(int), string lastPriceUsd = default(string), string lastPriceBlockNumber = default(string))
        {
        ...
        /// </summary>
        /// <value>Optional field to track the price of a token</value>
        ...
        {
            return this.Equals(input as CURVEFINANCEETHEREUMTokenDTO);
        }

        /// <summary>
        /// Returns true if CURVEFINANCEETHEREUMTokenDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CURVEFINANCEETHEREUMTokenDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CURVEFINANCEETHEREUMTokenDTO input)
        {
            if (input == null)
            {
                return false;
