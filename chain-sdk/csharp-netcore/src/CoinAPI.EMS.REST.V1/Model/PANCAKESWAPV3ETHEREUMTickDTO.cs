...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.TickDTO")]
    public partial class PANCAKESWAPV3ETHEREUMTickDTO : IEquatable<PANCAKESWAPV3ETHEREUMTickDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMTickDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMTickDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMTickDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMTickDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMTickDTO input)
        {
            if (input == null)
            {
                return false;
