...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Sushiswap.PairDayDataDTO")]
    public partial class SushiswapPairDayDataDTO : IEquatable<SushiswapPairDayDataDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SushiswapPairDayDataDTO" /> class.
        /// </summary>
        /// <param name="entryTime">entryTime.</param>
        /// <param name="recvTime">recvTime.</param>
        /// <param name="blockNumber">Number of block in which entity was recorded..</param>
        /// <param name="id">Identifier, format: (pair id)-(day start timestamp)..</param>
        ...
        /// <param name="volumeToken0">Total amount of token0 swapped throughout day..</param>
        /// <param name="volumeToken1">Total amount of token1 swapped throughout day..</param>
        /// <param name="volumeUsd">Total volume within pair throughout day..</param>
        /// <param name="txCount">Amount of transactions on pair throughout day..</param>
        /// <param name="vid">vid.</param>
        public SushiswapPairDayDataDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), int date = default(int), string pair = default(string), string token0 = default(string), string token1 = default(string), string reserve0 = default(string), string reserve1 = default(string), string totalSupply = default(string), string reserveUsd = default(string), string volumeToken0 = default(string), string volumeToken1 = default(string), string volumeUsd = default(string), string txCount = default(string), long vid = default(long))
        {
        ...
        /// </summary>
        /// <value>Identifier, format: (pair id)-(day start timestamp).</value>
        ...
        {
            return this.Equals(input as SushiswapPairDayDataDTO);
        }

        /// <summary>
        /// Returns true if SushiswapPairDayDataDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SushiswapPairDayDataDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SushiswapPairDayDataDTO input)
        {
            if (input == null)
            {
                return false;
