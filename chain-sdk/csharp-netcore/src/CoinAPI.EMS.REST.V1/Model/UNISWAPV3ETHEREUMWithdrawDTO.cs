...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UNISWAP_V3_ETHEREUM.WithdrawDTO")]
    public partial class UNISWAPV3ETHEREUMWithdrawDTO : IEquatable<UNISWAPV3ETHEREUMWithdrawDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UNISWAPV3ETHEREUMWithdrawDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UNISWAPV3ETHEREUMWithdrawDTO);
        }

        /// <summary>
        /// Returns true if UNISWAPV3ETHEREUMWithdrawDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UNISWAPV3ETHEREUMWithdrawDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UNISWAPV3ETHEREUMWithdrawDTO input)
        {
            if (input == null)
            {
                return false;
