...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Sushiswap.BurnDTO")]
    public partial class SushiswapBurnDTO : IEquatable<SushiswapBurnDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SushiswapBurnDTO" /> class.
        /// </summary>
        ...
        public SushiswapBurnDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string transaction = default(string), string timestamp = default(string), string pair = default(string), string liquidity = default(string), string sender = default(string), string amount0 = default(string), string amount1 = default(string), string to = default(string), string logIndex = default(string), string amountUsd = default(string), bool complete = default(bool), string feeTo = default(string), string feeLiquidity = default(string), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as SushiswapBurnDTO);
        }

        /// <summary>
        /// Returns true if SushiswapBurnDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SushiswapBurnDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SushiswapBurnDTO input)
        {
            if (input == null)
            {
                return false;
