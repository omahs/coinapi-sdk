...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniswapV3.PositionSnapshotDTO")]
    public partial class UniswapV3PositionSnapshotDTO : IEquatable<UniswapV3PositionSnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniswapV3PositionSnapshotDTO" /> class.
        /// </summary>
        ...
        public UniswapV3PositionSnapshotDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string owner = default(string), string pool = default(string), string position = default(string), string timestamp = default(string), string liquidity = default(string), string depositedToken0 = default(string), string depositedToken1 = default(string), string withdrawnToken0 = default(string), string withdrawnToken1 = default(string), string collectedFeesToken0 = default(string), string collectedFeesToken1 = default(string), string transaction = default(string), string feeGrowthInside0LastX128 = default(string), string feeGrowthInside1LastX128 = default(string), long vid = default(long))
        {
        ...
        {
            return this.Equals(input as UniswapV3PositionSnapshotDTO);
        }

        /// <summary>
        /// Returns true if UniswapV3PositionSnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UniswapV3PositionSnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniswapV3PositionSnapshotDTO input)
        {
            if (input == null)
            {
                return false;
