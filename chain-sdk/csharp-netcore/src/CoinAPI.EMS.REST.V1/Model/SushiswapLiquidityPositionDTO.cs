...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Sushiswap.LiquidityPositionDTO")]
    public partial class SushiswapLiquidityPositionDTO : IEquatable<SushiswapLiquidityPositionDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SushiswapLiquidityPositionDTO" /> class.
        /// </summary>
        ...
        /// <param name="block">Block number at which position was created..</param>
        /// <param name="timestamp">Creation time..</param>
        /// <param name="vid">vid.</param>
        public SushiswapLiquidityPositionDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string user = default(string), string pair = default(string), string liquidityTokenBalance = default(string), int block = default(int), int timestamp = default(int), long vid = default(long))
        {
        ...
        /// </summary>
        /// <value>Block number at which position was created.</value>
        ...
        {
            return this.Equals(input as SushiswapLiquidityPositionDTO);
        }

        /// <summary>
        /// Returns true if SushiswapLiquidityPositionDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SushiswapLiquidityPositionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SushiswapLiquidityPositionDTO input)
        {
            if (input == null)
            {
                return false;
