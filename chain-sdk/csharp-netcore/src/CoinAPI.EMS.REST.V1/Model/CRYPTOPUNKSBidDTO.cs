...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// CRYPTOPUNKSBidDTO
    /// </summary>
    [DataContract(Name = "CRYPTOPUNKS.BidDTO")]
    public partial class CRYPTOPUNKSBidDTO : IEquatable<CRYPTOPUNKSBidDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CRYPTOPUNKSBidDTO" /> class.
        /// </summary>
        ...
        /// <param name="tokensBid">tokensBid.</param>
        ...
        /// <summary>
        /// Gets or Sets TokensBid
        /// </summary>
        [DataMember(Name = "tokens_bid", EmitDefaultValue = true)]
        ...
        /// Gets or Sets Bidder
        /// </summary>
        [DataMember(Name = "bidder", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as CRYPTOPUNKSBidDTO);
        }

        /// <summary>
        /// Returns true if CRYPTOPUNKSBidDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CRYPTOPUNKSBidDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CRYPTOPUNKSBidDTO input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TokensBid == input.TokensBid ||
                    (this.TokensBid != null &&
                    this.TokensBid.Equals(input.TokensBid))
                ) && 
                (
                ...
                (
                    ...
                    (this.Bidder != null &&
                    this.Bidder.Equals(input.Bidder))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.TokensBid.GetHashCode();
                }
                ...
                if (this.Bidder != null)
                {
                    hashCode = (hashCode * 59) + this.Bidder.GetHashCode();
                }
                return hashCode;
            }
        }
