...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.PositionDTO")]
    public partial class SUSHISWAPV3ETHEREUMPositionDTO : IEquatable<SUSHISWAPV3ETHEREUMPositionDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMPositionDTO" /> class.
        /// </summary>
        ...
        public SUSHISWAPV3ETHEREUMPositionDTO(DateTime entryTime = default(DateTime), DateTime recvTime = default(DateTime), long blockNumber = default(long), string id = default(string), string account = default(string), string pool = default(string), string hashOpened = default(string), string hashClosed = default(string), string blockNumberOpened = default(string), string timestampOpened = default(string), string blockNumberClosed = default(string), string timestampClosed = default(string), string tickLower = default(string), string tickUpper = default(string), string liquidityToken = default(string), string liquidityTokenType = default(string), string liquidity = default(string), string liquidityUsd = default(string), List<string> cumulativeDepositTokenAmounts = default(List<string>), string cumulativeDepositUsd = default(string), List<string> cumulativeWithdrawTokenAmounts = default(List<string>), string cumulativeWithdrawUsd = default(string), List<string> cumulativeRewardUsd = default(List<string>), int depositCount = default(int), int withdrawCount = default(int))
        {
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMPositionDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMPositionDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMPositionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMPositionDTO input)
        {
            if (input == null)
            {
                return false;
