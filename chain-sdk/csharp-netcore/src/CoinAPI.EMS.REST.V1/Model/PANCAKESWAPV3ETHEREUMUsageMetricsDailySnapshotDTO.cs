...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PANCAKESWAP_V3_ETHEREUM.UsageMetricsDailySnapshotDTO")]
    public partial class PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO : IEquatable<PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PANCAKESWAPV3ETHEREUMUsageMetricsDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
