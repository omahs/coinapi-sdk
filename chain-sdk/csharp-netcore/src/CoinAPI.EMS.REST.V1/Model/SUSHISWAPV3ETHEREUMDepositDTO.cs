...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.DepositDTO")]
    public partial class SUSHISWAPV3ETHEREUMDepositDTO : IEquatable<SUSHISWAPV3ETHEREUMDepositDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMDepositDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMDepositDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMDepositDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMDepositDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMDepositDTO input)
        {
            if (input == null)
            {
                return false;
