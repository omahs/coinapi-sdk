...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SUSHISWAP_V3_ETHEREUM.LiquidityPoolDailySnapshotDTO")]
    public partial class SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO : IEquatable<SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SUSHISWAPV3ETHEREUMLiquidityPoolDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
