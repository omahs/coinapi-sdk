...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CURVE_FINANCE_ETHEREUM.LiquidityPoolDailySnapshotDTO")]
    public partial class CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO : IEquatable<CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO" /> class.
        /// </summary>
        ...
        /// <param name="dailySupplySideRevenueUsd">dailySupplySideRevenueUsd.</param>
        /// <param name="cumulativeProtocolSideRevenueUsd">Daily revenue generated by the liquidity pool, accrued to the supply side..</param>
        /// <param name="dailyProtocolSideRevenueUsd">All revenue generated by the liquidity pool, accrued to the protocol..</param>
        ...
        /// <param name="dailyVolumeByTokenAmount">dailyVolumeByTokenAmount.</param>
        /// <param name="dailyVolumeByTokenUsd">All trade volume occurred in a given day for a specific input token, in native amount. The ordering should be the same as the pool&#39;s &#39;inputTokens&#39; field..</param>
        /// <param name="cumulativeVolumeUsd">All trade volume occurred in a given day for a specific input token, in USD. The ordering should be the same as the pool&#39;s &#39;inputTokens&#39; field..</param>
        ...
        /// <summary>
        /// Gets or Sets DailySupplySideRevenueUsd
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets DailyVolumeByTokenAmount
        /// </summary>
        ...
        {
            return this.Equals(input as CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO);
        }

        /// <summary>
        /// Returns true if CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CURVEFINANCEETHEREUMLiquidityPoolDailySnapshotDTO input)
        {
            if (input == null)
            {
                return false;
