...
export const APIS = [CRYPTOPUNKSService, CowService, CurveService, DexService, MetadataService, SushiswapService, UNISWAPV3ETHEREUMService, UniswapV2Service, UniswapV3Service];
