...
-- pancakeswap_v3_ethereum_position_snapshot_dto class
local pancakeswap_v3_ethereum_position_snapshot_dto = {}
local pancakeswap_v3_ethereum_position_snapshot_dto_mt = {
	__name = "pancakeswap_v3_ethereum_position_snapshot_dto";
	__index = pancakeswap_v3_ethereum_position_snapshot_dto;
}

local function cast_pancakeswap_v3_ethereum_position_snapshot_dto(t)
	return setmetatable(t, pancakeswap_v3_ethereum_position_snapshot_dto_mt)
end

local function new_pancakeswap_v3_ethereum_position_snapshot_dto(entry_time, recv_time, block_number, id, hash, log_index, nonce, position, liquidity_token_type, liquidity, liquidity_usd, cumulative_deposit_token_amounts, cumulative_deposit_usd, cumulative_withdraw_token_amounts, cumulative_withdraw_usd, cumulative_reward_token_amounts, cumulative_reward_usd, deposit_count, withdraw_count, timestamp)
	return cast_pancakeswap_v3_ethereum_position_snapshot_dto({
...
return {
	cast = cast_pancakeswap_v3_ethereum_position_snapshot_dto;
	new = new_pancakeswap_v3_ethereum_position_snapshot_dto;
}
