...
-- uniswap_v3_ethereum_position_snapshot_dto class
local uniswap_v3_ethereum_position_snapshot_dto = {}
local uniswap_v3_ethereum_position_snapshot_dto_mt = {
	__name = "uniswap_v3_ethereum_position_snapshot_dto";
	__index = uniswap_v3_ethereum_position_snapshot_dto;
}

local function cast_uniswap_v3_ethereum_position_snapshot_dto(t)
	return setmetatable(t, uniswap_v3_ethereum_position_snapshot_dto_mt)
end

local function new_uniswap_v3_ethereum_position_snapshot_dto(entry_time, recv_time, block_number, id, hash, log_index, nonce, position, liquidity_token_type, liquidity, liquidity_usd, cumulative_deposit_token_amounts, cumulative_deposit_usd, cumulative_withdraw_token_amounts, cumulative_withdraw_usd, cumulative_reward_token_amounts, cumulative_reward_usd, deposit_count, withdraw_count, timestamp)
	return cast_uniswap_v3_ethereum_position_snapshot_dto({
...
return {
	cast = cast_uniswap_v3_ethereum_position_snapshot_dto;
	new = new_uniswap_v3_ethereum_position_snapshot_dto;
}
