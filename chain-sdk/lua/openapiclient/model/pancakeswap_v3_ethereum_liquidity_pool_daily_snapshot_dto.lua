...
return {
	cast = cast_pancakeswap_v3_ethereum_liquidity_pool_daily_snapshot_dto;
	new = new_pancakeswap_v3_ethereum_liquidity_pool_daily_snapshot_dto;
}
