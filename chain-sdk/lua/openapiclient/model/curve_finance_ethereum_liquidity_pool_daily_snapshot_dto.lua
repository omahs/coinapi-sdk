...
-- curve_finance_ethereum_liquidity_pool_daily_snapshot_dto class
local curve_finance_ethereum_liquidity_pool_daily_snapshot_dto = {}
local curve_finance_ethereum_liquidity_pool_daily_snapshot_dto_mt = {
	__name = "curve_finance_ethereum_liquidity_pool_daily_snapshot_dto";
	__index = curve_finance_ethereum_liquidity_pool_daily_snapshot_dto;
}

local function cast_curve_finance_ethereum_liquidity_pool_daily_snapshot_dto(t)
	return setmetatable(t, curve_finance_ethereum_liquidity_pool_daily_snapshot_dto_mt)
end

local function new_curve_finance_ethereum_liquidity_pool_daily_snapshot_dto(entry_time, recv_time, block_number, block_range, id, protocol, pool, timestamp, total_value_locked_usd, cumulative_supply_side_revenue_usd, daily_supply_side_revenue_usd, cumulative_protocol_side_revenue_usd, daily_protocol_side_revenue_usd, cumulative_total_revenue_usd, daily_total_revenue_usd, daily_volume_usd, daily_volume_by_token_amount, daily_volume_by_token_usd, cumulative_volume_usd, input_token_balances, input_token_weights, output_token_supply, output_token_price_usd, staked_output_token_amount, reward_token_emissions_amount, reward_token_emissions_usd)
	return cast_curve_finance_ethereum_liquidity_pool_daily_snapshot_dto({
...
return {
	cast = cast_curve_finance_ethereum_liquidity_pool_daily_snapshot_dto;
	new = new_curve_finance_ethereum_liquidity_pool_daily_snapshot_dto;
}
