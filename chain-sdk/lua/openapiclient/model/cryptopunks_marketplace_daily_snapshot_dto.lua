...
-- cryptopunks_marketplace_daily_snapshot_dto class
local cryptopunks_marketplace_daily_snapshot_dto = {}
local cryptopunks_marketplace_daily_snapshot_dto_mt = {
	__name = "cryptopunks_marketplace_daily_snapshot_dto";
	__index = cryptopunks_marketplace_daily_snapshot_dto;
}

local function cast_cryptopunks_marketplace_daily_snapshot_dto(t)
	return setmetatable(t, cryptopunks_marketplace_daily_snapshot_dto_mt)
end

local function new_cryptopunks_marketplace_daily_snapshot_dto(entry_time, recv_time, block_number, vid, block_range, id, marketplace, timestamp, collection_count, cumulative_trade_volume_eth, marketplace_revenue_eth, creator_revenue_eth, total_revenue_eth, trade_count, cumulative_unique_traders, daily_active_traders, daily_traded_collection_count, daily_traded_item_count)
	return cast_cryptopunks_marketplace_daily_snapshot_dto({
...
return {
	cast = cast_cryptopunks_marketplace_daily_snapshot_dto;
	new = new_cryptopunks_marketplace_daily_snapshot_dto;
}
