...
-- pancakeswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto class
local pancakeswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto = {}
local pancakeswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto_mt = {
	__name = "pancakeswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto";
	__index = pancakeswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto;
}

local function cast_pancakeswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto(t)
...
return {
	cast = cast_pancakeswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto;
	new = new_pancakeswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto;
}
