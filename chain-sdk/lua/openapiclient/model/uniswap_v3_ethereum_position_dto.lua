...
-- uniswap_v3_ethereum_position_dto class
local uniswap_v3_ethereum_position_dto = {}
local uniswap_v3_ethereum_position_dto_mt = {
	__name = "uniswap_v3_ethereum_position_dto";
	__index = uniswap_v3_ethereum_position_dto;
}

local function cast_uniswap_v3_ethereum_position_dto(t)
...
return {
	cast = cast_uniswap_v3_ethereum_position_dto;
	new = new_uniswap_v3_ethereum_position_dto;
}
