...
-- uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto class
local uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto = {}
local uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto_mt = {
	__name = "uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto";
	__index = uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto;
}

local function cast_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto(t)
	return setmetatable(t, uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto_mt)
end

local function new_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto(entry_time, recv_time, block_number, block_range, id, protocol, pool, timestamp, total_value_locked_usd, cumulative_supply_side_revenue_usd, hourly_supply_side_revenue_usd, cumulative_protocol_side_revenue_usd, hourly_protocol_side_revenue_usd, cumulative_total_revenue_usd, hourly_total_revenue_usd, hourly_volume_usd, hourly_volume_by_token_amount, hourly_volume_by_token_usd, cumulative_volume_usd, input_token_balances, input_token_weights, output_token_supply, output_token_price_usd, staked_output_token_amount, reward_token_emissions_amount, reward_token_emissions_usd)
	return cast_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto({
...
return {
	cast = cast_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto;
	new = new_uniswap_v2_ethereum_liquidity_pool_hourly_snapshot_dto;
}
