...
-- uniswap_v2_ethereum_financials_daily_snapshot_dto class
local uniswap_v2_ethereum_financials_daily_snapshot_dto = {}
local uniswap_v2_ethereum_financials_daily_snapshot_dto_mt = {
	__name = "uniswap_v2_ethereum_financials_daily_snapshot_dto";
	__index = uniswap_v2_ethereum_financials_daily_snapshot_dto;
}

local function cast_uniswap_v2_ethereum_financials_daily_snapshot_dto(t)
	return setmetatable(t, uniswap_v2_ethereum_financials_daily_snapshot_dto_mt)
end

local function new_uniswap_v2_ethereum_financials_daily_snapshot_dto(entry_time, recv_time, block_number, block_range, id, protocol, total_value_locked_usd, protocol_controlled_value_usd, daily_volume_usd, cumulative_volume_usd, daily_supply_side_revenue_usd, cumulative_supply_side_revenue_usd, daily_protocol_side_revenue_usd, cumulative_protocol_side_revenue_usd, daily_total_revenue_usd, cumulative_total_revenue_usd, timestamp)
	return cast_uniswap_v2_ethereum_financials_daily_snapshot_dto({
...
return {
	cast = cast_uniswap_v2_ethereum_financials_daily_snapshot_dto;
	new = new_uniswap_v2_ethereum_financials_daily_snapshot_dto;
}
