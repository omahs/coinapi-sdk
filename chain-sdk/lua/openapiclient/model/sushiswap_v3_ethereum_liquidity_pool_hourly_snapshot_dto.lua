...
return {
	cast = cast_sushiswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto;
	new = new_sushiswap_v3_ethereum_liquidity_pool_hourly_snapshot_dto;
}
