...
-- pancakeswap_v3_ethereum_financials_daily_snapshot_dto class
local pancakeswap_v3_ethereum_financials_daily_snapshot_dto = {}
local pancakeswap_v3_ethereum_financials_daily_snapshot_dto_mt = {
	__name = "pancakeswap_v3_ethereum_financials_daily_snapshot_dto";
	__index = pancakeswap_v3_ethereum_financials_daily_snapshot_dto;
}

local function cast_pancakeswap_v3_ethereum_financials_daily_snapshot_dto(t)
	return setmetatable(t, pancakeswap_v3_ethereum_financials_daily_snapshot_dto_mt)
end

local function new_pancakeswap_v3_ethereum_financials_daily_snapshot_dto(entry_time, recv_time, block_number, id, day, protocol, total_value_locked_usd, total_liquidity_usd, active_liquidity_usd, uncollected_protocol_side_value_usd, uncollected_supply_side_value_usd, protocol_controlled_value_usd, daily_volume_usd, cumulative_volume_usd, daily_supply_side_revenue_usd, cumulative_supply_side_revenue_usd, daily_protocol_side_revenue_usd, cumulative_protocol_side_revenue_usd, daily_total_revenue_usd, cumulative_total_revenue_usd, timestamp)
	return cast_pancakeswap_v3_ethereum_financials_daily_snapshot_dto({
...
return {
	cast = cast_pancakeswap_v3_ethereum_financials_daily_snapshot_dto;
	new = new_pancakeswap_v3_ethereum_financials_daily_snapshot_dto;
}
