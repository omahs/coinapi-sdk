...
local uniswapv3_ethereum_api_mt = {
	__name = "uniswapv3_ethereum_api";
	__index = uniswapv3_ethereum_api;
}

local function new_uniswapv3_ethereum_api(authority, basePath, schemes)
	local schemes_map = {}
	...
	return setmetatable({
		...
		api_key = {};
		access_token = nil;
	}, uniswapv3_ethereum_api_mt)
end

function uniswapv3_ethereum_api:u_niswapv3_ethereum_accounts__current()
	...
	if http_status:sub(1,1) == "2" then
		...
		for _, ob in ipairs(result) do
			openapiclient_uniswap_v3_ethereum_account_dto.cast(ob)
		end
...
function uniswapv3_ethereum_api:u_niswapv3_ethereum_swaps__current()
	...
	if http_status:sub(1,1) == "2" then
		...
		for _, ob in ipairs(result) do
			openapiclient_uniswap_v3_ethereum_swap_dto.cast(ob)
		end
		return result, headers
	else
		local body, err, errno2 = stream:get_body_as_string()
...
return {
	new = new_uniswapv3_ethereum_api;
}
