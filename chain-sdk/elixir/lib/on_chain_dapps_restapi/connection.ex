...
defmodule OnChainDapps-RESTAPI.Connection do
  @moduledoc """
  Handle Tesla connections for OnChainDapps-RESTAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, OnChainDapps-RESTAPI.Connection,
        base_url: "https://onchain.coinapi.io",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :on_chain_dapps_restapi,
        :base_url, "https://onchain.coinapi.io"
  """

  @default_base_url Application.compile_env(
                      :on_chain_dapps_restapi,
                      :base_url,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:on_chain_dapps_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - OnChainDapps-RESTAPI v1 - elixir"
        )
      )
