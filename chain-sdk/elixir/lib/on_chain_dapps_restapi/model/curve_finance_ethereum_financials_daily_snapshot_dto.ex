...
defmodule OnChainDapps-RESTAPI.Model.CurveFinanceEthereumFinancialsDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.CurveFinanceEthereumFinancialsDailySnapshotDto do
