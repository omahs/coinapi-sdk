...
defmodule OnChainDapps-RESTAPI.Model.UniswapV2EthereumLiquidityPoolHourlySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV2EthereumLiquidityPoolHourlySnapshotDto do
