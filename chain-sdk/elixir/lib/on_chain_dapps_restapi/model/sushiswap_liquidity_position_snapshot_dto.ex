...
defmodule OnChainDapps-RESTAPI.Model.SushiswapLiquidityPositionSnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.SushiswapLiquidityPositionSnapshotDto do
