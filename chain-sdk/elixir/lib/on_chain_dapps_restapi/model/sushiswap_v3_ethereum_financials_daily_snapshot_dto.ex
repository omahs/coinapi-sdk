...
defmodule OnChainDapps-RESTAPI.Model.SushiswapV3EthereumFinancialsDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.SushiswapV3EthereumFinancialsDailySnapshotDto do
