...
defmodule OnChainDapps-RESTAPI.Model.UniswapV2LiquidityPositionSnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV2LiquidityPositionSnapshotDto do
