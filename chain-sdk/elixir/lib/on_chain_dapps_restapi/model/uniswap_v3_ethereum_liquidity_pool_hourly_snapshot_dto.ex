...
defmodule OnChainDapps-RESTAPI.Model.UniswapV3EthereumLiquidityPoolHourlySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV3EthereumLiquidityPoolHourlySnapshotDto do
