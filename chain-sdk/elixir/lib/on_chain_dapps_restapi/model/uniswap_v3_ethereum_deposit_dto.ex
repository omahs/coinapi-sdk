...
defmodule OnChainDapps-RESTAPI.Model.UniswapV3EthereumDepositDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV3EthereumDepositDto do
