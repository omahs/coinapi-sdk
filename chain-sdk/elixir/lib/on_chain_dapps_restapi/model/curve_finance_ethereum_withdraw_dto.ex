...
defmodule OnChainDapps-RESTAPI.Model.CurveFinanceEthereumWithdrawDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.CurveFinanceEthereumWithdrawDto do
