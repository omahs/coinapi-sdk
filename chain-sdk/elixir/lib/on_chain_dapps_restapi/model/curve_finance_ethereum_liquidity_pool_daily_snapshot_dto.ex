...
defmodule OnChainDapps-RESTAPI.Model.CurveFinanceEthereumLiquidityPoolDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.CurveFinanceEthereumLiquidityPoolDailySnapshotDto do
