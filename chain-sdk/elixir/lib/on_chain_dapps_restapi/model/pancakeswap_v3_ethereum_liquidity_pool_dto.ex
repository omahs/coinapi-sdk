...
defmodule OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumLiquidityPoolDto do
  @moduledoc """
  Pool-level metadata.
  """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumLiquidityPoolDto do
