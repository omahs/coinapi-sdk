...
defmodule OnChainDapps-RESTAPI.Model.UniswapV2EthereumUsageMetricsHourlySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV2EthereumUsageMetricsHourlySnapshotDto do
