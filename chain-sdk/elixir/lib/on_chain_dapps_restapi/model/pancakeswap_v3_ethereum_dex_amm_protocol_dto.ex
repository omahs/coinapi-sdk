...
defmodule OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumDexAmmProtocolDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumDexAmmProtocolDto do
