...
defmodule OnChainDapps-RESTAPI.Model.UniswapV2EthereumDepositDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV2EthereumDepositDto do
