...
defmodule OnChainDapps-RESTAPI.Model.UniswapV3EthereumWithdrawDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV3EthereumWithdrawDto do
