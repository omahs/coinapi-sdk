...
defmodule OnChainDapps-RESTAPI.Model.UniswapV3EthereumFinancialsDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV3EthereumFinancialsDailySnapshotDto do
