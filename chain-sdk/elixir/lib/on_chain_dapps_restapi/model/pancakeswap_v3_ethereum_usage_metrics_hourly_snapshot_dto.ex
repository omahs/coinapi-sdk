...
defmodule OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumUsageMetricsHourlySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumUsageMetricsHourlySnapshotDto do
