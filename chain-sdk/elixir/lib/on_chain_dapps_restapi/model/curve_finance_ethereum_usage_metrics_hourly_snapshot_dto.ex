...
defmodule OnChainDapps-RESTAPI.Model.CurveFinanceEthereumUsageMetricsHourlySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.CurveFinanceEthereumUsageMetricsHourlySnapshotDto do
