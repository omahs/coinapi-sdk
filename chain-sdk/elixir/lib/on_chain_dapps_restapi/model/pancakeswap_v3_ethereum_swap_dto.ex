...
defmodule OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumSwapDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumSwapDto do
