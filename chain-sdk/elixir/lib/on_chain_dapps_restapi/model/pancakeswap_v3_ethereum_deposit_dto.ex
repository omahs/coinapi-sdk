...
defmodule OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumDepositDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumDepositDto do
