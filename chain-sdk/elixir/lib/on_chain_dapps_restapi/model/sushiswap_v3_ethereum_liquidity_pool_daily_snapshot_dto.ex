...
defmodule OnChainDapps-RESTAPI.Model.SushiswapV3EthereumLiquidityPoolDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.SushiswapV3EthereumLiquidityPoolDailySnapshotDto do
