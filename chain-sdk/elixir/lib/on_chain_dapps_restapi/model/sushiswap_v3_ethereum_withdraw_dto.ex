...
defmodule OnChainDapps-RESTAPI.Model.SushiswapV3EthereumWithdrawDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.SushiswapV3EthereumWithdrawDto do
