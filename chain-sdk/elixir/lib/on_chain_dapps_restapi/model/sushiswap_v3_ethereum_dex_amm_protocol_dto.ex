...
defmodule OnChainDapps-RESTAPI.Model.SushiswapV3EthereumDexAmmProtocolDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.SushiswapV3EthereumDexAmmProtocolDto do
