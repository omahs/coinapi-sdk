...
defmodule OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumLiquidityPoolDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumLiquidityPoolDailySnapshotDto do
