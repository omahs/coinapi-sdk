...
defmodule OnChainDapps-RESTAPI.Model.CurveFinanceEthereumUsageMetricsDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.CurveFinanceEthereumUsageMetricsDailySnapshotDto do
