...
defmodule OnChainDapps-RESTAPI.Model.UniswapV2EthereumUsageMetricsDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV2EthereumUsageMetricsDailySnapshotDto do
