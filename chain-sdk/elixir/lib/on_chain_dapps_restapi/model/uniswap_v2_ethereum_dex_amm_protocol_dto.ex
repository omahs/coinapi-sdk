...
defmodule OnChainDapps-RESTAPI.Model.UniswapV2EthereumDexAmmProtocolDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.UniswapV2EthereumDexAmmProtocolDto do
