...
defmodule OnChainDapps-RESTAPI.Model.SushiswapV3EthereumLiquidityPoolDto do
  @moduledoc """
  Pool-level metadata.
  """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.SushiswapV3EthereumLiquidityPoolDto do
