...
defmodule OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumUsageMetricsDailySnapshotDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: OnChainDapps-RESTAPI.Model.PancakeswapV3EthereumUsageMetricsDailySnapshotDto do
