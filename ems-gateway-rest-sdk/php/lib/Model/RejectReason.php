...
class RejectReason
{
    ...
    public const EXCHANGE_UNREACHABLE = 'EXCHANGE_UNREACHABLE';

    public const EXCHANGE_RESPONSE_TIMEOUT = 'EXCHANGE_RESPONSE_TIMEOUT';

    public const ORDER_ID_NOT_FOUND = 'ORDER_ID_NOT_FOUND';

    public const INVALID_TYPE = 'INVALID_TYPE';

    public const METHOD_NOT_SUPPORTED = 'METHOD_NOT_SUPPORTED';
