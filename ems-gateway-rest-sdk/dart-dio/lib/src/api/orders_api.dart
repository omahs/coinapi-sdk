...
class OrdersApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [MessageReject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<MessageReject>> v1OrdersCancelAllPost({ 
    required OrderCancelAllRequest orderCancelAllRequest,
    ...
    final _path = r'/v1/orders/cancel/all';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OrderExecutionReport] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<OrderExecutionReport>> v1OrdersCancelPost({ 
    required OrderCancelSingleRequest orderCancelSingleRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/orders/cancel';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [exchangeId] - Filter the open orders to the specific exchange.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<OrderExecutionReport>] as data
  /// Throws [DioError] if API call or serialization fails
  ...
  Future<Response<OrderExecutionReport>> v1OrdersPost({ 
    required OrderNewSingleRequest orderNewSingleRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<OrderExecutionReport>> v1OrdersStatusClientOrderIdGet({ 
    ...
    final _path = r'/v1/orders/status/{client_order_id}'.replaceAll('{' r'client_order_id' '}', clientOrderId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
