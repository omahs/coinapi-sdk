...
#
package WWW::OpenAPIClient::Object::BalanceDataInner;
...
__PACKAGE__->method_documentation({
    ...
    'available' => {
        datatype => 'double',
        base_name => 'available',
        description => 'Value of the current available currency balance on the exchange that can be used as collateral.',
        format => '',
        read_only => '',
            },
    'locked' => {
