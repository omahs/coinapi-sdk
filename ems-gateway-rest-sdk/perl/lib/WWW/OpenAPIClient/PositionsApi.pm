...
#
package WWW::OpenAPIClient::PositionsApi;
...
#
sub v1_positions_get {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/v1/positions';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[Position]', $response);
