...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Position_data_inner>>& getData();
    bool dataIsSet() const;
    void unsetData();

    void setData(const std::vector<std::shared_ptr<Position_data_inner>>& value);


protected:
    utility::string_t m_Exchange_id;
    bool m_Exchange_idIsSet;
    std::vector<std::shared_ptr<Position_data_inner>> m_Data;
    bool m_DataIsSet;
};
