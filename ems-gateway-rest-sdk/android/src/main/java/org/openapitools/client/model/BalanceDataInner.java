...
public class BalanceDataInner {
  ...
  public boolean equals(Object o) {
    ...
    return (this.assetIdExchange == null ? balanceDataInner.assetIdExchange == null : this.assetIdExchange.equals(balanceDataInner.assetIdExchange)) &&
        (this.assetIdCoinapi == null ? balanceDataInner.assetIdCoinapi == null : this.assetIdCoinapi.equals(balanceDataInner.assetIdCoinapi)) &&
        (this.balance == null ? balanceDataInner.balance == null : this.balance.equals(balanceDataInner.balance)) &&
        (this.available == null ? balanceDataInner.available == null : this.available.equals(balanceDataInner.available)) &&
        (this.locked == null ? balanceDataInner.locked == null : this.locked.equals(balanceDataInner.locked)) &&
        (this.lastUpdatedBy == null ? balanceDataInner.lastUpdatedBy == null : this.lastUpdatedBy.equals(balanceDataInner.lastUpdatedBy)) &&
        (this.rateUsd == null ? balanceDataInner.rateUsd == null : this.rateUsd.equals(balanceDataInner.rateUsd)) &&
        (this.traded == null ? balanceDataInner.traded == null : this.traded.equals(balanceDataInner.traded));
  }
