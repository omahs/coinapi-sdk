...
class OrderCancelSingleRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["exchange_id", "exchange_order_id", "client_order_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["exchange_id", "exchange_order_id", "client_order_id", ], str]):
