...
class ExecInst(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def MAKER_OR_CANCEL(cls):
                return cls("MAKER_OR_CANCEL")
            
            @schemas.classproperty
            def AUCTION_ONLY(cls):
                return cls("AUCTION_ONLY")
            
            @schemas.classproperty
            def INDICATION_OF_INTEREST(cls):
                return cls("INDICATION_OF_INTEREST")
