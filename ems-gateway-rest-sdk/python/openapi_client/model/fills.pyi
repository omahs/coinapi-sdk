...
class Fills(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["time", "price", "amount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["time", "price", "amount", ], str]):
