...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsRestApi.BalanceDataInner();
  });
  ...
  describe('BalanceDataInner', function() {
    it('should create an instance of BalanceDataInner', function() {
      // uncomment below and update the code to test BalanceDataInner
      //var instance = new EmsRestApi.BalanceDataInner();
      //expect(instance).to.be.a(EmsRestApi.BalanceDataInner);
    });
