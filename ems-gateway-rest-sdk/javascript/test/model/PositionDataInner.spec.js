...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmsRestApi.PositionDataInner();
  });
  ...
  describe('PositionDataInner', function() {
    it('should create an instance of PositionDataInner', function() {
      // uncomment below and update the code to test PositionDataInner
      //var instance = new EmsRestApi.PositionDataInner();
      //expect(instance).to.be.a(EmsRestApi.PositionDataInner);
    });
