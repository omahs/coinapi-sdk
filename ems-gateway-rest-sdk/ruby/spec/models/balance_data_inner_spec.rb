...
# Unit tests for OpenapiClient::BalanceDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BalanceDataInner do
  let(:instance) { OpenapiClient::BalanceDataInner.new }

  describe 'test an instance of BalanceDataInner' do
    it 'should create an instance of BalanceDataInner' do
      expect(instance).to be_instance_of(OpenapiClient::BalanceDataInner)
    end
  end
