...
module OpenapiClient
  class OrdStatus
    ...
    def self.all_vars
      @all_vars ||= [RECEIVED, ROUTING, ROUTED, NEW, PENDING_CANCEL, PARTIALLY_FILLED, FILLED, CANCELED, REJECTED].freeze
    end
    ...
    def build_from_hash(value)
      return value if OrdStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #OrdStatus"
    end
  end
end
