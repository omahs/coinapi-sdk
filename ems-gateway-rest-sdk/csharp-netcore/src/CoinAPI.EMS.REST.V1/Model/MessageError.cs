...
namespace CoinAPI.EMS.REST.V1.Model
{
    ...
    public partial class MessageError : IEquatable<MessageError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageError" /> class.
        /// </summary>
        /// <param name="message">Message text..</param>
        public MessageError(string message = default(string))
        {
        ...
        {
            return this.Equals(input as MessageError);
        }
