...
defmodule EMS-RESTAPI.Connection do
  @moduledoc """
  Handle Tesla connections for EMS-RESTAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, EMS-RESTAPI.Connection,
        base_url: "https://ems-gateway-aws-eu-central-1-dev.coinapi.io",
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:ems_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - EMS-RESTAPI v1 - elixir"
        )
      )
